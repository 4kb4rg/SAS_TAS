...
Public Class IN_Rpt_StockReturnDet : inherits page
    ...
    Sub Bind_ITEM(ByVal blnIsPDFFormat As Boolean)
        ...
        strOpCd_Get = "IN_CLSTRX_STOCKRETURN_DETAIL_GET_FOR_REPORT" & "|" & "StockReturn"
        strOpCd_GetLine = "IN_CLSTRX_STOCKRETURN_LINE_GET_FOR_REPORT" & "|" & "StockReturnLn"
        ...
        Try
            intErrNo = objIN.mtdGetStockReturnReport(strOpCodes, _
                                                     strParam, _
                                                     strCompany, _
                                                     strLocation, _
                                                     strUserId, _
