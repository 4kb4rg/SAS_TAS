...
Public Class PU_Rpt_SupplierList : Inherits Page
    ...
    Public Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        strSupplierName = Trim(Request.QueryString("strSupplierName"))
        ...
        strSupplierCodeTag = Trim(Request.QueryString("strSupplierCodeTag"))
    ...
    Sub Bind_ITEM(ByVal blnIsPDFFormat As Boolean)
        ...
        Dim strOpCd As String = "PU_CLSSETUP_SUPPLIER_LIST_GET_FOR_REPORT"
        ...
        Try
            intErrNo = objPU.mtdGetSupplier(strOpCd,strParam,objRptDs)
        ...
        For intCnt=0 To objRptDs.Tables(0).Rows.Count - 1
            objRptDs.Tables(0).Rows(intCnt).Item("Status") = objPU.mtdGetSuppStatus(objRptDs.Tables(0).Rows(intCnt).Item("Status"))
        ...
        rdCrystalViewer.Load(objMapPath & "Web\EN\PU\Reports\Crystal\PU_Rpt_SupplierList.rpt", OpenReportMethod.OpenReportByTempCopy)
        ...
        Else
            ...
            If strExportToExcel = "0" Then
                ...
                DiskOpts.DiskFileName = objMapPath & "web\ftp\PU_Rpt_SupplierList.pdf"
            Else
                rdCrystalViewer.ExportOptions.ExportFormatType = CrystalDecisions.[Shared].ExportFormatType.Excel
                DiskOpts.DiskFileName = objMapPath & "web\ftp\PU_Rpt_SupplierList.xls"
            End If
        ...
        If strExportToExcel = "0" Then
            Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../../ftp/PU_Rpt_SupplierList.pdf"">")
        Else
            Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../../ftp/PU_Rpt_SupplierList.xls"">")
        End If
    ...
    Sub PassParam()
        ...
        paramField1 = ParamFields.Item("strTitleTag") 
        paramField2 = ParamFields.Item("strSupplierCodeTag")
        paramField3 = ParamFields.Item("strDescTag")

        crParameterValues1 = paramField1.CurrentValues
        crParameterValues2 = paramField2.CurrentValues
        crParameterValues3 = paramField3.CurrentValues

        ParamDiscreteValue1.value = strTitleTag
        ParamDiscreteValue2.value = strSupplierCodeTag
        ParamDiscreteValue3.value = strDescTag
