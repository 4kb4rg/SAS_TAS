...
Public Class PU_Rpt_RFQDet : Inherits Page
    ...
    Sub Bind_ITEM(ByVal blnIsPDFFormat As Boolean)
        ...
        strOpCd_GetLine = "PU_STDRPT_RFQ_DOCRPT"
        strReportName = "PU_Rpt_RFQ.rpt"
        ...
        crDiskFileDestinationOptions.DiskFileName = objMapPath & "web\ftp\PU_Rpt_RFQ.pdf"
        ...
        Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../../ftp/PU_Rpt_RFQ.pdf"">")
    End Sub
