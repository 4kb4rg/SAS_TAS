...
Public Class WM_data_uploaddisp : Inherits Page
    ...
    Sub UploadBtn_Click(Sender As Object, E As ImageClickEventArgs)
        ...
        If objGlobal.mtdValidateUploadFileName(strZipName, objGlobal.EnumDataTransferFileType.WM_WeighingDispatchData, strErrMsg) = False Then
        ...
        Try
            ...
            If intErrNo <> 0 Then
                lblErrUpload.Text = "There was an error when uploading the file"
                lblErrUpload.Visible = True
                Exit Sub
            End If
        Catch Exp As System.Exception
