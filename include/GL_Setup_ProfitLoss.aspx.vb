...
Public Class GL_Setup_ProfitLoss : Inherits Page
    ...
    Sub Page_Load(ByVal Sender As Object, ByVal E As EventArgs)
        ...
        ElseIf objAR.mtdHasAccessRights(objAR.mtdGetAccessRights(objAR.EnumGLAccessRights.GLProfLossSetup), intGLAR) = False Then
            Response.Redirect("/" & strLangCode & "/include/mesg/AccessRights.aspx")
        Else
            onload_GetLangCap()
            strStmtType = CInt(objGLSetup.EnumStmtType.ProfitLoss)
    ...
    Protected Function LoadData() As DataSet
        ...
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=GL_SETUP_BALSHEET_GET&errmesg=" & lblErrMessage.Text & "&redirect=GL/Setup/GL_Setup_ProfitLoss.aspx")
        End Try
        Return objDataSet
    End Function
    ...
    Protected Function GetStmtAccYear As String
        ...
        Try
            intErrNo = objSysConfig.mtdGetConfigInfo(strOpCd_Config, _
                                                     ...
                                                     DsConfig, "")
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=GL_SETUP_PROFLOSS_GETACCYEAR&errmesg=" & lblErrMessage.Text & "&redirect=GL/Setup/GL_Setup_ProfitLoss.aspx")
        End Try
    ...
    Sub onClick_Account(ByVal Sender As Object, ByVal E As EventArgs)
        ...
        If strRowId <> "" Then
            Response.Write("<Script Language=""JavaScript"">pop_Account=window.open(""../../GL/Setup/GL_Setup_TemplAccount.aspx?rowid=" & strRowId & _
                            ...
                            """, null ,""'pop_Account',width=700,height=600,top=50,left=150,status=yes, resizable=yes, scrollbars=yes, toolbar=no, location=no"");pop_Account.focus();</Script>")
        End If
    End Sub
    ...
    Sub DEDR_Update(ByVal Sender As Object, ByVal E As DataGridCommandEventArgs)
       ...
       Else
        ...
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=GL_SETUP_PROFITLOSS_UPD&errmesg=" & lblErrMessage.Text & "&redirect=GL/Setup/GL_Setup_ProfitLoss.aspx")
        End Try
    ...
    Sub DEDR_Delete(ByVal Sender As Object, ByVal E As DataGridCommandEventArgs)
        ...
        Try
            intErrNo = objGLSetup.mtdDelStmtTempl(strOpCdDelTempl, _
                                                  ...
                                                  strParam)
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=GL_SETUP_PROFLOSS_DEL&errmesg=" & lblErrMessage.Text & "&redirect=GL/Setup/GL_Setup_ProfitLoss.aspx")
        End Try
   ...
   Sub DEDR_Cancel(ByVal Sender As Object, ByVal E As DataGridCommandEventArgs)
    ...
    Sub onclick_GenStmt(ByVal Sender As Object, ByVal E As ImageClickEventArgs)
        ...
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=GL_SETUP_PROFLOSS_POPULATE&errmesg=" & lblErrMessage.Text & "&redirect=GL/Setup/GL_Setup_ProfitLoss.aspx")
        End Try

        If pr_intError = 0 Then
            lblErrCalc.text = "Profit and Loss statement is created or updated successfully."
            lblErrCalc.visible = true
        Else
            lblErrCalc.text = "Profit and Loss statement is not created or updated successfully." 
            lblErrCalc.visible = true
        End If
    ...
    Sub GetEntireLangCap()
        ...
        Try
            intErrNo = objLangCap.mtdGetBussTerm(strOpCode_BussTerm, _
                                                 ...
                                                 strParam)
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=GL_SETUP_PROFLOSS_GETLANGCAP&errmesg=" & lblErrMessage.Text & "&redirect=gl/setup/GL_Setup_ProfitLoss.aspx")
        End Try
    End Sub
