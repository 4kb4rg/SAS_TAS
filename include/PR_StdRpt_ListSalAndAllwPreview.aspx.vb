...
Public Class PR_StdRpt_ListSalAndAllwPreview : Inherits Page
    ...
    Sub BindReport()
       ...
       strOpCd = "PR_STDRPT_LISTSALANDALLW" & "|" & objPRRpt.mtdGetPRReportTable(objPRRpt.EnumPRReportTable.ListSalAndAllw) & Chr(9) & _
        ...
        Try
            intErrNo = objPRRpt.mtdGetReport_ListSalAndAllw(strOpCd, _
                                                           strCompany, _
                                                           strLocation, _
                                                           strUserId, _
                                                           strAccMonth, _
        ...
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=PR_STDRPT_LISTSALANDALLW&errmesg=" & lblErrMessage.Text & "&redirect=")
        End Try

        rdCrystalViewer.Load(objMapPath & "web\" & strLangCode & "\Reports\Crystal\PR_StdRpt_ListSalAndAllw.rpt", OpenReportMethod.OpenReportByTempCopy)
        ...
        crDiskFileDestinationOptions.DiskFileName = objMapPath & "web\ftp\PR_StdRpt_ListSalAndAllw.pdf"
        ...
        Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../ftp/PR_StdRpt_ListSalAndAllw.pdf"">")
    End Sub
