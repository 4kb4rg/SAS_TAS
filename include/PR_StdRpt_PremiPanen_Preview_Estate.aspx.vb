...
Public Class PR_StdRpt_PremiPanen_Preview_Estate : Inherits Page
    ...
    Sub BindReport()
		...
		strOpCd = "PR_PR_STDRPT_PREMIPANEN_EMP_REPORT"
		strRptPrefix = "PR_StdRpt_PremiPanen_Emp"
        ...
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=PR_PR_STDRPT_PREMIPANEN_REPORT&errmesg=" & lblErrMessage.Text & "&redirect=")
        End Try
		...
		'else
        'objRptDs.Tables(0).TableName = "PREMI_A_DTL"
        'objRptDs.Tables(1).TableName = "PREMI_B_MDR"
        'objRptDs.Tables(2).TableName = "PREMI_C_KCS"
        'objRptDs.Tables(3).TableName = "PREMI_D_TRN"
