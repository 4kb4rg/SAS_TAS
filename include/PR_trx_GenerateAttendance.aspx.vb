...
Public Class PR_Trx_GenerateAttendance : Inherits Page
    ...
    Sub btnGenerate_Click(ByVal Sender As Object, ByVal E As ImageClickEventArgs)
        ...
        Dim strOpCode As String = "PR_CLSTRX_GENERATE_ATTENDANCE"
        ...
        strParamName = "LOCCODE|DEPTCODE|STARTDATE|ENDDATE"
        strParamValue = strLocation & "|" & Trim(ddlDeptCode.SelectedItem.Value) & "|" & _
                        objActualDateFrom & "|" & objActualDateTo 
