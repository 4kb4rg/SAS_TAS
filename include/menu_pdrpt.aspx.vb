...
Public Class menu_pdrpt : Inherits Page
    ...
    Private Sub ReportsRight()
        ...
        If objAR.mtdHasAccessRights(objAR.mtdGetModuleActivation(objAR.EnumModuleActivation.Production), intModuleActivate) Then
            ...
            If intLocType = 4 Then
                lnkRpt1.NavigateUrl = "/" & strLangCode & "/reports/PM_StdRpt_Selection.aspx?UserLoc=" & strLocation
            Else
                lnkRpt1.NavigateUrl = "/" & strLangCode & "/reports/PD_StdRpt_Selection.aspx?UserLoc=" & strLocation
            End If
