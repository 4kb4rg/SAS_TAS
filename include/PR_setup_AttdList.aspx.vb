...
Public Class PR_setup_AttdList : Inherits Page
    ...
    Protected Function LoadData() As DataSet
        ...
        Dim strOpCd_GET As String = "PR_CLSSETUP_ATTENDANCE_LIST_GET"    
        Dim strSrchAttCode As String
        ...
        strSrchAttCode = IIF(txtAttdCode.Text = "", "", txtAttdCode.Text)
        ...
        Try
            intErrNo = objPRSetup.mtdGetAttendance(strOpCd_GET, strParam, objAttDs, False)
        ...
        If objAttDs.Tables(0).Rows.Count > 0 Then
            For intCnt = 0 To objAttDs.Tables(0).Rows.Count - 1
                objAttDs.Tables(0).Rows(intCnt).Item("AttCode") = Trim(objAttDs.Tables(0).Rows(intCnt).Item("AttCode"))
                objAttDs.Tables(0).Rows(intCnt).Item("Description") = Trim(objAttDs.Tables(0).Rows(intCnt).Item("Description"))
    ...
    Sub DEDR_Delete(Sender As Object, e As DataGridCommandEventArgs)
        ...
        strSelectedAttCode = CPCell.Text
        strParam = strSelectedAttCode & "|||||||||||" & objPRSetup.EnumAttStatus.Deleted
        ...
        Try
            intErrNo = objPRSetup.mtdUpdAttendance(strOpCd_ADD, _
                                                   ...
                                                   True)
        Catch Exp As System.Exception
            Response.Redirect("../../../include/mesg/ErrorMessage.aspx?errcode=PR_SETUP_ATTENDANCE_DEL&errmesg=" & lblErrMessage.Text & "&redirect=pr/setup/PR_setup_AttdList.aspx")
        End Try
    ...
    Sub NewTBBtn_Click(Sender As Object, E As ImageClickEventArgs)
        Response.Redirect("PR_setup_AttdDet.aspx")
    End Sub
