...
Public Class PU_setup_UserGroup : Inherits Page
    ...
    Sub BindUserlist(ByVal pv_User As String)
        ...
        Else
            strParamValue = "Where UserID NOT IN (SELECT UserID FROM PU_SUPPLIER_USER)  ORDER By UserName ASC "
        End If
        ...
        For intCnt = 0 To objUser.Tables(0).Rows.Count - 1
            ...
            objUser.Tables(0).Rows(intCnt).Item("UserName") = Trim(objUser.Tables(0).Rows(intCnt).Item("UserName"))
        ...
        DDLUser.Items.Add("Please Select")
    ...
    Sub onload_GetLangCap()
        GetEntireLangCap()
        lblTitle.Text = "SETUP PURCHASING USER GROUP"
    ...
    Protected Function LoadData() As DataSet
        Dim strOppCd_GET As String = "PU_CLSSETUP_SUPPLIER_USER_GET"
        Dim strParam As String
        ...
        strParam = "SEARCHSTR"
        SearchStr = "Where Userid='" & DDLUser.SelectedItem.Value & "'"
    ...
    Sub DEDR_Delete(ByVal Sender As Object, ByVal E As DataGridCommandEventArgs)
        ...
        ParamNama = "USRID|GRCODE"
        ParamValue = DDLUser.SelectedItem.Value & "|" & strTypeCode
        Try
    ...
    Sub AddBtn_Click(ByVal Sender As Object, ByVal E As ImageClickEventArgs)
        Dim strOpCd_Upd As String = "PU_CLSSETUP_SUPPLIER_USER_ADD"
        Dim strParamName As String
        Dim strParamValue As String
        Dim intErrNo As Integer
        ...
        strParamName = "USRID|GRPCODE|UID|STATUS"
        strParamValue = Trim(DDLUser.SelectedItem.Value) & "|" & Trim(DDLItemGroup.SelectedItem.Value) & "|" & strUserId & _
                       "|" & "1"
    ...
    Sub AddBtnALL_Click(ByVal Sender As Object, ByVal E As ImageClickEventArgs)
        Dim strOpCd_Upd As String = "PU_CLSSETUP_SUPPLIER_USER_ADDALL"
        Dim strParamName As String
        Dim strParamValue As String
        Dim intErrNo As Integer
        Dim objEmp As New Object()
        ...
        strParamName = "USRID|UID|STATUS"
        strParamValue = Trim(DDLUser.SelectedItem.Value) & "|" & strUserId & _
                       "|" & "1"
    ...
    Sub btnDelete_Click(ByVal Sender As Object, ByVal E As ImageClickEventArgs)
        Dim strOpCd_Upd As String = "PU_CLSSETUP_SUPPLIER_USER_LIST_DEL"
        Dim strParamName As String
        Dim strParamValue As String
        Dim intErrNo As Integer
        Dim objEmp As New Object()
    ...
    Sub btnUnDelete_Click(ByVal Sender As Object, ByVal E As ImageClickEventArgs)
        ...
        UserMsgBox(Me, "UnDelete Sucsess")
        BindGrid()
    End Sub

    Sub btnBack_Click(ByVal Sender As Object, ByVal E As ImageClickEventArgs)
        Response.Redirect("PU_setup_UserGroupList.aspx")
    End Sub
