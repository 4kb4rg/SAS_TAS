...
Public Class PM_WaterQuality_Det : Inherits Page
    ...
    Dim strOppCd_WaterQuality_GET As String = "PM_CLSTRX_WATERQUALITY_GET"
    ...
    Sub GetEntireLangCap()
        ...
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=PM_CLSTRX_WATERQUALITY_GET_LANGCAP&errmesg=" & lblErrMessage.Text & "&redirect=PM/trx/pm_trx_WaterQuality_list.aspx")
        End Try
    ...
    Protected Function LoadData() As DataSet
        ...
        Try
            intErrNo = objPMTrx.mtdGetOilLoss(strOppCd_WaterQuality_GET, strLocation, strParam, objDataSet)
        Catch Exp As System.Exception
            Response.Redirect("../../../include/mesg/ErrorMessage.aspx?errcode=PM_CLSTRX_WaterQuality_GET&errmesg=" & lblErrMessage.Text & "&redirect=PM/trx/PM_trx_WaterQuality_List.aspx")
        End Try
    ...
    Sub DisplayData()
        Dim I As Integer
        Dim dsWaterQuality As DataSet = LoadData()

        If dsWaterQuality.Tables(0).Rows.Count > 0 Then
            
            txtdate.Text = objGlobal.GetShortDate(strDateFormat, Trim(dsWaterQuality.Tables(0).Rows(0).Item("TransDate")))

            Try
                ddlTestSampleCode.SelectedValue = dsWaterQuality.Tables(0).Rows(0).Item("TestSampleCode")
            Catch Exp As System.Exception
                ddlTestSampleCode.SelectedValue = ""
            End Try

            Try
                ddlStation.SelectedValue = dsWaterQuality.Tables(0).Rows(0).Item("StationCode")
            Catch Exp As System.Exception
                ddlStation.SelectedValue = ""
            End Try


            lblPeriod.Text = Trim(dsWaterQuality.Tables(0).Rows(0).Item("AccMonth")) & "/" & Trim(dsWaterQuality.Tables(0).Rows(0).Item("AccYear"))
            lblStatus.Text = objPMTrx.mtdGetWaterQualityStatus(Trim(dsWaterQuality.Tables(0).Rows(0).Item("Status")))
            lblCreateDate.Text = objGlobal.GetLongDate(Trim(dsWaterQuality.Tables(0).Rows(0).Item("CreateDate")))
            lblLastUpdate.Text = objGlobal.GetLongDate(Trim(dsWaterQuality.Tables(0).Rows(0).Item("UpdateDate")))
            lblUpdateBy.Text = Trim(dsWaterQuality.Tables(0).Rows(0).Item("Username"))
                        
            PopulateControls(dsWaterQuality)

            DisableControl(Trim(dsWaterQuality.Tables(0).Rows(0).Item("Status")))
    ...
    Sub UpdateData(ByVal strAction As String)
        ...
        Dim strOppCd_WaterQuality_ADD As String = "PM_CLSTRX_WATERQUALITY_ADD"
        Dim strOppCd_WaterQuality_UPD As String = "PM_CLSTRX_WATER_QUALITY_UPD"
        Dim strOppCd_Dtl_ADD As String = "PM_CLSTRX_WATERQUALITY_DETAIL_ADD"
        Dim strOppCd_Dtl_UPD As String = "PM_CLSTRX_WATERQUALITY_DETAIL_UPD"
        Dim strOpCodeDelDtl As String = "PM_CLSTRX_WATERQUALITY_DETAIL_DEL"
        ...
        Dim strTrxID As String = "WaterID" 
        ...
        strParam =  lblId.Text & "|" & _
                    ...
                    ddlMachine.SelectedValue & "|" &  objPMTrx.EnumWaterQualityStatus.Active
        
        Try
                
            intErrNo = objPMTrx.mtdUpdOilLoss(strOppCd_WaterQuality_ADD, _
                                              strOppCd_WaterQuality_UPD, _
                                              strOppCd_Dtl_ADD, _
                                              strOppCd_Dtl_UPD, _
                                              strOpCodeDelDtl, _
                                              strLocation, _
        ...
        Catch Exp As System.Exception
            Response.Redirect("../../../include/mesg/ErrorMessage.aspx?errcode=PM_CLSTRX_WATERQUALITY_UPDATE&errmesg=" & lblErrMessage.Text & "&redirect=PM/trx/pm_trx_WaterQuality_list.aspx")
        End Try
    ...
    Sub btnDelete_Click(ByVal Sender As Object, ByVal E As ImageClickEventArgs)
        Dim strOppCd_DEL As String = "PM_CLSTRX_WATERQUALITY_DEL"
        ...
        Try
            intErrNo = objPMTrx.mtdPhysicalDelete(strOppCd_DEL, _
                                                  strParam, objPMTrx.EnumTransType.WaterQuality)

        Catch Exp As System.Exception
            Response.Redirect("../../../include/mesg/ErrorMessage.aspx?errcode=PM_CLSTRX_WATERQUALITY_DEL&errmesg=" & lblErrMessage.Text & "&redirect=PM/Trx/PM_trx_WaterQuality_List.aspx")
        End Try

        Response.Redirect("PM_trx_WaterQuality_List.aspx")
    End Sub
    ...
    Sub BindMachine(Byval vstrValue As String, Optional Byval vstrStation As String = "")
        ...
        If vstrStation <> "" Then
            ...
            Try
                intErrNo = objPMTrx.mtdGetTransactionList(strOpCd, strParam, dsList)
            Catch Exp As System.Exception
                Response.Redirect("../../../include/mesg/ErrorMessage.aspx?errcode=PM_CLSTRX_WATERQUALITY_BINDMACHINE&errmesg=" & lblErrMessage.Text & "&redirect=PM/Trx/PM_trx_WaterQuality_List.aspx")
            End Try
    ...
    Private Sub PopulateTemplControls(ByVal vstrMachine As String) 
           ...
           Dim hrow As HtmlTableRow
            ...
            Try
                intErrNo = objPMTrx.mtdGetTransactionList(strOpCd, strParam, dsList)
            Catch Exp As System.Exception
                Response.Redirect("../../../include/mesg/ErrorMessage.aspx?errcode=PM_CLSTRX_WATERQUALITY_MACHINETEMPLATE_GET&errmesg=" & lblErrMessage.Text & "&redirect=PM/Trx/PM_trx_WaterQuality_List.aspx")
            End Try
