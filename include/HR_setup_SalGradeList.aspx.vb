...
Public Class HR_setup_SalGradeList : Inherits Page

    Protected WithEvents dgLine As DataGrid
    Protected WithEvents lbDelete As LinkButton    
    Protected WithEvents lblTracker As Label
    Protected WithEvents lstDropList As DropDownList
    Protected WithEvents txtSalSchemeCode As TextBox
    ...
    Sub Page_Load(Sender As Object, E As EventArgs)
        ...
        Else
           If SortExpression.Text = "" Then
                SortExpression.Text = "SG.SalGradeCode"
            End If
    ...
    Protected Function LoadData() As DataSet
        ...
        Dim strSrchSalSchemeCode As String
        Dim strSrchSalGradeCode As String
        ...
        strSrchSalSchemeCode = IIF(txtSalSchemeCode.Text = "", "", txtSalSchemeCode.Text)
        strSrchSalGradeCode = IIF(txtSalGradeCode.Text = "", "", txtSalGradeCode.Text)
        ...
        strParam = strSrchSalSchemeCode & "|" & _
                   strSrchSalGradeCode & "|" & _
                   strSrchStatus & "|" & _
                   strSrchLastUpdate & "|" & _
        ...
        If objSalGradeDs.Tables(0).Rows.Count > 0 Then
            For intCnt = 0 To objSalGradeDs.Tables(0).Rows.Count - 1
                ...
                objSalGradeDs.Tables(0).Rows(intCnt).Item("SalSchemeCode") = Trim(objSalGradeDs.Tables(0).Rows(intCnt).Item("SalSchemeCode"))
                objSalGradeDs.Tables(0).Rows(intCnt).Item("Status") = Trim(objSalGradeDs.Tables(0).Rows(intCnt).Item("Status"))
                objSalGradeDs.Tables(0).Rows(intCnt).Item("UpdateID") = Trim(objSalGradeDs.Tables(0).Rows(intCnt).Item("UpdateID"))
                objSalGradeDs.Tables(0).Rows(intCnt).Item("UserName") = Trim(objSalGradeDs.Tables(0).Rows(intCnt).Item("UserName"))
            Next
        End If

        Return objSalGradeDs
    End Function
    ...
    Sub DEDR_Delete(Sender As Object, e As DataGridCommandEventArgs)
        Dim strOpCd As String = "HR_CLSSETUP_SALGRADE_STATUS_UPD"
        Dim strParam As String = ""
        Dim CPCell As TableCell = e.Item.Cells(0)
        Dim strSelectedGradeCode As String 
        Dim intErrNo As Integer

        strSelectedGradeCode = CPCell.Text
        strParam = strSelectedGradeCode & "|" & objHRSetup.EnumSalGradeStatus.Deleted
        ...
        Try
            intErrNo = objHRSetup.mtdUpdSalGrade(strOpCd, _
                                                 ...
                                                 True)
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=HR_SETUP_SALGRADE_DEL&errmesg=" & lblErrMessage.Text & "&redirect=hr/setup/HR_setup_SalGradeList.aspx")
        End Try
    ...
    Sub NewSGBtn_Click(Sender As Object, E As ImageClickEventArgs)
        Response.Redirect("HR_setup_SalGradedet.aspx")
    End Sub
