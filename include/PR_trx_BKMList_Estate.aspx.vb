...
Public Class PR_BKMList : Inherits Page
    ...
    Protected Function LoadData() As DataSet
        Dim strOpCd_Get As String = "PR_PR_TRX_BKM_MAIN_GET_LIST"
        ...
        strSearch1 = "AND x.BKMCode Like '%" & strSrchBKM & "%' " & _
 					 "AND x.BKMType Like '%" & strSrchBKMType & "%' " & _
	    ...
	    strSearch = "AND (B.EmpName Like '%" & strSrchEmpName & "%' or F.EmpName Like  '%" & strSrchEmpName & " %' or H.EmpName Like  '%" & strSrchEmpName & "%' or I.EmpName Like  '%" & strSrchEmpName & "%')"  
    ...
    Sub BKMLink_Click(ByVal Sender As Object, ByVal E As DataGridCommandEventArgs)
        If Not E.CommandName.ToString = "Sort" And Not E.CommandName.ToString = "Delete" Then
            ...
            Session("BKM") = ddlEmpMonth.SelectedItem.Value.Trim() & "|" & _
    ...
    Sub DEDR_Delete(ByVal Sender As Object, ByVal E As DataGridCommandEventArgs)
        Dim strOpCd_Status As String = "PR_PR_TRX_BKM_MAIN_DEL"
        Dim intErrNo As Integer
