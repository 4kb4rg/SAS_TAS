...
Public Class HR_trx_MutasiList_Estate : Inherits Page
    ...
    Sub Page_Load(ByVal Sender As Object, ByVal E As EventArgs)
        ...
        Else
            If SortExpression.Text = "" Then
                SortExpression.Text = "MutasiCode"
            End If
    ...
    Protected Function LoadData() As DataSet
        Dim strOpCd_GET As String = "HR_HR_TRX_EMPMUTASI_GET"
    ...
    Sub DEDR_Delete(ByVal Sender As Object, ByVal e As DataGridCommandEventArgs)
        Dim strOpCd_UPD As String = "HR_HR_TRX_EMPMUTASI_DEL"
        ...
        ParamValue = strStatus & "|" & Now() & "|" & strUserId & "|" & Trim(strid) & "|" & idWH.Trim()
    ...
    Sub NewBtn_Click(ByVal Sender As Object, ByVal E As ImageClickEventArgs)
        Response.Redirect("HR_trx_MutasiDet_Estate.aspx")
    End Sub
