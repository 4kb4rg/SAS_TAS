...
Public Class PR_KTNDet_New_Estate : Inherits Page
...
#Region "Function & Procedure"
    ...
    Function getCode(ByVal cat As String, ByVal scat As String) As String
        ...
        tcode = "KTN/" & strLocation & "/" & cat & "-" & scat & "/" & Mid(Trim(txtWPDate.Text), 4, 2) & Right(Trim(txtWPDate.Text), 2) & "/"
    ...
    Private Function BKM_Already_Exist() As SByte
        ...
        Catch Exp As System.Exception
            Response.Write("/include/mesg/ErrorMessage.aspx?errcode=PR_PR_TRX_KTN_GET&errmesg=" & Exp.Message & "&redirect=")
        End Try
    ...
    Sub BKM_onSave()
        ...
        ParamNama = "BKM|LOC|IC|IS|RB|MC|KC|AM|AY|BD|DC|NTS|POL|SP|K1|K2|ST|CD|UD|UI|TC|PM"
        ParamValue = strIDM & "|" & _
                     strLocation & "|" & _
                     SIdCat & "|" & _
                     SIdSubCat & "|" & _
    ...
    Function BKM_onUpdate() as Boolean
        ...
        ParamNama = "BKM|LOC|MC|KC|BD|NP|NTS|UD|UI|TC|PM|TY"
...
#Region "Function & Procedure HJK"
    ...
    Private Sub HJK_RW_Pekerjaan_onSave()
        Dim strOpCd_Del As String = "PR_PR_TRX_KTNLN_MJOB_CLEAR"
        Dim strOpCd_Upd As String = "PR_PR_TRX_KTNLN_MJOB_UPD"
        ...
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=PR_PR_TRX_KTNLN_MJOB_CLEAR&errmesg=" & Exp.Message & "&redirect=")
        End Try
        ...
        For i = 0 To dgHKJ_RWT.Items.Count - 1
            ...
            If (hid_jb.Value.Trim <> "") And (hid_cb.Value.Trim <> "") And (txt_hk.Text <> "") And (txt_hs.Text <> "") Then
                ...
                Catch Exp As System.Exception
                    Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=PR_PR_TRX_KTNLN_MJOB_UPD&errmesg=" & Exp.Message & "&redirect=")
                End Try
            End If
    ...
    Private Sub HJK_BHN_Pekerjaan_onSave()
        Dim strOpCd_Del As String = "PR_PR_TRX_KTNLN_MBHN_CLEAR"
        Dim strOpCd_Upd As String = "PR_PR_TRX_KTNLN_MBHN_UPD"
        Dim strIDM As String = LblidM.Text
        Dim sIdSubCat As String
        Dim sIdDIv As String
        Dim hid_jb As HiddenField
        ...
        Try
            intErrNo = objOk.mtdInsertDataCommon(strOpCd_Del, ParamName, ParamValue)
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=PR_PR_TRX_KTNLN_MBHN_CLEAR&errmesg=" & Exp.Message & "&redirect=")
        End Try
        ...
        For i = 0 To dgHKJ_BHN.Items.Count - 1
            ...
            If (hid_jb.Value.Trim <> "") And (hid_cb.Value.Trim <> "") And (hid_itm.Value <> "") And (txt_qty.Text <> "") Then
                ...
                Try
                    intErrNo = objOk.mtdInsertDataCommon(strOpCd_Upd, ParamName, ParamValue)
                Catch Exp As System.Exception
                    Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=PR_PR_TRX_KTNLN_MBHN_UPD&errmesg=" & Exp.Message & "&redirect=")
                End Try
            End If
    ...
    Private Sub HKJ_RW_Pekerjaan_onSave_by_RW()
        Dim strOpCd_Upd As String = "PR_PR_TRX_KTNLN_MJOB_UPD_BY_RW"
        Dim strIDM As String = LblidM.Text
        Dim ParamName As String
        Dim ParamValue As String
        Dim intErrNo As Integer
        ...
        Try
            intErrNo = objOk.mtdInsertDataCommon(strOpCd_Upd, ParamName, ParamValue)
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=PR_PR_TRX_KTNLN_MJOB_UPD_BY_RW&errmesg=" & Exp.Message & "&redirect=")
        End Try
    ...
    Private Sub HKJ_RW_Pekerjaan_onSave_by_BO()
        Dim strOpCd_Upd As String = "PR_PR_TRX_KTNLN_MJOB_UPD_BY_BO"
        Dim strIDM As String = LblidM.Text
        Dim ParamName As String
        Dim ParamValue As String
        Dim intErrNo As Integer
        ...
        Try
            intErrNo = objOk.mtdInsertDataCommon(strOpCd_Upd, ParamName, ParamValue)
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=PR_PR_TRX_KTNLN_MJOB_UPD_BY_BO&errmesg=" & Exp.Message & "&redirect=")
        End Try
    ...
    Private Sub HKJ_RW_Pekerjaan_onSave_by_PN()
        Dim strOpCd_Upd As String = "PR_PR_TRX_KTNLN_MJOB_UPD_BY_PN"
        Dim strIDM As String = LblidM.Text
        Dim ParamName As String
        Dim ParamValue As String
        Dim intErrNo As Integer
        ...
        Try
            intErrNo = objOk.mtdInsertDataCommon(strOpCd_Upd, ParamName, ParamValue)
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=PR_PR_TRX_KTNLN_MJOB_UPD_BY_PN&errmesg=" & Exp.Message & "&redirect=")
        End Try
    ...
    Private Sub HKJ_RW_Pekerjaan_onSave_by_TR()
        Dim strOpCd_Upd As String = "PR_PR_TRX_KTNLN_MJOB_UPD_BY_TR"
        Dim strIDM As String = LblidM.Text
        Dim nopol As String = ""
        Dim ParamName As String
        Dim ParamValue As String
        ...
        Try
            intErrNo = objOk.mtdInsertDataCommon(strOpCd_Upd, ParamName, ParamValue)
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=PR_PR_TRX_KTNLN_MJOB_UPD_BY_TR&errmesg=" & Exp.Message & "&redirect=")
        End Try
    ...
    Private Sub HKJ_BHN_Pekerjaan_onSave_by_BHNALL()
        Dim strOpCd_Upd As String = "PR_PR_TRX_KTNLN_MBHN_UPD_BY_BHNALL"
        Dim strIDM As String = LblidM.Text
        Dim ParamName As String
        Dim ParamValue As String
        Dim intErrNo As Integer
        ...
        Try
            intErrNo = objOk.mtdInsertDataCommon(strOpCd_Upd, ParamName, ParamValue)
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=PR_PR_TRX_KTNLN_MBHN_UPD_BY_BHNALL&errmesg=" & Exp.Message & "&redirect=")
        End Try
...
#Region "Function & Procedure RW"
    ...
    Private Sub RW_Pekerjaan_onSave()
        ...
        Try
            intErrNo = objOk.mtdInsertDataCommon(strOpCd_Del, ParamName, ParamValue)
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=PR_PR_TRX_KTNLN_RW_CLEAR&errmesg=" & Exp.Message & "&redirect=")
        End Try
        ...
        For i = 0 To dgRW.Items.Count - 1
            ...
            If (hid_ec.Value <> "") And (hid_jb.Value.Trim <> "") And (hid_cb.Value.Trim <> "") And (txt_hk.Text <> "") And (txt_hs.Text <> "") Then
                ...
                Try
                    intErrNo = objOk.mtdInsertDataCommon(strOpCd_Upd, ParamName, ParamValue)
                Catch Exp As System.Exception
                    Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=PR_PR_TRX_KTNLN_RW_UPD&errmesg=" & Exp.Message & "&redirect=")
                End Try
            End If
    ...
    Private Sub RW_Bahan_onSave()
        Dim strOpCd_Del As String = "PR_PR_TRX_KTNLN_BHN_CLEAR"
        Dim strOpCd_Upd As String = "PR_PR_TRX_KTNLN_BHN_UPD"
        Dim strIDM As String = LblidM.Text
        Dim hid_ec As HiddenField
        Dim hid_cb As HiddenField
        Dim hid_jb As HiddenField
        ...
        Try
            intErrNo = objOk.mtdInsertDataCommon(strOpCd_Del, ParamName, ParamValue)
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=PR_PR_TRX_KTNLN_RWBHN_CLEAR&errmesg=" & Exp.Message & "&redirect=")
        End Try
        ...
        For i = 0 To dgBHN.Items.Count - 1
            ...
            If (hid_jb.Value.Trim <> "") And (hid_cb.Value.Trim <> "") And (hid_ic.Value.Trim <> "") And (txt_qty.Text.Trim <> "") Then
                ...
                Try
                    intErrNo = objOk.mtdInsertDataCommon(strOpCd_Upd, ParamName, ParamValue)
                Catch Exp As System.Exception
                    Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=PR_PR_TRX_KTNLN_RWBHN_UPD&errmesg=" & Exp.Message & "&redirect=")
                End Try
            End If
...
#Region "Function & Procedure PN"
    ...
    Private Function Cek_ALokasiPN(ByVal jb As String, ByVal cb As String) As Boolean
        Dim strOpCd_EmpDiv As String = "PR_PR_TRX_KTNLN_PN_CEK"
        Dim strParamName As String
        Dim strParamValue As String
        Dim intErrNo As Integer
        Dim objEmpCodeDs As New Object()
        ...
        Try
            intErrNo = objOk.mtdGetDataCommon(strOpCd_EmpDiv, strParamName, strParamValue, objEmpCodeDs)
        Catch Exp As System.Exception
            Response.Write("/include/mesg/ErrorMessage.aspx?errcode=PR_PR_TRX_KTNLN_PN_CEK&errmesg=" & Exp.Message & "&redirect=")
        End Try
    ...
    Private Sub PN_Pekerjaan_onSave()
        Dim strOpCd_Del As String = "PR_PR_TRX_KTNLN_PN_CLEAR"
        Dim strOpCd_Upd As String = "PR_PR_TRX_KTNLN_PN_UPD"
        Dim strIDM As String = LblidM.Text
        Dim sIdSubCat As String
        Dim sIdDIv As String
        Dim hid_jb As HiddenField
        ...
        Try
            intErrNo = objOk.mtdInsertDataCommon(strOpCd_Del, ParamName, ParamValue)
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=PR_PR_TRX_KTNLN_BO_CLEAR&errmesg=" & Exp.Message & "&redirect=")
        End Try
        ...
        For i = 0 To dgPN.Items.Count - 1
            ...
            If (hid_ec.Value <> "") And (ddl_cb.SelectedItem.Value.Trim <> "") And ((Trim(sIdSubCat) = "PBS" And CInt(txt_jg.Text) <> 0) or (Trim(sIdSubCat) <> "PBS")) Then
                ...
                Try
                    intErrNo = objOk.mtdInsertDataCommon(strOpCd_Upd, ParamName, ParamValue)
                Catch Exp As System.Exception
                    Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=PR_PR_TRX_KTNLN_PN_UPD&errmesg=" & Exp.Message & "&redirect=")
                End Try
            End If
    ...
    Private Sub PNSUM_Pekerjaan_onSave()
        Dim strOpCd_Del As String = "PR_PR_TRX_KTNLN_PNSUM_CLEAR"
        Dim strOpCd_Upd As String = "PR_PR_TRX_KTNLN_PNSUM_UPD"
        Dim strIDM As String = LblidM.Text
        Dim sIdSubCat As String
        ...
        For i = 0 To dgPNSUM.Items.Count - 1
            ...
            Try
                intErrNo = objOk.mtdInsertDataCommon(strOpCd_Upd, ParamName, ParamValue)
            Catch Exp As System.Exception
                Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=PR_PR_TRX_KTNLN_PNSUM_UPD&errmesg=" & Exp.Message & "&redirect=")
            End Try
        Next
    End Sub
...
#Region "Function & Procedure TR"
    ...
    Private Sub TR_Pekerjaan_onSave()
        Dim strOpCd_Del As String = "PR_PR_TRX_KTNLN_TR_CLEAR"
        Dim strOpCd_Upd As String = "PR_PR_TRX_KTNLN_TR_UPD"
        Dim strIDM As String = LblidM.Text
        Dim sIdSubCat As String
        Dim sIdDIv As String
        Dim hid_jb As HiddenField
        ...
        Try
            intErrNo = objOk.mtdInsertDataCommon(strOpCd_Del, ParamName, ParamValue)
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=PR_PR_TRX_KTNLN_TR_CLEAR&errmesg=" & Exp.Message & "&redirect=")
        End Try
        ...
        For i = 0 To dgTRX.Items.Count - 1
            ...
            If (hid_jb.Value.Trim <> "") And (txt_hk.Text <> "") And (txt_hs.Text <> "") Then
                ...
                Try
                    intErrNo = objOk.mtdInsertDataCommon(strOpCd_Upd, ParamName, ParamValue)
                Catch Exp As System.Exception
                    Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=PR_PR_TRX_KTNLN_TR_UPD&errmesg=" & Exp.Message & "&redirect=")
                End Try
            End If
...
#Region "Function & Procedure BO"
    Private Function Cek_ALokasiBO(ByVal jb As String, ByVal cb As String) As Boolean
        Dim strOpCd_EmpDiv As String = "PR_PR_TRX_KTNLN_BO_CEK"
        Dim strParamName As String
        Dim strParamValue As String
        Dim intErrNo As Integer
        Dim objEmpCodeDs As New Object()
        ...
        Try
            intErrNo = objOk.mtdGetDataCommon(strOpCd_EmpDiv, strParamName, strParamValue, objEmpCodeDs)
        Catch Exp As System.Exception
            Response.Write("/include/mesg/ErrorMessage.aspx?errcode=PR_PR_TRX_KTNLN_BO_CEK&errmesg=" & Exp.Message & "&redirect=")
        End Try
    ...
    Private Sub BOR_Pekerjaan_onSave()
        Dim strOpCd_Del As String = "PR_PR_TRX_KTNLN_BO_CLEAR"
        Dim strOpCd_Upd As String = "PR_PR_TRX_KTNLN_BO_UPD"
        Dim strIDM As String = LblidM.Text
        Dim sIdSubCat As String
        Dim sIdDIv As String
        Dim hid_ec As HiddenField
        ...
        For i = 0 To dgBOR.Items.Count - 1
			...
			sIdSubCat = left(right(ddl_jb.SelectedItem.Text.Trim(),4),3) 
            'Save only employee and job exists and blok  and hk and hasil
            If (hid_ec.Value <> "") And (ddl_jb.SelectedItem.Value.Trim <> "") And (ddl_cb.SelectedItem.Value.Trim <> "") And (txt_hs.Text <> "") And (CSng(txt_hs.Text) > 0) Then
                ...
                Try
                    intErrNo = objOk.mtdInsertDataCommon(strOpCd_Upd, ParamName, ParamValue)
                Catch Exp As System.Exception
                    Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=PR_PR_TRX_KTNLN_BO_UPD&errmesg=" & Exp.Message & "&redirect=")
                End Try
            End If
...
#Region "Binding BK"
    ...
    Sub BindMandor(ByVal strDivCode As String, ByVal sfilter As String, ByVal mdr As String)
        ...
        strParamName = "LOC|SEARCH|SORT"
        'strParamValue = strLocation & "|AND A.Status='1' AND C.isMandor='1' AND A.LocCode = '" & strLocation & "' AND (JobCode='ADM' or JobCode='MDR' or JobCode='MDT' or jobcode='MKN' or JobCode='KRN' or JobCode='KRT' or Jobcode='KRW')|ORDER BY A.EmpName"
        strParamValue = strLocation & "|AND A.Status='1' AND sMandor='1' AND A.LocCode = '" & strLocation & "'|ORDER BY A.EmpName"
    ...
    Sub BindKCS(ByVal strDivCode As String,Byval kcs as String)
        ...
        strParamName = "LOC|SEARCH|SORT"
        strParamValue = strLocation & "|AND A.Status='1' AND A.LocCode = '" & strLocation & "' AND (JobCode='MDR' or JobCode='MDT' or jobcode='MKN' or JobCode='KRN' or JobCode='KRT' or Jobcode='KRW')|ORDER BY A.EmpName"
    ...
    Sub BindBahan()
        Dim strOpCd_EmpDiv As String = "PR_PR_TRX_KTN_BAHAN_LIST_GET"
        Dim strParamName As String
        Dim strParamValue As String
        Dim intErrNo As Integer
        Dim intCnt As Integer
        ...
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=PR_PR_TRX_KTN_BAHAN_LIST_GET&errmesg=" & Exp.Message & "&redirect=")
        End Try
    ...
    Sub Bind_Blok(ByVal sdc As String, ByVal sjc As String, ByVal ssc As String, ByVal sku As String)
        Dim strOpCd_EmpDiv As String = "PR_PR_STP_BLOK_KTN_GET"
        Dim strParamName As String
        Dim strParamValue As String
        Dim intErrNo As Integer
        Dim intCnt As Integer
        ...
        Try
            intErrNo = objOk.mtdGetDataCommon(strOpCd_EmpDiv, strParamName, strParamValue, objEmpBlkDs)
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=PR_PR_STP_BLOK_KTN_GET&errmesg=" & Exp.Message & "&redirect=")
        End Try
    ...
    Sub Bind_BOR_Blok(ByVal sdc As String, ByVal sjc As String)
        Dim strOpCd_EmpDiv As String = "PR_PR_STP_BLOK_KTN_BOR_GET"
        Dim strParamName As String
        Dim strParamValue As String
        Dim intErrNo As Integer
        Dim intCnt As Integer
        ...
        Try
            intErrNo = objOk.mtdGetDataCommon(strOpCd_EmpDiv, strParamName, strParamValue, objEmpBlkDs)
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=PR_PR_STP_BLOK_KTN_BOR_GET&errmesg=" & Exp.Message & "&redirect=")
        End Try
...
#Region "Binding HKJ"
    ...
    Protected Function dgHKJ_RW_Reload() As DataSet
        ...
        'load data
        Dim strOpCd_EmpDiv As String = "PR_PR_TRX_KTN_MJOB_TEMP_UPDGET"
        Dim strParamName As String
        Dim strParamValue As String
        Dim objEmpCodeDs As New Object()
        Dim sc As String
        ...
        Try
            intErrNo = objOk.mtdGetDataCommon(strOpCd_EmpDiv, strParamName, strParamValue, objEmpCodeDs)
        Catch Exp As System.Exception
            Response.Write("/include/mesg/ErrorMessage.aspx?errcode=PR_PR_TRX_KTN_MJOB_TEMP_UPDGET&errmesg=" & Exp.Message & "&redirect=")
        End Try
    ...
    Sub HKJ_RW_EmpByMdr_Clear()
        Dim strOpCd As String = "PR_PR_TRX_KTN_MJOB_TEMP_CLEAR"
        Dim strParamName As String
        Dim strParamValue As String
        Dim intErrNo As Integer
    ...
    'BAHAN
    Sub HKJ_BHN_Clear()
        Dim strOpCd As String = "PR_PR_TRX_KTN_MBHN_TEMP_CLEAR"
        Dim strParamName As String
        Dim strParamValue As String
        Dim intErrNo As Integer
        strParamName = "IP|UI|LOC"
        ...
        Try
            ...
            dgHKJ_BHN.DataBind()
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=PR_PR_TRX_KTN_MBHN_TEMP_CLEAR&errmesg=" & Exp.Message & "&redirect=")
        End Try
    End Sub
    ...
    Protected Function dgHKJ_BHN_Reload() As DataSet
        ...
        'load data
        Dim strOpCd_EmpDiv As String = "PR_PR_TRX_KTN_MBHN_TEMP_UPDGET"
        Dim strParamName As String
        Dim strParamValue As String
        Dim objEmpCodeDs As New Object()
        Dim intErrNo As Integer
        ...
        Try
            intErrNo = objOk.mtdGetDataCommon(strOpCd_EmpDiv, strParamName, strParamValue, objEmpCodeDs)
        Catch Exp As System.Exception
            Response.Write("/include/mesg/ErrorMessage.aspx?errcode=PR_PR_TRX_KTN_MBHN_TEMP_UPDGET&errmesg=" & Exp.Message & "&redirect=")
        End Try
...
#Region "Binding RW"
    ...
    Protected Function dgRW_Reload() As DataSet
        ...
        Try
            intErrNo = objOk.mtdGetDataCommon(strOpCd_EmpDiv, strParamName, strParamValue, objEmpCodeDs)
        Catch Exp As System.Exception
            Response.Write("/include/mesg/ErrorMessage.aspx?errcode=PR_PR_TRX_KTN_RW_TEMP_UPDGET&errmesg=" & Exp.Message & "&redirect=")
        End Try
    ...
    Protected Function RW_EmpByMdrAll() As DataSet
        ...
        Try
            intErrNo = objOk.mtdGetDataCommon(strOpCd_EmpDiv, strParamName, strParamValue, objEmpCodeDs)
        Catch Exp As System.Exception
            Response.Write("/include/mesg/ErrorMessage.aspx?errcode=PR_PR_TRX_KTN_RW_TEMP_LISTEMP&errmesg=" & Exp.Message & "&redirect=")
        End Try
    ...
    Protected Function RW_EmpByMdr(ByVal mc As String, ByVal dt As String) As DataSet
        Dim strOpCd_EmpDiv As String = "PR_PR_TRX_KTN_RW_TEMP_UPDNEW"
        Dim strParamName As String
        Dim strParamValue As String
        Dim intErrNo As Integer
        Dim intCnt As Integer
        ...
        Try
            intErrNo = objOk.mtdGetDataCommon(strOpCd_EmpDiv, strParamName, strParamValue, objEmpCodeDs)
        Catch Exp As System.Exception
            Response.Write("/include/mesg/ErrorMessage.aspx?errcode=PR_PR_TRX_KTN_RW_TEMP_UPDNEW&errmesg=" & Exp.Message & "&redirect=")
        End Try
    ...
    Sub RW_Pekerjaan(ByVal cat As String, ByVal subcat As String)
        ...
        Try
            intErrNo = objOk.mtdGetDataCommon(strOpCd_EmpDiv, strParamName, strParamValue, objEmpCodeDs)
        Catch Exp As System.Exception
            Response.Write("/include/mesg/ErrorMessage.aspx?errcode=PR_PR_TRX_KTN_RW_JOB_LIST&errmesg=" & Exp.Message & "&redirect=")
        End Try
...
#Region "Binding BHN"
    Protected Function dgBHN_Reload() As DataSet
        ...
        Try
            intErrNo = objOk.mtdGetDataCommon(strOpCd_EmpDiv, strParamName, strParamValue, objEmpCodeDs)
        Catch Exp As System.Exception
            Response.Write("/include/mesg/ErrorMessage.aspx?errcode=PR_PR_TRX_KTN_BHN_TEMP_UPDGET&errmesg=" & Exp.Message & "&redirect=")
        End Try
    ...
    Sub BHN_Clear()
        ...
        Try
            ...
            dgBHN.DataBind()
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=PR_PR_TRX_KTN_BHN_TEMP_CLEAR&errmesg=" & Exp.Message & "&redirect=")
        End Try
    End Sub
...
#Region "Binding PN"
    Sub Bind_sub_sub_categori(ByVal sc As String)
        ...
        strParamName = "SEARCH|SORT"
        strParamValue = "WHERE IdSubCat='" & sc & "'|Order by SubSubCatName"

        Try
            intErrNo = objOk.mtdGetDataCommon(strOpCd_EmpDiv, strParamName, strParamValue, objEmpCodeDs)
        Catch Exp As System.Exception
            Response.Write("/include/mesg/ErrorMessage.aspx?errcode=PR_PR_STP_BK_SUBSUBCATEGORY_GET&errmesg=" & Exp.Message & "&redirect=")
        End Try

        hastbl_subsub.Clear()
        If objEmpCodeDs.Tables(0).Rows.Count > 0 Then
            For intCnt = 0 To objEmpCodeDs.Tables(0).Rows.Count - 1
                hastbl_subsub.Add(Trim(objEmpCodeDs.Tables(0).Rows(intCnt).Item("SubSubCatID")), Trim(objEmpCodeDs.Tables(0).Rows(intCnt).Item("SubSubCatName")))
            Next
        End If
    End Sub
    ...
    Protected Function dgPN_Reload() As DataSet
        'load data
        Dim strOpCd_EmpDiv As String = "PR_PR_TRX_KTN_PN_TEMP_UPDGET"
        Dim strParamName As String
        Dim strParamValue As String
        Dim objEmpCodeDs As New Object()
        Dim sc As String
        ...
        Try
            intErrNo = objOk.mtdGetDataCommon(strOpCd_EmpDiv, strParamName, strParamValue, objEmpCodeDs)
        Catch Exp As System.Exception
            Response.Write("/include/mesg/ErrorMessage.aspx?errcode=PR_PR_TRX_KTN_PN_TEMP_UPDGET&errmesg=" & Exp.Message & "&redirect=")
        End Try
    ...
    Protected Function dgPNSUM_Reload() As DataSet
        'load data
        Dim strOpCd_EmpDiv As String = "PR_PR_TRX_KTN_PNSUM_TEMP_UPDGET"
        Dim strParamName As String
        Dim strParamValue As String
        Dim objEmpCodeDs As New Object()
        Dim intErrNo As Integer
        ...
        Try
            intErrNo = objOk.mtdGetDataCommon(strOpCd_EmpDiv, strParamName, strParamValue, objEmpCodeDs)
        Catch Exp As System.Exception
            Response.Write("/include/mesg/ErrorMessage.aspx?errcode=PR_PR_TRX_KTN_PNSUM_TEMP_UPDNEW&errmesg=" & Exp.Message & "&redirect=")
        End Try
	...
	Protected Function dgPNSUM_Refresh() As DataSet
        'load data
        Dim strOpCd_EmpDiv As String = "PR_PR_TRX_KTN_PNSUM_TEMP_UPDNEW"
        Dim strParamName As String
        Dim strParamValue As String
        Dim objEmpCodeDs As New Object()
        Dim intErrNo As Integer
    ...
    Protected Function PN_EmpByMdr(ByVal mc As String, ByVal dt As String, ByVal flt As String) As DataTable
        Dim strOpCd_EmpDiv As String = "PR_PR_TRX_KTN_PN_TEMP_UPDNEW"
        Dim strParamName As String
        Dim strParamValue As String
        Dim intErrNo As Integer
        Dim intCnt As Integer
        ...
        Try
            intErrNo = objOk.mtdGetDataCommon(strOpCd_EmpDiv, strParamName, strParamValue, objEmpCodeDs)
        Catch Exp As System.Exception
            Response.Write("/include/mesg/ErrorMessage.aspx?errcode=PR_PR_TRX_KTN_PN_TEMP_UPDNEW&errmesg=" & Exp.Message & "&redirect=")
        End Try
    ...
    Sub PN_EmpByMdr_Clear()
        Dim strOpCd As String = "PR_PR_TRX_KTN_PN_TEMP_CLEAR"
        Dim strParamName As String
        Dim strParamValue As String
        Dim intErrNo As Integer
        ...
        Try
            ...
            dgPN.DataBind()
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=PR_PR_TRX_KTN_PN_TEMP_CLEAR&errmesg=" & Exp.Message & "&redirect=")
        End Try
    End Sub

    Sub PNSUM_Clear()
        Dim strOpCd As String = "PR_PR_TRX_KTN_PNSUM_TEMP_CLEAR"
        Dim strParamName As String
        Dim strParamValue As String
        Dim intErrNo As Integer
        ...
        Try
            ...
            dgPNSUM.DataBind()
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=PR_PR_TRX_KTN_PNSUM_TEMP_CLEAR&errmesg=" & Exp.Message & "&redirect=")
        End Try
    End Sub
...
#Region "Binding BOR"
    ...
    Protected Function dgBOR_Reload() As DataSet
        'load data
        Dim strOpCd_EmpDiv As String = "PR_PR_TRX_KTN_BO_TEMP_UPDGET"
        Dim strParamName As String
        Dim strParamValue As String
        Dim objEmpCodeDs As New Object()
        Dim sc As String
        ...
        Try
            intErrNo = objOk.mtdGetDataCommon(strOpCd_EmpDiv, strParamName, strParamValue, objEmpCodeDs)
        Catch Exp As System.Exception
            Response.Write("/include/mesg/ErrorMessage.aspx?errcode=PR_PR_TRX_KTN_BO_TEMP_UPDGET&errmesg=" & Exp.Message & "&redirect=")
        End Try
    ...
    Protected Function BOR_EmpByMdr(ByVal mc As String, ByVal dt As String) As DataSet
        Dim strOpCd_EmpDiv As String = "PR_PR_TRX_KTN_BO_TEMP_UPDNEW"
        Dim strParamName As String
        Dim strParamValue As String
        Dim intErrNo As Integer
        Dim intCnt As Integer
        ...
        Try
            intErrNo = objOk.mtdGetDataCommon(strOpCd_EmpDiv, strParamName, strParamValue, objEmpCodeDs)
        Catch Exp As System.Exception
            Response.Write("/include/mesg/ErrorMessage.aspx?errcode=PR_PR_TRX_KTN_BO_TEMP_UPDNEW&errmesg=" & Exp.Message & "&redirect=")
        End Try
    ...
    Sub BOR_EmpByMdr_Clear()
        Dim strOpCd As String = "PR_PR_TRX_KTN_BO_TEMP_CLEAR"
        Dim strParamName As String
        Dim strParamValue As String
        Dim intErrNo As Integer
        ...
        Try
            ...
            dgBOR.DataBind()
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=PR_PR_TRX_KTN_BO_TEMP_CLEAR&errmesg=" & Exp.Message & "&redirect=")
        End Try
    End Sub

    Sub BOR_Pekerjaan(ByVal cat As String, ByVal subcat As String)
        Dim strOpCd_EmpDiv As String = "PR_PR_TRX_KTN_JOB_BOR_LIST"
        Dim strParamName As String
        Dim strParamValue As String
        Dim intErrNo As Integer
        Dim intCnt As Integer
        ...
        Try
            intErrNo = objOk.mtdGetDataCommon(strOpCd_EmpDiv, strParamName, strParamValue, objEmpCodeDs)
        Catch Exp As System.Exception
            Response.Write("/include/mesg/ErrorMessage.aspx?errcode=PR_PR_TRX_KTN_JOB_BOR_LIST&errmesg=" & Exp.Message & "&redirect=")
        End Try
...
#Region "Binding TR"
    ...
    Protected Function dgTRX_Reload() As DataSet
        'load data
        Dim strOpCd_EmpDiv As String = "PR_PR_TRX_KTN_TR_TEMP_UPDGET"
        Dim strParamName As String
        Dim strParamValue As String
        Dim objEmpCodeDs As New Object()
        Dim sc As String
        ...
        Try
            intErrNo = objOk.mtdGetDataCommon(strOpCd_EmpDiv, strParamName, strParamValue, objEmpCodeDs)
        Catch Exp As System.Exception
            Response.Write("/include/mesg/ErrorMessage.aspx?errcode=PR_PR_TRX_KTN_TR_TEMP_UPDGET&errmesg=" & Exp.Message & "&redirect=")
        End Try
    ...
    Sub TRX_EmpByMdr_Clear()
        Dim strOpCd As String = "PR_PR_TRX_KTN_TR_TEMP_CLEAR"
        Dim strParamName As String
        Dim strParamValue As String
        Dim intErrNo As Integer
        ...
        Try
            ...
            dgTRX.DataBind()
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=PR_PR_TRX_KTN_TR_TEMP_CLEAR&errmesg=" & Exp.Message & "&redirect=")
        End Try
    End Sub
    ...
    Sub TRX_EmpByMdr(ByVal mc As String, ByVal dt As String)
        Dim strOpCd_EmpDiv As String = "PR_PR_TRX_KTN_TR_TEMP_EMP"
        Dim strParamName As String
        Dim strParamValue As String
        Dim intErrNo As Integer
        Dim intCnt As Integer
        ...
        Try
            intErrNo = objOk.mtdGetDataCommon(strOpCd_EmpDiv, strParamName, strParamValue, objEmpCodeDs)
        Catch Exp As System.Exception
            Response.Write("/include/mesg/ErrorMessage.aspx?errcode=PR_PR_TRX_KTN_TR_TEMP_EMP&errmesg=" & Exp.Message & "&redirect=")
        End Try
...
#Region "Event HKJ"
    ...
    Sub HKJ_RWT_onLoad_Display(ByVal bkmcode As String)
        Dim strOpCd As String = "PR_PR_TRX_KTNLN_MJOB_LOAD"
        Dim strParamName As String
        Dim strParamValue As String
        Dim intErrNo As Integer
        ...
        Try
            intErrNo = objOk.mtdInsertDataCommon(strOpCd, strParamName, strParamValue)
        Catch Exp As System.Exception
            Response.Write("/include/mesg/ErrorMessage.aspx?errcode=PR_PR_TRX_KTNLN_MJOB_LOAD&errmesg=" & Exp.Message & "&redirect=HR/trx/HR_trx_EmployeeList_Estate.aspx")
        End Try
    ...
    Sub dgHKJ_RWT_Delete(ByVal jb As String, ByVal cb As String)
        Dim strOpCd As String = "PR_PR_TRX_KTN_MJOB_TEMP_DEL"
        Dim strParamName As String
        Dim strParamValue As String
        Dim intErrNo As Integer
        ...
        Try
            intErrNo = objOk.mtdInsertDataCommon(strOpCd, strParamName, strParamValue)
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=PR_PR_TRX_KTN_MJOB_TEMP_DEL&errmesg=" & Exp.Message & "&redirect=")
        End Try
    ...
    Sub HKJ_RWT_add_onClick(ByVal Sender As Object, ByVal E As ImageClickEventArgs)
        Dim strOpCd_Del As String = "PR_PR_TRX_KTN_MJOB_TEMP_CLEAR"
        Dim strOpCd_Upd As String = "PR_PR_TRX_KTN_MJOB_TEMP_UPDADD"
        Dim hid_id As HiddenField
        Dim ddl_jb As DropDownList
        Dim lbl_nr As Label
        Dim ddl_cb As DropDownList
        ...
        Try
            intErrNo = objOk.mtdInsertDataCommon(strOpCd_Del, ParamName, ParamValue)
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=PR_PR_TRX_KTN_MJOB_TEMP_CLEAR&errmesg=" & Exp.Message & "&redirect=")
        End Try
        ...
        For i = 0 To dgHKJ_RWT.Items.Count - 1
            ...
            Try
                intErrNo = objOk.mtdInsertDataCommon(strOpCd_Upd, ParamName, ParamValue)
            Catch Exp As System.Exception
                Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=PR_PR_TRX_KTN_MJOB_TEMP_UPDADD&errmesg=" & Exp.Message & "&redirect=")
            End Try
    ...
    Sub HKJ_RWT_gen_onClick(ByVal Sender As Object, ByVal E As ImageClickEventArgs)
        ...
        Dim strOpCd_Del As String = "PR_PR_TRX_KTN_MJOB_TEMP_CLEAR"
        Dim strOpCd_Upd As String = "PR_PR_TRX_KTN_MJOB_TEMP_UPDADD"
        Dim strOpCd_Gen As String = "PR_PR_TRX_KTN_MJOB_TEMP_GEN"
        ...
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=PR_PR_TRX_KTN_MJOB_TEMP_GEN&errmesg=" & Exp.Message & "&redirect=")
        End Try
    ...
    Sub HKJ_BHN_onLoad_Display(ByVal bkmcode As String)
        Dim strOpCd As String = "PR_PR_TRX_KTNLN_MBHN_LOAD"
        Dim strParamName As String
        Dim strParamValue As String
        Dim intErrNo As Integer
        ...
        Try
            intErrNo = objOk.mtdInsertDataCommon(strOpCd, strParamName, strParamValue)
        Catch Exp As System.Exception
            Response.Write("/include/mesg/ErrorMessage.aspx?errcode=PR_PR_TRX_KTNLN_MBHN_LOAD&errmesg=" & Exp.Message & "&redirect=HR/trx/HR_trx_EmployeeList_Estate.aspx")
        End Try
    ...
    Sub HKJ_BHN_add_onClick(ByVal Sender As Object, ByVal E As ImageClickEventArgs)
        ' save dulu
        Dim strOpCd_del As String = "PR_PR_TRX_KTN_MBHN_TEMP_CLEAR"
        Dim strOpCd_Upd As String = "PR_PR_TRX_KTN_MBHN_TEMP_UPDADD"
        Dim ddl_jb As DropDownList
        ...
        For i = 0 To dgHKJ_BHN.Items.Count - 1
            ...
            If (ddl_jb.Text.Trim <> "") And (ddl_cb.Text.Trim <> "") And (ddl_ci.Text.Trim <> "") Then
                ...
                Catch Exp As System.Exception
                    Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=PR_PR_TRX_KTN_MBHN_TEMP_UPDADD&errmesg=" & Exp.Message & "&redirect=")
                End Try
            End If
    ...
    Sub HKJ_BHN_gen_onClick(ByVal Sender As Object, ByVal E As ImageClickEventArgs)
        ...
        Dim strOpCd_del As String = "PR_PR_TRX_KTN_MBHN_TEMP_CLEAR"
        Dim strOpCd_Upd As String = "PR_PR_TRX_KTN_MBHN_TEMP_UPDADD"
        Dim strOpCd_Gen As String = "PR_PR_TRX_KTN_MBHN_TEMP_GEN"
        ...
        Try
            intErrNo = objOk.mtdInsertDataCommon(strOpCd_Gen, ParamName, ParamValue)
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=PR_PR_TRX_KTN_MBHN_TEMP_GEN&errmesg=" & Exp.Message & "&redirect=")
        End Try
    ...
    Sub HKJ_BHN_Delete(ByVal id As String, ByVal jb As String, ByVal cb As String, ByVal ci As String)
        Dim strOpCd As String = "PR_PR_TRX_KTN_MBHN_TEMP_DEL"
        Dim strParamName As String
        Dim strParamValue As String
        Dim intErrNo As Integer
        ...
        Try
            intErrNo = objOk.mtdInsertDataCommon(strOpCd, strParamName, strParamValue)
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=PR_PR_TRX_KTN_MBHN_TEMP_DEL&errmesg=" & Exp.Message & "&redirect=")
        End Try
    End Sub
...
#Region "Event RWT"
    ...
    Sub RW_onLoad_Display(ByVal bkmcode As String)
        ...
        Try
            intErrNo = objOk.mtdInsertDataCommon(strOpCd, strParamName, strParamValue)
        Catch Exp As System.Exception
            Response.Write("/include/mesg/ErrorMessage.aspx?errcode=PR_PR_TRX_KTNLN_RW_LOAD&errmesg=" & Exp.Message & "&redirect=HR/trx/HR_trx_EmployeeList_Estate.aspx")
        End Try
    ...
    Sub RW_add_onClick(ByVal Sender As Object, ByVal E As ImageClickEventArgs)
        ...
        Try
            intErrNo = objOk.mtdInsertDataCommon(strOpCd_Upd, ParamName, ParamValue)
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=PR_PR_TRX_KTN_RW_TEMP_UPDADD&errmesg=" & Exp.Message & "&redirect=")
        End Try
    ...
    Sub dgRW_Delete(ByVal id As String, ByVal ec As String)
        ...
        Try
            intErrNo = objOk.mtdInsertDataCommon(strOpCd, strParamName, strParamValue)
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=PR_PR_TRX_KTN_RW_TEMP_DEL&errmesg=" & Exp.Message & "&redirect=")
        End Try
    End Sub
...
#Region "Event BHN"
    ...
    Sub BHN_onLoad_Display(ByVal bkmcode As String)
        ...
        Try
            intErrNo = objOk.mtdInsertDataCommon(strOpCd, strParamName, strParamValue)
        Catch Exp As System.Exception
            Response.Write("/include/mesg/ErrorMessage.aspx?errcode=PR_PR_TRX_KTNLN_BHN_LOAD&errmesg=" & Exp.Message & "&redirect=HR/trx/HR_trx_EmployeeList_Estate.aspx")
        End Try
    ...
    Sub BHN_Delete(ByVal id As String)
        Dim strOpCd As String = "PR_PR_TRX_KTN_BHN_TEMP_DEL"
        Dim strParamName As String
        Dim strParamValue As String
        Dim intErrNo As Integer
        ...
        Try
            intErrNo = objOk.mtdInsertDataCommon(strOpCd, strParamName, strParamValue)
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=PR_PR_TRX_KTN_BHN_TEMP_DEL&errmesg=" & Exp.Message & "&redirect=")
        End Try
    End Sub
...
#Region "Event PN"
    ...
    Sub PN_onLoad_Display(ByVal bkmcode As String)
        Dim strOpCd As String = "PR_PR_TRX_KTNLN_PN_LOAD"
        Dim strParamName As String
        Dim strParamValue As String
        Dim intErrNo As Integer
        ...
        Try
            intErrNo = objOk.mtdInsertDataCommon(strOpCd, strParamName, strParamValue)
        Catch Exp As System.Exception
            Response.Write("/include/mesg/ErrorMessage.aspx?errcode=PR_PR_TRX_KTNLN_PN_LOAD&errmesg=" & Exp.Message & "&redirect=")
        End Try

    End Sub

    Sub PNSUM_onLoad_Display(ByVal bkmcode As String)
        Dim strOpCd As String = "PR_PR_TRX_KTNLN_PNSUM_LOAD"
        Dim strParamName As String
        Dim strParamValue As String
        Dim intErrNo As Integer
        ...
        Try
            intErrNo = objOk.mtdInsertDataCommon(strOpCd, strParamName, strParamValue)
        Catch Exp As System.Exception
            Response.Write("/include/mesg/ErrorMessage.aspx?errcode=PR_PR_TRX_KTNLN_PNSUM_LOAD&errmesg=" & Exp.Message & "&redirect=")
        End Try
    ...
    Sub PN_update()
        Dim strOpCd As String = "PR_PR_TRX_KTN_PN_TEMP_CLEAR"
        Dim strOpCd_Upd As String = "PR_PR_TRX_KTN_PN_TEMP_UPDADD"
        Dim ddl_cb As DropDownList
        Dim ddl_ssc As DropDownList
        Dim hid_ec As HiddenField
        ...
        For i = 0 To dgPN.Items.Count - 1
            ...
            Try
                intErrNo = objOk.mtdInsertDataCommon(strOpCd_Upd, ParamName, ParamValue)
            Catch Exp As System.Exception
                Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=PR_PR_TRX_KTN_PN_TEMP_UPDADD&errmesg=" & Exp.Message & "&redirect=")
            End Try
        Next
    End Sub
    ...
    Sub PNSUM_update()
        Dim strOpCd As String = "PR_PR_TRX_KTN_PNSUM_TEMP_CLEAR"
        Dim strOpCd_Upd As String = "PR_PR_TRX_KTN_PNSUM_TEMP_UPDADD"
        ...
        For i = 0 To dgPNSUM.Items.Count - 1
            ...
            If txt_ha.Text.Trim <> "" Then
                ...
                Try
                    intErrNo = objOk.mtdInsertDataCommon(strOpCd_Upd, ParamName, ParamValue)
                Catch Exp As System.Exception
                    Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=PR_PR_TRX_KTN_PNSUM_TEMP_UPDADD&errmesg=" & Exp.Message & "&redirect=")
                End Try
            End If
    ...
    Sub dgPN_Delete(ByVal id As String, ByVal ec As String)
        Dim strOpCd As String = "PR_PR_TRX_KTN_PN_TEMP_DEL"
        Dim strParamName As String
        Dim strParamValue As String
        Dim intErrNo As Integer
        strParamName = "IP|UI|LOC|ID|EC"
...
#Region "Event BOR"
    ...
    Sub BOR_onLoad_Display(ByVal bkmcode As String)
        Dim strOpCd As String = "PR_PR_TRX_KTNLN_BO_LOAD"
        Dim strParamName As String
        Dim strParamValue As String
        Dim intErrNo As Integer
        ...
        Try
            intErrNo = objOk.mtdInsertDataCommon(strOpCd, strParamName, strParamValue)
        Catch Exp As System.Exception
            Response.Write("/include/mesg/ErrorMessage.aspx?errcode=PR_PR_TRX_KTNLN_BO_LOAD&errmesg=" & Exp.Message & "&redirect=HR/trx/HR_trx_EmployeeList_Estate.aspx")
        End Try
    ...
    Sub BOR_add_onClick(ByVal Sender As Object, ByVal E As ImageClickEventArgs)
        ...
        BOR_update()
        ' save dulu
        Dim strOpCd_Upd As String = "PR_PR_TRX_KTN_BO_TEMP_UPDADD"
        Dim ec As String = ""
        Dim ed As String = ""
        ...
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=PR_PR_TRX_KTN_BO_TEMP_UPDADD&errmesg=" & Exp.Message & "&redirect=")
        End Try
    ...
    Sub dgBOR_Delete(ByVal id As String, ByVal ec As String)
        Dim strOpCd As String = "PR_PR_TRX_KTN_BO_TEMP_DEL"
        Dim strParamName As String
        Dim strParamValue As String
        Dim intErrNo As Integer
        strParamName = "IP|UI|LOC|ID|EC"
        ...
        Try
            intErrNo = objOk.mtdInsertDataCommon(strOpCd, strParamName, strParamValue)
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=PR_PR_TRX_KTN_BO_TEMP_DEL&errmesg=" & Exp.Message & "&redirect=")
        End Try
    End Sub
...
#Region "Event TR"
    Sub TRX_onLoad_Display(ByVal bkmcode As String)
        Dim strOpCd As String = "PR_PR_TRX_KTNLN_TR_LOAD"
        Dim strParamName As String
        Dim strParamValue As String
        Dim intErrNo As Integer
        ...
        Try
            intErrNo = objOk.mtdInsertDataCommon(strOpCd, strParamName, strParamValue)
        Catch Exp As System.Exception
            Response.Write("/include/mesg/ErrorMessage.aspx?errcode=PR_PR_TRX_KTNLN_TR_LOAD&errmesg=" & Exp.Message & "&redirect=HR/trx/HR_trx_EmployeeList_Estate.aspx")
        End Try
    ...
    Sub TRX_add_onClick(ByVal Sender As Object, ByVal E As ImageClickEventArgs)
        If TRX_src_ddl_jb.Text <> "" Then
            ...
            If TRX_src_ddl_jb.SelectedItem.Value.Trim <> "" Then
                ...
                Dim strOpCd_Upd As String = "PR_PR_TRX_KTN_TR_TEMP_UPDADD"
                Dim i As Integer
                Dim ParamName As String
                Dim ParamValue As String
                Dim intErrNo As Integer
                ...
                Try
                    intErrNo = objOk.mtdInsertDataCommon(strOpCd_Upd, ParamName, ParamValue)
                Catch Exp As System.Exception
                    Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=PR_PR_TRX_KTN_TR_TEMP_UPDADD&errmesg=" & Exp.Message & "&redirect=")
                End Try
    ...
    Sub dgTRX_Delete(ByVal id As String)
        Dim strOpCd As String = "PR_PR_TRX_KTN_TR_TEMP_DEL"
        Dim strParamName As String
        Dim strParamValue As String
        Dim intErrNo As Integer
        strParamName = "IP|UI|LOC|ID"
        ...
        Try
            intErrNo = objOk.mtdInsertDataCommon(strOpCd, strParamName, strParamValue)
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=PR_PR_TRX_KTN_TR_TEMP_DEL&errmesg=" & Exp.Message & "&redirect=")
        End Try
    End Sub
    ...
    Sub BHNALL_add_onClick(ByVal Sender As Object, ByVal E As ImageClickEventArgs)
        If dgBHNALL_idd.Text.Trim <> "" Then
            If dgBHNALL_idd.SelectedItem.Value.Trim <> "" Then
                Dim strOpCd As String = "PR_PR_TRX_KTN_BHN_TEMP_CLEAR"
                Dim strOpCd_Upd As String = "PR_PR_TRX_KTN_BHN_TEMP_UPDADD"
                Dim i As Integer
                Dim ParamName As String
                Dim ParamValue As String
                Dim intErrNo As Integer
                ...
                For i = 0 To dgBHNALL.Items.Count - 1
                    ...
                    Try
                        intErrNo = objOk.mtdInsertDataCommon(strOpCd_Upd, ParamName, ParamValue)
                    Catch Exp As System.Exception
                        Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=PR_PR_TRX_KTN_BHN_TEMP_UPDADD&errmesg=" & Exp.Message & "&redirect=")
                    End Try
...
#End Region
    ...
    Sub CopyTR()
		Dim strOpCd_Up As String = "PR_PR_TRX_KTN_MAIN_GEN_TR"
        ...
        Catch ex As Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=PR_PR_TRX_KTN_MAIN_GEN_TR&errmesg=" & ex.ToString() & "&redirect=")
        End Try
