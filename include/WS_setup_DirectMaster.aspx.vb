...
Public Class WS_DirectMaster : Inherits Page
    ...
    Sub GetEntireLangCap()
        ...
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=WS_SETUP_DIRECTMASTER_GET_LANGCAP&errmesg=" & lblErrMessage.Text & "&redirect=ws/setup/wr_DirectMaster.aspx")
        End Try
    ...
    Protected Function LoadData() As DataSet
        ...
        Catch Exp As System.Exception
            Response.Redirect("../../../include/mesg/ErrorMessage.aspx?errcode=GET_DIRECTCHARGE_LIST&errmesg=" & lblErrMessage.Text & "&redirect=WS/Setup/WS_directcharge.aspx")
        End Try
        Return objDataSet
    End Function
