...
Public Class HR_Setup_Skill : Inherits Page
    ...
    Protected WithEvents srchSkillCode as TextBox
    ...
    Dim strOppCd_GET As String = "HR_CLSSETUP_SKILL_LIST_GET"
    Dim strOppCd_ADD As String = "HR_CLSSETUP_SKILL_LIST_ADD"
    Dim strOppCd_UPD As String = "HR_CLSSETUP_SKILL_LIST_UPD"
    ...
    Sub Page_Load(Sender As Object, E As EventArgs)
        ...
        ElseIf objAR.mtdHasAccessRights(objAR.mtdGetAccessRights(objAR.EnumHRAccessRights.HRSkill), intHRAR) = False Then
    ...
    Sub BindStatusList(index as integer) 
        ...
        StatusList.Items.Add(New ListItem(objHR.mtdGetSkillStatus(objHR.EnumSkillStatus.Active), objHR.EnumSkillStatus.Active))
        StatusList.Items.Add(New ListItem(objHR.mtdGetSkillStatus(objHR.EnumSkillStatus.Deleted), objHR.EnumSkillStatus.Deleted))

    End Sub 

    Sub BindSearchList() 

        srchStatusList.Items.Add(New ListItem(objHR.mtdGetSkillStatus(objHR.EnumSkillStatus.All), objHR.EnumSkillStatus.All))
        srchStatusList.Items.Add(New ListItem(objHR.mtdGetSkillStatus(objHR.EnumSkillStatus.Active), objHR.EnumSkillStatus.Active))
        srchStatusList.Items.Add(New ListItem(objHR.mtdGetSkillStatus(objHR.EnumSkillStatus.Deleted), objHR.EnumSkillStatus.Deleted))
    ...
    Protected Function LoadData() As DataSet
        ...
        SearchStr =  " AND SK.Status like '" & IIF(Not srchStatusList.selectedItem.Value = objHR.EnumSkillStatus.All, _
                       srchStatusList.selectedItem.Value, "%" ) &"' "
        If NOT srchSkillCode.text = "" Then
            SearchStr =  SearchStr & " AND SK.SkillCode like '" & srchSkillCode.text &"%' "
        End If
        If NOT srchDesc.text = "" Then
            SearchStr = SearchStr & " AND SK.Description like '" & _
                        srchDesc.text &"%' "
        End If
        ...
        Try
        intErrNo = objHR.mtdGetMasterList(strOppCd_GET, strParam, objHR.EnumHRMasterType.Skill, objDataSet)
        Catch Exp As System.Exception
            Response.Redirect("../../../include/mesg/ErrorMessage.aspx?errcode=HR_SKILL_GET_LIST&errmesg=" & lblErrMessage.Text & "&redirect=")
        End Try
        Return objDataSet
    End Function
    ...
    Sub DEDR_Edit(Sender As Object, E As DataGridCommandEventArgs)
        ...
        Select Case cint(Edittext.text) = objHR.EnumSkillStatus.Active
            Case True
                Statuslist.selectedindex = 0
                EditText = EventData.Items.Item(CInt(e.Item.ItemIndex)).FindControl("SkillCode")
    ...
    Sub DEDR_Update(Sender As Object, E As DataGridCommandEventArgs)
        ...
        EditText = E.Item.FindControl("SkillCode")
        SkillCode = EditText.Text
        ...
        intErrNo = objHR.mtdUpdMasterList(strOppCd_ADD, _
                                          ...
                                          strUserId, _
                                          strParam, _
                                          objHR.EnumHRMasterType.Skill, _
                                          blnDupKey, _
                                          blnUpdate.text)
        Catch Exp As System.Exception
            Response.Redirect("../../../include/mesg/ErrorMessage.aspx?errcode=HR_SETUP_UPDATE_SKILL&errmesg=" & lblErrMessage.Text & "&redirect=HR/Setup/HR_setup_Skill.aspx")
        End Try
    ...
    Sub DEDR_Delete(Sender As Object, E As DataGridCommandEventArgs)
        ...
        Status = IIF(EditText.Text = objHR.EnumSkillStatus.Active, _
                                    objHR.EnumSkillStatus.Deleted, _
                                    objHR.EnumSkillStatus.Active )
        EditText = E.Item.FindControl("CreateDate")
        CreateDate = EditText.Text
        strParam =  SkillCode & "|" & _
                    Description & "|" & _
        ...
        intErrNo = objHR.mtdUpdMasterList(strOppCd_ADD, _
                                          ...
                                          blnUpdate.text)
        Catch Exp As System.Exception
            Response.Redirect("../../../include/mesg/ErrorMessage.aspx?errcode=HR_SETUP_DELETE_SKILL&errmesg=" & lblErrMessage.Text & "&redirect=HR/Setup/HR_setup_Skill.aspx")
        End Try
