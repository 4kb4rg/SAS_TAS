...
Public Class FA_Rpt_AssetMaster : inherits page
    ...
    Sub Bind_ITEM(ByVal blnIsPDFFormat As Boolean)
        ...
        strSearch = "AND ItemType = '" & objInventory.EnumInventoryItemType.FixedAssetItem & "' AND itm.Status like  '" & IIf(Not strStatus = "", strStatus, "%") & "' "
        ...
        rdCrystalViewer.Load(objMapPath & "Web\EN\FA\Reports\Crystal\FA_Rpt_AssetMaster.rpt", OpenReportMethod.OpenReportByTempCopy)
        ...
        Else
            ...
            DiskOpts.DiskFileName = objMapPath & "web\ftp\FA_Rpt_AssetMaster.pdf"
            rdCrystalViewer.ExportOptions.DestinationOptions = DiskOpts
            rdCrystalViewer.Export()

            Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../../ftp/FA_Rpt_AssetMaster.pdf"">")
        End If
