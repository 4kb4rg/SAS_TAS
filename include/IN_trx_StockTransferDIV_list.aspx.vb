...
Public Class IN_TransferDIV : Inherits Page
    ...
    Dim strOppCd_GET As String = "IN_CLSTRX_STOCKTRANSFERDIV_LIST_GET"
    ...
    Protected Function LoadData() As DataSet
        ...
        If srchStatusList.SelectedItem.Value = 9 Then
            StrStatus = "ALL"
        End If
        strParamName = "LOC|TAHUN|BULAN|TRANSID|DESC|STATUS"
        strParamValue = strLocation & "|" & strAccYear & "|" & strAccMonth & "|" & srchStockTxID.Text & "|" & srchDesc.Text & "|" & StrStatus
    ...
    Sub btnNewItm_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        Response.Redirect("../../IN/Trx/IN_trx_StockTransferDiv_details.aspx")
    End Sub
