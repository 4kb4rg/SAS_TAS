...
Public Class PU_data_upload : Inherits Page
    ...
    Sub UploadBtn_Click(Sender As Object, E As ImageClickEventArgs)
        ...
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=PU_GET_FTPPATH&errmesg=" & lblErrMesage.Text & "&redirect=pu/data/pu_data_upload.aspx")
        End Try        
        ...
        If objGlobal.mtdValidateUploadFileName(strZipName, objGlobal.EnumDataTransferFileType.PU_PurchasingReferenceData, strErrMsg) = False Then
        ...
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=PU_SAVEAS&errmesg=" & lblErrUpload.Text & "&redirect=pu/data/pu_data_upload.aspx")
        End Try
        ...
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=PU_DECRYPT_REF&errmesg=" & lblErrMesage.Text & "&redirect=pu/data/pu_data_upload.aspx")
        End Try
        ...
        Try
            intErrNo = objPUData.mtdUploadRef(strXmlPath)
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=PU_UPLOAD_REF&errmesg=" & lblErrMesage.Text & "&redirect=pu/data/pu_data_upload.aspx")
        End Try
