...
Public Class IN_Rpt_StockAnalysis : inherits page
    ...
    Public Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        strStockAnaCode = Trim(Request.QueryString("strStockAnaCode"))
        ...
        StockAnaCodeTag = Trim(Request.QueryString("StockAnaCodeTag"))
        StockAnaDescTag = Trim(Request.QueryString("StockAnaDescTag"))
    ...
    Sub Bind_ITEM(ByVal blnIsPDFFormat As Boolean)
        ...
        Dim strOpCd As String = "IN_CLSSETUP_STOCKANA_LIST_GET_FOR_REPORT"
        ...
        strSearch =  " AND StockAna.Status like '" & IIF(Not strStatus = "", strStatus, "%" ) &"' "

        If NOT strStockAnaCode = "" Then
            strSearch =  strSearch & " AND StockAna.StockAnalysisCode like '" & strStockAnaCode & "%' "
        End If
        
        If NOT strDescription = "" Then
            strSearch = strSearch & " AND StockAna.Description like '" & strDescription &"%' "
        End If
        ...
        Try
            intErrNo = objInventory.mtdGetMasterList(strOpCd, _
                                                     strParam, _
                                                     EnumInventoryMasterType.StockAnalysis, _
                                                     objRptDs)
        ...
        For intCnt=0 To objRptDs.Tables(0).Rows.Count - 1
            objRptDs.Tables(0).Rows(intCnt).Item("Status") = objInventory.mtdGetStockAnalysisStatus(objRptDs.Tables(0).Rows(intCnt).Item("Status"))
        ...
        rdCrystalViewer.Load(objMapPath & "Web\EN\IN\Reports\Crystal\In_Rpt_StockAnalysis.rpt", OpenReportMethod.OpenReportByTempCopy)
        ...
        Else
            ...
            DiskOpts.DiskFileName = objMapPath & "web\ftp\In_Rpt_StockAnalysis.pdf"
            rdCrystalViewer.ExportOptions.DestinationOptions = DiskOpts
            rdCrystalViewer.Export()

            Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../../ftp/In_Rpt_StockAnalysis.pdf"">")
        End If
    ...
    Sub PassParam()
        ...
        paramField2 = ParamFields.Item("StockAnaCodeTag")
        paramField3 = ParamFields.Item("StockAnaDescTag")
        ...
        ParamDiscreteValue2.value = StockAnaCodeTag
        ParamDiscreteValue3.value = StockAnaDescTag
