...
Public Class PR_StdRpt_LPBKSPreview_Estate : Inherits Page
    ...
    Sub BindReport()
        ...
        If Not isMandor Then
            strOpCd = "PR_PR_STDRPT_LPBKS_REPORT_DIVISI"
            fname = "PR_StdRpt_LPBKS_Estate_Divisi"
            ...
            Try
                ...
                objRpt.Tables(0).TableName = "PR_StdRpt_LPBKS_Divisi"
                'objRpt.Tables(1).TableName = "PR_StdRpt_LHPT_JobSumary"
            Catch Exp As System.Exception
                Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=PR_PR_STDRPT_LPBKS_REPORT_DIVISI&errmesg=" & lblErrMessage.Text & "&redirect=")
            End Try

            objRptDs.Tables.Add(objRpt.Tables(0).Copy())
            objRptDs.Tables(0).TableName = "PR_StdRpt_LPBKS_Divisi"
            'objRptDs.Tables.Add(objRpt.Tables(1).Copy())
            'objRptDs.Tables(1).TableName = "PR_StdRpt_LHPT_JobSumary"
           
        Else
            strOpCd = "PR_PR_STDRPT_LPBKS_REPORT_MANDOR"
            fname = "PR_StdRpt_LPBKS_Estate_Divisi"
