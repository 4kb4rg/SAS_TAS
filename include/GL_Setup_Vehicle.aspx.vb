...
Public Class GL_Setup_Vehicle : Inherits Page
    ...
    Protected Function LoadData() As DataSet
        ...
        Dim strOpCd_GET As String = "GL_CLSSETUP_VEHICLE_LIST_GET"
        ...
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=GL_SETUP_VEHICLE_LIST_GET&errmesg=" & lblErrMessage.Text & "&redirect=")
        End Try
    ...
    Sub NewTBBtn_Click(ByVal Sender As Object, ByVal E As ImageClickEventArgs)
        Response.Redirect("GL_Setup_VehicleDet.aspx")
    End Sub
