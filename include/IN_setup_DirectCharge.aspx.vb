...
Public Class IN_DirectCharge : Inherits Page
    ...
    Sub GetEntireLangCap()
        ...
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=PWSYSTEM_CLSLANGCAP_BUSSTERM_GET&errmesg=" & lblErrMessage.Text & "&redirect=IN/setup/IN_setup_DirectCharge.aspx")
        End Try
    ...
    Protected Function LoadData() As DataSet
        ...
        SearchStr = " AND Loccode = '" & strLocation & "' AND ItemType = '" & objIN.EnumInventoryItemType.DirectCharge & "' AND itm.Status like '" & IIf(Not srchStatusList.SelectedItem.Value = objIN.EnumStockItemStatus.All, _
    ...
    Sub btnPreview_Click (sender As Object, e As ImageClickEventArgs)
        ...
        Response.Write("<Script Language=""JavaScript"">window.open(""../reports/IN_Rpt_DirectCharge.aspx?strDCCodeTag=" & strDCCodeTag & _
