...
Public Class WS_data_download : Inherits Page
    ...
    Protected WithEvents cbWorkshopItem As CheckBox
    Protected WithEvents cbDirectChargeItem As CheckBox
    Protected WithEvents cbItemPart As CheckBox 
    Protected WithEvents cbWorkCode As CheckBox
    ...
    Sub btnGenerate_Click(Sender As Object, E As ImageClickEventArgs)
        ...
        If cbWorkCode.Checked Then strParam = strParam & "cbWorkCode"
        If cbItemPart.Checked Then strParam = strParam & "cbItemPart" 
        ...
        Else
            strQuery = "prodtype=" & cbProdType.Checked & "&" & _
                    ...
                    "workcode=" & cbWorkCode.Checked & "&" & _
                    "itempart=" & cbItemPart.Checked 
            Response.Redirect("WS_data_download_savefile.aspx?" & strQuery)
        End If
