...
Public Class popUpRemainLifeTimeScreen : Inherits Page
    ...
    Protected Function LoadData() As DataSet
        ...
        nItemParameter = 0
        nItemParameter = objItemDs.Tables(0).Rows(0).Item("SetMinPopUp")
        lblHead.Text = "Remaining Life Time Sparepart < " & nItemParameter & " Hours"
        Return objItemDs
    ...
    Sub btnPreview_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        Response.Write("<Script Language=""JavaScript"">window.open(""PopUpRemainLifeTimeScreenListPreview.aspx?Type=Print&CompName=" & strCompany & "&Location=" & strUserLoc & "&RptID=" & strRptID & "&RptName=" & strRptName & _
