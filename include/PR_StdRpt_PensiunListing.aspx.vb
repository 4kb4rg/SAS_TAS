...
Public Class PR_StdRpt_PensiunListing : Inherits Page
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        Dim strTransferInd As String = IIF(cbExcel.Checked,"1","0")
        ...
        End If
            ...
            Response.Write("<Script Language=""JavaScript"">window.open(""PR_StdRpt_PensiunPreview.aspx?CompCode=" & strCompany & "&Location=" & strUserLoc & "&RptID=" & strRptID & "&RptName=" & strRptName & "&Decimal=" & strDec & _
                       "&lblLocation=" & lblLocation.Text & "&SelAccMonthFrom=" & strAccMonthFrom & "&SelAccYearFrom=" & strAccYearFrom & "&SelAccMonthTo=" & strAccMonthTo & "&SelAccYearTo=" & strAccYearTo & "&TransferInd=" & strTransferInd & """,null ,""status=yes, resizable=yes, scrollbars=yes, toolbar=no, location=no"");</Script>")
    End Sub
    ...
    Function BindAccYearToList(ByVal pv_strLocation As String, _
        ...
        Return intMaxPeriod
    End Function
    Sub OnChecked_Transfer(ByVal sender As Object, ByVal e As System.EventArgs)
        If cbExcel.Checked = False Then
            PrintPrev.AlternateText = "Print Preview"
            PrintPrev.ImageUrl = "../images/butt_print_preview.gif"
        ElseIf cbExcel.Checked = True Then
            PrintPrev.AlternateText = "Generate"
            PrintPrev.ImageUrl = "../images/butt_generate.gif"
        End If
    End Sub
