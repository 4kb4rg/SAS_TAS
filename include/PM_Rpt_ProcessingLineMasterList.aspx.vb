...
Public Class PM_Rpt_ProcessingLineMasterList : inherits page
    ...
    Public Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        strProcessingLineNo = Trim(Request.QueryString("strProcessingLineNo"))
        ...
        ProcessingLineNoTag = Trim(Request.QueryString("ProcessingLineNoTag"))
    ...
    Sub Bind_ITEM(ByVal blnIsPDFFormat As Boolean)
        ...
        Dim strOpCd As String = "PM_CLSSETUP_PROCESSINGLINE_GET"
        ...
        strSearch =  " AND PL.Status like '" & IIF(Not strStatus = "", strStatus, "%" ) & "' AND PL.LocCode='" & strLocation & "'"

        If NOT strProcessingLineNo = "" Then
            strSearch =  strSearch & " AND PL.ProcessingLnNo like '" & strProcessingLineNo & "%' "
        End If
        ...
        Try
            intErrNo = objPM.mtdGetProcessingLine(strOpCd, strParam, objRptDs)
        ...
        For intCnt=0 To objRptDs.Tables(0).Rows.Count - 1
            objRptDs.Tables(0).Rows(intCnt).Item("Status") = objPM.mtdGetProcessingLineStatus(objRptDs.Tables(0).Rows(intCnt).Item("Status"))
            objRptDs.Tables(0).Rows(intCnt).Item("UpdateDate") = objGlobal.GetLongDate(objRptDs.Tables(0).Rows(intCnt).Item("UpdateDate"))
        Next

        rdCrystalViewer.Load(objMapPath & "Web\EN\PM\Reports\Crystal\PM_Rpt_ProcessingLineMasterList.rpt", OpenReportMethod.OpenReportByTempCopy)
        ...
        Else
            ...
            DiskOpts.DiskFileName = objMapPath & "web\ftp\PM_Rpt_ProcessingLineMasterList.pdf"
            rdCrystalViewer.ExportOptions.DestinationOptions = DiskOpts
            rdCrystalViewer.Export()

            Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../../ftp/PM_Rpt_ProcessingLineMasterList.pdf"">")
        End If
    ...
    Sub PassParam()
        ...
        paramField4 = ParamFields.Item("ProcessingLineNoTag")
        ...
        ParamDiscreteValue4.value = ProcessingLineNoTag
