...
Public Class GL_RunningHour_List : Inherits Page
    ...
    Protected WithEvents srchRunHourID As TextBox
    Protected WithEvents srchTrxDate As TextBox
    ...
    Sub Page_Load(ByVal Sender As Object, ByVal E As EventArgs)
        ...
        Else
            ...
            If SortExpression.Text = "" Then
                SortExpression.Text = "RH.RunHourID"
            End If
    ...
    Sub onload_GetLangCap()
        ...
        'lblBlkCode.Text = GetCaption(objLangCap.EnumLangCap.Block) & "/" & GetCaption(objLangCap.EnumLangCap.SubBlock) & " Code"

        'dgTx.Columns(2).HeaderText = lblBlkCode.Text
        'dgTx.Columns(3).HeaderText = GetCaption(objLangCap.EnumLangCap.Block) & "/" & GetCaption(objLangCap.EnumLangCap.SubBlock) & " Description"
    ...
    End Sub
    Sub BindSearchList()
        srchStatusList.Items.Add(New ListItem(objGLtx.mtdGetRunningHourStatus(objGLtx.EnumRunningHourStatus.All), objGLtx.EnumRunningHourStatus.All))
        srchStatusList.Items.Add(New ListItem(objGLtx.mtdGetRunningHourStatus(objGLtx.EnumRunningHourStatus.Active), objGLtx.EnumRunningHourStatus.Active))
        srchStatusList.Items.Add(New ListItem(objGLtx.mtdGetRunningHourStatus(objGLtx.EnumRunningHourStatus.Cancelled), objGLtx.EnumRunningHourStatus.Cancelled))
    ...
    Protected Function LoadData() As DataSet
        Dim strOppCd_GET As String = "GL_CLSTRX_RUNNINGHOUR_LIST_GET"
        Dim strRunHourID As String
        ...
        strRunHourID = IIf(srchRunHourID.Text = "", "", srchRunHourID.Text)
        strBlkCode = IIf(srchBlkCode.Text = "", "", srchBlkCode.Text)
        ...
        If srchTrxDate.Text <> "" Then
            If objGlobal.mtdValidInputDate(strDateSetting, srchTrxDate.Text, strDateFormat, strValidDate) = True Then
                strTrxDate = Iif(srchTrxDate.Text="","",objGlobal.GetShortDate(strDateSetting, CDate(srchTrxDate.Text)))
            Else
        ...
        Try
            intErrNo = objGLtx.mtdGetRunningHourList(strOppCd_GET, strParam, objDataSet)
        Catch Exp As System.Exception
            Response.Redirect("../../../include/mesg/ErrorMessage.aspx?errcode=GET_RUNNINGHOURLIST&errmesg=" & lblErrMessage.Text & "&redirect=../EN/menu/menu_GLTrx_page.aspx")
        End Try
    ...
    Sub btnNewItm_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        Response.Redirect("../../GL/Trx/GL_Trx_RunningHour_Details.aspx")
    End Sub
