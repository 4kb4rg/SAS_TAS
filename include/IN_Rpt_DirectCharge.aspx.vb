...
Public Class IN_Rpt_DirectCharge : inherits page
    ...
    Public Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        strDCCode = Trim(Request.QueryString("strDCCode"))
        ...
        strDCCodeTag = Trim(Request.QueryString("strDCCodeTag"))
    ...
    Sub Bind_ITEM(ByVal blnIsPDFFormat As Boolean)
        ...
        strSearch =  " AND Loccode = '" & strLocation & "' AND ItemType = '" & objInventory.EnumInventoryItemType.DirectCharge & "' AND itm.Status like  '" & IIF(Not strStatus = "", strStatus, "%" ) &"' "

        If NOT strDCCode = "" Then
            strSearch =  strSearch & " AND itm.ItemCode like '" & strDCCode & "%' "
        End If
        ...
        rdCrystalViewer.Load(objMapPath & "Web\EN\IN\Reports\Crystal\IN_Rpt_DirectCharge.rpt", OpenReportMethod.OpenReportByTempCopy)
        ...
        Else
            ...
            DiskOpts.DiskFileName = objMapPath & "web\ftp\IN_Rpt_DirectCharge.pdf"
            rdCrystalViewer.ExportOptions.DestinationOptions = DiskOpts
            rdCrystalViewer.Export()

            Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../../ftp/IN_Rpt_DirectCharge.pdf"">")
        End If
    End Sub
    ...
    Sub PassParam()
        ...
        paramField3 = ParamFields.Item("strDCCodeTag")
        paramField4 = ParamFields.Item("strDescTag")
        paramField5 = ParamFields.Item("strTitleTag")
        paramField6 = ParamFields.Item("strAccCodeTag")
