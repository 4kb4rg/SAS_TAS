...
Public Class PR_Rpt_EmpEval : inherits page
    ...
    Public Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        strEmpCode = Trim(Request.QueryString("strEmpCode"))
        ...
        strEmpName = Trim(Request.QueryString("strEmpName"))
        strValue = Trim(Request.QueryString("strValue"))
    ...
    Sub Bind_ITEM(ByVal blnIsPDFFormat As Boolean)
        ...
        Dim strOpCd As String = "PR_CLSSETUP_EMPEVAL_GET_FOR_REPORT"
        ...
        strSearch =  " AND EE.Status like '" & IIF(Not strStatus = "", strStatus, "%" ) &"' "
        If NOT strYear = "" Then
            strSearch =  strSearch & " AND EE.Year like '" & strYear & "%' "
        End If        
        If NOT strEmpCode = "" Then
            strSearch = strSearch & " AND EE.EmpCode like '" & strEmpCode &"%' "
        End If       
        If NOT strEmpName = "" Then
            strSearch = strSearch & " AND EE.EmpName like '" & strEmpName &"%' "
        End If      
        If NOT strValue = "" Then
            strSearch = strSearch & " AND EE.Value like '" & strValue &"%' "
        End If      
        ...
        For intCnt=0 To objRptDs.Tables(0).Rows.Count - 1
            objRptDs.Tables(0).Rows(intCnt).Item("Status") = objPR.mtdGetEmployeeEvaluationStatus(objRptDs.Tables(0).Rows(intCnt).Item("Status"))
        ...
        rdCrystalViewer.Load(objMapPath & "Web\EN\PR\Reports\Crystal\PR_Rpt_EmpEval.rpt", OpenReportMethod.OpenReportByTempCopy)
        ...
        Else
            ...
            DiskOpts.DiskFileName = objMapPath & "web\ftp\PR_Rpt_EmpEval.pdf"
            rdCrystalViewer.ExportOptions.DestinationOptions = DiskOpts
            rdCrystalViewer.Export()
            Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../../ftp/PR_Rpt_EmpEval.pdf"">")
        End If
