...
Public Class HR_setup_GangList : Inherits Page
    ...
    Protected WithEvents txtGangLeader As TextBox
    ...
    Sub Page_Load(Sender As Object, E As EventArgs)
        ...
        Else
           If SortExpression.Text = "" Then
                SortExpression.Text = "G.GangCode"
            End If
    ...
    Protected Function LoadData() As DataSet
        Dim strOpCd_GET As String = "HR_CLSSETUP_GANG_SEARCH1"
        Dim strSrchGangCode As String
        Dim strSrchDesc As String
        Dim strSrchGangLeader As String
        ...
        strGangCode = Trim(strLocation) & Trim(txtGangCode.Text)

        strSrchGangCode = IIF(txtGangCode.Text = "", "", strGangCode)
        strSrchDesc = IIF(txtDescription.Text = "", "", txtDescription.Text)
        strSrchGangLeader = IIF(txtGangLeader.Text = "", "", txtGangLeader.Text)
        ...
        strParam = strLocation & "|" & _
                   ...
                   SortCol.Text & "|"
        Try
            intErrNo = objHRSetup.mtdGetGang(strOpCd_GET, strParam, objGangDs, False)
    ...
    Sub DEDR_Delete(Sender As Object, e As DataGridCommandEventArgs)
        ...
        strSelGangCode = CPCell.Text
        strSelGangCodeTemp = trim(strLocation) & trim(strSelGangCode)

        strParam = strSelGangCodeTemp  & "|||||" & objHRSetup.EnumGangStatus.Deleted & "||"
        ...
        Try
            intErrNo = objHRSetup.mtdUpdGang(strOpCd_ADD, _
                                            ...
                                            True)
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=HR_SETUP_GANG_DEL&errmesg=" & Exp.ToString() & "&redirect=hr/setup/HR_setup_GangList.aspx")
        End Try
    ...
    Sub NewBtn_Click(Sender As Object, E As ImageClickEventArgs)
        Response.Redirect("HR_setup_Mdrdet_Estate.aspx")
    End Sub
