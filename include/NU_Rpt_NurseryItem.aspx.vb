...
Public Class NU_Rpt_NurseryItem : Inherits page
    Protected WithEvents crvView As CrystalDecisions.Web.CrystalReportViewer
	Protected WithEvents EventData As DataGrid
    Protected WithEvents lblErrMesage As Label
	
    Dim objNU As New agri.NU.clsSetup()
    ...
    Sub Bind_Report()
        ...
        strSearch =  "AND Loccode = '" & strLocation & "' AND ItemType = '" & objNU.EnumInventoryItemType.NurseryItem 
        ...
        Try
            intErrNo = objNU.mtdGetMasterList(strOpCd, _
                                              strParam, _
                                              objRptDs)
        ...
        For intCnt=0 To objRptDs.Tables(0).Rows.Count - 1
            objRptDs.Tables(0).Rows(intCnt).Item("Status") = objNU.mtdGetStockItemStatus(objRptDs.Tables(0).Rows(intCnt).Item("Status"))
        Next
        ...
        rdCrystalViewer.Load(objMapPath & "Web\EN\NU\Reports\Crystal\NU_Rpt_NurseryItem.rpt", OpenReportMethod.OpenReportByTempCopy)
        ...
        crDiskFileDestinationOptions.DiskFileName = objMapPath & "web\ftp\NU_Rpt_NurseryItem.pdf"
        ...
        Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../../ftp/NU_Rpt_NurseryItem.pdf"">")
    ...
    Sub PassParam()
        ...
        paramField3 = ParamFields.Item("strNurseryItemCodeTag")
        ...
        ParamDiscreteValue3.value = "Nursery Item"
        ParamDiscreteValue4.value = "Description"
        ParamDiscreteValue5.value = "NURSERY ITEM"
