...
Public Class PR_StdRpt_BankTransListing : Inherits Page
    ...
    Protected WithEvents rbtBCA as RadioButton
    Protected WithEvents rbtLain as RadioButton  
    Protected WithEvents txtSB as TextBox  
    Protected WithEvents txtManagement as TextBox 
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        strSB = txtSB.Text
        strManagement = txtManagement.Text 
        
        Response.Write("<Script Language=""JavaScript"">window.open(""PR_StdRpt_BankTransListingPreview.aspx?Type=Print&CompName=" & strCompany & _
                       "&RptID=" & strRptID & _
