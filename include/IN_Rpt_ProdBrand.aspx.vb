...
Public Class IN_Rpt_ProdBrand : inherits page
    ...
    Public Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        strProdBrandCode = Trim(Request.QueryString("strProdBrandCode"))
        ...
        ProdBrandCodeTag = Trim(Request.QueryString("ProdBrandCodeTag"))
        ProdBrandDescTag = Trim(Request.QueryString("ProdBrandDescTag"))
    ...
    Sub Bind_ITEM(ByVal blnIsPDFFormat As Boolean)
        ...
        Dim strOpCd As String = "IN_CLSSETUP_PRODBRAND_LIST_GET_FOR_REPORT"
        ...
        strSearch =  " AND PBrand.Status like '" & IIF(Not strStatus = "", strStatus, "%" ) &"' "
        If NOT strProdBrandCode = "" Then
            strSearch =  strSearch & " AND PBrand.ProdBrandCode like '" & strProdBrandCode & "%' "
        End If        
        If NOT strDescription = "" Then
            strSearch = strSearch & " AND PBrand.Description like '" & _
                        strDescription &"%' "
        End If       
        ...
        Try
            intErrNo = objInventory.mtdGetMasterList(strOpCd, _
                                                     strParam, _
                                                     EnumInventoryMasterType.ProductBrand, _
                                                     objRptDs)
        ...
        For intCnt=0 To objRptDs.Tables(0).Rows.Count - 1
            objRptDs.Tables(0).Rows(intCnt).Item("Status") = objInventory.mtdGetProductBrandStatus(objRptDs.Tables(0).Rows(intCnt).Item("Status"))
        ...
        rdCrystalViewer.Load(objMapPath & "Web\EN\IN\Reports\Crystal\In_Rpt_ProdBrand.rpt", OpenReportMethod.OpenReportByTempCopy)
        ...
        Else
            ...
            DiskOpts.DiskFileName = objMapPath & "web\ftp\In_Rpt_ProdBrand.pdf"
            rdCrystalViewer.ExportOptions.DestinationOptions = DiskOpts
            rdCrystalViewer.Export()
            Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../../ftp/In_Rpt_ProdBrand.pdf"">")
        End If
    ...
    Sub PassParam()
        ...
        paramField2 = ParamFields.Item("ProdBrandCodeTag")
        paramField3 = ParamFields.Item("ProdBrandDescTag")
        ...
        ParamDiscreteValue2.value = ProdBrandCodeTag
        ParamDiscreteValue3.value = ProdBrandDescTag
