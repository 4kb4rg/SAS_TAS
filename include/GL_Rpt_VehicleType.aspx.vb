...
Public Class GL_Rpt_VehicleType : inherits page
    ...
    Public Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        strVehTypeCodeTag = Trim(Request.QueryString("strVehTypeCodeTag"))  
        ...
        strVehTypeCode = Trim(Request.QueryString("strVehTypeCode"))
    ...
    Sub Bind_ITEM(ByVal blnIsPDFFormat As Boolean)
        ...
        Dim strOpCd As String = "GL_CLSSETUP_VEHICLETYPE_LIST_GET"
        ...
        strSearch =  " and veh.Status like '" & IIF(Not strStatus = "", strStatus, "%" ) &"' "

        If NOT strVehTypeCode = "" Then
            strSearch =  strSearch & " and veh.VehTypeCode like '" & strVehTypeCode & "%' "
        End If
        
        If NOT strDescription = "" Then
            strSearch = strSearch & " and veh.Description like '" & _
                        strDescription &"%' "
        End If
        ...
        For intCnt=0 To objRptDs.Tables(0).Rows.Count - 1
            objRptDs.Tables(0).Rows(intCnt).Item("Status") = objGLSetup.mtdGetVehTypeStatus(objRptDs.Tables(0).Rows(intCnt).Item("Status"))
            objRptDs.Tables(0).Rows(intCnt).Item("UpdateDate") = objGlobal.GetLongDate(objRptDs.Tables(0).Rows(intCnt).Item("UpdateDate"))
        Next


        rdCrystalViewer.Load(objMapPath & "Web\EN\GL\Reports\Crystal\GL_Rpt_VehicleType.rpt", OpenReportMethod.OpenReportByTempCopy)
        ...
        Else
            ...
            DiskOpts.DiskFileName = objMapPath & "web\ftp\GL_Rpt_VehicleType.pdf"
            rdCrystalViewer.ExportOptions.DestinationOptions = DiskOpts
            rdCrystalViewer.Export()

            Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../../ftp/GL_Rpt_VehicleType.pdf"">")
        End If
    ...
    Sub PassParam()
        ...
        paramField3 = ParamFields.Item("strVehTypeCodeTag")
        ...
        ParamDiscreteValue3.value = strVehTypeCodeTag
