...
Public Class WM_data_uploadweigh : Inherits Page
    ...
    Sub UploadBtn_Click(Sender As Object, E As ImageClickEventArgs)
        ...
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=WM_SAVEAS&errmesg=" & Exp.ToString() & "&redirect=wm/data/wm_data_uploadweigh.aspx")
        End Try
        ...
        If blnUpdate = True Then 
            ...
            Catch Exp As System.Exception
                Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=WM_UPLOAD_REF&errmesg=" & Exp.ToString() & "&redirect=wm/data/wm_data_uploadweigh.aspx")
            End Try
