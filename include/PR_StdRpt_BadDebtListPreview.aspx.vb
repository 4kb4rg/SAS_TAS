...
Public Class PR_StdRpt_BadDebtListPreview : Inherits Page
    ...
    Sub BindReport()
        ...
        Try
            strRptPrefix = "PR_StdRpt_BadDebtList"

            strOpCd = "PR_STDRPT_BADDEBTLIST_EMP_GET" & "|" & objPRRpt.mtdGetPRReportTable(objPRRpt.EnumPRReportTable.BadDebt) & Chr(9) & _
                      "GET_REPORT_INFO_BY_REPORTID" & "|" & "SH_REPORT"

            If strSort = 1 Then
                strSorting = " Order By HR_Employee.EmpCode"
            Else If strSort = 2 Then
                strSorting = " Order By HR_Employee.EmpName"
            Else If strSort = 3 Then
                strSorting = " Order By HR_Employment.AppJoinDate"
            Else If strSort = 4 Then 
                strSorting = " Order By HR_Employment.TerminateDate, HR_Employee.EmpCode"
            End If
            ...
            intErrNo = objPRRpt.mtdGetReport_BadDebtList(strOpCd, _
                                                         strCompany, _
                                                         strLocation, _
                                                         strUserId, _
                                                         strAccMonth, _
        ...
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=PR_STDRPT_BADDEBTLIST_GET&errmesg=" & Exp.ToString() & "&redirect=")
        End Try


        rdCrystalViewer = New ReportDocument()
        rdCrystalViewer.Load(objMapPath & "web\" & strLangCode & "\Reports\Crystal\PR_StdRpt_BadDebtList.rpt", OpenReportMethod.OpenReportByTempCopy)
        ...
        crDiskFileDestinationOptions.DiskFileName = objMapPath & "web\ftp\PR_StdRpt_BadDebtList.pdf"
    ...
    Sub PassParam()
        ...
        ParamDiscreteValue11.Value = strSort
        ...
        ParamFieldDef11 = ParamFieldDefs.Item("ParamSort")
