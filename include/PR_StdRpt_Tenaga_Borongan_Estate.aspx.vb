...
Public Class PR_StdRpt_Tenaga_Borongan_Estate : Inherits Page
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        End If
		 ...
		 Response.Write("<Script Language=""JavaScript"">window.open(""PR_StdRpt_Tenaga_Borongan_Preview_Estate.aspx?CompCode=" & strCompany & "&Location=" & strUserLoc & "&RptID=" & strRptID & "&RptName=" & strRptName & "&Decimal=" & strDec & _
