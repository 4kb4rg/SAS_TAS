...
Public Class DP_MemberList : Inherits Page
    ...
    Sub MemberDet_Click(ByVal Sender As Object, ByVal E As ImageClickEventArgs)
        Response.Redirect("DP_trx_MemberDet.aspx?redirect=empdet")
    End Sub

    Sub MemberTrx_Click(ByVal Sender As Object, ByVal E As ImageClickEventArgs)
        Response.Redirect("DP_trx_MemberTransactionDet.aspx?redirect=empdet")
    End Sub

    Sub MemberAD_Click(ByVal Sender As Object, ByVal E As ImageClickEventArgs)
        Response.Redirect("DP_trx_MemberADDet.aspx?redirect=empdet")
    End Sub

    Sub MemberPen_Click(ByVal Sender As Object, ByVal E As ImageClickEventArgs)
