...
Public Class IN_Rpt_ProdCategory : inherits page
    ...
    Public Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        strProdCatCode = Trim(Request.QueryString("strProdCatCode"))
        ...
        ProdCatCodeTag = Trim(Request.QueryString("ProdCatCodeTag"))
        ProdCatDescTag = Trim(Request.QueryString("ProdCatDescTag"))
        Bind_ITEM(TRUE)
    ...
    Sub Bind_ITEM(ByVal blnIsPDFFormat As Boolean)
        ...
        Dim strOpCd As String = "IN_CLSSETUP_PRODCAT_LIST_GET_FOR_REPORT"
        ...
        strSearch =  " AND PCat.Status like '" & IIF(Not strStatus = "", strStatus, "%" ) &"' "
        If NOT strProdCatCode = "" Then
            strSearch =  strSearch & " AND PCat.ProdCatCode like '" & strProdCatCode & "%' "
        End If        
        If NOT strDescription = "" Then
            strSearch = strSearch & " AND PCat.Description like '" & _
                        strDescription &"%' "
        End If       
        ...
        Try
            intErrNo = objInventory.mtdGetMasterList(strOpCd, _
                                                     strParam, _
                                                     EnumInventoryMasterType.ProductCategory, _
                                                     objRptDs)
        ...
        For intCnt=0 To objRptDs.Tables(0).Rows.Count - 1
            objRptDs.Tables(0).Rows(intCnt).Item("Status") = objInventory.mtdGetProductCategoryStatus(objRptDs.Tables(0).Rows(intCnt).Item("Status"))
        ...
        rdCrystalViewer.Load(objMapPath & "Web\EN\IN\Reports\Crystal\In_Rpt_ProdCategory.rpt", OpenReportMethod.OpenReportByTempCopy)
        ...
        Else
            ...
            DiskOpts.DiskFileName = objMapPath & "web\ftp\In_Rpt_ProdCategory.pdf"
            rdCrystalViewer.ExportOptions.DestinationOptions = DiskOpts
            rdCrystalViewer.Export()
            Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../../ftp/In_Rpt_ProdCategory.pdf"">")
        End If
    ...
    Sub PassParam()
        ...
        paramField2 = ParamFields.Item("ProdCatCodeTag")
        paramField3 = ParamFields.Item("ProdCatDescTag")
        ...
        ParamDiscreteValue2.value = ProdCatCodeTag
        ParamDiscreteValue3.value = ProdCatDescTag
