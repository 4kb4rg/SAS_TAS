...
Public Class PR_Rpt_StdEval : inherits page
    ...
    Dim objPR As New agri.PR.clsSetup()
    ...
    Public Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        strGrade = Trim(Request.QueryString("strGrade"))
        strScoreMin = Trim(Request.QueryString("strScoreMin"))
        ...
        strScoreMax = Trim(Request.QueryString("strScoreMax"))
        strCont = Trim(Request.QueryString("strCont"))
    ...
    Sub Bind_ITEM(ByVal blnIsPDFFormat As Boolean)
        ...
        Dim strOpCd As String = "PR_CLSSETUP_STDEVAL_GET_FOR_REPORT"
        ...
        strSearch =  " AND S.Status like '" & IIF(Not strStatus = "", strStatus, "%" ) &"' "
        If NOT strGrade = "" Then
            strSearch =  strSearch & " AND S.Grade like '" & strGrade & "%' "
        End If        
        If NOT strScoreMin = "" Then
            strSearch = strSearch & " AND S.ScoreMin like '" & strScoreMin &"%' "
        End If     
        If NOT strScoreMax = "" Then
            strSearch = strSearch & " AND S.ScoreMax like '" & strScoreMax &"%' "
        End If  
        If NOT strCont = "" Then
            strSearch = strSearch & " AND S.Cont like '" & strCont &"%' "
        End If      
        ...
        Try
            intErrNo = objPR.mtdGetMasterList(strOpCd, _
                                                     strParam, _
        ...
        For intCnt=0 To objRptDs.Tables(0).Rows.Count - 1
            objRptDs.Tables(0).Rows(intCnt).Item("Status") = objPR.mtdGetSalaryIncreaseStatus(objRptDs.Tables(0).Rows(intCnt).Item("Status"))
        ...
        rdCrystalViewer.Load(objMapPath & "Web\EN\PR\Reports\Crystal\PR_Rpt_StdEval.rpt", OpenReportMethod.OpenReportByTempCopy)
        ...
        Else
            ...
            DiskOpts.DiskFileName = objMapPath & "web\ftp\PR_Rpt_StdEval.pdf"
            rdCrystalViewer.ExportOptions.DestinationOptions = DiskOpts
            rdCrystalViewer.Export()
            Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../../ftp/PR_Rpt_StdEval.pdf"">")
        End If
