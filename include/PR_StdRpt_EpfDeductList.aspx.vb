...
Public Class PR_StdRpt_EpfDeductList : Inherits Page
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        Response.Write("<Script Language=""JavaScript"">window.open(""PR_StdRpt_EpfDeductListPreview.aspx?Type=Print&CompName=" & strCompany & _
