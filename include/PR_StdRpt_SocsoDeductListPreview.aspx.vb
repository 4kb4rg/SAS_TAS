...
Public Class PR_StdRpt_SocsoDeductListPreview : Inherits Page
    ...
    Sub Page_Load(ByVal Sender As Object, ByVal E As EventArgs)
        ...
        strEmpCodeFrom = Trim(Request.QueryString("EmpCodeFrom"))
        strEmpCodeTo = Trim(Request.QueryString("EmpCodeTo"))
    ...
    Sub BindReport()
        ...
        Try
            strRptPrefix = "PR_StdRpt_SocsoDeductList"

            strOpCd = "PR_STDRPT_SOCSODEDUCTLIST_GET" & "|" & objPRRpt.mtdGetPRReportTable(objPRRpt.EnumPRReportTable.SocsoDeduct) & Chr(9) & _
            ...
            intErrNo = objPRRpt.mtdGetReport_SocsoDeductList(strOpCd, _
                                                             strCompany, _
                                                             strLocation, _
                                                             strUserId, _
                                                             strAccMonth, _
        ...
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=PR_STDRPT_SOCSODEDUCTLIST_GET&errmesg=" & Exp.ToString() & "&redirect=")
        End Try
    ...
    Sub BindReport_old()
        ...
        Try
            ...
            strOpCd = "PR_STDRPT_SOCSODEDUCT_EMP_GET" & "|" & objPRRpt.mtdGetPRReportTable(objPRRpt.EnumPRReportTable.SocsoDeduct) & Chr(9) & _
                      "GET_REPORT_INFO_BY_REPORTID" & "|" & "SH_REPORT"
