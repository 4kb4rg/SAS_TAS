...
Public Class GL_Workshop_Details : Inherits Page
    ...
    Protected WithEvents ddlChargeLocCode As DropDownList
    Protected WithEvents lblChargeLocCodeTag As Label
    Protected WithEvents lblChargeLocCodeErr As Label

    Protected WithEvents txtWPUnit As TextBox
    ...
    Dim strSelectedChargeLocCode As String
    ...
    Sub Page_Load(ByVal Sender As Object, ByVal E As EventArgs)
        ...
        Else
			...
			ReActBt.Attributes.Add("onclick", "this.disabled=true;" + GetPostBackEventReference(ReActBt).ToString())
            ...
            lblChargeLocCodeErr.Visible = False
    ...
    Sub BindChargeLevelDropDownList()
		...
		lstChargeLevel.Items.Add(New ListItem("Kendaraan", "3"))
    ...
    Sub lstChargeLevel_OnSelectedIndexChanged(ByVal sender As Object, ByVal e As EventArgs)
        ToggleChargeLevel()
		 If lstChargeLevel.SelectedIndex = 3 Then
		 BindVehicleCodeList()
		 else
         CheckVehicleUse()
		 End If
    ...
    Sub onload_GetLangCap()
		...
		lblPreBlkTag.Text = "Unit " & lblCode.Text & " : "
        ...
        lblChargeLocCodeTag.Text = GetCaption(objLangCap.EnumLangCap.Location)
       End Sub
    ...
    Sub DisplayFromDB()
        ...
        strSelectedChargeLocCode = objDataSet.Tables(0).Rows(0).Item("ChargeLocCode")
        BindChargeLocCode(Trim(strSelectedChargeLocCode))
    End Sub
    ...
    Sub DEDR_Edit(ByVal Sender As Object, ByVal E As DataGridCommandEventArgs)
		...
		lstChargeLevel.SelectedIndex = 3
		BindVehicleCodeList(strvehcode)
		end if
		
		hidVehActCode.Value = strvehcode 
		...
		lbl = E.Item.FindControl("WPUnit")
        txtWPUnit.Text = Trim(Replace(Replace(Replace(lbl.Text, ".", ""), ",", "."), "-", ""))
    ...
    Sub BindVehicleCodeDropList()
        ...
        Try
            ...
            strParam.Append("| AND GL.LocCode = '" & Session("SS_LOCATION") & "' AND VT.IsPowerSupply = 1")
	...
	Sub BindVehicleCodeList(Optional ByVal pv_strVehCode As String = "")
        ...
        strParam.Append("|LocCode = '" & strLocation & "' AND Status = '1'")
        Try
        ...
        lstPreBlock.DataValueField = "VehCode"
        lstPreBlock.DataTextField = "Description"
        lstPreBlock.DataBind()
        lstPreBlock.SelectedIndex = intSelectedIndex
    ...
    Sub btnAdd_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        Dim strBlkCode As String = iif(lstChargeLevel.SelectedIndex = 3,"",lstPreBlock.SelectedValue)
        Dim strNewIDFormat As String
        Dim strDate As String = Date_Validation(txtDate.Text, False)
        Dim indDate As String = ""
		
		hidVehActCode.Value = iif(lstChargeLevel.SelectedIndex = 3,lstPreBlock.SelectedValue,"")
        ...
        If ddlChargeLocCode.SelectedItem.Value = "" Then
            lblChargeLocCodeErr.Visible = True
            Exit Sub
        End If
        ...
        If lblTxID.Text = "" Then
            ...
            StrTxParam.Append("|")
            StrTxParam.Append(ddlChargeLocCode.SelectedItem.Value)
		...
		txtWPUnit.Text = iif(txtWPUnit.Text = "", 0, txtWPUnit.Text)
		...
		strTxLnParam.Append("|")
        strTxLnParam.Append(txtWPUnit.Text)
        strTxLnParam.Append("|")
        strTxLnParam.Append(ddlUOM.SelectedItem.Value)
    ...
    Sub btnUpdate_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        ParamNama = "ACCCODE|BLOCK|RH|RT|UU|AD|VUID|VULNID|VCODE|TD|WP|UOM"
    ...
    Sub btnCancel_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        StrTxParam = lblTxID.Text & "|||||||" & objGLtx.EnumVehicleUsageStatus.Cancelled & "|" & ddlChargeLocCode.SelectedItem.Value
	...
	Sub BtnReActBK_onClick(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        StrTxParam = lblTxID.Text & "|||||||" & objGLtx.EnumVehicleUsageStatus.Active & "|" & ddlChargeLocCode.SelectedItem.Value
    ...
    Sub BindChargeLocCode(ByVal pv_strPRId As String)
        ...
        strToLocCode = IIf(pv_strPRId = "", "", strSelectedChargeLocCode)
        ...
        For intCnt = 0 To objToLocCodeDs.Tables(0).Rows.Count - 1
            With objToLocCodeDs.Tables(0).Rows(intCnt)
                ...
                If .Item("LocCode") = Trim(strSelectedChargeLocCode) Then intSelectedIndex = intCnt + 1
                If strToLocCode = "" Then
                    If .Item("LocCode") = Trim(strLocation) Then
                        intSelectedIndex = intCnt + 1
                    End If
                End If
            End With
        ...
        dr("LocCode") = ""
        dr("Description") = lblPleaseSelect.Text & lblChargeLocCodeTag.Text
        objToLocCodeDs.Tables(0).Rows.InsertAt(dr, 0)

        ddlChargeLocCode.DataSource = objToLocCodeDs.Tables(0)
        ddlChargeLocCode.DataValueField = "LocCode"
        ddlChargeLocCode.DataTextField = "Description"
        ddlChargeLocCode.DataBind()
        ddlChargeLocCode.SelectedIndex = intSelectedIndex
    End Sub
End Class
