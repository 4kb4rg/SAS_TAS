   ...
   Sub BindStation()
    ...
    Sub BindGrid()
        ...
        If SortExpression.Text.Trim() = "OL.StationCode" Then
            ...
            dgoilLossList.DataSource = dView
        Else
    ...
    Protected Function LoadData() As DataSet
        ...
        strOppCode_Get = "PM_CLSTRX_OIL_LOSS_LIST_GET"
        strParam = " AND OL.LocCode = '" & strLocation & "' AND OL.AccMonth = '" & strAccMonth & "' AND OL.AccYear = '" & strAccYear & "'" & _
                   " AND TS.LocCode = '" & strLocation & "' AND M.LocCode = '" & strLocation & "'" 'CR_THG00009
        If strDate <> "" Then
        ...
        Try
            intErrNo = objPMTrx.mtdGetTransactionList(strOppCode_Get, strParam, objOilLoss)
        Catch Exp As System.Exception
    ...
    Sub DEDR_Edit(ByVal Sender As Object, ByVal E As DataGridCommandEventArgs)
        ...
        lblTransId = dgoilLossList.Items.Item(CInt(E.Item.ItemIndex)).FindControl("lblTransId")
