...
Public Class PM_Trx_CPOStorage_List : Inherits Page
    ...
    Protected WithEvents srchStorageArea As TextBox
    ...
    Sub Page_Load(ByVal Sender As Object, ByVal E As EventArgs)
        ...
        ElseIf objAR.mtdHasAccessRights(objAR.mtdGetAccessRights(objAR.EnumPMAccessRights.PMCPOStorage), intPMAR) = False Then
    ...
    Protected Function LoadData() As DataSet
        ...
        Dim strOppCode_Get As String = "PM_CLSTRX_DAILYPROD_CPO_STORAGE_GET"
        Dim intErrNo As Integer
    ...
    Sub DEDR_Edit(ByVal Sender As Object, ByVal E As DataGridCommandEventArgs)
        ...
        If strTransDate <> "" And strStorageAreaCode <> "" Then
            Response.Redirect("PM_trx_CPOStorage_Det.aspx?TransDate=" & strTransDate & "&StorageAreaCode=" & strStorageAreaCode)
        End If
    End Sub

    Sub NewBtn_Click(ByVal Sender As Object, ByVal E As ImageClickEventArgs)
        Response.Redirect("PM_trx_CPOStorage_Det.aspx")
    End Sub
