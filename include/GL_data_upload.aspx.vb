...
Public Class GL_data_upload : Inherits Page
    ...
    Sub UploadBtn_Click(Sender As Object, E As ImageClickEventArgs)
        ...
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=GL_GET_FTPPATH&errmesg=" & lblErrMesage.Text & "&redirect=gl/data/gl_data_upload.aspx")
        End Try        
        ...
        If objGlobal.mtdValidateUploadFileName(strZipName, objGlobal.EnumDataTransferFileType.GL_GeneralLedgerReferenceData, strErrMsg) = False Then
        ...
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=GL_SAVEAS&errmesg=" & lblErrUpload.Text & "&redirect=gl/data/gl_data_upload.aspx")
        End Try
        ...
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=GL_DECRYPT_REF&errmesg=" & lblErrMesage.Text & "&redirect=gl/data/gl_data_upload.aspx")
        End Try
        ...
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=GL_UPLOAD_REF&errmesg=" & lblErrMesage.Text & "&redirect=gl/data/gl_data_upload.aspx")
        End Try
