...
Public Class FA_trx_AssetAddList : Inherits Page
    ...
    Sub Page_Load(ByVal Sender As Object, ByVal E As EventArgs)
        ...
        Else
            ...
            If SortExpression.Text = "" Then
                SortExpression.Text = "AssetAddID"
            End If
    ...
    Sub onload_GetLangCap()
        ...
        lblTxID.Text = GetCaption(objLangCap.EnumLangCap.AssetAdd) & " ID"
    ...
    Sub GetEntireLangCap()
        ...
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=FA_TRX_AssetAdd_GET_LANGCAP&errmesg=" & lblErrMessage.Text & "&redirect=FA/trx/FA_trx_AssetAddList.aspx")
        End Try
    End Sub
    ...
    Sub BindSearchList()
        srchStatusList.Items.Add(New ListItem(objFATrx.mtdGetAssetAddStatus(objFATrx.EnumAssetAddStatus.Active), objFATrx.EnumAssetAddStatus.Active))
        srchStatusList.Items.Add(New ListItem(objFATrx.mtdGetAssetAddStatus(objFATrx.EnumAssetAddStatus.Confirmed), objFATrx.EnumAssetAddStatus.Confirmed))
        srchStatusList.Items.Add(New ListItem(objFATrx.mtdGetAssetAddStatus(objFATrx.EnumAssetAddStatus.Deleted), objFATrx.EnumAssetAddStatus.Deleted))
        srchStatusList.Items.Add(New ListItem(objFATrx.mtdGetAssetAddStatus(objFATrx.EnumAssetAddStatus.Closed), objFATrx.EnumAssetAddStatus.Closed))
        srchStatusList.Items.Add(New ListItem(objFATrx.mtdGetAssetAddStatus(objFATrx.EnumAssetAddStatus.All), objFATrx.EnumAssetAddStatus.All))
   ...
   End Sub
    ...
    Protected Function LoadData() As DataSet
        Dim strOppCode_Get As String = "FA_CLSTRX_ASSETADD_GET"
        Dim strParam As String
        Dim intCnt As Integer
        ...
        Try
            intErrNo = objFATrx.mtdGetAssetAdd(strOppCode_Get, strLocation, strParam, objTxDs)
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=FA_CLSTRX_AssetAddLIST_GET&errmesg=" & lblErrMessage.Text & "&redirect=FA/trx/FA_trx_AssetAddList.aspx")
        End Try

        For intCnt = 0 To objTxDs.Tables(0).Rows.Count - 1
            objTxDs.Tables(0).Rows(intCnt).Item("AssetAddID") = objTxDs.Tables(0).Rows(intCnt).Item("AssetAddID").Trim()
    ...
    Sub NewBtn_Click(ByVal Sender As Object, ByVal E As ImageClickEventArgs)
        Response.Redirect("FA_trx_AssetAddDetails.aspx")
    End Sub
