...
Public Class PR_Rpt_SalInc : inherits page
    ...
    Public Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        strIncrease = Trim(Request.QueryString("strIncrease"))
    ...
    Sub Bind_ITEM(ByVal blnIsPDFFormat As Boolean)
        ...
        Dim strOpCd As String = "PR_CLSSETUP_SALINC_GET_FOR_REPORT"
        ...
        strSearch =  " AND SI.Status like '" & IIF(Not strStatus = "", strStatus, "%" ) &"' "
        If NOT strYear = "" Then
            strSearch =  strSearch & " AND SI.Year like '" & strYear & "%' "
        End If        
        If NOT strIncrease = "" Then
            strSearch = strSearch & " AND SI.Increase like '" & strIncrease &"%' "
        End If     
    
        If NOT strValue = "" Then
            strSearch = strSearch & " AND SI.Value like '" & strValue &"%' "
        End If      
        ...
        rdCrystalViewer.Load(objMapPath & "Web\EN\PR\Reports\Crystal\PR_Rpt_SalInc.rpt", OpenReportMethod.OpenReportByTempCopy)
        ...
        Else
            ...
            DiskOpts.DiskFileName = objMapPath & "web\ftp\PR_Rpt_SalInc.pdf"
            rdCrystalViewer.ExportOptions.DestinationOptions = DiskOpts
            rdCrystalViewer.Export()
            Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../../ftp/PR_Rpt_SalInc.pdf"">")
        End If
