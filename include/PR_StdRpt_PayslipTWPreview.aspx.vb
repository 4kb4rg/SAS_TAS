...
Public Class PR_StdRpt_PayslipTW_Preview : Inherits Page
    ...
    Sub BindReport()
        ...
        strRptPrefix = "PR_StdRpt_PayslipTW"

        strOpCd = "PR_STDRPT_PAYSLIPTW_EMPDET|PR_PAYSLIPTW_EMP" & Chr(9) & _
                  "PR_STDRPT_PAYSLIPTW_PAY_SP|PR_PAYSLIPTW_PAY" & Chr(9) & _
                  "PR_STDRPT_PAYSLIPTW_ATTCODE_SP|PR_PAYSLIPTW_ATTCODE" & Chr(9) & _
                  "PR_STDRPT_PAYSLIPTW_UNITWORKED|PR_PAYSLIPTW_UNITWORKED"
        ...
        Try
            intErrNo = objPRRpt.mtdGetReport_PayslipTW(strOpCd, _
                                                       strCompCode, _
                                                       strLocCode, _
                                                       strUserId, _
                                                       strAccMonth, _
        ...
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=PR_GET_PAYSLIPTW&errmesg=" & lblErrMessage.Text & "&redirect=")
        End Try
    ...
    Sub PassParam()
        ...
        If Lcase(strCostLevel) = "block" Then
            ParamDiscreteValue15.Value = strBlockTag
        Else
            ParamDiscreteValue15.Value = strSubBlkTag
        End If
        ParamDiscreteValue16.Value = intSelDecimal
        ...
        ParamFieldDef15 = ParamFieldDefs.Item("BlockTag")
        ParamFieldDef16 = ParamFieldDefs.Item("subPay_Decimal")
        ParamFieldDef17 = ParamFieldDefs.Item("subUnit_Decimal")
