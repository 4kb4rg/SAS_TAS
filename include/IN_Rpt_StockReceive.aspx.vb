...
Public Class IN_Rpt_StockReceive : inherits page
    ...
    Public Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        strRcvType = Request.QueryString("strRcvType").Trim
    ...
    Sub Bind_ITEM(ByVal blnIsPDFFormat As Boolean)
        ...
        Dim strOpCd As String = "IN_CLSTRX_STOCKRECEIVE_LIST_GET_FOR_REPORT"
        ...
        strParam = strStockTxID & "|" & strRefNo & "|" & strUpdateBy & "|" & _
                   strStatus & "|" & strSortExp & "|" & strSortCol _
                    & "|" & strAccMonth & "|" & strAccYear & "|" & strLocation & "|" & strRcvType

        Try
            intErrNo = objIN.mtdGetStockReceiveList(strOpCd, strParam, objRptDs)
        ...
        For intCnt=0 To objRptDs.Tables(0).Rows.Count - 1
            objRptDs.Tables(0).Rows(intCnt).Item("Status") = objIn.mtdGetStocktransferStatus(objRptDs.Tables(0).Rows(intCnt).Item("Status"))
        ...
        rdCrystalViewer.Load(objMapPath & "Web\EN\IN\Reports\Crystal\In_Rpt_StockReceive.rpt", OpenReportMethod.OpenReportByTempCopy)
        ...
        Else
            ...
            DiskOpts.DiskFileName = objMapPath & "web\ftp\In_Rpt_StockReceive.pdf"
            rdCrystalViewer.ExportOptions.DestinationOptions = DiskOpts
            rdCrystalViewer.Export()

            Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../../ftp/In_Rpt_StockReceive.pdf"">")
        End If
