...
Public Class PU_GRDet : Inherits Page
    ...
    Protected WithEvents lblPoLocCode As Label
    ...
    Sub onLoad_Display(ByVal pv_strGoodsRcvId As String)
        ...
        If objGRDs.Tables(0).Rows.Count > 0 Then            
            ...
            txtSupCode.Text = Trim(objGRDs.Tables(0).Rows(0).Item("SupplierCode"))
            txtSupName.Text = Trim(objGRDs.Tables(0).Rows(0).Item("SupplierName"))
 ...
 '                           btnIssue.Attributes("onclick") = "javascript:return ConfirmAction('generate stock issue');"
    ...
    Sub BindPO(ByVal pv_strSuppCode As String)
        ...
        If Len(txtSupCode.Text.Trim) > 0 Then
            If strSelectedPOId <> "" Then
                'strParam = "|" & strLocation & "||" & txtSupCode.Text & "||" & objPU.EnumPOStatus.Deleted & "','" & objPU.EnumPOStatus.Cancelled & "','" & objPU.EnumPOStatus.Confirmed & "','" & objPU.EnumPOStatus.Invoiced & "','" & objPU.EnumPOStatus.Closed & "||||||"
                strParam = "|||" & txtSupCode.Text & "||" & objPU.EnumPOStatus.Deleted & "','" & objPU.EnumPOStatus.Cancelled & "','" & objPU.EnumPOStatus.Confirmed & "','" & objPU.EnumPOStatus.Invoiced & "','" & objPU.EnumPOStatus.Closed & "||||||"
            ...
            Else
                ...
                strParamValue = "AND COALESCE(B.LocPenyerahan,'') = '" & strLocation & "' AND (B.SupplierCode LIKE '" & txtSupCode.Text & "' OR B.Name LIKE '%" & txtSupCode.Text & "%') AND B.Status IN ('" & objPU.EnumPOStatus.Confirmed & "','" & objPU.EnumPOStatus.Invoiced & "')  "
        ...
        Else
            ddlPOId.Items.Add("Please select Purchase Order")
        End If
    End Sub
    ...
    Sub BindPOItem(ByVal pv_strPOId As String)
        ...
        If Len(txtSupCode.Text.Trim) > 0 And ddlPOId.SelectedIndex > 0 Then
    ...
    Sub ItemIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        strSelectedSuppCode = Request.Form("txtSupCode")
        ...
        ElseIf POType = objPU.EnumPOType.DirectCharge Then
            ...
            Else
				...
				If objCOA.Tables(0).Rows.Count > 0 Then
					BindAccount(objCOA.Tables(0).Rows(0).Item("AccCode"))
    ...
    Sub onSelect_Account(ByVal Sender As Object, ByVal E As EventArgs)
        ...
        GetAccountDetails(txtAccCode.Text.Trim, blnIsBalanceSheet, blnIsBlockRequire, blnIsVehicleRequire, blnIsOthers, intNurseryInd)

        If Not blnIsBalanceSheet Then
            If blnIsBlockRequire Then
                BindPreBlock(txtAccCode.Text.Trim, ddlPreBlock.SelectedItem.Value)
                BindBlock(txtAccCode.Text.Trim, ddlBlock.SelectedItem.Value)
            ...
            If blnIsVehicleRequire Then
                BindVehicle(txtAccCode.Text.Trim, strVehCode)
        ...
        Else
            If blnIsBalanceSheet And intNurseryInd = objGLSetup.EnumNurseryAccount.Yes Then
                ...
                BindPreBlockBalanceSheet(txtAccCode.Text.Trim, ddlPreBlock.SelectedItem.Value)
                BindBlockBalanceSheetDropList(txtAccCode.Text.Trim, ddlPreBlock.SelectedItem.Value)
                BindVehicle("", ddlVehCode.SelectedItem.Value)
                BindVehicleExpense(True, ddlVehExpCode.SelectedItem.Value)
    ...
    Sub btnDelete_Click(ByVal Sender As Object, ByVal E As ImageClickEventArgs)
        ...
        Try
            intErrNo = objGLtrx.mtdInsertDataCommon(strOpCd_DelGR, _
                                                strParamName, _
                                                strParamValue)
