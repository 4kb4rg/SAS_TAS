...
Public Class PM_trx_WaterQuality_List_KLR : Inherits Page
    ...
    Sub BindGrid()
        ...
        '        Case objPMTrx.EnumWaterQualityStatus.Active
        '            lbButton = dgList.Items.Item(intCnt).FindControl("Delete")
        '            lbButton.Visible = True
        '            lbButton.Attributes("onclick") = "javascript:return ConfirmAction('delete');"
        '        Case objPMTrx.EnumWaterQualityStatus.Deleted
        '            lbButton = dgList.Items.Item(intCnt).FindControl("Delete")
    ...
    Protected Function LoadData() As DataSet
        ...
        Dim strOpCode As String = "PM_CLSTRX_WATERQUALITY_KLR_SEARCH"
	...
	Dim strSrchLastUpdate As String
        ...
        'strSearch  = " WHERE WT.LocCode = '" & strLocation & "' AND WT.AccMonth = '" & strAccMonth & "' AND WT.AccYear = '" & strAccYear & "'"

	strSearch  = " WHERE WT.LocCode = '" & strLocation & "' AND WT.AccYear = '" & strAccYear & "'"
        
	If strDate <> "" Then
            strSearch  = strSearch  & " AND WT.TransDate = '" & strDate & "'"
        End If
        
        If strSrchLastUpdate <> "" Then
            strSearch  = strSearch  & " AND USR.UserName LIKE '" & strSrchLastUpdate & "'"
        End If

        strSearch = strSearch & " ORDER BY WT." & SortExpression.Text.Trim & " " & SortCol.Text
    ...
    Sub NewBtn_Click(ByVal Sender As Object, ByVal E As ImageClickEventArgs)
        Response.Redirect("PM_trx_WaterQuality_Det_KLR.aspx")
    End Sub
    ...
    Sub DEDR_Edit(ByVal Sender As Object, ByVal E As DataGridCommandEventArgs)
        ...
        QString = "?LocCode=" & Server.UrlEncode(Trim(strSelectedLocCode)) & _
                  ...
                  "&Edit=True"
        Response.Redirect("PM_trx_WaterQuality_Det_KLR.aspx" & QString)
