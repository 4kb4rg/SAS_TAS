...
Public Class FA_setup_AssetGrp : Inherits Page
    ...
    Protected WithEvents srchAssetGrpCode As TextBox
    Protected WithEvents srchDescription As TextBox
    Protected WithEvents srchUpdateBy As TextBox
    Protected WithEvents lblTitle As Label
    Protected WithEvents lblAssetGrpCode As Label
    ...
    Dim strOppCd_GET As String = "FA_CLSSETUP_ASSETGRP_LIST_GET"
    Dim strOppCd_ADD As String = "FA_CLSSETUP_ASSETGRP_LIST_ADD"
    Dim strOppCd_UPD As String = "FA_CLSSETUP_ASSETGRP_LIST_UPD"
    ...
    Sub Page_Load(ByVal Sender As Object, ByVal E As EventArgs)
        ...
        ElseIf objAR.mtdHasAccessRights(objAR.mtdGetAccessRights(objAR.EnumFAAccessRights.FAGroupSetup), intFAAR) = False Then
            Response.Redirect("/" & strLangCode & "/include/mesg/AccessRights.aspx")
        Else
            onload_GetLangCap()
            If SortExpression.Text = "" Then
                SortExpression.Text = "AssetGrpCode"
                SortCol.Text = "ASC"
            End If
    ...
    Sub onload_GetLangCap()
        GetEntireLangCap()
        lblTitle.Text = UCase(GetCaption(objLangCap.EnumLangCap.AssetGrp))
        lblAssetGrpCode.Text = GetCaption(objLangCap.EnumLangCap.AssetGrp) & lblCode.Text
        lblDescription.Text = GetCaption(objLangCap.EnumLangCap.AssetGrpDesc)

        DocTitleTag = lblTitle.Text & lblList.Text
        AssetGrpCodeTag = GetCaption(objLangCap.EnumLangCap.AssetGrp) & lblCode.Text
        DescriptionTag = GetCaption(objLangCap.EnumLangCap.AssetGrpDesc)

        strValidateCode = lblPleaseEnter.Text & lblAssetGrpCode.Text & "."
        strValidateDesc = lblPleaseEnter.Text & lblDescription.Text & "."

        EventData.Columns(0).HeaderText = lblAssetGrpCode.Text
        EventData.Columns(1).HeaderText = lblDescription.Text
        EventData.Columns(2).HeaderText = "No. Code"
    End Sub
    ...
    Sub GetEntireLangCap()
        ...
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=FA_SETUP_AssetGrp_GET_LANGCAP&errmesg=" & lblErrMessage.Text & "&redirect=FA/Setup/FA_setup_AssetGrp.aspx")
        End Try
    ...
    Sub BindStatusList(ByVal index As Integer)
        ...
        StatusList.Items.Add(New ListItem(objFASetup.mtdGetAssetGrpStatus(objFASetup.EnumAssetGrpStatus.Active), objFASetup.EnumAssetGrpStatus.Active))
        StatusList.Items.Add(New ListItem(objFASetup.mtdGetAssetGrpStatus(objFASetup.EnumAssetGrpStatus.Deleted), objFASetup.EnumAssetGrpStatus.Deleted))
    End Sub

    Sub BindSearchList()
        srchStatusList.Items.Add(New ListItem(objFASetup.mtdGetAssetGrpStatus(objFASetup.EnumAssetGrpStatus.Active), objFASetup.EnumAssetGrpStatus.Active))
        srchStatusList.Items.Add(New ListItem(objFASetup.mtdGetAssetGrpStatus(objFASetup.EnumAssetGrpStatus.Deleted), objFASetup.EnumAssetGrpStatus.Deleted))
        srchStatusList.Items.Add(New ListItem(objFASetup.mtdGetAssetGrpStatus(objFASetup.EnumAssetGrpStatus.All), objFASetup.EnumAssetGrpStatus.All))
    End Sub

    Protected Function LoadData() As DataSet
        Dim Period As String

        strParam = srchAssetGrpCode.Text & "|" & _
        ...
        Try
            intErrNo = objFASetup.mtdGetAssetGrp(strOppCd_GET, strParam, objDataSet)
        Catch Exp As System.Exception
            Response.Redirect("../include/mesg/ErrorMessage.aspx?errcode=FA_SETUP_ASSETGRP_GET&errmesg=" & lblErrMessage.Text & "&redirect=FA/Setup/FA_setup_AssetGrp.aspx")
        End Try
        Return objDataSet
    End Function
    ...
    Sub btnPreview_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        strAssetGrpCode = srchAssetGrpCode.Text
        strDescription = srchDescription.Text
        strUpdateBy = srchUpdateBy.Text
        strSortExp = SortExpression.Text
        strSortCol = SortCol.Text

        Response.Write("<Script Language=""JavaScript"">window.open(""../reports/FA_Rpt_AssetGrp.aspx?strStatus=" & strStatus & _
                       "&strAssetGrpCode=" & strAssetGrpCode & _
                       ...
                       "&AssetGrpCodeTag=" & AssetGrpCodeTag & _
    ...
    Sub DEDR_Edit(ByVal Sender As Object, ByVal E As DataGridCommandEventArgs)
        ...
        Select Case CInt(EditText.Text) = objFASetup.EnumAssetGrpStatus.Active
            Case True
                StatusList.SelectedIndex = 0
                EditText = EventData.Items.Item(CInt(E.Item.ItemIndex)).FindControl("AssetGrpCode")
            ...
            Case False
                ...
                EditText.Enabled = False
                EditText = EventData.Items.Item(CInt(E.Item.ItemIndex)).FindControl("FACode")
                EditText.Enabled = False
    ...
    Sub DEDR_Update(ByVal Sender As Object, ByVal E As DataGridCommandEventArgs)
        ...
        EditText = E.Item.FindControl("AssetGrpCode")
        strAssetGrpCode = EditText.Text
        EditText = E.Item.FindControl("Description")
        strDescription = EditText.Text
        EditText = E.Item.FindControl("FACode")
        strFACode = EditText.Text
        ...
        strParam = strAssetGrpCode & "|" & _
                    strDescription & "|" & _
                    strStatus & "|" & strFACode

        Try
            intErrNo = objFASetup.mtdUpdAssetGrp(strOppCd_ADD, _
                                                    strOppCd_UPD, _
                                                    strOppCd_GET, _
                                                    strCompany, _
                                                    strLocation, _
        ...
        Catch Exp As System.Exception
            Response.Redirect("../../../include/mesg/ErrorMessage.aspx?errcode=UPDATE_AssetGrp&errmesg=" & lblErrMessage.Text & "&redirect=FA/Setup/FA_setup_AssetGrp.aspx")
        End Try
    ...
    Sub DEDR_Delete(ByVal Sender As Object, ByVal E As DataGridCommandEventArgs)
        ...
        strStatus = IIf(EditText.Text = objFASetup.EnumAssetGrpStatus.Active, _
                        objFASetup.EnumAssetGrpStatus.Deleted, _
                        objFASetup.EnumAssetGrpStatus.Active)
        EditText = E.Item.FindControl("CreateDate")
        strCreateDate = EditText.Text
        ...
        Catch Exp As System.Exception
            Response.Redirect("../../../include/mesg/ErrorMessage.aspx?errcode=DELETE_AssetGrp&errmesg=" & lblErrMessage.Text & "&redirect=FA/Setup/FA_setup_AssetGrp.aspx")
        End Try
