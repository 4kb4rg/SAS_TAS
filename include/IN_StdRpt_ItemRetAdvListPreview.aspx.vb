...
Public Class IN_StdRpt_ItemRetAdvList_Preview : Inherits Page
    ...
    Sub BindReport()
        ...
        'Dim strOpCdItemRetAdv_GET As String = "IN_STDRPT_ITEMRETADV_AND_ITEMRETADVLN_GET"
        'Dim strOpCdRptName_GET as String = "IN_STDRPT_NAME_GET"
        'Dim strOppCd_UserLoc_GET As String = "IN_STDRPT_USERLOCATION_GET"
        'Dim strOpCdItem_GET as String = "IN_STDRPT_ITEM_GET"

        'Dim WildStr As String = "AND IRA.ItemRetAdvID *= IRALn.ItemRetAdvID AND IRA.ItemDocType = '" & objGlobal.EnumDocType.StockReturnAdvice & "' AND IRA.LocCode IN ('" & strUserLoc & "') AND "
        'Dim NormStr as string = "AND IRA.ItemRetAdvID = IRALn.ItemRetAdvID AND IRA.ItemDocType = '" & objGlobal.EnumDocType.StockReturnAdvice & "' AND IRA.LocCode IN ('" & strUserLoc & "') AND "
        ...
        'Try
        '    intErrNo = objIN.mtdGetReport_ItemRetAdvList(strOpCdItemRetAdv_GET, strParam, objRptDs, objMapPath)
        'Catch Exp As Exception
        '    Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=GET_ITEMRETADV_LIST_REPORT&errmesg=" & lblErrMessage.Text & "&redirect=")
        'End Try
        ...
        '                                        objItem)
        '        Catch Exp As Exception
        '            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=GET_ITEM_FOR_IN_ITEMRETADV_REPORT&errmesg=" & lblErrMessage.Text & "&redirect=")
        '        End Try
        ...
        'Catch Exp As Exception
        '    Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=GET_IN_ITEMRETADV_STDRPT_NAME&errmesg=" & lblErrMessage.Text & "&redirect=")
        'End Try
        ...
        'Catch Exp As Exception
        '    Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=GET_IN_ITEMRETADV_USERLOC_REPORT&errmesg=" & lblErrMessage.Text & "&redirect=")
        'End Try
        ...
        'rdCrystalViewer.Load(objMapPath & "web\" & strLangCode & "\Reports\Crystal\IN_StdRpt_ItemRetAdvList.rpt", OpenReportMethod.OpenReportByTempCopy)
        ...
        'crDiskFileDestinationOptions.DiskFileName = objMapPath & "web\ftp\IN_StdRpt_ItemRetAdvList.pdf"
        ...
        'Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../ftp/IN_StdRpt_ItemRetAdvList.pdf"">")
    End Sub
