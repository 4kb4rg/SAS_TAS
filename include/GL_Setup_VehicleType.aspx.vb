...
Public Class GL_Setup_VehicleType : Inherits Page
    ...
    Dim strOppCd_ADD As String = "GL_CLSSETUP_VEHICLETYPE_LIST_ADD"
    Dim strOppCd_UPD As String = "GL_CLSSETUP_VEHICLETYPE_LIST_UPD"
    ...
    Sub Page_Load(ByVal Sender As Object, ByVal E As EventArgs)
        ...
        Else
            ...
            If SortExpression.Text = "" Then
                SortExpression.Text = "VehTypeCode"
                sortcol.Text = "ASC"
            End If
    ...
    Sub onload_GetLangCap()
        ...
        lblDescription.Text = GetCaption(objLangCap.EnumLangCap.VehTypeDesc)
    ...
    Sub DEDR_Edit(ByVal Sender As Object, ByVal e As DataGridCommandEventArgs)
        ...
        Select Case CInt(txtEditText.Text) = objGLSetup.EnumVehTypeStatus.Active
            Case True
                ...
                txtEditText = EventData.Items.Item(CInt(e.Item.ItemIndex)).FindControl("VehTypeCode")
            ...
            Case False
                ...
                chk = EventData.Items.Item(CInt(e.Item.ItemIndex)).FindControl("IsPowerSupply")
                chk.Enabled = False
    ...
    Sub DEDR_Update(ByVal Sender As Object, ByVal E As DataGridCommandEventArgs)
        ...
        Dim intIsPwrSupply As integer
        Dim chk As CheckBox 

        txtEditText = E.Item.FindControl("VehTypeCode")
        strVehTypeCode = txtEditText.Text
        ...
        chk = E.Item.FindControl("IsPowerSupply")
        intIsPwrSupply = chk.Checked 

        strCreateDate = txtEditText.Text
        strParam = strVehTypeCode & "|" & _
                    strDescription & "|" & _
                    strStatus & "||" & intIsPwrSupply
        Try
            intErrNo = objGLSetup.mtdUpdMasterList(strOppCd_ADD, _
                                              ...
                                              blnUpdate.Text)
        Catch Exp As System.Exception
            Response.Redirect("../../../include/mesg/ErrorMessage.aspx?errcode=GL_SETUP_VEHICLETYPE_UPDATE&errmesg=" & lblErrMessage.Text & "&redirect=GL/Setup/GL_Setup_VehicleType.aspx")
        End Try
    ...
    Sub DEDR_Delete(ByVal Sender As Object, ByVal E As DataGridCommandEventArgs)
        ...
        Try
            intErrNo = objGLSetup.mtdUpdMasterList(strOppCd_ADD, _
                                              ...
                                              blnUpdate.Text)
        Catch Exp As System.Exception
            Response.Redirect("../../../include/mesg/ErrorMessage.aspx?errcode=GL_SETUP_VEHICLETYPE_DELETEP&errmesg=" & lblErrMessage.Text & "&redirect=GL/Setup/GL_Setup_VehicleType.aspx")
        End Try
    ...
    Sub DEDR_Add(ByVal Sender As Object, ByVal E As ImageClickEventArgs)
        ...
        newRow.Item("VehTypeCode") = ""
        newRow.Item("Description") = ""
        newRow.Item("Status") = 1
        newRow.Item("CreateDate") = DateTime.Now()
        newRow.Item("UpdateDate") = DateTime.Now()
        newRow.Item("UserName") = ""
        newRow.Item("IsPowerSupply") = 0
