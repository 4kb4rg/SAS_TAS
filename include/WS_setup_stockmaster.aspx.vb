...
Public Class WS_StockMaster : Inherits Page
    ...
    Protected Function LoadData() As DataSet
        ...
        SearchStr = "AND ItemType = '" & objIN.EnumInventoryItemType.WorkshopItem & "' AND itm.Status like '" & IIf(Not srchStatusList.SelectedItem.Value = objIN.EnumStockItemStatus.All, _
        ...
        Catch Exp As Exception
            Response.Redirect("../../../include/mesg/ErrorMessage.aspx?errcode=GET_STOCKITEM&errmesg=" & lblErrMessage.Text & "&redirect=WS/Setup/WS_stockMaster.aspx")
        End Try
        Return objDataSet
    End Function
    ...
    Sub btnPreview_Click (sender As Object, e As ImageClickEventArgs)
            ...
            strTitleTag = "Workshop Item Master"
            ...
            Response.Write("<Script Language=""JavaScript"">window.open(""../reports/WS_Rpt_StockMaster.aspx?strStockItemCodeTag=" & strStockItemCodeTag & _
