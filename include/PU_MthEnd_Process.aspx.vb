...
Imports agri.PU.clsMthEnd
Imports agri.Admin.clsShare
Imports agri.PWSystem.clsConfig


Public Class PU_mthend_Process : Inherits Page
    ...
    Protected WithEvents lblErrGoodsReceive As Label
    Protected WithEvents lblErrGoodsReturn As Label
    Protected WithEvents lblErrDispatchAdvice As Label
    ...
    Dim objMthEnd As New agri.PU.clsMthEnd()
    ...
    Sub Page_Load(Sender As Object, E As EventArgs)
        ...
        ElseIf objAR.mtdHasAccessRights(objAR.mtdGetAccessRights(objAR.EnumPUAccessRights.PUMonthEnd), intPUAR) = False Then
            Response.Redirect("/" & strLangCode & "/include/mesg/AccessRights.aspx")
        Else
            lblErrNotClose.Visible = False
            lblErrProcess.Visible = False
            lblErrGoodsReceive.Visible = False
            lblErrGoodsReturn.Visible = False
            lblErrDispatchAdvice.Visible = False
    ...
    Sub onLoad_Display()
        ...
        Else
            ...
            strAccMonth = objSysLocDs.Tables(0).Rows(0).Item("PUAccMonth").Trim()
            strAccYear = objSysLocDs.Tables(0).Rows(0).Item("PUAccYear").Trim()
    ...
    Sub btnProceed_Click(Sender As Object, E As ImageClickEventArgs)
        ...
        If CloseInd_Final.Checked = True Then
            ...
            Else
                Select Case objResult
                    ...
                    Case 10
                        lblErrGoodsReceive.Visible = True
                    Case 11
                        lblErrGoodsReturn.Visible = True
                    Case 12
                        lblErrDispatchAdvice.Visible = True
                End Select
            End If
        ...
        Else
            ...
            If CloseInd_Temporary.Checked = True Then
                clsAccyear = objSysLocDs.Tables(0).Rows(0).Item("PUAccYear").Trim()
                clsAccMonth = Val(objSysLocDs.Tables(0).Rows(0).Item("PUAccMonth").Trim()) + 1
            ...
            strParamValue = Trim(strLocation) & "|" & Trim(strCompany) & "|" & _
                            "PUACCMONTH='" & clsAccMonth & "', PUACCYEAR='" & clsAccyear & "' "
