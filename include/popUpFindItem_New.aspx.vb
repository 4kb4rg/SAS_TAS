...
Public Class popUpFindItem_New : Inherits Page
    ...
    Protected Function LoadData() As DataSet
        ...
        Dim strOpCode As String = "IN_CLSTRX_ITEM_STOCK_SEARCH"
    ...
    Sub OnSelectItem(ByVal Sender As Object, ByVal e As DataGridCommandEventArgs)
        ...
        If Left(strINItem, 3) = "txt" Then
            ...
            onclick_reload_txt(StrInItemName, Replace(Trim(LblDesc.Text), "'", "''"), False, blnPostBack)
