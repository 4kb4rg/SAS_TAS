...
Public Class PR_StdRpt_LHPKPreview_Estate : Inherits Page
    ...
    Sub BindReport()
        ...
        strOpCd = "PR_PR_STDRPT_LHPK_REPORT"
        fname = "PR_StdRpt_LHPK_Estate_Mandor"
        ...
        Try
            ...
            objRpt.Tables(0).TableName = "PR_StdRpt_LHPK_Mandor"
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=PR_PR_STDRPT_LHPK_REPORT&errmesg=" & lblErrMessage.Text & "&redirect=")
        End Try


        objRptDs.Tables.Add(objRpt.Tables(0).Copy())
        objRptDs.Tables(0).TableName = "PR_StdRpt_LHPK_Mandor"
