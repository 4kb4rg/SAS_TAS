...
Public Class NU_data_upload : Inherits Page
    ...
    Sub UploadBtn_Click(Sender As Object, E As ImageClickEventArgs)
        ...
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=NUDATA_GET_FTPPATH&errmesg=" & Exp.ToString() & "&redirect=NU/data/NU_data_upload.aspx")
        End Try        
        ...
        If objGlobal.mtdValidateUploadFileName(strZipName, objGlobal.EnumDataTransferFileType.NU_NurseryReferenceData, strErrMsg) = False Then
        ...
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=NUDATA_SAVEAS&errmesg=" & lblErrUpload.Text & "&redirect=NU/data/NU_data_upload.aspx")
        End Try
        ...
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=NUDATA_DECRYPT_REF&errmesg=" & Exp.ToString() & "&redirect=NU/data/NU_data_upload.aspx")
        End Try
        ...
        Try
            intErrNo = objNUData.mtdUploadRef(strXmlPath)
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=NUDATA_UPLOAD_REF&errmesg=" & Exp.ToString() & "&redirect=NU/data/NU_data_upload.aspx")
        End Try
