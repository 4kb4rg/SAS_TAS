...
Public Class PR_mthend_THRProcess : Inherits Page
    ...
    Sub Page_Load(Sender As Object, E As EventArgs)
        ...
        ElseIf objAR.mtdHasAccessRights(objAR.mtdGetAccessRights(objAR.EnumPRAccessRights.PRMthTHR), intPRAR) = False Then
    ...
    Sub btnGenerate_Click(Sender As Object, E As ImageClickEventArgs)
        Dim strOpCdSP As String = "PR_CLSMTHEND_THRPROCESS_SP"
        ...
        Try
            intErrNo = objPR.mtdTHRProcess(strCompany, _
                                                  strLocation, _
                                                  strUserId, _
                                                  strOpCdSP, _
                                                  strParam, _
                                                  objResult)
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=PR_MTHEND_THRPROCESS_GENERATE&errmesg=&redirect=")
        End Try
    ...
    Sub onload_GetLangCap()
        GetEntireLangCap()
        lblNoRecord.Text = "THR is not updated. This could be no active employee or no employee is entitled with any THR Code."
        lblSuccess.Text = "THR is updated successfully."
        lblFailed.Text = "Error while updating THR. Kindly contact system administrator for assistance."
    End Sub
    ...
    Sub GetEntireLangCap()
        ...
        Try
            intErrNo = objLangCap.mtdGetBussTerm(strOpCode_BussTerm, _
                                                 ...
                                                 strParam)
        Catch Exp As System.Exception
            Response.Redirect("../../../include/mesg/ErrorMessage.aspx?errcode=MENU_PRMTHEND_THRPROCESS_LANGCAP&errmesg=&redirect=")
        End Try
    End Sub
