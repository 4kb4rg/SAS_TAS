...
Public Class HR_Setup_DeptCode : Inherits Page
    ...
    Dim strOppCd_GET As String = "HR_HR_STP_DIVISICODE_GET"
    Dim strOppCd_UPD As String = "HR_HR_STP_DIVISICODE_UPD"

    Dim objDataSet As New Object()
    Dim objLangCapDs As New Object()
    Dim intErrNo As Integer
    Dim strParam As String = ""
    Dim strValidateCode As String = "Silakan input kode divisi"
    Dim strValidateDesc As String = "Silakan input deskrisi divisi"
    ...
    Sub BindType(ByVal index As String)
        ddltype = EventData.Items.Item(index).FindControl("ddltype")
        ddltype.Items.Add(New ListItem("Kebun", "K"))
        ddltype.Items.Add(New ListItem("Kantor", "O"))
        ddltype.Items.Add(New ListItem("Keamanan", "S"))
        ddltype.Items.Add(New ListItem("Traksi", "T"))
    End Sub
    ...
    Protected Function LoadData() As DataSet
        ...
        If Not srchDeptCode.Text = "" Then
            SearchStr = SearchStr & " AND A.DivCode like '%" & srchDeptCode.Text & "%' "
        End If
    ...
    Sub DEDR_Edit(ByVal Sender As Object, ByVal E As DataGridCommandEventArgs)
        ...
        BindType(EventData.EditItemIndex)

        EditText = EventData.Items.Item(CInt(E.Item.ItemIndex)).FindControl("Status")
        Select Case CInt(EditText.Text) = "1"
            Case True
                StatusList.SelectedIndex = 0
                EditText = EventData.Items.Item(CInt(E.Item.ItemIndex)).FindControl("DivCode")
                EditText.ReadOnly = True
                lblTemp = EventData.Items.Item(CInt(E.Item.ItemIndex)).FindControl("lblTyDiv")
    ...
    Sub DEDR_Update(ByVal Sender As Object, ByVal E As DataGridCommandEventArgs)
        ...
        EditText = E.Item.FindControl("DivCode")
        ...
        ParamNama = "ID|DES|TY|ST|CD|UD|UI"
