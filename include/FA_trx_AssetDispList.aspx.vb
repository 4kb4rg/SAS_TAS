...
Public Class FA_trx_AssetDispList : Inherits Page
    ...
    Sub Page_Load(ByVal Sender As Object, ByVal E As EventArgs)
        ...
        Else
            ...
            If SortExpression.Text = "" Then
                SortExpression.Text = "AssetDispID"
            End If
    ...
    Sub onload_GetLangCap()
        ...
        lblTxID.Text = GetCaption(objLangCap.EnumLangCap.AssetDisp) & " ID"
    ...
    Sub GetEntireLangCap()
        ...
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=FA_TRX_ASSETDISP_GET_LANGCAP&errmesg=" & lblErrMessage.Text & "&redirect=FA/trx/FA_trx_AssetDispList.aspx")
        End Try
    End Sub
    ...
    Sub BindSearchList()
        srchStatusList.Items.Add(New ListItem(objFATrx.mtdGetAssetDispStatus(objFATrx.EnumAssetDispStatus.Active), objFATrx.EnumAssetDispStatus.Active))
        srchStatusList.Items.Add(New ListItem(objFATrx.mtdGetAssetDispStatus(objFATrx.EnumAssetDispStatus.Confirmed), objFATrx.EnumAssetDispStatus.Confirmed))
        srchStatusList.Items.Add(New ListItem(objFATrx.mtdGetAssetDispStatus(objFATrx.EnumAssetDispStatus.Deleted), objFATrx.EnumAssetDispStatus.Deleted))
        srchStatusList.Items.Add(New ListItem(objFATrx.mtdGetAssetDispStatus(objFATrx.EnumAssetDispStatus.Closed), objFATrx.EnumAssetDispStatus.Closed))
        srchStatusList.Items.Add(New ListItem(objFATrx.mtdGetAssetDispStatus(objFATrx.EnumAssetDispStatus.All), objFATrx.EnumAssetDispStatus.All))
   ...
   End Sub
    ...
    Protected Function LoadData() As DataSet
        Dim strOppCode_Get As String = "FA_CLSTRX_ASSETDISP_GET"
        Dim strParam As String
        Dim intCnt As Integer
        ...
        Try
            intErrNo = objFATrx.mtdGetAssetDisp(strOppCode_Get, strLocation, strParam, objTxDs)
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=FA_CLSTRX_ASSETDISPLIST_GET&errmesg=" & lblErrMessage.Text & "&redirect=FA/trx/FA_trx_AssetDispList.aspx")
        End Try

        For intCnt = 0 To objTxDs.Tables(0).Rows.Count - 1
            objTxDs.Tables(0).Rows(intCnt).Item("AssetDispID") = objTxDs.Tables(0).Rows(intCnt).Item("AssetDispID").Trim()
    ...
    Sub NewBtn_Click(ByVal Sender As Object, ByVal E As ImageClickEventArgs)
        Response.Redirect("FA_trx_AssetDispDetails.aspx")
    End Sub
