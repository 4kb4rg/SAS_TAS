...
Public Class PR_setup_AktivitiSubKategori_Estate : Inherits Page
    ...
    Dim strOppCd_GET As String = "PR_PR_STP_BK_SUBCATEGORY_GET"
    Dim strOppCd_UPD As String = "PR_PR_STP_BK_SUBCATEGORY_UPD"
