...
Public Class PM_Rpt_UllageVolumeTableMasterList : inherits page
    ...
    Sub Bind_ITEM(ByVal blnIsPDFFormat As Boolean)
        ...
        Dim strOpCd As String = "PM_CLSSETUP_UVTABLE_GET"
        ...
        strSearch =  " AND UVT.Status like '" & IIF(Not strStatus = "", strStatus, "%" ) & "' "

        If NOT strTableCode = "" Then
            strSearch =  strSearch & " AND UVT.UVTableCode like '" & strTableCode & "%' "
        End If
        
        If NOT strDescription = "" Then
            strSearch = strSearch & " AND UVT.Description like '" & strDescription & "%' "
        End If
        ...
        rdCrystalViewer.Load(objMapPath & "Web\EN\PM\Reports\Crystal\PM_Rpt_UllageVolumeTableMasterList.rpt", OpenReportMethod.OpenReportByTempCopy)
        ...
        Else
            ...
            DiskOpts.DiskFileName = objMapPath & "web\ftp\PM_Rpt_UllageVolumeTableMasterList.pdf"
            rdCrystalViewer.ExportOptions.DestinationOptions = DiskOpts
            rdCrystalViewer.Export()

            Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../../ftp/PM_Rpt_UllageVolumeTableMasterList.pdf"">")
        End If
