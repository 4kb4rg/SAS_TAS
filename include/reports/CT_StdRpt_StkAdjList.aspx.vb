...
Public Class CT_StdRpt_StkAdjList : Inherits Page
    ...
    Sub GetLangCap()
        ...
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=CT_TRX_STOCKADJ_DET_GET_LANGCAP&errmesg=&redirect=")
        End Try
    ...
    Sub BindAdjustmentTypeDropDownList()
        ...
        ddlAdjType.Items.Add(New ListItem(objCTTrx.mtdGetAdjustmentType(objCTTrx.EnumAdjustmentType.All), objCTTrx.EnumAdjustmentType.All))
    ...
    Sub BindTransactionTypeDropDownList()
        ...
        ddlTransType.Items.Add(New ListItem(objCTTrx.mtdGetTransactionType(objCTTrx.EnumTransactionType.All), objCTTrx.EnumTransactionType.All))
    ...
    Sub BindStatusDropDownList()
        ...
        ddlStatus.Items.Add(New ListItem(objCTTrx.mtdGetStockAdjustStatus(objCTTrx.EnumStockAdjustStatus.All), objCTTrx.EnumStockAdjustStatus.All))
        ddlStatus.Items.Add(New ListItem(objCTTrx.mtdGetStockAdjustStatus(objCTTrx.EnumStockAdjustStatus.Active), objCTTrx.EnumStockAdjustStatus.Active))
        ddlStatus.Items.Add(New ListItem(objCTTrx.mtdGetStockAdjustStatus(objCTTrx.EnumStockAdjustStatus.Closed), objCTTrx.EnumStockAdjustStatus.Closed))
        ddlStatus.Items.Add(New ListItem(objCTTrx.mtdGetStockAdjustStatus(objCTTrx.EnumStockAdjustStatus.Confirmed), objCTTrx.EnumStockAdjustStatus.Confirmed))
        ddlStatus.Items.Add(New ListItem(objCTTrx.mtdGetStockAdjustStatus(objCTTrx.EnumStockAdjustStatus.Deleted), objCTTrx.EnumStockAdjustStatus.Deleted))
    ...
    Sub ibPrintPreview_OnClick(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        Try
            intErrNo = objSysCfg.mtdGetConfigInfo(strParam, _
                                                  ...
                                                  objSysCfgDs)
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=CT_STDRPT_STKADJ_GET_CONFIG_DATE&errmesg=" & lblErrMessage.Text & "&redirect=../../en/reports/CT_StdRpt_Selection.aspx")
        End Try
        ...
        Response.Write("<Script Language=""JavaScript"">window.open(""CT_StdRpt_StkAdjListPreview.aspx?Type=Print&CompName=" & strCompany & "&Location=" & strUserLoc & "&RptID=" & strRptID & "&RptName=" & strRptName & "&Decimal=" & strDec & _
