...
Public Class GL_StdRpt_BukaLahanAwalPreview : Inherits Page
    ...
    Sub GetEntireLangCap()
        ...
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=GL_STDRPT_BUKALAHANAWAL_GET_LANGCAP&errmesg=" & Exp.ToString() & "&redirect=")
        End Try
    ...
    Sub BindSummReport()
        ...
        Try
            strRptPrefix = "GL_StdRpt_BukaLahanAwal"

            strOpCd = "GL_STDRPT_BUKALAHANAWAL_GET_SP" & "|" & objGLRpt.mtdGetGLReportTable(objGLRpt.EnumGLReportTable.BukaLahanAwal) & Chr(9) & _
            ...
            intErrNo = objGLRpt.mtdGetReport_BukaLahanAwal(strOpCd, _
                                                    strCompany, _
                                                    strLocation, _
                                                    strUserId, _
                                                    strAccMonth, _
        ...
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=GL_STDRPT_BUKALAHANAWAL_GET_SP&errmesg=" & Exp.ToString() & "&redirect=")
        End Try
