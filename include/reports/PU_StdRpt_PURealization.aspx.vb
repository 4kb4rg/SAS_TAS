...
Public Class PU_StdRpt_PURealization : Inherits Page
    ...
    Sub BindPRTypeList()
        ...
        lstPRType.Items.Add(New ListItem(objPUTrx.mtdGetPOType(objPUTrx.EnumPOType.DirectCharge), objPUTrx.EnumPOType.DirectCharge))
        lstPRType.Items.Add(New ListItem(objPUTrx.mtdGetPOType(objPUTrx.EnumPOType.Stock), objPUTrx.EnumPOType.Stock))
        lstPRType.Items.Add(New ListItem(objPUTrx.mtdGetPOType(objPUTrx.EnumPOType.Workshop), objPUTrx.EnumPOType.Workshop))
        lstPRType.Items.Add(New ListItem(objPUTrx.mtdGetPOType(objPUTrx.EnumPOType.FixedAsset), objPUTrx.EnumPOType.FixedAsset))
        lstPRType.Items.Add(New ListItem(objPUTrx.mtdGetPOType(objPUTrx.EnumPOType.Nursery), objPUTrx.EnumPOType.Nursery))
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        If Not (strDateFrom = "" And strDateTo = "") Then
            If objGlobal.mtdValidInputDate(strDateSetting, strDateFrom, objDateFormat, objDateFrom) = True And objGlobal.mtdValidInputDate(strDateSetting, strDateTo, objDateFormat, objDateTo) = True Then
                Response.Write("<Script Language=""JavaScript"">window.open(""PU_StdRpt_PRRealizationPreview.aspx?Type=Print&Location=" & strUserLoc & "&RptID=" & strRptID & "&RptName=" & strRptName & "&Decimal=" & strDec & _
