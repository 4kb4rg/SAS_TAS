...
Public Class CB_StdRpt_BankTransactionPreview : Inherits Page
    ...
    Sub Page_Load(ByVal Sender As Object, ByVal E As EventArgs)
        ...
        strType = Trim(Request.QueryString("strType"))
    ...
    Sub BindReport()
        ...
        Dim strOpCode As String = "CB_STDRPT_BANKTRANSACTION_GET"
        Dim strFileName As String = "CB_StdRpt_BankTransaction_Report"
        ...
        strParamValue = strDate & "|" & strDateTo & "|" & strAccCode & "|" & strLocation & "|" & strType
    ...
    Sub PassParam()
        ...
        ParamFieldDef8 = ParamFieldDefs.Item("ParamDateTo")
