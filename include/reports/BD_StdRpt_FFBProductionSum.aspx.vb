...
Public Class BD_StdRpt_FFBProductionSum : Inherits Page
    ...
    Sub BindYearList()
        Dim strOpCd As String = "BD_STDRPT_FFB_PRODUCTION_YEAR_GET"
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        Response.Write("<Script Language=""JavaScript"">window.open(""BD_StdRpt_FFBProductionSumPreview.aspx?Year=" & strYear & _
                       "&RptID=" & strRptID & "&RptName=" & strRptName & "&Decimal=" & strDec & "&lblLocationTag=" & lblLocationTag.Text & """,null ,""status=yes, resizable=yes, scrollbars=yes, toolbar=no, location=no"");</Script>")
