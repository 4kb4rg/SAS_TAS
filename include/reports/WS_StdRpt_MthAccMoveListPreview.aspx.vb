...
Public Class WS_StdRpt_MthAccMoveList_Preview : Inherits Page
    ...
    Sub BindReportUsingStoredProcedure()
        ...
        Dim strOpCd As String = "WS_STDRPT_MTHACCMOVE_GET_SP" 
        ...
        Try
			...
			intErrNo = objWSReport.mtdGetReport_MthStkAccMoveList(strOpCd, Replace(strParam, "'", "''"), objRptDs, objMapPath)
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=GET_WS_MTHACCMOVE_LIST_REPORT&errmesg=" & Exp.ToString() & "&redirect=")
        End Try


        rdCrystalViewer.Load(objMapPath & "web\" & strLangCode & "\Reports\Crystal\WS_StdRpt_MthAccMoveList.rpt", OpenReportMethod.OpenReportByTempCopy)
        ...
        For Each myTable In rdCrystalViewer.Database.Tables
            ...
            If myTable.Name = "WS_StdRpt_DS_MthAccMoveList" Then
                ...
                myTable.Location = myLogin.ConnectionInfo.DatabaseName & ".dbo.WS_MTHACCMOVELIST_RPT"
        ...
        crDiskFileDestinationOptions.DiskFileName = objMapPath & "web\ftp\WS_StdRpt_MthAccMoveList.pdf"
        ...
        Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../ftp/WS_StdRpt_MthAccMoveList.pdf"">")
    End Sub
