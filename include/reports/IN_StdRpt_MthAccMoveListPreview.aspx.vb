...
Public Class IN_StdRpt_MthAccMoveList_Preview : Inherits Page
    ...
    Sub BindReportUsingStoredProcedure()
        ...
        Else
            crDiskFileDestinationOptions.DiskFileName = objMapPath & "web\ftp\IN_StdRpt_MthAccMoveList.xls"
        End If
        ...
        Else
            Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../ftp/IN_StdRpt_MthAccMoveList.xls"">")
        End If
