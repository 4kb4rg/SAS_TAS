...
Public Class PR_StdRpt_PremiPanen_Mdr_Preview_Estate : Inherits Page
    ...
    Sub BindReport()
		...
		strOpCd = "PR_PR_STDRPT_PREMIPANEN_MDR_REPORT"
		strRptPrefix = "PR_StdRpt_PremiPanen_Mdr"
		
        strParamName = "ACCMONTH|ACCYEAR|LOCCODE|F_DIVCODE|TYEMP"
        ...
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=PR_PR_STDRPT_PREMITRAKSI_EMP_REPORT&errmesg=" & lblErrMessage.Text & "&redirect=")
        End Try
