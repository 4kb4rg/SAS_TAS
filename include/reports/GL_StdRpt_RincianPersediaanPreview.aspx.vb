...
Public Class GL_StdRpt_RincianPersediaanPreview : Inherits Page
    ...
    Sub BindSummReport()
        ...
        Try
            strRptPrefix = "GL_StdRpt_RincianPersediaan"

            strOpCd = "GL_STDRPT_MR_RINCIAN_PERSEDIAAN" & "|" & objGLRpt.mtdGetGLReportTable(objGLRpt.EnumGLReportTable.RincianPersediaan) & Chr(9) & _
            ...
            intErrNo = objGLRpt.mtdGetReport_RincianPersediaan(strOpCd, _
                                                    strCompany, _
                                                    strLocation, _
                                                    strUserId, _
                                                    strAccMonth, _
