...
Public Class IN_StdRpt_LaporanPosisiStock : Inherits Page
...
Sub BindStorage(ByVal pv_strcode As String)
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
		...
		If trim(ddlRptType.SelectedItem.Value) = "0" Then
        ...
        strStorageCode=lstStorage.SelectedItem.Value
        ...
        Response.Write("<Script Language=""JavaScript"">window.open(""IN_StdRpt_LaporanPosisiStockPreview.aspx?Type=Print&CompName=" & strCompany & _
                       ...
                       "&StorageCode=" & strStorageCode & _
                       "&SDate_Trx=" & objDateFrom & _
                       "&EDate_Trx=" & objDateTo & _
					   "&RptType=" & strRptType & _
                       "&ExportToExcel=" & strExportToExcel & _
                       "&Bin=" & strBin & """,""" & strRptID & """ ,""status=yes, resizable=yes, scrollbars=yes, toolbar=no, location=no"");</Script>")
