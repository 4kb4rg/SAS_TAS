...
Public Class CB_StdRpt_CashTransferList_Preview : Inherits Page
    ...
    Sub BindReport()
        ...
        Dim strOpCd_CashBank_BlkGrp_And_Blk_GET As String = "CB_STDRPT_CASHBANK_AND_CASHBANKLN_BLKGRP_AND_BLK_GET_TEMP"
        Dim strOpCd_CashBank_SubBlk_GET As String = "CB_STDRPT_CASHBANK_AND_CASHBANKLN_SUBBLK_GET_TEMP"
        ...
        Dim strFileName As String = "CB_StdRpt_CashTransferList"
        ...
        If Not (Request.QueryString("CashBankIDFrom") = "" And Request.QueryString("CashBankIDTo") = "") Then
            SearchStr = SearchStr & "CB.CashBankID IN (SELECT SUBCB.CashBankID FROM CB_CASHBANKTEMP SUBCB WHERE SUBCB.CashBankID >= '" & Request.QueryString("CashBankIDFrom") & _
        ...
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=GET_CASHTRANSFER_LIST_REPORT&errmesg=" & lblErrMessage.Text & "&redirect=")
        End Try

        rdCrystalViewer.Load(objMapPath & "web\" & strLangCode & "\Reports\Crystal\CB_StdRpt_CashTransferList.rpt", OpenReportMethod.OpenReportByTempCopy)
        ...
        'crDiskFileDestinationOptions.DiskFileName = objMapPath & "web\ftp\CB_StdRpt_CashTransferList.pdf"
        ...
        'Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../ftp/CB_StdRpt_CashTransferList.pdf"">")
