...
Public Class PR_StdRpt_ADTrxListPreview : Inherits Page
    ...
    Dim strSelYear As String
    Dim strSelPeriod As String
    Dim strSelPeriodText As String
    ...
    Sub Page_Load(ByVal Sender As Object, ByVal E As EventArgs)
        ...
        Else
            ...
            strSrchGangCode = Trim(Request.QueryString("SrchGangCode"))
            ...
            strSelMonth = Request.QueryString("ddlSelMth")
            strSelYear = Request.QueryString("ddlSelYr")
            strSelPeriod = Request.QueryString("ddlSelPeriod")
            strSelPeriodText = Request.QueryString("lblSelPeriodText")
            strSelPeriodText = Request.QueryString("lblSelPeriodText")

            If Request.QueryString("SortBy") = "ad" Then
                strSortBy = "A.ADCode"
    ...
    Sub BindReport()
        ...
        Dim strSortExp As String = strSortBy & " " & strOrderBy

        strReportID = "RPTPR1000017"
        ...
        Try
            If Request.QueryString("SortBy") = "ad" Then
                strRptPrefix = "PR_StdRpt_ADTrxList"
            ElseIf Request.QueryString("SortBy") = "emp" Then
                strRptPrefix = "PR_StdRpt_ADTrxEmpList"
            End If

            strOpCd = "PR_STDRPT_ADTRXLIST_GET" & "|" & objPRRpt.mtdGetPRReportTable(objPRRpt.EnumPRReportTable.ADTrxList) & Chr(9) & _
            ...
            intErrNo = objPRRpt.mtdGetReport_ADTrxList(strOpCd, _
                                                       strCompany, _
                                                       strLocation, _
                                                       strUserId, _
                                                       strAccMonth, _
    ...
    Sub PassParam()
        ...
        ParamDiscreteValue9.Value = strVehCodeTag
        ParamDiscreteValue10.Value = strVehExpCodeTag
        If LCase(strBlkType) = "subblkcode" Then
            ParamDiscreteValue11.Value = strSubBlkCodeTag
        Else
            ParamDiscreteValue11.Value = strBlkCodeTag
        End If
        ParamDiscreteValue12.Value = strAccCodeTag
        ...
        Else
            ParamDiscreteValue17.Value = UCase(strSubBlkCodeTag)
        End If
        ...
        ParamDiscreteValue24.Value = strSelMonth
        ParamDiscreteValue25.Value = strSelYear
        ParamDiscreteValue26.Value = strSelPeriodText
        ParamDiscreteValue27.Value = Request.QueryString("SortByText")
        ParamDiscreteValue28.Value = Request.QueryString("OrderByText")
        ParamDiscreteValue29.Value = UCase(Request.QueryString("lblBlockTag"))
        ParamDiscreteValue30.Value = strSrchGangCode
        ...
        ParamFieldDef9 = ParamFieldDefs.Item("VehCodeTag")
        ParamFieldDef10 = ParamFieldDefs.Item("VehExpCodeTag")
        ...
        ParamFieldDef24 = ParamFieldDefs.Item("SelMonth")
        ParamFieldDef25 = ParamFieldDefs.Item("SelYear")
        ParamFieldDef26 = ParamFieldDefs.Item("SelPeriodText")
        ParamFieldDef27 = ParamFieldDefs.Item("SelSortBy")
        ParamFieldDef28 = ParamFieldDefs.Item("SelOrderBy")
        ParamFieldDef29 = ParamFieldDefs.Item("BlockTag")
