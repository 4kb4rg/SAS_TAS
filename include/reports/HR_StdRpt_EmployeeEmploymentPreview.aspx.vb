...
Public Class HR_StdRpt_EmployeeEmploymentPreview : Inherits Page
    ...
    Sub BindReport()
        ...
        Dim strOpCdEmpEmploymentGet As String = "HR_STDRPT_EMPLOYEEEMPLOYMENT_GET"
        ...
        Dim strRptFileName = "HR_StdRpt_EmployeeEmployment"
        ...
        Try
            intErrNo = objHRReport.mtdGetReport_HRGeneral(strOpCdEmpEmploymentGet, strParam, objRptDs, objMapPath)
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=GET_EMPLOYEE_EMPLOYMENT_REPORT&errmesg=" & lblErrMessage.Text & "&redirect=")
        End Try
    ...
    Sub PassParam()
        ...
        ParamDiscreteValue7.Value = Request.QueryString("Status") 'objHRSetup.mtdGetBonusStatus(Request.QueryString("Status"))
