...
Public Class WM_StdRpt_CPOBillRpt_Preview : Inherits Page
    ...
    Sub BindReport()
        ...
        Dim dsCPOBilling As New DataSet()
        Dim objMapPath As String

        Dim crExportOptions As ExportOptions
        Dim crDiskFileDestinationOptions As DiskFileDestinationOptions

        Dim strOpCd_CPO_Billing_GET As String = "WM_STDRPT_CPO_BILLING_REPORT_GET"
        Dim strFileName As String = "WM_StdRpt_CPO_Billing_Report"
        ...
        strParam = strUserLoc & "|" & Request.QueryString("strddlAccMth") & "|" & _
                   ...
                   searchStr
        Try
            intErrNo = objWM.mtdGetReport_CPOBilling_Report(strOpCd_CPO_Billing_GET, _
                                                            strParam, _
                                                            dsCPOBilling, _
                                                            objMapPath)
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=WM_STDRPT_CPO_BILLING_REPORT_GET&errmesg=" & lblErrMessage.Text & "&redirect=")
        End Try


        dsCPOBilling.Tables(0).TableName = "WM_CPO_BILLING_REPORT"


        rdCrystalViewer.Load(objMapPath & "web\" & strLangCode & "\Reports\Crystal\" & strFileName & ".rpt", OpenReportMethod.OpenReportByTempCopy)
        rdCrystalViewer.SetDataSource(dsCPOBilling.Tables("WM_CPO_BILLING_REPORT"))
