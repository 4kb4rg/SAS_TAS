...
Public Class PU_StdRpt_MthStockReceived : Inherits Page
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        Response.Write("<Script Language=""JavaScript"">window.open(""PU_StdRpt_MthStockReceivedPreview.aspx?CompName=" & strCompany & "&Location=" & strUserLoc & "&RptID=" & strRptID & "&RptName=" & strRptName & "&Decimal=" & strDec & _
                               "&DDLAccMth=" & strddlAccMth & "&DDLAccYr=" & strddlAccYr & "&lblLocation=" & lblLocation.Text & "&lblAccCode=" & lblAccCode.Text & "&lblVehCode=" & lblVehCode.Text & "&lblVehExpCode=" & lblVehExpCode.Text & "&lblBlkCode=" & lblBlkCode.Text & _
                               "&Supplier=" & strSupplier & "&RcvNoteIDFrom=" & strRcvNoteIDFrom & "&RcvNoteIDTo=" & strRcvNoteIDTo & "&RcvNoteDateFrom=" & strRcvNoteDateFrom & "&RcvNoteDateTo=" & strRcvNoteDateTo & _
