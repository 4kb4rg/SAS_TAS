...
Public Class WM_STDRPT_SELECTION_CTRL : Inherits UserControl
    ...
    Function BindAccYearList(ByVal pv_strLocation As String, _
        ...
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=WM_STDRPT_CTRL_ACCCFG_DIST_GET&errmesg=" & Exp.ToString() & "&redirect=")
        End Try
        ...
        If objAccCfg.Tables(0).Rows.Count > 0 Then      '--found year's record
            ...
            Try
                ...
                intErrNo = objAdmAcc.mtdGetAccPeriodCfg(strOpCd_Max_Get, _
                                                        ...
                                                        objAccCfg)
            Catch Exp As System.Exception
                Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=WM_STDRPT_CTRL_ACCCFG_MAX_GET&errmesg=" & Exp.ToString() & "&redirect=")
            End Try
            ...
            Catch Exp As System.Exception
                Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=WM_STDRPT_CTLR_ACCCFG_MAXPERIOD&errmesg=System required period configuration to process your request. Please set period configuration for the year of " & Convert.ToString(intAccYear) & "&redirect=")
            End Try
    ...
    Sub GetUserLoc()
        ...
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=GET_WM_SELECTIONCTRL_USERLOCATION&errmesg=" & Exp.ToString() & "&redirect=../en/reports/WM_StdRpt_Selection.aspx")
        End Try
    ...
    Sub BindReportNameList()
        ...
        strParam = " WHERE ReportType = '" & Convert.ToString(objGlobal.EnumStdRptType.MillWeighing) & "' AND Status = '" & Convert.ToString(objGlobal.EnumStdRptStatus.Active) & "' And RptLevel NOT IN ('0','1') ORDER BY RptName"
        Try
            intErrNo = objAdmin.mtdGetStdRptName(strOppCd_StdRptName_GET, strParam, dsForDropDown, objMapPath)
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=GET_WM_SELECTIONCTRL_REPORT_NAME_LIST&errmesg=" & Exp.ToString() & "&redirect=../en/reports/IN_StdRpt_Selection.aspx")
        End Try
    ...
    Sub CheckRptName(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If strSelectedIndex = "rptwm1000001" Then
            Response.Redirect("../../" & strLangCode & "/reports/WM_StdRpt_TransporterMasterList.aspx?RptName=" & strRptname & "&SelIndex=" & Convert.ToString(intSelectedIndex) & "&UserLoc=" & strUserLoc)
        ElseIf strSelectedIndex = "rptwm1000002" Then
            Response.Redirect("../../" & strLangCode & "/reports/WM_StdRpt_WeighBridge_Ticket_Listing.aspx?RptName=" & strRptname & "&SelIndex=" & Convert.ToString(intSelectedIndex) & "&UserLoc=" & strUserLoc)
        ElseIf strSelectedIndex = "rptwm1000003" Then
            Response.Redirect("../../" & strLangCode & "/reports/WM_StdRpt_FFBAssess_Listing.aspx?RptName=" & strRptname & "&SelIndex=" & Convert.ToString(intSelectedIndex) & "&UserLoc=" & strUserLoc)
        ElseIf strSelectedIndex = "rptwm1000004" Then
            Response.Redirect("../../" & strLangCode & "/reports/WM_StdRpt_Print_Ticket.aspx?RptName=" & strRptname & "&SelIndex=" & Convert.ToString(intSelectedIndex) & "&UserLoc=" & strUserLoc)
        ElseIf strSelectedIndex = "rptwm1000005" Then
            Response.Redirect("../../" & strLangCode & "/reports/WM_StdRpt_Daily_FFBRcv_Summary_Report.aspx?RptName=" & strRptname & "&SelIndex=" & Convert.ToString(intSelectedIndex) & "&UserLoc=" & strUserLoc)
        ElseIf strSelectedIndex = "rptwm1000006" Then

            Response.Redirect("../../" & strLangCode & "/reports/WM_StdRpt_Daily_FFBRcv_By_Supplier_Report.aspx?RptName=" & strRptname & "&SelIndex=" & Convert.ToString(intSelectedIndex) & "&UserLoc=" & strUserLoc)
        ElseIf strSelectedIndex = "rptwm1000007" Then
            Response.Redirect("../../" & strLangCode & "/reports/WM_StdRpt_FFBRcv_Summary_By_PlantYear.aspx?RptName=" & strRptname & "&SelIndex=" & Convert.ToString(intSelectedIndex) & "&UserLoc=" & strUserLoc)
        ElseIf strSelectedIndex = "rptwm1000008" Then
            Response.Redirect("../../" & strLangCode & "/reports/WM_StdRpt_LetterToSupp_FFBRcv_Summary.aspx?RptName=" & strRptname & "&SelIndex=" & Convert.ToString(intSelectedIndex) & "&UserLoc=" & strUserLoc)
        ElseIf strSelectedIndex = "rptwm1000009" Then
            Response.Redirect("../../" & strLangCode & "/reports/WM_StdRpt_FFB_Assess_BySupplier.aspx?RptName=" & strRptname & "&SelIndex=" & Convert.ToString(intSelectedIndex) & "&UserLoc=" & strUserLoc)
        ElseIf strSelectedIndex = "rptwm1000010" Then
            Response.Redirect("../../" & strLangCode & "/reports/WM_StdRpt_FFB_Assess_Summary.aspx?RptName=" & strRptname & "&SelIndex=" & Convert.ToString(intSelectedIndex) & "&UserLoc=" & strUserLoc)
        ElseIf strSelectedIndex = "rptwm1000011" Then
            Response.Redirect("../../" & strLangCode & "/reports/WM_StdRpt_CPO_Billing_Report.aspx?RptName=" & strRptname & "&SelIndex=" & Convert.ToString(intSelectedIndex) & "&UserLoc=" & strUserLoc)
        ElseIf strSelectedIndex = "rptwm1000012" Then
            Response.Redirect("../../" & strLangCode & "/reports/WM_StdRpt_PK_Billing_Report.aspx?RptName=" & strRptname & "&SelIndex=" & Convert.ToString(intSelectedIndex) & "&UserLoc=" & strUserLoc)
        ElseIf strSelectedIndex = "rptwm1000013" Then
            Response.Redirect("../../" & strLangCode & "/reports/WM_StdRpt_FFBRcv_Summary_By_Supplier.aspx?RptName=" & strRptname & "&SelIndex=" & Convert.ToString(intSelectedIndex) & "&UserLoc=" & strUserLoc)
        ElseIf strSelectedIndex = "rptwm1000014" Then
            Response.Redirect("../../" & strLangCode & "/reports/WM_StdRpt_Print_DeliveryOrder.aspx?RptName=" & strRptname & "&SelIndex=" & Convert.ToString(intSelectedIndex) & "&UserLoc=" & strUserLoc)
        ElseIf strSelectedIndex = "rptwm1000015" Then
            Response.Redirect("../../" & strLangCode & "/reports/WM_StdRpt_FFB_Price_Rpt.aspx?RptName=" & strRptname & "&SelIndex=" & Convert.ToString(intSelectedIndex) & "&UserLoc=" & strUserLoc)
        ElseIf strSelectedIndex = "rptwm1000017" Then
            Response.Redirect("../../" & strLangCode & "/reports/WM_StdRpt_CPO_Sales_Daily_Report.aspx?RptName=" & strRptname & "&SelIndex=" & Convert.ToString(intSelectedIndex) & "&UserLoc=" & strUserLoc)

        ElseIf strSelectedIndex = "rptwm1000018" Then
            Response.Redirect("../../" & strLangCode & "/reports/WM_StdRpt_Daily_FFBSales_Report.aspx?RptName=" & strRptname & "&SelIndex=" & Convert.ToString(intSelectedIndex) & "&UserLoc=" & strUserLoc)
