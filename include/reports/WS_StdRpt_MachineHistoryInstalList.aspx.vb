...
Public Class WS_StdRpt_MachineHistoryInstalList : Inherits Page
    ...
    Sub Page_Load(ByVal Sender As Object, ByVal E As EventArgs)
        ...
        Else
            If Not Page.IsPostBack Then
                BindAccYearList(strLocation, strAccYear, True)
                onload_GetLangCap()
                BindBlock("")
                BindSubBlock("")
    ...
    Sub BindBlock(ByVal pv_strBlockCode As String)
        ...
        Dim dr As DataRow
        Dim strParam As String = "|" & "And blk.Status = '" & objGLSetup.EnumBlockStatus.Active & "' and LocCode='" & strLocation & "'"
        ' & "|" & strLocation
        Dim intErrNo As Integer
        ...
        Catch Exp As Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=WS_TRX_REPLACEMENTSCHEDULE_BLOCK_GET&errmesg=" & Exp.ToString() & "&redirect=")
        End Try
    ...
    Sub onSelect_Block(ByVal Sender As Object, ByVal E As EventArgs)
        If Not (ddlBlock.SelectedItem.Value = "") Then
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        strYearperiod = lstAccYear.SelectedValue
        ...
        Try
            intErrNo = objSysCfg.mtdGetConfigInfo(strParam, _
                                                  ...
                                                  objSysCfgDs)
        Catch Exp As System.Exception
            Response.Redirect("../mesg/ErrorMessage.aspx?errcode=WS_STDRPT_ReplacementSchedule_GET_CONFIG_DATE&errmesg=" & lblErrMessage.Text & "&redirect=../en/reports/WS_StdRpt_Selection.aspx")
        End Try
        ...
        Response.Write("<Script Language=""JavaScript"">window.open(""WS_StdRpt_MachineHistoryInstalListPreview.aspx?Type=Print&CompName=" & strCompany & "&Location=" & strUserLoc & "&RptID=" & strRptID & "&RptName=" & strRptName & _
                       "&Decimal=" & strDec & "&lblBlkTag=" & lblBlkTag.Text & "&lblSubBlkTag=" & lblSubBlkTag.Text & _
                       "&BlkCode=" & strBlkCode & "&SubBlkCode=" & strSubBlkCode & "&StrYearPeriod=" & strYearperiod & "&ItemCode=" & strItemCode & _
                       "&ReplDateFrom=" & strReplDateFrom & "&ReplDateTo=" & strReplDateTo & _
        ...
        '    Response.Write("<Script Language=""JavaScript"">window.open(""WS_StdRpt_MachineHistoryInstalListPreview.aspx?Type=Print&CompName=" & strCompany & "&Location=" & strUserLoc & "&RptID=" & strRptID & "&RptName=" & strRptName & _
        '                    "&Decimal=" & strDec & "&lblBlkTag=" & lblBlkTag.Text & "&lblSubBlkTag=" & lblSubBlkTag.Text & _
        '                    "&BlkCode=" & strBlkCode & "&SubBlkCode=" & strSubBlkCode & "&ItemCode=" & strItemCode & _
        '                    "&ReplDateFrom=" & strReplDateFrom & "&ReplDateTo=" & strReplDateTo & _
        '                    """,null ,""status=yes, resizable=yes, scrollbars=yes, toolbar=no, location=no"");</Script>")
        'End If
    End Sub
