...
Public Class CT_StdRpt_MthlySalesList_Preview : Inherits Page
    ...
    Sub BindReport()
        ...
        Dim objRptDsQtyCostAmt As New DataSet()
        ...
        Dim strParamQtyCostAmt As String

        Dim crExportOptions As ExportOptions
        Dim crDiskFileDestinationOptions As DiskFileDestinationOptions

        Dim strOpCdStkIssue_GET_SP As String = "CT_STDRPT_MONTHLY_SALES_GET_SP"
        Dim strOpCdStkIssue_QtyCostAmt_GET As String = "CT_STDRPT_MONTHLY_SALES_QTYCOSTAMT_GET"
        ...
        strParam = Replace(strUserLoc, "'", "''") & "|" & strDDLAccMth & "|" & strDDLAccYr & "|''" & objCTTrx.EnumStockIssueStatus.Confirmed & "'',''" & _
                   objCTTrx.EnumStockIssueStatus.DBNote & "'',''" & objCTTrx.EnumStockIssueStatus.Closed & "''|" & _
                   objCTSetup.EnumInventoryItemType.CanteenItem & "|" & Replace(SearchStr, "'", "''")
        Try
            intErrNo = objCT.mtdGetReport_MthlySalesList(strOpCdStkIssue_GET_SP, strParam, objRptDs, objMapPath)
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=GET_CT_MTHLYSALES_LIST&errmesg=" & lblErrMessage.Text & "&redirect=")
        End Try
        ...
        rdCrystalViewer.Load(objMapPath & "web\" & strLangCode & "\Reports\Crystal\CT_StdRpt_MthlySalesList.rpt", OpenReportMethod.OpenReportByTempCopy)
        ...
        crDiskFileDestinationOptions.DiskFileName = objMapPath & "web\ftp\CT_StdRpt_MthlySalesList.pdf"
        ...
        Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../ftp/CT_StdRpt_MthlySalesList.pdf"">")
    End Sub
