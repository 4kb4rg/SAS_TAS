...
Public Class CB_StdRpt_ListOfBankTranPreview : Inherits Page
    ...
    Sub Page_Load(ByVal Sender As Object, ByVal E As EventArgs)
        ...
        strFileName = "CB_StdRpt_ListOfBankTran"
    ...
    Sub BindReport()
        ...
        Dim strOpCode As String = "CB_STDRPT_LISTOFBANKTRAN_GET"
        Dim strParam  As String = ""
        Dim objFTPFolder As String

        strParam = strDateFrom & "|" & strDateTo & "|" & strBankCodeFrom & "|" & strBankCodeTo & "|" &  strStatus & "|" &  strLocation

        Try
            intErrNo = objCB.mtdGetReport_ListOfBankTran(strOpCode, strParam, objRptDs, objMapPath, objFTPFolder)
        Catch Exp As Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=CB_StdRpt_ListOfBankTranPreview&errmesg=" & lblErrMessage.Text & "&redirect=")
        End Try
    ...
    Sub PassParam()
        ...
        ParamDiscreteValue7.Value = strDateFrom & " To " & strDateTo
