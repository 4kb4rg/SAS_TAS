...
Public Class AP_StdRpt_InvRcvListing : Inherits Page
    ...
    Sub BindStatus()
        ...
        ddlStatus.Items.Add(New ListItem(objAP1.mtdGetInvoiceRcvStatus(objAP1.EnumInvoiceRcvStatus.Active), objAP1.EnumInvoiceRcvStatus.Active))
        ddlStatus.Items.Add(New ListItem(objAP1.mtdGetInvoiceRcvStatus(objAP1.EnumInvoiceRcvStatus.Confirmed), objAP1.EnumInvoiceRcvStatus.Confirmed))
        ddlStatus.Items.Add(New ListItem(objAP1.mtdGetInvoiceRcvStatus(objAP1.EnumInvoiceRcvStatus.Deleted), objAP1.EnumInvoiceRcvStatus.Deleted))
        ddlStatus.Items.Add(New ListItem(objAP1.mtdGetInvoiceRcvStatus(objAP1.EnumInvoiceRcvStatus.Cancelled), objAP1.EnumInvoiceRcvStatus.Cancelled))
        ddlStatus.Items.Add(New ListItem(objAP1.mtdGetInvoiceRcvStatus(objAP1.EnumInvoiceRcvStatus.WriteOff), objAP1.EnumInvoiceRcvStatus.WriteOff))
        ddlStatus.Items.Add(New ListItem(objAP1.mtdGetInvoiceRcvStatus(objAP1.EnumInvoiceRcvStatus.Closed), objAP1.EnumInvoiceRcvStatus.Closed))
        ddlStatus.Items.Add(New ListItem(objAP1.mtdGetInvoiceRcvStatus(objAP1.EnumInvoiceRcvStatus.Paid), objAP1.EnumInvoiceRcvStatus.Paid))
    End Sub
    ...
    Sub onload_GetLangCap()
        ...
        lblInvRcvRefDateFrom.Text = lblInvRcv.Text & lblRefDateFrom.Text
        lblInvRcvRefDateTo.Text = lblInvRcv.Text & lblRefDateTo.Text
        ...
        If Not (strDateFrom = "" And strDateTo = "") Then
            If objGlobal.mtdValidInputDate(strDateSetting, strDateFrom, objDateFormat, objDateFrom) = True And objGlobal.mtdValidInputDate(strDateSetting, strDateTo, objDateFormat, objDateTo) = True Then
                Response.Write("<Script Language=""JavaScript"">window.open(""AP_StdRpt_InvRcvListingPreview.aspx?CompName=" & strCompany & "&Location=" & strUserLoc & "&RptID=" & strRptID & "&RptName=" & strRptName & "&Decimal=" & strDec & _
                            ...
                            "&txtCreditTermTypeValue=" & Trim(ddlTermType.SelectedItem.Value) & "&txtCreditTerm=" & Trim(txtCreditTerm.Text) & "&txtCreditTermType=" & Trim(ddlTermType.SelectedItem.Text) & "&txtItemCode=" & Server.UrlEncode(Trim(txtItemCode.Text)) & "&txtCOACode=" & Server.UrlEncode(Trim(txtCOACode.Text)) & "&txtBlock=" & Server.UrlEncode(strBlock) & "&txtVehicle=" & Server.UrlEncode(Trim(txtVehicle.Text)) & _
                            ...
                            "&lblProdTypeCode=" & Trim(lblProdTypeCode.Text) & "&lblProdBrandCode=" & Trim(lblProdBrandCode.Text) & "&lblProdModelCode=" & Trim(lblProdModelCode.Text) & "&lblProdCatCode=" & Trim(lblProdCatCode.Text) & "&lblProdMatCode=" & Trim(lblProdMatCode.Text) & _
                            "&lblStkAnaCode=" & Trim(lblStkAnaCode.Text) & "&lblCOACode=" & Trim(lblCOACode.Text) & "&lblVehicle=" & Trim(lblVehicle.Text) & "&lblVehicleType=" & Trim(lblVehicleType.Text) & "&lblVehicleExp=" & Trim(lblVehicleExp.Text) & _
                            ...
                            "&txtProdType=" & Server.UrlEncode(Trim(txtProdType.Text)) & "&txtProdBrand=" & Server.UrlEncode(Trim(txtProdBrand.Text)) & "&txtProdModel=" & Server.UrlEncode(Trim(txtProdModel.Text)) & "&txtProdCat=" & Server.UrlEncode(Trim(txtProdCat.Text)) & "&txtProdMaterial=" & Server.UrlEncode(Trim(txtProdMaterial.Text)) & "&txtStkAna=" & Server.UrlEncode(Trim(txtStkAna.Text)) & _
