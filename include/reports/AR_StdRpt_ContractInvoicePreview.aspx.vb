...
Public Class AR_StdRpt_ContractInvoicePreview : Inherits Page
    ...
    Sub Page_Load(ByVal Sender As Object, ByVal E As EventArgs)
        ...
        Else
            ...
            strBankAccOwner = Trim(Request.QueryString("BankAccOwner"))
            ...
            If Trim(strToInvoiceId) <> "" Then
                strSearchExp = strSearchExp & "and inv.InvoiceId <= '" & strToInvoiceId & "' "
            End If
    ...
    Sub BindReport()
        ...
        Select Case CInt(strInvoiceType)
            Case objBITrx.EnumInvoiceDocType.Manual 
                strRptPrefix = "AR_StdRpt_ManualInvoice"
        ...
        For intCnt = 0 To objRptDs.Tables(0).Rows.Count - 1
            ...
            Else
                totalRp = Trim(CStr(objRptDs.Tables(0).Rows(intCnt).Item("Amount") - objRptDs.Tables(0).Rows(intCnt).Item("PPNAmount")))
            End If
    ...
    Sub PassParam()
        ...
        if CInt(strInvoiceType) =  objBITrx.EnumInvoiceDocType.Manual  then
        ...
        End If
        ParamDiscreteValue13.Value = strPrintDate
        ParamDiscreteValue14.Value = strPPN
        ParamDiscreteValue15.Value = strProduct
        ParamDiscreteValue16.Value = strUOM
        ParamDiscreteValue17.Value = strBankAccOwner
        ...
        ParamFieldDef13 = ParamFieldDefs.Item("PrintDate")
        ParamFieldDef14 = ParamFieldDefs.Item("PPN")
        ParamFieldDef15 = ParamFieldDefs.Item("Product")
        ParamFieldDef16 = ParamFieldDefs.Item("UOM")
        ParamFieldDef17 = ParamFieldDefs.Item("BankAccOwner")
