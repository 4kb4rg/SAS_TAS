...
Public Class PM_StdRpt_KernelLossesTransactionList : Inherits Page
    ...
    Dim objProcessingLine As New Object()
    ...
    Sub BindProcessingLineList()
        ...
        ddlProcessingLnNo.Items.Add(New ListItem("All"))
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        strProcessingLnNo = Trim(ddlProcessingLnNo.SelectedItem.Text)
        ...
        Try
            intErrNo = objSysCfg.mtdGetConfigInfo(strParam, _
                                                  ...
                                                  objSysCfgDs)
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=PM_STDRPT_Produced_Kernel_Quality_GET_CONFIG_DATE&errmesg=" & lblErrMessage.Text & "&redirect=../en/reports/PM_StdRpt_Selection.aspx")
        End Try
        ...
        If Not (strDateFrom = "" And strDateTo = "") Then
            If objGlobal.mtdValidInputDate(strDateSetting, strDateFrom, objDateFormat, objDateFrom) = True And objGlobal.mtdValidInputDate(strDateSetting, strDateTo, objDateFormat, objDateTo) = True Then
                Response.Write("<Script Language=""JavaScript"">window.open(""PM_StdRpt_KernelLossesTransactionListPreview.aspx?Type=Print&Location=" & strUserLoc & "&RptID=" & strRptID & "&RptName=" & strRptName & "&Decimal=" & strDec & _
        ...
        Else
            Response.Write("<Script Language=""JavaScript"">window.open(""PM_StdRpt_KernelLossesTransactionListPreview.aspx?Type=Print&Location=" & strUserLoc & "&RptID=" & strRptID & "&RptName=" & strRptName & "&Decimal=" & strDec & _
                                "&DateFrom=" & objDateFrom & "&DateTo=" & objDateTo & _
                                "&ProcessingLnNo=" & strProcessingLnNo & _
                                "&AccMonth=" & strAccMonth & "&AccYear=" & strAccYear & _
                                "&lblLocation=" & strLblLocation & _
                                "&Status=" & strStatus & """,null ,""status=yes, resizable=yes, scrollbars=yes, toolbar=no, location=no"");</Script>")
        End If
