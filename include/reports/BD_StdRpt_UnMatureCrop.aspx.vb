...
Public Class BD_StdRpt_UnMatureCrop : Inherits Page
    ...
    Sub onload_GetLangCap()
        ...
        lblTitle.Text = "BUDGETING - IMMATURE CROP ACTIVITY"
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        Response.Write("<Script Language=""JavaScript"">window.open(""BD_StdRpt_UnMatureCropPreview.aspx?DDLPeriodID=" & strddlPeriodID & "&DDLPeriodName=" & strddlPeriodName & _
