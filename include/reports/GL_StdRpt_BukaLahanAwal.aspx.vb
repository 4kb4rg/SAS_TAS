...
Public Class GL_StdRpt_BukaLahanAwal : Inherits Page
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        strSrchAccMonth = Trim(ddlist.SelectedItem.Value)
       ...
       End If
        ...
        Response.Write("<Script Language=""JavaScript"">window.open(""GL_StdRpt_BukaLahanAwalPreview.aspx?Type=Print&CompName=" & strCompany & _
