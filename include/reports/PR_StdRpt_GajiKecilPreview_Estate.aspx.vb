...
Public Class PR_StdRpt_GajiKecilPreview_Estate : Inherits Page
    ...
    Sub BindReport()
        ...
        Dim strOpCd As String = "PR_PR_STDRPT_GAJIKECIL_REPORT"
        ...
        If objRptDs.Tables(0).Rows.Count > 0 Then
            For intcnt = 0 To objRptDs.Tables(0).Rows.Count - 1
                totalrp = Trim(CStr(FormatNumber(objRptDs.Tables(0).Rows(intcnt).Item("TotSmallpay"), 2)))
        ...
        rdCrystalViewer.Load(objMapPath & "web\" & strLangCode & "\reports\crystal\PR_StdRpt_GajiKecil_Estate.rpt", OpenReportMethod.OpenReportByTempCopy)
        ...
        If strExportToExcel = "0" Then
            crDiskFileDestinationOptions.DiskFileName = objMapPath & "web\ftp\PR_StdRpt_GajiKecil_Estate.pdf"
        Else
            crDiskFileDestinationOptions.DiskFileName = objMapPath & "web\ftp\PR_StdRpt_GajiKecil_Estate.xls"
        End If
        ...
        If strExportToExcel = "0" Then
            Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../ftp/PR_StdRpt_GajiKecil_Estate.pdf"">")
        Else
            Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../ftp/PR_StdRpt_GajiKecil_Estate.xls"">")
        End If
