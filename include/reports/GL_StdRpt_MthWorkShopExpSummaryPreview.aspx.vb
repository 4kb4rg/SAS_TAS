...
Public Class GL_StdRpt_MthWorkShopExpSummaryPreview : Inherits Page
    ...
    Sub BindReport()
        ...
        strRptPrefix = "GL_StdRpt_MthWorkShopExpSummary"
        strOpCd = "GL_STDRPT_MONTH_WORKSHOP_EXPENDITURE_SUMM_GET_SP" & "|GL_MTHWSEXPSUMM"
        ...
        Try
            ...
            intErrNo = objGLRpt.mtdGetReport_MthExpWSSumm(strOpCd, _
                                                        strCompany, _
                                                        strLocation, _
                                                        strUserId, _
                                                        strAccMonth, _
        ...
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=GL_STDRPT_MONTH_WORKSHOP_EXPENDITURE_SUMM_GET_SP&errmesg=" & Exp.ToString() & "&redirect=")
        End Try
