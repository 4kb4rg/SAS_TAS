...
Public Class GL_StdRpt_ProfitLossPreview : Inherits Page
    ...
    Sub GetLastYearEndPeriod(ByVal pv_strStmtAccYear As String, ByRef pr_strEndMonth as String, ByRef pr_strEndYear As String)
        ...
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=GL_STDRPT_PROFLOSS_GETENDACCMONTH&errmesg=" & lblErrMessage.Text & "&redirect=")
        End Try
    ...
    Sub BindReport()
        ...
        Dim pv_strOpCdGetProfLoss As String
        ...
        If Lcase(strPrintStmtBy) = "comp" Then
            strRptPrefix = "GL_StdRpt_CompProfLoss"
            pv_strOpCdGetProfLoss = "GL_STDRPT_COMPPROFLOSS_GETSP"

        Else
            strRptPrefix = "GL_StdRpt_LocProfLoss"
            pv_strOpCdGetProfLoss = "GL_STDRPT_LOCPROFLOSS_GETSP"
        End If
        ...
        Try
            ...
            intErrNo = objGLRpt.mtdGetReport_ProfLoss(pv_strOpCdGetStmtFig, _
                                                      pv_strOpCdGetProfLoss, _
                                                      pv_strOpCdGetTmpl, _
                                                      pv_strOpCdGetCfg, _
                                                      pv_strOpCdAddTmpl, _
                                                      pv_strOpCd_SP, _
        ...
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=GL_STDRPT_PROFLOSS_GET&errmesg=" & Exp.ToString() & "&redirect=")
        End Try 
    ...
    Sub GetEntireLangCap()
        ...
        Try
            intErrNo = objLangCap.mtdGetBussTerm(strOpCode_BussTerm, _
                                                 ...
                                                 strParam)
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=GL_STDRPT_PROFLOSS_GET_LANGCAP&errmesg=" & Exp.ToString() & "&redirect=")
        End Try
