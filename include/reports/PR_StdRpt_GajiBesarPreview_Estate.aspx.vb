...
Public Class PR_StdRpt_GajiBesarPreview_Estate : Inherits Page
    ...
    Sub BindReport()
        ...
        StrRptName = ""
        If rptType = "1" Then
            StrRptName = "PR_StdRpt_GajiBesar_Estate"
        Else
            StrRptName = "PR_StdRpt_GajiBesar_Summary_Estate"
        End If
        ...
        Else
            crDiskFileDestinationOptions.DiskFileName = objMapPath & "web\ftp\" & StrRptName & ".xls"
        End If
        ...
        Else
            Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../ftp/" & StrRptName & ".xls"">")
        End If
    End Sub
