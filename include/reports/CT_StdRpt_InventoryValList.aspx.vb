...
Public Class CT_StdRpt_InventoryValList : Inherits Page
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        Response.Write("<Script Language=""JavaScript"">window.open(""CT_StdRpt_InventoryValListPreview.aspx?Type=Print&CompName=" & strCompany & _
