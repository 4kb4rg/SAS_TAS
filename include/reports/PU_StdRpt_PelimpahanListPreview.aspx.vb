...
Public Class PU_StdRpt_PelimpahanListPreview : Inherits Page
    ...
    Sub BindReport()
        ...
        Dim strOpCdPelimpahan_GET As String = "PU_STDRPT_PELIMPAHAN_LISTING"
        ...
        If Not Request.QueryString("ItemCode") = "" Then
            SearchStr = SearchStr & "c.ItemCode LIKE '" & Request.QueryString("ItemCode") & "' AND "
        Else
            SearchStr = SearchStr & "c.ItemCode LIKE '%' AND "
        End If


        If Not Request.QueryString("PelimpahanType") = "" Then
            If Not Request.QueryString("PelimpahanType") = objAdm.EnumLocLevel.All Then
                SearchStr = SearchStr & "a.PelimpahanType = '" & Request.QueryString("PelimpahanType") & "' AND "
            Else
                SearchStr = SearchStr & "a.PelimpahanType LIKE '%' AND "
            End If
        End If
        ...
        if strUserLoc <> "" then 
            SearchStr = SearchStr & " a.loccode in ( '" & strUserLoc & "') Or a.PelimpahanType In ( '" & strUserLoc & "') AND "
        end if 
        ...
        Try
            intErrNo = objPU.mtdGetReport_RPHList(strOpCdPelimpahan_GET, strParam, objRptDs, objMapPath)
        ...
        rdCrystalViewer.Load(objMapPath & "web\" & strLangCode & "\Reports\Crystal\PU_StdRpt_PelimpahanList.rpt", OpenReportMethod.OpenReportByTempCopy)
        ...
        crDiskFileDestinationOptions.DiskFileName = objMapPath & "web\ftp\PU_StdRpt_PelimpahanList.pdf"
        ...
        Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../ftp/PU_StdRpt_PelimpahanList.pdf"">")
    End Sub
    ...
    Sub PassParam()
        ...
        paramField21 = paramFields.Item("ParamPelimpahanType")
        ...
        ParamDiscreteValue21.Value = Request.QueryString("PelimpahanType")
