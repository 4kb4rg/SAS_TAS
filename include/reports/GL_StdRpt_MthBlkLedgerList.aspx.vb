...
Public Class GL_StdRpt_MthBlkLedgerList : Inherits Page
    ...
    Sub GetEntireLangCap()
        ...
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=GL_STDRPT_MTHBLKLEDGERLIST_BUSSTERM_GET&errmesg=" & lblErrMessage.Text & "&redirect=../en/reports/IN_StdRpt_Selection.aspx")
        End Try
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
       ...
       End If
        ...
        Response.Write("<Script Language=""JavaScript"">window.open(""GL_StdRpt_MthBlkLedgerListPreview.aspx?Type=Print&CompName=" & strCompany & _
                       ...
                       "&SrchVehCode=" & strSrchVehCode & _
                       "&SrchVehExpCode=" & strSrchVehExpCode & _
                       "&AccType=" & strAccType & _
                       "&AccTypeText=" & strAccTypeText & _
                       "&WithTrans=" & strWithTrans & _
