...
Public Class PR_StdRpt_PieceRatePayTrxListPreview : Inherits Page
    ...
    Dim strSrchGroupRef As String
    Dim strSrchRefDate As String
    ...
    Sub Page_Load(ByVal Sender As Object, ByVal E As EventArgs)
        ...
        Else
            ...
            strSrchGroupRef = Trim(Request.QueryString("strSrchGroupRef"))
            strSrchRefDate = Trim(Request.QueryString("strSrchRefDate"))
    ...
    Sub BindReport()
        ...
        Dim strOpCd_PieceRatePay_Trx_GET As String = "PR_STDRPT_PIECERATEPAYTRXLIST_GET"
        ...
        If Request.QueryString("SortBy") = "code" Then
            strSortBy = "PRLN.EmpCode"
        ElseIf Request.QueryString("SortBy") = "other" Then
            strSortBy = "PR.Description"
        End If
        ...
        Try
            ...
            strParam = strSelLocCode & "|" & _
                       ...
                       strSrchTrxStatus & "|" & _
                       strSortBy & "|" & _
                       Request.QueryString("OrderBy") & "|" & _
                       strGangCode & "|" & _
                       Convert.ToString(objHRSetup.EnumGangStatus.Active) & "|" & _
                       strSrchGroupRef & "|" & _
                       strSrchRefDate

            intErrNo = objPRRpt.mtdGetReport_PieceRatePayTrxList(strOpCd_PieceRatePay_Trx_GET, _
                                                                strCompany, _
                                                                strLocation, _
                                                                strUserId, _
                                                                strAccMonth, _
        ...
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=PR_STDRPT_PIECERATEPAY_TRXLIST&errmesg=" & Exp.ToString() & "&redirect=")
        End Try


        objRptDs.Tables(0).TableName = objPRRpt.mtdGetPRReportTable(objPRRpt.EnumPRReportTable.PieceRatePayTrxList)

        rdCrystalViewer = New ReportDocument()
        If Request.QueryString("SortBy") = "code" Then
            rdCrystalViewer.Load(objMapPath & "web\" & strLangCode & "\Reports\Crystal\PR_StdRpt_PieceRatePayTrxList.rpt", OpenReportMethod.OpenReportByTempCopy)
        Else
            rdCrystalViewer.Load(objMapPath & "web\" & strLangCode & "\Reports\Crystal\PR_StdRpt_PieceRatePayTrxOtherList.rpt", OpenReportMethod.OpenReportByTempCopy)
        End If
        ...
        If Request.QueryString("SortBy") = "code" Then
            crDiskFileDestinationOptions.DiskFileName = objMapPath & "web\ftp\PR_StdRpt_PieceRatePayTrxList.pdf"
        Else
            crDiskFileDestinationOptions.DiskFileName = objMapPath & "web\ftp\PR_StdRpt_PieceRatePayTrxOtherList.pdf"
        End If
        ...
        If Request.QueryString("SortBy") = "code" Then
            Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../ftp/PR_StdRpt_PieceRatePayTrxList.pdf"">")
        Else
            Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../ftp/PR_StdRpt_PieceRatePayTrxOtherList.pdf"">")
        End If
    ...
    Sub PassParam()
        ...
        ElseIf Trim(Request.QueryString("SortBy")) = "other" Then
            ParamDiscreteValue28.Value = "Description / Piece Rate No."
        End If
        ...
        ParamDiscreteValue31.Value = strDocNoFrom
        ParamDiscreteValue32.Value = strDocNoTo
        ParamDiscreteValue33.Value = strSrchGroupRef
        ParamDiscreteValue34.Value = strSrchRefDate
        ParamDiscreteValue35.Value = IIf(Session("SS_INTER_ESTATE_CHARGING"), "true", "false")
        ...
        ParamFieldDef31 = ParamFieldDefs.Item("ParamDocNoFrom")
        ParamFieldDef32 = ParamFieldDefs.Item("ParamDocNoTo")
        ParamFieldDef33 = ParamFieldDefs.Item("SrchGroupRef")
        ParamFieldDef34 = ParamFieldDefs.Item("SrchRefDate")
        ParamFieldDef35 = ParamFieldDefs.Item("ParamInterEstateEnabled")
