...
Public Class BD_StdRpt_ExtractionRateList : Inherits Page
    ...
    Sub BindStatusList()
        ddlStatus.Items.Add(New ListItem(objBDTrx.mtdGetExtractRateStatus(objBDTrx.EnumExtractRateStatus.All), objBDTrx.EnumExtractRateStatus.All))
        ddlStatus.Items.Add(New ListItem(objBDTrx.mtdGetExtractRateStatus(objBDTrx.EnumExtractRateStatus.Active), objBDTrx.EnumExtractRateStatus.Active))
        ddlStatus.Items.Add(New ListItem(objBDTrx.mtdGetExtractRateStatus(objBDTrx.EnumExtractRateStatus.Budgeted), objBDTrx.EnumExtractRateStatus.Budgeted))
    End Sub
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        If strUpdatedDateFrom<>"" And strUpdatedDateTo<>"" Then
            ...
            End If
        End If
        Response.Write("<Script Language=""JavaScript"">window.open(""BD_StdRpt_ExtractionRateListPreview.aspx?MonthFrom=" & strMonthFrom & "&MonthTo=" & strMonthTo & "&UpdatedDateFrom=" & objDateFrom & "&UpdatedDateTo=" & objDateTo & _
