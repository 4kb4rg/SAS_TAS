...
Public Class NU_StdRpt_SeedlingsIssueListMi : Inherits Page
    ...
    Sub ibPrintPreview_OnClick(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        strPlantMaterial =  Server.UrlEncode(txtPlantMaterial.Text.Trim())        
        ...
        Response.Write("<Script Language=""JavaScript"">window.open(""NU_StdRpt_SeedlingsIssueListMiPreview.aspx?Type=Print&CompName=" & strCompany & "&Location=" & strUserLoc & "&RptID=" & strRptID & "&RptName=" & strRptName & "&Decimal=" & strDec & _
                        ...
                        "&lblBlkType=" & lblBlkType.Text & "&lblBlkGrp=" & lblBlkGrp.Text & "&PlantMaterial=" & strPlantMaterial & _
