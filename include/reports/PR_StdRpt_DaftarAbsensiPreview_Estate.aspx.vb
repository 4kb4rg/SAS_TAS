...
Public Class PR_StdRpt_DaftarAbsensiPreview_Estate : Inherits Page
 ...
 Dim objFTPFolder As String
    ...
    Sub Page_Load(ByVal Sender As Object, ByVal E As EventArgs)
        ...
        strEmpTipe = Request.QueryString("Emptype")
        strTypeRpt = Request.QueryString("Rpttype")
    ...
    Sub BindReport()
        ...
        Dim strOpCd As String = "PR_PR_STDRPT_DAFTAR_ABSENSI_REPORT"
        ...
        strParamName = "ACCMONTH|ACCYEAR|PHYMONTH|PHYYEAR|COMPCODE|LOCCODE|DATEFROM|DATETO|DECIMAL|F_EMPCODE|F_DIVCODE|F_MCODE|F_DIVKERJA|F_EMPTIPE"
        ...
        rdCrystalViewer.Load(objMapPath & "web\" & strLangCode & "\reports\crystal\PR_StdRpt_DaftarAbsensi_Estate.rpt", OpenReportMethod.OpenReportByTempCopy)
		...
		If strExportToExcel = "0" Then
			crDiskFileDestinationOptions.DiskFileName = objMapPath & "web\ftp\PR_StdRpt_DaftarAbsensi_Estate.pdf"
		Else
			crDiskFileDestinationOptions.DiskFileName = objMapPath & "web\ftp\PR_StdRpt_DaftarAbsensi_Estate.xls"
		End If
		...
		If strExportToExcel = "0" Then
			Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../ftp/PR_StdRpt_DaftarAbsensi_Estate.pdf"">")
        Else
			Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../ftp/PR_StdRpt_DaftarAbsensi_Estate.xls"">")
		End If
    End Sub
    ...
    Sub BindReportRekap()
        ...
        Dim crExportOptions As ExportOptions
        Dim crDiskFileDestinationOptions As DiskFileDestinationOptions
        Dim strOpCd As String = "PR_PR_STDRPT_DAFTAR_ABSENSI_REKAP_REPORT"
        Dim strParamName As String
        Dim strParamValue As String
        Dim ReportID As String = Request.QueryString("RptID")
        ...
        strParamName = "ACCMONTH|ACCYEAR|LOCCODE|F_EMPTIPE|F_DIVCODE"
        ...
        rdCrystalViewer.Load(objMapPath & "web\" & strLangCode & "\reports\crystal\PR_StdRpt_Attendance_Det.rpt", OpenReportMethod.OpenReportByTempCopy)
        rdCrystalViewer.SetDataSource(objRptDs.Tables(0))
        ...
        crDiskFileDestinationOptions = New DiskFileDestinationOptions()
		If strExportToExcel = "0" Then
			crDiskFileDestinationOptions.DiskFileName = objMapPath & "web\ftp\PR_StdRpt_Attendance_Det.pdf"
		Else
			crDiskFileDestinationOptions.DiskFileName = objMapPath & "web\ftp\PR_StdRpt_Attendance_Det.xls"
		End If
		...
		If strExportToExcel = "0" Then
			Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../ftp/PR_StdRpt_Attendance_Det.pdf"">")
		Else
			Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../ftp/PR_StdRpt_Attendance_Det.xls"">")
		End If
