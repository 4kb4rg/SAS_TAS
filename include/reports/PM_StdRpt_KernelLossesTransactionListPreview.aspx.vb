...
Public Class PM_StdRpt_KernelLossesTransactionListPreview : Inherits Page
    ...
    Sub BindReport()
        ...
        Dim strOpCdPR_GET As String = "PM_CLSRPT_KERNEL_LOSSES_GET"

        SearchStr = " AND PMKL.LocCode IN('" & strUserLoc & "') "

        If Not (Request.QueryString("DateFrom") = "" And Request.QueryString("DateTo") = "") Then
            SearchStr = SearchStr & " AND (DateDiff(Day, '" & Session("SS_DATEFROM") & "', PMKL.TransDate) >= 0) And (DateDiff(Day, '" & Session("SS_DATETO") & "', PMKL.TransDate) <= 0) "
        End If

        If Not (strProcessingLnNo = "All") Then
            SearchStr = SearchStr & " AND PMKL.ProcessLnNo='" & strProcessingLnNo & "' "
        End If

        strParam = strUserLoc & "|" & strAccMonth & "|" & strAccYear & "||" & SearchStr

        Try
            intErrNo = objPM.mtdGetKernelLosses(strOpCdPR_GET, strParam, objRptDs, objMapPath)
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=GET_PM_KERNEL_LOSSES_GET_LIST_REPORT&errmesg=" & lblErrMessage.Text & "&redirect=")
        End Try



        rdCrystalViewer.Load(objMapPath & "web\" & strLangCode & "\Reports\Crystal\PM_StdRpt_KernelLossesTransactionList.rpt", OpenReportMethod.OpenReportByTempCopy)
        ...
        crDiskFileDestinationOptions.DiskFileName = objMapPath & "web\ftp\PM_StdRpt_KernelLossesTransactionList.pdf"
        ...
        Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../ftp/PM_StdRpt_KernelLossesTransactionList.pdf"">")
    End Sub
    ...
    Sub PassParam()
        ...
        paramField14 = paramFields.Item("ParamProcessingLnNo")
        ...
        crParameterValues14 = paramField13.CurrentValues
        ...
        ParamDiscreteValue14.Value = strProcessingLnNo
