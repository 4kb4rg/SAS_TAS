...
Public Class BD_StdRpt_CropDistSBlkPreview : Inherits Page
    ...
    Sub BindReport()
        ...
        Dim strOpCd_CropDist_GET As String = "BD_STDRPT_CROPDIST_SBLK_GET"
        ...
        ElseIf strBlkType = "SubBlkCode" Then
            If Not Request.QueryString("SubBlkCode") = "" Then
                SearchStr = " AND CD.BlkCode LIKE '" & Request.QueryString("SubBlkCode") & "' "
            End If
        End If
        ...
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=BD_CROP_DIST_SBLK&errmesg=" & lblErrMessage.Text & "&redirect=")
        End Try


        rdCrystalViewer.Load(objMapPath & "web\" & strLangCode & "\Reports\Crystal\BD_StdRpt_CropDist_SubBlock.rpt", OpenReportMethod.OpenReportByTempCopy)
        ...
        crDiskFileDestinationOptions.DiskFileName = objMapPath & "web\ftp\BD_StdRpt_CropDist_SubBlock.pdf"
        ...
        Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../ftp/BD_StdRpt_CropDist_SubBlock.pdf"">")
    End Sub
    ...
    Sub PassParam()
        ...
        paramField8 = paramFields.Item("lblSubBlkCodeTag")
        paramField9 = paramFields.Item("lblBlkCodeTag")
        paramField10 = paramFields.Item("ParamBlkType")
        ...
        ParamDiscreteValue8.Value = Request.QueryString("lblSubBlkCodeTag")
        ParamDiscreteValue9.Value = Request.QueryString("lblBlkCodeTag")
        ParamDiscreteValue10.Value = Request.QueryString("BlkType")
    ...
    Sub GetEntireLangCap()
        ...
        Try
            intErrNo = objLangCap.mtdGetBussTerm(strOpCode_BussTerm, _
                                                 ...
                                                 strParam)
        Catch Exp As System.Exception
            Response.Redirect("../../../include/mesg/ErrorMessage.aspx?errcode=BD_CROPDISTSBLK_LANGCAP_GET&errmesg=" & lblErrMessage.Text & "&redirect=")
        End Try
