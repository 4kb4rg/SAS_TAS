...
Public Class WS_StdRpt_StkMoveDetList_Preview : Inherits Page
    ...
    Sub BindReport()
        ...
        Dim strOpCd As String = "WS_STDRPT_ITEMMOVEDET_ITEM_SP|ITEM" 
        ...
        Try
			...
			intErrNo = objWSReport.mtdGetItemMoveDetItemListSP(strCompany, _
                                                            strLocation, _
                                                            strUserId, _
                                                            strAccMonth, _
                                                            strAccYear, _
        ...
        Catch Exp As System.Exception
            Response.Redirect("include/mesg/ErrorMessage.aspx?errcode=WS_RPT_GET_ITEM_MOVEDET_LIST&errmesg=" & Exp.ToString() & "&redirect=")
        End Try


        rdCrystalViewer.Load(objMapPath & "web\" & strLangCode & "\Reports\Crystal\WS_StdRpt_StkMoveDetList.rpt", OpenReportMethod.OpenReportByTempCopy)
        ...
        crDiskFileDestinationOptions.DiskFileName = objMapPath & "web\ftp\WS_StdRpt_StkMoveDetList.pdf"
        ...
        Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../ftp/WS_StdRpt_StkMoveDetList.pdf"">")
