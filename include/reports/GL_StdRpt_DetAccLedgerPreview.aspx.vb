...
Public Class GL_StdRpt_DetAccLedgerPreview : Inherits Page
    ...
    Sub BindReport()
        ...
        Try
            ...
            Catch Exp As System.Exception
                Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=GL_STDRPT_DETAILED_ACCOUNT_LEDGER_GET&errmesg=" & err.description & "&redirect=")
            End Try
        ...
        For Each myTable In rdCrystalViewer.Database.Tables
            ...
            If myTable.Name = "GL_DETACCLEDGER" Then
    ...
    Sub PassParam()
        ...
        ParamDiscreteValue27.Value = strUserID
        ...
        ParamFieldDef27 = ParamFieldDefs.Item("UserID")
