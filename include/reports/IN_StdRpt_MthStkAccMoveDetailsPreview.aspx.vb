...
Public Class IN_StdRpt_MthStkAccMoveDetails_Preview : Inherits Page
    ...
    Sub BindReport()
        ...
        Dim strOpCd As String = "IN_STDRPT_MTHSTKACCMOVEDET_GET_SP"
        ...
        Try
            intErrNo = objIN.mtdGetReport_MthStkAccMoveDetails(strOpCd, Replace(strParam, "'", "''"), objRptDs, objMapPath)
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=GET_IN_MTHSTKACCMOVE_DETAILS_REPORT&errmesg=" & Exp.ToString() & "&redirect=")
        End Try


        rdCrystalViewer.Load(objMapPath & "web\" & strLangCode & "\Reports\Crystal\IN_StdRpt_MthStkAccMoveDetails.rpt", OpenReportMethod.OpenReportByTempCopy)
        ...
        If strExportToExcel = "0" Then
            crDiskFileDestinationOptions.DiskFileName = objMapPath & "web\ftp\IN_StdRpt_MthStkAccMoveDetails.pdf"
        Else
            crDiskFileDestinationOptions.DiskFileName = objMapPath & "web\ftp\IN_StdRpt_MthStkAccMoveDetails.xls"
        End If
        ...
        If strExportToExcel = "0" Then
            Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../ftp/IN_StdRpt_MthStkAccMoveDetails.pdf"">")
        Else
            Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../ftp/IN_StdRpt_MthStkAccMoveDetails.xls"">")
        End If
    End Sub
    ...
    Sub PassParam()
        ...
        paramField28 = paramFields.Item("ParamIncWS")
