...
Public Class PM_StdRpt_StorageTypeFormulaList_Preview : Inherits Page
    ...
    Sub BindReport()
        ...
        Dim strOpCd As String = "PM_STDRPT_STORAGETYPEFML_MASTERLIST_GET"
        Dim strFileName As String = "PM_StdRpt_StorageTypeFormulaList"
        ...
        If strStorageTypeCode <> "" Then
            strParam = strParam & " AND STF.StorageTypeCode LIKE '" & Replace(strStorageTypeCode, "'", "''") & "' "
        End If
    ...
    Sub PassParam()
        ...
        paramField7 = paramFields.Item("ParamStorageTypeCode")
        ...
        ParamDiscreteValue7.Value = strStorageTypeCode
