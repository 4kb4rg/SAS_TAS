...
Public Class WM_StdRpt_Daily_FFBBySuppPreview : Inherits Page
    ...
    Sub BindReport()
        ...
        Dim strOpCd_SuppDet As String = "WM_STDRPT_DAILY_FFBRCV_BYSUPP_GET_SP"
        Dim strFileName As String = "WM_StdRpt_DailyFFBRcvSuppDet"
        ...
        strParamName = "SUPFR|SUPTO|PRODUCT|DATEFR|DATETO|TIPE|LOCCODE|UID"
    ...
    Sub BindReport_Summary()
        ...
        Dim strOpCd_SuppDet As String = "WM_STDRPT_DAILY_FFBRCV_BYSUPP_SUMMARY_GET_SP"
        Dim strFileName As String = "WM_StdRpt_DailyFFBRcvSuppSummary"
        ...
        strParamName = "DATEFR|DATETO|LOCCODE|UID"
        strParam = strDateFrom & "|" & _
                   strDateTo & "|" & _
                   strLocation & "|" & _
                   strUserId
        Try
    ...
    Sub BindReport_Grading()
        ...
        Dim strOpCd_Grading As String = "WM_STDRPT_DAILY_FFBRCV_GRADING_GET_SP"
        Dim strFileName As String = "WM_StdRpt_DailyFFBRcvGrading"
        ...
        strParamName = "LOCCODE|SUPFR|DATEFR|DATETO|UID"
        strParam = strLocation & "|" & strSuppFr & "|" & strDateFrom & "|" & strDateTo & "|" & strUserId
        Try
            intErrNo = objOk.mtdGetReportDataCommon(strOpCd_Grading, strParamName, strParam, dsSupplier, objMapPath, objFTPFolder)
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=WM_STDRPT_PRODUCTION_TBS_CPO_KERNEL_MONTHLY_GET&errmesg=" & lblErrMessage.Text & "&redirect=")
        End Try
