...
Public Class PD_StdRpt_ProdDet_Estate : Inherits Page
    ...
    Protected WithEvents ddlGroupBy As DropDownList
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        If strErrDateFrom = "" And strErrDateTo = "" Then
            ...
            Response.Write("<Script Language=""JavaScript"">window.open(""PD_StdRpt_ProdDet_Estate_Preview.aspx?Type=Print&CompName=" & strCompany & _
                        ...
                        "&DateTo=" & strDateTo & _
                        "&GroupBy=" & ddlGroupBy.SelectedItem.Value & _
