...
Public Class NU_StdRpt_MutasiBibitPreview : Inherits Page
    ...
    Sub BindReport()
        ...
        If Trim(strRptType) = "0" Then
            strFileName = "NU_StdRpt_MutasiBibit"
            strOpCode = "NU_STDRPT_LAPORAN_POSISI_STOCK"
        Else
            strFileName = "NU_StdRpt_MutasiBibitRekap"
            strOpCode = "NU_STDRPT_LAPORAN_POSISI_STOCK_REKAP"
        End If
