...
Public Class PU_StdRpt_PurchaseOrderPFPreview : Inherits Page
    ...
    Sub BindReport()
        ...
        Else
            ...
            strPOID = " and po.POID between '" & strPONoFrom & "' and '" & strPONoTo & "' "
        End If
        ...
        ElseIf strPeriodeFrom <> "" and strPeriodeTo <> "" then  
            strPeriode = " and po.CreateDate between CONVERT(DATETIME, '" & Trim(strPeriodeFrom) & "',103) and CONVERT(DATETIME, '" & Trim(strPeriodeTo) & "',103)"
        Else
            strPeriode = ""
        end if 
        ...
        strRptPrefix = "PU_StdRpt_PurchaseOrderPF"

        EventData.DataSource = objRptDs.Tables("AR_INVOICE")
    ...
    Sub PassParam()
        ...
        ParamDiscreteValue8.Value = Request.QueryString("Catatan")
        ParamDiscreteValue9.Value = Request.QueryString("PIC2")
        ParamDiscreteValue10.Value = Request.QueryString("Jabatan2")
        ParamDiscreteValue11.Value = Request.QueryString("Lokasi")
