...
Public Class GL_StdRpt_CostLedgerSummaryPreview : Inherits Page
    ...
    Sub Page_Load(ByVal Sender As Object, ByVal E As EventArgs)
        ...
        Else
            ...
            strSrchExpCode = Trim(Request.QueryString("SrchExpCode"))
    ...
    Sub BindReport()
        Dim strOpCd_Bgt_GET As String = "GL_STDRPT_COST_LEDGER_SUMMARY_DETAIL_BGT_GET"
        ...
        Try
            strRptPrefix = "GL_StdRpt_CostLedgerSummary"

                strOpCd = "GL_STDRPT_COST_LEDGER_SUMMARY_DETAIL_GET_SP" & "|" & objGLRpt.mtdGetGLReportTable(objGLRpt.EnumGLReportTable.CostLedgerSum) & _
            ...
            strParam = strSelAccMonth & "|" & _
                       ...
                       strRptId & "|" & _
                       strSelSupress & "|" & _
                       objGLSetup.EnumAccountType.ProfitAndLost & "|" & _
                       objGlobal.EnumDocType.VehicleUsage       

            intErrNo = objGLRpt.mtdGetReport_CostLedgerSummary_SP(strOpCd, _
                                                                  strCompany, _
                                                                  strLocation, _
                                                                  strUserId, _
                                                                  strAccMonth, _
        ...
        Catch Exp As System.Exception
            Response.Redirect("../../../include/mesg/ErrorMessage.aspx?errcode=GL_STDRPT_COST_LEDGER_SUMMARY_GET_DETAIL&errmesg=" & Exp.ToString() & "&redirect=")
        End Try
        ...
        '    If myTable.Name = "GL_COSTLEDGERSUMMARY" Then
        '        myLogin = myTable.LogOnInfo
        '        Try
        '            intErrNo = objGLRpt.mtdGet_DBConnObj(myLogin)
        '        Catch Exp As System.Exception
        '            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=GL_COSTLEDGERSUM_RPT_GET&errmesg=" & Exp.ToString() & "&redirect=")
        '        End Try

        '        myTable.ApplyLogOnInfo(myLogin)
        '        myTable.Location = myLogin.ConnectionInfo.DatabaseName & ".dbo.GL_COSTLEDGERSUM_RPT"
        '    End If
    ...
    Sub PassParam()
        ...
        ParamDiscreteValue12.Value = UCase(strExpCodeTag)
        ...
        End If
        ParamDiscreteValue15.Value = strSrchExpCode
        ParamDiscreteValue16.Value = strActTag
        ParamDiscreteValue17.Value = strBlkTag
        ParamDiscreteValue18.Value = strExpTag
    ...
    Sub onload_GetLangCap()
        ...
        strExpCodeTag = GetCaption(objLangCap.EnumLangCap.Expense) & lblCode.text
        strLocationTag = GetCaption(objLangCap.EnumLangCap.Location) & lblCode.text
