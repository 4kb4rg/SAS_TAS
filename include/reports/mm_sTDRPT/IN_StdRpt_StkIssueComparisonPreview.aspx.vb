...
Public Class IN_StdRpt_StkIssueComparison_Preview : Inherits Page
    ...
    Sub BindReport()
        ...
        Dim strOpCdStkIssueListGet As String = "IN_STDRPT_STKISSUE_COMPARISON_GET"
        ...
        If Not (Request.QueryString("DateFrom") = "" And Request.QueryString("DateTo") = "") Then
            SearchStr = SearchStr & "  AND (DateDiff(Day, '" & Session("SS_DATEFROM") & "', STKISS.CreateDate) >= 0) AND (DateDiff(Day, '" & Session("SS_DATETO") & "', STKISS.CreateDate) <= 0)" & vbCrLf
        End If
        ...
        ElseIf strBlkType = "BlkCode" Then
            If Not Request.QueryString("BlkCode") = "" Then
                SearchStr = SearchStr & "  AND STKISSLN.BlkCode LIKE '" & Request.QueryString("BlkCode") & "'" & vbCrLf
            End If
        ...
        rdCrystalViewer.Load(objMapPath & "web\" & strLangCode & "\Reports\Crystal\IN_StdRpt_StkIssueComparison.rpt", OpenReportMethod.OpenReportByTempCopy)
        ...
        crDiskFileDestinationOptions.DiskFileName = objMapPath & "web\ftp\IN_StdRpt_StkIssueComparison.pdf"
        ...
        Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../ftp/IN_StdRpt_StkIssueComparison.pdf"">")
    End Sub
