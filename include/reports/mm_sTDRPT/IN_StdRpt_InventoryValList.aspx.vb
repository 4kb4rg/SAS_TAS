...
Public Class IN_StdRpt_InventoryValList : Inherits Page
    ...
    Protected WithEvents txtVarLevel As TextBox
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        If txtVarLevel.Text = "" Then
            strVarLevel = ""
        Else
            strVarLevel = Trim(txtVarLevel.Text)
        End If
        ...
        Response.Write("<Script Language=""JavaScript"">window.open(""IN_StdRpt_InventoryValListPreview.aspx?Type=Print&CompName=" & strCompany & _
                       ...
                       "&VarLevel=" & strVarLevel & """,null ,""status=yes, resizable=yes, scrollbars=yes, toolbar=no, location=no"");</Script>")
    End Sub
