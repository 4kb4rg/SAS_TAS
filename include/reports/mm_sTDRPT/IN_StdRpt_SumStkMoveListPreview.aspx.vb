...
Public Class IN_StdRpt_SumStkMoveList_Preview : Inherits Page
    ...
    Sub BindReport()
        ...
        Dim strOpCd As String = "IN_STDRPT_ITEMMOVESUM_ITEM_SP"
        ...
        strParam = strUserLoc & "|" & _
                    ...
                    strPOStatus
        Try
            intErrNo = objINRpt.mtdGetReport_SumStkMoveListSP(strCompany, _
                                                              strLocation, _
                                                              strUserId, _
                                                              strAccMonth, _
                                                              strAccYear, _
        ...
        rdCrystalViewer.Load(objMapPath & "web\" & strLangCode & "\Reports\Crystal\IN_StdRpt_SumStkMoveList.rpt", OpenReportMethod.OpenReportByTempCopy)
        ...
        If strExportToExcel = "0" Then
            crDiskFileDestinationOptions.DiskFileName = objMapPath & "web\ftp\IN_StdRpt_SumStkMoveList.pdf"
        Else
            crDiskFileDestinationOptions.DiskFileName = objMapPath & "web\ftp\IN_StdRpt_SumStkMoveList.xls"
        End If
        ...
        If strExportToExcel = "0" Then
            Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../ftp/IN_StdRpt_SumStkMoveList.pdf"">")
        Else
            Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../ftp/IN_StdRpt_SumStkMoveList.xls"">")
        End If
