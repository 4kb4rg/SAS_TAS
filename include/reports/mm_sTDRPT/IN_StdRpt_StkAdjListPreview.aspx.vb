...
Public Class IN_StdRpt_StkAdjList_Preview : Inherits Page
    ...
    Sub BindReport()
        ...
        Else
            crDiskFileDestinationOptions.DiskFileName = objMapPath & "web\ftp\IN_StdRpt_StkAdjList.xls"
        End If
        ...
        Else
            Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../ftp/IN_StdRpt_StkAdjList.xls"">")
        End If
