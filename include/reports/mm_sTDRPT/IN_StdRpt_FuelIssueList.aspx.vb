...
Public Class IN_StdRpt_FuelIssueList : Inherits Page
    ...
    Protected WithEvents txtFuelIssueIDFrom As TextBox
    Protected WithEvents txtFuelIssueIDTo As TextBox
    Protected WithEvents lstFuelIssueType As DropDownList
    ...
    Sub BindFuelIssueType()
        Dim strText = "All"

        lstFuelIssueType.Items.Add(New ListItem(strText))
        lstFuelIssueType.Items.Add(New ListItem(objINTrx.mtdGetFuelIssueType(objINTrx.EnumFuelIssueType.External), objINTrx.EnumFuelIssueType.External))
        lstFuelIssueType.Items.Add(New ListItem(objINTrx.mtdGetFuelIssueType(objINTrx.EnumFuelIssueType.OwnUse), objINTrx.EnumFuelIssueType.OwnUse))
        lstFuelIssueType.Items.Add(New ListItem(objINTrx.mtdGetFuelIssueType(objINTrx.EnumFuelIssueType.StaffDN), objINTrx.EnumFuelIssueType.StaffDN))
        lstFuelIssueType.Items.Add(New ListItem(objINTrx.mtdGetFuelIssueType(objINTrx.EnumFuelIssueType.StaffPayroll), objINTrx.EnumFuelIssueType.StaffPayroll))

    End Sub

    Sub BindStatus()

        lstStatus.Items.Add(New ListItem(objINTrx.mtdGetFuelIssueStatus(objINTrx.EnumFuelIssueStatus.All), objINTrx.EnumFuelIssueStatus.All))
        lstStatus.Items.Add(New ListItem(objINTrx.mtdGetFuelIssueStatus(objINTrx.EnumFuelIssueStatus.Active), objINTrx.EnumFuelIssueStatus.Active))
        lstStatus.Items.Add(New ListItem(objINTrx.mtdGetFuelIssueStatus(objINTrx.EnumFuelIssueStatus.Confirmed), objINTrx.EnumFuelIssueStatus.Confirmed))
        lstStatus.Items.Add(New ListItem(objINTrx.mtdGetFuelIssueStatus(objINTrx.EnumFuelIssueStatus.DbNote), objINTrx.EnumFuelIssueStatus.DbNote))
        lstStatus.Items.Add(New ListItem(objINTrx.mtdGetFuelIssueStatus(objINTrx.EnumFuelIssueStatus.Deleted), objINTrx.EnumFuelIssueStatus.Deleted))
        lstStatus.Items.Add(New ListItem(objINTrx.mtdGetFuelIssueStatus(objINTrx.EnumFuelIssueStatus.Closed), objINTrx.EnumFuelIssueStatus.Closed))
        lstStatus.SelectedIndex = 2
    End Sub

    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        Dim strFuelIssueIDFrom As String
        Dim strFuelIssueIDTo As String
        ...
        If txtFuelIssueIDFrom.Text = "" Then
            strFuelIssueIDFrom = ""
        Else
            strFuelIssueIDFrom = Trim(txtFuelIssueIDFrom.Text)
        End If

        If txtFuelIssueIDTo.Text = "" Then
            strFuelIssueIDTo = ""
        Else
            strFuelIssueIDTo = Trim(txtFuelIssueIDTo.Text)
        End If

        strFuelIssueType = Trim(lstFuelIssueType.SelectedItem.Value)
        ...
        strFuelIssueIDFrom = Server.UrlEncode(strFuelIssueIDFrom)
        strFuelIssueIDTo = Server.UrlEncode(strFuelIssueIDTo)
        ...
        If Not (strDateFrom = "" And strDateTo = "") Then
            If objGlobal.mtdValidInputDate(strDateSetting, strDateFrom, objDateFormat, objDateFrom) = True And objGlobal.mtdValidInputDate(strDateSetting, strDateTo, objDateFormat, objDateTo) = True Then
                Response.Write("<Script Language=""JavaScript"">window.open(""IN_StdRpt_FuelIssueListPreview.aspx?Type=Print&CompName=" & strCompany & "&Location=" & strUserLoc & "&RptID=" & strRptID & "&RptName=" & strRptName & _
                            "&Decimal=" & strDec & "&lblLocation=" & lblLocation.Text & "&DateFrom=" & objDateFrom & "&DateTo=" & objDateTo & "&DDLAccMth=" & strddlAccMth & "&DDLAccYr=" & strddlAccYr & "&lblAccCode=" & lblAccCode.Text & "&lblVehTypeCode=" & lblVehType.Text & _
                            ...
                            "&lblStkAnaCode=" & lblStkAnaCode.Text & "&lblBillParty=" & lblBillParty.Text & "&lblVehDesc=" & lblVehDesc.Text & "&FuelIssueIDFrom=" & strFuelIssueIDFrom & "&FuelIssueIDTo=" & strFuelIssueIDTo & "&FuelIssueType=" & strFuelIssueType & _
