...
Public Class GL_StdRpt_RincianBiayaPanenPerThnTanamPreview : Inherits Page
    ...
    Sub PassParam()
        ...
        ParamDiscreteValue9.Value = strRemark
        ...
        ParamFieldDef9 = ParamFieldDefs.Item("Remark")
    ...
    Sub GetEntireLangCap()
        ...
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=GL_STDRPT_RincianBiayaPanenPerThnTanam_GET_LANGCAP&errmesg=" & Exp.ToString() & "&redirect=")
        End Try
    ...
    Sub BindSummReport()
        ...
        Try
            strRptPrefix = "GL_StdRpt_RincianBiayaPanenPerThnTanam"

            strOpCd = "GL_STDRPT_MR_BIAYAPANEN_GET_SP" & "|" & objGLRpt.mtdGetGLReportTable(objGLRpt.EnumGLReportTable.RincianBiayaPanen) & Chr(9) & _
            ...
            intErrNo = objGLRpt.mtdGetReport_RincianBiayaPanen(strOpCd, _
                                                    strCompany, _
                                                    strLocation, _
                                                    strUserId, _
                                                    strAccMonth, _
        ...
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=GL_STDRPT_RincianBiayaPanenPerThnTanam_GET_SP&errmesg=" & Exp.Message & "&redirect=")
        End Try
