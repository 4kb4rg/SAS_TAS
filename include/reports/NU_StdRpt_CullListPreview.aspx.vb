...
Public Class NU_StdRpt_CullListPreview : Inherits Page
    ...
    Sub BindReport()
        ...
        Dim strOpCd_GET As String = "NU_STDRPT_CULLLIST_GET"


        If Not (Request.QueryString("TxIDFrom") = "" And Request.QueryString("TxIDTo") = "") Then
            SearchStr = SearchStr & " AND NU.CullID >= '" & Request.QueryString("TxIDFrom") & "' AND NU.CullID <= '" & Request.QueryString("TxIDTo") & "'"
        End If

        If Not (Request.QueryString("TxDateFrom") = "" And Request.QueryString("TxDateTo") = "") Then
            SearchStr = SearchStr & " AND (DateDiff(Day, '" & Request.QueryString("TxDateFrom") & "', NU.CullDate) >= 0) And (DateDiff(Day, '" & Request.QueryString("TxDateTo") & "', NU.CullDate) <= 0) "
        End If
        ...
        If Not Request.QueryString("CullTypeCode") = "" Then
            SearchStr = SearchStr & " AND NU.CullTypeCode LIKE '" & Request.QueryString("CullTypeCode") & "'"
        End If

        If Not Request.QueryString("Status") = "" Then
            If Not Request.QueryString("Status") = objNUTrx.EnumCullStatus.All Then
        ...
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=NU_STDRPT_CULL_GET_CHECKACCPERIOD&errmesg=" & lblErrMessage.Text & "&redirect=")
        End Try

        SearchStr = SearchStr & strAccPeriod
        SearchStr = SearchStr & " ORDER BY NU.CullID ASC "

        strParam = strLocation & "|" & _
                    SearchStr

        Try
            intErrNo = objNU.mtdGetReport_CullList(strOpCd_GET, strParam, objRptDs, objMapPath)
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=GET_NU_CULLLIST_REPORT&errmesg=" & lblErrMessage.Text & "&redirect=")
        End Try


        rdCrystalViewer.Load(objMapPath & "web\" & strLangCode & "\Reports\Crystal\NU_StdRpt_CullList.rpt", OpenReportMethod.OpenReportByTempCopy)
        ...
        crDiskFileDestinationOptions.DiskFileName = objMapPath & "web\ftp\NU_StdRpt_CullList.pdf"
        ...
        Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../ftp/NU_StdRpt_CullList.pdf"">")
    End Sub
    ...
    Sub PassParam()
        ...
        paramField14 = paramFields.Item("ParamBlkCode")
        ...
        paramField19 = paramFields.Item("lblBatchNo")
        paramField20 = paramFields.Item("ParamCullTypeCode")
        paramField21 = paramFields.Item("lblCullTypeCode")
        ...
        ParamDiscreteValue14.Value = Request.QueryString("BlkCode")
        ...
        ParamDiscreteValue18.Value = Request.QueryString("lblBlkCode")
        ParamDiscreteValue19.Value = Request.QueryString("lblBatchNo")
        ParamDiscreteValue20.Value = Request.QueryString("CullTypeCode")
        ParamDiscreteValue21.Value = Request.QueryString("lblCullTypeCode")
