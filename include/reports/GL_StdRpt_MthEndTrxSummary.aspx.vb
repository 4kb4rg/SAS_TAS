...
Public Class GL_StdRpt_MthEndTrxSummary : Inherits Page
    ...
    Protected WithEvents cbDetail As CheckBox
    ...
    Sub BindModule()
        If ddlModule.Items.Count = 0 Then
            ddlModule.Items.Add(New ListItem(objGlobal.mtdGetModuleName(objGlobal.EnumModule.Inventory), objGlobal.EnumModule.Inventory))
            ddlModule.Items.Add(New ListItem(objGlobal.mtdGetModuleName(objGlobal.EnumModule.Canteen), objGlobal.EnumModule.Canteen))
            ddlModule.Items.Add(New ListItem(objGlobal.mtdGetModuleName(objGlobal.EnumModule.Workshop), objGlobal.EnumModule.Workshop))
            ddlModule.Items.Add(New ListItem(objGlobal.mtdGetModuleName(objGlobal.EnumModule.Purchasing), objGlobal.EnumModule.Purchasing))
            ddlModule.Items.Add(New ListItem(objGlobal.mtdGetModuleName(objGlobal.EnumModule.AccountPayable), objGlobal.EnumModule.AccountPayable))
            ddlModule.Items.Add(New ListItem(objGlobal.mtdGetModuleName(objGlobal.EnumModule.Payroll), objGlobal.EnumModule.Payroll))
            ddlModule.Items.Add(New ListItem(objGlobal.mtdGetModuleName(objGlobal.EnumModule.Billing), objGlobal.EnumModule.Billing))
            ddlModule.Items.Add(New ListItem(objGlobal.mtdGetModuleName(objGlobal.EnumModule.GeneralLedger), objGlobal.EnumModule.GeneralLedger))
        End If
    End Sub
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        Dim strInDetail As String
        Dim strParam As String
        Dim strDateSetting As String
        Dim objSysCfgDs As New Object()

        Dim enStrModuleCode As String
        ...
        strModuleCode = Trim(ddlModule.SelectedItem.Value)
        ...
        enStrModuleCode = Server.UrlEncode(strModuleCode)
        ...
        Response.Write("<Script Language=""JavaScript"">window.open(""GL_StdRpt_MthEndTrxSummaryPreview.aspx?Type=Print&CompName=" & strCompany & _
                       "&SelLocation=" & strUserLoc & _
                       "&DDLAccMth=" & strddlAccMth & _
                       "&DDLAccYr=" & strddlAccYr & _
                       "&RptId=" & strRptId & _
                       "&RptName=" & strRptName & _
                       "&Decimal=" & strDec & "&Supp=" & strSupp & _
                       ...
                       "&ModuleCode=" & enStrModuleCode & _
                       "&InDetail=" & strInDetail & _
