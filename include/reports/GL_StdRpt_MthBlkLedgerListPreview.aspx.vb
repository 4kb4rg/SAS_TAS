...
Public Class GL_StdRpt_MthBlkLedgerListPreview : Inherits Page
    ...
    Sub BindReport()
        ...
        If strSrchAccCode <> "" Then
            strSearchExp = strSearchExp & "and me.AccCode like '" & strSrchAccCode & "'"
        End If
        ...
        'strRptPrefix = "GL_StdRpt_MthBlkLedgerListEst"
        'strOpCd = "GL_STDRPT_MONTHLY_BLOCK_LEDGER_LIST_SP|GL_MTHBLKLEDGERLIST" & Chr(9) & _
        '          "GL_STDRPT_MONTHLY_BLOCK_LEDGER_LIST_ESTEXP_SP|GL_ESTEXP"
        'Else
        strRptPrefix = "GL_StdRpt_MthBlkLedgerList"
        'strOpCd = "GL_STDRPT_MONTHLY_BLOCK_LEDGER_LIST_SP" & "|" & "GL_MTHBLKLEDGERLIST"
        strOpCd = "GL_STDRPT_MONTHLY_BLOCK_LEDGER_LIST_SP"
        'End If
        ...
        Try
            intErrNo = objGLRpt.mtdGetReport_MonthlyBlockLedgerList(strOpCd, _
                                                                    strCompany, _
                                                                    strLocation, _
                                                                    strUserId, _
                                                                    strAccMonth, _
        ...
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=GL_STDRPT_MTHBLKLEDGERLIST_GET&errmesg=Error&redirect=")
        End Try
        ...
        '    If myTable.Name = "GL_MTHBLKLEDGERLIST" Then
        ...
        '        myTable.Location = myLogin.ConnectionInfo.DatabaseName & ".dbo.GL_MTHBLKLEDGERLIST_RPT"

        '    ElseIf myTable.Name = "GL_ESTEXP" Then
        '        myLogin = myTable.LogOnInfo
        '        Try
        '            intErrNo = objGLRpt.mtdGet_DBConnObj(myLogin)
        '        Catch Exp As System.Exception
        ...
        '        myTable.Location = myLogin.ConnectionInfo.DatabaseName & ".dbo.GL_ESTEXP_RPT"
