...
Public Class WM_StdRpt_Print_DeliveryOrderPreview : Inherits Page
    ...
    Sub BindReport()
        ...
        Dim strOpCd_GET As String = "WM_STDRPT_PRINT_DO_GET"
        Dim strFileName As String = "WM_StdRpt_PrintDeliveryOrder"
        ...
        If Not Request.QueryString("DONum") = "" Then
            SearchStr = SearchStr & "AND TIC.DeliveryNoteNo LIKE '" & Request.QueryString("DONum") & "' "
        End If
        ...
        Try
            intErrNo = objWM.mtdGetReport_PrintDO(strOpCd_GET, strParam, objRptDs, objMapPath)
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=WM_STDRPT_PRINT_DO&errmesg=" & lblErrMessage.Text & "&redirect=")
        End Try
