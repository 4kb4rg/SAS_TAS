...
Public Class PM_StdRpt_StorageAreaFormulaList_Preview : Inherits Page
    ...
    Sub BindReport()
        ...
        Dim strOpCd As String = "PM_STDRPT_STORAGEAREAFML_MASTERLIST_GET"
        Dim strFileName As String = "PM_StdRpt_StorageAreaFormulaList"

        Dim strParam As String
        Dim I As Long

        strParam = " AND SAF.LocCode IN ('" & strUserLoc & "')"
        
        If strStorageAreaCode <> "" Then
            strParam = strParam & " AND SAF.StorageAreaCode LIKE '" & Replace(strStorageAreaCode, "'", "''") & "' "
        End If
    ...
    Sub PassParam()
        ...
        paramField7 = paramFields.Item("ParamStorageAreaCode")
        ...
        ParamDiscreteValue7.Value = strStorageAreaCode
        ParamDiscreteValue8.Value = Request.QueryString("lblLocation")
        ParamDiscreteValue9.Value = Session("SS_PMACCMONTH")
        ParamDiscreteValue10.Value = Session("SS_PMACCYEAR")
