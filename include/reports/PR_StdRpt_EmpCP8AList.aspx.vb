...
Public Class PR_StdRpt_EmpCP8AList : Inherits Page
    ...
    Function BindAccYearList(ByVal pv_strLocation As String, _
        ...
        Try
            ...
            intErrNo = objAdmAcc.mtdGetAccPeriodCfg(strOpCd_Dist_Get, _
                                                    ...
                                                    objAccCfg)
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=PR_CP8A_LIST_ACCCFG_DIST_GET&errmesg=" & Exp.ToString() & "&redirect=")
        End Try
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        Response.Write("<Script Language=""JavaScript"">window.open(""PR_StdRpt_EmpCP8AListPreview.aspx?Type=Print&CompName=" & strCompany & _
