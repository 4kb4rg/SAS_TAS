...
Public Class GL_StdRpt_TrialBalDailyPreview : Inherits Page
    ...
    Sub BindReport()
        ...
        strParamName = "LOCCODE|DATEFROM|DATETO|SEARCH|SEARCH2|BLKCODE"
				
        strOpCode = "GL_STDRPT_TRIALBALDAILY_GET"
        strFileName = "GL_StdRpt_TrialBalDaily"
        strParamValue = strLocation & "|" & strDateFrom & "|" & strDateTo & "|" & strSrchAccCode & "|" & strSrchAccCode2 & "|" & strSrchBlkCode
