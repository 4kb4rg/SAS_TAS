...
Public Class PU_StdRpt_GoodsRcvList : Inherits Page
    ...
    Sub BindToLocCode(ByVal pv_strPRId As String)
        ...
        strParam = strToLocCode & "|" & objAdminLoc.EnumLocStatus.Active & "|LocCode|"
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        strToLocCode = Trim(ddlToLocCode.SelectedItem.Value)
        ...
        If Not (strDocDateFrom = "" And strDocDateTo = "") Then
            If objGlobal.mtdValidInputDate(strDateSetting, strDocDateFrom, objDateFormat, objDocDateFrom) = True And objGlobal.mtdValidInputDate(strDateSetting, strDocDateTo, objDateFormat, objDocDateTo) = True Then
                Response.Write("<Script Language=""JavaScript"">window.open(""PU_StdRpt_GoodsRcvListPreview.aspx?CompName=" & strCompany & "&Location=" & strUserLoc & "&RptID=" & strRptID & "&RptName=" & strRptName & "&Decimal=" & strDec & _
                               ...
                               "&lblLocation=" & lblLocation.Text & "&Supplier=" & strSupplier & "&DocIDFrom=" & strDocIDFrom & "&DocIDTo=" & strDocIDTo & "&DocNoFrom=" & strDocNoFrom & "&DocNoTo=" & strDocNoTo & "&DocDateFrom=" & objDocDateFrom & "&DocDateTo=" & objDocDateTo & _
                               ...
                               "&AccCode=" & strAccCode & "&VehTypeCode=" & strVehTypeCode & "&VehCode=" & strVehCode & "&VehExpCode=" & strVehExpCode & "&BlkType=" & strBlkType & "&BlkGrp=" & strBlkGrpCode & "&BlkCode=" & strBlkCode & "&SubBlkCode=" & strSubBlkCode & "&ToLocCode=" & strToLocCode & _
                               "&ExportToExcel=" & strExportToExcel & _
                               "&Status=" & strStatus & "&GroupBy=" & strGroupBy & """,null ,""status=yes, resizable=yes, scrollbars=yes, toolbar=no, location=no"");</Script>")
            Else
