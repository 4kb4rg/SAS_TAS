...
Public Class HR_StdRpt_EmployeeCPPreview : Inherits Page
    ...
    Sub BindReport()
        ...
        Dim strOpCdEmployeeCPGet As String = "HR_STDRPT_EMPLOYEECP_GET"
        ...
        Dim strRptFileName = "HR_StdRpt_EmployeeCP"

        SearchStr = ""
        
        If Not (strEmployeeCodeFrom = "" And strEmployeeCodeTo = "") Then
            SearchStr = SearchStr & "  AND CPTRX.EmpCode >= '" & strEmployeeCodeFrom & "' AND CPTRX.EmpCode <= '" & strEmployeeCodeTo & "'" & vbCrLf
        End If
        ...
        Try
            intErrNo = objHRReport.mtdGetReport_HRGeneral(strOpCdEmployeeCPGet, strParam, objRptDs, objMapPath)
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=GET_EMPLOYEE_CP_REPORT&errmesg=" & lblErrMessage.Text & "&redirect=")
        End Try
    ...
    Sub PassParam()
        ...
        paramField10 = paramFields.Item("Decimal")
        paramField11 = paramFields.Item("CPTag")
        ...
        ParamDiscreteValue10.Value = Request.QueryString("Decimal")
        ParamDiscreteValue11.Value = Request.QueryString("CPTag")
