...
Public Class GL_StdRpt_DetTrialBalPreview : Inherits Page
    ...
    Sub BindReport()
        ...
        'Else
        '    If LCase(strEstExpense) = "yes" Then
        '        strRptPrefix = "GL_StdRpt_DetTrialBalEst"
    ...
    Sub PassParam()
        ...
        ParamDiscreteValue25.Value = strEstExpense
        ...
        ParamFieldDef25 = ParamFieldDefs.Item("EstExpense")
    ...
    Sub GetEntireLangCap()
        ...
        Try
            intErrNo = objLangCap.mtdGetBussTerm(strOpCode_BussTerm, _
                                                 ...
                                                 strParam)
        Catch Exp As Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=GL_STDRPT_DETTRIALBAL_GET_LANGCAP&errmesg=" & Exp.ToString() & "&redirect=")
        End Try
