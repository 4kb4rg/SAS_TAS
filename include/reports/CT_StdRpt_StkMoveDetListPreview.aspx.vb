...
Public Class CT_StdRpt_StkMoveDetList_Preview : Inherits Page
    ...
    Sub BindReport()
        ...
        Dim GoodRcvSearchStr As String = ""
        Dim GoodRtnSearchStr As String = ""
        Dim DispAdvSearchStr As String = ""
        Dim strOpCd As String = "CT_STDRPT_ITEMMOVEDET_ITEM_SP|ITEM"

        SearchStr = "AND ITM.ItemType = '" & objINSetup.EnumInventoryItemType.CanteenItem & "' "
        ...
        If Not (Request.QueryString("DocIDFrom") = "") Then
            StkRcvSearchStr = "AND HD.CanteenRcvID >= '" & Request.QueryString("DocIDFrom") & "' "
            StkIssSearchStr = "AND HD.StockIssueId >= '" & Request.QueryString("DocIDFrom") & "' "
            StkRtnSearchStr = "AND HD.StockRtnID >= '" & Request.QueryString("DocIDFrom") & "' "
            StkTranSearchStr = "AND HD.StockTransferId >= '" & Request.QueryString("DocIDFrom") & "' "
            ItemRetAdvSearchStr = "AND HD.ItemRetAdvID >= '" & Request.QueryString("DocIDFrom") & "' "
            StkAdjSearchStr = "AND HD.StockAdjID >= '" & Request.QueryString("DocIDFrom") & "' "
            GoodRcvSearchStr = "AND HD.GoodsRcvID >= '" & Request.QueryString("DocIDFrom") & "' "
            GoodRtnSearchStr = "AND HD.GoodsRetID >= '" & Request.QueryString("DocIDFrom") & "' "
            DispAdvSearchStr = "AND HD.DispAdvID >= '" & Request.QueryString("DocIDFrom") & "' "
        End If

        If Not (Request.QueryString("DocIDTo") = "") Then
            StkRcvSearchStr = StkRcvSearchStr & "AND HD.CanteenRcvID <= '" & Request.QueryString("DocIDTo") & "' "
            StkIssSearchStr = StkIssSearchStr & "AND HD.StockIssueId <= '" & Request.QueryString("DocIDTo") & "' "
            StkRtnSearchStr = StkRtnSearchStr & "AND HD.StockRtnID <= '" & Request.QueryString("DocIDTo") & "' "
            StkTranSearchStr = StkTranSearchStr & "AND HD.StockTransferId <= '" & Request.QueryString("DocIDTo") & "' "
            ItemRetAdvSearchStr = ItemRetAdvSearchStr & "AND HD.ItemRetAdvID <= '" & Request.QueryString("DocIDTo") & "' "
            StkAdjSearchStr = StkAdjSearchStr & "AND HD.StockAdjID <= '" & Request.QueryString("DocIDTo") & "' "
            GoodRcvSearchStr = GoodRcvSearchStr & "AND HD.GoodsRcvID <= '" & Request.QueryString("DocIDTo") & "' "
            GoodRtnSearchStr = GoodRtnSearchStr & "AND HD.GoodsRetID <= '" & Request.QueryString("DocIDTo") & "' "
            DispAdvSearchStr = DispAdvSearchStr & "AND HD.DispAdvID <= '" & Request.QueryString("DocIDTo") & "' "
        End If

        ItemRetAdvSearchStr = ItemRetAdvSearchStr & "AND HD.ItemDocType = '" & Convert.ToString(objGlobal.EnumDocType.CanteenReturnAdvice) & "' "

        If Not Request.QueryString("TransType") = "All" Then
            Select Case Convert.ToInt16(Request.QueryString("TransType"))
                Case objGlobal.EnumDocType.CTCanteenReceive
                    StkIssSearchStr = ""
                    StkRtnSearchStr = ""
                    StkTranSearchStr = ""
                    ItemRetAdvSearchStr = ""
                    ...
                    GoodRtnSearchStr = ""
                    DispAdvSearchStr = ""
                Case objGlobal.EnumDocType.CanteenIssue
                    StkRcvSearchStr = ""
                    StkRtnSearchStr = ""
                    StkTranSearchStr = ""
                    ItemRetAdvSearchStr = ""
                    ...
                    GoodRtnSearchStr = ""
                    DispAdvSearchStr = ""
                Case objGlobal.EnumDocType.CanteenReturn
                    StkRcvSearchStr = ""
                    StkIssSearchStr = ""
                    StkTranSearchStr = ""
                    ItemRetAdvSearchStr = ""
                    ...
                    GoodRtnSearchStr = ""
                    DispAdvSearchStr = ""
                Case objGlobal.EnumDocType.CanteenTransfer
                    StkRcvSearchStr = ""
                    StkIssSearchStr = ""
                    StkRtnSearchStr = ""
                    ItemRetAdvSearchStr = ""
                    StkAdjSearchStr = ""
                Case objGlobal.EnumDocType.CanteenReturnAdvice
                    StkRcvSearchStr = ""
                    StkIssSearchStr = ""
                    StkRtnSearchStr = ""
                    StkTranSearchStr = ""
                    ...
                    GoodRtnSearchStr = ""
                    DispAdvSearchStr = ""
                Case objGlobal.EnumDocType.CanteenAdjust
                    StkRcvSearchStr = ""
                    StkIssSearchStr = ""
                    StkRtnSearchStr = ""
                    StkTranSearchStr = ""
                    ...
                    GoodRtnSearchStr = ""
                    DispAdvSearchStr = ""
                Case objGlobal.EnumDocType.GoodsReceive
                    StkRcvSearchStr = ""
                    StkIssSearchStr = ""
                    StkRtnSearchStr = ""
                    StkTranSearchStr = ""
                    ...
                    GoodRtnSearchStr = ""
                    DispAdvSearchStr = ""
                Case objGlobal.EnumDocType.GoodsReturn
                    StkRcvSearchStr = ""
                    StkIssSearchStr = ""
                    StkRtnSearchStr = ""
                    StkTranSearchStr = ""
                    ...
                    GoodRcvSearchStr = ""
                    DispAdvSearchStr = ""
                Case objGlobal.EnumDocType.DispatchAdvice
                    StkRcvSearchStr = ""
                    StkIssSearchStr = ""
                    StkRtnSearchStr = ""
                    StkTranSearchStr = ""
        ...
        strParam = strUserLoc & "|" & _
                    ...
                    DispAdvSearchStr 
        Try
            intErrNo = objCTRpt.mtdGetReport_ItemMoveDetListSP(strCompany, _
                                                            strLocation, _
                                                            strUserId, _
                                                            strAccMonth, _
                                                            strAccYear, _
        ...
        Catch Exp As System.Exception
            Response.Redirect("include/mesg/ErrorMessage.aspx?errcode=CT_RPT_GET_ITEM_MOVEDET_LIST&errmesg=" & Exp.ToString() & "&redirect=")
        End Try


        rdCrystalViewer.Load(objMapPath & "web\" & strLangCode & "\Reports\Crystal\CT_StdRpt_StkMoveDetList.rpt", OpenReportMethod.OpenReportByTempCopy)
        rdCrystalViewer.SetDataSource(objRptDsItem.Tables("ITEM"))
        ...
        crDiskFileDestinationOptions.DiskFileName = objMapPath & "web\ftp\CT_StdRpt_StkMoveDetList.pdf"
        ...
        Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../ftp/CT_StdRpt_StkMoveDetList.pdf"">")
    ...
    Sub PassParam()
        ...
        paramField10 = paramFields.Item("ParamDocIDFrom")
        paramField11 = paramFields.Item("ParamDocIDTo")
        paramField12 = paramFields.Item("ParamTransType")
        ...
        ParamDiscreteValue10.Value = Session("SS_DOCIDFROM")
        ParamDiscreteValue11.Value = Session("SS_DOCIDTO")
        ParamDiscreteValue12.Value = Session("SS_TRANSTYPE")
        ParamDiscreteValue13.Value = Session("SS_LBLLOCATION")
        ParamDiscreteValue14.Value = Session("SS_PRODTYPE")
        ParamDiscreteValue15.Value = Session("SS_PRODBRAND")
        ParamDiscreteValue16.Value = Session("SS_PRODMODEL")
        ParamDiscreteValue17.Value = Session("SS_PRODCAT")
        ParamDiscreteValue18.Value = Session("SS_PRODMAT")
        ParamDiscreteValue19.Value = Session("SS_STKANA")
        ParamDiscreteValue20.Value = Session("SS_LBLPRODTYPECODE")
        ParamDiscreteValue21.Value = Session("SS_LBLPRODBRANDCODE")
        ParamDiscreteValue22.Value = Session("SS_LBLPRODMODELCODE")
        ParamDiscreteValue23.Value = Session("SS_LBLPRODCATCODE")
        ParamDiscreteValue24.Value = Session("SS_LBLPRODMATCODE")
        ParamDiscreteValue25.Value = Session("SS_LBLSTKANACODE")
