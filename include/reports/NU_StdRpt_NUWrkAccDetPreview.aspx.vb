...
Public Class NU_StdRpt_NUWrkAccDetPreview : Inherits Page
    ...
    Sub BindReport()
        ...
        Dim strNurseryInd As String
        Dim strAccStatus As String
        Dim strNuAccStatus As String
        Dim strSeedDispatchStatus As String
        Dim strAccCode As String
        Dim crExportOptions As ExportOptions
        Dim crDiskFileDestinationOptions As DiskFileDestinationOptions
        Dim strOpCd_GET As String = "NU_STDRPT_NUWRKACCDET_SP_GET"
        Dim strOpCdSub1_GET As String = "NU_STDRPT_NUWRKACCDET_SUB1_SP_GET"
        Dim strOpCdSub2_GET As String = "NU_STDRPT_NUWRKACCDET_SUB2_SP_GET"
        ...
        strNurseryInd = objGLSetup.EnumNurseryAccount.Yes
        strAccStatus = objGLSetup.EnumAccStatus.Active
        strNuAccStatus = objNUSetup.EnumAccDistStatus.Active
        strSeedDispatchStatus = objNUTrx.EnumSeedDispatchStatus.Deleted
        ...
        strParam = strLocation & "|" & _
                    ...
                    strAccStatus & "|" & _
                    strNuAccStatus & "|" & _
                    strSeedDispatchStatus & "|" & _
                    strAccCode & "|" & _
                    Convert.ToString(intConfigSetting)

        Try
            intErrNo = objNU.mtdGetReport_NUWrkAccDet(strOpCd_GET, strOpCdSub1_GET, strOpCdSub2_GET, strParam, objRptDs, objRptDsSub1, objRptDsSub2, objMapPath)
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=GET_NU_NUWRKACCDET_REPORT&errmesg=" & Exp.ToString() & "&redirect=")
        End Try

        objRptDs.Tables(0).TableName = "NU_StdRpt_NuWrkAccDet_main"
        objRptDs.Tables.Add(objRptDsSub1.Tables(0).Copy())
        objRptDs.Tables(1).TableName = "NU_StdRpt_NuWrkAccDet_Sub1"
        objRptDs.Tables.Add(objRptDsSub2.Tables(0).Copy())
        objRptDs.Tables(2).TableName = "NU_StdRpt_NuWrkAccDet_Sub2"


        rdCrystalViewer.Load(objMapPath & "web\" & strLangCode & "\Reports\Crystal\NU_StdRpt_NUWrkAccDet.rpt", OpenReportMethod.OpenReportByTempCopy)
        ...
        crDiskFileDestinationOptions.DiskFileName = objMapPath & "web\ftp\NU_StdRpt_NUWrkAccDet.pdf"
        ...
        Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../ftp/NU_StdRpt_NUWrkAccDet.pdf"">")
    ...
    Sub PassParam()
        ...
        paramField11 = paramFields.Item("ParamDistAccCode")
        ...
        ParamDiscreteValue11.Value = Request.QueryString("AccCode")
