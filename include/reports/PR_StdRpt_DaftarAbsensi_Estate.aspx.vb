...
Public Class PR_StdRpt_DaftarAbsensi_Estate : Inherits Page
    ...
    Sub Page_Load(ByVal Sender As Object, ByVal E As EventArgs)
        ...
        Else
            If Not Page.IsPostBack Then
                ...
                BindEmpType()
                ddlrpttype.items.add("Rekap")
                ddlrpttype.items.add("Detail")
            End If
        End If
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        strEmpTipe = Trim(ddlemptype.SelectedItem.Value)
        ...
        If ddlrpttype.SelectedItem.Value.Trim = "" Then
            strTypeRpt = ""
        Else
            strTypeRpt = Trim(ddlrpttype.SelectedItem.Value.Trim)
        End If
...
'ddlmandor.items.add(strTypeRpt)
'exit sub
        ...
        Response.Write("<Script Language=""JavaScript"">window.open(""PR_StdRpt_DaftarAbsensiPreview_Estate.aspx?CompCode=" & strCompany & "&Location=" & strUserLoc & "&RptID=" & strRptID & "&RptName=" & strRptName & "&Decimal=" & strDec & _
                       ...
                       "&Divisi=" & strDivisi & _
                       "&Mandor=" & strMandor & _
                       "&DivisiKerja=" & strDivisiKerja & _
                       "&Emptype=" & strEmpTipe & _
                       "&Rpttype=" & strTypeRpt & _
