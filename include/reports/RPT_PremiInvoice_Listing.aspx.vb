...
Public Class RPT_PremiInvoice_Listing : Inherits Page
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        Response.Write("<Script Language=""JavaScript"">window.open(""RPT_PremiInvoice_Listing_Preview.aspx?Type=Print&CompName=" & strCompany & _
