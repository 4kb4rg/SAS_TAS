...
Public Class GL_StdRpt_PemeliharaanTanaman : Inherits Page
    ...
    Sub Page_Load(ByVal Sender As Object, ByVal E As EventArgs)
        ...
        Else
            ...
            If Not Page.IsPostBack Then
                ...
                BindLevel()
            End If
            If Trim(ddlLevel.SelectedItem.Value) = "0" Then
                ...
                BindBlk("")
                BindSubBlk("")
            ElseIf Trim(ddlLevel.SelectedItem.Value) = "1" Then
    ...
    Sub BindLevel()
        ...
        ddlLevel.Items.Add(New ListItem(lblBlkGrp.Text, "0"))
        ddlLevel.Items.Add(New ListItem(lblBlk.Text, "1"))
        ddlLevel.Items.Add(New ListItem(lblSubBlk.Text, "2"))
        ddlLevel.Items.Add(New ListItem(lblLocCode.Text, "3"))
        ddlLevel.Items.Add(New ListItem(lblThnTnm.Text, "4"))
    End Sub
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
       ...
       End If
        ...
        strSrchLocLevel = Trim(ddlLevel.SelectedItem.Value)
        If Trim(ddlLevel.SelectedItem.Value) = "4" Then 
        ...
        enSrchLocLevel = Server.UrlEncode(strSrchLocLevel)

        Response.Write("<Script Language=""JavaScript"">window.open(""GL_StdRpt_PemeliharaanTanamanPreview.aspx?Type=Print&CompName=" & strCompany & _
                       ...
                       "&SelLocLevel=" & enSrchLocLevel & _
                       "&SelRemark= " & strRemark & _
