...
Public Class PR_StdRpt_AngsuranPreview_Estate : Inherits Page
    ...
    Sub Page_Load(ByVal Sender As Object, ByVal E As EventArgs)
		...
		strEmpType = Trim(Request.QueryString("EmpType"))
    ...
    Sub BindReport()
        ...
        strParamName = "ACCMONTH|ACCYEAR|LOCCODE|CETAK|TY|EMPTYPE"
        ...
        rdCrystalViewer.Load(objMapPath & "web\" & strLangCode & "\reports\crystal\PR_StdRpt_Angsuran_Estate.rpt", OpenReportMethod.OpenReportByTempCopy)
