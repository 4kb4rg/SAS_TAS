...
Public Class RPT_PremiInvoice_Detail : Inherits Page
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        Response.Write("<Script Language=""JavaScript"">window.open(""RPT_PremiInvoice_Detail_Preview.aspx?Type=Print&CompName=" & strCompany & _
