...
Public Class PU_StdRpt_OutstandingPO_Preview : Inherits Page
    ...
    Sub Page_Load(ByVal Sender As Object, ByVal E As EventArgs)
        ...
        strGR = Request.QueryString("lstGR")
        ...
        Else
            Session("SS_GR") = Request.QueryString("lstGR")
            Session("SS_INVOICE") = Request.QueryString("lstInvoice")
            Session("SS_PAYMENT") = Request.QueryString("lstPayment")
            BindReport()
        End If
    End Sub
    ...
    Sub BindReport()
        ...
        Dim strOpCdPO_GET As String = "PU_STDRPT_OUTSTANDING_PO_GET"
        ...
        If Not Request.QueryString("POID") = "" Then
            SearchStr = SearchStr & "PO.POID IN (SELECT SUBPO.POID FROM PU_PO SUBPO WHERE SUBPO.POID = '" & Request.QueryString("POID") & "') AND "
        End If

        If Not Request.QueryString("Supplier") = "" Then
            'SearchStr = SearchStr & "PO.SupplierCode LIKE '" & Request.QueryString("Supplier") & "' AND "
        ...
        If Not Request.QueryString("Status") = "" Then
            If Not Request.QueryString("Status") = objPUTrx.EnumPOStatus.All Then
                SearchStr = SearchStr & "PO.Status = '" & Request.QueryString("Status") & "' "
            Else
                SearchStr = SearchStr & "PO.Status LIKE '%' "
            End If
        End If

        If (Session("SS_GR") = "0" And Session("SS_INVOICE") = "0" And Session("SS_PAYMENT") = "0") Then
            SearchStr = SearchStr & " "
        ElseIf (Session("SS_GR") = "0" And Session("SS_INVOICE") = "0" And Session("SS_PAYMENT") = "1") Then
            SearchStr = SearchStr & " AND CBID IS NULL"
        ElseIf (Session("SS_GR") = "0" And Session("SS_INVOICE") = "0" And Session("SS_PAYMENT") = "2") Then
            SearchStr = SearchStr & " AND CBID IS NOT NULL"
        ElseIf (Session("SS_GR") = "0" And Session("SS_INVOICE") = "1" And Session("SS_PAYMENT") = "0") Then
            SearchStr = SearchStr & " AND APID IS NULL"
        ElseIf (Session("SS_GR") = "0" And Session("SS_INVOICE") = "1" And Session("SS_PAYMENT") = "1") Then
            SearchStr = SearchStr & " AND APID IS NULL AND CBID IS NULL"
        ElseIf (Session("SS_GR") = "0" And Session("SS_INVOICE") = "1" And Session("SS_PAYMENT") = "2") Then
            SearchStr = SearchStr & " AND APID IS NULL AND CBID IS NOT NULL"
        ElseIf (Session("SS_GR") = "0" And Session("SS_INVOICE") = "2" And Session("SS_PAYMENT") = "0") Then
            SearchStr = SearchStr & " AND APID IS NOT NULL"
        ElseIf (Session("SS_GR") = "0" And Session("SS_INVOICE") = "2" And Session("SS_PAYMENT") = "1") Then
            SearchStr = SearchStr & " AND APID IS NOT NULL AND CBID IS NULL"
        ElseIf (Session("SS_GR") = "0" And Session("SS_INVOICE") = "2" And Session("SS_PAYMENT") = "2") Then
            SearchStr = SearchStr & " AND APID IS NOT NULL AND CBID IS NOT NULL"
        ElseIf (Session("SS_GR") = "1" And Session("SS_INVOICE") = "0" And Session("SS_PAYMENT") = "0") Then
            SearchStr = SearchStr & " AND GRID IS NULL"
        ElseIf (Session("SS_GR") = "1" And Session("SS_INVOICE") = "0" And Session("SS_PAYMENT") = "1") Then
            SearchStr = SearchStr & " AND GRID IS NULL AND CBID IS NULL"
        ElseIf (Session("SS_GR") = "1" And Session("SS_INVOICE") = "0" And Session("SS_PAYMENT") = "2") Then
            SearchStr = SearchStr & " AND GRID IS NULL AND CBID IS NOT NULL"
        ElseIf (Session("SS_GR") = "1" And Session("SS_INVOICE") = "1" And Session("SS_PAYMENT") = "0") Then
            SearchStr = SearchStr & " AND GRID IS NULL AND APID IS NULL"
        ElseIf (Session("SS_GR") = "1" And Session("SS_INVOICE") = "1" And Session("SS_PAYMENT") = "1") Then
            SearchStr = SearchStr & " AND GRID IS NULL AND APID IS NULL AND CBID IS NULL"
        ElseIf (Session("SS_GR") = "1" And Session("SS_INVOICE") = "1" And Session("SS_PAYMENT") = "2") Then
            SearchStr = SearchStr & " AND GRID IS NULL AND APID IS NULL AND CBID IS NOT NULL"
        ElseIf (Session("SS_GR") = "1" And Session("SS_INVOICE") = "2" And Session("SS_PAYMENT") = "0") Then
            SearchStr = SearchStr & " AND GRID IS NULL AND APID IS NOT NULL"
        ElseIf (Session("SS_GR") = "1" And Session("SS_INVOICE") = "2" And Session("SS_PAYMENT") = "1") Then
            SearchStr = SearchStr & " AND GRID IS NULL AND APID IS NOT NULL AND CBID IS NULL"
        ElseIf (Session("SS_GR") = "1" And Session("SS_INVOICE") = "2" And Session("SS_PAYMENT") = "2") Then
            SearchStr = SearchStr & " AND GRID IS NULL AND APID IS NOT NULL AND CBID IS NOT NULL"
        ElseIf (Session("SS_GR") = "2" And Session("SS_INVOICE") = "0" And Session("SS_PAYMENT") = "0") Then
            SearchStr = SearchStr & " AND GRID IS NOT NULL"
        ElseIf (Session("SS_GR") = "2" And Session("SS_INVOICE") = "0" And Session("SS_PAYMENT") = "1") Then
            SearchStr = SearchStr & " AND GRID IS NOT NULL AND CBID IS NULL"
        ElseIf (Session("SS_GR") = "2" And Session("SS_INVOICE") = "0" And Session("SS_PAYMENT") = "2") Then
            SearchStr = SearchStr & " AND GRID IS NOT NULL AND CBID IS NOT NULL"
        ElseIf (Session("SS_GR") = "2" And Session("SS_INVOICE") = "1" And Session("SS_PAYMENT") = "0") Then
            SearchStr = SearchStr & " AND GRID IS NOT NULL AND APID IS NULL"
        ElseIf (Session("SS_GR") = "2" And Session("SS_INVOICE") = "1" And Session("SS_PAYMENT") = "1") Then
            SearchStr = SearchStr & " AND GRID IS NOT NULL AND APID IS NULL AND CBID IS NULL"
        ElseIf (Session("SS_GR") = "2" And Session("SS_INVOICE") = "1" And Session("SS_PAYMENT") = "2") Then
            SearchStr = SearchStr & " AND GRID IS NOT NULL AND APID IS NULL AND CBID IS NOT NULL"
        ElseIf (Session("SS_GR") = "2" And Session("SS_INVOICE") = "2" And Session("SS_PAYMENT") = "0") Then
            SearchStr = SearchStr & " AND GRID IS NOT NULL AND APID IS NOT NULL"
        ElseIf (Session("SS_GR") = "2" And Session("SS_INVOICE") = "2" And Session("SS_PAYMENT") = "1") Then
            SearchStr = SearchStr & " AND GRID IS NOT NULL AND APID IS NOT NULL AND CBID IS NULL"
        ElseIf (Session("SS_GR") = "2" And Session("SS_INVOICE") = "2" And Session("SS_PAYMENT") = "2") Then
            SearchStr = SearchStr & " AND GRID IS NOT NULL AND APID IS NOT NULL AND CBID IS NOT NULL"
        End If

        'If Not Session("SS_GR") = "0" Then SearchStr = SearchStr & " AND GRID IS NULL "
        'If Not Session("SS_INVOICE") = "0" Then SearchStr = SearchStr & " AND GRID IS NOT NULL AND APID IS NULL "
        'If Not Session("SS_PAYMENT") = "0" Then SearchStr = SearchStr & " AND CBID IS NULL "
        ...
        rdCrystalViewer.Load(objMapPath & "web\" & strLangCode & "\Reports\Crystal\PU_StdRpt_OutstandingPO.rpt", OpenReportMethod.OpenReportByTempCopy)
        ...
        If strExportToExcel = "0" Then
            crDiskFileDestinationOptions.DiskFileName = objMapPath & "web\ftp\PU_StdRpt_OutstandingPO.pdf"
        Else
            crDiskFileDestinationOptions.DiskFileName = objMapPath & "web\ftp\PU_StdRpt_OutstandingPO.xls"
        End If
        ...
        If strExportToExcel = "0" Then
            Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../ftp/PU_StdRpt_OutstandingPO.pdf"">")
        Else
            Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../ftp/PU_StdRpt_OutstandingPO.xls"">")
        End If
    End Sub
    ...
    Sub PassParam()
        ...
        paramField10 = paramFields.Item("ParamPOID")
        ...
        ParamDiscreteValue10.Value = Request.QueryString("POID")
