...
Public Class CB_StdRpt_TreasuryCashFlow : Inherits Page
    ...
    Sub BindReportCode(ByVal pv_strReportCode As String)
        ...
        Catch Exp As Exception
            Response.Redirect("../../../include/mesg/ErrorMessage.aspx?errcode=TREASURYTEMPLATE_LIST_GET&errmesg=" & Exp.Message & "&redirect=../en/reports/CB_StdRpt_Selection.aspx")
        End Try
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        If ddlReport.SelectedIndex = 0 then
            lblErrRpt.Text = "Please Select Report"
            lblErrRpt.Visible = True
            Exit Sub
        end if
        ...
        Response.Write("<Script Language=""JavaScript"">window.open(""CB_StdRpt_TreasuryCashFlowPreview.aspx?Type=Print&CompName=" & strCompany & _
                       "&RptID=" & strRptID & _
