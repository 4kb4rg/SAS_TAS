...
Public Class GL_StdRpt_RekapOutputPotongBuahPreview : Inherits Page
    ...
    Sub Page_Load(ByVal Sender As Object, ByVal E As EventArgs)
        ...
        Else
            ...
            strLevel = Trim(Request.QueryString("SelLevel"))
            onload_GetLangCap()
            BindSummReport()
        End If
    ...
    Sub GetEntireLangCap()
        ...
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=GL_STDRPT_RekapOutputPotongBuah_GET_LANGCAP&errmesg=" & Exp.ToString() & "&redirect=")
        End Try
    ...
    Sub BindSummReport()
        ...
        Try
            strRptPrefix = "GL_StdRpt_RekapOutputPotongBuah"

            strOpCd = "GL_STDRPT_REKAPOUTPUTPOTONGBUAH_GET_SP" & "|" & objGLRpt.mtdGetGLReportTable(objGLRpt.EnumGLReportTable.RekapOutputPotongBuah) & Chr(9) & _
            ...
            intErrNo = objGLRpt.mtdGetReport_RekapOutputPotongBuah(strOpCd, _
                                                    strCompany, _
                                                    strLocation, _
                                                    strUserId, _
                                                    strAccMonth, _
        ...
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=GL_STDRPT_RekapOutputPotongBuah_GET_SP&errmesg=" & Exp.ToString() & "&redirect=")
        End Try
