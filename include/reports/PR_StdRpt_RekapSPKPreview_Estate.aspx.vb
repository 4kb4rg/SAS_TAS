...
Public Class PR_StdRpt_RekapSPKPreview_Estate : Inherits Page
 ...
 Dim objFTPFolder As String
    ...
    Sub BindReport()
        ...
        Dim strOpCd As String = "PR_PR_STDRPT_REKAPSPK_REPORT"
        ...
        rdCrystalViewer.Load(objMapPath & "web\" & strLangCode & "\reports\crystal\PR_StdRpt_RekapSPK_Estate.rpt", OpenReportMethod.OpenReportByTempCopy)
        ...
        crDiskFileDestinationOptions.DiskFileName = objMapPath & "web\ftp\PR_StdRpt_RekapSPK_Estate.pdf"
        ...
        Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../ftp/PR_StdRpt_RekapSPK_Estate.pdf"">")
    End Sub
