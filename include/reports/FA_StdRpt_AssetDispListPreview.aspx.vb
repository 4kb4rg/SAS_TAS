...
Public Class FA_StdRpt_AssetDispListPreview : Inherits Page
    ...
    Sub BindReport()
        ...
        Select Case strDeprType
            Case "0"
                strFileName = "FA_StdRpt_AssetDispList"
            Case "1"
                strFileName = "FA_StdRpt_AssetDispListFiskal"
            Case "2"
                strFileName = "FA_StdRpt_AssetDispListFiskalVSKomersial"
        End Select
        
        Dim strOpCd_GET As String = "FA_STDRPT_ASSETDISPLIST_GET"

        If Not (Request.QueryString("TxIDFrom") = "" And Request.QueryString("TxIDTo") = "") Then
            SearchStr = SearchStr & " AND FA.AssetDispID >= '" & Request.QueryString("TxIDFrom") & "' AND FA.AssetDispID <= '" & Request.QueryString("TxIDTo") & "'"
        End If
        ...
        If Not Request.QueryString("BillPartyCode") = "" Then
            SearchStr = SearchStr & " AND FA.BillPartyCode LIKE '" & Request.QueryString("BillPartyCode") & "'"
        End If

        'If Not Request.QueryString("DispGLAssetAccCode") = "" Then
        '    SearchStr = SearchStr & " AND RGLN.AssetAccCode LIKE '" & Request.QueryString("DispGLAssetAccCode") & "'"
        'End If

        'If Not Request.QueryString("DispGLAccumDeprAccCode") = "" Then
        '    SearchStr = SearchStr & " AND RGLN.DeprGLAccumDeprAccCode LIKE '" & Request.QueryString("DispGLAccumDeprAccCode") & "'"
        'End If

        'If Not Request.QueryString("DispGLGainLossAccCode") = "" Then
        '    SearchStr = SearchStr & " AND FA.DispGLAssetAccCode LIKE '" & Request.QueryString("DispGLGainLossAccCode") & "'"
        'End If
        ...
        If Not Request.QueryString("Status") = "" Then
            If Not Request.QueryString("Status") = objFATrx.EnumAssetDispStatus.All Then
        ...
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=FA_STDRPT_AssetDisp_GET_CHECKACCPERIOD&errmesg=" & lblErrMessage.Text & "&redirect=")
        End Try

        SearchStr = SearchStr & strAccPeriod
        'SearchStr = SearchStr & " ORDER BY FA.AssetDispID ASC "

        strParam = strUserLoc & "|" & _
                    SearchStr

        Try
            intErrNo = objFA.mtdGetReport_AssetDispList(strOpCd_GET, strParam, objRptDs, objMapPath)
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=GET_FA_AssetDispLIST_REPORT&errmesg=" & lblErrMessage.Text & "&redirect=")
        End Try

        For intCnt = 0 To objRptDs.Tables(0).Rows.Count - 1
            objRptDs.Tables(0).Rows(intCnt).Item("Status") = objFATrx.mtdGetAssetDispStatus(objRptDs.Tables(0).Rows(intCnt).Item("Status"))
        Next
    ...
    Sub PassParam()
        ...
        paramField22 = paramFields.Item("lblDispGLAssetAccCode")
        paramField23 = paramFields.Item("lblDispGLAccumDeprAccCode")
        paramField24 = paramFields.Item("lblDispGLGainLossAccCode")
        paramField25 = paramFields.Item("ParamAssetHeaderCode")
        paramField26 = paramFields.Item("ParamBillPartyCode")
        paramField27 = paramFields.Item("ParamDispGLAssetAccCode")
        paramField28 = paramFields.Item("ParamDispGLAccumDeprAccCode")
        paramField29 = paramFields.Item("ParamDispGLGainLossAccCode")
        paramField30 = paramFields.Item("ParamDecimal")
        ...
        ParamDiscreteValue7.Value = objFATrx.mtdGetAssetDispStatus(Request.QueryString("Status"))
        ...
        ParamDiscreteValue22.Value = Request.QueryString("lblDispGLAssetAccCode")
        ParamDiscreteValue23.Value = Request.QueryString("lblDispGLAccumDeprAccCode")
        ParamDiscreteValue24.Value = Request.QueryString("lblDispGLGainLossAccCode")
        ParamDiscreteValue25.Value = Request.QueryString("AssetHeaderCode")
        ParamDiscreteValue26.Value = Request.QueryString("BillPartyCode")
        ParamDiscreteValue27.Value = Request.QueryString("DispGLAssetAccCode")
        ParamDiscreteValue28.Value = Request.QueryString("DispGLAccumDeprAccCode")
        ParamDiscreteValue29.Value = Request.QueryString("DispGLGainLossAccCode")
        ParamDiscreteValue30.Value = Request.QueryString("Decimal")
