...
Public Class PR_StdRpt_ADListPreview : Inherits Page
    ...
    Sub BindReport()
        ...
        strReportID = "RPTPR1000004"


        Try
            strRptPrefix = "PR_StdRpt_ADList"
            strOpCd = "PR_STDRPT_ADLIST_EMP_GET_SP" & "|" & objPRRpt.mtdGetPRReportTable(objPRRpt.EnumPRReportTable.AD) & Chr(9) & _
            ...
            strParam = strSelAccMonth & "|" & _
                        ...
                        strStatus & "|" & _
                        strGangCode & "|" & _
                        objHRSetup.EnumGangStatus.Active
            intErrNo = objPRRpt.mtdGetReport_ADList_SP(strOpCd, _
                                                    strCompany, _
                                                    strLocation, _
                                                    strUserId, _
                                                    strAccMonth, _
        ...
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=PR_STDRPT_ADLIST_GET&errmesg=" & Exp.ToString() & "&redirect=")
        End Try
    ...
    Sub PassParam()
        ...
        ParamDiscreteValue9.Value = Session("SS_STATUS")
        ParamDiscreteValue10.Value = Session("SS_LBLLOCATION")
        ParamDiscreteValue11.Value = strGangCode
        ...
        ParamFieldDef9 = ParamFieldDefs.Item("ParamStatus")
        ParamFieldDef10 = ParamFieldDefs.Item("lblLocation")
        ParamFieldDef11 = ParamFieldDefs.Item("SrchGangCode")
