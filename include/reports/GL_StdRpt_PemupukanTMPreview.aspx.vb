...
Public Class GL_StdRpt_PemupukanTMPreview : Inherits Page
    ...
    Sub GetEntireLangCap()
        ...
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=GL_STDRPT_PemupukanTM_GET_LANGCAP&errmesg=" & Exp.ToString() & "&redirect=")
        End Try
    ...
    Sub BindSummReport()
        ...
        Try
            strRptPrefix = "GL_StdRpt_PemupukanTM"

            strOpCd = "GL_STDRPT_PEMUPUKANTM_GET_SP" & "|" & objGLRpt.mtdGetGLReportTable(objGLRpt.EnumGLReportTable.PemupukanTM) & Chr(9) & _
            ...
            intErrNo = objGLRpt.mtdGetReport_PemupukanTM(strOpCd, _
                                                    strCompany, _
                                                    strLocation, _
                                                    strUserId, _
                                                    strAccMonth, _
        ...
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=GL_STDRPT_PemupukanTM_GET_SP&errmesg=" & Exp.ToString() & "&redirect=")
        End Try
