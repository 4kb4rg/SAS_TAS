...
Public Class PU_StdRpt_PURealizationPreview : Inherits Page
    ...
    Sub BindReport()
        ...
        Dim strOpCdPR_GET As String = "PU_STDRPT_PRREALIZATION"
        ...
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=GET_PU_PR_REALIZATION_REPORT&errmesg=" & lblErrMessage.Text & "&redirect=")
        End Try
        ...
        crDiskFileDestinationOptions.DiskFileName = objMapPath & "web\ftp\PU_StdRpt_PRRealization.pdf"
        ...
        Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../ftp/PU_StdRpt_PRRealization.pdf"">")
    End Sub
