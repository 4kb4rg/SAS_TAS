...
Public Class PR_StdRpt_DaftarSPKPreview_Estate : Inherits Page
 ...
 Dim objFTPFolder As String
    ...
    Sub BindReport()
        ...
        Dim strOpCd As String = "PR_PR_STDRPT_DAFTARSPK_REPORT"
        Dim strParamName As String
        Dim strParamValue As String
        Dim ReportID As String = Request.QueryString("RptID")

        strParamName = "ACCMONTH|ACCYEAR|COMPCODE|LOCCODE|SUPPLIERCODE"
        ...
        rdCrystalViewer.Load(objMapPath & "web\" & strLangCode & "\reports\crystal\PR_StdRpt_DaftarSPK_Estate.rpt", OpenReportMethod.OpenReportByTempCopy)
        ...
        crDiskFileDestinationOptions.DiskFileName = objMapPath & "web\ftp\PR_StdRpt_DaftarSPK_Estate.pdf"
        ...
        Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../ftp/PR_StdRpt_DaftarSPK_Estate.pdf"">")
    End Sub
