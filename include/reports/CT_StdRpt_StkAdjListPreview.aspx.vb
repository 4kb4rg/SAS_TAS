...
Public Class CT_StdRpt_StkAdjList_Preview : Inherits Page
    ...
    Sub BindReport()
        ...
        Dim strOpCd As String = "CT_STDRPT_STOCKADJUST_LIST_GET"    
        ...
        If Not Request.QueryString("AdjType") = "" Then
            If Not Request.QueryString("AdjType") = objCTTrx.EnumAdjustmentType.All Then
                strWhere = strWhere & " AND HD.AdjType = '" & Request.QueryString("AdjType") & "'" & vbCrLf
            End If
        End If
        strAdjType = objCTTrx.mtdGetAdjustmentType(Request.QueryString("AdjType"))
        
        If Not Request.QueryString("TransType") = "" Then
            If Not Request.QueryString("TransType") = objCTTrx.EnumTransactionType.All Then
                strWhere = strWhere & " AND HD.TransType = '" & Request.QueryString("TransType") & "'" & vbCrLf
            End If
        End If
        strTransType = objCTTrx.mtdGetTransactionType(Request.QueryString("TransType"))

        If Not Request.QueryString("Status") = "" Then
            If Not Request.QueryString("Status") = objCTTrx.EnumStockAdjustStatus.All Then
                strWhere = strWhere & " AND HD.Status = '" & Request.QueryString("Status") & "'" & vbCrLf
            End If
        End If
        
        strStatus = objCTTrx.mtdGetStockAdjustStatus(Request.QueryString("Status"))
        ...
        Try
            intErrNo = objCTRpt.mtdGetReport_StockAdjustmentList(strOpCd, strWhere, strOrderBy, dsRpt, objMapPath)
        ...
        rdCrystalViewer.Load(objMapPath & "web\" & strLangCode & "\Reports\Crystal\CT_StdRpt_StkAdjList.rpt", OpenReportMethod.OpenReportByTempCopy)
        ...
        crDiskFileDestinationOptions.DiskFileName = objMapPath & "web\ftp\CT_StdRpt_StkAdjList.pdf"
        ...
        Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../ftp/CT_StdRpt_StkAdjList.pdf"">")
    End Sub
    ...
    Sub PassParam()
        ...
        ParamDiscreteValue44.Value = objCTTrx.EnumTransactionType.NewValue
        ParamDiscreteValue45.Value = objCTTrx.mtdGetTransactionType(objCTTrx.EnumTransactionType.NewValue)
        ParamDiscreteValue46.Value = objCTTrx.EnumTransactionType.Difference
        ParamDiscreteValue47.Value = objCTTrx.mtdGetTransactionType(objCTTrx.EnumTransactionType.Difference)

        ParamDiscreteValue48.Value = objCTTrx.EnumAdjustmentType.Quantity
        ParamDiscreteValue49.Value = objCTTrx.mtdGetAdjustmentType(objCTTrx.EnumAdjustmentType.Quantity)
        ParamDiscreteValue50.Value = objCTTrx.EnumAdjustmentType.AverageCost
        ParamDiscreteValue51.Value = objCTTrx.mtdGetAdjustmentType(objCTTrx.EnumAdjustmentType.AverageCost)
        ParamDiscreteValue52.Value = objCTTrx.EnumAdjustmentType.TotalCost
        ParamDiscreteValue53.Value = objCTTrx.mtdGetAdjustmentType(objCTTrx.EnumAdjustmentType.TotalCost)
        ParamDiscreteValue54.Value = objCTTrx.EnumAdjustmentType.QuantityAtAverageCost
        ParamDiscreteValue55.Value = objCTTrx.mtdGetAdjustmentType(objCTTrx.EnumAdjustmentType.QuantityAtAverageCost)
        ParamDiscreteValue56.Value = objCTTrx.EnumAdjustmentType.QuantityAtTotalCost
        ParamDiscreteValue57.Value = objCTTrx.mtdGetAdjustmentType(objCTTrx.EnumAdjustmentType.QuantityAtTotalCost)

        ParamDiscreteValue58.Value = objCTTrx.EnumStockAdjustStatus.Active
        ParamDiscreteValue59.Value = objCTTrx.mtdGetStockAdjustStatus(objCTTrx.EnumStockAdjustStatus.Active)
        ParamDiscreteValue60.Value = objCTTrx.EnumStockAdjustStatus.Confirmed
        ParamDiscreteValue61.Value = objCTTrx.mtdGetStockAdjustStatus(objCTTrx.EnumStockAdjustStatus.Confirmed)
        ParamDiscreteValue62.Value = objCTTrx.EnumStockAdjustStatus.Deleted
        ParamDiscreteValue63.Value = objCTTrx.mtdGetStockAdjustStatus(objCTTrx.EnumStockAdjustStatus.Deleted)
        ParamDiscreteValue64.Value = objCTTrx.EnumStockAdjustStatus.Cancelled
        ParamDiscreteValue65.Value = objCTTrx.mtdGetStockAdjustStatus(objCTTrx.EnumStockAdjustStatus.Cancelled)
        ParamDiscreteValue66.Value = objCTTrx.EnumStockAdjustStatus.Closed
        ParamDiscreteValue67.Value = objCTTrx.mtdGetStockAdjustStatus(objCTTrx.EnumStockAdjustStatus.Closed)
