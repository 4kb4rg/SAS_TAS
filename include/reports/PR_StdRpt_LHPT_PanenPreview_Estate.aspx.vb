...
Public Class PR_StdRpt_LHPT_PanenPreview_Estate : Inherits Page
    ...
    Sub BindReport()
        ...
        If Not isMandor Then
            strOpCd = "PR_PR_STDRPT_LHPT_PANEN_REPORT_DIVISI"
			if isexcel then
			fname = "PR_StdRpt_LHPT_Estate_Divisi_Panen_EXCEL"
			else
			fname = "PR_StdRpt_LHPT_Estate_Divisi_Panen"
			end if 
        ...
        Else
            strOpCd = "PR_PR_STDRPT_LHPT_PANEN_REPORT_MANDOR"
			if isexcel then
            ...
            strParamName = "LOCCODE|DIVISI|MANDOR|BKMDATE|TD"
            strParamValue = strLocation & "|" & _
                            strDivisi & "|" & _
                            strMandor & "|" & _
                            strDate & "|" & _
