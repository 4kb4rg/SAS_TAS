...
Public Class RPT_ClaimBenefit_Listing : Inherits Page
    ...
    Protected WithEvents ddlListingType As DropDownList
    Protected WithEvents ddlAirline As DropDownList
    Protected WithEvents ddlAirlineType As DropDownList
    Protected WithEvents ddlProvider As DropDownList
    Protected WithEvents ddlBenefit As DropDownList
    Protected WithEvents ListingType1 As HtmlTableRow
    Protected WithEvents ListingType2 As HtmlTableRow
    Protected WithEvents ListingType3 As HtmlTableRow
    Protected WithEvents ListingType4 As HtmlTableRow
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        If ddlListingType.SelectedItem.Value = "1" Then
            strListingType = "1"
            strAirline = Trim(ddlAirline.SelectedItem.Value)
            strProvider = ""
            strBenefit = ""
        ElseIf ddlListingType.SelectedItem.Value = "2" Then
            strListingType = "2"
            strAirline = ""
            strProvider = Trim(ddlProvider.SelectedItem.Value)
            strBenefit = ""
        Else
            strListingType = "3"
            strAirline = ""
            strProvider = ""
            strBenefit = Trim(ddlBenefit.SelectedItem.Value)
        End If

        strExportToExcel = IIf(cbExcel.Checked = True, "1", "0")


        Response.Write("<Script Language=""JavaScript"">window.open(""RPT_ClaimBenefit_Listing_Preview.aspx?Type=Print&CompName=" & strCompany & _
                       ...
                       "&strProvider=" & strProvider & _
                       "&strBenefit=" & strBenefit & _
                       "&strListingType=" & strListingType & _
                       "&DateFrom=" & strDate & _
                       "&DateTo=" & strDateTo & _
    ...
    Sub ListingType_Changed(ByVal sender As System.Object, ByVal e As System.EventArgs)
        If ddlListingType.SelectedItem.Value = "1" Then
            ListingType1.Visible = True
            ListingType2.Visible = True
            ListingType3.Visible = False
            ListingType4.Visible = False
        ElseIf ddlListingType.SelectedItem.Value = "2" Then
            ListingType1.Visible = False
            ListingType2.Visible = False
            ListingType3.Visible = True
            ListingType4.Visible = False
        Else
            ListingType1.Visible = False
            ListingType2.Visible = False
            ListingType3.Visible = False
            ListingType4.Visible = True
        End If
    End Sub

    Sub BindProvider()
        Dim strOpCd As String = "SETUP_GET_PROVIDER"
        Dim dr As DataRow
        Dim intErrNo As Integer
        Dim intSelectedIndex As Integer = 0
        ...
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=GET_PROVIDER&errmesg=" & lblErrMessage.Text & "&redirect=")
        End Try
        ...
        ddlProvider.DataSource = objDataGet.Tables(0)
        ddlProvider.DataValueField = "ProviderCode"
        ddlProvider.DataTextField = "Init_Descr"
        ddlProvider.DataBind()
        ddlProvider.SelectedIndex = intSelectedIndex
    ...
    Sub BindBenefit()
        Dim strOpCd As String = "SETUP_GET_BENEFIT"
        Dim dr As DataRow
        Dim intErrNo As Integer
        Dim intSelectedIndex As Integer = 0
        ...
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=GET_BENEFIT&errmesg=" & lblErrMessage.Text & "&redirect=")
        End Try
        ...
        ddlBenefit.DataSource = objDataGet.Tables(0)
        ddlBenefit.DataValueField = "BenefitCode"
        ddlBenefit.DataTextField = "Init_Descr"
        ddlBenefit.DataBind()
        ddlBenefit.SelectedIndex = intSelectedIndex
