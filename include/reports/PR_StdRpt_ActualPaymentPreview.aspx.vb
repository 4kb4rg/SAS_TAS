...
Public Class PR_StdRpt_ActualPaymentPreview : Inherits Page
    ...
    Sub BindReport()
        ...
        strRptPrefix = "PR_StdRpt_ActualPaymentListing"

        strOpCd = "PRDOC_STDRPT_ACTUALPAYMENT_SP" 
        ...
        Try
            intErrNo = objPRRpt.mtdGetReport_ActualPayment(strOpCd, _
                                                       strCompCode, _
                                                       strLocCode, _
                                                       strUserId, _
                                                       strAccMonth, _
