...
Public Class RPT_PremiInvoice_Detail_Preview : Inherits Page
    ...
    Sub BindReport()
        ...
        strFileName = "RPT_PremiInvoice_Detail"

        If strFlightNo = "" And strAirline = "" And strProvider = "" Then
            strSearch = ""
        Else
            If strFlightNo <> "" Then
                strSearch = strSearch + " AND PM.FlightNo = '" & strFlightNo & "'"
        ...
        objRptDs.Tables(0).TableName = "RPT_PREMI_INVOICE"
        objRptDs.Tables(1).TableName = "RPT_PROVIDER"
        objRptDs.Tables(2).TableName = "RPT_AIRLINE"
