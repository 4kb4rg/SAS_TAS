...
Public Class GL_StdRpt_MutTeKerPreview : Inherits Page
    ...
    Sub BindReport()
       ...
       strRptPrefix = "GL_StdRpt_MutTeKer"
       ...
       strOpCd = "GL_STDRPT_MUTTEKER" & "|" & objGLRpt.mtdGetGLReportTable(objGLRpt.EnumGLReportTable.MutTeKer) & Chr(9) & _
        ...
        Try
            intErrNo = objGLRpt.mtdGetReport_MutTeKer(strOpCd, _
                                                            strCompany, _
                                                            strLocation, _
                                                            strUserId, _
                                                            strAccMonth, _
        ...
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=GL_STDRPT_MUTTEKER&errmesg=" & Exp.ToString() & "&redirect=")
        End Try
