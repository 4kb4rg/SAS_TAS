...
Public Class NU_StdRpt_BiayaBibitPreview : Inherits Page
    ...
    Sub Page_Load(ByVal Sender As Object, ByVal E As EventArgs)
        ...
        Else
            ...
            strBatchNo = Trim(Request.QueryString("BatchNo"))
    ...
    Sub BindReport()
        ...
        If Trim(strRptType) = "0" Then
            strFileName = "NU_StdRpt_BiayaBibit"
            strOpCode = "NU_STDRPT_LAPORAN_BIAYA"
        Else
            strFileName = "NU_StdRpt_BiayaBibitRekap"
            strOpCode = "NU_STDRPT_LAPORAN_BIAYA"
        End If

        strSearch = IIf(strBatchNo = "", "", " AND A.BatchNo = '" & strBatchNo & "'")

        strParamName = "LOCCODE|BIN|ACCMONTH|ACCYEAR|STRSEARCH"
    ...
    Sub PassParam()
        ...
        paramField3 = paramFields.Item("AccMonth")
        paramField4 = paramFields.Item("AccYear")
        ...
        ParamDiscreteValue3.Value = Trim(strDDLAccMth)
        ParamDiscreteValue4.Value = Trim(strDDLAccYr)
