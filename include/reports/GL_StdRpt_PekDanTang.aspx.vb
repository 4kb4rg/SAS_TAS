...
Public Class GL_StdRpt_PekDanTang : Inherits Page
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        if strDivision = "All" then 
            SearchStr = " and blk.Status like '1' and blk.loccode = '" & trim(strLocation) & "' "
        ...
        Response.Write("<Script Language=""JavaScript"">window.open(""GL_StdRpt_PekDanTangPreview.aspx?Type=Print&CompName=" & strCompany & _
    ...
    Sub BindPhyMonthList(ByVal pv_intMaxMonth As Integer)
        Dim intCnt As Integer
