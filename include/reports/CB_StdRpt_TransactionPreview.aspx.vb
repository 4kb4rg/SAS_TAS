...
Public Class CB_StdRpt_TransactionPreview : Inherits Page
    ...
    Sub BindReport()
        ...
        Dim strOpCode As String = "CB_STDRPT_TRANSACTION_GET"
        Dim strFileName As String = "CB_StdRpt_Transaction_Report"

        Dim strParam As String
        Dim searchStr As String
        Dim objFTPFolder As String

        strParamName = "TRXDATE|TRXDATETO|ACCCODE|LOCCODE"
        strParamValue = strDate & "|" & strDateTo & "|" & strAccCode & "|" & strLocation
