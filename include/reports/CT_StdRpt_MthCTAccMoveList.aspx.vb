...
Public Class CT_StdRpt_MthCTAccMoveList : Inherits Page
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        Response.Write("<Script Language=""JavaScript"">window.open(""CT_StdRpt_MthCTAccMoveListPreview.aspx?Type=Print&Location=" & strUserLoc & _
