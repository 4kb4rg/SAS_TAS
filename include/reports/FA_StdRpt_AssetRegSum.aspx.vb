...
Public Class FA_StdRpt_AssetRegSum : Inherits Page
    ...
    Sub onload_GetLangCap()
        'GetEntireLangCap()
        lblLocation.Text = "Location" 'GetCaption(objLangCap.EnumLangCap.Location)
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        Response.Write("<Script Language=""JavaScript"">window.open(""FA_StdRpt_AssetRegSumPreview.aspx?Type=Print&CompName=" & strCompany & _
