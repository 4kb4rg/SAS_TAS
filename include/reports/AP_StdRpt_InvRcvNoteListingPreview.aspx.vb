...
Public Class AP_StdRpt_InvRcvNoteListingPreview : Inherits Page
    ...
    Sub Page_Load(ByVal Sender As Object, ByVal E As EventArgs)
        ...
        Else
            ...
            strFileName = "AP_StdRpt_InvRcvNoteListing"
    ...
    Sub BindReport()
        ...
        Dim strOpCd_InvRcvListing_GET As String = "AP_STDRPT_INVRCVNOTELISTING_GET"
        ...
        If Not (Request.QueryString("txtInvDueDateFrom") = "" And Request.QueryString("txtInvDueDateTo") = "") Then
            SearchStr = SearchStr & " AND (DateDiff(Day, '" & Session("SS_InvDueDateFrom") & "', AP.InvoiceDueDate) >= 0) And (DateDiff(Day, '" & Session("SS_InvDueDateTo") & "', AP.InvoiceDueDate) <= 0) "
        End If
        ...
        If Not Request.QueryString("txtUserCreation") = "" Then
            SearchStr = SearchStr & "AND AP.UpdateID LIKE '" & Request.QueryString("txtUserCreation") & "' "
        End If
