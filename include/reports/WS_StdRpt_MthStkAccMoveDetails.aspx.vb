...
Public Class WS_StdRpt_MthStkAccMoveDetails : Inherits Page
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        Response.Write("<Script Language=""JavaScript"">window.open(""WS_StdRpt_MthStkAccMoveDetailsPreview.aspx?Type=Print&Location=" & strUserLoc & _
                       ...
                       "&lblProdBrandCode=" & lblProdBrandCode.Text & "&lblProdModelCode=" & lblProdModelCode.Text & _
