...
Public Class PR_StdRpt_GajiBesar_Harian_Preview_Estate : Inherits Page
    ...
    Sub Page_Load(ByVal Sender As Object, ByVal E As EventArgs)
        ...
        strDateFrom = Request.QueryString("DateStart")
        strDateTo = Request.QueryString("DateEnd")
    ...
    Sub BindReport()
        ...
        Dim strOpCd As String = "PR_PR_STDRPT_GAJIBESAR_HARIAN_REPORT"
        ...
        Dim strRptPrefix As String = "PR_StdRpt_GajiBesar_Harian_Estate" 
        ...
        strParamName = "ACCMONTH|ACCYEAR|LOCCODE|DATEFROM|DATETO|F_EMPCODE|F_DIVCODE|F_MCODE|F_EMPTYPE"
