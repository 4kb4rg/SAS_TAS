...
Public Class NU_StdRpt_SeedTransplantList : Inherits Page
    ...
    Sub BindStatus()
        lstStatus.Items.Add(New ListItem(objNUTrx.mtdGetSeedTransplantStatus(objNUTrx.EnumSeedTransplantStatus.All), objNUTrx.EnumSeedTransplantStatus.All))
        lstStatus.Items.Add(New ListItem(objNUTrx.mtdGetSeedTransplantStatus(objNUTrx.EnumSeedTransplantStatus.Confirmed), objNUTrx.EnumSeedTransplantStatus.Confirmed))
        lstStatus.Items.Add(New ListItem(objNUTrx.mtdGetSeedTransplantStatus(objNUTrx.EnumSeedTransplantStatus.Deleted), objNUTrx.EnumSeedTransplantStatus.Deleted))
        lstStatus.Items.Add(New ListItem(objNUTrx.mtdGetSeedTransplantStatus(objNUTrx.EnumSeedTransplantStatus.Closed), objNUTrx.EnumSeedTransplantStatus.Closed))
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        If Not (strTxDateFrom = "" And strTxDateTo = "") Then
            If objGlobal.mtdValidInputDate(strDateSetting, strTxDateFrom, objDateFormat, objDateFrom) = True And objGlobal.mtdValidInputDate(strDateSetting, strTxDateTo, objDateFormat, objDateTo) = True Then
                Response.Write("<Script Language=""JavaScript"">window.open(""NU_StdRpt_SeedTransplantListPreview.aspx?Type=Print&CompName=" & strCompany & "&Location=" & strUserLoc & "&RptID=" & strRptID & _
