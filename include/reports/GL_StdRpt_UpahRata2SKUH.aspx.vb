...
Public Class GL_StdRpt_UpahRata2SKUH : Inherits Page
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        if strDivision = "All" then 
            ...
            Next  
            strDivision = strDivision & "'',''KNTOR'', ''KNTR'', ''WSHOP'',''"
            strDivision = left(strDivision, len(strDivision) - 3)
        end if 

        Response.Write("<Script Language=""JavaScript"">window.open(""GL_StdRpt_UpahRata2SKUHPreview.aspx?Type=Print&CompName=" & strCompany & _
