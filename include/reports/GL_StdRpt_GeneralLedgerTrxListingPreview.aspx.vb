...
Public Class GL_StdRpt_GeneralLedgerTrxListingPreview : Inherits Page
    ...
    Sub BindReport()
        ...
        Dim strOpCd As String = "GL_STDRPT_GENERAL_LEDGER_TRX_LISTING"
        ...
        Try
            strRptPrefix = "GL_StdRpt_GeneralLedgerTrxListing"
            ...
            intErrNo = objGLRpt.mtdGetReport_GeneralLedgerTrxListing(strOpCd, _
                                                                    strCompany, _
                                                                    strLocation, _
                                                                    strUserId, _
                                                                    strAccMonth, _
        ...
        Catch Exp As System.Exception
            Response.Redirect("../../../include/mesg/ErrorMessage.aspx?errcode=GL_STDRPT_GeneralLedgerTrxListing_GET&errmesg=" & Exp.ToString() & "&redirect=")
        End Try
        ...
        For Each myTable In rdCrystalViewer.Database.Tables
            If myTable.Name = "GL_TRXLIST" Then
                myLogin = myTable.LogOnInfo

                Try
                    intErrNo = objGLRpt.mtdGet_DBConnObj(myLogin)
                Catch Exp As System.Exception
                    Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=GL_StdRpt_GeneralLedgerTrxListing&errmesg=" & Exp.ToString() & "&redirect=")
                End Try
    ...
    Sub PassParam()
        ...
        ParamDiscreteValue9.Value = UCase(strAccCodeTag)
        ParamDiscreteValue10.Value = UCase(strBlkCodeTag)
        ParamDiscreteValue11.Value = UCase(strVehCodeTag)
        ParamDiscreteValue12.Value = UCase(strVehExpCodeTag)
        ParamDiscreteValue13.Value = strSrchAccCode
        ...
        End If
        ParamDiscreteValue15.Value = strSrchVehCode
        ParamDiscreteValue16.Value = strSrchVehExpCode
        ParamDiscreteValue17.Value = strAccTag
        ParamDiscreteValue18.Value = strBlkTag
        ParamDiscreteValue19.Value = strVehTag
        ParamDiscreteValue20.Value = strVehExpTag
        ParamDiscreteValue21.Value = strRptId
        ParamDiscreteValue22.Value = strRptName
        ParamDiscreteValue23.Value = strSrchTrxIDFrom
        ParamDiscreteValue24.Value = strSrchTrxIDTo
        ParamDiscreteValue25.Value = strUserID
        ...
        ParamFieldDef10 = ParamFieldDefs.Item("BlkCodeTag")
        ParamFieldDef11 = ParamFieldDefs.Item("VehCodeTag")
        ParamFieldDef12 = ParamFieldDefs.Item("VehExpCodeTag")
        ParamFieldDef13 = ParamFieldDefs.Item("SrchAccCode")
        ParamFieldDef14 = ParamFieldDefs.Item("SrchBlkCode")
        ParamFieldDef15 = ParamFieldDefs.Item("SrchVehCode")
        ParamFieldDef16 = ParamFieldDefs.Item("SrchVehExpCode")
        ParamFieldDef17 = ParamFieldDefs.Item("AccTag")
        ParamFieldDef18 = ParamFieldDefs.Item("BlkTag")
        ParamFieldDef19 = ParamFieldDefs.Item("VehTag")
        ParamFieldDef20 = ParamFieldDefs.Item("VehExpTag")
        ParamFieldDef21 = ParamFieldDefs.Item("RptId")
        ParamFieldDef22 = ParamFieldDefs.Item("RptName")
        ParamFieldDef23 = ParamFieldDefs.Item("SrchTrxIDFrom")
        ParamFieldDef24 = ParamFieldDefs.Item("SrchTrxIDTo")
        ParamFieldDef25 = ParamFieldDefs.Item("UserID")
