...
Public Class PD_STDRPT_SELECTION_CTRL : Inherits UserControl
    ...
    Protected WithEvents hidAccMonth As HtmlInputHidden
    ...
    Function BindAccYearList(ByVal pv_strLocation As String, _
        ...
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=PD_STDRPT_CTRL_ACCCFG_DIST_GET&errmesg=" & Exp.ToString() & "&redirect=")
        End Try
        ...
        If objAccCfg.Tables(0).Rows.Count > 0 Then      '--found year's record
            ...
            Try
                ...
                intErrNo = objAdmAcc.mtdGetAccPeriodCfg(strOpCd_Max_Get, _
                                                        ...
                                                        objAccCfg)
            Catch Exp As System.Exception
                Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=PD_STDRPT_CTRL_ACCCFG_MAX_GET&errmesg=" & Exp.ToString() & "&redirect=")
            End Try
            ...
            Catch Exp As System.Exception
                Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=PD_STDRPT_CTLR_ACCCFG_MAXPERIOD&errmesg=System required period configuration to process your request. Please set period configuration for the year of " & Convert.ToString(intAccYear) & "&redirect=")
            End Try
    ...
    Sub GetUserLoc()
        ...
        Dim strOppCd_UserLoc_GET As String = "PD_STDRPT_USERLOCATION_GET"
        ...
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=GET_PD_SELECTIONCTRL_USERLOCATION&errmesg=" & Exp.ToString() & "&redirect=../en/reports/PD_StdRpt_Selection.aspx")
        End Try
    ...
    Sub BindReportNameList()
        ...
        Dim objMapPath As String
        Dim dsForDropDown As New DataSet()
        Dim strOppCd_StdRptName_GET As String = "PD_STDRPT_NAME_GET"

        'If Session("PW_ISMILLWARE") = True Then
        If Session("SS_LOCTYPE") = 4 Then
            'strParam = " WHERE (ReportType = '" & Convert.ToString(objGlobal.EnumStdRptType.Production) & "' OR ReportType = '" & Convert.ToString(objGlobal.EnumStdRptType.MillProduction) & "') AND Status = '" & Convert.ToString(objGlobal.EnumStdRptStatus.Active) & "' ORDER BY RptName"
            strParam = " WHERE ReportType = '" & Convert.ToString(objGlobal.EnumStdRptType.MillProduction) & "' AND Status = '" & Convert.ToString(objGlobal.EnumStdRptStatus.Active) & "' ORDER BY RptName"

        Else
            strParam = " WHERE ReportType = '" & Convert.ToString(objGlobal.EnumStdRptType.Production) & "' AND Status = '" & Convert.ToString(objGlobal.EnumStdRptStatus.Active) & "' ORDER BY RptName"
        End If

        Try
            intErrNo = objAdmin.mtdGetStdRptName(strOppCd_StdRptName_GET, strParam, dsForDropDown, objMapPath)
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=GET_PD_SELECTIONCTRL_REPORT_NAME_LIST&errmesg=" & Exp.ToString() & "&redirect=../en/reports/PD_StdRpt_Selection.aspx")
        End Try
    ...
    Sub CheckRptName(ByVal sender As System.Object, ByVal e As System.EventArgs)
		...
		response.write(strSelectedIndex)
        ...
        If strSelectedIndex = "rptpd1000001" Then
            Response.Redirect("../../" & strLangCode & "/reports/PD_StdRpt_OilPalmYieldStatList.aspx?RptName=" & strRptname & "&SelIndex=" & Convert.ToString(intSelectedIndex) & "&UserLoc=" & strUserLoc)
            'else if intSelectedIndex = 3 then
            '    response.redirect("../../" & strLangCode & "/reports/GL_StdRpt_TrialBalSumList.aspx?RptName=" & strRptname & "&SelIndex=" & intSelectedIndex & "&UserLoc=" & strUserLoc & "&DateFrom=" & strDateFrom & "&DateTo=" & strDateTo)
            'else if intSelectedIndex = 4 then
            '    response.redirect("../../" & strLangCode & "/reports/GL_StdRpt_VehExpDetList.aspx?RptName=" & strRptname & "&SelIndex=" & intSelectedIndex & "&UserLoc=" & strUserLoc & "&DateFrom=" & strDateFrom & "&DateTo=" & strDateTo)
        ElseIf strSelectedIndex = "rptpm1000001" Then
            Response.Redirect("../../" & strLangCode & "/reports/PM_StdRpt_DailyProdReport.aspx?RptName=" & strRptname & "&SelIndex=" & Convert.ToString(intSelectedIndex) & "&UserLoc=" & strUserLoc)
        ElseIf strSelectedIndex = "rptpm1000002" Then
            Response.Redirect("../../" & strLangCode & "/reports/PM_StdRpt_MonthlyProdSummary.aspx?RptName=" & strRptname & "&SelIndex=" & Convert.ToString(intSelectedIndex) & "&UserLoc=" & strUserLoc)
        ElseIf strSelectedIndex = "rptpm1000003" Then
            Response.Redirect("../../" & strLangCode & "/reports/PM_StdRpt_UllageVolumeTableMasterList.aspx?RptName=" & strRptname & "&SelIndex=" & Convert.ToString(intSelectedIndex) & "&UserLoc=" & strUserLoc)
        ElseIf strSelectedIndex = "rptpm1000004" Then
            Response.Redirect("../../" & strLangCode & "/reports/PM_StdRpt_UllageVolumeConversionMasterList.aspx?RptName=" & strRptname & "&SelIndex=" & Convert.ToString(intSelectedIndex) & "&UserLoc=" & strUserLoc)
        ElseIf strSelectedIndex = "rptpm1000005" Then
            Response.Redirect("../../" & strLangCode & "/reports/PM_StdRpt_UllageAverageCapacityConversionMasterList.aspx?RptName=" & strRptname & "&SelIndex=" & Convert.ToString(intSelectedIndex) & "&UserLoc=" & strUserLoc)
        ElseIf strSelectedIndex = "rptpm1000006" Then
            Response.Redirect("../../" & strLangCode & "/reports/PM_StdRpt_CPOPropertiesMasterList.aspx?RptName=" & strRptname & "&SelIndex=" & Convert.ToString(intSelectedIndex) & "&UserLoc=" & strUserLoc)
        ElseIf strSelectedIndex = "rptpm1000007" Then
            Response.Redirect("../../" & strLangCode & "/reports/PM_StdRpt_StorageTypeMasterList.aspx?RptName=" & strRptname & "&SelIndex=" & Convert.ToString(intSelectedIndex) & "&UserLoc=" & strUserLoc)
        ElseIf strSelectedIndex = "rptpm1000008" Then
            Response.Redirect("../../" & strLangCode & "/reports/PM_StdRpt_StorageTypeFormulaList.aspx?RptName=" & strRptname & "&SelIndex=" & Convert.ToString(intSelectedIndex) & "&UserLoc=" & strUserLoc)
        ElseIf strSelectedIndex = "rptpm1000009" Then
            Response.Redirect("../../" & strLangCode & "/reports/PM_StdRpt_StorageAreaMasterList.aspx?RptName=" & strRptname & "&SelIndex=" & Convert.ToString(intSelectedIndex) & "&UserLoc=" & strUserLoc)
        ElseIf strSelectedIndex = "rptpm1000010" Then
            Response.Redirect("../../" & strLangCode & "/reports/PM_StdRpt_StorageAreaFormulaList.aspx?RptName=" & strRptname & "&SelIndex=" & Convert.ToString(intSelectedIndex) & "&UserLoc=" & strUserLoc)
        ElseIf strSelectedIndex = "rptpm1000011" Then
            Response.Redirect("../../" & strLangCode & "/reports/PM_StdRpt_CPOStorageTransactionList.aspx?RptName=" & strRptname & "&SelIndex=" & Convert.ToString(intSelectedIndex) & "&UserLoc=" & strUserLoc)
        ElseIf strSelectedIndex = "rptpm1000012" Then
            Response.Redirect("../../" & strLangCode & "/reports/PM_StdRpt_PKStorageTransactionList.aspx?RptName=" & strRptname & "&SelIndex=" & Convert.ToString(intSelectedIndex) & "&UserLoc=" & strUserLoc)
        ElseIf strSelectedIndex = "rptpm1000013" Then
            Response.Redirect("../../" & strLangCode & "/reports/PM_StdRpt_OilLossTransactionList.aspx?RptName=" & strRptname & "&SelIndex=" & Convert.ToString(intSelectedIndex) & "&UserLoc=" & strUserLoc)
        ElseIf strSelectedIndex = "rptpm1000014" Then
            Response.Redirect("../../" & strLangCode & "/reports/PM_StdRpt_OilQualityTransactionList.aspx?RptName=" & strRptname & "&SelIndex=" & Convert.ToString(intSelectedIndex) & "&UserLoc=" & strUserLoc)
        ElseIf strSelectedIndex = "rptpm1000015" Then
            Response.Redirect("../../" & strLangCode & "/reports/PM_StdRpt_KernelQualityTransactionList.aspx?RptName=" & strRptname & "&SelIndex=" & Convert.ToString(intSelectedIndex) & "&UserLoc=" & strUserLoc)
        ElseIf strSelectedIndex = "rptpm1000016" Then
            Response.Redirect("../../" & strLangCode & "/reports/PM_StdRpt_ProducedKernelQualityTransactionList.aspx?RptName=" & strRptname & "&SelIndex=" & Convert.ToString(intSelectedIndex) & "&UserLoc=" & strUserLoc)
        ElseIf strSelectedIndex = "rptpm1000017" Then
            Response.Redirect("../../" & strLangCode & "/reports/PM_StdRpt_DispatchedKernelQualityTransactionList.aspx?RptName=" & strRptname & "&SelIndex=" & Convert.ToString(intSelectedIndex) & "&UserLoc=" & strUserLoc)
        ...
        'CR_THG00009 END
        '#3 start
        ElseIf strSelectedIndex = "rptpm1000019" Then
            Response.Redirect("../../" & strLangCode & "/reports/PD_StdRpt_ProdAreaStt.aspx?RptName=" & strRptname & "&SelIndex=" & intSelectedIndex & "&UserLoc=" & strUserLoc)
            '#3 end
        'dian start
        ElseIf strSelectedIndex = "rptpd1000003" Then
            Response.Redirect("../../" & strLangCode & "/reports/PD_StdRpt_ProdStat.aspx?RptName=" & strRptname & "&SelIndex=" & intSelectedIndex & "&UserLoc=" & strUserLoc)
        'dian end
        
            '#4 Start
        ElseIf strSelectedIndex = "rptpm1000020" Then
            Response.Redirect("../../" & strLangCode & "/reports/PM_StdRpt_KernelLossTransactionList.aspx?RptName=" & strRptname & "&SelIndex=" & intSelectedIndex & "&UserLoc=" & strUserLoc)
        ElseIf strSelectedIndex = "rptpm1000021" Then
            Response.Redirect("../../" & strLangCode & "/reports/PM_StdRpt_WaterQualityTransactionList.aspx?RptName=" & strRptname & "&SelIndex=" & intSelectedIndex & "&UserLoc=" & strUserLoc)
        ElseIf strSelectedIndex = "rptpm1000022" Then
            Response.Redirect("../../" & strLangCode & "/reports/PM_StdRpt_WastedWaterQualityTransactionList.aspx?RptName=" & strRptname & "&SelIndex=" & intSelectedIndex & "&UserLoc=" & strUserLoc)
            '#4 End
        ElseIf strSelectedIndex = "rptpm1000023" Then
            Response.Redirect("../../" & strLangCode & "/reports/PM_StdRpt_KernelLossesTransactionList.aspx?RptName=" & strRptname & "&SelIndex=" & Convert.ToString(intSelectedIndex) & "&UserLoc=" & strUserLoc)
    	...
    	ElseIf strSelectedIndex = "rptpd1000004" Then
            Response.Redirect("../../" & strLangCode & "/reports/PD_StdRpt_ProdStat_Estate.aspx?RptName=" & strRptname & "&SelIndex=" & intSelectedIndex & "&UserLoc=" & strUserLoc)
		ElseIf strSelectedIndex = "rptpd1000005" Then
            Response.Redirect("../../" & strLangCode & "/reports/PD_StdRpt_ProdDet_Estate.aspx?RptName=" & strRptname & "&SelIndex=" & intSelectedIndex & "&UserLoc=" & strUserLoc)
		ElseIf strSelectedIndex = "rptpd1000006" Then
            Response.Redirect("../../" & strLangCode & "/reports/PD_StdRpt_Production_Estate.aspx?RptName=" & strRptname & "&SelIndex=" & intSelectedIndex & "&UserLoc=" & strUserLoc)
