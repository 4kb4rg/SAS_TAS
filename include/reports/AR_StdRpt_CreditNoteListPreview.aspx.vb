...
Public Class AR_StdRpt_CreditNoteList_Preview : Inherits Page
    ...
    Sub Page_Load(ByVal Sender As Object, ByVal E As EventArgs)
        ...
        strFileName = "AR_StdRpt_CreditNoteListing"
        ...
        Session("SS_CreditNoteType") = Request.QueryString("CreditNoteType")
    ...
    Sub BindReport()
        ...
        Dim strOpCd_CreditNoteList_GET As String = "AR_STDRPT_CREDITNOTE_LIST"
        Dim SearchStr As String
        Dim SQLStr As String

        Dim intCnt As Integer

        If Not (Request.QueryString("InvNoFrom") = "" AND Request.QueryString("InvNoTo") = "") Then SearchStr = " AND CRN.CreditNoteID >='" & Request.QueryString("InvNoFrom") & "' AND CRN.CreditNoteID <='" & Request.QueryString("InvNoTo") & "'"
        If Not Request.QueryString("BillParty") = "" Then SearchStr += " AND CRN.BillPartyCode LIKE '" & Request.QueryString("BillParty") & "' "

        If Not Request.QueryString("CreditNoteType") = "0" Then SearchStr += " AND CRN.DocType = '" & Request.QueryString("CreditNoteType") & "' "
        If Not Request.QueryString("CustomerRef") = "" Then SearchStr += " AND CRN.CustRef LIKE '" & Request.QueryString("CustomerRef") & "' "
        If Not Request.QueryString("DeliveryRef") = "" Then SearchStr += " AND CRN.DeliveryRef LIKE '" & Request.QueryString("DeliveryRef") & "' "
        If Not Request.QueryString("COA") = "" Then SearchStr += " AND CRNln.AccCode = '" & Request.QueryString("COA") & "' "
        If Not Request.QueryString("BlkCode") = "" Then SearchStr += " AND CRNln.BlkCode = '" & Request.QueryString("BlkCode") & "' "
        If Not Request.QueryString("Vehicle") = "" Then SearchStr += " AND CRNln.VehCode = '" & Request.QueryString("Vehicle") & "' "
        If Not Request.QueryString("VehicleExpCode") = "" Then SearchStr += " AND CRNln.VehExpenseCode = '" & Request.QueryString("VehicleExpCode") & "' "
        If Not Request.QueryString("ItemDesc") = "" Then SearchStr += " AND CRNln.Description LIKE '" & Request.QueryString("ItemDesc") & "' "
        If Not Request.QueryString("Status") = "0" Then SearchStr += " AND CRN.Status = '" & Request.QueryString("Status") & "' "



        strParam =  strUserLoc & "|" & strDDLAccMth & "|" & strDDLAccYr & "|"  & strStatus & "|" & SearchStr
        Try
            intErrNo = objAR.mtdGetReport_CreditNoteList(strOpCd_CreditNoteList_GET, strParam, objRptDs, objMapPath)
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=AR_STDRPT_CreditNoteList&errmesg=" & lblErrMessage.Text & "&redirect=")
        End Try
...
Sub PassParam()
        ...
        paramField30 = paramFields.Item("ParamCreditNoteType")
        ...
        ParamDiscreteValue30.Value = Session("SS_CreditNoteType")
