...
Public Class GL_StdRpt_AreaStatement : Inherits Page
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        Response.Write("<Script Language=""JavaScript"">window.open(""GL_StdRpt_AreaStatementPreview.aspx?Type=Print&CompName=" & strCompany & _
