...
Public Class PM_StdRpt_KernelLossTransactionListPreview : Inherits Page
    ...
    Sub BindReport()
       ...
       Dim objRptDs As New DataSet()
        ...
        colParam.Add("PM_STDRPT_DAILYKERNELLOSS_GET_SP", "OC_REPORT_GET")

        Try
            intErrNo = objPM.mtdGetReport_DailyOilLoss(colParam, objRptDs, objMapPath)
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=GET_PM_KernelLossTransaction_GET_LIST_REPORT&errmesg=" & lblErrMessage.Text & "&redirect=")
        End Try


        rdCrystalViewer.Load(objMapPath & "web\" & strLangCode & "\Reports\Crystal\PM_StdRpt_KernelLossTransactionList.rpt", OpenReportMethod.OpenReportByTempCopy)
        ...
        crDiskFileDestinationOptions.DiskFileName = objMapPath & "web\ftp\PM_StdRpt_KernelLossTransactionList.pdf"
        ...
        Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../ftp/PM_StdRpt_KernelLossTransactionList.pdf"">")
    End Sub
