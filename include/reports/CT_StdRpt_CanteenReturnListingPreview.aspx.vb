...
Public Class CT_StdRpt_CanteenReturnListing_Preview : Inherits Page
    Protected WithEvents crvView As CrystalDecisions.Web.CrystalReportViewer
    Protected WithEvents tblCrystal As System.Web.UI.HtmlControls.HtmlTable
    Protected WithEvents lblErrMessage As Label
    Protected WithEvents dgDebug As DataGrid
    ...
    Sub Page_Load(ByVal Sender As Object, ByVal E As EventArgs)
        ...
        strDDLAccMonth = Request.QueryString("AccMonth")
        strDDLAccYear = Request.QueryString("AccYear")
    ...
    Sub BindReport()
        ...
        Dim strOpCd As String = "CT_STDRPT_CANTEEN_RETURN_LISTING_GET"
        
        Dim strParam As String
        
        strSearch = "AND CR.LocCode IN('" & strUserLoc & "') AND CR.AccMonth = '" & strDDLAccMonth & "' AND CR.AccYear = '" & strDDLAccYear & "'" & vbCrLf

        If Not (Request.QueryString("DateFrom") = "" And Request.QueryString("DateTo") = "") Then
            strSearch = strSearch & "AND (DateDiff(Day, '" & Request.QueryString("DateFrom") & "', CR.CreateDate) >= 0) AND (DateDiff(Day, '" & Request.QueryString("DateTo") & "', CR.CreateDate) <= 0) "
        End If

        If Not (Request.QueryString("CanteenReturnIDFrom") = "" And Request.QueryString("CanteenReturnIDTo") = "") Then
            strSearch = strSearch & "AND (CR.StockRtnID >= '" & Request.QueryString("CanteenReturnIDFrom") & "' AND CR.StockRtnID <= '" & Request.QueryString("CanteenReturnIDTo") & "') "
        End If

        If Not Request.QueryString("ProdType") = "" Then
            strSearch = strSearch & "AND ITM.ProdTypeCode LIKE '" & Request.QueryString("ProdType") & "' "
        End If

        If Not Request.QueryString("ProdBrand") = "" Then
            strSearch = strSearch & "AND ITM.ProdBrandCode LIKE '" & Request.QueryString("ProdBrand") & "' "
        End If

        If Not Request.QueryString("ProdModel") = "" Then
            strSearch = strSearch & "AND ITM.ProdModelCode LIKE '" & Request.QueryString("ProdModel") & "' "
        End If

        If Not Request.QueryString("ProdCat") = "" Then
            strSearch = strSearch & "AND ITM.ProdCatCode LIKE '" & Request.QueryString("ProdCat") & "' "
        End If

        If Not Request.QueryString("ProdMat") = "" Then
            strSearch = strSearch & "AND ITM.ProdMatCode LIKE '" & Request.QueryString("ProdMat") & "' "
        End If

        If Not Request.QueryString("StkAna") = "" Then
            strSearch = strSearch & "AND ITM.StockAnalysisCode LIKE '" & Request.QueryString("StkAna") & "' "
        End If

        If Not Request.QueryString("EmpCode") = "" Then
            strSearch = strSearch & "AND CRL.PsEmpCode LIKE '" & Request.QueryString("EmpCode") & "' "
        End If
        
        If Not Request.QueryString("BillPartyCode") = "" Then
            strSearch = strSearch & "AND CI.BillPartyCode LIKE '" & Request.QueryString("BillPartyCode") & "' "
        End If
        
        If Not Request.QueryString("ItemCode") = "" Then
            strSearch = strSearch & "AND ITM.ItemCode LIKE '" & Request.QueryString("ItemCode") & "' "
        End If
        
        If Not Request.QueryString("Status") = objCTTrx.EnumStockReturnStatus.All Then
            strSearch = strSearch & "AND CR.Status = '" & Request.QueryString("Status") & "' "
        End If
        ...
        Try
            intErrNo = objCT.mtdGetReport_CanteenReturnListing(strOpCd, strParam, dsRpt, objMapPath)
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=GET_CANTEEN_RETURN_LISTING_REPORT&errmesg=" & lblErrMessage.Text & "&redirect=")
        End Try
        
        For intCnt = 0 To dsRpt.Tables(0).Rows.Count - 1
            dsRpt.Tables(0).Rows(intCnt).Item("Status") = objCTTrx.mtdGetStockReturnStatus(dsRpt.Tables(0).Rows(intCnt).Item("Status"))
        Next
        

        rdCrystalViewer.Load(objMapPath & "web\" & strLangCode & "\Reports\Crystal\CT_StdRpt_CanteenReturnListing.rpt", OpenReportMethod.OpenReportByTempCopy)
        ...
        crDiskFileDestinationOptions.DiskFileName = objMapPath & "web\ftp\CT_StdRpt_CanteenReturnListing.pdf"
        ...
        Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../ftp/CT_StdRpt_CanteenReturnListing.pdf"">")
    End Sub
    ...
    Sub PassParam()
        ...
        paramField2 = paramFields.Item("ParamUserName")
        paramField3 = paramFields.Item("ParamRptID")
        paramField4 = paramFields.Item("ParamRptName")
        paramField5 = paramFields.Item("ParamLocation")
        paramField6 = paramFields.Item("ParamAccMonth")
        paramField7 = paramFields.Item("ParamAccYear")
        paramField8 = paramFields.Item("ParamDateFrom")
        paramField9 = paramFields.Item("ParamDateTo")
        paramField10 = paramFields.Item("ParamCanteenReturnIDFrom")
        paramField11 = paramFields.Item("ParamCanteenReturnIDTo")
        ...
        paramField17 = paramFields.Item("ParamStockAna")
        paramField18 = paramFields.Item("ParamEmpCode")
        paramField19 = paramFields.Item("ParamBillPartyCode")
        paramField20 = paramFields.Item("ParamItemCode")
        paramField21 = paramFields.Item("ParamStatus")
        paramField22 = paramFields.Item("ParamDecimal")
        paramField23 = paramFields.Item("lblLocation")
        paramField24 = paramFields.Item("lblProdType")
        paramField25 = paramFields.Item("lblProdBrand")
        paramField26 = paramFields.Item("lblProdModel")
        paramField27 = paramFields.Item("lblProdCat")
        paramField28 = paramFields.Item("lblProdMat")
        paramField29 = paramFields.Item("lblStockAna")
        paramField30 = paramFields.Item("lblBillParty")
        paramField31 = paramFields.Item("lblAccount")
        paramField32 = paramFields.Item("lblBlock")
        paramField33 = paramFields.Item("lblVehicle")
        paramField34 = paramFields.Item("lblVehExp")
        ...
        ParamDiscreteValue3.Value = Request.QueryString("RptID")
        ParamDiscreteValue4.Value = Request.QueryString("RptName")
        ParamDiscreteValue5.Value = Session("SS_LOC")
        ParamDiscreteValue6.Value = Request.QueryString("AccMonth")
        ParamDiscreteValue7.Value = Request.QueryString("AccYear")
        ParamDiscreteValue8.Value = Request.QueryString("DateFrom")
        ParamDiscreteValue9.Value = Request.QueryString("DateTo")
        ParamDiscreteValue10.Value = Request.QueryString("CanteenReturnIDFrom")
        ParamDiscreteValue11.Value = Request.QueryString("CanteenReturnIDTo")
        ...
        ParamDiscreteValue18.Value = Request.QueryString("EmpCode")
        ParamDiscreteValue19.Value = Request.QueryString("BillPartyCode")
        ParamDiscreteValue20.Value = Request.QueryString("ItemCode")
        ParamDiscreteValue21.Value = objCTTrx.mtdGetStockReturnStatus(Request.QueryString("Status"))
        ParamDiscreteValue22.Value = Request.QueryString("Decimal")
        ...
        ParamDiscreteValue30.Value = Request.QueryString("lblBillPartyCode")
        ParamDiscreteValue31.Value = Request.QueryString("lblAccCode")
        ParamDiscreteValue32.Value = Request.QueryString("lblBlkCode")
        ParamDiscreteValue33.Value = Request.QueryString("lblVehCode")
        ParamDiscreteValue34.Value = Request.QueryString("lblVehExpCode")
