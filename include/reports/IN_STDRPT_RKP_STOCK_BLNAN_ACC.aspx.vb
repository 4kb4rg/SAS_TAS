...
Public Class IN_STDRPT_RKP_STOCK_BLNAN_ACC : Inherits Page
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        Response.Write("<Script Language=""JavaScript"">window.open(""IN_STDRPT_RKP_STOCK_BLNAN_ACC_Preview.aspx?Type=Print&CompName=" & strCompany & _
