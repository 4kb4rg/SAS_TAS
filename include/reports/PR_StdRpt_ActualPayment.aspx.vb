...
Public Class PR_StdRpt_ActualPayment : Inherits Page
    ...
    Sub BindDeptCode()
        ...
        strParam = "|" & objHRSetup.EnumDeptStatus.Active & "' AND A.LocCode = '" & strLocation & "||A.DeptCode||"
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        Response.Write("<Script Language=""JavaScript"">window.open(""PR_StdRpt_ActualPaymentPreview.aspx?Type=Print&CompName=" & strCompany & _
                       "&RptID=" & strRptID & _
