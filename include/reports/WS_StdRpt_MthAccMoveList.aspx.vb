...
Public Class WS_StdRpt_MthAccMoveList : Inherits Page
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        Response.Write("<Script Language=""JavaScript"">window.open(""WS_StdRpt_MthAccMoveListPreview.aspx?Type=Print&Location=" & strUserLoc & _
