...
Public Class AP_StdRpt_MutasiAccountPayableDetail : Inherits Page
	...
	Protected WithEvents ddlSplType As DropDownList
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        strSrchSupplier = Server.UrlEncode(Trim(txtSupplierCode.Text))
        ...
        Response.Write("<Script Language=""JavaScript"">window.open(""AP_StdRpt_MutasiAccountPayableDetailPreview.aspx?Type=Print&CompName=" & strCompany & _
