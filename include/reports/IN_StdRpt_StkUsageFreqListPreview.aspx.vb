...
Public Class IN_StdRpt_StkUsageFreqListPreview : Inherits Page
    ...
    Sub BindReport()
        ...
        Dim strOpCdItem_GET As String = "IN_STDRPT_STKUSAGEFREQ_ITEM_GET"
        Dim strOpCdPRLn_GET As String = "IN_STDRPT_STKUSAGEFREQ_PRLN_GET"
        ...
        If Not SearchStr = "" Then
            ...
            strParam = objINSetup.EnumInventoryItemType.Stock & "|" & strUserLoc & "|" & objINSetup.EnumStockItemStatus.Active & "|" & _
                       SearchStr & "|" & Request.QueryString("SortBy") & "|" & Request.QueryString("OrderBy")
        End If

        Try
            intErrNo = objIN.mtdGetReport_StkUsageFreqList(strOpCdItem_GET, strParam, objRptDs, objMapPath)
        ...
        For intItemCode = 0 To objRptDs.Tables(0).Rows.Count - 1
            ...
            If objRptDs.Tables(0).Rows.Count > 0 Then
                strParamItemCode = objINTrx.EnumPurReqDocType.StockPR & "|" & strItemCode & "|" & strUserLoc
                Try
                    intErrNo = objIN.mtdGetStkUsageFreqPurchaseRequestLn(strOpCdPRLn_GET, strParamItemCode, objRptPRLn)
                Catch Exp As System.Exception
        ...
        rdCrystalViewer.Load(objMapPath & "web\" & strLangCode & "\Reports\Crystal\IN_StdRpt_StkUsageFreqList.rpt", OpenReportMethod.OpenReportByTempCopy)
        ...
        crDiskFileDestinationOptions.DiskFileName = objMapPath & "web\ftp\IN_StdRpt_StkUsageFreqList.pdf"
        ...
        Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../ftp/IN_StdRpt_StkUsageFreqList.pdf"">")
    End Sub
