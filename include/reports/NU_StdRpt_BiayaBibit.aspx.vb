...
Public Class NU_StdRpt_BiayaBibit : Inherits Page
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        strBatchNo = ddlBatchNo.SelectedItem.Value
        ...
        Response.Write("<Script Language=""JavaScript"">window.open(""NU_StdRpt_BiayaBibitPreview.aspx?Type=Print&CompName=" & strCompany & _
