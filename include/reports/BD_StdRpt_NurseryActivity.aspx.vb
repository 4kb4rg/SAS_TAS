...
Public Class BD_StdRpt_NurseryActivity : Inherits Page
    ...
    Sub onload_GetLangCap()
        ...
        lblTitle.Text = "BUDGETING - NURSERY ACTIVITY"
    ...
    Sub GetEntireLangCap()
        ...
        Catch Exp As System.Exception
            Response.Redirect("../../../include/mesg/ErrorMessage.aspx?errcode=BD_STDRPT_NURSERYACTIVITY_BUSSTERM_GET&errmesg=" & lblErrMessage.Text & "&redirect=../en/reports/BD_StdRpt_Selection.aspx")
        End Try
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        Response.Write("<Script Language=""JavaScript"">window.open(""BD_StdRpt_NurseryActivityPreview.aspx?DDLPeriodID=" & strddlPeriodID & "&DDLPeriodName=" & strddlPeriodName & _
                       "&RptID=" & strRptID & "&RptName=" & strRptName & "&Decimal=" & strDec & "&lblNurseryActivity=" & lblNurseryActivity.Text & "&BlkCode=" & strBlkCode & _
                       "&lblBlkCodeTag=" & lblBlkCodeTag.Text & "&lblAccCodeTag=" & lblAccCodeTag.Text & "&lblLocationTag=" & lblLocationTag.Text & """,null ,""status=yes, resizable=yes, scrollbars=yes, toolbar=no, location=no"");</Script>")
    End Sub
