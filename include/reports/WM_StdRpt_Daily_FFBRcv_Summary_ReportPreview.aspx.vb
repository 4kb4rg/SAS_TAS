...
Public Class WM_StdRpt_Daily_FFBSumPreview : Inherits Page
    ...
    Sub Page_Load(ByVal Sender As Object, ByVal E As EventArgs)
        ...
        strSupCode = Trim(Request.QueryString("SupCode"))
    ...
    Sub BindReport()
        ...
        Dim strOpCd_Daily_FFBRcv_Sum_GET As String = "WM_STDRPT_DAILY_FFBRCV_SUMMARY_REPORT"
        Dim strFileName As String = "WM_StdRpt_DailyFFBRcvSum"
        ...
        Try
            intErrNo = objWM.mtdGetReport_DailyFFBRcvSummaryReport(strOpCd_Daily_FFBRcv_Sum_GET, _
                                                                   strParam, _
                                                                   objRptDs, _
                                                                   objMapPath)
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=WM_STDRPT_DAILY_FFBRCV_SUM&errmesg=" & lblErrMessage.Text & "&redirect=")
        End Try
    ...
    Sub BindReport_DetailByDate()
        ...
        Dim strOpCd_Daily As String = "WM_STDRPT_DAILY_FFBRCV_SUMMARY_BYDATE_REPORT"
        Dim strFileName As String = "WM_StdRpt_FFBRcvSumBySupplier_Monthly"
 

        Dim strParamName As String
        Dim strParamValue As String

        strParamName = "LOCCODE|ACCMONTH|ACCYEAR|SUPCODE"
        strParamValue = strUserLoc & "|" & Request.QueryString("strddlAccMth") & "|" & Request.QueryString("strddlAccYr") & "|" & strSupCode

        Try
            intErrNo = objOk.mtdGetReportDataCommon(strOpCd_Daily, strParamName, strParamValue, objRptDs, objMapPath, objFTPFolder)
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=WM_STDRPT_DAILY_FFBRCV_SUM&errmesg=" & lblErrMessage.Text & "&redirect=")
        End Try
