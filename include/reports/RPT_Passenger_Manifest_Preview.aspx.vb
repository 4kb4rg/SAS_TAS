...
Public Class RPT_Passenger_Manifest_Preview : Inherits Page
    ...
    Sub Page_Load(ByVal Sender As Object, ByVal E As EventArgs)
        ...
        strOrigin = Trim(Request.QueryString("strOrigin"))
        strDestination = Trim(Request.QueryString("strDestination"))
    ...
    Sub BindReport()
        ...
        strOpCode = "REPORTS_PSGR_MANIFEST"
        strFileName = "RPT_Passenger_Manifest"


        If strFlightNo = "" And strAirline = "" And strOrigin = "" And strDestination = "" Then
            strSearch = ""
        Else
            If strFlightNo <> "" Then
            ...
            ElseIf strOrigin <> "" Then
                strSearch = strSearch + " AND Origin = '" & strOrigin & "'"
            ElseIf strDestination <> "" Then
                strSearch = strSearch + " AND Destination = '" & strDestination & "'"
            End If
        End If
        ...
        objRptDs.Tables(0).TableName = "RPT_PSGR_MANIFEST"
        objRptDs.Tables(1).TableName = "RPT_FLIGHT_MANIFEST"
