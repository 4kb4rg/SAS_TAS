...
Public Class WS_StdRpt_ReplacementScheduleList_Preview : Inherits Page
    ...
    Sub BindReport()
        ...
        rdCrystalViewer.Load(objMapPath & "web\" & strLangCode & "\Reports\Crystal\WS_StdRpt_PreventiveMaintenance.rpt", OpenReportMethod.OpenReportByTempCopy)
        ...
        crDiskFileDestinationOptions.DiskFileName = objMapPath & "web\ftp\WS_StdRpt_PreventiveMaintenance.pdf"
        ...
        Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../ftp/WS_StdRpt_PreventiveMaintenance.pdf"">")
        ...
        '' ''rdCrystalViewer.Load(objMapPath & "web\" & strLangCode & "\Reports\Crystal\WS_StdRpt_PreventiveMaintenance.rpt", OpenReportMethod.OpenReportByTempCopy)
        ' '' ''rdCrystalViewer.Load(objMapPath & "Web\en\reports\Crystal\WS_StdRpt_PreventiveMaintenance.rpt", OpenReportMethod.OpenReportByTempCopy)
        ...
        '' ''crDiskFileDestinationOptions.DiskFileName = objMapPath & "web\ftp\WS_StdRpt_PreventiveMaintenance.xls"
        ...
        '' ''rdCrystalViewer.Export()
        '' ''Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../ftp/WS_StdRpt_PreventiveMaintenance.xls"">")
    End Sub
    ...
    Sub PassParam()
        ...
        paramField5 = paramFields.Item("ParamReplDateFrom")
        paramField6 = paramFields.Item("ParamReplDateTo")
        paramField7 = paramFields.Item("ParamBlkCode")
        paramField8 = paramFields.Item("ParamCompany")
        '        paramField8 = paramFields.Item("lblLocation")
        'paramField9 = paramFields.Item("ParamSubBlkCode")
        ...
        ParamDiscreteValue5.Value = Session("SS_REPLDATEFROM")
        ParamDiscreteValue6.Value = Session("SS_REPLDATETO")
        ParamDiscreteValue7.Value = Session("SS_BLKCODE")
        ParamDiscreteValue8.Value = Session("SS_LOCATIONNAME")
        ...
        'PFDefs(6).ApplyCurrentValues(crParameterValues9)
