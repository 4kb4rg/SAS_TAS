...
Public Class PM_StdRpt_MonthlyRecordProd : Inherits Page
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        Response.Write("<Script Language=""JavaScript"">window.open(""PM_StdRpt_MonthlyRecordProdPreview.aspx?Type=Print&CompName=" & strCompany & "&Location=" & strUserLoc & "&RptID=" & strRptID & "&RptName=" & strRptName & _
                       "&strddlAccMth=" & strddlAccMth & _
                       "&strddlAccYr=" & strddlAccYr & _
                       "&Decimal=" & strDec & _
                       "&lblLocation=" & lblLocation.Text & _
                       "&TransDate=" & strTrxDate & _
