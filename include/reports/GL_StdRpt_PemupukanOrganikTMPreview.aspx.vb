...
Public Class GL_StdRpt_PemupukanOrganikTMPreview : Inherits Page
    ...
    Sub PassParam()
        ...
        ParamDiscreteValue9.Value = UCase(strBlkGrpTag)
        ParamDiscreteValue10.Value = UCase(strBlkTag)
        ParamDiscreteValue11.Value = strRemark
        ...
        ParamFieldDef9 = ParamFieldDefs.Item("lblBlkGrp")
        ParamFieldDef10 = ParamFieldDefs.Item("lblBlk")
        ParamFieldDef11 = ParamFieldDefs.Item("Remark")
    ...
    Sub onload_GetLangCap()
        ...
        strBlkGrpTag = GetCaption(objLangCap.EnumLangCap.BlockGrp)
    ...
    Sub GetEntireLangCap()
        ...
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=GL_STDRPT_PemupukanOrganikTM_GET_LANGCAP&errmesg=" & Exp.ToString() & "&redirect=")
        End Try
    ...
    Sub BindSummReport()
        ...
        Try
            strRptPrefix = "GL_StdRpt_PemupukanOrganikTM"

            strOpCd = "GL_STDRPT_MR_PEMUPUKANORGANIKTM_GET_SP" & "|" & objGLRpt.mtdGetGLReportTable(objGLRpt.EnumGLReportTable.PemupukanOrganikTM) & Chr(9) & _
            ...
            intErrNo = objGLRpt.mtdGetReport_PemupukanOrganikTM(strOpCd, _
                                                    strCompany, _
                                                    strLocation, _
                                                    strUserId, _
                                                    strAccMonth, _
        ...
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=GL_STDRPT_PemupukanOrganikTM_GET_SP&errmesg=" & Exp.ToString() & "&redirect=")
        End Try
