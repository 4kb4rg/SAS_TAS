...
Public Class AP_StdRpt_MutasiAccountPayableDetailPreview : Inherits Page
    ...
    Sub Page_Load(ByVal Sender As Object, ByVal E As EventArgs)
        ...
        Else
            ...
            strSplType = Trim(Request.QueryString("SrchSplType"))
    ...
    Sub BindReport()
        ...
        Dim strOpCode As String = "AP_STDRPT_MUTASI_DETAIL_GET"
        Dim strFileName As String = "AP_StdRpt_MutasiAccountPayable_Detail"
        ...
        strParamName = "SUPCODE|LOCCODE|PERIOD1|PERIOD2|SUPTYPE|RPTTYPE"
        strParamValue = strSrchSupplier & "|''" & strSelLocation & "''|" & strSrchPeriode1 & "|" & strSrchPeriode2 & "|" & strSplType & "|" & strRptType

        Try
            intErrNo = objGLRpt.mtdGetReport_BiayaProduksi(strOpCode, strParamName, strParamValue, objRptDs, objMapPath, objFTPFolder)

            objRptDs.Tables(0).TableName = "AP_StdRpt_MutasiAccountPayable_SaldoAwalDet"
            objRptDs.Tables(1).TableName = "AP_StdRpt_MutasiAccountPayable_SaldoAkhirDet"
            objRptDs.Tables(1).TableName = "AP_StdRpt_MutasiAccountPayable"
            objRptDs.Tables(1).TableName = "AP_StdRpt_MutasiAccountPayable_Plus"
            objRptDs.Tables(1).TableName = "AP_StdRpt_MutasiAccountPayable_Plus2"
            objRptDs.Tables(1).TableName = "AP_StdRpt_MutasiAccountPayable_Min"
            objRptDs.Tables(1).TableName = "AP_StdRpt_MutasiAccountPayable_Min2"
        ...
        'response.write(objMapPath & "web\" & strLangCode & "\Reports\Crystal\" & strFileName & ".rpt")

        objRptDs1.Tables.Add(objRptDs.Tables(0).Copy())
        objRptDs1.Tables(0).TableName = "AP_StdRpt_MutasiAccountPayable_SaldoAwalDet"
        objRptDs1.Tables.Add(objRptDs.Tables(1).Copy())
        objRptDs1.Tables(1).TableName = "AP_StdRpt_MutasiAccountPayable_SaldoAkhirDet"
        objRptDs1.Tables.Add(objRptDs.Tables(2).Copy())
        objRptDs1.Tables(2).TableName = "AP_StdRpt_MutasiAccountPayable"
        objRptDs1.Tables.Add(objRptDs.Tables(3).Copy())
        objRptDs1.Tables(3).TableName = "AP_StdRpt_MutasiAccountPayable_Plus"
        objRptDs1.Tables.Add(objRptDs.Tables(4).Copy())
        objRptDs1.Tables(4).TableName = "AP_StdRpt_MutasiAccountPayable_Plus2"
        objRptDs1.Tables.Add(objRptDs.Tables(5).Copy())
        objRptDs1.Tables(5).TableName = "AP_StdRpt_MutasiAccountPayable_Min"
        objRptDs1.Tables.Add(objRptDs.Tables(6).Copy())
        objRptDs1.Tables(6).TableName = "AP_StdRpt_MutasiAccountPayable_Min2"
