...
Public Class AR_StdRpt_Customer_AgeingList : Inherits Page
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        strSrchSupplier = RadCmbCustCode.SelectedValue

        strddlAccMth = ddlSrchAccMonthFrom.SelectedItem.Value
        strddlAccYr = ddlSrchAccYearFrom.SelectedItem.Value

        strExportToExcel = IIf(cbExcel.Checked = True, "1", "0")

        Response.Write("<Script Language=""JavaScript"">window.open(""AR_StdRpt_Customer_AgeingListPreview.aspx?Type=Print&CompName=" & strCompany & _
