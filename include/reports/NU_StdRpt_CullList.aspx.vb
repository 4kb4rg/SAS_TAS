...
Public Class NU_StdRpt_CullList : Inherits Page
    ...
    Protected WithEvents txtCullTypeCode As TextBox
    ...
    Sub onload_GetLangCap()
        ...
        lblCullTypeCode.Text = GetCaption(objLangCap.EnumLangCap.CullType)
    ...
    Sub BindStatus()
        lstStatus.Items.Add(New ListItem(objNUTrx.mtdGetCullStatus(objNUTrx.EnumCullStatus.All), objNUTrx.EnumCullStatus.All))
        lstStatus.Items.Add(New ListItem(objNUTrx.mtdGetCullStatus(objNUTrx.EnumCullStatus.Confirmed), objNUTrx.EnumCullStatus.Confirmed))
        lstStatus.Items.Add(New ListItem(objNUTrx.mtdGetCullStatus(objNUTrx.EnumCullStatus.Deleted), objNUTrx.EnumCullStatus.Deleted))
        lstStatus.Items.Add(New ListItem(objNUTrx.mtdGetCullStatus(objNUTrx.EnumCullStatus.Closed), objNUTrx.EnumCullStatus.Closed))
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        If txtCullTypeCode.Text = "" Then
            strCullTypeCode = ""
        Else
            strCullTypeCode = Trim(txtCullTypeCode.Text)
        End If
        ...
        strCullTypeCode = Server.UrlEncode(strCullTypeCode)
        ...
        If Not (strTxDateFrom = "" And strTxDateTo = "") Then
            If objGlobal.mtdValidInputDate(strDateSetting, strTxDateFrom, objDateFormat, objDateFrom) = True And objGlobal.mtdValidInputDate(strDateSetting, strTxDateTo, objDateFormat, objDateTo) = True Then
                Response.Write("<Script Language=""JavaScript"">window.open(""NU_StdRpt_CullListPreview.aspx?Type=Print&CompName=" & strCompany & "&Location=" & strUserLoc & "&RptID=" & strRptID & _
                               "&RptName=" & strRptName & "&Decimal=" & strDec & "&TxDateFrom=" & objDateFrom & "&TxDateTo=" & objDateTo & _
                               "&DDLAccMth=" & strddlAccMth & "&DDLAccYr=" & strddlAccYr & "&DDLAccMthTo=" & strddlAccMthTo & "&DDLAccYrTo=" & strddlAccYrTo & "&CullTypeCode=" & strCullTypeCode & "&lblCullTypeCode=" & lblCullTypeCode.Text & _
                               "&lblLocation=" & lblLocation.Text & "&lblBlkCode=" & lblBlkCode.Text & "&lblBatchNo=" & lblBatchNo.Text & "&TxIDFrom=" & strTxIDFrom & "&TxIDTo=" & strTxIDTo & _
