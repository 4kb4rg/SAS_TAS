...
Public Class RPT_Flight_Manifest : Inherits Page
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        Response.Write("<Script Language=""JavaScript"">window.open(""RPT_Flight_Manifest_Preview.aspx?Type=Print&CompName=" & strCompany & _
