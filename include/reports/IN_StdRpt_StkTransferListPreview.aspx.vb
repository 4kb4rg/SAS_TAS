...
Public Class IN_StdRpt_StkTransferListPreview : Inherits Page
    ...
    Sub BindReport()
        ...
        Dim strOpCd As String = "IN_STDRPT_STOCKTRANSFER_LISTING_GET"
        ...
        If Not Request.QueryString("Status") = "" Then
            If Not Request.QueryString("Status") = objINTrx.EnumStockTransferStatus.All Then
        ...
        Try
            intErrNo = objIN.mtdGetReport_StkTransferList(strOpCd, strParam, objRptDs, objMapPath)
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=GET_STOCKTRANSFER_LIST_REPORT&errmesg=" & Exp.ToString & "&redirect=")
        End Try


        rdCrystalViewer.Load(objMapPath & "web\" & strLangCode & "\Reports\Crystal\IN_StdRpt_StkTransferList.rpt", OpenReportMethod.OpenReportByTempCopy)
        ...
        crDiskFileDestinationOptions.DiskFileName = objMapPath & "web\ftp\IN_StdRpt_StkTransferList.pdf"
        ...
        Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../ftp/IN_StdRpt_StkTransferList.pdf"">")
    End Sub
