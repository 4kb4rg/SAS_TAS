...
Public Class PM_StdRpt_CPOStorageTransactionList : Inherits Page
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        If strErrDateFrom = "" And strErrDateTo = "" Then
            ...
            Response.Write("<Script Language=""JavaScript"">window.open(""PM_StdRpt_CPOStorageTransactionListPreview.aspx?Type=Print&CompName=" & strCompany & "&Location=" & strUserLoc & "&RptID=" & strRptID & "&RptName=" & strRptName & _
                           "&strddlAccMth=" & strddlAccMth & "&strddlAccYr=" & strddlAccYr & "&Decimal=" & strDec & "&lblLocation=" & lblLocation.Text & _
                           "&strDateFrom=" & strDateFrom & "&strDateTo=" & strDateTo & "&strStorageAreaCode=" & strStorageAreaCode &  """,null ,""status=yes, resizable=yes, scrollbars=yes, toolbar=no, location=no"");</Script>")
        Else
