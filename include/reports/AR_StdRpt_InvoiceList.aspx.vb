...
Public Class AR_StdRpt_InvoiceList : Inherits Page
    ...
    Sub BindInvoiceType()
        ...
        ddlInvoiceType.Items.Add(New ListItem(objARTrx.mtdGetInvoiceDocType(objARTrx.EnumInvoiceDocType.Manual), objARTrx.EnumInvoiceDocType.Manual))
        ddlInvoiceType.Items.Add(New ListItem(objARTrx.mtdGetInvoiceDocType(objARTrx.EnumInvoiceDocType.Manual_Millware), objARTrx.EnumInvoiceDocType.Manual_Millware))
    ...
    Sub BindStatus()
        ...
        ddlStatus.Items.Add(New ListItem(objARTrx.mtdGetCreditNoteStatus(objARTrx.EnumInvoiceStatus.Active), objARTrx.EnumInvoiceStatus.Active))
        ddlStatus.Items.Add(New ListItem(objARTrx.mtdGetCreditNoteStatus(objARTrx.EnumInvoiceStatus.Confirmed), objARTrx.EnumInvoiceStatus.Confirmed))
        ddlStatus.Items.Add(New ListItem(objARTrx.mtdGetCreditNoteStatus(objARTrx.EnumInvoiceStatus.Deleted), objARTrx.EnumInvoiceStatus.Deleted))
        ddlStatus.Items.Add(New ListItem(objARTrx.mtdGetCreditNoteStatus(objARTrx.EnumInvoiceStatus.Cancelled), objARTrx.EnumInvoiceStatus.Cancelled))        
        ddlStatus.Items.Add(New ListItem(objARTrx.mtdGetCreditNoteStatus(objARTrx.EnumInvoiceStatus.Closed), objARTrx.EnumInvoiceStatus.Closed))        
        ddlStatus.Items.Add(New ListItem(objARTrx.mtdGetCreditNoteStatus(objARTrx.EnumInvoiceStatus.WrittenOff), objARTrx.EnumInvoiceStatus.WrittenOff))        
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        strInvoiceType = Trim(ddlInvoiceType.SelectedItem.value)
        ...
        strInvoiceType = Server.UrlEncode(strInvoiceType)
        ...
        If txtSubBlkCode.visible = true then strBlock = Trim(txtSubBlkCode.Text)
                ...
                Response.Write("<Script Language=""JavaScript"">window.open(""AR_StdRpt_InvoiceListPreview.aspx?CompName=" & strCompany & "&Location=" & strUserLoc & "&RptID=" & strRptID & "&RptName=" & strRptName & "&Decimal=" & strDec & _
                            ...
                            "&InvoiceType=" & strInvoiceType & "&CustomerRef=" & strCustomerRef & "&DeliveryRef=" & strDeliveryRef & _
