...
Public Class PM_StdRpt_DailyProdRpt_Preview : Inherits Page
    ...
    Sub BindReport()
        ...
        Dim strOpCd_Losis As String = "WM_STDRPT_PRODUCTION_DAILY_LOSIS_REPORT_GET"
        Dim strOpCd_Limbah As String = "WM_STDRPT_PRODUCTION_DAILY_LIMBAH_REPORT_GET"
        Dim strOpCd_Bahan As String = "WM_STDRPT_PRODUCTION_DAILY_BAHAN_REPORT_GET"
        Dim strOpCd_Kualitas As String = "WM_STDRPT_PRODUCTION_DAILY_KUALITAS_REPORT_GET"
        Dim strOpCd_Bulking As String = "WM_STDRPT_PRODUCTION_DAILY_BULKING_REPORT_GET"
        ...
        Dim dsLosis As New DataSet()
        Dim dsBahan As New DataSet()
        Dim dsKualitas As New DataSet()
        Dim dsLimbah As New DataSet()
        Dim dsBulking As New DataSet()
        ...
        Try
            intErrNo = objOk.mtdGetReportDataCommon(strOpCd_Losis, strParamName, strParamValue, dsLosis, objMapPath, objFTPFolder)
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=WM_STDRPT_PRODUCTION_DAILY_CPO_REPORT_GET&errmesg=" & lblErrMessage.Text & "&redirect=")
        End Try

        Try
            intErrNo = objOk.mtdGetReportDataCommon(strOpCd_Kualitas, strParamName, strParamValue, dsKualitas, objMapPath, objFTPFolder)
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=WM_STDRPT_PRODUCTION_DAILY_CPO_REPORT_GET&errmesg=" & lblErrMessage.Text & "&redirect=")
        End Try

        Try
            intErrNo = objOk.mtdGetReportDataCommon(strOpCd_Bahan, strParamName, strParamValue, dsBahan, objMapPath, objFTPFolder)
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=WM_STDRPT_PRODUCTION_DAILY_CPO_REPORT_GET&errmesg=" & lblErrMessage.Text & "&redirect=")
        End Try

        'Try
        '    intErrNo = objOk.mtdGetReportDataCommon(strOpCd_Limbah, strParamName, strParamValue, dsLimbah, objMapPath, objFTPFolder)
        'Catch Exp As System.Exception
        '    Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=WM_STDRPT_PRODUCTION_DAILY_CPO_REPORT_GET&errmesg=" & lblErrMessage.Text & "&redirect=")
        'End Try
        ...
        Try
            intErrNo = objOk.mtdGetReportDataCommon(strOpCd_Bulking, strParamName, strParamValue, dsBulking, objMapPath, objFTPFolder)
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=WM_STDRPT_PRODUCTION_DAILY_CPO_REPORT_GET&errmesg=" & lblErrMessage.Text & "&redirect=")
        End Try
        ...
        rdCrystalViewer.Subreports.Item("LOSIS").SetDataSource(dsLosis.Tables(0))
        rdCrystalViewer.Subreports.Item("KUALITAS").SetDataSource(dsKualitas.Tables(0))
        rdCrystalViewer.Subreports.Item("BAHAN").SetDataSource(dsBahan.Tables(0))

        'rdCrystalViewer.Subreports.Item("LIMBAH").SetDataSource(dsLimbah.Tables(0))

        rdCrystalViewer.Subreports.Item("BULKING").SetDataSource(dsBulking.Tables(0))
