...
Public Class PD_StdRpt_OilPalmList : Inherits Page
    ...
    Protected WithEvents txtYieldIDFrom As TextBox
    Protected WithEvents txtYieldIDTo As TextBox
    ...
    Sub Page_Load(ByVal Sender As Object, ByVal E As EventArgs)
        ...
        Else
            ...
            If objSysCfg.mtdHasConfigValue(objSysCfg.mtdGetConfigSetting(objSysCfg.EnumConfig.BlockYieldLevel), intConfigSetting) = True Then
                strBlockTag = GetCaption(objLangCap.EnumLangCap.Block) & " Code"
            Else                
                strBlockTag = GetCaption(objLangCap.EnumLangCap.SubBlock) & " Code"
            End If
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        strYieldIDFrom = txtYieldIDFrom.Text
        strYieldIDTo = txtYieldIDTo.Text
        ...
        strStatusValue = Trim(lstStatus.SelectedItem.Value)
        ...
        If strErrDateFrom = "" And strErrDateTo = "" Then
            ...
            Response.Write("<Script Language=""JavaScript"">window.open(""PD_StdRpt_OilPalmListPreview.aspx?Type=Print&CompName=" & strCompany & _
                        "&Location=" & strUserLoc & _
                        "&DDLAccMth=" & strddlAccMth & _
                        "&DDLAccYr=" & strddlAccYr & _
                        "&RptID=" & strRptID & _
                        "&RptName=" & strRptName & _
                        "&YieldIDFrom=" & strYieldIDFrom & _
                        "&YieldIDTo=" & strYieldIDTo & _                        
