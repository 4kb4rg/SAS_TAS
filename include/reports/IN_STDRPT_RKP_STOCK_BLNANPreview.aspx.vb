...
Public Class IN_STDRPT_RKP_STOCK_BLNANPreview : Inherits Page
    ...
    Sub Page_Load(ByVal Sender As Object, ByVal E As EventArgs)
        ...
        Else
            ...
            strReportLevel = Trim(Request.QueryString("ReportLevel")) 
            ...
            strStorage = Trim(Request.QueryString("Storage"))
    ...
    Sub BindReport()
        ...
        Dim strOpCode As String = "IN_STDRPT_RKP_STOCK_BLNAN_STORAGE"
        Dim strParamName As String = ""
        Dim strParamValue As String = ""
        Dim objFTPFolder As String
        Dim strFileName As String

        Select Case  Trim(strReportLevel)
        Case "RPTIN1000024.A"        
            If strReportType = "1" Then
                strFileName = "IN_STDRPT_RKP_STOCK_BLNAN_WAREHOUSE"          
            elseif strReportType = "2"
                strFileName = "IN_STDRPT_RKP_STOCK_BLNAN_WAREHOUSE_GROUP"   
            End If
        Case "RPTIN1000024.B"
            If strReportType = "1" Then
                strFileName = "IN_STDRPT_RKP_STOCK_BLNAN_WAREHOUSE_PRICE"          
            elseif strReportType = "2"
                strFileName = "IN_STDRPT_RKP_STOCK_BLNAN_WAREHOUSE_GROUP_PRICE"   
            End If
        End Select
        strParamName = "LocCode|AccMonth|AccYear|ItemCode|ItemCodeTo|Storage|SaldoCat"
