...
Public Class BD_StdRpt_MatureCropPreview : Inherits Page
    ...
    Sub BindReport()
        ...
        Dim strParamMatureCrop As String

        Dim crExportOptions As ExportOptions
        Dim crDiskFileDestinationOptions As DiskFileDestinationOptions

        Dim strOpCd_MatureCrop_Format_GET As String = "BD_CLSTRX_MATURECROP_FORMAT_GET"
        Dim strOpCd_MatureCrop_BlkCode_GET As String = "BD_STDRPT_MATURECROP_BLKCODE_GET"
        Dim strOppCd_MatureCrop_TotalFFB_GET As String = "BD_CLSTRX_MATURECROP_PRODFFB_GET"
        Dim strOppCd_MatureCrop_TotalArea_GET As String
        ...
        strParamMatureCrop = Request.QueryString("DDLPeriodID") & "|" & strLocation & "|" & SearchStr & "|" & "MC.BlkCode, MCS.DispSeq ASC"
        Try
            intErrNo = objBD.mtdGetReport_MatureCrop(strOpCd_MatureCrop_Format_GET, strParamMatureCrop, objRptDs, objMapPath)
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=BD_MATURECROP_GET&errmesg=" & lblErrMessage.Text & "&redirect=")
        End Try

        strParam = strLocation & "|" & Request.QueryString("DDLPeriodID") & "|"
        Try
            intErrNo = objBD.mtdGetMatureCropBlkCode(strOpCd_MatureCrop_BlkCode_GET, strParam, dsBlkCode)
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=BD_STDRPT_MATURECROP_BLKCODE_GET&errmesg=" & lblErrMessage.Text & "&redirect=")
        End Try
        ...
        For intCnt = 0 To dsBlkCode.Tables(0).Rows.Count - 1
            ...
            If objSysCfg.mtdHasConfigValue(objSysCfg.mtdGetConfigSetting(objSysCfg.EnumConfig.BlockCostLevel), intConfigsetting) = True Then
                strOppCd_MatureCrop_TotalArea_GET = "BD_CLSTRX_MATURECROP_BLKTOTALAREA_GET"
                strParamArea = objGLSetup.EnumBlockType.MatureField & "|" & objGLSetup.EnumBlockStatus.Active & "|" & strLocation & "|" & strBlkCode & "|"
            Else
                strOppCd_MatureCrop_TotalArea_GET = "BD_CLSTRX_MATURECROP_SUBBLKTOTALAREA_GET"
                strParamArea = objGLSetup.EnumBlockType.MatureField & "|" & objGLSetup.EnumSubBlockStatus.Active & "|" & strLocation & "|" & strBlkCode & "|"
            End If

            Try
                intErrNo = objBDTrx.mtdGetMatureCropTotalArea(strOppCd_MatureCrop_TotalArea_GET, strParamArea, dsTotalArea)
            Catch Exp As System.Exception
                Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=BD_STDRPT_MATURECROP_TOTALAREA_GET&errmesg=" & lblErrMessage.Text & "&redirect=")
            End Try

            strParamFFB = strBlkCode & "|" & Request.QueryString("DDLPeriodID") & "|" & strLocation & "|"
            Try
                intErrNo = objBDTrx.mtdGetMatureCropTotalFFB(strOppCd_MatureCrop_TotalFFB_GET, strParamFFB, dsTotalYield)
            Catch Exp As System.Exception
                Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=BD_STDRPT_MATURECROP_TOTALYIELD_GET&errmesg=" & lblErrMessage.Text & "&redirect=")
            End Try
        ...
        rdCrystalViewer.Load(objMapPath & "web\" & strLangCode & "\Reports\Crystal\BD_StdRpt_MatureCrop.rpt", OpenReportMethod.OpenReportByTempCopy)
        ...
        crDiskFileDestinationOptions.DiskFileName = objMapPath & "web\ftp\BD_StdRpt_MatureCrop.pdf"
        ...
        Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../ftp/BD_StdRpt_MatureCrop.pdf"">")
    End Sub
    ...
    Sub GetEntireLangCap()
        ...
        Try
            intErrNo = objLangCap.mtdGetBussTerm(strOpCode_BussTerm, _
                                                 ...
                                                 strParam)
        Catch Exp As System.Exception
            Response.Redirect("../../../include/mesg/ErrorMessage.aspx?errcode=BD_STDRPT_MATURECROP_LANGCAP_GET&errmesg=" & lblErrMessage.Text & "&redirect=")
        End Try
