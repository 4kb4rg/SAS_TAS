...
Public Class PD_StdRpt_ProdDet_Estate_Preview : Inherits Page
    ...
    Sub BindReport()
        ...
        Select Case strGroupBy
            Case "1"
                strRptPrefix = "PD_StdRpt_PENGIRIMAN_TBS_DET_DIVISI"
            Case "2"
                strRptPrefix = "PD_StdRpt_PENGIRIMAN_TBS_DET_TTANAM"
            Case "3"
                strRptPrefix = "PD_StdRpt_PENGIRIMAN_TBS_DET_BLOK"
            Case "4"
                strRptPrefix = "PD_StdRpt_PENGIRIMAN_TBS_DET_TRANSPORT"
        End Select

        'If strGroupBy = "1" Then
        '    strRptPrefix = "PD_StdRpt_PENGIRIMAN_TBS_DET"
        'Else
        '    strRptPrefix = "PD_StdRpt_PENGIRIMAN_TBS_DET_TRANSPORT"
        'End If

        Try
            strOpCd = "PD_PD_STDRPT_PENGIRIMAN_TBS_DET"
            strname = "LOCCODE|DIVISI|SD|ED|TD"
        ...
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=PD_PD_STDRPT_PENGIRIMAN_TBS_DET&errmesg=" & Exp.ToString() & "&redirect=")
        End Try
