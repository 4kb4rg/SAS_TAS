...
Public Class CB_StdRpt_DailyReceivePreview : Inherits Page
    ...
    Sub BindReport()
        ...
        Dim strOpCode As String = "CB_STDRPT_DAILYRECEIVE_GET"
        Dim strFileName As String = "CB_StdRpt_DailyReceive_Report"

        Dim strParam As String
        Dim searchStr As String
        Dim objFTPFolder As String

        strParamName = "TRXDATE|ACCCODE|LOCCODE"
        strParamValue = strDate & "|" & strAccCode & "|" & strLocation

        Try
            intErrNo = objGLRpt.mtdGetReport_BiayaProduksi(strOpCode, strParamName, strParamValue, objRptDs, objMapPath, objFTPFolder)

        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=CB_STDRPT_DAILYPAYMENT_RPT&errmesg=" & lblErrMessage.Text & "&redirect=")
        End Try
        ...
        'rdCrystalViewer.PrintOptions.PaperOrientation = PaperOrientation.Potrait
