...
Public Class CB_StdRpt_WithdrawalListing : Inherits Page
    ...
    Protected WithEvents txtWithdrawalCodeFrom As TextBox
    Protected WithEvents txtWithdrawalCodeTo As TextBox
    Protected WithEvents txtDescription As TextBox
    Protected WithEvents ddlBankCode As DropDownList
    Protected WithEvents ddlStatus As DropDownList
    
    Protected WithEvents PrintPrev As ImageButton
    Protected lblWithdrawal As Label    
    ...
    Sub BindBankCode(ByVal pv_strBankCode As String)
        ...
        Catch Exp As Exception
            Response.Redirect("../../../include/mesg/ErrorMessage.aspx?errcode=CB_RPT_WITHDRAWAL_GET_BANK&errmesg=" & lblErrMessage.Text & "&redirect=")
        End Try
    ...
    Sub BindStatus()
        ...
        ddlStatus.Items.Add(New ListItem(objCB1.mtdGetWithdrawalStatus(objCB1.EnumWithdrawalStatus.Active), objCB1.EnumWithdrawalStatus.Active))
        ddlStatus.Items.Add(New ListItem(objCB1.mtdGetWithdrawalStatus(objCB1.EnumWithdrawalStatus.Cancelled), objCB1.EnumWithdrawalStatus.Cancelled))
        ddlStatus.Items.Add(New ListItem(objCB1.mtdGetWithdrawalStatus(objCB1.EnumWithdrawalStatus.Confirmed), objCB1.EnumWithdrawalStatus.Confirmed))
        ddlStatus.Items.Add(New ListItem(objCB1.mtdGetWithdrawalStatus(objCB1.EnumWithdrawalStatus.Deleted), objCB1.EnumWithdrawalStatus.Deleted))
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        Response.Write("<Script Language=""JavaScript"">window.open(""CB_StdRpt_WithdrawalListingPreview.aspx?CompName=" & strCompany & "&Location=" & strUserLoc & "&RptID=" & strRptID & "&RptName=" & strRptName & "&Decimal=" & strDec & _
                    "&DDLAccMth=" & strddlAccMth & "&DDLAccYr=" & strddlAccYr & "&lblLocation=" & lblLocation.Text & _
                    "&txtStatus=" & Trim(ddlStatus.SelectedItem.Value) & _
                    "&txtBankCode=" & Trim(ddlBankCode.SelectedItem.Value) & _
                    "&txtDescription=" & txtDescription.Text & _
                    "&txtWithdrawalCodeFrom=" & Server.UrlEncode(Trim(txtWithdrawalCodeFrom.Text)) & _
                    "&txtWithdrawalCodeTo=" & Server.UrlEncode(Trim(txtWithdrawalCodeTo.Text)) & _
                    "&lblWithdrawal=" & Server.UrlEncode(lblWithdrawal.Text) & _
