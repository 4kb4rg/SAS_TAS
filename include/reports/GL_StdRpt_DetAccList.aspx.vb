...
Public Class GL_StdRpt_DetAccList : Inherits Page
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
       ...
       End If
        ...
        Next
        If intCnt <> 1 Then
            If trim(strAccType) <> "" then strAccType = Right(strAccType, Len(strAccType) - 3)
            If trim(strAccTypeText) <> "" then strAccTypeText = Right(strAccTypeText, Len(strAccTypeText) - 2)
        End If
        ...
        Response.Write("<Script Language=""JavaScript"">window.open(""GL_StdRpt_DetAccListPreview.aspx?Type=Print&CompName=" & strCompany & _
