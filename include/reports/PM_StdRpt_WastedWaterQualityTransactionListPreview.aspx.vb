...
Public Class PM_StdRpt_WastedWaterQualityTransactionListPreview : Inherits Page
    ...
    Sub BindReport()
        ...
        'Dim strOpCdPR_GET As String = "PM_CLSRPT_WASTED_WATER_QUALITY_GET"


        'If Not (Request.QueryString("DateFrom") = "" And Request.QueryString("DateTo") = "") Then
        '    SearchStr = SearchStr & " AND (DateDiff(Day, '" & Session("SS_DATEFROM") & "', PMWWQ.TransDate) >= 0) And (DateDiff(Day, '" & Session("SS_DATETO") & "', PMWWQ.TransDate) <= 0) "
        'End If
        ...
        'Try
        '    intErrNo = objPM.mtdGetWastedWaterQuality(strOpCdPR_GET, strParam, objRptDs, objMapPath)

        '    objRptDs.Tables(0).TableName = "PM_StdRpt_WastedWaterQualityTransactionListTitleBar"
        '    objRptDs.Tables(1).TableName = "PM_StdRpt_WastedWaterQualityTransactionListMain"
        '    objRptDs.Tables(2).TableName = "PM_StdRpt_WastedWaterQualityTransactionListDetail"
        'Catch Exp As System.Exception
        '    Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=GET_PM_WASTED_WATER_QUALITY_GET_LIST_REPORT&errmesg=" & lblErrMessage.Text & "&redirect=")
        'End Try


        'rdCrystalViewer.Load(objMapPath & "web\" & strLangCode & "\Reports\Crystal\PM_StdRpt_WastedWaterQualityTransactionList.rpt", OpenReportMethod.OpenReportByTempCopy)
        ...
        'crDiskFileDestinationOptions.DiskFileName = objMapPath & "web\ftp\PM_StdRpt_WastedWaterQualityTransactionList.pdf"
        ...
        'Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../ftp/PM_StdRpt_WastedWaterQualityTransactionList.pdf"">")
    End Sub
    ...
    Sub PassParam()
        ...
        ParamDiscreteValue13.Value = strLblLocation
