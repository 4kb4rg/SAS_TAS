...
Public Class FA_StdRpt_AssetWOList : Inherits Page
    ...
    'Protected WithEvents lblWOGLAssetAccCode As Label
    'Protected WithEvents lblWOGLAccumDeprAccCode As Label
    'Protected WithEvents lblWOGLWOAccCode As Label
    ...
    'Protected WithEvents txtWOGLAssetAccCode As TextBox
    'Protected WithEvents txtWOGLAccumDeprAccCode As TextBox
    'Protected WithEvents txtWOGLWOAccCode As TextBox
    ...
    Sub onload_GetLangCap()
        ...
        'lblWOGLAssetAccCode.Text = GetCaption(objLangCap.EnumLangCap.WOGLAssetAccCode)
        'lblWOGLAccumDeprAccCode.Text = GetCaption(objLangCap.EnumLangCap.WOGLAccumDeprAccCode)
        'lblWOGLWOAccCode.Text = GetCaption(objLangCap.EnumLangCap.WOGLWOAccCode)
        lblTxID.Text = GetCaption(objLangCap.EnumLangCap.AssetWO)
    ...
    Sub BindStatus()
        lstStatus.Items.Add(New ListItem(objFATrx.mtdGetAssetWOStatus(objFATrx.EnumAssetWOStatus.All), objFATrx.EnumAssetWOStatus.All))
        lstStatus.Items.Add(New ListItem(objFATrx.mtdGetAssetWOStatus(objFATrx.EnumAssetWOStatus.Active), objFATrx.EnumAssetWOStatus.Active))
        lstStatus.Items.Add(New ListItem(objFATrx.mtdGetAssetWOStatus(objFATrx.EnumAssetWOStatus.Confirmed), objFATrx.EnumAssetWOStatus.Confirmed))
        lstStatus.Items.Add(New ListItem(objFATrx.mtdGetAssetWOStatus(objFATrx.EnumAssetWOStatus.Deleted), objFATrx.EnumAssetWOStatus.Deleted))
        lstStatus.Items.Add(New ListItem(objFATrx.mtdGetAssetWOStatus(objFATrx.EnumAssetWOStatus.Closed), objFATrx.EnumAssetWOStatus.Closed))
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        Dim strWOGLAssetAccCode As String
        Dim strWOGLAccumDeprAccCode As String
        Dim strWOGLWOAccCode As String
        ...
        'If txtWOGLAssetAccCode.Text = "" Then
        '    strWOGLAssetAccCode = ""
        'Else
        '    strWOGLAssetAccCode = Trim(txtWOGLAssetAccCode.Text)
        'End If

        'If txtWOGLAccumDeprAccCode.Text = "" Then
        '    strWOGLAccumDeprAccCode = ""
        'Else
        '    strWOGLAccumDeprAccCode = Trim(txtWOGLAccumDeprAccCode.Text)
        'End If

        'If txtWOGLWOAccCode.Text = "" Then
        '    strWOGLWOAccCode = ""
        'Else
        '    strWOGLWOAccCode = Trim(txtWOGLWOAccCode.Text)
        'End If
        ...
        strWOGLAssetAccCode = "" 'Server.UrlEncode(strWOGLAssetAccCode)
        strWOGLAccumDeprAccCode = "" 'Server.UrlEncode(strWOGLAccumDeprAccCode)
        strWOGLWOAccCode = "" 'Server.UrlEncode(strWOGLWOAccCode)
        ...
        If Not (strTxDateFrom = "" And strTxDateTo = "") Then
            If objGlobal.mtdValidInputDate(strDateSetting, strTxDateFrom, objDateFormat, objDateFrom) = True And objGlobal.mtdValidInputDate(strDateSetting, strTxDateTo, objDateFormat, objDateTo) = True Then
                Response.Write("<Script Language=""JavaScript"">window.open(""FA_StdRpt_AssetWOListPreview.aspx?Type=Print&CompName=" & strCompany & "&Location=" & strUserLoc & "&RptID=" & strRptID & _
                               ...
                               "&lblLocation=" & lblLocation.Text & "&lblAssetCode=" & lblAssetCode.Text & "&lblAssetHeaderCode=" & lblAssetHeaderCode.Text & "&lblWOGLAssetAccCode=" & "" & _
                               "&lblWOGLAccumDeprAccCode=" & "" & "&lblWOGLWOAccCode=" & "" & "&lblTxID=" & lblTxID.Text & "&TxIDFrom=" & strTxIDFrom & "&TxIDTo=" & strTxIDTo & _
                                "&ExportToExcel=" & strExportToExcel & _
                                "&DeprType=" & strDeprType & _
                                "&Status=" & strStatus & "&AssetCode=" & strAssetCode & "&AssetHeaderCode=" & strAssetHeaderCode & "&WOGLAssetAccCode=" & strWOGLAssetAccCode & "&WOGLAccumDeprAccCode=" & strWOGLAccumDeprAccCode & _
                               "&WOGLWOAccCode=" & strWOGLWOAccCode & "&RefNo=" & strRefNo & """,null ,""status=yes, resizable=yes, scrollbars=yes, toolbar=no, location=no"");</Script>")
            Else
