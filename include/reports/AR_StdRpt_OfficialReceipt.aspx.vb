...
Public Class AR_StdRpt_OfficialReceipt : Inherits Page
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        Response.Write("<Script Language=""JavaScript"">window.open(""AR_StdRpt_OfficialReceiptPreview.aspx?Type=Print&CompName=" & strCompany & _
