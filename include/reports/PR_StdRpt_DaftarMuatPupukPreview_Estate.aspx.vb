...
Public Class PR_StdRpt_DaftarMuatPupukPreview_Estate : Inherits Page
 ...
 Dim objFTPFolder As String
    ...
    Sub BindReport()
        ...
        Dim strOpCd As String = "PR_PR_STDRPT_DAFTAR_MUATPUPUK_REPORT"
        ...
        crDiskFileDestinationOptions.DiskFileName = objMapPath & "web\ftp\PR_StdRpt_DaftarMuatPupuk_Estate.pdf"
        ...
        Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../ftp/PR_StdRpt_DaftarMuatPupuk_Estate.pdf"">")
    End Sub
