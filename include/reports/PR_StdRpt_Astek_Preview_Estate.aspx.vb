...
Public Class PR_StdRpt_Astek_Preview_Estate : Inherits Page
    ...
    Sub BindReport()
        ...
        Dim strOpCd As String = "PR_PR_STDRPT_ASTEK_REPORT"
        ...
        Select Case strMandor 
			Case 1 
				strRptPrefix = "PR_StdRpt_Astek_Estate"
			Case 2 
				strRptPrefix = "PR_StdRpt_BPJS_Estate"
		End Select
            
        strParamName = "ACCMONTH|ACCYEAR|COMPCODE|LOCCODE|F_DIVCODE"
        ...
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=PR_PR_STDRPT_ASTEK_REPORT&errmesg=" & lblErrMessage.Text & "&redirect=")
        End Try
