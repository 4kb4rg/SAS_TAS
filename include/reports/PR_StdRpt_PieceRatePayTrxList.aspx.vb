...
Public Class PR_StdRpt_PieceRatePayTrxList : Inherits Page
    ...
    Sub GetEntireLangCap()
        ...
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=PR_STDRPT_PIECERATEPAY_LANGCAP_GET&errmesg=" & Exp.ToString() & "&redirect=../en/reports/PR_StdRpt_Selection.aspx")
        End Try
    End Sub
    ...
    Sub BindTrxStatus()
        ...
        lstTrxStatus.Items.Add(New ListItem(objPRTrx.mtdGetPieceRateStatus(objPRTrx.EnumPieceRateStatus.Active), objPRTrx.EnumPieceRateStatus.Active))
        lstTrxStatus.Items.Add(New ListItem(objPRTrx.mtdGetPieceRateStatus(objPRTrx.EnumPieceRateStatus.Closed), objPRTrx.EnumPieceRateStatus.Closed))
        lstTrxStatus.Items.Add(New ListItem(objPRTrx.mtdGetPieceRateStatus(objPRTrx.EnumPieceRateStatus.Cancelled), objPRTrx.EnumPieceRateStatus.Cancelled))

    End Sub

    Sub BindSortByList()
        lstSortBy.Items.Add(New ListItem("Employee Code", "code"))
        lstSortBy.Items.Add(New ListItem("Description / Piece Rate No. ", "other"))
    End Sub
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        strSrchGroupRef = Server.UrlEncode(Trim(txtGroupRef.Text))
        strSrchRefDate = Server.UrlEncode(Trim(strSrchRefDate))
        ...
        Response.Write("<Script Language=""JavaScript"">window.open(""PR_StdRpt_PieceRatePayTrxListPreview.aspx?Type=Print&CompName=" & strCompany & _
                       ...
                       "&strSrchGroupRef=" & strSrchGroupRef & "&strSrchRefDate=" & strSrchRefDate & _
