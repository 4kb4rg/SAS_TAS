...
Public Class CT_StdRpt_StkReceiveList : Inherits Page
    ...
    Sub BindStkRcvType()
        ...
        lstStkRcvType.Items.Add(New ListItem(objCTTrx.mtdGetCanteenReceiveDocType(objCTTrx.EnumCanteenReceiveDocType.DispatchAdvice), objCTTrx.EnumCanteenReceiveDocType.DispatchAdvice))
        lstStkRcvType.Items.Add(New ListItem(objCTTrx.mtdGetCanteenReceiveDocType(objCTTrx.EnumCanteenReceiveDocType.StockReturnAdvice), objCTTrx.EnumCanteenReceiveDocType.StockReturnAdvice))
        lstStkRcvType.Items.Add(New ListItem(objCTTrx.mtdGetCanteenReceiveDocType(objCTTrx.EnumCanteenReceiveDocType.StockTransfer), objCTTrx.EnumCanteenReceiveDocType.StockTransfer))
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        Try
            intErrNo = objSysCfg.mtdGetConfigInfo(strParam, _
                                                  ...
                                                  objSysCfgDs)
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=CT_STDRPT_STKRECEIVE_GET_CONFIG_DATE&errmesg=" & lblErrMessage.Text & "&redirect=../../en/reports/CT_StdRpt_Selection.aspx")
        End Try
        ...
        If Not (strDateFrom = "" And strDateTo = "") Then
            If objGlobal.mtdValidInputDate(strDateSetting, strDateFrom, objDateFormat, objDateFrom) = True And objGlobal.mtdValidInputDate(strDateSetting, strDateTo, objDateFormat, objDateTo) = True Then
                Response.Write("<Script Language=""JavaScript"">window.open(""CT_StdRpt_StkReceiveListPreview.aspx?Type=Print&CompName=" & strCompany & "&Location=" & strUserLoc & "&RptID=" & strRptID & _
                               ...
                               "&lblProdMatCode=" & lblProdMatCode.Text & "&lblStkAnaCode=" & lblStkAnaCode.Text & "&lblLocation=" & lblLocation.Text & "&StkRcvIDFrom=" & strStkRcvIDFrom & _
                               "&StkRcvIDTo=" & strStkRcvIDTo & "&StkRefNo=" & strStkRefNo & "&PRIDFrom=" & strPRIDFrom & "&PRIDTo=" & strPRIDTo & "&StkRcvType=" & strStkRcvType & "&ProdType=" & strProdType & _
                               "&ProdBrand=" & strProdBrand & "&ProdModel=" & strProdModel & "&ProdCat=" & strProdCat & "&ProdMat=" & strProdMat & "&StkAna=" & strStkAna & "&ItemCode=" & strItemCode & _
