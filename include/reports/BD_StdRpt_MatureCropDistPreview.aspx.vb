...
Public Class BD_StdRpt_MatureCropDistPreview : Inherits Page
    ...
    Sub CountAccPeriod()
        Dim strOppCd_MatureCropDist_AccPeriod_GET As String = "BD_STDRPT_MATURECROPDIST_ACCPERIOD_GET"
        Dim strParam As String

        strParam = "|" & strLocation & "|" & Request.QueryString("DDLPeriodID").Trim & "||||"
        Try
            intErrNo = objBDTrx.mtdGetMatureCropDist(strOppCd_MatureCropDist_AccPeriod_GET, strParam, dsAccPeriod)
        Catch Exp As System.Exception
            Response.Redirect("../../../include/mesg/ErrorMessage.aspx?errcode=BD_STDRPT_MATURECROPDIST_YEAR_GET&errmesg=" & lblErrMessage.Text & "&redirect=")
        End Try
    ...
    Sub BindReport()
        ...
        Dim strOpCd_MatureCropDist_Format_GET As String = "BD_STDRPT_MATURECROPDIST_FORMAT_GET"

        If objSysCfg.mtdHasConfigValue(objSysCfg.mtdGetConfigSetting(objSysCfg.EnumConfig.BlockCostLevel), intConfigsetting) = True Then
            If Not Request.QueryString("BlkCode") = "" Then
                SearchStr = " AND MCD.BlkCode LIKE '" & Request.QueryString("BlkCode") & "' "
            Else
                SearchStr = " AND MCD.BlkCode LIKE '%' "
            End If
        Else
            If Not Request.QueryString("SubBlkCode") = "" Then
                SearchStr = " AND MCD.BlkCode LIKE '" & Request.QueryString("SubBlkCode") & "' "
            Else
                SearchStr = " AND MCD.BlkCode LIKE '%' "
            End If
        End If
        ...
        Try
            intErrNo = objBD.mtdGetReport_MatureCropDist(strOpCd_MatureCropDist_Format_GET, strParam, objRptDs, objMapPath)
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=BD_MATURECROPDIST_GET&errmesg=" & lblErrMessage.Text & "&redirect=")
        End Try

        objRptDs.Tables(0).TableName = "BD_MATURECROPDIST_FORMAT"
        objRptDs.Tables.Add(dsAccPeriod.Tables(0).Copy())
        objRptDs.Tables(1).TableName = "BD_MATURECROPDIST_PERIOD"


        rdCrystalViewer.Load(objMapPath & "web\" & strLangCode & "\Reports\Crystal\BD_StdRpt_MatureCropDist.rpt", OpenReportMethod.OpenReportByTempCopy)
        ...
        crDiskFileDestinationOptions.DiskFileName = objMapPath & "web\ftp\BD_StdRpt_MatureCropDist.pdf"
        ...
        Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../ftp/BD_StdRpt_MatureCropDist.pdf"">")
    End Sub
    ...
    Sub GetEntireLangCap()
        ...
        Try
            intErrNo = objLangCap.mtdGetBussTerm(strOpCode_BussTerm, _
                                                 ...
                                                 strParam)
        Catch Exp As System.Exception
            Response.Redirect("../../../include/mesg/ErrorMessage.aspx?errcode=BD_STDRPT_MATURECROPDIST_LANGCAP_GET&errmesg=" & lblErrMessage.Text & "&redirect=")
        End Try
