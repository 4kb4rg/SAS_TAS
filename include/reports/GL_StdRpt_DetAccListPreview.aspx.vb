...
Public Class GL_StdRpt_DetAccListPreview : Inherits Page
    ...
    Sub BindReport()
        ...
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=GL_STDRPT_TRIALBAL_DETAIL_GET_WITH_TRANS&errmesg=" & Exp.Message.ToString() & "&redirect=")
        End Try
	    ...
	    If myTable.Name = "GL_ESTEXP" Then
                myLogin = myTable.LogOnInfo
