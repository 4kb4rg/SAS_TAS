...
Public Class WS_StdRpt_StkMoveDetList : Inherits Page
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        Response.Write("<Script Language=""JavaScript"">window.open(""WS_StdRpt_StkMoveDetListPreview.aspx?Type=Print&CompName=" & strCompany & _
