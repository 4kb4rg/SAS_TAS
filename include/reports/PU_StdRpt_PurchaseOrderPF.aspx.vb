...
Public Class PU_StdRpt_PurchaseOrderPF : Inherits Page
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        If txtJabatan1.Text <> "" Then
            strJabatan1 = txtJabatan1.Text
        Else
            strJabatan1 = ""
        End If
        ...
        Response.Write("<Script Language=""JavaScript"">window.open(""PU_StdRpt_PurchaseOrderPFPreview.aspx?Type=Print&CompName=" & strCompany & _
