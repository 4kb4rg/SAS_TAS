...
Public Class NU_StdRpt_SeedDispatchRpt : Inherits Page
    ...
    Protected WithEvents lblPlantMaterial As Label
    ...
    Sub onload_GetLangCap()
        ...
        lblPlantMaterial.Text = GetCaption(objLangCap.EnumLangCap.PlantMaterial)
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        strStatus = Trim(objNUTrx.EnumSeedDispatchStatus.Deleted)
        ...
        If Not (strTxDateFrom = "" And strTxDateTo = "") Then
            If objGlobal.mtdValidInputDate(strDateSetting, strTxDateFrom, objDateFormat, objDateFrom) = True And objGlobal.mtdValidInputDate(strDateSetting, strTxDateTo, objDateFormat, objDateTo) = True Then
                Response.Write("<Script Language=""JavaScript"">window.open(""NU_StdRpt_SeedDispatchRptPreview.aspx?Type=Print&CompName=" & strCompany & "&Location=" & strUserLoc & "&RptID=" & strRptID & _
                               ...
                               "&lblLocation=" & lblLocation.Text & "&lblBlkCode=" & lblBlkCode.Text & "&lblBatchNo=" & lblBatchNo.Text & "&lblBillPartyCode=" & lblBillPartyCode.Text & "&lblPlantMaterial=" & lblPlantMaterial.Text & _
