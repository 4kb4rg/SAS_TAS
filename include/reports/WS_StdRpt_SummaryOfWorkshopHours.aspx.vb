...
Public Class WS_StdRpt_SummaryOfWorkshopHours : Inherits Page
    Protected RptSelect As UserControl
    
    Protected WithEvents lblLocation As Label
    Protected WithEvents lblServiceType As Label
    ...
    Sub GetLangCap()
        ...
        lblServiceType.Text = GetCaption(objLangCap.EnumLangCap.ServType)
    ...
    Function GetLanguageCaptionDS() As DataSet
        ...
        Catch ex As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=WS_STDRPT_SUMMARY_OF_WORKSHOP_HOURS_GET_LANGCAP&errmesg=" & Server.UrlEncode(ex.Message) & "&redirect=WS/trx/WS_Trx_Job_List.aspx")
        End Try
    ...
    Sub ibPrintPreview_OnClick(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        Response.Write("<Script Language=""JavaScript"">window.open(""WS_StdRpt_SummaryOfWorkshopHoursPreview.aspx?CompName=" & strCompany & "&RptID=" & strRptID & "&RptName=" & strRptName & "&RptLocation=" & strRptLocation & "&RptAccMonth=" & strRptAccMonth & "&RptAccYear=" & strRptAccYear & "&Decimal=" & strDecimal & _
                        "&lblLocation=" & lblLocation.Text & "&lblServiceType=" & lblServiceType.Text & "&lblWork=" & lblWork.Text & "&lblVehicle=" & lblVehicle.Text & "&lblBillParty=" & lblBillParty.Text & _
