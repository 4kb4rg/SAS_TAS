...
Public Class BD_StdRpt_UnMatureCropSummary : Inherits Page
    ...
    Sub onload_GetLangCap()
        ...
        lblTitle.Text = "BUDGETING - IMMATURE CROP ACTIVITY SUMMARY"
    ...
    Sub GetEntireLangCap()
        ...
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=BD_STDRPT_IMMATURECROP_BUSSTERM_GET&errmesg=" & lblErrMessage.Text & "&redirect=../en/reports/BD_StdRpt_Selection.aspx")
        End Try
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        Response.Write("<Script Language=""JavaScript"">window.open(""BD_StdRpt_UnMatureCropSummaryPreview.aspx?DDLPeriodID=" & strddlPeriodID & "&DDLPeriodName=" & strddlPeriodName & _
