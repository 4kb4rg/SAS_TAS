...
Public Class PR_StdRpt_PensiunPreview : Inherits Page
    ...
    Sub BindReport()
        ...
        Dim strOpCdPensiunListGet As String = "PR_STDRPT_DANAPENSIUN_LIST"
        ...
        Dim strTransferInd As String = Trim(Request.QueryString("TransferInd"))

        SearchStr = ""

        
        If strUserLoc <> "" Then
             SearchStr = SearchStr & " AND CP.LOCCODE in ('" & strUserLoc & "')"
        End If
        strParam = SearchStr & "|" & ReportID  & "|" & strAccMonthFrom  & "|" & strAccMonthTo  & "|" & strAccYearFrom  & "|" & strAccYearTo                                     

        Try
            intErrNo = objPRRpt.mtdGetReport_PensiunList(strOpCdPensiunListGet, _
                                                           strCompany, _
                                                           strLocation, _
                                                           strUserId, _
                                                           strAccMonth, _
        ...
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=PR_STDRPT_Pensiun_LIST_REPORT&errmesg=" & lblErrMessage.Text & "&redirect=")
        End Try

        rdCrystalViewer.Load(objMapPath & "web\" & strLangCode & "\Reports\Crystal\PR_StdRpt_PensiunListing.rpt", OpenReportMethod.OpenReportByTempCopy)
        ...
        If strTransferInd = "1" Then            
            crDiskFileDestinationOptions.DiskFileName = objMapPath & "web\ftp\" & Trim(Request.QueryString("RptName")) & ".xls"
        Else
            crDiskFileDestinationOptions.DiskFileName = objMapPath & "web\ftp\PR_StdRpt_PensiunListing.pdf"
        End If
        ...
        If strTransferInd = "1" Then
            Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../ftp/" & Trim(Request.QueryString("RptName")) & ".xls"">")
        Else
            Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../ftp/PR_StdRpt_PensiunListing.pdf"">")
        End If
    End Sub
