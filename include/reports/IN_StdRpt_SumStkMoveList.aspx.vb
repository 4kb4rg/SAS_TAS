...
Public Class IN_StdRpt_SumStkMoveList : Inherits Page
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        Response.Write("<Script Language=""JavaScript"">window.open(""IN_StdRpt_SumStkMoveListPreview.aspx?Type=Print&CompName=" & strCompany & _
