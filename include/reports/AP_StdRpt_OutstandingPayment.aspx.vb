...
Public Class AP_StdRpt_OutstandingPayment : Inherits Page
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        Response.Write("<Script Language=""JavaScript"">window.open(""AP_StdRpt_OutstandingPaymentPreview.aspx?CompName=" & strCompany & "&Location=" & strUserLoc & "&RptID=" & strRptID & "&RptName=" & strRptName & "&Decimal=" & strDec & _
                    "&DDLAccMth=" & strddlAccMth & "&DDLAccYr=" & strddlAccYr & "&lblLocation=" & lblLocation.Text & "&txtSuppCode=" & Server.UrlEncode(Trim(txtSuppCode.Text)) & _
                    "&ddlSortBy=" & Trim(ddlSortBy.SelectedItem.Value) & """,null ,""status=yes, resizable=yes, scrollbars=yes, toolbar=no, location=no"");</Script>")
        objSysCfgDs = Nothing
    End Sub
