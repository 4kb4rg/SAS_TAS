...
Public Class PM_StdRpt_OilLossTransactionListPreview : Inherits Page
    ...
    Sub Page_Load(ByVal Sender As Object, ByVal E As EventArgs)
        ...
        strTestSampleCode = Request.QueryString("TestSampleCode") 
        strMachine = Request.QueryString("Machine")
        strMachineTo = Request.QueryString("MachineTo")
    ...
    Sub BindReport()
       ...
       Dim objRptDs As New DataSet()
        ...
        Dim strOpCdPR_GET As String = "PM_CLSRPT_DAILY_OIL_LOSS_GET"
        Dim colParam As New Collection

        SearchStr = " AND OL.LocCode IN('" & strUserLoc & "') "

        If Not (Request.QueryString("DateFrom") = "" And Request.QueryString("DateTo") = "") Then
            SearchStr = SearchStr & " AND (DateDiff(Day, '" & Session("SS_DATEFROM") & "', OL.TransDate) >= 0) And (DateDiff(Day, '" & Session("SS_DATETO") & "', OL.TransDate) <= 0) "
        End If

        If Not (strTestSampleCode = "All") Then
            SearchStr = SearchStr & " AND OL.TestSampleCode='" & strTestSampleCode & "' "
        End If

        SearchStr = SearchStr & " AND OL.MachineCode Between '" & strMachine & "' And '" & strMachineTo & "'"


        colParam.Add(strAccMonth, "PARAM_ACCMONTH")
        colParam.Add(strAccYear, "PARAM_ACCYEAR")
        colParam.Add(SearchStr, "PARAM_SEARCHSTR")
        colParam.Add("PM_STDRPT_DAILYOILLOSS_GET_SP", "OC_REPORT_GET")

        Try
            intErrNo = objPM.mtdGetReport_DailyOilLoss(colParam, objRptDs, objMapPath)
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=GET_PM_OilLossTransaction_GET_LIST_REPORT&errmesg=" & lblErrMessage.Text & "&redirect=")
        End Try


        rdCrystalViewer.Load(objMapPath & "web\" & strLangCode & "\Reports\Crystal\PM_StdRpt_OilLossTransactionList.rpt", OpenReportMethod.OpenReportByTempCopy)
        ...
        crDiskFileDestinationOptions.DiskFileName = objMapPath & "web\ftp\PM_StdRpt_OilLossTransactionList.pdf"
 	...
 	rdCrystalViewer.Close()
        ...
        Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../ftp/PM_StdRpt_OilLossTransactionList.pdf"">")
    End Sub
    ...
    Sub PassParam()
        ...
        paramField9 = paramFields.Item("ParamUpdatedBy")
        ...
        paramField13 = paramFields.Item("ParamTestSampleCode")
        paramField14 = paramFields.Item("ParamMachine")
        ...
        ParamDiscreteValue9.Value = "" 'Session("SS_UPDATEDBY")
        ParamDiscreteValue10.Value = Session("SS_RPTID")
        ParamDiscreteValue11.Value = strAccMonth
        ParamDiscreteValue12.Value = strAccYear
        ParamDiscreteValue13.Value = strTestSampleCode
        ParamDiscreteValue14.Value = strMachine
