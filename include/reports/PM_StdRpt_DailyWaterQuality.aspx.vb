...
Public Class PM_StdRpt_DailyWaterQuality : Inherits Page
...
Dim objAdminLoc As New agri.Admin.clsLoc()
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        Response.Write("<Script Language=""JavaScript"">window.open(""PM_StdRpt_DailyWaterQualityPreview.aspx?Type=Print&CompName=" & strCompany & "&Location=" & strUserLoc & "&RptID=" & strRptID & "&RptName=" & strRptName & _
