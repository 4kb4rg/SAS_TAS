...
Public Class PU_StdRpt_RPHList : Inherits Page
    ...
    Protected WithEvents lstRPHType As DropDownList
    ...
    Sub BindRPHType()
        ...
        lstRPHType.Items.Add(New ListItem(objPUTrx.mtdGetRPHType(objPUTrx.EnumRPHType.All), objPUTrx.EnumRPHType.All))
        lstRPHType.Items.Add(New ListItem(objPUTrx.mtdGetRPHType(objPUTrx.EnumRPHType.Canteen), objPUTrx.EnumRPHType.Canteen))
        lstRPHType.Items.Add(New ListItem(objPUTrx.mtdGetRPHType(objPUTrx.EnumRPHType.DirectCharge), objPUTrx.EnumRPHType.DirectCharge))
        lstRPHType.Items.Add(New ListItem(objPUTrx.mtdGetRPHType(objPUTrx.EnumRPHType.FixedAsset), objPUTrx.EnumRPHType.FixedAsset))
        lstRPHType.Items.Add(New ListItem("Stock / Workshop", objPUTrx.EnumRPHType.Stock))
    ...
    Sub BindStatus()
        ...
        lstStatus.Items.Add(New ListItem("Approved", objPUTrx.EnumPOStatus.Confirmed))
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        strRPHType = Trim(lstRPHType.SelectedItem.Value)
        ...
        If Not (strDocDateFrom = "" And strDocDateTo = "") Then
            If objGlobal.mtdValidInputDate(strDateSetting, strDocDateFrom, objDateFormat, objDocDateFrom) = True And objGlobal.mtdValidInputDate(strDateSetting, strDocDateTo, objDateFormat, objDocDateTo) = True Then
                Response.Write("<Script Language=""JavaScript"">window.open(""PU_StdRpt_RPHListPreview.aspx?CompName=" & strCompany & "&Location=" & strUserLoc & "&RptID=" & strRptID & "&RptName=" & strRptName & "&Decimal=" & strDec & _
                               ...
                               "&ProdModel=" & strProdModel & "&ProdCat=" & strProdCat & "&ProdMat=" & strProdMat & "&StkAna=" & strStkAna & "&ItemCode=" & strItemCode & "&RPHType=" & strRPHType & "&Status=" & strStatus & _
