...
Public Class PU_StdRpt_POList_Preview : Inherits Page
    ...
    Sub Page_Load(ByVal Sender As Object, ByVal E As EventArgs)
        ...
        strPRRefLoc = Request.QueryString("strPRRefLoc")
    ...
    Sub BindReport()
        ...
        Dim strOpCdPO_GET As String = "PU_STDRPT_PO_AND_POLN_GET"
        ...
        If Not Request.QueryString("strPRRefLoc") = "" Then
            SearchStr = SearchStr & "RTRIM(POLN.PRRefLocCode) = '" & Trim(Request.QueryString("strPRRefLoc")) & "' AND "
        End If
        ...
        strView = Request.QueryString("strView")
        If strView = "1" Then
            strRptPrefix = "PU_StdRpt_PORealizationList"
        Else
            strRptPrefix = "PU_StdRpt_POList"
        End If
