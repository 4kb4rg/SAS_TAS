...
Public Class GL_StdRpt_RincianBiayaPanenPerThnTanam : Inherits Page
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
       ...
       End If
        ...
        Response.Write("<Script Language=""JavaScript"">window.open(""GL_StdRpt_RincianBiayaPanenPerThnTanamPreview.aspx?Type=Print&CompName=" & strCompany & _
