...
Public Class HR_StdRpt_Profile_KaryPreview_Estate : Inherits Page
    ...
    Sub Page_Load(ByVal Sender As Object, ByVal E As EventArgs)
        ...
        strEmptype = Request.QueryString("Emptypecode")
    ...
    Sub BindReport()
        ...
        strOpCd = "HR_HR_STDRPT_EMP_PROFILE_GET"
        fname = "HR_StdRpt_Emp_Profile_Estate"
        strParamName = "LOC|ET|DV"
        ...
        Try
            ...
            objRpt.Tables(0).TableName = "HR_HR_STDRPT_EMP_PROFILE_DET"
        ...
        objRptDs.Tables(0).TableName = "HR_HR_STDRPT_EMP_PROFILE_DET"
