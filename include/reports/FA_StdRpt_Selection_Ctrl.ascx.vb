...
Public Class FA_StdRpt_Selection_Ctrl : Inherits UserControl
    ...
    Function BindAccYearList(ByVal pv_strLocation As String, _
        ...
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=FA_STDRPT_CTRL_ACCCFG_DIST_GET&errmesg=" & Exp.ToString() & "&redirect=")
        End Try
        ...
        If objAccCfg.Tables(0).Rows.Count > 0 Then      '--found year's record
            ...
            Try
                ...
                intErrNo = objAdmAcc.mtdGetAccPeriodCfg(strOpCd_Max_Get, _
                                                        ...
                                                        objAccCfg)
            Catch Exp As System.Exception
                Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=FA_STDRPT_CTRL_ACCCFG_MAX_GET&errmesg=" & Exp.ToString() & "&redirect=")
            End Try
            ...
            Catch Exp As System.Exception
                Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=FA_STDRPT_CTLR_ACCCFG_MAXPERIOD&errmesg=System required period configuration to process your request. Please set period configuration for the year of " & Convert.ToString(intAccYear) & "&redirect=")
            End Try
    ...
    Sub GetUserLoc()
        ...
        Dim strOppCd_UserLoc_GET As String = "FA_STDRPT_USERLOCATION_GET"
        ...
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=GET_FA_SELECTIONCTRL_USERLOCATION&errmesg=" & Exp.ToString() & "&redirect=../en/reports/FA_StdRpt_Selection.aspx")
        End Try
    ...
    Sub BindReportNameList()
        ...
        Dim objMapPath As String
        Dim dsForDropDown As New DataSet()
        Dim strOppCd_StdRptName_GET As String = "FA_STDRPT_NAME_GET"

        strParam = " WHERE ReportType = '" & Convert.ToString(objGlobal.EnumStdRptType.FixAsset) & "' AND Status = '" & Convert.ToString(objGlobal.EnumStdRptStatus.Active) & "' ORDER BY RptName"
        Try
            intErrNo = objAdmin.mtdGetStdRptName(strOppCd_StdRptName_GET, strParam, dsForDropDown, objMapPath)
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=GET_FA_SELECTIONCTRL_REPORT_NAME_LIST&errmesg=" & Exp.ToString() & "&redirect=../en/reports/FA_StdRpt_Selection.aspx")
        End Try
    ...
    Sub CheckRptName(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If strSelectedIndex = "rptfa1000001" Then
            Response.Redirect("../../" & strLangCode & "/reports/FA_StdRpt_AssetClassList.aspx?SelIndex=" & Convert.ToString(intSelectedIndex) & "&UserLoc=" & strUserLoc)
        ElseIf strSelectedIndex = "rptfa1000002" Then
            Response.Redirect("../../" & strLangCode & "/reports/FA_StdRpt_AssetGrpList.aspx?SelIndex=" & Convert.ToString(intSelectedIndex) & "&UserLoc=" & strUserLoc)
        ElseIf strSelectedIndex = "rptfa1000003" Then
            Response.Redirect("../../" & strLangCode & "/reports/FA_StdRpt_AssetRegList.aspx?SelIndex=" & Convert.ToString(intSelectedIndex) & "&UserLoc=" & strUserLoc)
        ElseIf strSelectedIndex = "rptfa1000004" Then
            Response.Redirect("../../" & strLangCode & "/reports/FA_StdRpt_AssetReglnList.aspx?SelIndex=" & Convert.ToString(intSelectedIndex) & "&UserLoc=" & strUserLoc)
        ElseIf strSelectedIndex = "rptfa1000005" Then
            Response.Redirect("../../" & strLangCode & "/reports/FA_StdRpt_AssetPermitList.aspx?SelIndex=" & Convert.ToString(intSelectedIndex) & "&UserLoc=" & strUserLoc)
        ElseIf strSelectedIndex = "rptfa1000006" Then
            Response.Redirect("../../" & strLangCode & "/reports/FA_StdRpt_AssetAddList.aspx?SelIndex=" & Convert.ToString(intSelectedIndex) & "&UserLoc=" & strUserLoc)
        ElseIf strSelectedIndex = "rptfa1000007" Then
            Response.Redirect("../../" & strLangCode & "/reports/FA_StdRpt_AssetDeprList.aspx?SelIndex=" & Convert.ToString(intSelectedIndex) & "&UserLoc=" & strUserLoc)
        ElseIf strSelectedIndex = "rptfa1000008" Then
            Response.Redirect("../../" & strLangCode & "/reports/FA_StdRpt_AssetDispList.aspx?SelIndex=" & Convert.ToString(intSelectedIndex) & "&UserLoc=" & strUserLoc)
        ElseIf strSelectedIndex = "rptfa1000009" Then
            Response.Redirect("../../" & strLangCode & "/reports/FA_StdRpt_AssetWOList.aspx?SelIndex=" & Convert.ToString(intSelectedIndex) & "&UserLoc=" & strUserLoc)
        ElseIf strSelectedIndex = "rptfa1000010" Then
            Response.Redirect("../../" & strLangCode & "/reports/FA_StdRpt_AssetRegSum.aspx?SelIndex=" & Convert.ToString(intSelectedIndex) & "&UserLoc=" & strUserLoc)
        ElseIf strSelectedIndex = "rptfa1000011" Then
            Response.Redirect("../../" & strLangCode & "/reports/FA_StdRpt_AssetRegDet.aspx?SelIndex=" & Convert.ToString(intSelectedIndex) & "&UserLoc=" & strUserLoc)
        ElseIf strSelectedIndex = "rptfa1000012" Then
            Response.Redirect("../../" & strLangCode & "/reports/FA_StdRpt_AssetAct.aspx?SelIndex=" & Convert.ToString(intSelectedIndex) & "&UserLoc=" & strUserLoc)
        End If
