...
Public Class PR_StdRpt_SOCSOBorang8A : Inherits Page
    ...
    Protected WithEvents txtExpiryDate As TextBox
    ...
    Sub BindEmpCodeList(ByVal pv_strSelectedEmpCode As Object)
        ...
        dr("EmpCode") = ""
        dr("EmpName") = "Please Select Employee Code"
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        If txtExpiryDate.Text = "" Then
            strExpiryDate = ""
        Else
            strExpiryDate = Trim(txtExpiryDate.Text)
        End If
        ...
        Try
            intErrNo = objSysCfg.mtdGetConfigInfo(strParam, _
                                                  ...
                                                  objSysCfgDs)
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=PR_STDRPT_SOCSOBORANG8A_GET_CONFIG_DATE&errmesg=" & lblErrMessage.Text & "&redirect=reports/PR_StdRpt_Selection.aspx")
        End Try

        strDateSetting = objSysCfg.mtdGetDateFormat(Trim(objSysCfgDs.Tables(0).Rows(0).Item("Datefmt")))

        If Not (strExpiryDate = "") Then
            If objGlobal.mtdValidInputDate(strDateSetting, strExpiryDate, objDateFormat, objExpiryDate) = False Then
                lblDate.Text = lblDate.Text & objDateFormat & "."
                lblDate.Visible = True
            Else
                Response.Write("<Script Language=""JavaScript"">window.open(""PR_StdRpt_SOCSOBorang8APreview.aspx?Type=Print&CompName=" & strCompany & _
                               "&Location=" & strUserLoc & "&ddlAccMth=" & strDdlAccMth & "&ddlAccYr=" & strDdlAccYr & _
                               "&Decimal=" & strDec & "&ChequeNo=" & strChequeNo & "&ExpiryDate=" & strExpiryDate & _
                               "&EmpCode=" & strEmpCode & "&SignName=" & strSignName & _
