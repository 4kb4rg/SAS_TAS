...
Public Class AP_StdRpt_SuppCreditNoteListing_Preview : Inherits Page
    ...
    Sub Page_Load(ByVal Sender As Object, ByVal E As EventArgs)
        ...
        strFileName = "AP_StdRpt_SuppCreditNoteListing"
        ...
        Session("SS_CreditNoteIDFrom") = Request.QueryString("txtCreditNoteIDFrom")
        Session("SS_CreditNoteIDTo") = Request.QueryString("txtCreditNoteIDTo")
        ...
        Session("SS_BlkType") = Request.QueryString("lstBlkType")
        ...
        Session("SS_SuppCreditNoteRefNo") = Request.QueryString("txtSuppCreditNoteRefNo")
        Session("SS_SuppCreditNoteRefDateFrom") = Request.QueryString("txtSuppCreditNoteRefDateFrom")
        Session("SS_SuppCreditNoteRefDateTo") = Request.QueryString("txtSuppCreditNoteRefDateTo")
        Session("SS_SuppCode") = Request.QueryString("txtSuppCode")
        Session("SS_COACode") = Request.QueryString("txtCOACode")
        Session("SS_SuppCreditNoteIDFrom") = Request.QueryString("txtSuppCreditNoteIDFrom")
        Session("SS_SuppCreditNoteIDTo") = Request.QueryString("txtSuppCreditNoteIDTo")
    ...
    Sub BindReport()
        ...
        Dim strOpCd_SuppCreditNoteListing_GET As String = "AP_STDRPT_CREDITNOTELISTING_GET"
        Dim SearchStr As String
        Dim SQLStr As String
        Dim objFTPFolder As String
        Dim intCnt As Integer

        If Not (Request.QueryString("txtSuppCreditNoteIDFrom") = "" And Request.QueryString("txtSuppCreditNoteIDFromIDTo") = "") Then SearchStr = SearchStr & " AND APC.CreditNoteID >= '" & Request.QueryString("txtSuppCreditNoteIDFrom") & "' AND  APC.CreditNoteID <= '" & Request.QueryString("txtSuppCreditNoteIDTo") & "'"
        If Not Request.QueryString("txtSuppCreditNoteRefNo") = "" Then SearchStr = SearchStr & " AND APC.SupplierDocRefNo LIKE '" & Request.QueryString("txtSuppCreditNoteRefNo") & "' "
        If Not Request.QueryString("txtCOACode") = "" Then SearchStr = SearchStr & "AND APCLN.AccCode LIKE '" & Request.QueryString("txtCOACode") & "' "
        If Not Request.QueryString("txtBlock") = "" Then SearchStr = SearchStr & "AND APCLN.BlkCode LIKE '" & Request.QueryString("txtBlock") & "' "
        ...
        If Not Request.QueryString("txtVehicle") = "" Then SearchStr = SearchStr & "AND APCLN.VehCode LIKE '" & Request.QueryString("txtVehicle") & "' "
        If Not Request.QueryString("txtVehicleExp") = "" Then SearchStr = SearchStr & "AND APCLN.VehExpenseCode LIKE '" & Request.QueryString("txtVehicleExp") & "' "
        If Not Request.QueryString("txtStatus") = "0" Then SearchStr = SearchStr & "AND APC.Status LIKE '" & Request.QueryString("txtStatus") & "' "
        If Not Request.QueryString("txtSuppCode") = "" Then SearchStr = SearchStr & "AND (APC.SupplierCode LIKE '%" & Request.QueryString("txtSuppCode") & "%' OR PUSS.Name LIKE '%" & Request.QueryString("txtSuppCode") & "%') "
        If Not Request.QueryString("InvoiceRcvRefNo") = "" Then SearchStr = SearchStr & "AND APC.InvoiceRcvRefNo LIKE '" & Request.QueryString("InvoiceRcvRefNo") & "' "
        If Not (Request.QueryString("txtSuppCreditNoteRefDateFrom") = "" And Request.QueryString("txtSuppCreditNoteRefDateTo") = "") Then
            SearchStr = SearchStr & " AND (DateDiff(Day, '" & Session("SS_SuppCreditNoteRefDateFrom") & "', APC.SupplierDocRefDate) >= 0) And (DateDiff(Day, '" & Session("SS_SuppCreditNoteRefDateTo") & "', APC.SupplierDocRefDate) <= 0) "
        End If


        strParam = strUserLoc & "|" & strDDLAccMth & "|" & strDDLAccYr & "|" & strStatus & "|" & SearchStr
        Try
            intErrNo = objAP.mtdGetReport_SuppCreditNoteListing(strOpCd_SuppCreditNoteListing_GET, strParam, objRptDs, objMapPath, objFTPFolder)
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=APC_StdRpt_SuppCreditNoteListing&errmesg=" & lblErrMessage.Text & "&redirect=")
        End Try
    ...
    Sub PassParam()
        ...
        paramField27 = paramFields.Item("ParamSuppCreditNoteRefNo")
        paramField28 = paramFields.Item("ParamSuppCreditNoteRefDateFrom")
        paramField29 = paramFields.Item("ParamSuppCode")
        paramField30 = paramFields.Item("ParamCOACode")
        paramField31 = paramFields.Item("ParamSuppCreditNoteRefDateTo")
        paramField32 = paramFields.Item("ParamSuppCreditNoteIDFrom")
        paramField33 = paramFields.Item("ParamSuppCreditNoteIDTo")
        ...
        ParamDiscreteValue27.Value = Session("SS_SuppCreditNoteRefNo")
        ParamDiscreteValue28.Value = Session("SS_SuppCreditNoteREFDATEFROM")
        ParamDiscreteValue29.Value = Session("SS_SUPPCODE")
        ParamDiscreteValue30.Value = Session("SS_COACODE")
        ParamDiscreteValue31.Value = Session("SS_SuppCreditNoteREFDATETO")
        ParamDiscreteValue32.Value = Session("SS_SuppCreditNoteIDFrom")
        ParamDiscreteValue33.Value = Session("SS_SuppCreditNoteIDTo")
