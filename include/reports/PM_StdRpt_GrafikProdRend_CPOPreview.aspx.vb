...
Public Class PM_StdRpt_GrafikProdRend_CPOPreview : Inherits Page
    ...
    Sub BindReport()
        ...
        Dim strOpCd As String = "WM_STDRPT_PRODUCTION_GRAFIK_CPO_GET"
        ...
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=WM_STDRPT_PRODUCTION_GRAFIK_CPO_GET&errmesg=" & lblErrMessage.Text & "&redirect=")
        End Try

        rdCrystalViewer.Load(objMapPath & "web\" & strLangCode & "\reports\crystal\PM_StdRpt_GrafikProdRend_CPO.rpt", OpenReportMethod.OpenReportByTempCopy)
        ...
        If strExportToExcel = "0" Then
            crDiskFileDestinationOptions.DiskFileName = objMapPath & "web\ftp\PM_StdRpt_GrafikProdRend_CPO.pdf"
        Else
            crDiskFileDestinationOptions.DiskFileName = objMapPath & "web\ftp\PM_StdRpt_GrafikProdRend_CPO.xls"
        End If
        ...
        If strExportToExcel = "0" Then
            Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../ftp/PM_StdRpt_GrafikProdRend_CPO.pdf"">")
        Else
            Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../ftp/PM_StdRpt_GrafikProdRend_CPO.xls"">")
        End If
    End Sub
