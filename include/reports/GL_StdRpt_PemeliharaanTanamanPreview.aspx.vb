...
Public Class GL_StdRpt_PemeliharaanTanamanPreview : Inherits Page
    ...
    Dim strSelLocLevel as String 
    Dim strSelSubLocLevel as String
    Dim strSelRemark as String 
    ...
    Sub Page_Load(ByVal Sender As Object, ByVal E As EventArgs)
        ...
        Else
            ...
            strSelBlkGrp = Trim(Request.QueryString("SelBlkGrp"))
            strSelSubBlk = Trim(Request.QueryString("SelSubBlk"))
            strSelLocLevel = Trim(Request.QueryString("SelLocLevel"))
            strSelRemark = Trim(Request.QueryString("SelRemark"))


            if strSelLocLevel = "0" then
                strSelSubLocLevel = strSelBlkGrp
            Elseif (strSelLocLevel = "1") or (strSelLocLevel = "4") then
                strSelSubLocLevel = strSelBlk
            Else
                strSelSubLocLevel = strSelSubBlk
            end if
    ...
    Sub GetEntireLangCap()
        ...
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=GL_STDRPT_BiayaUmum_GET_LANGCAP&errmesg=" & Exp.ToString() & "&redirect=")
        End Try
    ...
    Sub BindSummReport()
        ...
        Try
            strRptPrefix = "GL_StdRpt_PemeliharaanTanaman"

            strOpCd = "GL_STDRPT_MR_PEMELIHARAAN_TM" & "|" & objGLRpt.mtdGetGLReportTable(objGLRpt.EnumGLReportTable.PemeliharaanTM) & Chr(9) & _
            ...
            intErrNo = objGLRpt.mtdGetReport_PemeliharaanTM(strOpCd, _
                                                    strCompany, _
                                                    strLocation, _
                                                    strUserId, _
                                                    strAccMonth, _
        ...
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=GL_STDRPT_BIAYAUMUM_GET_SP&errmesg=" & Exp.ToString() & "&redirect=")
        End Try
