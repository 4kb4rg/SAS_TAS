...
Public Class CB_StdRpt_ListOfBankTran : Inherits Page
    ...
    Protected WithEvents ddlBankCodeFrom As DropDownList
    Protected WithEvents ddlBankCodeTo As DropDownList
    ...
    Sub BindBankCode(ByVal pv_strBankCode As String)
        ...
        Catch Exp As Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=CB_TRX_LISTOFBANK_GET_BANK&errmesg=" & Exp.Message & "&redirect=CB/trx/cb_trx_ListOfBank.aspx")
        End Try
        ...
        ddlBankCodeFrom.DataSource = objBankDs.Tables(0)
        ddlBankCodeFrom.DataValueField = "BankCode"
        ddlBankCodeFrom.DataTextField = "Description"
        ddlBankCodeFrom.DataBind()
        ddlBankCodeFrom.SelectedIndex = intSelectedBankIndex
        
        ddlBankCodeTo.DataSource = objBankDs.Tables(0)
        ddlBankCodeTo.DataValueField = "BankCode"
        ddlBankCodeTo.DataTextField = "Description"
        ddlBankCodeTo.DataBind()
        ddlBankCodeTo.SelectedIndex = intSelectedBankIndex
    ...
    Sub GetEntireLangCap()
        ...
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=PWSYSTEM_CLSLANGCAP_BUSSTERM_GET&errmesg=" & lblErrMessage.Text & "&redirect=../en/reports/CB_StdRpt_Selection.aspx")
        End Try
    End Sub
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        strBankCodeFrom = ddlBankCodeFrom.SelectedItem.Value
        strBankCodeTo = ddlBankCodeTo.SelectedItem.Value
        strStatus = ddlStatus.SelectedItem.Value
       
        
        Response.Write("<Script Language=""JavaScript"">window.open(""CB_StdRpt_ListOfBankTranPreview.aspx?Type=Print&CompName=" & strCompany & _
                       "&RptID=" & strRptID & _
                       "&RptTitle=" & strRptTitle & _
                       "&Decimal=" & strDecimal & _
                       "&DateFrom=" & strDateFrom & _
                       "&DateTo=" & strDateTo & _
                       "&BankCodeFrom=" & strBankCodeFrom & _
                       "&BankCodeTo=" & strBankCodeTo & _
                       "&Status=" & strStatus & _
