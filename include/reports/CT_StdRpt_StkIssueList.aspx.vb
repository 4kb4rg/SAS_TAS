...
Public Class CT_StdRpt_StkIssueList : Inherits Page
    ...
    Sub BindStkIssueType()
        ...
        lstStkIssueType.Items.Add(New ListItem(objCTTrx.mtdGetStockIssueType(objCTTrx.EnumStockIssueType.External), objCTTrx.EnumStockIssueType.External))
        lstStkIssueType.Items.Add(New ListItem(objCTTrx.mtdGetStockIssueType(objCTTrx.EnumStockIssueType.OwnUse), objCTTrx.EnumStockIssueType.OwnUse))
        lstStkIssueType.Items.Add(New ListItem(objCTTrx.mtdGetStockIssueType(objCTTrx.EnumStockIssueType.StaffDN), objCTTrx.EnumStockIssueType.StaffDN))
        lstStkIssueType.Items.Add(New ListItem(objCTTrx.mtdGetStockIssueType(objCTTrx.EnumStockIssueType.StaffPayroll), objCTTrx.EnumStockIssueType.StaffPayroll))

    End Sub

    Sub BindStatus()

        lstStatus.Items.Add(New ListItem(objCTTrx.mtdGetStockIssueStatus(objCTTrx.EnumStockIssueStatus.All), objCTTrx.EnumStockIssueStatus.All))
        lstStatus.Items.Add(New ListItem(objCTTrx.mtdGetStockIssueStatus(objCTTrx.EnumStockIssueStatus.Active), objCTTrx.EnumStockIssueStatus.Active))
        lstStatus.Items.Add(New ListItem(objCTTrx.mtdGetStockIssueStatus(objCTTrx.EnumStockIssueStatus.Closed), objCTTrx.EnumStockIssueStatus.Closed))
        lstStatus.Items.Add(New ListItem(objCTTrx.mtdGetStockIssueStatus(objCTTrx.EnumStockIssueStatus.Confirmed), objCTTrx.EnumStockIssueStatus.Confirmed))
        lstStatus.Items.Add(New ListItem(objCTTrx.mtdGetStockIssueStatus(objCTTrx.EnumStockIssueStatus.DbNote), objCTTrx.EnumStockIssueStatus.DbNote))
        lstStatus.Items.Add(New ListItem(objCTTrx.mtdGetStockIssueStatus(objCTTrx.EnumStockIssueStatus.Deleted), objCTTrx.EnumStockIssueStatus.Deleted))
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        Try
            intErrNo = objSysCfg.mtdGetConfigInfo(strParam, _
                                                  ...
                                                  objSysCfgDs)
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=CT_STKISSUE_GET_CONFIG_DATE&errmesg=" & lblErrMessage.Text & "&redirect=../../en/reports/CT_StdRpt_Selection.aspx")
        End Try
        ...
        If Not (strDateFrom = "" And strDateTo = "") Then
            If objGlobal.mtdValidInputDate(strDateSetting, strDateFrom, objDateFormat, objDateFrom) = True And objGlobal.mtdValidInputDate(strDateSetting, strDateTo, objDateFormat, objDateTo) = True Then
                Response.Write("<Script Language=""JavaScript"">window.open(""CT_StdRpt_StkIssueListPreview.aspx?Type=Print&CompName=" & strCompany & "&Location=" & strUserLoc & "&RptID=" & strRptID & "&RptName=" & strRptName & "&Decimal=" & strDec & _
