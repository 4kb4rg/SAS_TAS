...
Public Class PR_StdRpt_LHPBPreview_Estate : Inherits Page
    ...
    Sub BindReport()
        ...
        If Not isMandor Then
            strOpCd = "PR_PR_STDRPT_LHPB_REPORT_DIVISI"
            fname = "PR_STDRPT_LHPB_ESTATE_DIVISI"
            strParamName = "LOCCODE|DIVISI|BKMDATE"
            ...
            Try
                ...
                objRpt.Tables(0).TableName = "PR_StdRpt_LHPB_Divisi"
                objRpt.Tables(1).TableName = "PR_StdRpt_LHPB_Sumarry"
            ...
            objRptDs.Tables(0).TableName = "PR_StdRpt_LHPB_Divisi"
            objRptDs.Tables.Add(objRpt.Tables(1).Copy())
            objRptDs.Tables(1).TableName = "PR_StdRpt_LHPB_Sumarry"

        Else
            strOpCd = "PR_PR_STDRPT_LHPB_REPORT_MANDOR"
            fname = "PR_STDRPT_LHPB_ESTATE_MANDOR"
            ...
            Try
                intErrNo = objOk.mtdGetReportDataCommon(strOpCd, strParamName, strParamValue, objRpt, objMapPath, objFTPFolder)
                objRpt.Tables(0).TableName = "PR_StdRpt_LHPB_Mandor"
            Catch Exp As System.Exception
                Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=PR_PR_STDRPT_LHPT_REPORT&errmesg=" & lblErrMessage.Text & "&redirect=")
            End Try
            ...
            objRptDs.Tables.Add(objRpt.Tables(0).Copy())
            objRptDs.Tables(0).TableName = "PR_StdRpt_LHPB_Mandor"
        End If
