...
Public Class CB_StdRpt_DailyPaymentPreview : Inherits Page
    ...
    Sub BindReport()
        ...
        Dim strOpCode As String = "CB_STDRPT_DAILYPAYMENT_GET"
        Dim strFileName As String = "CB_StdRpt_DailyPayment_Report"
