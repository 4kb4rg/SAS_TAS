...
Public Class WM_StdRpt_FFB_Assess_SumPreview : Inherits Page
    ...
    Sub BindReport()
        ...
        Dim strOpCd_FFBAssess_Sum_GET As String = "WM_STDRPT_FFBASSESS_SUMMARY_GET"
        Dim strFileName As String = "WM_StdRpt_FFBAssessSummary"
        ...
        End If
        searchStr = searchStr & "AND (FFB.Status = '" & objWMTrx.EnumFFBAssessStatus.Active & "' OR FFB.Status IS NULL) "
        ...
        strParam = strUserLoc & "|" & _
                   ...
                   objWMTrx.EnumWeighBridgeTicketStatus.Active & "|" & searchStr
                   
        Try
            intErrNo = objWM.mtdGetReport_FFBAssessSummary(strOpCd_FFBAssess_Sum_GET, _
                                                           strParam, _
                                                           objRptDs, _
                                                           objMapPath)
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=WM_STDRPT_DAILY_FFBRCV_BYSUPP_GET&errmesg=" & lblErrMessage.Text & "&redirect=")
        End Try
