...
Public Class AP_StdRpt_MutasiAccountPayablePreview : Inherits Page
    ...
    Sub BindReport()
        ...
        Dim strOpCode As String = "AP_STDRPT_MUTASI_GET"
        Dim strFileName As String = "AP_StdRpt_MutasiAccountPayable"

        Dim strParam As String
        Dim searchStr As String
        Dim objFTPFolder As String
        Dim strloc As String = "''" + Replace(strSelLocation, "'", "''") + "''"
		...
		strParamValue = strSrchSupplier & "|" & strloc & "|" & strSrchPeriode1 & "|" & strSrchPeriode2 & "|" & strSplType & "|" & strRptType
        ...
        If strSplType <> "0" Then
            rdCrystalViewer.SetDataSource(objRptDs.Tables(0))
        Else
            rdCrystalViewer.SetDataSource(objRptDs.Tables(3))
        End If
