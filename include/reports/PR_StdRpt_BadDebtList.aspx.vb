...
Public Class PR_StdRpt_BadDebtList : Inherits Page
    ...
    Protected WithEvents lstSort As DropDownList
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        strSort = lstSort.SelectedItem.Value



            Response.Write("<Script Language=""JavaScript"">window.open(""PR_StdRpt_BadDebtListPreview.aspx?Type=Print&CompName=" & strCompany & _
