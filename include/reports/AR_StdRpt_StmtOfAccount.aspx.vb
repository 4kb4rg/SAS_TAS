...
Public Class AR_StdRpt_StmtOfAccount : Inherits Page
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        Response.Write("<Script Language=""JavaScript"">window.open(""AR_StdRpt_StmtOfAccountPreview.aspx?Type=Print&CompName=" & strCompany & _
    ...
    Sub DisplayXmlParameters(ByRef pr_strToAge1 As String, _
        ...
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=AR_STDRPT_GET_FTPPATH_DISPLAY&errmesg=" & Exp.ToString() & "&redirect=reports/ar_stdrpt_stmtofaccount.aspx")
        End Try
    ...
    Sub UpdateXmlParameters()
        ...
        Try
            intErrNo = objSysCfg.mtdGetFtpPath(strFtpPath)
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=AR_STD_RPT_GET_FTPPATH_UPD&errmesg=" & Exp.ToString() & "&redirect=reports/ar_stdrpt_stmtofaccount.aspx")
        End Try
    ...
    Sub GetEntireLangCap()
        ...
        Try
            intErrNo = objLangCap.mtdGetBussTerm(strOpCode_BussTerm, _
                                                 ...
                                                 strParam)
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=AR_STDRPT_STMTOFACCOUNT_GET_LANGCAP&errmesg=" & lblErrMessage.Text & "&redirect=../en/reports/IN_StdRpt_Selection.aspx")
        End Try
