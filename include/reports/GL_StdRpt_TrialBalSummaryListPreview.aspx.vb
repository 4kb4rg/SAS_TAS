...
Public Class GL_StdRpt_TrialBalSummaryListPreview : Inherits Page
    ...
    Sub Page_Load(ByVal Sender As Object, ByVal E As EventArgs)
        ...
        strSum = Request.QueryString("Sum")
    ...
    Sub BindReport()
        ...
        'If lcase(strSum) = "yes" Then
        '    Try
        '        If lcase(strEstExpense) = "yes" Then
        '            strRptPrefix = "GL_StdRpt_TrialBalEstExp"
        '            strOpCd = "GL_STDRPT_TRIALBAL_SUMMARY_GET_SP" & "|" & objGLRpt.mtdGetGLReportTable(objGLRpt.EnumGLReportTable.TrialBalSummary) & Chr(9) & _
        '                      "GL_STDRPT_TRIALBAL_GET_ESTEXP_SP" & "|" & "GL_ESTEXP"
        '        Else
        '            strRptPrefix = "GL_StdRpt_TrialBalSummaryList"
        '            strOpCd = "GL_STDRPT_TRIALBAL_SUMMARY_GET_SP" & "|" & objGLRpt.mtdGetGLReportTable(objGLRpt.EnumGLReportTable.TrialBalSummary) & Chr(9) & _
        ...
        '        intErrNo = objGLRpt.mtdGetReport_TrialBalSumList(strOpCd, _
        '                                                         strOpCdRslGet, _
        '                                                         strCompany, _
        '                                                         strLocation, _
        '                                                         strUserId, _
        ...
        '        Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=GL_STDRPT_TRIALBALSUMMARY_GET&errmesg=" & Exp.ToString() & "&redirect=")
        '    End Try

        'Else

        '    If strSrchBlkCode = "" Then
        '        strSearchExp = strSearchExp & "AND ME.BlkCode LIKE '%'"
        '    Else
        '        strSearchExp = strSearchExp & "AND ME.BlkCode LIKE '" & strSrchBlkCode & "'"
        '    End If

        '    If strSrchVehCode = "" Then
        '        strSearchExp = strSearchExp & "AND ME.VehCode LIKE '%'"
        '    Else
        '        strSearchExp = strSearchExp & "AND ME.VehCode LIKE '" & strSrchVehCode & "'"
        '    End If

        '    If strSrchVehExpCode = "" Then
        '        strSearchExp = strSearchExp & "AND ME.VehExpenseCode LIKE '%'"
        '    Else
        '        strSearchExp = strSearchExp & "AND ME.VehExpenseCode LIKE '" & strSrchVehExpCode & "'"
        '    End If

        '    If LCase(strWithTrans) = "yes" Then
        '        Try
        ...
        '        For intCnt=0 To objRptDs.Tables("GL_TRIALBALSUMMARY").Rows.Count - 1
        '            objRptDs.Tables("GL_TRIALBALSUMMARY").Rows(intCnt).Item("RefDesc") = objGlobal.mtdGetModuleName(CInt(objRptDs.Tables("GL_TRIALBALSUMMARY").Rows(intCnt).Item("ModuleCode"))) & lblRefDesc.text & objGlobal.mtdGetDocName(CInt(objRptDs.Tables("GL_TRIALBALSUMMARY").Rows(intCnt).Item("DocType")))
        '        Next
        '    Else
        '        Try
        '            strRptPrefix = "GL_StdRpt_TrialBalSummaryDet"
        '            strOpCd = "GL_STDRPT_TRIALBAL_DETAIL_GET_NOTRX_SP" & "|" & objGLRpt.mtdGetGLReportTable(objGLRpt.EnumGLReportTable.TrialBalSummary) & Chr(9) & _
        '                    "GET_REPORT_INFO_BY_REPORTID|SH_REPORT"
        '            strParam = strSelAccMonth & "|" & _
        '                        strSelAccYear & "|" & _
        '                        strUserLoc & "|" & _
        ...
        '                                                            dblNCF)
        '        Catch Exp As System.Exception
        '            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=GL_STDRPT_TRIALBALDETAIL_GET&errmesg=" & Exp.ToString() & "&redirect=")
        '        End Try

        '        For intCnt=0 To objRptDs.Tables("GL_TRIALBALSUMMARY").Rows.Count - 1
        '            objRptDs.Tables(0).Rows(intCnt).Item("AccType") = objGLSetup.mtdGetAccountType(objRptDs.Tables(0).Rows(intCnt).Item("AccType"))
        '        Next
        '    End If
        'End If
    ...
    Sub PassParam()
        ...
        If lcase(strSum) = "yes" Then
            ...
            ParamDiscreteValue14.Value = strEstExpense
            ...
            ParamFieldDef14 = ParamFieldDefs.Item("EstExpense")
        ...
        Else
            ...
            ParamDiscreteValue20.Value = dblPCF
            ParamDiscreteValue21.Value = dblNCF
            ParamDiscreteValue22.Value = strWithTrans
            ...
            ParamFieldDef20 = ParamFieldDefs.Item("totalPCF")
            ParamFieldDef21 = ParamFieldDefs.Item("totalNCF")
            ParamFieldDef22 = ParamFieldDefs.Item("SelWithTrans")
            ...
            ParameterValues23 = ParamFieldDef22.CurrentValues
            ParameterValues24 = ParamFieldDef23.CurrentValues
    ...
    Sub GetEntireLangCap()
        ...
        Try
            intErrNo = objLangCap.mtdGetBussTerm(strOpCode_BussTerm, _
                                                 ...
                                                 strParam)
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=PWSYSTEM_CLSLANGCAP_BUSSTERM_GET&errmesg=" & Exp.ToString() & "&redirect=")
        End Try
