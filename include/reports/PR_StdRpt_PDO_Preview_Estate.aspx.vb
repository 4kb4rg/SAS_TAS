...
Public Class PR_StdRpt_PDO_Preview_Estate : Inherits Page
    ...
    Sub BindReport()
        ...
        Dim ReportID As String = Request.QueryString("RptID")
            ...
            strOpCd = "PR_PR_STDRPT_PDO_REPORT"
            fname = "PR_StdRpt_PDO_Estate"
            ...
            Try
                ...
                objRpt.Tables(0).TableName = "PR_PDO_Estate"
            ...
            objRptDs.Tables(0).TableName = "PR_PDO_Estate"
