...
Public Class CT_StdRpt_MthCTAccMoveDetails_Preview : Inherits Page
    ...
    Sub BindReport()
        ...
        Dim strOpCd As String = "CT_STDRPT_MONTHLY_CANTEEN_ACCOUNT_MOVEMENT_DETAILS_SP"
        ...
        Try
            intErrNo = objCT.mtdGetReport_MthCTAccMoveDetails(strOpCd, Replace(strParam, "'", "''"), objRptDs, objMapPath)
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=CT_STDRPT_MONTHLY_CANTEEN_ACCOUNT_MOVEMENT_DETAILS&errmesg=" & Exp.ToString() & "&redirect=")
        End Try


        rdCrystalViewer.Load(objMapPath & "web\" & strLangCode & "\Reports\Crystal\CT_StdRpt_MthCTAccMoveDetails.rpt", OpenReportMethod.OpenReportByTempCopy)
        ...
        crDiskFileDestinationOptions.DiskFileName = objMapPath & "web\ftp\CT_StdRpt_MthCTAccMoveDetails.pdf"
        ...
        Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../ftp/CT_StdRpt_MthCTAccMoveDetails.pdf"">")
    End Sub
