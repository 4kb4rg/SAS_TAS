...
Public Class PM_StdRpt_PKStorageTransactionList : Inherits Page
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        If strErrDateFrom = "" And strErrDateTo = "" Then
            ...
            Response.Write("<Script Language=""JavaScript"">window.open(""PM_StdRpt_PKStorageTransactionListPreview.aspx?Type=Print&CompName=" & strCompany & "&Location=" & strUserLoc & "&RptID=" & strRptID & "&RptName=" & strRptName & _
