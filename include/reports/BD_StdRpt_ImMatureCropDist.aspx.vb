...
Public Class BD_StdRpt_ImMatureCropDist : Inherits Page
    ...
    Sub onload_GetLangCap()
        ...
        lblTitle.Text = "BUDGETING - IMMATURE CROP ACTIVITY CALENDERISATION"
    End Sub
    ...
    Sub GetEntireLangCap()
        ...
        Catch Exp As System.Exception
            Response.Redirect("../../../include/mesg/ErrorMessage.aspx?errcode=BD_STDRPT_IMMATURECROPDIST_BUSSTERM_GET&errmesg=" & lblErrMessage.Text & "&redirect=../en/reports/BD_StdRpt_Selection.aspx")
        End Try
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        Response.Write("<Script Language=""JavaScript"">window.open(""BD_StdRpt_ImMatureCropDistPreview.aspx?DDLPeriodID=" & strddlPeriodID & "&DDLPeriodName=" & strddlPeriodName & _
                       "&RptID=" & strRptID & "&RptName=" & strRptName & "&Decimal=" & strDec & "&lblCrop=" & lblCrop.Text & "&BlkCode=" & strBlkCode & "&SubBlkCode=" & strSubBlkCode & _
                       "&lblAccCodeTag=" & lblAccCodeTag.Text & "&lblBlkCodeTag=" & lblBlkCodeTag.Text & "&lblSubBlkCodeTag=" & lblSubBlkCodeTag.Text & _
