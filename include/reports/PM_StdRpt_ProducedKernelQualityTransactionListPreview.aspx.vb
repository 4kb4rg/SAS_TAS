...
Public Class PM_StdRpt_ProducedKernelQualityTransactionListPreview : Inherits Page
    ...
    Sub BindReport()
        ...
        Dim strOpCdPR_GET As String = "PM_CLSRPT_PRODUCED_KERNEL_QUALITY_GET"
        ...
        Try
            intErrNo = objPM.mtdGetProduceKernelQuality(strOpCdPR_GET, strParam, objRptDs, objMapPath)
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=GET_PM_PRODUCED_KERNEL_QUALITY_GET_LIST_REPORT&errmesg=" & lblErrMessage.Text & "&redirect=")
        End Try



        rdCrystalViewer.Load(objMapPath & "web\" & strLangCode & "\Reports\Crystal\PM_StdRpt_ProducedKernelQualityTransactionList.rpt", OpenReportMethod.OpenReportByTempCopy)
        ...
        crDiskFileDestinationOptions.DiskFileName = objMapPath & "web\ftp\PM_StdRpt_ProducedKernelQualityTransactionList.pdf"
 	...
 	rdCrystalViewer.Close()
        ...
        Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../ftp/PM_StdRpt_ProducedKernelQualityTransactionList.pdf"">")
    End Sub
