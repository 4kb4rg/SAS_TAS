...
Public Class PR_StdRpt_TaxDeductListPreview : Inherits Page
    ...
    Sub BindReport()
        ...
        Try
            strRptPrefix = "PR_StdRpt_TaxDeductList"

            strOpCd = "PR_STDRPT_TAXDEDUCT_SP" & "|" & objPRRpt.mtdGetPRReportTable(objPRRpt.EnumPRReportTable.TaxDeduct) & Chr(9) & _
            ...
            intErrNo = objPRRpt.mtdGetReport_TaxDeductList_SP(strOpCd, _
                                                              strCompany, _
                                                              strLocation, _
                                                              strUserId, _
                                                              strAccMonth, _
        ...
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=PR_STDRPT_TAXDEDUCTLIST_GET&errmesg=" & Exp.ToString() & "&redirect=")
        End Try
