...
Public Class GL_StdRpt_BiayaUmumPreview : Inherits Page
    ...
    Sub BindSummReport()
        ...
        Try
            strRptPrefix = "GL_StdRpt_BiayaUmum"

            strOpCd = "GL_STDRPT_BIAYAUMUM_GET_SP" & "|" & objGLRpt.mtdGetGLReportTable(objGLRpt.EnumGLReportTable.BiayaUmum) & Chr(9) & _
            ...
            intErrNo = objGLRpt.mtdGetReport_BiayaUmum(strOpCd, _
                                                    strCompany, _
                                                    strLocation, _
                                                    strUserId, _
                                                    strAccMonth, _
