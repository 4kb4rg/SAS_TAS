...
Public Class PR_StdRpt_Lembur_Preview_Estate : Inherits Page
    ...
    Sub Page_Load(ByVal Sender As Object, ByVal E As EventArgs)
        ...
        strDetHours = Trim(Request.QueryString("DetHours"))
    ...
    Sub BindReport()
        ...
        If strDetHours = "1" Then
            strOpCd = "PR_PR_STDRPT_LEMBUR_EMP_HOURS_REPORT"
            strRptPrefix = "PR_StdRpt_Lembur_Emp_Hours"
        Else
            strOpCd = "PR_PR_STDRPT_LEMBUR_EMP_REPORT"
            strRptPrefix = "PR_StdRpt_Lembur_Emp"
        End If
       

        strParamName = "ACCMONTH|ACCYEAR|LOCCODE|F_DIVCODE|ST|TYPE"
        ...
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=PR_PR_STDRPT_LEMBUR_EMP_REPORT&errmesg=" & lblErrMessage.Text & "&redirect=")
        End Try
