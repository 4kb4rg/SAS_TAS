...
Public Class GL_StdRpt_VehExpenseDetPreview : Inherits Page
    ...
    Sub Page_Load(ByVal Sender As Object, ByVal E As EventArgs)
        ...
        Else
            ...
            strIsSummBy = Trim(Request.QueryString("IsSummBy"))
    ...
    Sub BindReport()
        ...
        Try
            strRptPrefix = "GL_StdRpt_VehExpenseDetail"
            
            strOpCd = "GL_STDRPT_VEH_EXPENSE_DET_SP" & "|" & objGLRpt.mtdGetGLReportTable(objGLRpt.EnumGLReportTable.VehExpenseDet)
            ...
            intErrNo = objGLRpt.mtdGetReport_VehExpDetail(strOpCd, _
                                              strCompany, _
                                              strLocation, _
                                              strUserId, _
                                              strAccMonth, _
        ...
        Catch Exp As System.Exception
           Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=GL_STDRPT_VEHICLE_EXPENSE_DETAIL_GET_DETAIL&errmesg=" & Exp.ToString() & "&redirect=")
        End Try
        ...
        For Each myTable In rdCrystalViewer.Database.Tables
            ...
            If myTable.Name = "GL_VEHICLEEXPENSEDET" Then
                myLogin = myTable.LogOnInfo
                Try
                    intErrNo = objGLRpt.mtdGet_DBConnObj(myLogin)
                Catch Exp As System.Exception
                    Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=GL_VEHEXP_RPT_GET&errmesg=" & Exp.ToString() & "&redirect=")
                End Try

                myTable.ApplyLogOnInfo(myLogin)
                myTable.Location = myLogin.ConnectionInfo.DatabaseName & ".dbo.GL_VEHEXP_RPT"
            End If
    ...
    Sub BindSummReport()
        ...
        Try
            strRptPrefix = "GL_StdRpt_VehExpenseDetailSumm"
