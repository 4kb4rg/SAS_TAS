...
Public Class PR_StdRpt_GajiBank_Estate : Inherits Page
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        If intLevel = 0 Then
                lblErrMessage.Text = "Your dont have access"
		...
		strEmpType = ddltype.SelectedItem.Value.Trim() 
        ...
        Response.Write("<Script Language=""JavaScript"">window.open(""PR_StdRpt_GajiBankPreview_Estate.aspx?CompCode=" & strCompany & "&Location=" & strUserLoc & "&RptID=" & strRptID & "&RptName=" & strRptName & "&Decimal=" & strDec & _
                       "&lblLocation=" & lblLocation.Text & "&AccMonth=" & strddlAccMth & "&AccYear=" & strddlAccYr & "&Type=" & strEmpType & _
