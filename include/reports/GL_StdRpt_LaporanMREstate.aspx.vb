...
Public Class GL_StdRpt_LaporanMREstate : Inherits Page
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        Response.Write("<Script Language=""JavaScript"">window.open(""GL_StdRpt_LaporanMREstatePreview.aspx?Type=Print&CompName=" & strCompany & _
                       ...
                       """,""" & strRptId+strRptType & """ ,""status=yes, resizable=yes, scrollbars=yes, toolbar=no, location=no"");</Script>")
    End Sub
End Class
