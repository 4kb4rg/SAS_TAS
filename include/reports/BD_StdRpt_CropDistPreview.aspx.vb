...
Public Class BD_StdRpt_CropDistPreview : Inherits Page
    ...
    Protected WithEvents lblAreaTag As Label
    ...
    Sub BindReport()
        ...
        Dim strOpCd_CropDist_GET As String = "BD_STDRPT_CROPDIST_GET"
        ...
        If strBlkType = "BlkGrp" Then
            ...
            Else
                SearchStr = "AND BLK.BlkGrpCode LIKE '%' "
            End If
        ElseIf strBlkType = "BlkCode" Then
            If Not Request.QueryString("BlkCode") = "" Then
                SearchStr = "AND CD.BlkCode LIKE '" & Request.QueryString("BlkCode") & "' "
            Else
                SearchStr = "AND CD.BlkCode LIKE '%' "
            End If
        End If

        strParam = Request.QueryString("DDLPeriodID") & "|" & strLocation & "|" & SearchStr
        Try
            intErrNo = objBD.mtdGetReport_CropDist(strOpCd_CropDist_GET, strParam, objRptDs, objMapPath)
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=BD_CROP_DIST&errmesg=" & lblErrMessage.Text & "&redirect=")
        End Try


        rdCrystalViewer.Load(objMapPath & "web\" & strLangCode & "\Reports\Crystal\BD_StdRpt_CropDist.rpt", OpenReportMethod.OpenReportByTempCopy)
        ...
        crDiskFileDestinationOptions.DiskFileName = objMapPath & "web\ftp\BD_StdRpt_CropDist.pdf"
        ...
        Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../ftp/BD_StdRpt_CropDist.pdf"">")
    End Sub
    ...
    Sub PassParam()
        ...
        paramField8 = paramFields.Item("ParamlblArea")
        paramField9 = paramFields.Item("lblBlkGrp")
        paramField10 = paramFields.Item("lblBlkCodeTag")
        paramField11 = paramFields.Item("ParamBlkType")
        paramField12 = paramFields.Item("ParamBlkCode")
        paramField13 = paramFields.Item("ParamBlkOrSubBlk")
        paramField14 = paramFields.Item("ParamBlkGrp")
        ...
        ParamDiscreteValue8.Value = lblAreaTag.Text
        ParamDiscreteValue9.Value = Request.QueryString("lblBlkGrp")
        ParamDiscreteValue10.Value = Request.QueryString("lblBlkCodeTag")
        ParamDiscreteValue11.Value = Request.QueryString("BlkType")
        ParamDiscreteValue12.Value = Request.QueryString("BlkCode")

        If strBlkType = "BlkGrp" Then
            ParamDiscreteValue13.Value = "BlkGrp"
        ElseIf strBlkType = "BlkCode" Then
            ParamDiscreteValue13.Value = "Block"
        End If
        ParamDiscreteValue14.Value = Request.QueryString("BlkGrp")
    ...
    Sub onload_GetLangCap()
        ...
        lblAreaTag.Text = GetCaption(objLangCap.EnumLangCap.Area)
    ...
    Sub GetEntireLangCap()
        ...
        Try
            intErrNo = objLangCap.mtdGetBussTerm(strOpCode_BussTerm, _
                                                 ...
                                                 strParam)
        Catch Exp As System.Exception
            Response.Redirect("../../../include/mesg/ErrorMessage.aspx?errcode=BD_CROPDIST_LANGCAP_GET&errmesg=" & lblErrMessage.Text & "&redirect=")
        End Try
