...
Public Class WS_StdRpt_MthWSUtilByBlockList : Inherits Page
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        Response.Write("<Script Language=""JavaScript"">window.open(""WS_StdRpt_MthWSUtilByBlockListPreview.aspx?Type=Print&CompName=" & strCompany & "&Location=" & strUserLoc & _
