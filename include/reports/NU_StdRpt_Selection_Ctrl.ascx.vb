...
Public Class NU_StdRpt_Selection_Ctrl : Inherits UserControl
    ...
    Protected WithEvents TrDec As HtmlTableRow
    ...
    Function BindAccYearList(ByVal pv_strLocation As String, _
        ...
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=NU_STDRPT_CTRL_ACCCFG_DIST_GET&errmesg=" & Exp.ToString() & "&redirect=")
        End Try
        ...
        If objAccCfg.Tables(0).Rows.Count > 0 Then      '--found year's record
            ...
            Try
                ...
                intErrNo = objAdmAcc.mtdGetAccPeriodCfg(strOpCd_Max_Get, _
                                                        ...
                                                        objAccCfg)
            Catch Exp As System.Exception
                Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=NU_STDRPT_CTRL_ACCCFG_MAX_GET&errmesg=" & Exp.ToString() & "&redirect=")
            End Try
            ...
            Catch Exp As System.Exception
                Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=NU_STDRPT_CTLR_ACCCFG_MAXPERIOD&errmesg=System required period configuration to process your request. Please set period configuration for the year of " & Convert.ToString(intAccYear) & "&redirect=")
            End Try
    ...
    Sub GetUserLoc()
        ...
        Dim strOppCd_UserLoc_GET As String = "NU_STDRPT_USERLOCATION_GET"
        ...
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=GET_NU_SELECTIONCTRL_USERLOCATION&errmesg=" & Exp.ToString() & "&redirect=../en/reports/NU_StdRpt_Selection.aspx")
        End Try
    ...
    Sub BindReportNameList()
        ...
        Dim strOppCd_StdRptName_GET As String = "NU_STDRPT_NAME_GET"

        strParam = " WHERE ReportType = '" & Convert.ToString(objGlobal.EnumStdRptType.Nursery) & "' AND Status = '" & Convert.ToString(objGlobal.EnumStdRptStatus.Active) & "' ORDER BY RptName"
        Try
            intErrNo = objAdmin.mtdGetStdRptName(strOppCd_StdRptName_GET, strParam, dsForDropDown, objMapPath)
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=GET_NU_SELECTIONCTRL_REPORT_NAME_LIST&errmesg=" & Exp.ToString() & "&redirect=../en/reports/NU_StdRpt_Selection.aspx")
        End Try
    ...
    Sub CheckRptName(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If strSelectedIndex = "rptnu1000001" Then
            Response.Redirect("../../" & strLangCode & "/reports/NU_StdRpt_SeedReceiveList.aspx?SelIndex=" & Convert.ToString(intSelectedIndex) & "&UserLoc=" & strUserLoc)
        ElseIf strSelectedIndex = "rptnu1000002" Then
            Response.Redirect("../../" & strLangCode & "/reports/NU_StdRpt_SeedPlantList.aspx?SelIndex=" & Convert.ToString(intSelectedIndex) & "&UserLoc=" & strUserLoc)
        ElseIf strSelectedIndex = "rptnu1000003" Then
            Response.Redirect("../../" & strLangCode & "/reports/NU_StdRpt_DoubleTurnList.aspx?SelIndex=" & Convert.ToString(intSelectedIndex) & "&UserLoc=" & strUserLoc)
        ElseIf strSelectedIndex = "rptnu1000004" Then
            Response.Redirect("../../" & strLangCode & "/reports/NU_StdRpt_SeedTransplantList.aspx?SelIndex=" & Convert.ToString(intSelectedIndex) & "&UserLoc=" & strUserLoc)
        ElseIf strSelectedIndex = "rptnu1000005" Then
            Response.Redirect("../../" & strLangCode & "/reports/NU_StdRpt_SeedDispatchList.aspx?SelIndex=" & Convert.ToString(intSelectedIndex) & "&UserLoc=" & strUserLoc)
        ElseIf strSelectedIndex = "rptnu1000006" Then
            Response.Redirect("../../" & strLangCode & "/reports/NU_StdRpt_CullList.aspx?SelIndex=" & Convert.ToString(intSelectedIndex) & "&UserLoc=" & strUserLoc)
        ElseIf strSelectedIndex = "rptnu1000007" Then
            Response.Redirect("../../" & strLangCode & "/reports/NU_StdRpt_NUWrkAccDet.aspx?SelIndex=" & Convert.ToString(intSelectedIndex) & "&UserLoc=" & strUserLoc)
        ElseIf strSelectedIndex = "rptnu1000008" Then
            Response.Redirect("../../" & strLangCode & "/reports/NU_StdRpt_NUWrkAccSum.aspx?SelIndex=" & Convert.ToString(intSelectedIndex) & "&UserLoc=" & strUserLoc)
        ElseIf strSelectedIndex = "rptnu1000009" Then
            Response.Redirect("../../" & strLangCode & "/reports/NU_StdRpt_SeedDispatchRpt.aspx?SelIndex=" & Convert.ToString(intSelectedIndex) & "&UserLoc=" & strUserLoc)
        ElseIf strSelectedIndex = "rptnu1000010" Then
            Response.Redirect("../../" & strLangCode & "/reports/NU_StdRpt_SeedDispatchDoc.aspx?SelIndex=" & Convert.ToString(intSelectedIndex) & "&UserLoc=" & strUserLoc)
        ElseIf strSelectedIndex = "rptnu1000011" Then
            Response.Redirect("../../" & strLangCode & "/reports/NU_StdRpt_SeedlingsIssueList.aspx?SelIndex=" & Convert.ToString(intSelectedIndex) & "&UserLoc=" & strUserLoc)
        ElseIf strSelectedIndex = "rptnu1000012" Then
            Response.Redirect("../../" & strLangCode & "/reports/NU_StdRpt_SeedlingsIssueListMi.aspx?SelIndex=" & Convert.ToString(intSelectedIndex) & "&UserLoc=" & strUserLoc)
        ElseIf strSelectedIndex = "rptnu1000013" Then
            'Response.Redirect("../../" & strLangCode & "/reports/NU_StdRpt_WorkAccDetMi.aspx?SelIndex=" & Convert.ToString(intSelectedIndex) & "&UserLoc=" & strUserLoc)
            Response.Redirect("../../" & strLangCode & "/reports/NU_StdRpt_BiayaBibit.aspx?SelIndex=" & Convert.ToString(intSelectedIndex) & "&UserLoc=" & strUserLoc)
        ElseIf strSelectedIndex = "rptnu1000014" Then
            Response.Redirect("../../" & strLangCode & "/reports/NU_StdRpt_MutasiBibit.aspx?SelIndex=" & Convert.ToString(intSelectedIndex) & "&UserLoc=" & strUserLoc)
        End If
