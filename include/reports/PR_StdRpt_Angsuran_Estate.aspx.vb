...
Public Class PR_StdRpt_Angsuran_Estate : Inherits Page
	...
	Protected WithEvents ddlty As DropDownList
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        strddlEmpType = ddlemptype.SelectedItem.Value.Trim
		...
		strddlTy = ddlTy.SelectedItem.Value.Trim()
        ...
        Response.Write("<Script Language=""JavaScript"">window.open(""PR_StdRpt_AngsuranPreview_Estate.aspx?CompCode=" & strCompany & "&Location=" & strUserLoc & "&RptID=" & strRptID & "&RptName=" & strRptName & _
                       "&lblLocation=" & lblLocation.Text & "&AccMonth=" & strddlAccMth & "&EmpType=" & strddlEmpType &  "&AccYear=" & strddlAccYr & "&TypeAsr=" & strddlTy & "&ExportToExcel=" & strExportToExcel & _
    ...
    Sub BindEmpType(ByVal pv_strEmpType As String)
        Dim strParamName As String
        Dim strParamValue As String
        Dim intErrNo As Integer
        Dim intCnt As Integer = 0
        ...
        Dim dr As DataRow		
        Dim strOpCd As String = "HR_HR_STP_EMPTYPE_LIST_GET_REPORT"

        strParamName = "SEARCH|SORT"
        strParamValue = "Where Status='1'|"

        Try
            intErrNo = Objok.mtdGetDataCommon(strOpCd, strParamName, strParamValue, objDs)
        Catch Exp As System.Exception
        ...
        For intCnt = 0 To objDs.Tables(0).Rows.Count - 1
            ...
            If objDs.Tables(0).Rows(intCnt).Item("Description") = pv_strEmpType Then
                intSelectedIndex = intCnt + 1
            End If
        Next intCnt
        ...
        ddlemptype.DataBind()
        ddlemptype.SelectedIndex = intSelectedIndex - 1
    End Sub
End Class
