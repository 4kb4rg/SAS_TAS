...
Public Class NU_StdRpt_SeedReceiveList : Inherits Page
    ...
    Sub BindStatus()
        lstStatus.Items.Add(New ListItem(objNUTrx.mtdGetSeedReceiveStatus(objNUTrx.EnumSeedReceiveStatus.All), objNUTrx.EnumSeedReceiveStatus.All))
        lstStatus.Items.Add(New ListItem(objNUTrx.mtdGetSeedReceiveStatus(objNUTrx.EnumSeedReceiveStatus.Confirmed), objNUTrx.EnumSeedReceiveStatus.Confirmed))
        lstStatus.Items.Add(New ListItem(objNUTrx.mtdGetSeedReceiveStatus(objNUTrx.EnumSeedReceiveStatus.Deleted), objNUTrx.EnumSeedReceiveStatus.Deleted))
        lstStatus.Items.Add(New ListItem(objNUTrx.mtdGetSeedReceiveStatus(objNUTrx.EnumSeedReceiveStatus.Closed), objNUTrx.EnumSeedReceiveStatus.Closed))
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        If Not (strTxDateFrom = "" And strTxDateTo = "") Then
            If objGlobal.mtdValidInputDate(strDateSetting, strTxDateFrom, objDateFormat, objDateFrom) = True And objGlobal.mtdValidInputDate(strDateSetting, strTxDateTo, objDateFormat, objDateTo) = True Then
                Response.Write("<Script Language=""JavaScript"">window.open(""NU_StdRpt_SeedReceiveListPreview.aspx?Type=Print&CompName=" & strCompany & "&Location=" & strUserLoc & "&RptID=" & strRptID & _
