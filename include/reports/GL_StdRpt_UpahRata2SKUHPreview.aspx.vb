...
Public Class GL_StdRpt_UpahRata2SKUHPreview : Inherits Page
    ...
    Sub BindReport()
       ...
       strRptPrefix = "GL_StdRpt_UpahRata2SKUH"
       ...
       strOpCd = "GL_STDRPT_MR_UPAH_RATA_SKUH" & "|" & objGLRpt.mtdGetGLReportTable(objGLRpt.EnumGLReportTable.UpahRata2SKUH) & Chr(9) & _
        ...
        Try
            intErrNo = objGLRpt.mtdGetReport_UpahRata2SKUH(strOpCd, _
                                                            strCompany, _
                                                            strLocation, _
                                                            strUserId, _
                                                            strAccMonth, _
        ...
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=GL_STDRPT_UPAHRATA2SKUH&errmesg=" & Exp.ToString() & "&redirect=")
        End Try
