...
Public Class HR_StdRpt_Profile_Kary_Estate : Inherits Page
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        Response.Write("<Script Language=""JavaScript"">window.open(""HR_StdRpt_Profile_KaryPreview_Estate.aspx?CompCode=" & strCompany & "&Location=" & strUserLoc & "&RptID=" & strRptID & "&RptName=" & strRptName & "&Decimal=" & strDec & _
                       "&lblLocation=" & lblLocation.Text & _
					   "&ExportToExcel=" & strExportToExcel & _
					   "&Emptypecode=" & ddlEmpType.SelectedItem.Value.Trim() & _
