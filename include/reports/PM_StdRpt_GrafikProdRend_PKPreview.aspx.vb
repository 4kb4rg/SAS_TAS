...
Public Class PM_StdRpt_GrafikProdRend_PKPreview : Inherits Page
    ...
    Sub BindReport()
        ...
        Dim strOpCd As String = "WM_STDRPT_PRODUCTION_GRAFIK_PK_GET"
        ...
        Dim strFileName As String = "CRTEST"
        ...
        strParamName = "ACCYEAR|ACCMONTH|LOC|USRID"
        ...
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=WM_STDRPT_PRODUCTION_GRAFIK_PK_GET&errmesg=" & lblErrMessage.Text & "&redirect=")
        End Try

        rdCrystalViewer.Load(objMapPath & "web\" & strLangCode & "\reports\crystal\PM_StdRpt_GrafikProdRend_PK.rpt", OpenReportMethod.OpenReportByTempCopy)
        ...
        If strExportToExcel = "0" Then
            crDiskFileDestinationOptions.DiskFileName = objMapPath & "web\ftp\PM_StdRpt_GrafikProdRend_PK.pdf"
        Else
            crDiskFileDestinationOptions.DiskFileName = objMapPath & "web\ftp\PM_StdRpt_GrafikProdRend_PK.xls"
        End If
        ...
        If strExportToExcel = "0" Then
            Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../ftp/PM_StdRpt_GrafikProdRend_PK.pdf"">")
        Else
            Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../ftp/PM_StdRpt_GrafikProdRend_PK.xls"">")
        End If
    End Sub
