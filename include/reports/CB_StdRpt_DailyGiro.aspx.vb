...
Public Class CB_StdRpt_DailyGiro : Inherits Page
    ...
    Protected WithEvents txtGrpAmount As TextBox
    Protected WithEvents txtGrpAmountTo As TextBox

    Protected WithEvents txtTransIdFr As TextBox
    Protected WithEvents txtTransIdTo As TextBox
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        Dim dbGrpAmount As Double
        Dim dbGrpAmountTo As Double
        ...
        If txtGrpAmount.Text = "" Then
            txtGrpAmount.Text = "0"
        End If
        If txtGrpAmountTo.Text = "" Then
            txtGrpAmountTo.Text = "0"
        End If

        dbGrpAmount = Iif(txtGrpAmount.Text = "", 0, CDbl(txtGrpAmount.Text))
        dbGrpAmountTo = Iif(txtGrpAmountTo.Text = "", 0, CDbl(txtGrpAmountTo.Text))
        strExportToExcel = IIf(cbExcel.Checked = True, "1", "0")

        Response.Write("<Script Language=""JavaScript"">window.open(""CB_StdRpt_DailyGiroPreview.aspx?Type=Print&CompName=" & strCompany & _
                       "&RptID=" & strRptID & _
                       ...
                       "&GrpAmount=" & dbGrpAmount & _
                       "&GrpAmountTo=" & dbGrpAmountTo & _
                       "&transidFr=" & txtTransIdFr.Text & _
                       "&transidTo=" & txtTransIdTo.Text & _
