...
Public Class NU_StdRpt_SeedPlantList : Inherits Page
    ...
    Sub BindStatus()
        lstStatus.Items.Add(New ListItem(objNUTrx.mtdGetSeedPlantStatus(objNUTrx.EnumSeedPlantStatus.All), objNUTrx.EnumSeedPlantStatus.All))
        lstStatus.Items.Add(New ListItem(objNUTrx.mtdGetSeedPlantStatus(objNUTrx.EnumSeedPlantStatus.Confirmed), objNUTrx.EnumSeedPlantStatus.Confirmed))
        lstStatus.Items.Add(New ListItem(objNUTrx.mtdGetSeedPlantStatus(objNUTrx.EnumSeedPlantStatus.Deleted), objNUTrx.EnumSeedPlantStatus.Deleted))
        lstStatus.Items.Add(New ListItem(objNUTrx.mtdGetSeedPlantStatus(objNUTrx.EnumSeedPlantStatus.Closed), objNUTrx.EnumSeedPlantStatus.Closed))
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        If Not (strTxDateFrom = "" And strTxDateTo = "") Then
            If objGlobal.mtdValidInputDate(strDateSetting, strTxDateFrom, objDateFormat, objDateFrom) = True And objGlobal.mtdValidInputDate(strDateSetting, strTxDateTo, objDateFormat, objDateTo) = True Then
                Response.Write("<Script Language=""JavaScript"">window.open(""NU_StdRpt_SeedPlantListPreview.aspx?Type=Print&CompName=" & strCompany & "&Location=" & strUserLoc & "&RptID=" & strRptID & _
