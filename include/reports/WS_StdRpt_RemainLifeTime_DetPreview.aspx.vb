...
Public Class WS_StdRpt_RemainLifeTime_DetPreview : Inherits Page
    ...
    Sub BindReport()
        ...
        Dim strOpCdItem_GET As String = "WS_STDRPT_VEHICLE_PREVENTIVE_REMAINING_LIFITIME_GET"
        ...
        rdCrystalViewer.Load(objMapPath & "web\" & strLangCode & "\Reports\Crystal\WS_StdRpt_RemainLifeTime_Det.rpt", OpenReportMethod.OpenReportByTempCopy)
        ...
        crDiskFileDestinationOptions.DiskFileName = objMapPath & "web\ftp\WS_StdRpt_RemainLifeTime_Det.pdf"
        ...
        Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../ftp/WS_StdRpt_RemainLifeTime_Det.pdf"">")
    End Sub
