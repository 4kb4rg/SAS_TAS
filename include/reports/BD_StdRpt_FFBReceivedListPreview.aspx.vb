...
Public Class BD_StdRpt_FFBReceivedListPreview : inherits page
    ...
    Public Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        strParamStatus = objBD.mtdGetFFBReceiveStatus(strStatus)
        Bind_ITEM(TRUE)
    ...
    Sub Bind_ITEM(ByVal blnIsPDFFormat As Boolean)
        ...
        If NOT strUpdatedBy = "" Then
            strSearch = strSearch & " AND usr.Username like '" & strUpdatedBy & "' "
        End If
        
        If NOT strStatus = objBD.EnumFFBReceiveStatus.All Then
            strSearch = strSearch & " AND BD.Status = '" & strStatus & "'"
        End If
        
        strSortItem = "ORDER BY SupplierCode, AccYear, AccMonth"
        ...
        rdCrystalViewer.Load(objMapPath & "Web\" & strLangCode & "\Reports\Crystal\BD_StdRpt_FFBReceivedList.rpt", OpenReportMethod.OpenReportByTempCopy)
        ...
        Else
            ...
            DiskOpts.DiskFileName = objMapPath & "web\ftp\BD_StdRpt_FFBReceivedList.pdf"
            rdCrystalViewer.ExportOptions.DestinationOptions = DiskOpts
            rdCrystalViewer.Export()

            Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../ftp/BD_StdRpt_FFBReceivedList.pdf"">")
        End If
