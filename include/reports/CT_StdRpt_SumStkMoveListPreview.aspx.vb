...
Public Class CT_StdRpt_SumStkMoveList_Preview : Inherits Page
    ...
    Sub BindReport()
        ...
        Dim strOpCd As String = "CT_STDRPT_ITEMMOVESUM_ITEM_SP"
        ...
        strParam = strUserLoc & "|" & _
                    ...
                    strPOStatus
        Try
            intErrNo = objCTRpt.mtdGetReport_SumStkMoveListSP(strCompany, _
                                                              strLocation, _
                                                              strUserId, _
                                                              strAccMonth, _
                                                              strAccYear, _
        ...
        rdCrystalViewer.Load(objMapPath & "web\" & strLangCode & "\Reports\Crystal\CT_StdRpt_SumStkMoveList.rpt", OpenReportMethod.OpenReportByTempCopy)
        ...
        crDiskFileDestinationOptions.DiskFileName = objMapPath & "web\ftp\CT_StdRpt_SumStkMoveList.pdf"
        ...
        Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../ftp/CT_StdRpt_SumStkMoveList.pdf"">")
