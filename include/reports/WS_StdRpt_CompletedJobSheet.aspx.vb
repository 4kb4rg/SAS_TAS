...
Public Class WS_StdRpt_CompletedJobSheet : Inherits Page
    ...
    Protected WithEvents lblJobEndDateFromErr As Label
    Protected WithEvents lblJobEndDateToErr As Label
    ...
    Protected WithEvents txtJobEndDateFrom As TextBox
    Protected WithEvents txtJobEndDateTo As TextBox
    ...
    Protected WithEvents imgJobEndDateFrom As Image
    Protected WithEvents imgJobEndDateTo As Image
    ...
    Sub Page_Load(ByVal Sender As Object, ByVal E As EventArgs)
        ...
        Else
            ...
            lblJobEndDateFromErr.Visible = False
            lblJobEndDateToErr.Visible = False
    ...
    Function GetLanguageCaptionDS() As DataSet
        ...
        Catch ex As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=WS_STDRPT_COMPLETED_JOB_SHEET_GET_LANGCAP&errmesg=" & Server.UrlEncode(ex.Message) & "&redirect=WS/trx/WS_Trx_Job_List.aspx")
        End Try
    ...
    Sub ibPrintPreview_OnClick(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        Dim strJobEndDateFrom As String
        Dim strJobEndDateTo As String
        ...
        strJobEndDateFrom = Trim(txtJobEndDateFrom.Text)
        strJobEndDateTo = Trim(txtJobEndDateTo.Text)
        ...
        If strJobEndDateFrom <> "" Then
            strJobEndDateFrom = GetValidDate(strJobEndDateFrom, strErrMsg)
            If strJobEndDateFrom = "" Then
                lblJobEndDateFromErr.Text = strErrMsg
                lblJobEndDateFromErr.Visible = True
                blnErrMsg = True
            End If
        End If
        If strJobEndDateTo <> "" Then
            strJobEndDateTo = GetValidDate(strJobEndDateTo, strErrMsg)
            If strJobEndDateTo = "" Then
                lblJobEndDateToErr.Text = strErrMsg
                lblJobEndDateToErr.Visible = True
                blnErrMsg = True
            End If
        End If
        ...
        Response.Write("<Script Language=""JavaScript"">window.open(""WS_StdRpt_CompletedJobSheetPreview.aspx?CompName=" & strCompany & "&RptID=" & strRptID & "&RptName=" & strRptName & "&RptLocation=" & strRptLocation & "&RptAccMonth=" & strRptAccMonth & "&RptAccYear=" & strRptAccYear & "&Decimal=" & strDecimal & _
                        "&lblLocation=" & lblLocation.Text & "&lblWork=" & lblWork.Text & "&lblVehicle=" & lblVehicle.Text & "&lblBillParty=" & lblBillParty.Text & _
                        "&JobIDFrom=" & strJobIDFrom & "&JobIDTo=" & strJobIDTo & _
                        "&JobStartDateFrom=" & strJobStartDateFrom & "&JobStartDateTo=" & strJobStartDateTo & _
                        "&JobEndDateFrom=" & strJobEndDateFrom & "&JobEndDateTo=" & strJobEndDateTo & _
