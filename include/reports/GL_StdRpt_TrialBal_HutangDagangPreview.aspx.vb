...
Public Class GL_StdRpt_TrialBal_HutangDagangPreview : Inherits Page
    ...
    Sub Page_Load(ByVal Sender As Object, ByVal E As EventArgs)
        ...
        Else
            ...
            Else
				...
				strSelLocation = strSelLocation.Replace("','", "'',''")
            End If
    ...
    Sub BindReport()
        ...
        Dim strOpCode As String = "GL_STDRPT_TRIALBAL_HUTANGDAGANG_GET"
        Dim strFileName As String = "GL_StdRpt_TrialBal_HutangDagang_Get"
        ...
        Try
            ...
            objRptDs.Tables(0).TableName = "GL_StdRpt_TrialBal_HutangDagang_Summary"
            objRptDs.Tables(1).TableName = "GL_StdRpt_TrialBal_HutangDagang_SaldoAwal"
            objRptDs.Tables(1).TableName = "GL_StdRpt_TrialBal_HutangDagang_Trx"
            objRptDs.Tables(1).TableName = "GL_StdRpt_TrialBal_HutangDagang_SaldoAkhir"
            objRptDs.Tables(1).TableName = "GL_StdRpt_TrialBal_HutangDagang_SummarySaldo"
            objRptDs.Tables(1).TableName = "GL_StdRpt_TrialBal_HutangDagang_SummarySaldoSupplier"
        ...
        objRptDs1.Tables(0).TableName = "GL_StdRpt_TrialBal_HutangDagang_Summary"
        objRptDs1.Tables.Add(objRptDs.Tables(1).Copy())
        objRptDs1.Tables(1).TableName = "GL_StdRpt_TrialBal_HutangDagang_SaldoAwal"
        objRptDs1.Tables.Add(objRptDs.Tables(2).Copy())
        objRptDs1.Tables(2).TableName = "GL_StdRpt_TrialBal_HutangDagang_Trx"
        objRptDs1.Tables.Add(objRptDs.Tables(3).Copy())
        objRptDs1.Tables(3).TableName = "GL_StdRpt_TrialBal_HutangDagang_SaldoAkhir"
        objRptDs1.Tables.Add(objRptDs.Tables(4).Copy())
        objRptDs1.Tables(4).TableName = "GL_StdRpt_TrialBal_HutangDagang_SummarySaldo"
        objRptDs1.Tables.Add(objRptDs.Tables(5).Copy())
        objRptDs1.Tables(5).TableName = "GL_StdRpt_TrialBal_HutangDagang_SummarySaldoSupplier"
