...
Public Class GL_StdRpt_GeneralLedgerTrxListing : Inherits Page
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        Dim enStrTrxIDFrom As string
        Dim enStrTrxIDTo As String
        ...
        strSrchTrxIDFrom = Trim(txtSrchTrxIDFrom.text)
        strSrchTrxIDTo = Trim(txtSrchTrxIDTo.text)
        ...
        enStrTrxIDFrom = Server.UrlEncode(strSrchTrxIDFrom)
        enStrTrxIDTo = Server.UrlEncode(strSrchTrxIDTo)
        ...
        Response.Write("<Script Language=""JavaScript"">window.open(""GL_StdRpt_GeneralLedgerTrxListingPreview.aspx?Type=Print&CompName=" & strCompany & _
                       ...
                       "&SrchTrxIDFrom=" & enStrTrxIDFrom & _
                       "&SrchTrxIDTo=" & enStrTrxIDTo & _
