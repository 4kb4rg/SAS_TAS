...
Public Class CB_StdRpt_ListOfBank : Inherits Page
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        Response.Write("<Script Language=""JavaScript"">window.open(""CB_StdRpt_ListOfBankPreview.aspx?Type=Print&CompName=" & strCompany & _
                       "&RptID=" & strRptID & _
