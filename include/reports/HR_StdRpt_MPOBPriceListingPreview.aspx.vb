...
Public Class HR_StdRpt_MPOBPriceListingPreview : Inherits Page
    ...
    Sub BindReport()
        ...
        Dim strOpCdMPOBPriceListGet As String = "HR_STDRPT_MPOBPRICELIST_GET"
        ...
        Try
            intErrNo = objHRReport.mtdGetReport_HRGeneral(strOpCdMPOBPriceListGet, strParam, objRptDs, objMapPath)
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=GET_MPOB_PRICE_LIST_REPORT&errmesg=" & lblErrMessage.Text & "&redirect=")
        End Try

        rdCrystalViewer.Load(objMapPath & "web\" & strLangCode & "\Reports\Crystal\HR_StdRpt_MPOBPriceListing.rpt", OpenReportMethod.OpenReportByTempCopy)
        ...
        crDiskFileDestinationOptions.DiskFileName = objMapPath & "web\ftp\HR_StdRpt_MPOBPriceListing.pdf"
        ...
        Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../ftp/HR_StdRpt_MPOBPriceListing.pdf"">")
    End Sub
