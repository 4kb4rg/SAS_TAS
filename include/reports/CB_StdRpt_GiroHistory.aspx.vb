...
Public Class CB_StdRpt_GiroHistory : Inherits Page
    ...
    Protected WithEvents cbUsed As CheckBox
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        strUsed = IIf(cbUsed.Checked = True, "1", "0")

        Response.Write("<Script Language=""JavaScript"">window.open(""CB_StdRpt_GiroHistoryPreview.aspx?Type=Print&CompName=" & strCompany & _
                       "&RptID=" & strRptID & _
                       ...
                       "&DocType=" & ddlDocType.SelectedItem.Value & _
