...
Public Class GL_StdRpt_DistribusiPemakaianPreview : Inherits Page
    ...
    Sub Page_Load(ByVal Sender As Object, ByVal E As EventArgs)
        ...
        Else
            ...
            strSelRemark = Trim(Request.QueryString("Remark"))
    ...
    Sub PassParam()
        ...
        ParamDiscreteValue5.Value = strLocTag
    ...
    Sub BindSummReport()
        ...
        Try
            strRptPrefix = "GL_StdRpt_DistribusiPemakaian"

            strOpCd = "GL_STDRPT_PUPUK_PESTISIDA_DAN_KACANGAN" & "|" & objGLRpt.mtdGetGLReportTable(objGLRpt.EnumGLReportTable.DistribusiPemakaian) & Chr(9) & _
            ...
            intErrNo = objGLRpt.mtdGetReport_DistribusiPemakaian(strOpCd, _
                                                    strCompany, _
                                                    strLocation, _
                                                    strUserId, _
                                                    strAccMonth, _
