...
Public Class CT_StdRpt_SumStkMoveList : Inherits Page
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        Response.Write("<Script Language=""JavaScript"">window.open(""CT_StdRpt_SumStkMoveListPreview.aspx?Location=" & strUserLoc & _
                       "&RptID=" & strRptID & _
