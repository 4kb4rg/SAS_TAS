...
Public Class GL_StdRpt_MthEndTrxSummaryPreview : Inherits Page
    ...
    Dim strSelModule As String
    Dim strSelDetail As String    
    ...
    Sub Page_Load(ByVal Sender As Object, ByVal E As EventArgs)
        ...
        Else
            ...
            strSelModule = Trim(Request.QueryString("ModuleCode"))
            strSelDetail = Trim(Request.QueryString("InDetail"))
    ...
    Sub BindReport()
        ...
        Dim strRptPrefixPay As String
        Dim intCnt As Integer
        Dim objFTPFolder As String

        If LCase(strSelDetail) = "yes" Then
            strRptPrefix = "GL_StdRpt_MthEndTrxDet"
            strRptPrefixPay = "GL_StdRpt_MthEndTrxDetPayRoll"
            strOpCode = "GL_STDRPT_MTHENDTRXDET_GET_SP" & "|" & "GL_MTHENDTRX" & _
                        Chr(9) & "GET_REPORT_INFO_BY_REPORTID" & "|" & "SH_REPORT"
        Else
            strRptPrefix = "GL_StdRpt_MthEndTrxSum"
            strRptPrefixPay = "GL_StdRpt_MthEndTrxSumPayRoll"
            strOpCode = "GL_STDRPT_MTHENDTRX_GET_SP" & "|" & "GL_MTHENDTRX" & _
                        Chr(9) & "GET_REPORT_INFO_BY_REPORTID" & "|" & "SH_REPORT"
        ...
        Try
            ...
            intErrNo = objGLRpt.mtdGetReport_MthEndTrx(strOpCode, _
                                                       strCompany, _
                                                       strLocation, _
                                                       strUserId, _
                                                       strAccMonth, _
        ...
        If strSelModule <> objGlobal.EnumModule.Payroll Then
            rdCrystalViewer.Load(objMapPath & "web\" & strLangCode & "\Reports\Crystal\" & strRptPrefix & ".rpt", OpenReportMethod.OpenReportByTempCopy)
        Else
            rdCrystalViewer.Load(objMapPath & "web\" & strLangCode & "\Reports\Crystal\" & strRptPrefixPay & ".rpt", OpenReportMethod.OpenReportByTempCopy)
        End If
        ...
        For Each myTable In rdCrystalViewer.Database.Tables
            ...
            If myTable.Name = "GL_MTHENDTRX" Then
                ...
                If LCase(strSelDetail) = "yes"
                    myTable.Location = myLogin.ConnectionInfo.DatabaseName & ".dbo.GL_MONTHACCDIST_DET_RPT"
                else
                    myTable.Location = myLogin.ConnectionInfo.DatabaseName & ".dbo.GL_MONTHACCDIST_SUM_RPT"
                end if
        ...
        Else
            'crDiskFileDestinationOptions.DiskFileName = objMapPath & "web\ftp\" & strRptPrefixPay & ".pdf"
            crDiskFileDestinationOptions.DiskFileName = objFTPFolder & strRptPrefixPay & ".pdf"
        End If
        ...
        Else
            'Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../ftp/" & strRptPrefixPay & ".pdf"">")
            Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../" & strUrl & strRptPrefixPay & ".pdf"">")
        End If
    End Sub
    ...
    Sub PassParam()
        ...
        ParamDiscreteValue25.Value = objGlobal.mtdGetModuleName(CInt(strSelModule))
        ParamDiscreteValue26.Value = strSelDetail
        ParamDiscreteValue27.Value = strRptId
        ParamDiscreteValue28.Value = strRptName
        ...
        ParamFieldDef25 = ParamFieldDefs.Item("SelModule")
        ParamFieldDef26 = ParamFieldDefs.Item("SelDetail")
        ParamFieldDef27 = ParamFieldDefs.Item("RptId")
        ParamFieldDef28 = ParamFieldDefs.Item("RptName")
    ...
    Sub GetEntireLangCap()
        ...
        Try
            intErrNo = objLangCap.mtdGetBussTerm(strOpCode_BussTerm, _
                                                 ...
                                                 strParam)
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=GL_STDRPT_MTHENDTRX_GET_LANGCAP&errmesg=" & Exp.ToString() & "&redirect=")
        End Try
