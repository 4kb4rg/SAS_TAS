...
Public Class GL_StdRpt_StokPupukPreview : Inherits Page
    ...
    Dim strSelProdModel As String
    Dim strSelAct As String
    Dim strSelActTo As String
    Dim strSelSubAct As String
    Dim strSelSubActTo As String
    ...
    Sub Page_Load(ByVal Sender As Object, ByVal E As EventArgs)
        ...
        Else
            ...
            strSelProdModel = Trim(Request.QueryString("SelProdModel"))
            strSelAct = Trim(Request.QueryString("SelAct"))
            strSelActTo = Trim(Request.QueryString("SelActTo"))
            strSelSubAct = Trim(Request.QueryString("SelSubAct"))
            strSelSubActTo = Trim(Request.QueryString("SelSubActTo"))
    ...
    Sub GetEntireLangCap()
        ...
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=GL_STDRPT_STOKPUPUK_GET_LANGCAP&errmesg=" & Exp.ToString() & "&redirect=")
        End Try
    ...
    Sub BindSummReport()
        ...
        Try
            strRptPrefix = "GL_StdRpt_StokPupuk"

            strOpCd = "GL_STDRPT_STOKPUPUK_GET_SP" & "|" & objGLRpt.mtdGetGLReportTable(objGLRpt.EnumGLReportTable.StokPupuk) & Chr(9) & _
            ...
            intErrNo = objGLRpt.mtdGetReport_StokPupuk(strOpCd, _
                                                    strCompany, _
                                                    strLocation, _
                                                    strUserId, _
                                                    strAccMonth, _
        ...
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=GL_STDRPT_STOKPUPUK_GET_SP&errmesg=" & Exp.ToString() & "&redirect=")
        End Try
        ...
        For Each myTable In rdCrystalViewer.Database.Tables
            ...
            If myTable.Name = "GL_STOKPUPUK" Then
                myLogin = myTable.LogOnInfo
                Try
                    intErrNo = objGLRpt.mtdGet_DBConnObj(myLogin)
                Catch Exp As System.Exception
                    Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=GL_STOKPUPUK_RPT_GET&errmesg=" & Exp.ToString() & "&redirect=")
                End Try

                myTable.ApplyLogOnInfo(myLogin)
                myTable.Location = myLogin.ConnectionInfo.DatabaseName & ".dbo.GL_STOKPUPUK_RPT"
            End If
