...
Public Class PR_StdRpt_DailyAllowanceTransPreview : Inherits Page
    ...
    Sub BindReport()
        ...
        Try
            strRptPrefix = "PR_StdRpt_DailyAllowanceTrans"
            
            strOpCd = "PR_STDRPT_ATTDLIST_SP" & "|" & objPRRpt.mtdGetPRReportTable(objPRRpt.EnumPRReportTable.DailyAllowTrans) & Chr(9) & _
            ...
            intErrNo = objPRRpt.mtdGetReport_DailyAllowTrans_SP(strOpCd, _
                                                                strCompany, _
                                                                strLocation, _
                                                                strUserId, _
                                                                strAccMonth, _
        ...
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=PR_STDRPT_DAILYALLOWANCETRANS_GET&errmesg=" & Exp.ToString() & "&redirect=")
        End Try
        ...
        For Each myTable In rdCrystalViewer.Database.Tables
            ...
            If myTable.Name = "PR_DAILYALLOWANCETRANS" Then
                myLogin = myTable.LogOnInfo
                Try
                    intErrNo = objGLRpt.mtdGet_DBConnObj(myLogin)
                Catch Exp As System.Exception
                    Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=PR_STDRPT_DAILYALLOWANCETRANS_PREVIEW&errmesg=" & Exp.ToString() & "&redirect=")
                End Try
                myTable.ApplyLogOnInfo(myLogin)
                myTable.Location = myLogin.ConnectionInfo.DatabaseName & ".dbo.PR_DAILYATTDTRANS_RPT"
    ...
    Sub PassParam()
        ...
        ParamDiscreteValue8.Value = strSelLocTag
        ParamDiscreteValue9.Value = strLocTag
        ParamDiscreteValue10.Value = strVehCodeTag
        ParamDiscreteValue11.Value = strVehExpCodeTag

        If LCase(strBlkType) = "subblkcode" Then
            ParamDiscreteValue12.Value = strSubBlkCodeTag
        Else
            ParamDiscreteValue12.Value = strBlkCodeTag
        End If

        ParamDiscreteValue13.Value = strAccCodeTag
        ParamDiscreteValue14.Value = strFromEmp
        ParamDiscreteValue15.Value = strToEmp
        ParamDiscreteValue16.Value = strEmpStatusText

        ParamDiscreteValue17.Value = UCase(strAccCodeTag)
        If LCase(strBlkType) = "blkcode" Then
            ParamDiscreteValue18.Value = UCase(strBlkCodeTag)
        ElseIf LCase(strBlkType) = "blkgrp" Then
            ParamDiscreteValue18.Value = UCase(strBlkGrpCodeTag)
        Else
            ParamDiscreteValue18.Value = UCase(strSubBlkCodeTag)
        End If
        ParamDiscreteValue19.Value = UCase(strVehCodeTag)
        ParamDiscreteValue20.Value = UCase(strVehExpCodeTag)
        ...
        ParamDiscreteValue25.Value = strReportID
        ParamDiscreteValue26.Value = strRptTitle
        ParamDiscreteValue27.Value = strGangCode
        ParamDiscreteValue28.Value = strDocNoFrom
        ParamDiscreteValue29.Value = strDocNoTo
        ParamDiscreteValue30.Value = IIf(Session("SS_INTER_ESTATE_CHARGING"), "true", "false")
        ParamDiscreteValue31.Value = strUserID
        ...
        ParamFieldDef16 = ParamFieldDefs.Item("SrchStatus")
        ...
        ParamFieldDef25 = ParamFieldDefs.Item("ReportID")
        ParamFieldDef26 = ParamFieldDefs.Item("RptTitle")
        ParamFieldDef27 = ParamFieldDefs.Item("SrchGangCode")
        ParamFieldDef28 = ParamFieldDefs.Item("ParamDocNoFrom")
        ParamFieldDef29 = ParamFieldDefs.Item("ParamDocNoTo")
        ParamFieldDef30 = ParamFieldDefs.Item("ParamInterEstateEnabled")
        ParamFieldDef31 = ParamFieldDefs.Item("UserID")
