...
Public Class PU_StdRpt_LastItemPricePreview : Inherits Page
    ...
    Sub Page_Load(ByVal Sender As Object, ByVal E As EventArgs)
        ...
        strItem = Trim(Request.QueryString("itemCode"))
        strPT = Trim(Request.QueryString("PT"))
    ...
    Sub BindReport()
        ...
        Dim strOpCode As String = "PU_STDRPT_LASTITEMPRICE_GET"
        Dim strFileName As String = "PU_StdRpt_LastItemPrice_Report"
        ...
        'strParamValue = "where x.itemcode like '%" & replace(strItem, "'", "''") & "%' And x.PT like '%" & replace(strPT, "'", "''") & _
        '                "%'  and year(x.createdate) = '" & Trim(strDDLAccYr) & "'"
        ...
        strParamName = "PYEAR|ITEM|CMPY"
        strParamValue = Trim(strDDLAccYr) & _
                            "|" & Replace(strItem, "'", "''") & _
                            "|" & Replace(strPT, "'", "''")
        Try
        ...
        If strExportToExcel = "0" Then
            crDiskFileDestinationOptions.DiskFileName = objFTPFolder & strFileName & ".pdf" 'bjMapPath & "web\ftp\" & strFileName & ".pdf"
        Else
            crDiskFileDestinationOptions.DiskFileName = objFTPFolder & strFileName & ".xls" 'bjMapPath & "web\ftp\" & strFileName & ".pdf"
        End If
