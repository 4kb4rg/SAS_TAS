...
Public Class WM_StdRpt_PKBillRpt : Inherits Page
    ...
    Sub GetEntireLangCap()
        ...
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=WM_STDRPT_PK_BILLING_RPT_CLSLANGCAP_BUSSTERM_GET&errmesg=" & lblErrMessage.Text & "&redirect=../en/reports/WM_StdRpt_Selection.aspx")
        End Try
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        If Not (strDelDateFrom = "" And strDelDateTo = "") Then
            If objGlobal.mtdValidInputDate(strDateFormat, strDelDateFrom, objDateFormat, objDateFrom) = True And objGlobal.mtdValidInputDate(strDateFormat, strDelDateTo, objDateFormat, objDateTo) = True Then
                Response.Write("<Script Language=""JavaScript"">window.open(""WM_StdRpt_PK_Billing_RptPreview.aspx?Type=Print&CompName=" & strCompany & "&Location=" & strUserLoc & "&RptID=" & strRptID & "&RptName=" & strRptName & _
