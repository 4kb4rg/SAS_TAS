...
Public Class CB_StdRpt_PosisiDepositoPreview : Inherits Page
    ...
    Sub Page_Load(ByVal Sender As Object, ByVal E As EventArgs)
        ...
        intType = Request.QueryString("RType")
        strCOACode = Trim(Request.QueryString("COACode"))
    ...
    Sub BindReport()
        ...
        Dim strOpCode As String = "CB_STDRPT_POSISIDEPOSITO_GET"
        Dim strParam As String
        Dim strFileName  As String
        Dim objFTPFolder As String

        If intType = "0" then
            strFileName = "CB_StdRpt_PosisiDepositoByBank"
        else
            strFileName = "CB_StdRpt_PosisiDepositoByDate"
        end if 

        strParam = strDateTo & "|" &  strDateFrom 

        
        Try
            intErrNo = objCB.mtdGetReport_PosisiDeposito(strOpCode, strParam, objRptDs, objMapPath, objFTPFolder)
        Catch Exp As Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=CB_StdRpt_PosisiDepositoPreview&errmesg=" & lblErrMessage.Text & "&redirect=")
        End Try
    ...
    Sub PassParam()
        ...
        ParamDiscreteValue9.Value = intType
        ParamDiscreteValue10.Value = strCOACode
        ...
        ParamFieldDef9 = ParamFieldDefs.Item("ParamType")
        ParamFieldDef10 = ParamFieldDefs.Item("ParamCOACode")        
