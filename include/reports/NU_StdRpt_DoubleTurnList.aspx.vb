...
Public Class NU_StdRpt_DoubleTurnList : Inherits Page
    ...
    Sub BindStatus()
        lstStatus.Items.Add(New ListItem(objNUTrx.mtdGetDoubleTurnStatus(objNUTrx.EnumDoubleTurnStatus.All), objNUTrx.EnumDoubleTurnStatus.All))
        lstStatus.Items.Add(New ListItem(objNUTrx.mtdGetDoubleTurnStatus(objNUTrx.EnumDoubleTurnStatus.Confirmed), objNUTrx.EnumDoubleTurnStatus.Confirmed))
        lstStatus.Items.Add(New ListItem(objNUTrx.mtdGetDoubleTurnStatus(objNUTrx.EnumDoubleTurnStatus.Deleted), objNUTrx.EnumDoubleTurnStatus.Deleted))
        lstStatus.Items.Add(New ListItem(objNUTrx.mtdGetDoubleTurnStatus(objNUTrx.EnumDoubleTurnStatus.Closed), objNUTrx.EnumDoubleTurnStatus.Closed))
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        If Not (strTxDateFrom = "" And strTxDateTo = "") Then
            If objGlobal.mtdValidInputDate(strDateSetting, strTxDateFrom, objDateFormat, objDateFrom) = True And objGlobal.mtdValidInputDate(strDateSetting, strTxDateTo, objDateFormat, objDateTo) = True Then
                Response.Write("<Script Language=""JavaScript"">window.open(""NU_StdRpt_DoubleTurnListPreview.aspx?Type=Print&CompName=" & strCompany & "&Location=" & strUserLoc & "&RptID=" & strRptID & _
