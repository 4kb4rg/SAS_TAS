...
Public Class CB_StdRpt_InterestAdjListing_Preview : Inherits Page
    ...
    Sub Page_Load(ByVal Sender As Object, ByVal E As EventArgs)
        ...
        strFileName = "CB_StdRpt_InterestAdjListing"
        ...
        Session("SS_InterestCodeFrom") = Request.QueryString("txtInterestCodeFrom")
        Session("SS_InterestCodeTo") = Request.QueryString("txtInterestCodeTo")
    ...
    Sub BindReport()
        ...
        Dim strOpCode As String = "CB_STDRPT_INTERESTADJLISTING_GET"
        ...
        If Not (Request.QueryString("txtInterestCodeFrom") = "" And Request.QueryString("txtInterestCodeTo") = "") Then SearchStr = SearchStr & " AND ADJ.InterestCode >= '" & Replace(Request.QueryString("txtInterestCodeFrom"), "'", "''") & "' AND  ADJ.InterestCode <= '" & Replace(Request.QueryString("txtInterestCodeTo"), "'", "''") & "'"
        If Not Request.QueryString("txtDescription") = "" Then SearchStr = SearchStr & " AND ADJ.Description LIKE '%" & Replace(Request.QueryString("txtDescription"), "'", "''") & "%' "
        If Not Request.QueryString("txtBankCode") = "" Then SearchStr = SearchStr & " AND DEP.BankCode = '" & Request.QueryString("txtBankCode") & "' "
        If Not Request.QueryString("txtStatus") = "0" Then SearchStr = SearchStr & " AND ADJ.Status = '" & Request.QueryString("txtStatus") & "' "

        strParam = strUserLoc & "|" & strDDLAccMth & "|" & strDDLAccYr & "|" & strStatus & "|" & SearchStr
        Try
            intErrNo = objCB.mtdGetReport_InterestAdjListing(strOpCode, strParam, objRptDs, objMapPath, objFTPFolder)
        Catch Exp As Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=CB_StdRpt_InterestAdjListing&errmesg=" & lblErrMessage.Text & "&redirect=")
        End Try
    ...
    Sub PassParam()
        ...
        paramField10 = paramFields.Item("ParamInterestCodeFrom")
        paramField11 = paramFields.Item("ParamInterestCodeTo")
        ...
        ParamDiscreteValue10.Value = Session("SS_InterestCodeFrom")
        ParamDiscreteValue11.Value = Session("SS_InterestCodeTo")
