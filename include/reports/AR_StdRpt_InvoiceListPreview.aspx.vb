...
Public Class AR_StdRpt_InvoiceList_Preview : Inherits Page
    ...
    Sub Page_Load(ByVal Sender As Object, ByVal E As EventArgs)
        ...
        strFileName = "AR_StdRpt_InvoiceListing"
        ...
        Session("SS_InvoiceType") = Request.QueryString("InvoiceType")
    ...
    Sub BindReport()
        ...
        Dim strOpCd_InvoiceList_GET As String = "AR_STDRPT_INVOICE_LIST"
        Dim SearchStr As String
        Dim SQLStr As String

        Dim intCnt As Integer

                If Not (Request.QueryString("InvNoFrom") = "" AND Request.QueryString("InvNoTo") = "") Then SearchStr = " AND INV.InvoiceID >='" & Request.QueryString("InvNoFrom") & "' AND INV.InvoiceID <='" & Request.QueryString("InvNoTo") & "'"
        If Not Request.QueryString("BillParty") = "" Then SearchStr = " AND INV.BillPartyCode LIKE '" & Request.QueryString("BillParty") & "' "

        If Not Request.QueryString("InvoiceType") = "0" Then SearchStr = " AND INV.DocType LIKE '" & Request.QueryString("InvoiceType") & "' "
        If Not Request.QueryString("CustomerRef") = "" Then SearchStr = " AND INV.CustRef LIKE '" & Request.QueryString("CustomerRef") & "' "
        If Not Request.QueryString("DeliveryRef") = "" Then SearchStr = " AND INV.DeliveryRef LIKE '" & Request.QueryString("DeliveryRef") & "' "
        If Not Request.QueryString("COA") = "" Then SearchStr = " AND INVLN.AccCode LIKE '" & Request.QueryString("COA") & "' "
        If Not Request.QueryString("BlkCode") = "" Then SearchStr = " AND INVLN.BlkCode LIKE '" & Request.QueryString("BlkCode") & "' "
        If Not Request.QueryString("Vehicle") = "" Then SearchStr = " AND INVLN.VehCode LIKE '" & Request.QueryString("Vehicle") & "' "
        If Not Request.QueryString("VehicleExpCode") = "" Then SearchStr = " AND INVLN.VehExpenseCode LIKE '" & Request.QueryString("VehicleExpCode") & "' "
        If Not Request.QueryString("ItemDesc") = "" Then SearchStr = " AND INVLN.Description LIKE '" & Request.QueryString("ItemDesc") & "' "
        If Not Request.QueryString("Status") = "0" Then SearchStr = " AND INV.Status LIKE '" & Request.QueryString("Status") & "' "


        strParam =  strUserLoc & "|" & strDDLAccMth & "|" & strDDLAccYr & "|"  & strStatus & "|" & SearchStr
        Try
            intErrNo = objAR.mtdGetReport_InvoiceList(strOpCd_InvoiceList_GET, strParam, objRptDs, objMapPath)
...
Sub PassParam()
        ...
        paramField30 = paramFields.Item("ParamInvoiceType")
        ...
        ParamDiscreteValue20.Value = trim(Session("SS_LBLSUBBLKCODE"))
        ParamDiscreteValue21.Value = trim(Session("SS_ITEMCODE"))
        ...
        ParamDiscreteValue30.Value = Session("SS_InvoiceType")
