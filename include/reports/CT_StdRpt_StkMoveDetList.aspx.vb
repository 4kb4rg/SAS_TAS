...
Public Class CT_StdRpt_StkMoveDetList : Inherits Page
    ...
    Sub BindTransTypeList()
        ...
        lstTransType.Items.Add(New ListItem(objGlobal.mtdGetDocPrefix(objGlobal.EnumDocType.CanteenTransfer) & " (" & objGlobal.mtdGetDocName(objGlobal.EnumDocType.CanteenTransfer) & ")", objGlobal.EnumDocType.CanteenTransfer))
        lstTransType.Items.Add(New ListItem(objGlobal.mtdGetDocPrefix(objGlobal.EnumDocType.CanteenAdjust) & " (" & objGlobal.mtdGetDocName(objGlobal.EnumDocType.CanteenAdjust) & ")", objGlobal.EnumDocType.CanteenAdjust))
        lstTransType.Items.Add(New ListItem(objGlobal.mtdGetDocPrefix(objGlobal.EnumDocType.CanteenIssue) & " (" & objGlobal.mtdGetDocName(objGlobal.EnumDocType.CanteenIssue) & ")", objGlobal.EnumDocType.CanteenIssue))
        lstTransType.Items.Add(New ListItem(objGlobal.mtdGetDocPrefix(objGlobal.EnumDocType.CTCanteenReceive) & " (" & objGlobal.mtdGetDocName(objGlobal.EnumDocType.CTCanteenReceive) & ")", objGlobal.EnumDocType.CTCanteenReceive))
        lstTransType.Items.Add(New ListItem(objGlobal.mtdGetDocPrefix(objGlobal.EnumDocType.CanteenReturnAdvice) & " (" & objGlobal.mtdGetDocName(objGlobal.EnumDocType.CanteenReturnAdvice) & ")", objGlobal.EnumDocType.CanteenReturnAdvice))
        lstTransType.Items.Add(New ListItem(objGlobal.mtdGetDocPrefix(objGlobal.EnumDocType.CanteenReturn) & " (" & objGlobal.mtdGetDocName(objGlobal.EnumDocType.CanteenReturn) & ")", objGlobal.EnumDocType.CanteenReturn))
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        Response.Write("<Script Language=""JavaScript"">window.open(""CT_StdRpt_StkMoveDetListPreview.aspx?Location=" & strUserLoc & _
                       "&RptID=" & strRptID & _
