...
Public Class CB_StdRpt_MutasiBank : Inherits Page
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        intType = ddlType.SelectedItem.Value
        ...
        Response.Write("<Script Language=""JavaScript"">window.open(""CB_StdRpt_MutasiBankPreview.aspx?Type=Print&CompName=" & strCompany & _
                       "&RptID=" & strRptID & _
