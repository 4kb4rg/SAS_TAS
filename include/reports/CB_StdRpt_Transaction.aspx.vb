...
Public Class CB_StdRpt_Transaction : Inherits Page
    ...
    Sub Page_Load(ByVal Sender As Object, ByVal E As EventArgs)
        ...
        Else
            ...
            If Not Page.IsPostBack Then
                ...
                txtDate.Text = objGlobal.GetShortDate(strDateFmt, dateAdd("d", -1, Now()))
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        Response.Write("<Script Language=""JavaScript"">window.open(""CB_StdRpt_TransactionPreview.aspx?Type=Print&CompName=" & strCompany & _
                       "&RptID=" & strRptID & _
