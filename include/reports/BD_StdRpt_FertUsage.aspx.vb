...
Public Class BD_StdRpt_FertUsage : Inherits Page
    ...
    Sub BindPlantYr()
        Dim strOppCd_PlantYr_GET As String = "BD_STDRPT_MANURINGUSG_PLANTYR_GET"
        Dim objRptDsPlantYr As New DataSet()
        Dim objMapPath As String
        Dim intCnt As Integer

        strParam = GetActivePeriod("") & "||AND LocCode = '" & strLocation & "'"
        Try
            intErrNo = objBD.mtdGetReport_FertUsage(strOppCd_PlantYr_GET, strParam, objRptDsPlantYr, objMapPath)
        Catch Exp As System.Exception
            Response.Redirect("../../../include/mesg/ErrorMessage.aspx?errcode=BD_STDRPT_FERTUSAGE_GET&errmesg=" & lblErrMessage.Text & "&redirect=../en/reports/BD_StdRpt_Selection.aspx")
        End Try
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        Response.Write("<Script Language=""JavaScript"">window.open(""BD_StdRpt_FertUsagePreview.aspx?DDLPeriodID=" & strddlPeriodID & "&DDLPeriodName=" & strddlPeriodName & _
