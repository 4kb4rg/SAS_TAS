...
Public Class PM_StdRpt_DailyOilLossPreview : Inherits Page
    ...
    Sub BindReport()
        ...
        If Not (strMachine = "All") Then
            SearchStr = SearchStr & " AND OL.MachineCode='" & strMachine & "'"
        End If
        ...
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=GET_PM_DailyOilLoss_GET_LIST_REPORT&errmesg=" & lblErrMessage.Text & "&redirect=")
        End Try
