...
Public Class CT_StdRpt_StkSummaryList_Preview : Inherits Page
    ...
    Sub BindReport()
        ...
        Dim strOpCd As String = "CT_STDRPT_ITEMSUMMARY_SP"
        Dim objMapPath As String
        Dim SearchStr As String = ""
        Dim PRSearchStr As String = ""
        ...
        If Not Request.QueryString("ProdBrand") = "" Then
            SearchStr = SearchStr & "ITM.ProdBrandCode LIKE '" & Request.QueryString("ProdBrand") & "' "
        End If

        If Not Request.QueryString("ProdModel") = "" Then
            SearchStr = SearchStr & "ITM.ProdModelCode LIKE '" & Request.QueryString("ProdModel") & "'D "
        End If

        If Not Request.QueryString("ProdCat") = "" Then
            SearchStr = SearchStr & "ITM.ProdCatCode LIKE '" & Request.QueryString("ProdCat") & "' "
        End If

        If Not Request.QueryString("ProdMat") = "" Then
            SearchStr = SearchStr & "ITM.ProdMatCode LIKE '" & Request.QueryString("ProdMat") & "' "
        End If

        If Not Request.QueryString("StkAna") = "" Then
            SearchStr = SearchStr & "ITM.StockAnalysisCode LIKE '" & Request.QueryString("StkAna") & "' "
        End If

        If Not Request.QueryString("ItemCode") = "" Then
            SearchStr = "AND ITM.ItemCode LIKE '" & Request.QueryString("ItemCode") & "' "
        End If

        If Not Request.QueryString("ItemStatus") = Convert.ToString(objCTSetup.EnumStockItemStatus.All) Then
        ...
        If Request.QueryString("OrderBy") = "Bin" Then
            strOrderBy = "ITM.Bin"
        Else
            strOrderBy = "ITM.ItemCode"
        End If

        strPRStatus = Convert.ToString(objCTTrx.EnumPurReqStatus.Confirmed)
        PRSearchStr = "AND HD.PRType = '" & Convert.ToString(objCTTrx.EnumPurReqDocType.CanteenPR) & "'"
        ...
        strParam = strUserLoc & "|" & _
                    ...
                    PRSearchStr
        Try
            intErrNo = objCTRpt.mtdGetReport_ItemSummaryListSP(strCompany, _
                                                               strLocation, _
                                                               strUserId, _
                                                               strAccMonth, _
                                                               strAccYear, _
        ...
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=CT_GET_ITEM_SUMMARY_LIST_REPORT&errmesg=" & Exp.ToString & "&redirect=")
        End Try


        rdCrystalViewer.Load(objMapPath & "web\" & strLangCode & "\Reports\Crystal\CT_StdRpt_StkSummaryList.rpt", OpenReportMethod.OpenReportByTempCopy)
        ...
        crDiskFileDestinationOptions.DiskFileName = objMapPath & "web\ftp\CT_StdRpt_StkSummaryList.pdf"
        ...
        Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../ftp/CT_StdRpt_StkSummaryList.pdf"">")
