...
Public Class HR_StdRpt_Penerimaan_KaryPreview_Estate : Inherits Page
    ...
    Sub BindReport()
        ...
        strOpCd = "HR_HR_STDRPT_EMP_PENERIMAAN_GET"
        fname = "HR_StdRpt_Emp_Penerimaan_Estate"
        ...
        Try
            ...
            objRpt.Tables(0).TableName = "HR_HR_STDRPT_EMP_PENERIMAAN_DET"
            objRpt.Tables(1).TableName = "HR_HR_STDRPT_EMP_PENERIMAAN_SUM_BY_TY"
            objRpt.Tables(2).TableName = "HR_HR_STDRPT_EMP_PENERIMAAN_SUM_BY_DV_TY"
            objRpt.Tables(3).TableName = "HR_HR_STDRPT_EMP_PENERIMAAN_SUM_BY_DV_TY_YEAR"


        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=HR_HR_STDRPT_EMP_PENERIMAAN_GET&errmesg=" & lblErrMessage.Text & "&redirect=")
        End Try

        objRptDs.Tables.Add(objRpt.Tables(0).Copy())
        objRptDs.Tables(0).TableName = "HR_HR_STDRPT_EMP_PENERIMAAN_DET"
        objRptDs.Tables.Add(objRpt.Tables(1).Copy())
        objRptDs.Tables(1).TableName = "HR_HR_STDRPT_EMP_PENERIMAAN_SUM_BY_TY"
        objRptDs.Tables.Add(objRpt.Tables(2).Copy())
        objRptDs.Tables(2).TableName = "HR_HR_STDRPT_EMP_PENERIMAAN_SUM_BY_DV_TY"
        objRptDs.Tables.Add(objRpt.Tables(3).Copy())
        objRptDs.Tables(3).TableName = "HR_HR_STDRPT_EMP_PENERIMAAN_SUM_BY_DV_TY_YEAR"
