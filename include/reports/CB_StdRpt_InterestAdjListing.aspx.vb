...
Public Class CB_StdRpt_InterestAdjListing : Inherits Page
    ...
    Protected WithEvents txtInterestCodeFrom As TextBox
    Protected WithEvents txtInterestCodeTo As TextBox
    Protected WithEvents txtDescription As TextBox
    Protected WithEvents ddlBankCode As DropDownList
    Protected WithEvents ddlStatus As DropDownList
    
    Protected WithEvents PrintPrev As ImageButton
    Protected lblInterest As Label    
    ...
    Sub BindBankCode(ByVal pv_strBankCode As String)
        ...
        Catch Exp As Exception
            Response.Redirect("../../../include/mesg/ErrorMessage.aspx?errcode=CB_RPT_INTEREST_GET_BANK&errmesg=" & lblErrMessage.Text & "&redirect=")
        End Try
    ...
    Sub BindStatus()
        ...
        ddlStatus.Items.Add(New ListItem(objCB1.mtdGetInterestAdjStatus(objCB1.EnumInterestAdjStatus.Active), objCB1.EnumInterestAdjStatus.Active))
        ddlStatus.Items.Add(New ListItem(objCB1.mtdGetInterestAdjStatus(objCB1.EnumInterestAdjStatus.Cancelled), objCB1.EnumInterestAdjStatus.Cancelled))
        ddlStatus.Items.Add(New ListItem(objCB1.mtdGetInterestAdjStatus(objCB1.EnumInterestAdjStatus.Confirmed), objCB1.EnumInterestAdjStatus.Confirmed))
        ddlStatus.Items.Add(New ListItem(objCB1.mtdGetInterestAdjStatus(objCB1.EnumInterestAdjStatus.Deleted), objCB1.EnumInterestAdjStatus.Deleted))
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        Response.Write("<Script Language=""JavaScript"">window.open(""CB_StdRpt_InterestAdjListingPreview.aspx?CompName=" & strCompany & "&Location=" & strUserLoc & "&RptID=" & strRptID & "&RptName=" & strRptName & "&Decimal=" & strDec & _
                    ...
                    "&txtInterestCodeFrom=" & Server.UrlEncode(Trim(txtInterestCodeFrom.Text)) & _
                    "&txtInterestCodeTo=" & Server.UrlEncode(Trim(txtInterestCodeTo.Text)) & _
                    "&lblInterest=" & Server.UrlEncode(lblInterest.Text) & _
