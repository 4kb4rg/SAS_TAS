...
Public Class PD_StdRpt_Production_Estate_Preview : Inherits Page
    ...
    Sub Page_Load(ByVal Sender As Object, ByVal E As EventArgs)
        ...
        Else
			...
			strSelTipe = Trim(Request.QueryString("Tipe"))
    ...
    Sub BindReport()
        ...
        Try
            strRptPrefix = "PD_StdRpt_PRODUKSI_TBS"
            strOpCd = "PD_PD_STDRPT_PRODUKSI_TBS"
            strname = "LOCCODE|SD|ED|TY"
        ...
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=PD_PD_STDRPT_PRODUKSI_TBS&errmesg=" & Exp.ToString() & "&redirect=")
        End Try
    ...
    Sub PassParam()
        ...
        ParamDiscreteValue2.Value = trim(A & " ["& strDateFrom & " s/d " & strDateTo & "]")
		ParamDiscreteValue3.Value = trim(strCompanyName)
		ParamDiscreteValue4.Value = trim(strLocationName)
		...
		ParamFieldDef3 = ParamFieldDefs.Item("Comp")
