...
Public Class GL_StdRpt_HKEfektifSKUHPreview : Inherits Page
    ...
    Dim strSrchPhyMonth1 as String
    Dim strSrchPhyYear1 as String
    Dim strSrchPhyMonth2 as String
    Dim strSrchPhyYear2 as String
    ...
    Sub Page_Load(ByVal Sender As Object, ByVal E As EventArgs)
        ...
        strSrchPhyMonth1 = Trim(Request.QueryString("PhyMonth1"))
        strSrchPhyYear1 = Trim(Request.QueryString("PhyYear1"))
        strSrchPhyMonth2 = Trim(Request.QueryString("PhyMonth2"))
        strSrchPhyYear2 = Trim(Request.QueryString("PhyYear2"))

        strRemarks = Trim(Request.QueryString("Remarks"))
    ...
    Sub BindReport()
        ...
        if strSrchPhyMonth2 = "1" or strSrchPhyMonth2 = "3" or strSrchPhyMonth2 = "5" or strSrchPhyMonth2 = "7" or strSrchPhyMonth2 = "8" or strSrchPhyMonth2 = "10" or strSrchPhyMonth2 = "12" then 
            strDateTo = strSrchPhyMonth2 & "/31/" & strSrchPhyYear2 
        else if strSrchPhyMonth2 = "2" and (CInt(strSrchPhyYear1) mod 4 = 0) then 
            strDateTo = strSrchPhyMonth2 & "/29/" & strSrchPhyYear2 
        else if strSrchPhyMonth2 = "2" and (CInt(strSrchPhyYear1) mod 4 > 0) then 
            strDateTo = strSrchPhyMonth2 & "/28/" & strSrchPhyYear2 
        else
            strDateTo = strSrchPhyMonth2 & "/30/" & strSrchPhyYear2 
        end if 

        strDateFrom = strSrchPhyMonth1 & "/1/" & strSrchPhyYear1
       ...
       strRptPrefix = "GL_StdRpt_HKEfektifSKUH"
       ...
       strOpCd = "GL_STDRPT_MR_HKEFEKTIF_SKUH" & "|" & objGLRpt.mtdGetGLReportTable(objGLRpt.EnumGLReportTable.HKEfektifSKUH) & Chr(9) & _
        ...
        Try
            intErrNo = objGLRpt.mtdGetReport_HKEfektifSKUH(strOpCd, _
                                                            strCompany, _
                                                            strLocation, _
                                                            strUserId, _
                                                            strAccMonth, _
        ...
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=GL_STDRPT_HKEFEKTIFSKUH&errmesg=" & Exp.ToString() & "&redirect=")
        End Try
    ...
    Sub PassParam()
        ...
        ParamDiscreteValue7.Value = strSrchDivision
        ...
        ParamFieldDef7 = ParamFieldDefs.Item("SelDivision")
        ...
        ParameterValues7 = ParamFieldDef3.CurrentValues
