...
Public Class PR_StdRpt_DaftarBrondolanPreview_Estate : Inherits Page
 ...
 Dim objFTPFolder As String
    ...
    Sub BindReport()
        ...
        Dim strOpCd As String = "PR_PR_STDRPT_DAFTAR_PANENBORONGAN_REPORT"
		...
		If strExportToExcel = "0" Then
			crDiskFileDestinationOptions.DiskFileName = objMapPath & "web\ftp\PR_StdRpt_DaftarPanenBorongan_Estate.pdf"
		Else
			crDiskFileDestinationOptions.DiskFileName = objMapPath & "web\ftp\PR_StdRpt_DaftarPanenBorongan_Estate.xls"
		End if
		...
		If strExportToExcel = "0" Then
        Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../ftp/PR_StdRpt_DaftarPanenBorongan_Estate.pdf"">")
		else
		Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../ftp/PR_StdRpt_DaftarPanenBorongan_Estate.xls"">")
		end if 
    End Sub
