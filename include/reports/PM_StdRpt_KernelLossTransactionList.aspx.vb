...
Public Class PM_StdRpt_KernelLossTransactionList : Inherits Page
    ...
    Sub BindMachineList()
        ...
        Dim strParam = "|WHERE Status = '1' AND ProcessCtrl = '1' AND SubBlkCode In (SELECT Machine FROM PM_MACHINE_CRITERIA WHERE UsedFor = '" & objPMSetup.EnumMachineCriteriaFor.KernelLoss & "' GROUP BY Machine) "
        Dim intCnt As Integer
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        If Not (strDateFrom = "" And strDateTo = "") Then
            If objGlobal.mtdValidInputDate(strDateSetting, strDateFrom, objDateFormat, objDateFrom) = True And objGlobal.mtdValidInputDate(strDateSetting, strDateTo, objDateFormat, objDateTo) = True Then
                Response.Write("<Script Language=""JavaScript"">window.open(""PM_StdRpt_KernelLossTransactionListPreview.aspx?Type=Print&Location=" & strUserLoc & "&RptID=" & strRptID & "&RptName=" & strRptName & "&Decimal=" & strDec & _
