...
Public Class AP_StdRpt_MutasiAccountPayable : Inherits Page
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        Response.Write("<Script Language=""JavaScript"">window.open(""AP_StdRpt_MutasiAccountPayablePreview.aspx?Type=Print&CompName=" & strCompany & _
