...
Public Class FA_StdRpt_AssetDeprList : Inherits Page
    ...
    Protected WithEvents lblDeprGLDeprAccCode As Label
    Protected WithEvents lblDeprGLAccumDeprAccCode As Label
    ...
    Protected WithEvents txtDeprGLDeprAccCode As TextBox
    Protected WithEvents txtDeprGLAccumDeprAccCode As TextBox
    ...
    Sub onload_GetLangCap()
        ...
        lblDeprGLDeprAccCode.Text = GetCaption(objLangCap.EnumLangCap.DeprGLDeprAccCode)
        lblDeprGLAccumDeprAccCode.Text = GetCaption(objLangCap.EnumLangCap.DeprGLAccumDeprAccCode)
        lblTxID.Text = GetCaption(objLangCap.EnumLangCap.AssetDepr)
    ...
    Sub BindStatus()
        lstStatus.Items.Add(New ListItem(objFATrx.mtdGetAssetDeprStatus(objFATrx.EnumAssetDeprStatus.All), objFATrx.EnumAssetDeprStatus.All))
        lstStatus.Items.Add(New ListItem(objFATrx.mtdGetAssetDeprStatus(objFATrx.EnumAssetDeprStatus.Active), objFATrx.EnumAssetDeprStatus.Active))
        lstStatus.Items.Add(New ListItem(objFATrx.mtdGetAssetDeprStatus(objFATrx.EnumAssetDeprStatus.Confirmed), objFATrx.EnumAssetDeprStatus.Confirmed))
        lstStatus.Items.Add(New ListItem(objFATrx.mtdGetAssetDeprStatus(objFATrx.EnumAssetDeprStatus.Deleted), objFATrx.EnumAssetDeprStatus.Deleted))
        lstStatus.Items.Add(New ListItem(objFATrx.mtdGetAssetDeprStatus(objFATrx.EnumAssetDeprStatus.Closed), objFATrx.EnumAssetDeprStatus.Closed))
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        If txtDeprGLDeprAccCode.Text = "" Then
            strDeprGLDeprAccCode = ""
        Else
            strDeprGLDeprAccCode = Trim(txtDeprGLDeprAccCode.Text)
        End If

        If txtDeprGLAccumDeprAccCode.Text = "" Then
            strDeprGLAccumDeprAccCode = ""
        Else
            strDeprGLAccumDeprAccCode = Trim(txtDeprGLAccumDeprAccCode.Text)
        End If
        ...
        strDeprGLDeprAccCode = Server.UrlEncode(strDeprGLDeprAccCode)
        strDeprGLAccumDeprAccCode = Server.UrlEncode(strDeprGLAccumDeprAccCode)
        ...
        If Not (strTxDateFrom = "" And strTxDateTo = "") Then
            If objGlobal.mtdValidInputDate(strDateSetting, strTxDateFrom, objDateFormat, objDateFrom) = True And objGlobal.mtdValidInputDate(strDateSetting, strTxDateTo, objDateFormat, objDateTo) = True Then
                Response.Write("<Script Language=""JavaScript"">window.open(""FA_StdRpt_AssetDeprListPreview.aspx?Type=Print&CompName=" & strCompany & "&Location=" & strUserLoc & "&RptID=" & strRptID & _
                               ...
                               "&lblLocation=" & lblLocation.Text & "&lblAssetCode=" & lblAssetCode.Text & lblAssetCode.Text & "&lblAssetHeaderCode=" & lblAssetHeaderCode.Text & "&lblDeprGLDeprAccCode=" & lblDeprGLDeprAccCode.Text & "&lblDeprGLAccumDeprAccCode=" & lblDeprGLAccumDeprAccCode.Text & "&TxIDFrom=" & strTxIDFrom & "&TxIDTo=" & strTxIDTo & _
                               "&ExportToExcel=" & strExportToExcel & _
                               "&DeprType=" & strDeprType & _
                               "&Status=" & strStatus & "&AssetCode=" & strAssetCode & "&AssetHeaderCode=" & strAssetHeaderCode & "&DeprGLDeprAccCode=" & strDeprGLDeprAccCode & "&DeprGLAccumDeprAccCode=" & strDeprGLAccumDeprAccCode & "&RefNo=" & strRefNo & """,null ,""status=yes, resizable=yes, scrollbars=yes, toolbar=no, location=no"");</Script>")
            Else
        ...
        Else
            Response.Write("<Script Language=""JavaScript"">window.open(""FA_StdRpt_AssetDeprListPreview.aspx?Type=Print&CompName=" & strCompany & "&Location=" & strUserLoc & "&RptID=" & strRptID & _
                           "&RptName=" & strRptName & "&Decimal=" & strDec & "&TxDateFrom=" & objDateFrom & "&TxDateTo=" & objDateTo & _
                           "&DDLAccMth=" & strddlAccMth & "&DDLAccYr=" & strddlAccYr & "&DDLAccMthTo=" & strddlAccMthTo & "&DDLAccYrTo=" & strddlAccYrTo & "&lblTxID=" & lblTxID.Text & _
                           "&lblLocation=" & lblLocation.Text & "&lblAssetCode=" & lblAssetCode.Text & "&lblAssetHeaderCode=" & lblAssetHeaderCode.Text & "&lblDeprGLDeprAccCode=" & lblDeprGLDeprAccCode.Text & "&lblDeprGLAccumDeprAccCode=" & lblDeprGLAccumDeprAccCode.Text & "&TxIDFrom=" & strTxIDFrom & "&TxIDTo=" & strTxIDTo & _
                           "&ExportToExcel=" & strExportToExcel & _
                           "&DeprType=" & strDeprType & _
                           "&Status=" & strStatus & "&AssetCode=" & strAssetCode & "&AssetHeaderCode=" & strAssetHeaderCode & "&DeprGLDeprAccCode=" & strDeprGLDeprAccCode & "&DeprGLAccumDeprAccCode=" & strDeprGLAccumDeprAccCode & "&RefNo=" & strRefNo & """,null ,""status=yes, resizable=yes, scrollbars=yes, toolbar=no, location=no"");</Script>")
        End If
