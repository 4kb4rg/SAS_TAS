...
Public Class AR_StdRpt_LaporanPenjualan : Inherits Page
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        Response.Write("<Script Language=""JavaScript"">window.open(""AR_StdRpt_LaporanPenjualanPreview.aspx?Type=Print&Location=" & strUserLoc & _
                        "&RptID=" & strRptID & _
