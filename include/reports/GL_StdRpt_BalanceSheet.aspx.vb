...
Public Class GL_StdRpt_BalanceSheet : Inherits Page
    ...
    Protected Overloads Sub OnPreRender(ByVal Source As Object, ByVal E As EventArgs) Handles MyBase.PreRender
        ...
        htmltr.visible = True
        htmltr = RptSelect.FindControl("TrStmtBy")
        htmltr.visible = True
    ...
    Protected Function GetStmtAccYear(ByVal pv_strAccMonth as String, ByVal pv_strAccYear as String) As String
        ...
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=GL_STDRPT_BALSHEET_GETACCYEAR&errmesg=" & lblErrMessage.Text & "&redirect=")
        End Try
        intStartMonth = CInt(DsConfig.Tables(0).Rows(0).Item("StartAccMonth").Trim())
        intAccMonth = CInt(pv_strAccMonth)
        intAccYear = CInt(pv_strAccYear)
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        ddlist = RptSelect.FindControl("ddlStmtBy")
        strStmtBy = Trim(ddlist.SelectedItem.Value)
        ...
        strStmtAccYear = GetStmtAccYear(strddlAccMth, strddlAccYr)

        If strStmtBy = "loc" Then
        ...
        Response.Write("<Script Language=""JavaScript"">window.open(""GL_StdRpt_BalanceSheetPreview.aspx?Type=Print&CompName=" & strCompany & _
                       ...
                       "&Decimal=" & strDec & _
                       "&Supp=" & strSupp & _
                       "&PrintStmtBy=" & strStmtBy & _
                       "&StmtAccYear=" & strStmtAccYear & _
