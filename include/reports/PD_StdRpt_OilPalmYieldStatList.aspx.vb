...
Public Class PD_StdRpt_OilPalmYieldStatList : Inherits Page
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        Response.Write("<Script Language=""JavaScript"">window.open(""PD_StdRpt_OilPalmYieldStatListPreview.aspx?Type=Print&CompName=" & strCompany & _
