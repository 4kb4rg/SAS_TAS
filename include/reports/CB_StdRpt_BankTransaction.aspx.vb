...
Public Class CB_StdRpt_BankTransaction : Inherits Page
    ...
    'Protected WithEvents lstType As DropDownList
    ...
    Sub Page_Load(ByVal Sender As Object, ByVal E As EventArgs)
        ...
        Else
            ...
            If Not Page.IsPostBack Then
                txtDate.Text = "01/" & Month(Now()) & "/" & Year(Now())
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        strType = 0 'Trim(lstType.SelectedItem.Value)
        ...
        Response.Write("<Script Language=""JavaScript"">window.open(""CB_StdRpt_BankTransactionPreview.aspx?Type=Print&CompName=" & strCompany & _
                       "&RptID=" & strRptID & _
