...
Public Class WS_StdRpt_WorkshopVehicleBreakdownListingPreview : Inherits Page
    ...
    Dim strRptVehCode As String
    Dim strRptVehRegNo As String
    Dim strLblLocation As String
    Dim strLblWork As String
    Dim strLblVehicle As String
    Dim strLblVehRegNo As String
    ...
    Sub Page_Load(ByVal Sender As Object, ByVal E As EventArgs)
        ...
        Else
            ...
            strRptVehCode = Trim(Request.QueryString("VehCode"))
            strRptVehRegNo = Trim(Request.QueryString("VehRegNo"))
            ...
            strLblVehRegNo = Trim(Request.QueryString("lblVehicleRegistrationNo"))
    ...
    Sub BindReport()
        ...
        Dim strRptPrefix As String = "WS_StdRpt_WorkshopVehicleBreakdownListing"
        ...
        colParam.Add(strRptVehCode, "PARAM_VEHCODE")
        colParam.Add(strRptVehRegNo, "PARAM_VEHREGNO")
        
        colParam.Add("WS_STDRPT_VEHICLE_BREAKDOWN_LISTING_GET_SP", "OC_REPORT_GET")
        
        Try
            intErrNo = objWS.mtdGetReport_WorkshopVehicleBreakdownListing(colParam, dsReport, strMapPath)
            dsReport.Tables(0).TableName = "MAIN_REPORT"
            dsReport.Tables(1).TableName = "MECHANIC_HOUR"
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=WS_STDRPT_WORKSHOP_VEHICLE_BREAKDOWN_LISTING_GET&errmesg=" & Server.UrlEncode(Exp.ToString()) & "&redirect=")
        End Try
    ...
    Sub PassParam()
        Const PARAM_UBOUND As Integer = 17
        ...
        ParamFieldDef(11) = ParamFieldDefs.Item("ParamVehCode")
        ParamFieldDef(12) = ParamFieldDefs.Item("ParamVehRegNo")
        ParamFieldDef(13) = ParamFieldDefs.Item("lblLocation")
        ParamFieldDef(14) = ParamFieldDefs.Item("lblBillParty")
        ParamFieldDef(15) = ParamFieldDefs.Item("lblVehicle")
        ParamFieldDef(16) = ParamFieldDefs.Item("lblVehRegNo")
        ParamFieldDef(17) = ParamFieldDefs.Item("lblWork")
        ...
        ParamDiscreteValue(11).Value = strRptVehCode
        ParamDiscreteValue(12).Value = strRptVehRegNo
        ParamDiscreteValue(13).Value = strLblLocation
        ParamDiscreteValue(14).Value = strLblBillParty
        ParamDiscreteValue(15).Value = strLblVehicle
        ParamDiscreteValue(16).Value = strLblVehRegNo
        ParamDiscreteValue(17).Value = strLblWork
