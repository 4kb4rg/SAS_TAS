...
Public Class PR_StdRpt_Astek_Estate : Inherits Page
    ...
    Protected WithEvents ddlcat As DropDownList
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        strcat = Trim(ddlcat.SelectedItem.Value)
		strExportToExcel = IIf(cbExcel.Checked = True, "1", "0")



        Response.Write("<Script Language=""JavaScript"">window.open(""PR_StdRpt_Astek_Preview_Estate.aspx?CompCode=" & strCompany & "&Location=" & strUserLoc & "&RptID=" & strRptID & "&RptName=" & strRptName & "&Decimal=" & strDec & _
                       "&lblLocation=" & lblLocation.Text & "&AccMonth=" & strddlAccMth & "&AccYear=" & strddlAccYr & _
                       "&ExportToExcel=" & strExportToExcel & "&Divisi=" & strDivisi & "&Cat=" & strcat & """,""" & strRptID & """ ,""status=yes, resizable=yes, scrollbars=yes, toolbar=no, location=no"");</Script>")
    End Sub
