...
Public Class GL_StdRpt_VehExpenseDet : Inherits Page
    ...
    Protected WithEvents chkSummBy As CheckBox
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        Dim blnIsSummarize As Boolean = False
        ...
        If chkSummBy.Checked = True Then
            blnIsSummarize = True
        End If
        ...
        enStrSumm = Server.UrlEncode(blnIsSummarize)


        Response.Write("<Script Language=""JavaScript"">window.open(""GL_StdRpt_VehExpenseDetPreview.aspx?Type=Print&CompName=" & strCompany & _
