...
Public Class PR_StdRpt_SarawakLabourRetPreview : Inherits Page
    ...
    Sub Page_Load(ByVal Sender As Object, ByVal E As EventArgs)
        ...
        strAttdDateFrom = Request.QueryString("AttdDateFrom")
        strAttdDateTo = Request.QueryString("AttdDateTo")
        ...
        Session("SS_EMPSTATUSTEXT") = strEmpStatusText
    ...
    Sub BindReport()
        ...
        Try
            strRptPrefix = "PR_StdRpt_SarawakLabourRet"

            strOpCd = "PR_STDRPT_SARAWAK_LABOUR_RET_SP" & "|" & objPRRpt.mtdGetPRReportTable(objPRRpt.EnumPRReportTable.SarawakLabRet) & Chr(9) & _
                     "GET_REPORT_INFO_BY_REPORTID|SH_REPORT"
           
            strParam = strAttdDateFrom & "|" & _
                       strAttdDateTo & "|" & _
            ...
            strAccMonth = mid(strAttdDateFrom,4,2)
            if Right(strAccMonth,1) = "/" then
                strAccMonth = left(strAccMonth,len(strAccMonth)-1)
            End if 
            strAccYear = right(strAttdDateFrom,4)


            intErrNo = objPRRpt.mtdGetReport_SarawakLabRet_SP(strOpCd, _
                                                         strCompany, _
                                                         strLocation, _
                                                         strUserId, _
                                                         strAccMonth, _
        ...
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=PR_STDRPT_SARAWAKLABRET_GET&errmesg=" & Exp.ToString() & "&redirect=")
        End Try
    ...
    Sub PassParam()
        ...
        ParamDiscreteValue7.Value = Session("SS_EMPIDFROM")
        ParamDiscreteValue8.Value = Session("SS_EMPIDTO")
        ParamDiscreteValue9.Value = Session("SS_EMPSTATUSTEXT")
        ...
        ParamFieldDef7 = ParamFieldDefs.Item("ParamEmpIDFrom")
        ParamFieldDef8 = ParamFieldDefs.Item("ParamEmpIDTo")
        ParamFieldDef9 = ParamFieldDefs.Item("ParamEmpStatusText")
