...
Public Class GL_StdRpt_TrialBalSumPreview : Inherits Page
    ...
    Dim strSrchTrxNo As String
    Dim strSrchtrxNo2 As String
    ...
    Sub Page_Load(ByVal Sender As Object, ByVal E As EventArgs)
        ...
        strSrchAccCode2 = Trim(Request.QueryString("SrchAccCode2"))
        strSrchBlkCode = Trim(Request.QueryString("SrchBlkCode"))

        strSrchTrxNo = Trim(Request.QueryString("SrchTrxNo"))
        strSrchTrxNo2 = Trim(Request.QueryString("SrchTrxNo2"))
    ...
    Sub BindReport()
        ...
        strParamName = "LOCCODE|ACCMONTH|ACCYEAR|SEARCH|SEARCH2|BLKCODE"

        If Trim(strSrchTrxNo) = "" Then
            strOpCode = "GL_STDRPT_TRIALBAL_TEMPORARY_GET"
            strFileName = "GL_StdRpt_TrialBal_Temporary"
            strParamValue = strLocation & "|" & strSelAccMonth & "|" & strSelAccYear & "|" & strSrchAccCode & "|" & strSrchAccCode2 & "|" & strSrchBlkCode

        Else
            strOpCode = "GL_STDRPT_TRIALBAL_TEMPORARYTRANS_GET"
            strFileName = "GL_StdRpt_TrialBal_TemporaryTrans"
            strParamValue = strLocation & "|" & strSelAccMonth & "|" & strSelAccYear & "|" & strSrchTrxNo & "|" & strSrchtrxNo2 & "|" & strSrchBlkCode
