...
Public Class CB_StdRpt_OfficialReceiptPreview : Inherits Page
    ...
    Sub Page_Load(ByVal Sender As Object, ByVal E As EventArgs)
        ...
        Else
            ...
            strSearchExp = "and rct.LocCode = '" & strUserLoc & "' " & _
                            "and rct.Status = '" & objCBTrx.EnumReceiptStatus.Confirmed & "' "
    ...
    Sub BindReport()
        ...
        strRptPrefix = "CB_StdRpt_OfficialReceipt"
        strOpCd = "CB_STDRPT_OFFICIALRECEIPT_GET_SP" & "|" & "CB_RECEIPT"
        ...
        Try
            intErrNo = objCBRpt.mtdGetReport_OfficialReceipt(strOpCd, _
                                                            strCompany, _
                                                            strLocation, _
                                                            strUserId, _
                                                            strAccMonth, _
        ...
        Catch Exp As Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=CB_STDRPT_OFFICIALRECEIPT_GET&errmesg=" & Exp.ToString() & "&redirect=")
        End Try
