...
Public Class AR_StdRpt_ReceiptList : Inherits Page
    ...
    Sub BindStatus()
        ...
        ddlStatus.Items.Add(New ListItem(objARTrx.mtdGetReceiptStatus(objARTrx.EnumReceiptStatus.Active), objARTrx.EnumReceiptStatus.Active))
        ddlStatus.Items.Add(New ListItem(objARTrx.mtdGetReceiptStatus(objARTrx.EnumReceiptStatus.Confirmed), objARTrx.EnumReceiptStatus.Confirmed))
        ddlStatus.Items.Add(New ListItem(objARTrx.mtdGetReceiptStatus(objARTrx.EnumReceiptStatus.Void), objARTrx.EnumReceiptStatus.Void))        
        ddlStatus.Items.Add(New ListItem(objARTrx.mtdGetReceiptStatus(objARTrx.EnumReceiptStatus.Deleted), objARTrx.EnumReceiptStatus.Deleted))
        ddlStatus.Items.Add(New ListItem(objARTrx.mtdGetReceiptStatus(objARTrx.EnumReceiptStatus.Closed), objARTrx.EnumReceiptStatus.Closed))        
    End Sub      
    ...
    Sub onload_GetLangCap()
        ...
        Catch Exp As System.Exception
            Response.Redirect("../../../include/mesg/ErrorMessage.aspx?errcode=AR_STDRPT_INVOICE_LIST_COST_LEVEL_GET&errmesg=" & lblErrMessage.Text & "&redirect=../en/reports/AR_StdRpt_Selection.aspx")
        End Try
    End Sub
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        Else
            ...
            End If
        End If
        Response.Write("<Script Language=""JavaScript"">window.open(""AR_StdRpt_ReceiptListPreview.aspx?CompName=" & strCompany & "&Location=" & strUserLoc & "&RptID=" & strRptID & "&RptName=" & strRptName & "&Decimal=" & strDec & _
