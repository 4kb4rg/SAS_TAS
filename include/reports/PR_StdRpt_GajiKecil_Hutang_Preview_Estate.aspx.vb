...
Public Class PR_StdRpt_GajiKecil_Hutang_Preview_Estate : Inherits Page
    ...
    Sub BindReport()
        ...
        Dim strOpCd As String = "PR_PR_STDRPT_GAJIKECIL_HUTANG_REPORT"
        ...
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=PR_PR_STDRPT_GAJIKECIL_HUTANG_REPORT&errmesg=" & lblErrMessage.Text & "&redirect=")
        End Try
       ...
       ' End If
        ...
        rdCrystalViewer.Load(objMapPath & "web\" & strLangCode & "\reports\crystal\PR_StdRpt_GajiKecil_Hutang_Estate.rpt", OpenReportMethod.OpenReportByTempCopy)
        ...
        crDiskFileDestinationOptions.DiskFileName = objMapPath & "web\ftp\PR_StdRpt_GajiKecil_Hutang_Estate.pdf"
        ...
        Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../ftp/PR_StdRpt_GajiKecil_Hutang_Estate.pdf"">")
    End Sub
