...
Public Class PU_StdRpt_MthStoreItem_Preview : Inherits Page
    ...
    Sub BindReport()
        ...
        Dim strOpCd_StoreItem_GET As String = "PU_STDRPT_STOCK_GET"
        ...
        Try
            intErrNo = objPU.mtdGetReport_StoreItem(strOpCd_StoreItem_GET, strParam, objRptDs, objMapPath)
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=PU_STDRPT_GRTN_LIST&errmesg=" & Exp.ToString() & "&redirect=")
        End Try

        
        rdCrystalViewer.Load(objMapPath & "web\" & strLangCode & "\Reports\Crystal\PU_StdRpt_StoreItem.rpt", OpenReportMethod.OpenReportByTempCopy)
        ...
        crDiskFileDestinationOptions.DiskFileName = objMapPath & "web\ftp\PU_StdRpt_StoreItem.pdf"
        ...
        Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../ftp/PU_StdRpt_StoreItem.pdf"">")
    ...
    Sub PassParam()
        ...
        paramField13 = paramFields.Item("ParamReceiveIDFrom")
        paramField14 = paramFields.Item("ParamReceiveIDTo")
        paramField15 = paramFields.Item("ParamReceiveDateFrom")
        paramField16 = paramFields.Item("ParamReceiveDateTo")  
        paramField17 = paramFields.Item("ParamItemCodeFrom")
        paramField18 = paramFields.Item("ParamItemCodeTo")       
        paramField19 = paramFields.Item("ParamStatus")
        paramField20 = paramFields.Item("ParamItemType")
        ...
        ParamDiscreteValue13.Value = Request.QueryString("RcvNoteIDFrom")
        ParamDiscreteValue14.Value = Request.QueryString("RcvNoteIDTo")
        ParamDiscreteValue15.Value = Request.QueryString("RcvNoteDateFrom")
        ParamDiscreteValue16.Value = Request.QueryString("RcvNoteDateTo")
        ParamDiscreteValue17.Value = Request.QueryString("FromItemCode")
        ParamDiscreteValue18.Value = Request.QueryString("ToItemCode")
        ParamDiscreteValue19.Value = Request.QueryString("Status")
        ParamDiscreteValue20.Value = Request.QueryString("ItemType")
