...
Public Class PR_StdRpt_Lembur_Estate : Inherits Page
    ...
    Protected WithEvents chkDetHours As CheckBox
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        strType = ddlemptype.SelectedItem.Value.Trim()
        strDetHours = IIf(chkDetHours.Checked = True, "1", "0")
        ...
        Response.Write("<Script Language=""JavaScript"">window.open(""PR_StdRpt_Lembur_Preview_Estate.aspx?CompCode=" & strCompany & "&Location=" & strUserLoc & "&RptID=" & strRptID & "&RptName=" & strRptName & "&Decimal=" & strDec & _
                   "&lblLocation=" & lblLocation.Text & "&AccMonth=" & strddlAccMth & "&AccYear=" & strddlAccYr & _
                    "&Divisi=" & strdivisi & _
                    "&Type=" & strType & _
                    "&Status=" & strStatus & _
                    "&ExportToExcel=" & strExportToExcel & _
                    "&DetHours=" & strDetHours & _
