...
Public Class PR_StdRpt_YearEndList_Preview : Inherits Page
    ...
    Sub BindReport()
        ...
        strRptPrefix = "PR_StdRpt_YearEndList"

        strOpCd = "PRDOC_STDRPT_YEAREND_SP|" & objPRDoc.mtdGetEAReportTable(objPRDoc.EnumEAReportTable.YearEnd) & Chr(9) & _
                  "GET_REPORT_INFO_BY_REPORTID|SH_REPORT"

        strParamDs = strParam & "|RPTPR1000014|" & strEAYear

        Try
            intErrNo = objPRDoc.mtdGetReport_YearEndList_SP(strOpCd, strParamDs, objRptDs, objMapPath)
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=PRDOC_GET_EMPLOYEEYEARENDLIST&errmesg=" & lblErrMessage.Text & "&redirect=")
        End Try
