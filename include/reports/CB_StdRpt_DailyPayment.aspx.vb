...
Public Class CB_StdRpt_DailyPayment : Inherits Page
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        Response.Write("<Script Language=""JavaScript"">window.open(""CB_StdRpt_DailyPaymentPreview.aspx?Type=Print&CompName=" & strCompany & _
                       "&RptID=" & strRptID & _
