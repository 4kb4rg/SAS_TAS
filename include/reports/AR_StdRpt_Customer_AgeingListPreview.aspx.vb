...
Public Class Ar_StdRpt_Customer_AgeingListPreview : Inherits Page
    ...
    Sub Page_Load(ByVal Sender As Object, ByVal E As EventArgs)
        ...
        Else
            ...
            strSrchAccMonth = Trim(Request.QueryString("DDLAccMth"))
            strSrchAccYear = Trim(Request.QueryString("DDLAccYr"))
    ...
    Sub BindReport()
        ...
        Dim strOpCode As String = "AR_STDRPT_CUSTOMER_AGING_DETAIL_GET"
        Dim strFileName As String = "AR_StdRpt_Customer_AgeingList"

        Dim objFTPFolder As String


        strParamName = "CustID|strLocCode|strYear|strMonth|IntGroup1Fr|IntGroup1To|IntGroup2fr|IntGroup2To|IntGroup3fr|IntGroup3To|IntGroup4fr|IntGroup4To|IntCurrent"
        ...
        rdCrystalViewer.Load(objMapPath & "web\" & strLangCode & "\Reports\Crystal\AR_StdRpt_Customer_AgeingList.rpt", OpenReportMethod.OpenReportByTempCopy)
