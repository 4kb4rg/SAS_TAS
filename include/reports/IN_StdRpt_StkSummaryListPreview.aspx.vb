...
Public Class IN_StdRpt_StkSummaryList_Preview : Inherits Page
    ...
    Sub BindReport(strAccMonthOpen, strAccYearOpen, strAccMonth, strAccYear)
        ...
        Dim strOpCdItemSum_GET As String = "IN_STDRPT_STKSUMMARYLIST"
        Dim SearchStr As String
        Dim strOrderBy As String
        Dim strOpenYear As String = "0"
        ...
        If Trim(strDDLAccMth) = "1" Then
            strOpenYear = CStr(CInt(strDDLAccYr) - 1)
        End If

        strParam = strUserLoc & "|" & strDDLAccMth & "|" & strOpenYear & "|" & strDDLAccMth & "|" & strDDLAccYr & "|" & SearchStr & strOrderBy
        strParam = Replace(strParam, "'", "''")

        Try
            intErrNo = objIN.mtdGetReport_ItemSummaryList(strOpCdItemSum_GET, strParam, objRptDs, objMapPath)
        ...
        rdCrystalViewer.Load(objMapPath & "web\" & strLangCode & "\Reports\Crystal\IN_StdRpt_StkSummaryList.rpt", OpenReportMethod.OpenReportByTempCopy)
        ...
        If strExportToExcel = "0" Then
            crDiskFileDestinationOptions.DiskFileName = objMapPath & "web\ftp\IN_StdRpt_StkSummaryList.pdf"
        Else
            crDiskFileDestinationOptions.DiskFileName = objMapPath & "web\ftp\IN_StdRpt_StkSummaryList.xls"
        End If
        ...
        If strExportToExcel = "0" Then
            Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../ftp/IN_StdRpt_StkSummaryList.pdf"">")
        Else
            Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../ftp/IN_StdRpt_StkSummaryList.xls"">")
        End If
    End Sub
    ...
    Sub PassParam()
        ...
        paramField25 = paramFields.Item("ParamIncWS")
        ...
        ParamDiscreteValue25.Value = Request.QueryString("WS")
