...
Public Class PU_StdRpt_RPHListPreview : Inherits Page
    ...
    Sub BindReport()
        ...
        Dim strOpCdRPH_GET As String = "PU_STDRPT_RPH_LISTING"
        ...
        If Not (Request.QueryString("DocDateFrom") = "" And Request.QueryString("DocDateTo") = "") Then
            SearchStr = SearchStr & "(DateDiff(Day, '" & Session("SS_DOCDATEFROM") & "', a.CreateDate) >= 0) And (DateDiff(Day, '" & Session("SS_DOCDATETO") & "', a.CreateDate) <= 0) AND "
        End If

        If Not Request.QueryString("Supplier") = "" Then
            SearchStr = SearchStr & "(b.suppcode1 LIKE '" & Request.QueryString("Supplier") & "' or b.suppcode2 LIKE '" & Request.QueryString("Supplier") & "' or b.suppcode3 LIKE '" & Request.QueryString("Supplier") & "') AND "
        Else
            SearchStr = SearchStr & "(b.suppcode1 LIKE '%' or b.suppcode2 LIKE '%' or b.suppcode3 LIKE '%') AND "
        End If

        If Not Request.QueryString("ProdType") = "" Then
            SearchStr = SearchStr & "IT.ProdTypeCode LIKE '" & Request.QueryString("ProdType") & "' AND "
        Else
            SearchStr = SearchStr & "IT.ProdTypeCode LIKE '%' AND "
        End If

        If Not Request.QueryString("ProdBrand") = "" Then
            SearchStr = SearchStr & "IT.ProdBrandCode LIKE '" & Request.QueryString("ProdBrand") & "' AND "
        Else
            SearchStr = SearchStr & "IT.ProdBrandCode LIKE '%' AND "
        End If

        If Not Request.QueryString("ProdModel") = "" Then
            SearchStr = SearchStr & "IT.ProdModelCode LIKE '" & Request.QueryString("ProdModel") & "' AND "
        Else
            SearchStr = SearchStr & "IT.ProdModelCode LIKE '%' AND "
        End If

        If Not Request.QueryString("ProdCat") = "" Then
            SearchStr = SearchStr & "IT.ProdCatCode LIKE '" & Request.QueryString("ProdCat") & "' AND "
        Else
            SearchStr = SearchStr & "IT.ProdCatCode LIKE '%' AND "
        End If

        If Not Request.QueryString("ProdMat") = "" Then
            SearchStr = SearchStr & "IT.ProdMatCode LIKE '" & Request.QueryString("ProdMat") & "' AND "
        Else
            SearchStr = SearchStr & "IT.ProdMatCode LIKE '%' AND "
        End If

        If Not Request.QueryString("StkAna") = "" Then
            SearchStr = SearchStr & "IT.StockAnalysisCode LIKE '" & Request.QueryString("StkAna") & "' AND "
        Else
            SearchStr = SearchStr & "IT.StockAnalysisCode LIKE '%' AND "
        End If

        If Not Request.QueryString("ItemCode") = "" Then
            SearchStr = SearchStr & "IT.ItemCode LIKE '" & Request.QueryString("ItemCode") & "' AND "
        Else
            SearchStr = SearchStr & "IT.ItemCode LIKE '%' AND "
        End If


        If Not Request.QueryString("RPHType") = "" Then
            If Not Request.QueryString("RPHType") = objPUTrx.EnumRPHType.All Then
                SearchStr = SearchStr & "a.RPHType = '" & Request.QueryString("RPHType") & "' AND "
            Else
                SearchStr = SearchStr & "a.RPHType LIKE '%' AND "
            End If
        End If

        If Not Request.QueryString("Status") = "" Then
            If Not Request.QueryString("Status") = objPUTrx.EnumRPHStatus.All Then
                SearchStr = SearchStr & "a.Status = '" & Request.QueryString("Status") & "' AND "
            Else
                SearchStr = SearchStr & "a.Status LIKE '%' AND "
            End If
        End If

        If strDDLAccMth <> "" Then 
            SearchStr = SearchStr & "a.AccMonth = '" & strDDLAccMth & "' AND "
        End If

        If strDDLAccYr <> "" Then 
            SearchStr = SearchStr & "a.AccYear = '" & strDDLAccYr & "' AND "
        End If

        if strUserLoc <> "" then 
            SearchStr = SearchStr & " a.loccode in ( '" & strUserLoc & "') AND "
        end if 
        ...
        If Not SearchStr = "" Then
            ...
            strParam = " where " & SearchStr


        End If

        Try
            intErrNo = objPU.mtdGetReport_RPHList(strOpCdRPH_GET, strParam, objRptDs, objMapPath)
        Catch Exp As System.Exception
            Response.Redirect("../../../include/mesg/ErrorMessage.aspx?errcode=PU_STDRPT_RPH_LIST&errmesg=" & lblErrMessage.Text & "&redirect=")
        End Try
        ...
        rdCrystalViewer.Load(objMapPath & "web\" & strLangCode & "\Reports\Crystal\PU_StdRpt_RPHList.rpt", OpenReportMethod.OpenReportByTempCopy)
        ...
        If strExportToExcel = "0" Then
            crDiskFileDestinationOptions.DiskFileName = objMapPath & "web\ftp\PU_StdRpt_RPHList.pdf"
        Else
            crDiskFileDestinationOptions.DiskFileName = objMapPath & "web\ftp\PU_StdRpt_RPHList.xls"
        End If
        ...
        If strExportToExcel = "0" Then
            Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../ftp/PU_StdRpt_RPHList.pdf"">")
        Else
            Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../ftp/PU_StdRpt_RPHList.xls"">")
        End If
    ...
    Sub PassParam()
        ...
        paramField21 = paramFields.Item("ParamRPHType")
        ...
        ParamDiscreteValue21.Value = Request.QueryString("RPHType")
