...
Public Class CB_StdRpt_MutasiBankPreview : Inherits Page
    ...
    Sub Page_Load(ByVal Sender As Object, ByVal E As EventArgs)
        ...
        strFileName = "CB_StdRpt_MutasiBank"
        ...
        If Right(strLocation, 1) = "," Then
            strUserLoc = Left(strLocation, Len(strLocation) - 1)
        Else
            strUserLoc = Trim(strLocation)
        End If
        
        If Right(strLocation, 1) = "," Then
            strDispLoc = Left(strLocation, Len(strLocation) - 1)
        Else
            strDispLoc = strLocation.Replace("','", ", ")
        End If
        ...
        strType  = Trim(Request.QueryString("PType"))
        
        If strType = "3" Then strType = "%"
    ...
    Sub BindReport()
        ...
        Dim strOpCode As String = "CB_STDRPT_MUTASIBANK_GET"
        Dim strParam As String
        Dim objFTPFolder As String

        strParam =  strDateFrom & "|" & strDateTo & "|" & strType & "|" & strUserLoc

        Try
            intErrNo = objCB.mtdGetReport_MutasiBank(strOpCode, strParam, objRptDs, objMapPath, objFTPFolder)
        Catch Exp As Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=CB_StdRpt_MutasiBank&errmesg=" & lblErrMessage.Text & "&redirect=")
        End Try
    ...
    Sub PassParam()
        ...
        ParamDiscreteValue2.Value = strDispLoc
        ...
        ParamDiscreteValue9.Value = strType
