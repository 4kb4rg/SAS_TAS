...
Public Class NU_StdRpt_WorkAccDetMi : Inherits Page
    ...
    Protected WithEvents txtAccClass As TextBox
    ...
    Sub ibPrintPreview_OnClick(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        strAccClass =  Server.UrlEncode(txtAccClass.Text.Trim())        
        ...
        Response.Write("<Script Language=""JavaScript"">window.open(""NU_StdRpt_WorkAccDetMiPreview.aspx?Type=Print&CompName=" & strCompany & "&Location=" & strUserLoc & "&RptID=" & strRptID & "&RptName=" & strRptName & "&Decimal=" & strDec & _
                        "&DDLAccMth=" & strddlAccMth & "&DDLAccYr=" & strddlAccYr & "&DDLAccMthTo=" & strddlAccMthTo & "&DDLAccYrTo=" & strddlAccYrTo & _
                        "&BatchNo=" & strBatchNo & _
                        "&BlkType=" & strBlkType & "&BlkGrp=" & strBlkGrpCode & "&BlkCode=" & strBlkCode & "&SubBlkCode=" & strSubBlkCode & _
                        "&lblBlkType=" & lblBlkType.Text & "&lblBlkGrp=" & lblBlkGrp.Text & "&AccClass=" & strAccClass & _
                        "&lblBlkCode=" & lblBlkCode.Text & "&lblSubBlkCode=" & lblSubBlkCode.Text & "&lblLocation=" & lblLocation.Text & "&lblBatchNo=" & lblBatchNo.Text & _
