...
Public Class PR_StdRpt_DaftarMuatTBS_Estate : Inherits Page
    ...
    Protected WithEvents ddldivisikerja As DropDownList 
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
		...
		Dim strDivisikerja As String = Trim(ddldivisikerja.SelectedItem.Value)
		Dim strddlsubcat As String = Trim(ddlsubcat.SelectedItem.Value)
        ...
        Response.Write("<Script Language=""JavaScript"">window.open(""PR_StdRpt_DaftarMuatTBSPreview_Estate.aspx?CompCode=" & strCompany & "&Location=" & strUserLoc & "&RptID=" & strRptID & "&RptName=" & strRptName & "&Decimal=" & strDec & _
                       "&lblLocation=" & lblLocation.Text & "&AccMonth=" & strddlAccMth & "&AccYear=" & strddlAccYr & _
                       "&EmpCode=" & strEmpCode & "&Divisi=" & strDivisi & "&Mandor=" & strMandor & "&DivisiKerja=" & strDivisikerja &  "&Kategori=" & strddlsubcat &""",""" & strRptID & ""","" status=yes, resizable=yes, scrollbars=yes, toolbar=no, location=no"");</Script>")
    End Sub
    ...
    Sub BindDivisiCode()
		...
		ddldivisikerja.DataSource = objDs.Tables(0)
        ddldivisikerja.DataTextField = "Description"
        ddldivisikerja.DataValueField = "BlkGrpCode"
        ddldivisikerja.DataBind()
