...
Public Class CT_StdRpt_MthlySalesList : Inherits Page
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        Response.Write("<Script Language=""JavaScript"">window.open(""CT_StdRpt_MthlySalesListPreview.aspx?Location=" & strUserLoc & "&RptID=" & strRptID & "&RptName=" & strRptName & _
