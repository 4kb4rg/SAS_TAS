...
Public Class CM_STDRPT_SELECTION_CTRL : Inherits UserControl
    ...
    Sub BindReportNameList()
        ...
        strParam = " WHERE ReportType = '" & Convert.ToString(objGlobal.EnumStdRptType.MillContract) & "' AND Status = '" & Convert.ToString(objGlobal.EnumStdRptStatus.Active) & "'   AND Reportid IN (Select ReportID From SH_REPORT_USER Where UserId='" & strUserId & "') ORDER BY RptName"
        Try
