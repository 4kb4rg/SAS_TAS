...
Public Class AR_StdRpt_CreditNoteList : Inherits Page
    ...
    Sub BindCreditNoteType()
        ...
        ddlCreditNoteType.Items.Add(New ListItem("All",0))
        ddlCreditNoteType.Items.Add(New ListItem(objARTrx.mtdGetCreditNoteDocType(objARTrx.EnumCreditNoteDocType.Auto_Millware), objARTrx.EnumCreditNoteDocType.Auto_Millware))
        ddlCreditNoteType.Items.Add(New ListItem(objARTrx.mtdGetCreditNoteDocType(objARTrx.EnumCreditNoteDocType.Auto_WSJob_Staff), objARTrx.EnumCreditNoteDocType.Auto_WSJob_Staff))
        ddlCreditNoteType.Items.Add(New ListItem(objARTrx.mtdGetCreditNoteDocType(objARTrx.EnumCreditNoteDocType.Auto_WSJob_External), objARTrx.EnumCreditNoteDocType.Auto_WSJob_External))
        ddlCreditNoteType.Items.Add(New ListItem(objARTrx.mtdGetCreditNoteDocType(objARTrx.EnumCreditNoteDocType.Auto_INReturn), objARTrx.EnumCreditNoteDocType.Auto_INReturn)) 
        ddlCreditNoteType.Items.Add(New ListItem(objARTrx.mtdGetCreditNoteDocType(objARTrx.EnumCreditNoteDocType.Manual), objARTrx.EnumCreditNoteDocType.Manual))
        ddlCreditNoteType.Items.Add(New ListItem(objARTrx.mtdGetCreditNoteDocType(objARTrx.EnumCreditNoteDocType.Manual_Millware), objARTrx.EnumCreditNoteDocType.Manual_Millware))
    ...
    Sub BindStatus()
        ...
        ddlStatus.Items.Add(New ListItem(objARTrx.mtdGetCreditNoteStatus(objARTrx.EnumCreditNoteStatus.Active), objARTrx.EnumCreditNoteStatus.Active))
        ddlStatus.Items.Add(New ListItem(objARTrx.mtdGetCreditNoteStatus(objARTrx.EnumCreditNoteStatus.Confirmed), objARTrx.EnumCreditNoteStatus.Confirmed))
        ddlStatus.Items.Add(New ListItem(objARTrx.mtdGetCreditNoteStatus(objARTrx.EnumCreditNoteStatus.Deleted), objARTrx.EnumCreditNoteStatus.Deleted))
        ddlStatus.Items.Add(New ListItem(objARTrx.mtdGetCreditNoteStatus(objARTrx.EnumCreditNoteStatus.Cancelled), objARTrx.EnumCreditNoteStatus.Cancelled))        
        ddlStatus.Items.Add(New ListItem(objARTrx.mtdGetCreditNoteStatus(objARTrx.EnumCreditNoteStatus.Closed), objARTrx.EnumCreditNoteStatus.Closed))        
        ddlStatus.Items.Add(New ListItem(objARTrx.mtdGetCreditNoteStatus(objARTrx.EnumCreditNoteStatus.WrittenOff), objARTrx.EnumCreditNoteStatus.WrittenOff))        
    ...
    Sub GetEntireLangCap()
        ...
        Catch Exp As System.Exception
            Response.Redirect("../../../include/mesg/ErrorMessage.aspx?errcode=AR_STDRPT_CreditNote_LIST_CLSLANGCAR_BUSSTERM_GET&errmesg=" & lblErrMessage.Text & "&redirect=../en/reports/AR_StdRpt_Selection.aspx")
        End Try
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        strCreditNoteType = Trim(ddlCreditNoteType.SelectedItem.value)
        ...
        strCreditNoteType = Server.UrlEncode(strCreditNoteType)
        ...
        Response.Write("<Script Language=""JavaScript"">window.open(""AR_StdRpt_CreditNoteListPreview.aspx?CompName=" & strCompany & "&Location=" & strUserLoc & "&RptID=" & strRptID & "&RptName=" & strRptName & "&Decimal=" & strDec & _
                            ...
                            "&CreditNoteType=" & strCreditNoteType & "&CustomerRef=" & strCustomerRef & "&DeliveryRef=" & strDeliveryRef & _
