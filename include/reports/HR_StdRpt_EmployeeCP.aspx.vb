...
Public Class HR_StdRpt_EmployeeCP : Inherits Page
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        Response.Write("<Script Language=""JavaScript"">window.open(""HR_StdRpt_EmployeeCPPreview.aspx?CompCode=" & strCompany & "&Location=" & strUserLoc & "&RptID=" & strRptID & "&RptName=" & strRptName & "&Decimal=" & strDec & _
                       "&lblLocation=" & lblLocation.Text & "&EmployeeCodeFrom=" & strEmployeeCodeFrom & "&EmployeeCodeTo=" & strEmployeeCodeTo & _
                       "&Status=" & strStatus & "&CPTag=" & lblTitle.Text & """,null ,""status=yes, resizable=yes, scrollbars=yes, toolbar=no, location=no"");</Script>")
    End Sub
