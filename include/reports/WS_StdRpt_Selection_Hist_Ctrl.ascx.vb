...
Public Class WS_StdRpt_Selection_Hist_Ctrl : Inherits UserControl
    ...
    Sub BindReportNameList()
        ...
        strParam = " WHERE ReportType = '" & Convert.ToString(EnumStdRptType.Workshop) & "' AND Status = '" & Convert.ToString(EnumStdRptStatus.Active) & "' ORDER BY RptName"
        Try
