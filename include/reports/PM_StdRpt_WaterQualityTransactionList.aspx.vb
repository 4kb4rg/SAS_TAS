...
Public Class PM_StdRpt_WaterQualityTransactionList : Inherits Page
    ...
    Sub BindMachineList()
        ...
        Dim strParam = "|WHERE Status = '1' AND ProcessCtrl = '1' AND SubBlkCode In (SELECT Machine FROM PM_MACHINE_CRITERIA WHERE UsedFor = '" & objPMSetup.EnumMachineCriteriaFor.WaterQuality & "' GROUP BY Machine) "
        Dim intCnt As Integer
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        Catch Exp As System.Exception
            ...
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=PM_STDRPT_Produced_WaterQuality_GET_CONFIG_DATE&errmesg=" & lblErrMessage.Text & "&redirect=../en/reports/PM_StdRpt_Selection.aspx")
        End Try
        ...
        If Not (strDateFrom = "" And strDateTo = "") Then
            If objGlobal.mtdValidInputDate(strDateSetting, strDateFrom, objDateFormat, objDateFrom) = True And objGlobal.mtdValidInputDate(strDateSetting, strDateTo, objDateFormat, objDateTo) = True Then
                Response.Write("<Script Language=""JavaScript"">window.open(""PM_StdRpt_WaterQualityTransactionListPreview.aspx?Type=Print&Location=" & strUserLoc & "&RptID=" & strRptID & "&RptName=" & strRptName & "&Decimal=" & strDec & _
