...
Public Class NU_StdRpt_SeedDispatchListPreview : Inherits Page
    ...
    Sub BindReport()
        ...
        If Not Request.QueryString("Status") = "" Then
            If Not Request.QueryString("Status") = objNUTrx.EnumSeedDispatchStatus.All Then
        ...
        Try
            intErrNo = objNU.mtdGetReport_SeedDispatchList(strOpCd_GET, strParam, objRptDs, objMapPath)
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=GET_NU_SEEDDISPATCHLIST_REPORT&errmesg=" & lblErrMessage.Text & "&redirect=")
        End Try


        rdCrystalViewer.Load(objMapPath & "web\" & strLangCode & "\Reports\Crystal\NU_StdRpt_SeedDispatchList.rpt", OpenReportMethod.OpenReportByTempCopy)
        ...
        crDiskFileDestinationOptions.DiskFileName = objMapPath & "web\ftp\NU_StdRpt_SeedDispatchList.pdf"
        ...
        Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../ftp/NU_StdRpt_SeedDispatchList.pdf"">")
    End Sub
    ...
    Sub PassParam()
        ...
        paramField20 = paramFields.Item("ParamDocRefNoFrom")
        paramField21 = paramFields.Item("ParamBillPartyCode")
        ...
        ParamDiscreteValue20.Value = Request.QueryString("DocRefNoFrom")
        ParamDiscreteValue21.Value = Request.QueryString("BillPartyCode")
        ParamDiscreteValue22.Value = Request.QueryString("lblBillPartyCode")
