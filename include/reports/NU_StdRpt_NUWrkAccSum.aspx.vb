...
Public Class NU_StdRpt_NUWrkAccSum : Inherits Page
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        Response.Write("<Script Language=""JavaScript"">window.open(""NU_StdRpt_NUWrkAccSumPreview.aspx?Type=Print&CompName=" & strCompany & _
