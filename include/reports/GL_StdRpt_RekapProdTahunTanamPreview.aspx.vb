...
Public Class GL_StdRpt_RekapProdTahunTanamPreview : Inherits Page
    ...
    Sub BindReport()
        ...
        strRptPrefix = "GL_StdRpt_RekapProdTahunTanam"
        strParamName = "ACCMONTH|ACCYEAR|LOCCODE|BLK|BLKGRP|SUBBLK|LEVEL"
        strParamVal = strSelAccMonth & "|" & strSelAccYear & "|" &  strSelLoc & "|" & strSelBlk & "|" & strSelBlkGrp & "|" & strSelSubBlk & "|" & strLevel          
        strOpCd = "GL_STDRPT_REKAPPROD_PERTHNTANAM"
        ...
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=GL_STDRPT_REKAPPRODPERTHNTANAM&errmesg=" & Exp.ToString() & "&redirect=")
        End Try
    ...
    Sub PassParam()
        ...
        ParamDiscreteValue9.Value = UCase(lblLocation)
        ParamDiscreteValue10.Value = strRemarks
        ...
        ParamFieldDef9 = ParamFieldDefs.Item("ParamLocTag")
        ParamFieldDef10 = ParamFieldDefs.Item("ParamDescr")
