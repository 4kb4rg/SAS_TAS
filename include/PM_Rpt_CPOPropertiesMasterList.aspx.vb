...
Public Class PM_Rpt_CPOPropertiesMasterList : inherits page
    ...
    Public Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        strUVTableCode = Trim(Request.QueryString("strUVTableCode"))
        strTemperature = Trim(Request.QueryString("strTemperature"))
        strDensity = Trim(Request.QueryString("strDensity"))
        ...
        UVTableCodeTag = Trim(Request.QueryString("UVTableCodeTag"))
        TemperatureTag = Trim(Request.QueryString("TemperatureTag"))
        DensityTag = Trim(Request.QueryString("DensityTag"))
    ...
    Sub Bind_ITEM(ByVal blnIsPDFFormat As Boolean)
        ...
        Dim strOpCd As String = "PM_CLSSETUP_CPOPROPERTIES_GET"
        ...
        strSearch =  " AND CPOP.Status like '" & IIF(Not strStatus = "", strStatus, "%" ) & "' "

        If NOT strUVTableCode = "" Then
            strSearch =  strSearch & " AND CPOP.UVTableCode like '" & strUVTableCode & "%' "
        End If

        If NOT strTemperature = "" Then
            strSearch =  strSearch & " AND CPOP.Temperature like '" & strTemperature & "%' "
        End If
        
        If NOT strDensity = "" Then
            strSearch = strSearch & " AND CPOP.Density like '" & strDensity & "%' "
        End If
        ...
        Try
            intErrNo = objPM.mtdGetCPOProperties(strOpCd, strParam, objRptDs)
        ...
        For intCnt=0 To objRptDs.Tables(0).Rows.Count - 1
            objRptDs.Tables(0).Rows(intCnt).Item("Status") = objPM.mtdGetCPOPropertiesStatus(objRptDs.Tables(0).Rows(intCnt).Item("Status"))
            objRptDs.Tables(0).Rows(intCnt).Item("UpdateDate") = objGlobal.GetLongDate(objRptDs.Tables(0).Rows(intCnt).Item("UpdateDate"))
        Next

        rdCrystalViewer.Load(objMapPath & "Web\EN\PM\Reports\Crystal\PM_Rpt_CPOPropertiesMasterList.rpt", OpenReportMethod.OpenReportByTempCopy)
        ...
        Else
            ...
            DiskOpts.DiskFileName = objMapPath & "web\ftp\PM_Rpt_CPOPropertiesMasterList.pdf"
            rdCrystalViewer.ExportOptions.DestinationOptions = DiskOpts
            rdCrystalViewer.Export()

            Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../../ftp/PM_Rpt_CPOPropertiesMasterList.pdf"">")
        End If
    ...
    Sub PassParam()
        ...
        paramField4 = ParamFields.Item("TemperatureTag")
        paramField5 = ParamFields.Item("DensityTag")
        paramField6 = ParamFields.Item("ParamUserName")
        paramField7 = ParamFields.Item("UVTableCodeTag")
        ...
        ParamDiscreteValue4.value = TemperatureTag
        ParamDiscreteValue5.value = DensityTag
        ParamDiscreteValue6.value = Session("SS_USERNAME")
        ParamDiscreteValue7.value = UVTableCodeTag
