...
Public Class PR_setup_PrmiGolList_Estate : Inherits Page
    ...
    Protected Function LoadData() As DataSet
        ...
        If Not txtGolID.Text = "" Then
            strSearch = strSearch & " AND A.GolId like '%" & _
                        txtGolID.Text & "%' "
        End If
        ...
        If objBankDs.Tables(0).Rows.Count > 0 Then
            For intCnt = 0 To objBankDs.Tables(0).Rows.Count - 1
                objBankDs.Tables(0).Rows(intCnt).Item("GolId") = Trim(objBankDs.Tables(0).Rows(intCnt).Item("GolId"))
    ...
    Sub DEDR_Delete(ByVal Sender As Object, ByVal e As DataGridCommandEventArgs)
        Dim strOpCd_UPD As String = "PR_PR_STP_PREMI_GOLONGAN_LIST_DEL"
        Dim int As Integer = e.Item.ItemIndex
        Dim GICell As TableCell = e.Item.Cells(0)
    ...
    Sub NewAstekBtn_Click(ByVal Sender As Object, ByVal E As ImageClickEventArgs)
        Response.Redirect("PR_setup_PrmiGolDet_Estate.aspx")
    End Sub
