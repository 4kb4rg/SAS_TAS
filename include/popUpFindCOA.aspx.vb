...
Public Class PopUpFindCOA : Inherits Page
    ...
    Protected WithEvents lblNameCOA As System.Web.UI.WebControls.Label
    ...
    Sub Page_Load(ByVal Sender As Object, ByVal E As EventArgs)
        ...
        StrCoaName = Request.QueryString("inicoaname")
    ...
    Protected Function LoadData() As DataSet
        ...
        Dim strOpCode As String = "IN_CLSTRX_COA_SEARCH"
        ...
        strSortExp = " ORDER BY AccCode ASC"

        strParamName = "SEARCH|LOCCODE|SORTEXP"
        If txtItemCode.Text = "" Then
            strParamValue = "" & "|" & IIf(Session("SS_COACENTRALIZED") = "1", " COALevel = '2' AND ", " LocCode = '" & Trim(strLocCode) & "' AND COALevel = '2' AND ") & "|" & strSortExp
        Else
            strParamValue = "%" & txtItemCode.Text & "%|" & IIf(Session("SS_COACENTRALIZED") = "1", " COALevel = '2' AND  ", " LocCode = '" & Trim(strLocCode) & "' AND COALevel = '2' AND ") & "|" & strSortExp
        End If
    ...
    Sub OnSelectItem(ByVal Sender As Object, ByVal e As DataGridCommandEventArgs)
        ...
        If Left(strINItem, 3) = "txt" Then
            ...
            lblNameCOA.Text = Trim(strName)

            opener_findtextbox()
            opener_dropdownval(strINItem, txtItemCode.Text)
            opener_dropdownval(StrCoaName, lblNameCOA.Text)
        ...
        If Left(strINItem, 3) = "txt" Then
            ...
            onclick_reload_txt(StrCoaName, lblNameCOA.Text, False, blnPostBack)
        Else
