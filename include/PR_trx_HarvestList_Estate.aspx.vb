...
Public Class PR_HarvestList : Inherits Page
    ...
    Protected WithEvents lbtotal As TextBox

    Protected WithEvents ddlEmpDiv As DropDownList
    Protected WithEvents ddlEmpBlock As DropDownList
    ...
    Dim objEmpBlockDs As New Object()
    Dim cnt As Double
    ...
    Sub BindGrid()
        ...
        'For intCnt = 0 To dgEmpList.Items.Count - 1
        '    lbtot = dgEmpList.Items.Item(intCnt).FindControl("lbtotal")

        '    lbtot.Text = "zz" 'objGlobal.GetIDDecimalSeparator_FreeDigit(cnt, 0)
    ...
    Protected Function LoadData() As DataSet
        Dim strOpCd_Get As String = "PR_PR_TRX_EMPHVS_LIST_GET"
        ...
        For intCnt = 0 To objEmpDs.Tables(0).Rows.Count - 1
            ...
            cnt = cnt + objEmpDs.Tables(0).Rows(intCnt).Item("Total")
        Next
    ...
    Sub NewEmpBtn_Click(ByVal Sender As Object, ByVal E As ImageClickEventArgs)
        Response.Redirect("PR_trx_HarvestDet_Estate.aspx?redirect=empdet")
    End Sub

    Sub KeepRunningSum(ByVal sender As Object, ByVal E As DataGridItemEventArgs)
        If E.Item.ItemType = ListItemType.Footer Then
            E.Item.Cells(9).Text = objGlobal.GetIDDecimalSeparator_FreeDigit(cnt, 0)
        End If
