...
Public Class IN_data_trx_savefile : inherits page
    ...
    Sub Page_Load(Sender As Object, E As EventArgs)
        ...
        ElseIf objAR.mtdHasAccessRights(objAR.mtdGetAccessRights(objAR.EnumINAccessRights.INDownload), intINAR) = False Then
    ...
    Sub SaveFile()
        ...
        Dim strOpCode As String = "IN_CLSDATA_MTHENDTRX_DOWNLOAD"
        Dim strFtpPath As String
        Dim strXmlPath As String = ""
        Dim strXmlFileName As String = objGlobal.mtdGenerateDownloadFile(objGlobal.EnumMthEnd.INMthEnd, False)
        ...
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=INDATA_TRX_GET_FTPPATH&errmesg=&redirect=")
        End Try

        Try
            strParam = strParam & strOpCode & "|" & objInData.mtdGetDownloadTable(objInData.EnumDownloadType.INMthEndTrx)
            intErrNo = objInData.mtdDownloadRef(strCompany, _
                                                ...
                                                objDownloadDs)
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=INDATA_TRX_DOWNLOAD_REF&errmesg=&redirect=")
        End Try
        ...
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=INDATA_TRX_ENCRYPT_REF&errmesg=&redirect=")
        End Try

        Try
            strParam = objGlobal.EnumModule.Inventory & "|" & objAdmShare.EnumMthEndPost.Yes
            intErrNo = objAdmShare.mtdUpdMonthEndPosted(strCompany, _
                                                        ...
                                                        intPosted)
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=INDATA_TRX_POSTED_UPD&errmesg=&redirect=")
        End Try

        If intPosted = 2 Then
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=INDATA_TRX_NOT_CLOSED&errmesg=&redirect=")
        Else
