...
Public Class IN_Rpt_ProdTypeList : inherits page
    ...
    Public Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        strProdTypeCode = Trim(Request.QueryString("strProdTypeCode"))
        ...
        ProdTypeCodeTag = Trim(Request.QueryString("ProdTypeCodeTag"))
        ProdTypeDescTag = Trim(Request.QueryString("ProdTypeDescTag"))
    ...
    Sub Bind_ITEM(ByVal blnIsPDFFormat As Boolean)
        ...
        Dim strOpCd As String = "IN_CLSSETUP_PRODTYPE_LIST_GET_FOR_REPORT"
        ...
        strSearch =  " AND PType.Status like '" & IIF(Not strStatus = "", strStatus, "%" ) &"' "

        If NOT strProdTypeCode = "" Then
            strSearch =  strSearch & " AND PType.ProdTypeCode like '" & strProdTypeCode & "%' "
        End If
        
        If NOT strDescription = "" Then
            strSearch = strSearch & " AND PType.Description like '" & _
                        strDescription &"%' "
        End If
        ...
        Try
            intErrNo = objInventory.mtdGetMasterList(strOpCd, _
                                                     strParam, _
                                                     EnumInventoryMasterType.ProductType, _
                                                     objRptDs)
        ...
        For intCnt=0 To objRptDs.Tables(0).Rows.Count - 1
            objRptDs.Tables(0).Rows(intCnt).Item("Status") = objInventory.mtdGetProductTypeStatus(objRptDs.Tables(0).Rows(intCnt).Item("Status"))
        ...
        rdCrystalViewer.Load(objMapPath & "Web\EN\IN\Reports\Crystal\In_Rpt_ProdTypeList.rpt", OpenReportMethod.OpenReportByTempCopy)
        ...
        Else
            ...
            DiskOpts.DiskFileName = objMapPath & "web\ftp\In_Rpt_ProdTypeList.pdf"
            rdCrystalViewer.ExportOptions.DestinationOptions = DiskOpts
            rdCrystalViewer.Export()

            Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../../ftp/In_Rpt_ProdTypeList.pdf"">")
        End If
    ...
    Sub PassParam()
        ...
        paramField2 = ParamFields.Item("ProdTypeCodeTag")
        paramField3 = ParamFields.Item("ProdTypeDescTag")
        ...
        ParamDiscreteValue2.value = ProdTypeCodeTag
        ParamDiscreteValue3.value = ProdTypeDescTag
