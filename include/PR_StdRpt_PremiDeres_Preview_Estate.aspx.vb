...
Public Class PR_StdRpt_PremiDeres_Preview_Estate : Inherits Page
    ...
    Sub BindReport()
        ...
        Dim strOpCd As String = "PR_PR_STDRPT_PREMIDERES_REPORT"
        ...
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=PR_PR_STDRPT_PREMIDERES_REPORT&errmesg=" & lblErrMessage.Text & "&redirect=")
        End Try

        rdCrystalViewer.Load(objMapPath & "web\" & strLangCode & "\reports\crystal\PR_StdRpt_PremiDeres.rpt", OpenReportMethod.OpenReportByTempCopy)

        objRptDs.Tables(0).TableName = "PR_StdRpt_Premi_Deres"
        objRptDs.Tables(1).TableName = "PR_StdRpt_Premi_Mandor"
        objRptDs.Tables(2).TableName = "PR_StdRpt_Premi_KCS"
        ...
        crDiskFileDestinationOptions.DiskFileName = objMapPath & "web\ftp\PR_StdRpt_PremiDeres.pdf"
        ...
        Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../ftp/PR_StdRpt_PremiDeres.pdf"">")
    End Sub
