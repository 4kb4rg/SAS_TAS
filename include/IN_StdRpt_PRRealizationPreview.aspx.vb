...
Public Class IN_StdRpt_PRRealizationPreview : Inherits Page
    ...
    Sub BindReport()
        ...
        ElseIf Request.QueryString("PRStatus") = "Outstanding" Then
            SearchStr = SearchStr & "AND PR.Status NOT IN ('" & objINTrx.EnumPurReqStatus.Deleted & "','" & objINTrx.EnumPurReqStatus.Cancelled & "') "
        End If
        ...
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=GET_IN_PR_REALIZATION_REPORT&errmesg=" & lblErrMessage.Text & "&redirect=")
        End Try



        rdCrystalViewer.Load(objMapPath & "web\" & strLangCode & "\Reports\Crystal\IN_StdRpt_PRRealization.rpt", OpenReportMethod.OpenReportByTempCopy)
        ...
        crDiskFileDestinationOptions.DiskFileName = objMapPath & "web\ftp\IN_StdRpt_PRRealization.pdf"
        ...
        Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../ftp/IN_StdRpt_PRRealization.pdf"">")
    End Sub
