...
Public Class PR_MuatTBSList : Inherits Page
    ...
    Protected Function LoadData() As DataSet
        Dim strOpCd_Get As String = "PR_PR_TRX_EMPMTB_LIST_GET"
    ...
    Sub NewEmpBtn_Click(ByVal Sender As Object, ByVal E As ImageClickEventArgs)
        Response.Redirect("PR_trx_MuatTBSDet_Estate.aspx")
    End Sub
