...
Public Class GL_Rpt_SubActivity : inherits page
    ...
    Public Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        strSubActCodeTag = Trim(Request.QueryString("strSubActCodeTag"))  
        ...
        strSubActCode = Trim(Request.QueryString("strSubActCode"))
    ...
    Sub Bind_ITEM(ByVal blnIsPDFFormat As Boolean)
        ...
        Dim strOpCd As String = "GL_CLSSETUP_SUBACTIVITY_LIST_GET"
        ...
        Try
            intErrNo = objGLSetup.mtdGetSubActivity(strOpCd, strParam, objRptDs, False)

        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=GL_RPT_SUBACTIVITY_GET&errmesg=" & lblErrMesage.Text & "&redirect=")
        End Try
        ...
        For intCnt=0 To objRptDs.Tables(0).Rows.Count - 1
            objRptDs.Tables(0).Rows(intCnt).Item("SubActCode") = Trim(objRptDs.Tables(0).Rows(intCnt).Item("SubActCode"))
        ...
        For intCnt=0 To objRptDs.Tables(0).Rows.Count - 1
            objRptDs.Tables(0).Rows(intCnt).Item("Status") = objGLSetup.mtdGetSubActStatus(objRptDs.Tables(0).Rows(intCnt).Item("Status"))
            objRptDs.Tables(0).Rows(intCnt).Item("UpdateDate") = objGlobal.GetLongDate(objRptDs.Tables(0).Rows(intCnt).Item("UpdateDate"))
        Next


        rdCrystalViewer.Load(objMapPath & "Web\EN\GL\Reports\Crystal\GL_Rpt_SubActivity.rpt", OpenReportMethod.OpenReportByTempCopy)
        ...
        Else
            ...
            DiskOpts.DiskFileName = objMapPath & "web\ftp\GL_Rpt_SubActivity.pdf"
            rdCrystalViewer.ExportOptions.DestinationOptions = DiskOpts
            rdCrystalViewer.Export()

            Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../../ftp/GL_Rpt_SubActivity.pdf"">")
        End If
    ...
    Sub PassParam()
        ...
        paramField3 = ParamFields.Item("strSubActCodeTag")
        paramField4 = ParamFields.Item("strDescTag")
        paramField5 = ParamFields.Item("strTitleTag")
        paramField6 = ParamFields.Item("strActCodeTag")
        ...
        ParamDiscreteValue3.value = strSubActCodeTag
        ParamDiscreteValue4.value = strDescTag
        ParamDiscreteValue5.value = UCase(strTitleTag)
        ParamDiscreteValue6.value = strActCodeTag
