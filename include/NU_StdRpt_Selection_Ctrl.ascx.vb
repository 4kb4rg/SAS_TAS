...
Public Class NU_StdRpt_Selection_Ctrl : Inherits UserControl
    ...
    Sub BindReportNameList()
        ...
        strParam = " WHERE ReportType = '" & Convert.ToString(objGlobal.EnumStdRptType.Nursery) & "' AND Status = '" & Convert.ToString(objGlobal.EnumStdRptStatus.Active) & "' And  ReportID IN (SELECT ReportID FROM SH_REPORT_USER Where UserID='" & strUserId & "') ORDER BY RptName"
        Try
