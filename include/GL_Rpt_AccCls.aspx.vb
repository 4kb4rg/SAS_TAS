...
Public Class GL_Rpt_AccCls : inherits page
    ...
    Public Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        strAccClsCode = Trim(Request.QueryString("strAccClsCode"))
        ...
        AccClsTag = Trim(Request.QueryString("AccClsTag"))
        AccClsDescTag = Trim(Request.QueryString("AccClsDescTag"))
        AccClsGrpTag = Trim(Request.QueryString("AccClsGrpTag"))
    ...
    Sub Bind_ITEM(ByVal blnIsPDFFormat As Boolean)
        ...
        If NOT strAccClsCode = "" Then
            strSearch =  strSearch & " AND Acc.AccClsCode like '" & strAccClsCode & "%' "
        End If
        
        If NOT strDescription = "" Then
            strSearch = strSearch & " AND Acc.Description like '" & _
                        strDescription &"%' "
        End If
        ...
        For intCnt=0 To objRptDs.Tables(0).Rows.Count - 1
            objRptDs.Tables(0).Rows(intCnt).Item("Status") = objGLSetup.mtdGetAccClsStatus(objRptDs.Tables(0).Rows(intCnt).Item("Status"))
            objRptDs.Tables(0).Rows(intCnt).Item("UpdateDate") = objGlobal.GetLongDate(objRptDs.Tables(0).Rows(intCnt).Item("UpdateDate"))
        Next

        rdCrystalViewer.Load(objMapPath & "Web\EN\GL\Reports\Crystal\GL_Rpt_AccCls.rpt", OpenReportMethod.OpenReportByTempCopy)
        ...
        Else
            ...
            DiskOpts.DiskFileName = objMapPath & "web\ftp\GL_Rpt_AccCls.pdf"
            rdCrystalViewer.ExportOptions.DestinationOptions = DiskOpts
            rdCrystalViewer.Export()

            Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../../ftp/GL_Rpt_AccCls.pdf"">")
        End If
    ...
    Sub PassParam()
        ...
        paramField4 = ParamFields.Item("AccClsTag")
        paramField5 = ParamFields.Item("AccClsDescTag")
        paramField6 = ParamFields.Item("AccClsGrpTag")
        ...
        ParamDiscreteValue4.value = AccClsTag
        ParamDiscreteValue5.value = AccClsDescTag
        ParamDiscreteValue6.value = AccClsGrpTag
