...
Public Class HR_StdRpt_Penerimaan_Kary_Estate : Inherits Page
    ...
    Protected WithEvents txtTrxDateSD As TextBox
    Protected WithEvents txtTrxDateED As TextBox
    ...
    Sub Page_Load(ByVal Sender As Object, ByVal E As EventArgs)
        ...
        Else
            If Not Page.IsPostBack Then
                txtTrxDateSD.Text = objGlobal.GetShortDate(strDateFmt, Now())
                txtTrxDateED.Text = objGlobal.GetShortDate(strDateFmt, Now())
                BindDivisiCode()
            End If
        End If
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        strFrom = Date_Validation(txtTrxDateSD.Text.Trim, False)
        strTo = Date_Validation(txtTrxDateED.Text.Trim, False)


        If strFrom = "" Then
            lblErrMessage.Visible = True
            lblErrMessage.Text = "Silakan input tanggal mulai !"
            Exit Sub
        End If

        If strTo = "" Then
            lblErrMessage.Visible = True
            lblErrMessage.Text = "Silakan input tanggal akhir !"
            Exit Sub
        End If
        ...
        Response.Write("<Script Language=""JavaScript"">window.open(""HR_StdRpt_Penerimaan_KaryPreview_Estate.aspx?CompCode=" & strCompany & "&Location=" & strUserLoc & "&RptID=" & strRptID & "&RptName=" & strRptName & "&Decimal=" & strDec & _
