...
Public Class GL_data_trx_savefile : inherits page
    ...
    Sub SaveFile()
        ...
        Dim strOpCode_MthEnd As String = "GL_CLSDATA_MTHENDTRX_DOWNLOAD"
        Dim strFtpPath As String
        Dim strXmlPath As String = ""
        Dim strXmlFileName As String = objGlobal.mtdGenerateDownloadFile(objGlobal.EnumMthEnd.GLMthEnd, False)
        ...
        Try
            strParam = strParam & strOpCode_VehUsg & "|" & objGLData.mtdGetDownloadTable(objGLData.EnumDownloadType.VehUsage) & Chr(9) & _
                                  strOpCode_VehUsgLn & "|" & objGLData.mtdGetDownloadTable(objGLData.EnumDownloadType.VehUsageLn) & Chr(9) & _
                                  strOpCode_MthEnd & "|" & objGLData.mtdGetDownloadTable(objGLData.EnumDownloadType.SHMthEndTrxTmp)
        ...
        Try
            strParam = objGlobal.EnumModule.GeneralLedger & "|" & objAdmShare.EnumMthEndPost.Yes
            intErrNo = objAdmShare.mtdUpdMonthEndPosted(strCompany, _
                                                        ...
                                                        intPosted)
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=GLDATA_TRX_POSTED_UPD&errmesg=&redirect=")
        End Try

        If intPosted = 2 Then
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=GLDATA_TRX_NOT_CLOSED&errmesg=&redirect=")
        Else
