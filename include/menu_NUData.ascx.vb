...
Public Class menu_NU_Data : Inherits UserControl
    ...
    Sub Page_Load(Sender As Object, E As EventArgs)
        ...
        If strScriptName = "menu_nudata_page.aspx" Then
        ...
        If (objAR.mtdHasAccessRights(objAR.mtdGetAccessRights(objAR.EnumNUAccessRights.NUDataTransfer), intNUAR) = True) Then
            strHrefDownload = "<a class=mt-t href=""/" & Session("SS_LANGCODE") & "/NU/data/NU_data_download.aspx"" target=_self>Download Reference File</a>"
            strHrefUpload = "<a class=mt-t href=""/" & Session("SS_LANGCODE") & "/NU/data/NU_data_upload.aspx"" target=_self>Upload Reference File</a>"
        Else
