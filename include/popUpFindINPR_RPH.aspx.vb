...
Public Class popUpFindINPR_RPH : Inherits Page
    ...
    Protected Function LoadData() As DataSet
        ...
        'sSQLKriteria = "AND A.PrType NOT IN('2') AND A.PRID LIKE '%" & nItem & "%'"
		sSQLKriteria = "AND B.Status Not IN ('2', '5') AND A.PrType NOT IN('2') AND (A.PRID LIKE '%" & nItem & "%' OR B.ItemCode LIKE '%" & nItem & "%' OR C.Description LIKE '%" & nItem & "%')"
        strParamName = "LOCCODE|USERPO|STRSEARCH"
        strParamValue = "" & Trim(strLocCode) & "|" & strUserId & "|" & sSQLKriteria
