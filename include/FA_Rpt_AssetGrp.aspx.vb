...
Public Class FA_Rpt_AssetGrp : Inherits Page
    ...
    Public Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        AssetGrpCodeTag = Trim(Request.QueryString("AssetGrpCodeTag"))
    ...
    Sub Bind_ITEM(ByVal blnIsPDFFormat As Boolean)
        ...
        Try
            intErrNo = objFASetup.mtdGetAssetGrp(strOpCd, _
                                                   strParam, _
                                                   objRptDs)
        ...
        For intCnt = 0 To objRptDs.Tables(0).Rows.Count - 1
            objRptDs.Tables(0).Rows(intCnt).Item("Status") = objFASetup.mtdGetAssetGrpStatus(objRptDs.Tables(0).Rows(intCnt).Item("Status"))
            objRptDs.Tables(0).Rows(intCnt).Item("UpdateDate") = objGlobal.GetLongDate(objRptDs.Tables(0).Rows(intCnt).Item("UpdateDate"))
        Next

        rdCrystalViewer.Load(objMapPath & "Web\EN\FA\Reports\Crystal\FA_Rpt_AssetGrp.rpt", OpenReportMethod.OpenReportByTempCopy)
        ...
        Else
            ...
            DiskOpts.DiskFileName = objMapPath & "web\ftp\FA_Rpt_AssetGrp.pdf"
            rdCrystalViewer.ExportOptions.DestinationOptions = DiskOpts
            rdCrystalViewer.Export()

            Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../../ftp/FA_Rpt_AssetGrp.pdf"">")
        End If
    ...
    Sub PassParam()
        ...
        paramField4 = paramFields.Item("AssetGrpCodeTag")
        ...
        ParamDiscreteValue4.Value = AssetGrpCodeTag
