...
Public Class PR_StdRpt_MedicalPreview : Inherits Page
    ...
    Sub Page_Load(ByVal Sender As Object, ByVal E As EventArgs)
        ...
        strAccMonthTo = "'" & Trim(Request.QueryString("AccMonthTo")) & "'"
    ...
    Sub BindReport()
        ...
        Dim strOpCdMedicalListGet As String = "PR_STDRPT_MEDICAL_LIST"
        ...
        If strEmpCode <> "" Then
             SearchStr = SearchStr & " AND e.EmpCode in ('" & strEmpCode & "')"
        End If

        strParam = SearchStr & "|" & ReportID  & "|" & strAccMonth & "|" & strAccMonthTo  & "|" &  strAccYear                                   

        Try
            intErrNo = objPRRpt.mtdGetReport_MedicalList(strOpCdMedicalListGet, _
                                                           strCompany, _
                                                           strLocation, _
                                                           strUserId, _
                                                           strAccMonth, _
        ...
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=PR_STDRPT_MEDICAL_LIST_REPORT&errmesg=" & lblErrMessage.Text & "&redirect=")
        End Try

        rdCrystalViewer.Load(objMapPath & "web\" & strLangCode & "\Reports\Crystal\PR_StdRpt_MedicalListing.rpt", OpenReportMethod.OpenReportByTempCopy)
        ...
        crDiskFileDestinationOptions.DiskFileName = objMapPath & "web\ftp\PR_StdRpt_MedicalListing.pdf"
        ...
        Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../ftp/PR_StdRpt_MedicalListing.pdf"">")
    End Sub
    ...
    Sub PassParam()
        ...
        ParamDiscreteValue7.Value = strAccMonth & "/" & strAccYear
