...
Public Class HR_Setup_ICType : Inherits Page
    ...
    Protected WithEvents srchICTypeCode as TextBox
    ...
    Dim strOppCd_GET As String = "HR_CLSSETUP_ICTYPE_LIST_GET"
    ...
    Sub Page_Load(Sender As Object, E As EventArgs)
        ...
        Else
            ...
            If SortExpression.text = "" Then
                SortExpression.text = "ICTypeCode"
                sortcol.text = "ASC"
            End If
    ...
    Protected Function LoadData() As DataSet
        ...
        If NOT srchICTypeCode.text = "" Then
            SearchStr =  SearchStr & " AND IC.ICTypeCode like '" & srchICTypeCode.text &"%' "
        End If
    ...
    Sub DEDR_Edit(Sender As Object, E As DataGridCommandEventArgs)
        ...
        Select Case cint(Edittext.text) = objHR.EnumICTypeStatus.Active
            Case True
                ...
                EditText = EventData.Items.Item(CInt(e.Item.ItemIndex)).FindControl("ICTypeCode")
    ...
    Sub DEDR_Update(Sender As Object, E As DataGridCommandEventArgs)
        ...
        EditText = E.Item.FindControl("ICTypeCode")
        ICTypeCode = EditText.Text
