...
Public Class PM_Rpt_StorageAreaMasterList : inherits page
    ...
    Public Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        StorageAreaCodeTag = Trim(Request.QueryString("StorageAreaCodeTag"))
    ...
    Sub Bind_ITEM(ByVal blnIsPDFFormat As Boolean)
        ...
        Dim strOpCd As String = "PM_CLSSETUP_STORAGEAREA_GET"
        ...
        strSearch =  " AND SA.Status like '" & IIF(Not strStatus = "", strStatus, "%" ) & "' AND SA.LocCode='" & strLocation & "'"

        If NOT strStorageAreaCode = "" Then
            strSearch =  strSearch & " AND SA.StorageAreaCode like '" & strStorageAreaCode & "%' "
        End If
        ...
        Try
            intErrNo = objPM.mtdGetStorageArea(strOpCd, strParam, objRptDs)
        ...
        For intCnt=0 To objRptDs.Tables(0).Rows.Count - 1
            objRptDs.Tables(0).Rows(intCnt).Item("Status") = objPM.mtdGetStorageAreaStatus(objRptDs.Tables(0).Rows(intCnt).Item("Status"))
            objRptDs.Tables(0).Rows(intCnt).Item("UpdateDate") = objGlobal.GetLongDate(objRptDs.Tables(0).Rows(intCnt).Item("UpdateDate"))
        Next

        rdCrystalViewer.Load(objMapPath & "Web\EN\PM\Reports\Crystal\PM_Rpt_StorageAreaMasterList.rpt", OpenReportMethod.OpenReportByTempCopy)
        ...
        Else
            ...
            DiskOpts.DiskFileName = objMapPath & "web\ftp\PM_Rpt_StorageAreaMasterList.pdf"
            rdCrystalViewer.ExportOptions.DestinationOptions = DiskOpts
            rdCrystalViewer.Export()

            Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../../ftp/PM_Rpt_StorageAreaMasterList.pdf"">")
        End If
    ...
    Sub PassParam()
        ...
        paramField4 = ParamFields.Item("StorageAreaCodeTag")
        paramField5 = ParamFields.Item("StorageTypeTag")
        ...
        ParamDiscreteValue4.value = StorageAreaCodeTag
