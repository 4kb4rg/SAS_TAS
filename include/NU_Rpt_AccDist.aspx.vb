...
Public Class NU_Rpt_AccDist : Inherits Page
    ...
    Sub Bind_ITEM(ByVal blnIsPDFFormat As Boolean)
        ...
        Dim strOpCd As String = "NU_CLSSETUP_ACCDIST_LIST_GET"
        ...
        Try
            intErrNo = objNUSetup.mtdGetAccDist(strOpCd, _
                                                   strParam, _
                                                   objRptDs)
        ...
        For intCnt = 0 To objRptDs.Tables(0).Rows.Count - 1
            objRptDs.Tables(0).Rows(intCnt).Item("AccCode") = objRptDs.Tables(0).Rows(intCnt).Item("AccCode").Trim()
        ...
        rdCrystalViewer.Load(objMapPath & "Web\EN\NU\Reports\Crystal\NU_Rpt_AccDist.rpt", OpenReportMethod.OpenReportByTempCopy)
        ...
        Else
            ...
            DiskOpts.DiskFileName = objMapPath & "web\ftp\NU_Rpt_AccDist.pdf"
            rdCrystalViewer.ExportOptions.DestinationOptions = DiskOpts
            rdCrystalViewer.Export()

            Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../../ftp/NU_Rpt_AccDist.pdf"">")
        End If
    ...
    Sub PassParam()
        ...
        paramField4 = paramFields.Item("AccCodeTag")
        paramField5 = paramFields.Item("NurseryStageTag")
        ...
        ParamDiscreteValue5.Value = NurseryStageTag
