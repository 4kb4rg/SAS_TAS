...
Public Class WM_StdRpt_FFBRcv_SumBySupplierPreview : Inherits Page
    ...
    Sub BindReport()
        ...
        Dim strOpCd_FFBRcvSum_BySupplier_GET As String = "WM_STDRPT_FFBRCVSUM_BYSUPPLIER_GET"
        Dim strFileName As String = "WM_StdRpt_FFBRcvSumBySupplier"
        Dim strParamName As String = ""
        Dim strParam As String
        Dim searchStr As String
        Dim suptipe As String
        ...
        If Not Request.QueryString("SuppType") = objPUSetup.EnumSupplierType.All Then
            suptipe = " & Request.QueryString("SuppType") & "
        End If
        ...
        strParam = Replace(strUserLoc, "'", "''") & "|" & _
                   ...
                   Replace(searchStr, "'", "''")
        Try
            intErrNo = objOk.mtdGetReportDataCommon(strOpCd_FFBRcvSum_BySupplier_GET, strParamName, strParam, dsSupplier, objMapPath, objFTPFolder)
