...
Public Class GL_Setup_VehicleSubGrpCode : Inherits Page
    ...
    Protected WithEvents srchVehExpGrpCd As TextBox
    ...
    Dim strOppCd_GET As String = "GL_CLSSETUP_VEHSUBGROUP_LIST_SEARCH"
    Dim strOppCd_ADD As String = "GL_CLSSETUP_VEHSUBGROUP_LIST_ADD"
    Dim strOppCd_UPD As String = "GL_CLSSETUP_VEHSUBGROUP_LIST_UPD"
    ...
    Sub Page_Load(ByVal Sender As Object, ByVal E As EventArgs)
        ...
        ElseIf objAR.mtdHasAccessRights(objAR.mtdGetAccessRights(objAR.EnumGLAccessRights.GLVehicleExpenseGrp), intGLAR) = False Then
            Response.Redirect("/" & strLangCode & "/include/mesg/AccessRights.aspx")

        Else
            onload_GetLangCap()
            If SortExpression.Text = "" Then
                SortExpression.Text = "VehExpGrpCode"
                sortcol.Text = "ASC"
            End If
    ...
    Sub onload_GetLangCap()
        GetEntireLangCap()
        lblTitle.Text = UCase(GetCaption(objLangCap.EnumLangCap.VehExpGrp) & lblCode.Text)
        lblVehExpGrpCode.Text = GetCaption(objLangCap.EnumLangCap.VehExpGrp) & lblCode.Text
        lblDescription.Text = GetCaption(objLangCap.EnumLangCap.VehExpGrpDesc)
        strValidateCode = lblPleaseEnter.Text & lblVehExpGrpCode.Text & "."
        strValidateDesc = lblPleaseEnter.Text & lblDescription.Text & "."

        EventData.Columns(0).HeaderText = lblVehExpGrpCode.Text
    ...
    Sub BindStatusList(ByVal index As Integer)
        ...
        StatusList.Items.Add(New ListItem(objGLSetup.mtdGetVehicleExpenseGrpStatus(objGLSetup.EnumVehicleExpenseGrpStatus.Active), objGLSetup.EnumVehicleExpenseGrpStatus.Active))
        StatusList.Items.Add(New ListItem(objGLSetup.mtdGetVehicleExpenseGrpStatus(objGLSetup.EnumVehicleExpenseGrpStatus.Deleted), objGLSetup.EnumVehicleExpenseGrpStatus.Deleted))
    End Sub

    Sub BindSearchList()
        srchStatus.Items.Add(New ListItem(objGLSetup.mtdGetVehicleExpenseGrpStatus(objGLSetup.EnumVehicleExpenseGrpStatus.All), objGLSetup.EnumVehicleExpenseGrpStatus.All))
        srchStatus.Items.Add(New ListItem(objGLSetup.mtdGetVehicleExpenseGrpStatus(objGLSetup.EnumVehicleExpenseGrpStatus.Active), objGLSetup.EnumVehicleExpenseGrpStatus.Active))
        srchStatus.Items.Add(New ListItem(objGLSetup.mtdGetVehicleExpenseGrpStatus(objGLSetup.EnumVehicleExpenseGrpStatus.Deleted), objGLSetup.EnumVehicleExpenseGrpStatus.Deleted))
    ...
    Protected Function LoadData() As DataSet
        ...
        SearchStr = " AND Acc.Status like '" & IIf(srchStatus.SelectedItem.Value <> objGLSetup.EnumVehicleExpenseGrpStatus.All, srchStatus.SelectedItem.Value, "%") & "' "

        If Not srchVehExpGrpCd.Text = "" Then
            SearchStr = SearchStr & " AND Acc.VehExpGrpCode like '" & srchVehExpGrpCd.Text & "%'"
        End If
        ...
        Try
            intErrNo = objGLSetup.mtdGetMasterList(strOppCd_GET, strParam, objGLSetup.EnumGLMasterType.VehicleExpenseGrp, objDataSet)
        Catch Exp As System.Exception
            Response.Redirect("../../../include/mesg/ErrorMessage.aspx?errcode=GL_SETUP_GET_VEHEXPGRPCODE&errmesg=" & Exp.ToString() & "&redirect=GL/Setup/GL_Setup_VehicleSubGrpCode.aspx")
        End Try
        Return objDataSet
    End Function
    ...
    Sub btnPreview_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        strStatus = IIf(Not srchStatus.SelectedItem.Value = objGLSetup.EnumVehicleExpenseGrpStatus.All, srchStatus.SelectedItem.Value, "")
        strVehExpGrpCode = srchVehExpGrpCd.Text
    ...
    Sub DEDR_Edit(ByVal Sender As Object, ByVal e As DataGridCommandEventArgs)
        ...
        Select Case CInt(txtEditText.Text) = objGLSetup.EnumVehicleExpenseGrpStatus.Active
            Case True
                ...
                txtEditText = EventData.Items.Item(CInt(e.Item.ItemIndex)).FindControl("VehExpGrpCode")
    ...
    Sub DEDR_Delete(ByVal Sender As Object, ByVal E As DataGridCommandEventArgs)
        ...
        strStatus = IIf(txtEditText.Text = objGLSetup.EnumVehicleExpenseGrpStatus.Active, _
                        objGLSetup.EnumVehicleExpenseGrpStatus.Deleted, _
                        objGLSetup.EnumVehicleExpenseGrpStatus.Active)
        txtEditText = E.Item.FindControl("CreateDate")
        strCreateDate = txtEditText.Text
        strParam = strVehExpGrpCode & "|" & _
                    strDescription & "|" & _
