...
Public Class HR_trx_ResignList_Estate : Inherits Page
    ...
    Sub Page_Load(ByVal Sender As Object, ByVal E As EventArgs)
        ...
        Else
            If SortExpression.Text = "" Then
                SortExpression.Text = "ResignCode"
            End If
    ...
    Sub BindGrid()
        ...
        For intCnt = 0 To dgLine.Items.Count - 1
            lbl = dgLine.Items.Item(intCnt).FindControl("lbStatus")
    ...
    Protected Function LoadData() As DataSet
        Dim strOpCd_GET As String = "HR_HR_TRX_EMPRESIGN_GET"
        ...
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=HR_HR_TRX_EMPRESIGN_GET&errmesg=" & lblErrMessage.Text & "&redirect=")
        End Try
    ...
    Sub DEDR_Delete(ByVal Sender As Object, ByVal e As DataGridCommandEventArgs)
        Dim strOpCd_UPD As String = "HR_HR_TRX_EMPRESIGN_DEL"
        ...
        strid = DivCell.Text
        EditText = dgLine.Items.Item(int).FindControl("lstatus")
    ...
    Sub NewBtn_Click(ByVal Sender As Object, ByVal E As ImageClickEventArgs)
        Response.Redirect("HR_trx_ResignDet_Estate.aspx")
    End Sub
    ...
    Function Kategori(ByVal b As String) As String
        Dim s As String = ""
        Select Case Trim(b)
            Case "1" : s = "Pindah PT"
            Case "2" : s = "Kecelakaan"
            Case "3" : s = "Meninggal Dunia"
            Case "4" : s = "Lain-lain"
