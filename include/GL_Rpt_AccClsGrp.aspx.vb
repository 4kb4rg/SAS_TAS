...
Public Class GL_Rpt_AccClsGrp : inherits page
    ...
    Public Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        strAccClsGrpCode = Trim(Request.QueryString("strAccClsGrpCode"))
        ...
        AccClsGrpDescTag = Trim(Request.QueryString("AccClsGrpDescTag"))
    ...
    Sub Bind_ITEM(ByVal blnIsPDFFormat As Boolean)
        ...
        If NOT strAccClsGrpCode = "" Then
            strSearch =  strSearch & " AND Acc.AccClsGrpCode like '" & strAccClsGrpCode & "%' "
        End If
        ...
        For intCnt=0 To objRptDs.Tables(0).Rows.Count - 1
            objRptDs.Tables(0).Rows(intCnt).Item("Status") = objGLSetup.mtdGetAccClsGrpStatus(objRptDs.Tables(0).Rows(intCnt).Item("Status"))
            objRptDs.Tables(0).Rows(intCnt).Item("UpdateDate") = objGlobal.GetLongDate(objRptDs.Tables(0).Rows(intCnt).Item("UpdateDate"))
        Next

        rdCrystalViewer.Load(objMapPath & "Web\EN\GL\Reports\Crystal\GL_Rpt_AccClsGrp.rpt", OpenReportMethod.OpenReportByTempCopy)
        ...
        Else
            ...
            DiskOpts.DiskFileName = objMapPath & "web\ftp\GL_Rpt_AccClsGrp.pdf"
            rdCrystalViewer.ExportOptions.DestinationOptions = DiskOpts
            rdCrystalViewer.Export()

            Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../../ftp/GL_Rpt_AccClsGrp.pdf"">")
        End If
    ...
    Sub PassParam()
        ...
        paramField4 = ParamFields.Item("AccClsGrpTag")
        paramField5 = ParamFields.Item("AccClsGrpDescTag") 
        ...
        ParamDiscreteValue4.value = AccClsGrpTag
        ParamDiscreteValue5.value = AccClsGrpDescTag
