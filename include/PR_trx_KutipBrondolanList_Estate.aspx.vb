...
Public Class PR_KutipBrondolanList : Inherits Page
    ...
    Protected Function LoadData() As DataSet
        Dim strOpCd_Get As String = "PR_PR_TRX_EMPKBR_LIST_GET"
    ...
    Sub NewEmpBtn_Click(ByVal Sender As Object, ByVal E As ImageClickEventArgs)
        Response.Redirect("PR_trx_KutipBrondolanDet_Estate.aspx")
    End Sub

    Sub KeepRunningSum(ByVal sender As Object, ByVal E As DataGridItemEventArgs)
        If E.Item.ItemType = ListItemType.Footer Then
            E.Item.Cells(8).Text = objGlobal.GetIDDecimalSeparator_FreeDigit(cnt, 0)
        End If
