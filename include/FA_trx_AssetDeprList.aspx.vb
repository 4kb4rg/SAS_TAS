...
Public Class FA_trx_AssetDeprList : Inherits Page
    ...
    Sub Page_Load(ByVal Sender As Object, ByVal E As EventArgs)
        ...
        Else
            ...
            If SortExpression.Text = "" Then
                SortExpression.Text = "AssetDeprID"
            End If
    ...
    Sub onload_GetLangCap()
        ...
        lblTxID.Text = GetCaption(objLangCap.EnumLangCap.AssetDepr) & " ID"
    ...
    Sub GetEntireLangCap()
        ...
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=FA_TRX_ASSETDEPR_GET_LANGCAP&errmesg=" & lblErrMessage.Text & "&redirect=FA/trx/FA_trx_AssetDeprList.aspx")
        End Try
    End Sub
    ...
    Sub BindSearchList()
        srchStatusList.Items.Add(New ListItem(objFATrx.mtdGetAssetDeprStatus(objFATrx.EnumAssetDeprStatus.Active), objFATrx.EnumAssetDeprStatus.Active))
        srchStatusList.Items.Add(New ListItem(objFATrx.mtdGetAssetDeprStatus(objFATrx.EnumAssetDeprStatus.Confirmed), objFATrx.EnumAssetDeprStatus.Confirmed))
        srchStatusList.Items.Add(New ListItem(objFATrx.mtdGetAssetDeprStatus(objFATrx.EnumAssetDeprStatus.Deleted), objFATrx.EnumAssetDeprStatus.Deleted))
        srchStatusList.Items.Add(New ListItem(objFATrx.mtdGetAssetDeprStatus(objFATrx.EnumAssetDeprStatus.Closed), objFATrx.EnumAssetDeprStatus.Closed))
        srchStatusList.Items.Add(New ListItem(objFATrx.mtdGetAssetDeprStatus(objFATrx.EnumAssetDeprStatus.All), objFATrx.EnumAssetDeprStatus.All))
   ...
   End Sub
    ...
    Protected Function LoadData() As DataSet
        Dim strOppCode_Get As String = "FA_CLSTRX_ASSETDEPR_GET"
        Dim strParam As String
        Dim intCnt As Integer
        ...
        Try
            intErrNo = objFATrx.mtdGetAssetDepr(strOppCode_Get, strLocation, strParam, objTxDs)
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=FA_CLSTRX_ASSETDeprLIST_GET&errmesg=" & lblErrMessage.Text & "&redirect=FA/trx/FA_trx_AssetDeprList.aspx")
        End Try

        For intCnt = 0 To objTxDs.Tables(0).Rows.Count - 1
            objTxDs.Tables(0).Rows(intCnt).Item("AssetDeprID") = objTxDs.Tables(0).Rows(intCnt).Item("AssetDeprID").Trim()
    ...
    Sub NewBtn_Click(ByVal Sender As Object, ByVal E As ImageClickEventArgs)
        Response.Redirect("FA_trx_AssetDeprDetails.aspx")
    End Sub
