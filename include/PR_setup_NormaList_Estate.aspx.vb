...
Public Class PR_setup_NormaList_Estate : Inherits Page
    ...
    Protected Function LoadData() As DataSet
        ...
        If Not txtSalCode.Text = "" Then
            strSearch = strSearch & " AND A.NormaCode like '%" & _
                        txtSalCode.Text & "%' "
        End If
        ...
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=PR_PR_STP_BK_NORMA_GET_LIST&errmesg=" & lblErrMessage.Text & "&redirect=")
        End Try

        If objBankDs.Tables(0).Rows.Count > 0 Then
            For intCnt = 0 To objBankDs.Tables(0).Rows.Count - 1
                objBankDs.Tables(0).Rows(intCnt).Item("NormaCode") = Trim(objBankDs.Tables(0).Rows(intCnt).Item("NormaCode"))
            Next
        End If
        Return objBankDs
    End Function
    ...
    Sub DEDR_Delete(ByVal Sender As Object, ByVal e As DataGridCommandEventArgs)
        Dim strOpCd_UPD As String = "PR_PR_STP_BK_NORMA_DEL"
        ...
        ParamNama = "UD|UI|NC"
        ParamValue = DateTime.Now & "|" & strUserId & "|" & strSalCd

        Try
            intErrNo = ObjOK.mtdInsertDataCommon(strOpCd_UPD, ParamNama, ParamValue)
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=PR_PR_STP_BK_NORMA_DEL&errmesg=" & lblErrMessage.Text & "&redirect=")
        End Try
