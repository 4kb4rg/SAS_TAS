...
Public Class PR_StdRpt_PieceRatedAttdTransPreview : Inherits Page
    ...
    Sub Page_Load(ByVal Sender As Object, ByVal E As EventArgs)
        ...
        strRptID = Trim(Request.QueryString("strRptID"))
    ...
    Sub BindReport()
        ...
        Try
            strRptPrefix = "PR_StdRpt_PieceRatedAttdTrans"
            
            strOpCd = "PR_STDRPT_PIECERATEATTDTRANS_SP" & "|" & "PR_PIECERATEDATTDTRX"
            ...
            intErrNo = objPRRpt.mtdGetReport_PieceRatedAttdTrans(strOpCd, _
                                                                 strCompany, _
                                                                 strLocation, _
                                                                 strUserId, _
                                                                 strAccMonth, _
        ...
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=PR_STDRPT_PIECERATEDATTDTRANS_GET&errmesg=" & Exp.ToString() & "&redirect=")
        End Try
    ...
    Sub PassParam()
        ...
        ParamDiscreteValue28.Value = IIf(Session("SS_INTER_ESTATE_CHARGING"), "true", "false")
        ...
        paramFieldDef28 = paramFieldDefs.Item("ParamInterEstateEnabled")
