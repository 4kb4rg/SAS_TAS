...
Public Class IN_StdRpt_LaporanPosisiStockPreview : Inherits Page
    ...
    Sub BindReport()
        ...
        Dim strOpCode As String = "IN_STDRPT_LAPORAN_POSISI_STOCK"
		...
		If Trim(strRptType) = "0" Then
			strFileName = "IN_StdRpt_LaporanPosisiStock"
			strOpCode = "IN_STDRPT_LAPORAN_POSISI_STOCK"
		Else
			strFileName = "IN_StdRpt_LaporanPosisiStockRekap"
			strOpCode = "IN_STDRPT_LAPORAN_POSISI_STOCK_REKAP"
		End If
		
        strParamName = "LOCCODE|BIN|ACCMONTH|ACCYEAR|ITEMCODE|SDATE_TRX|EDATE_TRX"
