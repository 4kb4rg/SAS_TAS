...
Public Class IN_StdRpt_InventoryValList_Preview : Inherits Page
    ...
    Sub BindReport()
        ...
        Dim strOpCd_InventoryVal_GET As String = "IN_STDRPT_INVENTORYVAL_GET"

        Dim NormStr As String

        If (Request.QueryString("WS") = "Yes")
            NormStr = "AND ITM.LocCode IN ('" & strUserLoc & "') AND ITM.ItemType IN ('" & objINSetup.EnumInventoryItemType.Stock & "','" & objINSetup.EnumInventoryItemType.WorkshopItem & "') " 
        Else
            NormStr = "AND ITM.LocCode IN ('" & strUserLoc & "') AND ITM.ItemType IN ('" & objINSetup.EnumInventoryItemType.Stock & "') " 
        End If
        ...
        Try
            intErrNo = objIN.mtdGetReport_InventoryValList(strOpCd_InventoryVal_GET, _
                                                           intDecimal, _
                                                           strParam, _
                                                           strParamOrderBy, _
                                                           objRptDs, _
        ...
        rdCrystalViewer.Load(objMapPath & "web\" & strLangCode & "\Reports\Crystal\IN_StdRpt_InventoryValList.rpt", OpenReportMethod.OpenReportByTempCopy)
        ...
        crDiskFileDestinationOptions.DiskFileName = objMapPath & "web\ftp\IN_StdRpt_InventoryValList.pdf"
        ...
        Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../ftp/IN_StdRpt_InventoryValList.pdf"">")
    End Sub
    ...
    Sub PassParam()
        ...
        paramField26 = paramFields.Item("ParamVarLevel")
        ...
        ParamDiscreteValue26.Value = iif(Request.QueryString("VarLevel") = "", "0", Request.QueryString("VarLevel"))
