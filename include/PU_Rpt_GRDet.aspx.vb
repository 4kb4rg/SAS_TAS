...
Public Class PU_Rpt_GRDet : Inherits Page
    ...
    Sub Bind_ITEM(ByVal blnIsPDFFormat As Boolean)
        ...
        strReportName = "PU_Rpt_GoodsReceive.rpt"
        ...
        Else
            ...
            DiskOpts.DiskFileName = objMapPath & "web\ftp\PU_Rpt_GoodsReceive.pdf"
            rdCrystalViewer.ExportOptions.DestinationOptions = DiskOpts
            rdCrystalViewer.Export()
            rdCrystalViewer.Close()
            rdCrystalViewer.Dispose()
            Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../../ftp/PU_Rpt_GoodsReceive.pdf"">")
        End If
