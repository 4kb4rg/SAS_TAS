...
Public Class IN_StdRpt_PrevMaintenancePreview : Inherits Page
    ...
    Sub BindReport()
        ...
        Dim strOpCdItem_GET As String = "IN_STDRPT_PREVMAINTENANCE_GET"
        ...
        If Not Request.QueryString("BlkCode") = "" Then
            SearchStr = SearchStr & "AND PM.BlkCode LIKE '" & Request.QueryString("BlkCode") & "' AND "
        Else
            SearchStr = SearchStr & "AND PM.BlkCode LIKE '%' AND "
        End If

        If Not Request.QueryString("SubBlkCode") = "" Then
            SearchStr = SearchStr & "PM.SubBlkCode LIKE '" & Request.QueryString("SubBlkCode") & "' AND "
        Else
            SearchStr = SearchStr & "PM.SubBlkCode LIKE '%' AND "
        End If

        If Not Request.QueryString("ItemCode") = "" Then
            SearchStr = SearchStr & "PM.ItemCode LIKE '" & Request.QueryString("ItemCode") & "' AND "
        Else
            SearchStr = SearchStr & "PM.ItemCode LIKE '%' AND "
        End If
        ...
        If Not SearchStr = "" Then
            ...
            strParam = strUserLoc & "|1|" & _
                       SearchStr 
        End If
        
        Try
            intErrNo = objIN.mtdGetReport_PrevMaintenance(strOpCdItem_GET, strParam, objRptDs, objMapPath)
        ...
        rdCrystalViewer.Load(objMapPath & "web\" & strLangCode & "\Reports\Crystal\IN_StdRpt_PrevMaintenance.rpt", OpenReportMethod.OpenReportByTempCopy)
        ...
        crDiskFileDestinationOptions.DiskFileName = objMapPath & "web\ftp\IN_StdRpt_PrevMaintenance.pdf"
	 ...
	 rdCrystalViewer.Close()
        ...
        Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../ftp/IN_StdRpt_PrevMaintenance.pdf"">")
    End Sub
