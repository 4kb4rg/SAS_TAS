...
Public Class GL_Rpt_ExpenseCode : inherits page
    ...
    Public Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        strExpenseCode = Trim(Request.QueryString("strExpenseCode"))
        ...
        ExpenseTag = Trim(Request.QueryString("ExpenseTag"))
        ExpDescTag = Trim(Request.QueryString("ExpDescTag"))
        Bind_ITEM(TRUE)
    ...
    Sub Bind_ITEM(ByVal blnIsPDFFormat As Boolean)
        ...
        Dim strOpCd As String = "GL_CLSSETUP_EXPCODE_LIST_SEARCH"
        ...
        strSearch =  " AND Expense.Status like '" & IIF(Not strStatus = "", strStatus, "%" ) &"' "

        If NOT strExpenseCode = "" Then
            strSearch =  strSearch & " AND Expense.ExpenseCode like '" & strExpenseCode & "%' "
        End If
        
        If NOT strDescription = "" Then
            strSearch = strSearch & " AND Expense.Description like '" & _
                        strDescription &"%' "
        End If
        ...
        For intCnt=0 To objRptDs.Tables(0).Rows.Count - 1
            objRptDs.Tables(0).Rows(intCnt).Item("Status") = objGLSetup.mtdGetExpCodeStatus(objRptDs.Tables(0).Rows(intCnt).Item("Status"))
            objRptDs.Tables(0).Rows(intCnt).Item("UpdateDate") = objGlobal.GetLongDate(objRptDs.Tables(0).Rows(intCnt).Item("UpdateDate"))
        Next

        rdCrystalViewer.Load(objMapPath & "Web\EN\GL\Reports\Crystal\GL_Rpt_ExpenseCode.rpt", OpenReportMethod.OpenReportByTempCopy)
        ...
        Else
            ...
            DiskOpts.DiskFileName = objMapPath & "web\ftp\GL_Rpt_ExpenseCode.pdf"
            rdCrystalViewer.ExportOptions.DestinationOptions = DiskOpts
            rdCrystalViewer.Export()

            Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../../ftp/GL_Rpt_ExpenseCode.pdf"">")
        End If
    ...
    Sub PassParam()
        ...
        paramField4 = ParamFields.Item("ExpenseTag") 
        paramField5 = ParamFields.Item("ExpDescTag") 
        ...
        ParamDiscreteValue4.value = ExpenseTag
        ParamDiscreteValue5.value = ExpDescTag
