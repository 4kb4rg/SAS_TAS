...
Public Class IN_Rpt_StockTransferDivDet : Inherits Page
    ...
    Sub Bind_ITEM(ByVal blnIsPDFFormat As Boolean)
        ...
        Dim strOpCd_Get As String = "IN_CLSTRX_STOCKTRANSFER_DIVISI_DETAIL_GET_FOR_REPORT"
        Dim strParamName As String
        Dim strParamValue As String
        Dim intErrNo As Integer

        strParamName = "TRANSID|LOC"
        ...
        rdCrystalViewer.Load(objMapPath & "web\" & strLangCode & "\IN\reports\Crystal\IN_Rpt_StockTransferDIvDet.rpt", OpenReportMethod.OpenReportByTempCopy)
        ...
        Else
            ...
            DiskOpts.DiskFileName = objMapPath & "web\ftp\IN_Rpt_StockTransferDivDet.pdf"
            rdCrystalViewer.ExportOptions.DestinationOptions = DiskOpts
            rdCrystalViewer.Export()

            Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../../ftp/IN_Rpt_StockTransferDivDet.pdf"">")
        End If
