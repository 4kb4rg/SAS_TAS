...
Public Class PR_StdRpt_PieceRatedAttdTrans : Inherits Page
    ...
    Sub GetEntireLangCap()
        ...
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=PR_REPORTS_PIECERATEDATTDTRANS_LANGCAP_GET&errmesg=" & lblErrMessage.Text & "&redirect=../en/reports/PR_StdRpt_Selection.aspx")
        End Try
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        strRptTitle = Trim(tempRptName.SelectedItem.Text)
        ...
        Response.Write("<Script Language=""JavaScript"">window.open(""PR_StdRpt_PieceRatedAttdTransPreview.aspx?Type=Print&CompName=" & strCompany & _
                       "&Location=" & strUserLoc & _
                       "&DDLAccMth=" & strddlAccMth & _
                       "&DDLAccYr=" & strddlAccYr & _
                       "&RptName=" & strRptTitle & _
                       "&Decimal=" & strDec & _
