...
Public Class Data_downloadHR : Inherits Page
    ...
    Sub btnGenerate_Click(ByVal Sender As Object, ByVal E As ImageClickEventArgs)
        ...
        'StrData = "hr_trx_employee"
        strQuery = "Table=" & ddlTable.SelectedItem.Value.Trim() & _
                   "&DateFrom=" & strDate & _
                   "&DateTo=" & strDateTo

        Response.Redirect("Data_download_savefileHR.aspx?" & strQuery)
    End Sub
