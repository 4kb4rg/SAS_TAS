...
Public Class IN_StdRpt_ItemToMachineList : Inherits Page
    ...
    Sub BindBlock(ByVal pv_strBlockCode As String)
        ...
        Dim dr As DataRow
        Dim strParam As String = "|" & "And blk.LocCode = '" & Trim(strLocation) & "' And blk.Status = '" & objGLSetup.EnumBlockStatus.Active & "'" & "|" & strLocation
        Dim intErrNo As Integer
    ...
    Sub BindSubBlock(ByVal pv_strSubBlkCode As String)
        ...
        strParam = "|" & "And sub.LocCode = '" & Trim(strLocation) & "' And Sub.Status = '" & objGLSetup.EnumSubBlockStatus.Active & "' And BlkCode = '" & Trim(strSelectedBlkCode) & "'" & "|" & strLocation
        Try
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        If Not (strInstallDateFrom = "" And strInstallDateTo = "") Then
            If objGlobal.mtdValidInputDate(strDateSetting, strInstallDateFrom, objDateFormat, objInstallDateFrom) = True And objGlobal.mtdValidInputDate(strDateSetting, strInstallDateTo, objDateFormat, objInstallDateTo) = True Then
                Response.Write("<Script Language=""JavaScript"">window.open(""IN_StdRpt_ItemToMachineListPreview.aspx?Type=Print&CompName=" & strCompany & "&Location=" & strUserLoc & "&RptID=" & strRptID & "&RptName=" & strRptName & _
