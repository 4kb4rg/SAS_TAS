...
Public Class menu_RC_Send : Inherits UserControl
    ...
    Sub Page_Load(Sender As Object, E As EventArgs)
        ...
        If strScriptName = "menu_rcsend_page.aspx" Then
        ...
        If (objAR.mtdHasAccessRights(objAR.mtdGetAccessRights(objAR.EnumADAccessRights.RCSendInterface), intADAR) = True) Then
            strDA = "<a class=mt-t href=""/" & Session("SS_LANGCODE") & "/RC/inter/RC_Send_DA.aspx"" target=_self>Dispatch Advice</a>"
            strJrn = "<a class=mt-t href=""/" & Session("SS_LANGCODE") & "/RC/inter/RC_Send_Journal.aspx"" target=_self>Journal</a>"
        Else
