...
Public Class NU_trx_SeedTransplantList : Inherits Page
    ...
    Sub Page_Load(ByVal Sender As Object, ByVal E As EventArgs)
        ...
        Else
            ...
            If SortExpression.Text = "" Then
                SortExpression.Text = "TransplantID"
            End If
    ...
    Sub GetEntireLangCap()
        ...
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=NU_TRX_SEEDTRANSPLANT_LIST_GET_LANGCAP&errmesg=" & Exp.ToString() & "&redirect=NU/trx/NU_trx_SeedTransplantList.aspx")
        End Try
    ...
    Sub BindSearchList()
        srchStatusList.Items.Add(New ListItem(objNUTrx.mtdGetSeedTransplantStatus(objNUTrx.EnumSeedTransplantStatus.All), objNUTrx.EnumSeedTransplantStatus.All))
        srchStatusList.Items.Add(New ListItem(objNUTrx.mtdGetSeedTransplantStatus(objNUTrx.EnumSeedTransplantStatus.Closed), objNUTrx.EnumSeedTransplantStatus.Closed))
        srchStatusList.Items.Add(New ListItem(objNUTrx.mtdGetSeedTransplantStatus(objNUTrx.EnumSeedTransplantStatus.Confirmed), objNUTrx.EnumSeedTransplantStatus.Confirmed))
        srchStatusList.Items.Add(New ListItem(objNUTrx.mtdGetSeedTransplantStatus(objNUTrx.EnumSeedTransplantStatus.Deleted), objNUTrx.EnumSeedTransplantStatus.Deleted))
    ...
    Protected Function LoadData() As DataSet
        Dim strOppCode_Get As String = "NU_CLSTRX_SEEDTRANSPLANT_GET"
        Dim strParam As String
        Dim intCnt As Integer
        ...
        Try
            intErrNo = objNUTrx.mtdGetSeedTransplant(strCompany, _
                                                    ...
                                                    objTxDs)
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=NU_CLSTRX_SEEDTRANSPLANTLIST_GET&errmesg=" & Exp.ToString() & "&redirect=NU/trx/NU_trx_SeedTransplantList.aspx")
        End Try

        For intCnt = 0 To objTxDs.Tables(0).Rows.Count - 1
            objTxDs.Tables(0).Rows(intCnt).Item("TransplantID") = objTxDs.Tables(0).Rows(intCnt).Item("TransplantID").Trim()
    ...
    Sub NewBtn_Click(ByVal Sender As Object, ByVal E As ImageClickEventArgs)
        Response.Redirect("NU_trx_SeedTransplantDetails.aspx")
    End Sub
