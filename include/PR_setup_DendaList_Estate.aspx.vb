...
Public Class PR_setup_DendaList_Estate : Inherits Page
    ...
    Sub Page_Load(ByVal Sender As Object, ByVal E As EventArgs)
        ...
        Else
            ...
            If Not Page.IsPostBack Then
			    srcpmonth.SelectedIndex = Cint(Session("SS_SELACCMONTH")) 
    ...
    Protected Function LoadData() As DataSet
        ...
        If Not txtDendaCode.Text = "" Then
            strSearch = strSearch & " AND A.DendaCode like '%" & _
                        txtDendaCode.Text & "%' "
        End If
        If Not txtDesc.Text = "" Then
            strSearch = strSearch & " AND A.Description like '%" & txtDesc.Text & "%' "
        End If
        ...
        If objBankDs.Tables(0).Rows.Count > 0 Then
            For intCnt = 0 To objBankDs.Tables(0).Rows.Count - 1
                objBankDs.Tables(0).Rows(intCnt).Item("DendaCode") = Trim(objBankDs.Tables(0).Rows(intCnt).Item("DendaCode"))
    ...
    Sub DEDR_Delete(ByVal Sender As Object, ByVal e As DataGridCommandEventArgs)
        Dim strOpCd_UPD As String = "PR_PR_STP_DENDA_LIST_DEL"
        Dim int As Integer = e.Item.ItemIndex
        Dim DCell As TableCell = e.Item.Cells(0)
        ...
        ParamNama = "DC|ST|UD|UI|Loc"
        ParamValue = strdenda & "|" & strStatus & "|" & DateTime.Now & "|" & strUserId & "|" & strLocation
    ...
    Sub NewAstekBtn_Click(ByVal Sender As Object, ByVal E As ImageClickEventArgs)
        Response.Redirect("PR_setup_DendaDet_Estate.aspx")
    End Sub
