...
Public Class IN_StdRpt_StockTakeList_Preview : Inherits Page
    ...
    Sub BindReport()
        ...
        Try
            strRptPrefix = "IN_StdRpt_StockTakeList"

            strOpCd = "IN_CLSSETUP_INVITEM_LIST_GET_FOR_REPORT" & "|" & "IN_STOCKTAKE" & Chr(9) & _
            ...
            intErrNo = objINRpt.mtdGetReport_StockTakeList(strOpCd, _
                                                           strCompany, _
                                                           strLocation, _
                                                           strUserId, _
                                                           strAccMonth, _
