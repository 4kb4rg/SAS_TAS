...
Public Class NU_Rpt_NurseryItemMaster : Inherits page
    ...
    Sub Bind_Report()
		...
		strSearch =  "AND ItemType = '" & objNU.EnumInventoryItemType.NurseryItem & "' AND itm.Status like  '" & IIF(Not strStatus = "", strStatus, "%" ) &"' "
        ...
        rdCrystalViewer.Load(objMapPath & "Web\EN\NU\Reports\Crystal\NU_Rpt_NurseryItemMaster.rpt", OpenReportMethod.OpenReportByTempCopy)
        ...
        crDiskFileDestinationOptions.DiskFileName = objMapPath & "web\ftp\NU_Rpt_NurseryItemMaster.pdf"
        ...
        Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../../ftp/NU_Rpt_NurseryItemMaster.pdf"">")
