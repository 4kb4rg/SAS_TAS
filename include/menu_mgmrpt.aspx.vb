...
Public Class menu_mgmrpt : Inherits Page
    ...
    Sub Page_Load(ByVal Sender As Object, ByVal E As EventArgs)
        ...
        Else
            ...
            lblUser.Text = Session("SS_USERNAME") & " - " & Session("SS_LOCATION") & " " & Session("SS_SELACCMONTH") & "/" & Session("SS_SELACCYEAR") & " (" & Session("SS_COMPANYNAME") & ")"
            onLoad_Display()
