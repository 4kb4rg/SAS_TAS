...
Public Class GL_trx_BudgetProd_Karet_Estate_list : Inherits Page
    ...
    Protected Function LoadData() As DataSet
        ...
        Dim strOpCd As String = "GL_CLSTRX_BUDGET_PROD_KARET_SEARCH"
        ...
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=BUDGET_LIST_SEARCH&errmesg=" & lblErrMessage.Text )
        End Try
    ...
    Sub NewBtn_Click(ByVal Sender As Object, ByVal E As ImageClickEventArgs)
        Response.Redirect("GL_trx_BudgetProd_Karet_Estate_Det.aspx")
    End Sub
