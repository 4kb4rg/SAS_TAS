...
Public Class HR_setup_JobGroup_Estate : Inherits Page
    ...
    Dim strOppCd_GET As String = "HR_HR_STP_GROUPJOB_GET"
    Dim strOppCd_UPD As String = "HR_HR_STP_GROUPJOB_UPD"
    ...
    Sub Page_Load(ByVal Sender As Object, ByVal E As EventArgs)
        ...
        Else
            ...
            If SortExpression.Text = "" Then
                SortExpression.Text = "GrpJobCode"
                sortcol.Text = "ASC"
            End If
    ...
    Protected Function LoadData() As DataSet
        ...
        If Not srchJobCode.Text = "" Then
            SearchStr = SearchStr & " AND A.GrpJobCode like '%" & srchJobCode.Text & "%' "
        End If
    ...
    Sub DEDR_Edit(ByVal Sender As Object, ByVal E As DataGridCommandEventArgs)
        ...
        Select Case CInt(EditText.Text) = "1"
            Case True
                ...
                EditText = EventData.Items.Item(CInt(E.Item.ItemIndex)).FindControl("GrpJobCode")
				...
				List = EventData.Items.Item(CInt(E.Item.ItemIndex)).FindControl("ddlBKM")
				Lbl =  EventData.Items.Item(CInt(E.Item.ItemIndex)).FindControl("lblBKM")
    ...
    Sub DEDR_Update(ByVal Sender As Object, ByVal E As DataGridCommandEventArgs)
        ...
        EditText = E.Item.FindControl("GrpJobCode")
        JobCode = EditText.Text.ToUpper
		...
		list = E.Item.FindControl("ddlBKM")
        isBKM = list.SelectedItem.Value
        
		
        ParamNama = "JC|Desc|ST|CD|UD|UI|BKM"
        ...
        Catch Exp As System.Exception
            Response.Redirect("../../../include/mesg/ErrorMessage.aspx?errcode=HR_HR_STP_GROUPJOB_UPD&errmesg=" & lblErrMessage.Text & "&redirect=HR/Setup/HR_setup_Religion.aspx")
        End Try
