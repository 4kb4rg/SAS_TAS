...
Public Class PR_StdRpt_PotKoperasiPreview : Inherits Page
    ...
    Sub BindReport()
        ...
        Dim strOpCdPotKoperasiListGet As String = "PR_STDRPT_POTKOPERASI_LIST"
        ...
        Try
            intErrNo = objPRRpt.mtdGetReport_KoperasiList(strOpCdPotKoperasiListGet, _
                                                           strCompany, _
                                                           strLocation, _
                                                           strUserId, _
                                                           strAccMonth, _
        ...
        rdCrystalViewer.Load(objMapPath & "web\" & strLangCode & "\Reports\Crystal\PR_StdRpt_PotKoperasiListing.rpt", OpenReportMethod.OpenReportByTempCopy)
        ...
        crDiskFileDestinationOptions.DiskFileName = objMapPath & "web\ftp\PR_StdRpt_PotKoperasiListing.pdf"
        ...
        Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../ftp/PR_StdRpt_PotKoperasiListing.pdf"">")
    End Sub
