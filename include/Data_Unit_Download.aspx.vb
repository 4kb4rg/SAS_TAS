...
Public Class Data_Unit_Download : Inherits Page
    ...
    Sub Page_Load(ByVal Sender As Object, ByVal E As EventArgs)
        ...
        Else
            ...
            If Not Page.IsPostBack Then
                btnProceed.Attributes("onclick") = "javascript:return ConfirmAction('Process Download');"
                onLoad_Display("")
            End If
        End If
    End Sub
    ...
    Sub btnProceed_Click(ByVal Sender As Object, ByVal e As System.EventArgs)
        ...
        Dim strOpCode As String = "DOWNLOAD_DATA_UNIT"
