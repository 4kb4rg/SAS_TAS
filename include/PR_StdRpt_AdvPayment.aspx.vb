...
Public Class PR_StdRpt_AdvPayment : Inherits Page
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        Response.Write("<Script Language=""JavaScript"">window.open(""PR_StdRpt_AdvPaymentPreview.aspx?Type=Print&CompName=" & strCompany & _
                       "&RptID=" & strRptID & _
