...
Public Class GL_VehicleUsage_List : Inherits Page
    ...
    Dim strOppCd_GET As String = "GL_CLSTRX_VEHICLEUSAGE_LIST_GET"
    ...
    Sub onload_GetLangCap()
        ...
        lblVehUsageId.Text = GetCaption(objLangCap.EnumLangCap.VehUsage) & " ID"
        ...
        dgTx.Columns(2).HeaderText = GetCaption(objLangCap.EnumLangCap.VehicleDesc)
    ...
    Sub btnNewItm_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        Response.Redirect("../../GL/Trx/GL_Trx_VehicleUsage_Details.aspx")
    End Sub
