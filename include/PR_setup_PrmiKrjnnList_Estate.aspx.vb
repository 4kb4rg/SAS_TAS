...
Public Class PR_setup_PrmiKrjnnList_Estate : Inherits Page
    ...
    Sub OnDataBound(ByVal sender As Object, ByVal e As DataGridItemEventArgs)
        Const target = "PR_setup_PrmiKrjnn_Estate.aspx?periodestart={0}&periodeend={1}"
    ...
    Protected Function LoadData() As DataSet
        ...
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=PR_PR_STP_PREMI_KERAJINAN_GET&errmesg=" & lblErrMessage.Text & "&redirect=")
        End Try
    ...
    Sub NewDeptBtn_Click(ByVal Sender As Object, ByVal E As ImageClickEventArgs)
        Response.Redirect("PR_setup_PrmiKrjnn_Estate.aspx")
    End Sub
