...
Public Class PopUpFindVehAct : Inherits Page
    ...
    Protected Function LoadData() As DataSet
        ...
        Dim strOpCode As String = "GL_CLSTRX_VEHACTIVITY_SEARCH"
        ...
        strSortExp = " ORDER BY VehActCode ASC"
    ...
    Sub OnSelectItem(ByVal Sender As Object, ByVal e As DataGridCommandEventArgs)
        ...
        Dim CPCell2 As TableCell = e.Item.Cells(2)
