...
Public Class PR_Setup_Vehicle_Estate : Inherits Page
    ...
    Sub Page_Load(ByVal Sender As Object, ByVal E As EventArgs)
        ...
        Else
            ...
            If SortExpression.Text = "" Then
                SortExpression.Text = "veh.VehCode"
            End If
    ...
    Sub onload_GetLangCap()
        ...
        lblDescription.Text = GetCaption(objLangCap.EnumLangCap.VehicleDesc)
    ...
    Protected Function LoadData() As DataSet
        ...
        Dim intErrNo As Integer
		Dim intCnt As Integer
		Dim strSrchStatus As String  = IIf(srchStatus.SelectedItem.Value = "0", "", srchStatus.SelectedItem.Value) 
		
		strParamName = "VEHCODE|LOCCODE|ST"
		strParamValue =   srchVehCode.Text & "|" & _
						  strLocation & "|" & _ 
		                  strSrchStatus 
		
        Try
            intErrNo = objOk.mtdGetDataCommon(strOpCd, strParamName, strParamValue, objGLSetupDs)
        Catch Exp As System.Exception
        ...
        If objGLSetupDs.Tables(0).Rows.Count > 0 Then
            For intCnt = 0 To objGLSetupDs.Tables(0).Rows.Count - 1
                objGLSetupDs.Tables(0).Rows(intCnt).Item("VehCode") = Trim(objGLSetupDs.Tables(0).Rows(intCnt).Item("VehCode"))
    ...
    Sub DEDR_Delete(ByVal Sender As Object, ByVal e As DataGridCommandEventArgs)
        ...
        strParam = strSelVehCode & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & objGLSetup.EnumVehicleStatus.Deleted & Chr(9) & Chr(9)
        ...
        Try
            intErrNo = objGLSetup.mtdUpdVehicle(strOpCd_ADD, _
                                                ...
                                                True)
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=GL_SETUP_VEHICLE_LIST_DEL&errmesg=" & lblErrMessage.Text & "&redirect=gl/setup/gl_setup_vehicle.aspx")
        End Try
    ...
    Sub NewTBBtn_Click(ByVal Sender As Object, ByVal E As ImageClickEventArgs)
        Response.Redirect("PR_Setup_VehicleDet_Estate.aspx")
    End Sub
