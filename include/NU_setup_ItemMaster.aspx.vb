...
Public Class NU_NurseryMaster : Inherits Page
    ...
    Protected Function LoadData() As DataSet
        ...
        SearchStr = "AND ItemType = '" & objIN.EnumInventoryItemType.NurseryItem & "' AND itm.Status like '" & IIf(Not srchStatusList.SelectedItem.Value = objIN.EnumStockItemStatus.All, _
        ...
        Catch Exp As System.Exception
            Response.Redirect("../../../include/mesg/ErrorMessage.aspx?errcode=GET_STOCKITEM&errmesg=" & lblErrMessage.Text & "&redirect=NU/Setup/NU_Setup_Item.aspx")
        End Try
        Return objDataSet
    End Function
	...
	Sub btnPreview_Click(sender As Object, e As ImageClickEventArgs)
        ...
        strStockItemCodeTag = "Nursery Item Code"
        strDescTag = "Description"
        strTitleTag = "NURSERY MASTER"
        ...
        Response.Write("<Script Language=""JavaScript"">window.open(""../reports/NU_Rpt_NurseryItemMaster.aspx?strStockItemCodeTag=" & strStockItemCodeTag & _
