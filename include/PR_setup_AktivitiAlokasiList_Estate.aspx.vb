...
Public Class PR_setup_AktivitiAlokasiList_Estate : Inherits Page
    ...
    Sub Page_Load(ByVal Sender As Object, ByVal E As EventArgs)
        ...
        Else
            If SortExpression.Text = "" Then
                SortExpression.Text = "AloJobCode"
            End If
    ...
    Protected Function LoadData() As DataSet
        Dim strOpCd_GET As String = "PR_PR_STP_BK_ALOKASI_GET_LIST"
        ...
        If Not txtSalCode.Text = "" Then
            strSearch = strSearch & " AND AloJobCode like '%" & _
                        txtSalCode.Text & "%' "
        End If
        If Not txtEmpCode.Text = "" Then
            strSearch = strSearch & " AND Rtrim(C.JobName)+' '+Rtrim(JobNote) like '%" & txtEmpCode.Text & "%' "
        End If
        ...
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=PR_PR_STP_BK_ALOKASI_GET_LIST&errmesg=" & lblErrMessage.Text & "&redirect=")
        End Try

        If objBankDs.Tables(0).Rows.Count > 0 Then
            For intCnt = 0 To objBankDs.Tables(0).Rows.Count - 1
                objBankDs.Tables(0).Rows(intCnt).Item("AloJobCode") = Trim(objBankDs.Tables(0).Rows(intCnt).Item("AloJobCode"))
            Next
        End If
        Return objBankDs
    End Function
    ...
    Sub NewBtn_Click(ByVal Sender As Object, ByVal E As ImageClickEventArgs)
        Response.Redirect("PR_setup_Normadet_Estate.aspx")
    End Sub
