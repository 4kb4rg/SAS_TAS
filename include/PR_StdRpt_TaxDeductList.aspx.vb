...
Public Class PR_StdRpt_TaxDeductList : Inherits Page
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        Response.Write("<Script Language=""JavaScript"">window.open(""PR_StdRpt_TaxDeductListPreview.aspx?Type=Print&CompName=" & strCompany & _
