...
Public Class NU_trx_SeedPlantList : Inherits Page
    ...
    Sub GetEntireLangCap()
        ...
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=NU_CLSTRX_SEEDPLANT_GET_LANGCAP&errmesg=" & Exp.ToString() & "&redirect=NU/Trx/NU_trx_SeedPlantList.aspx")
        End Try
    ...
    Sub BindSearchList()
        srchStatusList.Items.Add(New ListItem(objNUTrx.mtdGetSeedPlantStatus(objNUTrx.EnumSeedPlantStatus.All), objNUTrx.EnumSeedPlantStatus.All))
        srchStatusList.Items.Add(New ListItem(objNUTrx.mtdGetSeedPlantStatus(objNUTrx.EnumSeedPlantStatus.Closed), objNUTrx.EnumSeedPlantStatus.Closed))
        srchStatusList.Items.Add(New ListItem(objNUTrx.mtdGetSeedPlantStatus(objNUTrx.EnumSeedPlantStatus.Confirmed), objNUTrx.EnumSeedPlantStatus.Confirmed))
        srchStatusList.Items.Add(New ListItem(objNUTrx.mtdGetSeedPlantStatus(objNUTrx.EnumSeedPlantStatus.Deleted), objNUTrx.EnumSeedPlantStatus.Deleted))
    ...
    Protected Function LoadData() As DataSet
        Dim strOppCode_Get As String = "NU_CLSTRX_SEEDPLANT_GET"
        Dim strParam As String
        Dim intCnt As Integer
        ...
        Try
            intErrNo = objNUTrx.mtdGetSeedPlant(strCompany, _
                                                ...
                                                objTxDs)
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=NU_CLSTRX_SEEDPLANTLIST_GET&errmesg=" & Exp.ToString() & "&redirect=NU/trx/NU_trx_SeedPlantList.aspx")
        End Try

        For intCnt = 0 To objTxDs.Tables(0).Rows.Count - 1
            objTxDs.Tables(0).Rows(intCnt).Item("PlantID") = objTxDs.Tables(0).Rows(intCnt).Item("PlantID").Trim()
    ...
    Sub NewBtn_Click(ByVal Sender As Object, ByVal E As ImageClickEventArgs)
        Response.Redirect("NU_trx_SeedPlantDetails.aspx")
    End Sub
