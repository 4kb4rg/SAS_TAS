...
Public Class PopUpFindCOA : Inherits Page
    ...
    Protected Function LoadData() As DataSet
        ...
        Dim strOpCode As String = "IN_CLSTRX_FA_SEARCH"
        ...
        strSortExp = " ORDER BY AssetCode ASC"

        strParamName = "SEARCH|LOCCODE|SORTEXP"

        If Trim(txtItemCode.Text) = "" Then
            strParamValue = "|" & Trim(strLocCode) & "|" & strSortExp
        Else
            strParamValue = "%" & trim(txtItemCode.Text) & "%|" & Trim(strLocCode) & "|" & strSortExp
        End If
