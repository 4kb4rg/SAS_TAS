...
Public Class FA_AssetItemDet : Inherits Page
        ...
        Else
            ...
            If Not IsPostBack Then
                ...
                If Not ItemCode = "" Then
                    ...
                    If Delete.ImageUrl = "../../images/butt_delete.gif" Then
                        Delete.Attributes("onclick") = "javascript:return ConfirmAction('delete');"
                    ElseIf Delete.ImageUrl = "../../images/butt_Undelete.gif" Then
                        Delete.ToolTip = "Undelete"
    ...
    Sub onload_GetLangCap()
        ...
        lblDCCode.Text = GetCaption(objLangCap.EnumLangCap.AssetItem) & " Code"
    ...
    Sub GetEntireLangCap()
        ...
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=FA_SETUP_AssetGrp_GET_LANGCAP&errmesg=" & lblErrMessage.Text & "&redirect=FA/Setup/FA_setup_AssetItem.aspx")
        End Try
    ...
    Protected Function LoadData(ByVal pv_blnIsMaster As Boolean) As DataSet
        ...
        strParam = ItemCode & "|" & objIN.EnumInventoryItemType.FixedAssetItem & "|" & Trim(strLocation) 
        If Not Request.QueryString("ID") = "" Then
        ...
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=GET_ASSETITEM_DETAILS&errmesg=" & lblErrMessage.Text & "&redirect=FA/Setup/FA_AssetItemDetails.aspx")
        End Try
        Return objDataSet
    End Function
    ...
    Sub BindItemCodeDropList()
        ...
        SearchStr = "AND ItemType in ('" & objIN.EnumInventoryItemType.FixedAssetItem & "') AND itm.Status = '" & objIN.EnumStockItemStatus.Active & "' AND Not ItemCode In (Select ItemCode From IN_Item where ItemType in ('" & objIN.EnumInventoryItemType.FixedAssetItem &  "') And LocCode='" & strLocation & "' ) "
        ...
        Catch Exp As System.Exception
            Response.Redirect("../../../include/mesg/ErrorMessage.aspx?errcode=GET_STOCKITEM&errmesg=" & lblErrMessage.Text & "&redirect=FA/Setup/FA_AssetItem.aspx")
        End Try
    ...
    ByVal ModuleType As Integer, ByVal Status As Integer, ByVal BindToList As DropDownList)
        ...
        If SelectedIndex = -1 And Not ItemCode = "" Then
            ...
            Try
                ...
                End If
            Catch Exp As System.Exception
                Response.Redirect("../../../include/mesg/ErrorMessage.aspx?errcode=ADD_ITEMTODROPDOWN&errmesg=" & lblErrMessage.Text & "&redirect=FA/Setup/FA_AssetItem.aspx")
            End Try
    ...
    Sub UpdateData(ByVal strAction As String)
        ...
        Trim(Desc.Text) & "||" & _
        Trim(objIN.EnumInventoryItemType.FixedAssetItem) & "||" & _
        ...
        Try
            intErrNo = objIN.mtdUpdInvItemsDetails(strOppCd_ADD, _
                                                        ...
                                                        blnUpdate.Text)
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=UPDATE_FIXEDASSETITEM_DETAILS&errmesg=" & lblErrMessage.Text & "&redirect=FA/Setup/FA_setup_AssetItem.aspx")
        End Try
        ...
        Else
            Select Case blnUpdate.Text
                Case True
                    Response.Redirect("FA_setup_AssetItem.aspx")
                Case False
...
Sub btnSynchronizeData_Click(ByVal Sender As Object, ByVal E As ImageClickEventArgs)
        ...
        strParam = Trim(DCCode.Text) & "|" & _
                   Trim(objIN.EnumInventoryItemType.FixedAssetItem)
        Try
            intErrNo = objIN.mtdSynchronizeFAItemData(strOpCode_GetMaster, _
                                                    strOpCode_UpdItem, _
                                                    strParam, _
                                                    strUserId, _
                                                    strLocation)
        Catch Exp As System.Exception
            Response.Redirect("../../../include/mesg/ErrorMessage.aspx?errcode=FA_UPDATE_ASSETITEM&errmesg=" & lblErrMessage.Text & "&redirect=FA/Setup/FA_setup_AssetItem.aspx")
        End Try
        
        Call LoadFAItemMaster(Sender, E)
End Sub

Sub LoadFAItemMaster(ByVal Sender As Object, ByVal E As EventArgs)
        ItemCode = lstItemCode.SelectedItem.Value
        If ItemCode <> "" Then
            DisplayData()
            DisableControl()
