...
Public Class PR_StdRpt_Tenaga_Borongan_Preview_Estate : Inherits Page
    ...
    Sub BindReport()
        ...
        strOpCd = "PR_STDRPT_DAFTAR_TENAGA_BORONGAN_REPORT"
        fname = "PR_StdRpt_Tenaga_Borongan_Estate"
