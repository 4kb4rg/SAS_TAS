...
Public Class FA_AssetMasterDet : Inherits Page
    ...
    Sub onload_GetLangCap()
        GetEntireLangCap()
        lblDupMsg.Text = lblDupMsgText.Text & UCase(GetCaption(objLangCap.EnumLangCap.StockMaster)) & ", " & UCase(GetCaption(objLangCap.EnumLangCap.AssetMaster))
    ...
    Sub GetEntireLangCap()
        ...
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=FA_SETUP_AssetGrp_GET_LANGCAP&errmesg=" & lblErrMessage.Text & "&redirect=FA/Setup/FA_setup_AssetMaster.aspx")
        End Try
    ...
    Protected Function LoadData() As DataSet
        ...
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=GET_FIXEDASSETITEM_DETAILS&errmesg=" & lblErrMessage.Text & "&redirect=FA/Setup/FA_Setup_AssetMaster.aspx")
        End Try
        Return objDataSet
    End Function
    ...
    ByVal ModuleType As Integer, ByVal Status As Integer, ByVal BindToList As DropDownList)
        ...
        If SelectedIndex = -1 And Not ItemCode = "" Then
            ...
            Try
                ...
                End If
            Catch Exp As System.Exception
                Response.Redirect("../../../include/mesg/ErrorMessage.aspx?errcode=ADD_ITEMTODROPDOWN&errmesg=" & lblErrMessage.Text & "&redirect=FA/Setup/FA_Setup_AssetMaster.aspx")
            End Try
    ...
    Sub UpdateData(ByVal strAction As String)
        ...
        Try
            ...
            intErrNo = objIN.mtdUpdInvItemsDetails(strOppCd_ADD, _
                                                        ...
                                                        blnUpdate.Text)
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=UPDATE_FIXEDASSETITEM_DETAILS&errmesg=" & lblErrMessage.Text & "&redirect=FA/Setup/FA_Setup_AssetMaster.aspx")
        End Try
        ...
        Else
            Select Case blnUpdate.Text
                Case True
                    Response.Redirect("FA_Setup_AssetMaster.aspx")
                Case False
