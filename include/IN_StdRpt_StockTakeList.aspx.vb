...
Public Class IN_StdRpt_StockTakeList : Inherits Page
    ...
    Sub BindItemTypeList()
        ddlItemType.Items.Add(New ListItem("All",""))
        ddlItemType.Items.Add(New ListItem(objINSetup.mtdGetInventoryItemType(objINSetup.EnumInventoryItemType.Stock),objINSetup.EnumInventoryItemType.Stock))
        ddlItemType.Items.Add(New ListItem(objINSetup.mtdGetInventoryItemType(objINSetup.EnumInventoryItemType.MiscItem),objINSetup.EnumInventoryItemType.MiscItem))
    End Sub
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        strItemType = Trim(ddlItemType.SelectedItem.Value)

        If lstItemStatus.SelectedItem.Value = objINSetup.EnumStockItemStatus.All Then
            strItemStatus = ""
        Else
        ...
        Response.Write("<Script Language=""JavaScript"">window.open(""IN_StdRpt_StockTakeListPreview.aspx?Type=Print&CompName=" & strCompany & _
