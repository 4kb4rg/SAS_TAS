...
Public Class menu_hrrpt : Inherits Page
   ...
   Sub onLoad_Display()
    ...
    Private Sub ReportsRight()
        ...
        If objAR.mtdHasAccessRights(objAR.mtdGetModuleActivation(objAR.EnumModuleActivation.HumanResource), intModuleActivate) Then
            'lnkRpt1.NavigateUrl = "/" & strLangCode & "/reports/HR_StdRpt_Selection.aspx?UserLoc=" & strLocation
            lnkRpt1.NavigateUrl = "/" & strLangCode & "/reports/HR_StdRpt_Selection_Estate.aspx?UserLoc=" & strLocation
        ...
        If objAR.mtdHasAccessRights(objAR.mtdGetModuleActivation(objAR.EnumModuleActivation.Payroll), intModuleActivate) Then
            lnkRpt2.NavigateUrl = "/" & strLangCode & "/reports/PR_StdRpt_Selection_Estate.aspx?UserLoc=" & strLocation
