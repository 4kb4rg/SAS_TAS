...
Public Class IN_Rpt_ProdModel : inherits page
    ...
    Public Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        strProdModelCode = Trim(Request.QueryString("strProdModelCode"))
        ...
        ProdModelCodeTag = Trim(Request.QueryString("ProdModelCodeTag"))
        ProdModelDescTag = Trim(Request.QueryString("ProdModelDescTag"))
    ...
    Sub Bind_ITEM(ByVal blnIsPDFFormat As Boolean)
        ...
        Dim strOpCd As String = "IN_CLSSETUP_PRODMODEL_LIST_GET_FOR_REPORT"
        ...
        strSearch =  " AND PModel.Status like '" & IIF(Not strStatus = "", strStatus, "%" ) &"' "
        If NOT strProdModelCode = "" Then
            strSearch =  strSearch & " AND PModel.ProdModelCode like '" & strProdModelCode & "%' "
        End If        
        If NOT strDescription = "" Then
            strSearch = strSearch & " AND PModel.Description like '" & strDescription &"%' "
        End If       
        ...
        Try
            intErrNo = objInventory.mtdGetMasterList(strOpCd, _
                                                     strParam, _
                                                     EnumInventoryMasterType.ProductModel, _
                                                     objRptDs)
        ...
        For intCnt=0 To objRptDs.Tables(0).Rows.Count - 1
            objRptDs.Tables(0).Rows(intCnt).Item("Status") = objInventory.mtdGetProductModelStatus(objRptDs.Tables(0).Rows(intCnt).Item("Status"))
        ...
        rdCrystalViewer.Load(objMapPath & "Web\EN\IN\Reports\Crystal\In_Rpt_ProdModel.rpt", OpenReportMethod.OpenReportByTempCopy)
        ...
        Else
            ...
            DiskOpts.DiskFileName = objMapPath & "web\ftp\In_Rpt_ProdModel.pdf"
            rdCrystalViewer.ExportOptions.DestinationOptions = DiskOpts
            rdCrystalViewer.Export()
            Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../../ftp/In_Rpt_ProdModel.pdf"">")
        End If
    ...
    Sub PassParam()
        ...
        paramField2 = ParamFields.Item("ProdModelCodeTag")
        paramField3 = ParamFields.Item("ProdModelDescTag")
        ...
        ParamDiscreteValue2.value = ProdModelCodeTag
        ParamDiscreteValue3.value = ProdModelDescTag
