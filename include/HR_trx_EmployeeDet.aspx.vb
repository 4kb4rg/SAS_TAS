    ...
    Sub BindICType()
        ...
        If objICTypeDs.Tables(0).Rows.Count > 0 Then
            For intCnt = 0 To objICTypeDs.Tables(0).Rows.Count - 1
                ...
                If objICTypeDs.Tables(0).Rows(intCnt).Item("ICTypeCode") = strSelectedNewICType
                    intNewICTypeIndex = intCnt + 1
                End If

                If objICTypeDs.Tables(0).Rows(intCnt).Item("ICTypeCode") = strSelectedOldICType
    ...
    Sub BindRace()
        ...
        If objRaceDs.Tables(0).Rows.Count > 0 Then
            For intCnt = 0 To objRaceDs.Tables(0).Rows.Count - 1
                ...
                If objRaceDs.Tables(0).Rows(intCnt).Item("RaceCode") = strSelectedRace
    ...
    Sub BindReligion()
        ...
        If objReligionDs.Tables(0).Rows.Count > 0 Then
            For intCnt = 0 To objReligionDs.Tables(0).Rows.Count - 1
                ...
                If objReligionDs.Tables(0).Rows(intCnt).Item("ReligionCode") = strSelectedReligion
    ...
    Sub BindNation()
        ...
        If objNationDs.Tables(0).Rows.Count > 0 Then
            For intCnt = 0 To objNationDs.Tables(0).Rows.Count - 1
                ...
                If objNationDs.Tables(0).Rows(intCnt).Item("CountryCode") = strSelectedNation
    ...
    Sub BindKoperasiID()
        ...
        If objICTypeDs.Tables(0).Rows.Count > 0 Then
            For intCnt = 0 To objICTypeDs.Tables(0).Rows.Count - 1
                ...
                If objICTypeDs.Tables(0).Rows(intCnt).Item("ICTypeCode") = strSelectedKoperasiID
