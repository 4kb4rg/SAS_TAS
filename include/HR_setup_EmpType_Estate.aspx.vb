...
Public Class HR_setup_EmpType_Estate : Inherits Page
    ...
    Protected WithEvents srchEmptyCodeCode As TextBox
	...
	Protected WithEvents ddlsimbol As DropDownList
    Protected WithEvents ddlGroupType As DropDownList
    Protected WithEvents ddlTaxType As DropDownList
	
	Protected WithEvents lbsimbol As Label
    Protected WithEvents lbGroupType As Label
    Protected WithEvents lbTaxType As Label
    ...
    Dim strOppCd_GET As String = "HR_HR_STP_EMPTYPE_GET"
    Dim strOppCd_UPD As String = "HR_HR_STP_EMPTYPE_UPD"
	...
	Sub BindsimbolList(ByVal index As Integer)

        ddlsimbol = EventData.Items.Item(index).FindControl("ddlsimbol")
        ddlsimbol.Items.Add(New ListItem("Staff","S"))
        ddlsimbol.Items.Add(New ListItem("Bulanan","B"))
		ddlsimbol.Items.Add(New ListItem("Harian Tetap","R"))
		ddlsimbol.Items.Add(New ListItem("Harian Lepas","L"))
		ddlsimbol.Items.Add(New ListItem("Kontrak/Honorer","K"))
    End Sub

	Sub BindgroupList(ByVal index As Integer)
        ddlGroupType = EventData.Items.Item(index).FindControl("ddlGroupType")
        ddlGroupType.Items.Add(New ListItem("Kary.Tetap","1"))
        ddlGroupType.Items.Add(New ListItem("Kary.Non Tetap","2"))
    End Sub
	
	Sub BindTaxTypeList(ByVal index As Integer)
        ddlTaxType = EventData.Items.Item(index).FindControl("ddlTaxType")
        ddlTaxType.Items.Add(New ListItem("Netto","1"))
        ddlTaxType.Items.Add(New ListItem("Gross","2"))
		ddlTaxType.Items.Add(New ListItem("GrossUp","3"))
    ...
    Protected Function LoadData() As DataSet
        ...
        SearchStr = " AND A.Status like '" & IIf(Not srchStatusList.SelectedItem.Value = "3", _
                       srchStatusList.SelectedItem.Value, "%") & "' "
        If Not srchEmptyCodeCode.Text = "" Then
            SearchStr = SearchStr & " AND A.EmpTyCode like '%" & srchEmptyCodeCode.Text & "%' "
        End If
        ...
        Catch Exp As System.Exception
            Response.Redirect("../../../include/mesg/ErrorMessage.aspx?errcode=HR_RELIGION_GET_LIST&errmesg=" & lblErrMessage.Text & "&redirect=")
        End Try
        Return objDataSet
    End Function
    ...
    Sub DEDR_Edit(ByVal Sender As Object, ByVal E As DataGridCommandEventArgs)
		...
		BindsimbolList(EventData.EditItemIndex)
		BindgroupList(EventData.EditItemIndex)
		BindTaxTypeList(EventData.EditItemIndex)

        EditText = EventData.Items.Item(CInt(E.Item.ItemIndex)).FindControl("Status")
        Select Case CInt(EditText.Text) = "1"
            Case True
                StatusList.SelectedIndex = 0
                EditText = EventData.Items.Item(CInt(E.Item.ItemIndex)).FindControl("EmpTyCode")
				Lbl =  EventData.Items.Item(CInt(E.Item.ItemIndex)).FindControl("lbsimbol")
				List = EventData.Items.Item(CInt(E.Item.ItemIndex)).FindControl("ddlsimbol")
    ...
    Sub DEDR_Update(ByVal Sender As Object, ByVal E As DataGridCommandEventArgs)
        ...
        EditText = E.Item.FindControl("EmpTyCode")
        EmpTypeCode = EditText.Text.ToUpper
        EditText = E.Item.FindControl("Description")
        Description = EditText.Text
		list = E.Item.FindControl("ddlsimbol")
		Symbol  = list.SelectedItem.Value
		list = E.Item.FindControl("ddlGroupType")
		GroupType  = list.SelectedItem.Value
		list = E.Item.FindControl("ddlTaxType")
		TaxType  = list.SelectedItem.Value
        ...
        ParamNama = "EC|Desc|ST|CD|UD|UI|S|G|T"
        ParamValue = EmpTypeCode & "|" & _
                    Description & "|" & _
                    Status & "|" & _
                    CreateDate & "|" & _
                    DateTime.Now() & "|" & _
        ...
        Catch Exp As System.Exception
            Response.Redirect("../../../include/mesg/ErrorMessage.aspx?errcode=HR_SETUP_UPDATE_RELIGION&errmesg=" & lblErrMessage.Text & "&redirect=HR/Setup/HR_setup_Religion.aspx")
        End Try
    ...
    Sub DEDR_Delete(ByVal Sender As Object, ByVal E As DataGridCommandEventArgs)
        ...
        Try
            intErrNo = ObjOK.mtdInsertDataCommon(strOppCd_UPD, ParamNama, ParamValue)
        Catch Exp As System.Exception
            Response.Redirect("../../../include/mesg/ErrorMessage.aspx?errcode=HR_SETUP_DELETE_LVEL&errmesg=" & lblErrMessage.Text & "&redirect=HR/Setup/HR_setup_Religion.aspx")
        End Try
    ...
    Sub DEDR_Add(ByVal Sender As Object, ByVal E As ImageClickEventArgs)
        ...
        newRow.Item("EmpTyCode") = ""
        newRow.Item("Description") = ""
		newRow.Item("Symbol") = ""
		newRow.Item("GroupType") = ""
		newRow.Item("TaxType") = ""
    ...
    Sub onload_GetLangCap()
        ...
        lblTitle.Text = UCase(GetCaption(objLangCap.EnumLangCap.Religion))
        lblReligion.Text = GetCaption(objLangCap.EnumLangCap.Religion)
        lblDesc.Text = GetCaption(objLangCap.EnumLangCap.ReligionDesc)

        strValidateCode = lblValidate.Text & lblReligion.Text & lblCode.Text & "."
        strValidateDesc = lblValidate.Text & lblDesc.Text & "."

        EventData.Columns(0).HeaderText = lblReligion.Text & lblCode.Text
    ...
    Sub GetEntireLangCap()
        ...
        Try
            intErrNo = objLangCap.mtdGetBussTerm(strOpCode_BussTerm, _
                                                 ...
                                                 strParam)
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=PU_GET_LANGCAP&errmesg=" & lblErrMessage.Text & "&redirect=HR/Setup/HR_setup_Religion.aspx")
        End Try
