...
Public Class PR_KTNList : Inherits Page
        ...
        Else
            ...
            If Not Page.IsPostBack Then
                ...
                If Session("KTN") <> "" Then
                    ...
                    BindAccYear(ary(1))
                    ddlsupplier.SelectedValue = ary(2)
	...
	Sub BindSupplier()
        ...
        If objEmpDivDs.Tables(0).Rows.Count > 0 Then
            For intCnt = 0 To objEmpDivDs.Tables(0).Rows.Count - 1
                objEmpDivDs.Tables(0).Rows(intCnt).Item("SupplierCode") = Trim(objEmpDivDs.Tables(0).Rows(intCnt).Item("SupplierCode"))
                objEmpDivDs.Tables(0).Rows(intCnt).Item("Name") = Trim(objEmpDivDs.Tables(0).Rows(intCnt).Item("Name"))
            Next
        End If
        ...
        ddlsupplier.DataSource = objEmpDivDs.Tables(0)
    ...
    Sub BindGrid()
        ...
        For intCnt = 0 To dgEmpList.Items.Count - 1
            ...
            End If
            if (intlevel >=2) or (intlevel=0 and lbstatus.Text.Trim() = "3") then
    ...
    Protected Function LoadData() As DataSet
        ...
        strSrchEmpName = IIf(ddlsupplier.SelectedItem.Value.Trim() = "", "", ddlsupplier.SelectedItem.Value.Trim())
        ...
        strSearch1 = "AND x.BKMCode Like '%" & strSrchBKM & "%' " & _
                     ...
                     "AND x.Status like '" & strSrchStatus & "%' " & _ 
					 "AND y.CodeAlojob like '" &  strSrchBKMAkt &  "%' "
	    ...
	    strSearch = "AND (B.Name Like '%" & strSrchEmpName & "%')"  
        ...
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=PR_PR_TRX_BKM_MAIN_GET_LIST&errmesg=" & Exp.Message )
        End Try
    ...
    Sub BKMLink_Click(ByVal Sender As Object, ByVal E As DataGridCommandEventArgs)
        If Not E.CommandName.ToString = "Sort" And Not E.CommandName.ToString = "Delete" Then
            ...
            Session("KTN") = ddlEmpMonth.SelectedItem.Value.Trim() & "|" & _
                          ...
                          ddlsupplier.SelectedItem.Value.Trim() & "|" & _
						  ...
						  ddlEmpBKMAkt.SelectedItem.Value.Trim() 
    ...
    Sub DEDR_Delete(ByVal Sender As Object, ByVal E As DataGridCommandEventArgs)
        ...
        strstatus = IIf(lbstatus.Text.Trim() = "3", "4", "3")
