...
Public Class IN_Rpt_StockItem : inherits page
    ...
    Sub Bind_ITEM(ByVal blnIsPDFFormat As Boolean)
        ...
        strSearch =  "AND Loccode = '" & strLocation & "' AND ItemType = '" & objInventory.EnumInventoryItemType.Stock & "' AND itm.Status like  '" & IIF(Not strStatus = "", strStatus, "%" ) &"' "
        ...
        rdCrystalViewer.Load(objMapPath & "Web\EN\IN\Reports\Crystal\IN_Rpt_StockItem.rpt", OpenReportMethod.OpenReportByTempCopy)
        ...
        Else
            ...
            DiskOpts.DiskFileName = objMapPath & "web\ftp\IN_Rpt_StockItem.pdf"
            rdCrystalViewer.ExportOptions.DestinationOptions = DiskOpts
            rdCrystalViewer.Export()

            Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../../ftp/IN_Rpt_StockItem.pdf"">")
        End If
