...
Public Class WM_TransporterDet : Inherits Page
    ...
    Sub btnSave_Click(ByVal Sender As Object, ByVal E As ImageClickEventArgs)
        Dim strOpCd_Transporter_Add As String = "WM_CLSSETUP_TRANSPORTER_ADD_AUTO" '"WM_CLSSETUP_TRANSPORTER_ADD"
        ...
        Else
            strParamName = "TRANSPORTERCODE|NAME|ADDRESS|TELNO|STATUS|CREATEDATE|UPDATEDATE|UPDATEID|TTYPE"
            strParamValue = txtTransCode.Text & "|" & strName & "|" & strAddress & "|" & strTelNo & "|" & objWM.EnumTransporterStatus.Active & "|" & _
                            Now() & "|" & Now() & "|" & Trim(strUserId) & "|" & strTType
