...
Public Class GL_Rpt_BlockGrp : inherits page
    ...
    Public Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        strBlkGrpCodeTag = Trim(Request.QueryString("strBlkGrpCodeTag"))  
        ...
        strBlkGrpCode = Trim(Request.QueryString("strBlkGrpCode"))
    ...
    Sub Bind_ITEM(ByVal blnIsPDFFormat As Boolean)
        ...
        Dim strOpCd As String = "GL_CLSSETUP_BLOCKGROUP_LIST_GET"
        ...
        strSearch =  " AND blk.Status like '" & IIF(Not strStatus = "", strStatus, "%" ) &"' "

        If NOT strBlkGrpCode = "" Then
            strSearch =  strSearch & " AND blk.BlkGrpCode like '" & strBlkGrpCode & "%' "
        End If
        
        If NOT strDescription = "" Then
            strSearch = strSearch & " AND blk.Description like '" & _
                        strDescription &"%' "
        End If
        ...
        For intCnt=0 To objRptDs.Tables(0).Rows.Count - 1
            objRptDs.Tables(0).Rows(intCnt).Item("BlkGrpCode") = Trim(objRptDs.Tables(0).Rows(intCnt).Item("BlkGrpCode"))
        ...
        For intCnt=0 To objRptDs.Tables(0).Rows.Count - 1
            objRptDs.Tables(0).Rows(intCnt).Item("Status") = objGLSetup.mtdGetBlkGrpStatus(objRptDs.Tables(0).Rows(intCnt).Item("Status"))
            objRptDs.Tables(0).Rows(intCnt).Item("UpdateDate") = objGlobal.GetLongDate(objRptDs.Tables(0).Rows(intCnt).Item("UpdateDate"))
        Next


        rdCrystalViewer.Load(objMapPath & "Web\EN\GL\Reports\Crystal\GL_Rpt_BlockGrp.rpt", OpenReportMethod.OpenReportByTempCopy)
        ...
        Else
            ...
            DiskOpts.DiskFileName = objMapPath & "web\ftp\GL_Rpt_BlockGrp.pdf"
            rdCrystalViewer.ExportOptions.DestinationOptions = DiskOpts
            rdCrystalViewer.Export()

            Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../../ftp/GL_Rpt_BlockGrp.pdf"">")
        End If
    ...
    Sub PassParam()
        ...
        paramField3 = ParamFields.Item("strBlkGrpCodeTag")
        ...
        ParamDiscreteValue3.value = strBlkGrpCodeTag
