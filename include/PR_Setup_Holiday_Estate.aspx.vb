...
Public Class PR_Setup_Holiday_Estate : Inherits Page
    ...
    Protected WithEvents srchHolDate As TextBox
    ...
    Dim strOppCd_GET As String = "PR_PR_STP_HOLIDAY_GET"
    Dim strOppCd_UPD As String = "PR_PR_STP_HOLIDAY_UPD"
    ...
    Protected Function LoadData() As DataSet
        ...
        SearchStr = " AND year(A.HolidayDate)='" & Trim(srcperiode.Text) & "' AND A.Status like '1'"

        
        If Not srchHolDate.Text = "" Then
            SearchStr = SearchStr & " AND A.HolidayDate like '%" & _
                        srchHolDate.Text & "%' "
        End If
    ...
    Sub DEDR_Edit(ByVal Sender As Object, ByVal E As DataGridCommandEventArgs)
        ...
        Select Case CInt(EditText.Text) = "1"
            Case True
                ...
                ddlTemp = EventData.Items.Item(CInt(E.Item.ItemIndex)).FindControl("ddliswkd")
                ddlTemp.SelectedValue = lblTemp.Text.Trim
            Case False
    ...
    Sub DEDR_Update(ByVal Sender As Object, ByVal E As DataGridCommandEventArgs)
        ...
        HolDay = Date_Validation(EditText.Text, False)
        If HolDay = "" Then
        ...
        EditText = E.Item.FindControl("isTHR")
        If EditText.Text = "Y" Or EditText.Text = "y" Then
            THR = "1"
        ElseIf EditText.Text = "N" Or EditText.Text = "n" Then
            THR = "0"
        End If
        list = E.Item.FindControl("ddliswkd")
        Ty = list.SelectedItem.Value.Trim()


        ParamNama = "HD|Desc|ST|CD|UD|UI|THR|TY"
        ParamValue = HolDay & "|" & _
                    Description & "|" & _
                    Status & "|" & _
                    CreateDate & "|" & _
    ...
    Sub DEDR_Add(ByVal Sender As Object, ByVal E As ImageClickEventArgs)
        ...
        newRow.Item("HolidayDate") = Format(DateTime.Now(), "dd MMM yyyy")
    ...
    Sub GenerateBtn_Click(ByVal Sender As Object, ByVal E As ImageClickEventArgs)
        Dim stropp As String = "PR_PR_STP_HOLIDAY_GEN_WKD"
        ...
        ParamNama = "PR|UI"
        ParamValue = srcperiode.Text.Trim() & "|" & _
                     strUserId & "|"


        Try
            intErrNo = ObjOK.mtdInsertDataCommon(stropp, ParamNama, ParamValue)
        Catch Exp As System.Exception
