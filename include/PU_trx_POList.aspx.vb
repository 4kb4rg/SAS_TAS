...
Public Class PU_POList : Inherits Page
    ...
    Sub BindGrid()
        ...
        If lstDept.SelectedIndex > 0 Then
            sSQLKriteria = sSQLKriteria & "AND A.DeptCode='" & lstDept.SelectedItem.Value & "'"
        End If
        ...
        For intCnt = 0 To dgPOList.Items.Count - 1
            ...
            If RTrim(CType(dgPOList.Items(intCnt).FindControl("lblDocID"), Label).Text) <> "" And RTrim(CType(dgPOList.Items(intCnt).FindControl("lblGRStatus"), Label).Text) <> "1" Then
                dgPOList.Items(intCnt).Cells(13).BackColor = Drawing.Color.Blue
                dgPOList.Items(intCnt).Cells(13).ForeColor = Drawing.Color.White
            End If

            If RTrim(CType(dgPOList.Items(intCnt).FindControl("lblDocID"), Label).Text) <> "" And RTrim(CType(dgPOList.Items(intCnt).FindControl("lblGRStatus"), Label).Text) = "1" Then
                dgPOList.Items(intCnt).Cells(13).BackColor = Drawing.Color.Yellow
                dgPOList.Items(intCnt).Cells(13).ForeColor = Drawing.Color.Black
            End If
