...
Public Class HR_data_upload : Inherits Page
    ...
    Sub UploadBtn_Click(Sender As Object, E As ImageClickEventArgs)
        ...
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=HRDATA_GET_FTPPATH&errmesg=" & lblErrMesage.Text & "&redirect=hr/data/hr_data_upload.aspx")
        End Try        
        ...
        If objGlobal.mtdValidateUploadFileName(strZipName, objGlobal.EnumDataTransferFileType.HR_HumanResourceReferenceData, strErrMsg) = False Then
        ...
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=HRDATA_SAVEAS&errmesg=" & lblErrUpload.Text & "&redirect=hr/data/hr_data_upload.aspx")
        End Try
        ...
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=HRDATA_DECRYPT_REF&errmesg=" & lblErrMesage.Text & "&redirect=hr/data/hr_data_upload.aspx")
        End Try
        ...
        Try
            intErrNo = objHRData.mtdUploadRef(strXmlPath)
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=HRDATA_UPLOAD_REF&errmesg=" & lblErrMesage.Text & "&redirect=hr/data/hr_data_upload.aspx")
        End Try
