...
Public Class HR_setup_ShiftList : Inherits Page
    ...
    Sub Page_Load(Sender As Object, E As EventArgs)
        ...
        Else
            If SortExpression.Text = "" Then
                SortExpression.Text = "S.ShiftCode"
            End If
    ...
    Protected Function LoadData() As DataSet
        ...
        Dim strSrchShiftCode As String
        ...
        strSrchShiftCode = IIF(txtShiftCode.Text = "", "", txtShiftCode.Text)
        ...
        strParam = strSrchShiftCode & "|" & _
                   ...
                   SortCol.Text & "|"
        Try
            intErrNo = objHRSetup.mtdGetShift(strOpCd_GET, strParam, objGangDs, False)
        ...
        If objGangDs.Tables(0).Rows.Count > 0 Then
            For intCnt = 0 To objGangDs.Tables(0).Rows.Count - 1
                objGangDs.Tables(0).Rows(intCnt).Item("ShiftCode") = objGangDs.Tables(0).Rows(intCnt).Item("ShiftCode").Trim()
                objGangDs.Tables(0).Rows(intCnt).Item("Description") = objGangDs.Tables(0).Rows(intCnt).Item("Description").Trim()
            Next
        End If
    ...
    Sub DEDR_Delete(Sender As Object, e As DataGridCommandEventArgs)
        ...
        strSelShiftCode = CPCell.Text
        strParam = strSelShiftCode & "|||" & objHRSetup.EnumShiftStatus.Deleted
        ...
        Try
            intErrNo = objHRSetup.mtdUpdShift(strOpCd_ADD, _
                                            ...
                                            True)
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=HR_SETUP_SHIFT_DEL&errmesg=" & Exp.ToString() & "&redirect=hr/setup/HR_setup_ShiftList.aspx")
        End Try
    ...
    Sub NewBtn_Click(Sender As Object, E As ImageClickEventArgs)
        Response.Redirect("HR_setup_Shiftdet.aspx")
    End Sub
