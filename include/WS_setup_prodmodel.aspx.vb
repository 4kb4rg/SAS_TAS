...
Public Class WS_ProdModel : Inherits Page
    ...
    Protected WithEvents lblProdModelDesc As Label
    ...
    Sub Page_Load(ByVal Sender As Object, ByVal E As EventArgs)
        ...
        ElseIf objAR.mtdHasAccessRights(objAR.mtdGetAccessRights(objAR.EnumWSAccessRights.WSProductModel), intWSAR) = False Then
    ...
    Sub onload_GetLangCap()
        ...
        lblProdModelDesc.Text = GetCaption(objLangCap.EnumLangCap.ProdModelDesc)
        lblTitle.Text = UCase(lblProdModel.Text)

        EventData.Columns(0).HeaderText = lblProdModel.Text & lblCode.Text
        EventData.Columns(1).HeaderText = lblProdModelDesc.Text

        strProdModelErr = lblPleaseEnter.Text & lblProdModel.Text & lblCode.Text
        strDescErr = lblPleaseEnter.Text & lblProdModelDesc.Text
    End Sub
    ...
    Sub GetEntireLangCap()
        ...
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=WS_SETUP_PRODMODEL_GET_LANGCAP&errmesg=" & lblErrMessage.Text & "&redirect=ws/setup/ws_prodmodel.aspx")
        End Try
    ...
    Sub BindStatusList(ByVal index As Integer)
        ...
        StatusList.Items.Add(New ListItem(objWS.mtdGetProductModelStatus(objWS.EnumProductModelStatus.Active), objWS.EnumProductModelStatus.Active))
        StatusList.Items.Add(New ListItem(objWS.mtdGetProductModelStatus(objWS.EnumProductModelStatus.Deleted), objWS.EnumProductModelStatus.Deleted))

    End Sub

    Sub BindSearchList()

        srchStatusList.Items.Add(New ListItem(objWS.mtdGetProductModelStatus(objWS.EnumProductModelStatus.All), objWS.EnumProductModelStatus.All))
        srchStatusList.Items.Add(New ListItem(objWS.mtdGetProductModelStatus(objWS.EnumProductModelStatus.Active), objWS.EnumProductModelStatus.Active))
        srchStatusList.Items.Add(New ListItem(objWS.mtdGetProductModelStatus(objWS.EnumProductModelStatus.Deleted), objWS.EnumProductModelStatus.Deleted))
    ...
    Protected Function LoadData() As DataSet
        ...
        SearchStr = " AND PModel.Status like '" & IIf(Not srchStatusList.SelectedItem.Value = objWS.EnumProductTypeStatus.All, _
        ...
        Try
            intErrNo = objWS.mtdGetMasterList(strOppCd_GET, strParam, objWS.EnumInventoryMasterType.ProductModel, objDataSet)
        Catch Exp As System.Exception
            Response.Redirect("../../../include/mesg/ErrorMessage.aspx?errcode=GET_PRODMODEL&errmesg=" & lblErrMessage.Text & "&redirect=WS/Setup/WS_prodmodel.aspx")
        End Try
        Return objDataSet
    End Function
    ...
    Sub DEDR_Edit(ByVal Sender As Object, ByVal E As DataGridCommandEventArgs)
        ...
        Select Case CInt(EditText.Text) = objWS.EnumProductModelStatus.Active
            Case True
        ...
        rfv.ErrorMessage = strProdModelErr
    ...
    Sub DEDR_Update(ByVal Sender As Object, ByVal E As DataGridCommandEventArgs)
        ...
        Try
            intErrNo = objWS.mtdUpdMasterList(strOppCd_ADD, _
                                                    ...
                                                    strUserId, _
                                                    strParam, _
                                                    objWS.EnumInventoryMasterType.ProductModel, _
                                                    blnDupKey, _
                                                    blnUpdate.Text)
        Catch Exp As System.Exception
            Response.Redirect("../../../include/mesg/ErrorMessage.aspx?errcode=UPDATE_PRODMODEL&errmesg=" & lblErrMessage.Text & "&redirect=WS/Setup/WS_prodmodel.aspx")
        End Try
    ...
    Sub DEDR_Delete(ByVal Sender As Object, ByVal E As DataGridCommandEventArgs)
        ...
        Status = IIf(EditText.Text = objWS.EnumProductModelStatus.Active, _
                        objWS.EnumProductModelStatus.Deleted, _
                        objWS.EnumProductModelStatus.Active)
        EditText = E.Item.FindControl("CreateDate")
        CreateDate = EditText.Text
        strParam = ProdModelCode & "|" & _
                    Description & "|" & _
