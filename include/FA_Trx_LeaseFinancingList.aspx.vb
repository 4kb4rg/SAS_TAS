...
Public Class FA_trx_LeaseFinancingList : Inherits Page
    ...
    Sub BindStatusList()
        srchStatus.Items.Add(New ListItem(objGLTrx.mtdGetLeaseFinanceStatus(objGLTrx.EnumLeaseFinancingStatus.All), objGLTrx.EnumLeaseFinancingStatus.All))
        srchStatus.Items.Add(New ListItem(objGLTrx.mtdGetLeaseFinanceStatus(objGLTrx.EnumLeaseFinancingStatus.Active), objGLTrx.EnumLeaseFinancingStatus.Active))
        srchStatus.Items.Add(New ListItem(objGLTrx.mtdGetLeaseFinanceStatus(objGLTrx.EnumLeaseFinancingStatus.Confirmed), objGLTrx.EnumLeaseFinancingStatus.Confirmed))
        srchStatus.Items.Add(New ListItem(objGLTrx.mtdGetLeaseFinanceStatus(objGLTrx.EnumLeaseFinancingStatus.Deleted), objGLTrx.EnumLeaseFinancingStatus.Deleted))
        srchStatus.Items.Add(New ListItem(objGLTrx.mtdGetLeaseFinanceStatus(objGLTrx.EnumLeaseFinancingStatus.Cancelled), objGLTrx.EnumLeaseFinancingStatus.Cancelled))
        srchStatus.Items.Add(New ListItem(objGLTrx.mtdGetLeaseFinanceStatus(objGLTrx.EnumLeaseFinancingStatus.Closed), objGLTrx.EnumLeaseFinancingStatus.Closed))
    ...
    Protected Function LoadData() As DataSet
        Dim strOpCd_GET As String = "FA_CLSTRX_LEASEFINANCING_LIST_GET"
        ...
        strSearch = strSearch + IIf(Trim(srchDescription.Text) = "", "", "C.Description LIKE '%" & Trim(srchDescription.Text) & "%' AND ")
    ...
    Sub DEDR_Delete(ByVal Sender As Object, ByVal e As DataGridCommandEventArgs)
        ...
        strParamValue = "SET STATUS = '" & IIf(strSelStatus = objGLTrx.EnumLeaseFinancingStatus.Active, objGLTrx.EnumLeaseFinancingStatus.Deleted, objGLTrx.EnumLeaseFinancingStatus.Active) & "'" & _
