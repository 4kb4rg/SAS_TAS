...
Public Class PM_Setup_UllageVolumeConversionMaster : Inherits Page
    ...
    Dim strOppCd_GET As String = "PM_CLSSETUP_UVCONVERSION_GET"
    Dim strOppCd_ADD As String = "PM_CLSSETUP_UVCONVERSION_ADD"
    Dim strOppCd_UPD As String = "PM_CLSSETUP_UVCONVERSION_UPD"
    ...
    Dim strValidateUllage As String
    ...
    Sub Page_Load(ByVal Sender As Object, ByVal E As EventArgs)
        ...
        ElseIf objAR.mtdHasAccessRights(objAR.mtdGetAccessRights(objAR.EnumPMAccessRights.PMVolConvMaster), intPMAR) = False Then
    ...
    Sub onload_GetLangCap()
        GetEntireLangCap()
        lblTitle.Text = "ULLAGE - VOLUME CONVERSION MASTER" 
        lblUVTableCode.Text = "Table Code" 
        lblUllage.Text = "Ullage (MM)" 
        lblVolume.Text = "Volume (Litres)" 

        strValidateTableCode = lblPleaseEnter.Text & lblUVTableCode.Text & "."
        strValidateUllage = lblPleaseEnter.Text & lblUllage.Text & "."
        strValidateVolume = lblPleaseEnter.Text & lblVolume.Text & "."

        EventData.Columns(0).HeaderText = lblUVTableCode.Text
        EventData.Columns(1).HeaderText = lblUllage.Text
        EventData.Columns(2).HeaderText = lblVolume.Text

        TitleTag = lblTitle.Text & lblList.Text
        TableCodeTag = lblUVTableCode.Text
        UllageTag = lblUllage.Text
    ...
    Sub GetEntireLangCap()
        ...
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=PM_SETUP_ULLAGEVOLUMETABLE_GET_LANGCAP&errmesg=" & lblErrMessage.Text & "&redirect=PM/Setup/PM_Setup_UllageVolumeConversionMaster.aspx")
        End Try
    ...
    Sub BindStatusList(ByVal index As Integer)
        ...
        StatusList.Items.Add(New ListItem(objPM.mtdGetUllageVolumeConversionStatus(objPM.EnumUllageVolumeConversionStatus.Active), objPM.EnumUllageVolumeConversionStatus.Active))
        StatusList.Items.Add(New ListItem(objPM.mtdGetUllageVolumeConversionStatus(objPM.EnumUllageVolumeConversionStatus.Deleted), objPM.EnumUllageVolumeConversionStatus.Deleted))

    End Sub

    Sub BindSearchList()
        srchStatusList.Items.Add(New ListItem(objPM.mtdGetUllageVolumeConversionStatus(objPM.EnumUllageVolumeConversionStatus.All), objPM.EnumUllageVolumeConversionStatus.All))
        srchStatusList.Items.Add(New ListItem(objPM.mtdGetUllageVolumeConversionStatus(objPM.EnumUllageVolumeConversionStatus.Active), objPM.EnumUllageVolumeConversionStatus.Active))
        srchStatusList.Items.Add(New ListItem(objPM.mtdGetUllageVolumeConversionStatus(objPM.EnumUllageVolumeConversionStatus.Deleted), objPM.EnumUllageVolumeConversionStatus.Deleted))
    ...
    Protected Function LoadData() As DataSet
        ...
        SearchStr = " AND UVC.Status like '" & IIf(Not srchStatusList.SelectedItem.Value = objPM.EnumUllageVolumeConversionStatus.All, _
                       srchStatusList.SelectedItem.Value, "%") & "' "

        If Not srchUVTableCode.Text = "" Then
            SearchStr = SearchStr & " AND UVC.UVTableCode like '" & srchUVTableCode.Text & "%' "
        End If
        If Not srchUllage.Text = "" Then
            SearchStr = SearchStr & " AND UVC.Ullage like '" & srchUllage.Text & "%' "
        End If
        If Not srchVolume.Text = "" Then
            SearchStr = SearchStr & " AND UVC.Volume like '" & srchVolume.Text & "%' "
        End If
        ...
        Try
            intErrNo = objPM.mtdGetUllageVolumeConversion(strOppCd_GET, strParam, objDataSet)
        Catch Exp As System.Exception
            Response.Redirect("../../../include/mesg/ErrorMessage.aspx?errcode=GET_ULLAGEVOLUMECONVERSION&errmesg=" & lblErrMessage.Text & "&redirect=PM/Setup/PM_Setup_UllageVolumeConversionMaster.aspx")
        End Try
    ...
    Sub btnPreview_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        strUllage = srchUllage.Text
        strVolume = srchVolume.Text
        strUpdateBy = srchUpdateBy.Text
        strSortExp = SortExpression.Text
        strSortCol = sortcol.Text

        Response.Write("<Script Language=""JavaScript"">window.open(""../reports/PM_Rpt_UllageVolumeConversionMasterList.aspx?strStatus=" & strStatus & _
                       "&strTableCode=" & strTableCode & _
                       "&strUllage=" & strUllage & _
    ...
    Sub DEDR_Edit(ByVal Sender As Object, ByVal E As DataGridCommandEventArgs)
        ...
        Dim validateUllage As RequiredFieldValidator
        ...
        Select Case CInt(EditText.Text) = objPM.EnumUllageVolumeTableStatus.Active
            Case True
                ...
                EditText = EventData.Items.Item(CInt(E.Item.ItemIndex)).FindControl("txtUllage")
        ...
        validateUllage = EventData.Items.Item(CInt(E.Item.ItemIndex)).FindControl("ValidateUllage")
        ...
        validateUllage.ErrorMessage = strValidateUllage
    ...
    Sub DEDR_Update(ByVal Sender As Object, ByVal E As DataGridCommandEventArgs)
        ...
        EditText = E.Item.FindControl("txtUllage")
        Ullage = EditText.Text
        ...
        Try
            intErrNo = objPM.mtdUpdUllageVolumeConversion(strOppCd_ADD, _
                                                    strOppCd_UPD, _
                                                    strOppCd_GET, _
                                                    strCompany, _
                                                    strLocation, _
                                                    ...
                                                    blnUpdate.Text)
        Catch Exp As System.Exception
            Response.Redirect("../../../include/mesg/ErrorMessage.aspx?errcode=UPDATE_ULLAGEVOLUMECONVERSION&errmesg=" & lblErrMessage.Text & "&redirect=PM/Setup/PM_Setup_UllageVolumeConversionMaster.aspx")
        End Try
    ...
    Sub DEDR_Delete(ByVal Sender As Object, ByVal E As DataGridCommandEventArgs)
        ...
        Status = IIf(EditText.Text = objPM.EnumUllageVolumeConversionStatus.Active, _
                        objPM.EnumUllageVolumeConversionStatus.Deleted, _
                        objPM.EnumUllageVolumeConversionStatus.Active)
        EditText = E.Item.FindControl("txtCreateDate")
        CreateDate = EditText.Text
        strParam = TableCode & "|" & _
                    Ullage & "|" & _
    ...
    Sub DEDR_Add(ByVal Sender As Object, ByVal E As ImageClickEventArgs)
        ...
        validateUllage = EventData.Items.Item(CInt(EventData.EditItemIndex)).FindControl("ValidateUllage")
