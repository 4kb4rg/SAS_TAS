...
Public Class PR_StdRpt_GangAvgEarnPreview : Inherits Page
    ...
    Sub BindReport()
        ...
        'Try
        '    strRptPrefix = "PR_StdRpt_GangAvgEarn"

        '    strOpCd = "PR_STDRPT_GANGAVGEARN_SP" & objPRRpt.mtdGetPRReportTable(objPRRpt.EnumPRReportTable.GangAvgEarn) & Chr(9)
        ...
        '    intErrNo = objPRRpt.mtdGetReport_GangAvgEarn_SP(strOpCd, _
        '                                                    strCompany, _
        '                                                    strLocation, _
        '                                                    strUserId, _
        '                                                    strAccMonth, _
        ...
        '    Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=PR_STDRPT_GANGAVGEARN_GET&errmesg=" & Exp.ToString() & "&redirect=")
        'End Try
