...
Public Class PM_Rpt_UllageAverageCapacityConversionMasterList : inherits page
    ...
    Public Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        strUllageFrom = Trim(Request.QueryString("strUllageFrom"))
        strUllageTo = Trim(Request.QueryString("strUllageTo"))
        strUllageDiff = Trim(Request.QueryString("strUllageDiff"))
        ...
        UllageFromTag = Trim(Request.QueryString("UllageFromTag"))
        UllageToTag = Trim(Request.QueryString("UllageToTag"))
        UllageDiffTag = Trim(Request.QueryString("UllageDiffTag"))
    ...
    Sub Bind_ITEM(ByVal blnIsPDFFormat As Boolean)
        ...
        Dim strOpCd As String = "PM_CLSSETUP_UACAPACITYCONVERSION_GET"
        ...
        strSearch =  " AND UACC.Status like '" & IIF(Not strStatus = "", strStatus, "%" ) & "' "

        If NOT strTableCode = "" Then
            strSearch =  strSearch & " AND UACC.UVTableCode like '" & strTableCode & "%' "
        End If
        
        If NOT strUllageFrom = "" Then
            strSearch = strSearch & " AND UACC.UllageFrom like '" & strUllageFrom & "%' "
        End If
        
        If NOT strUllageTo = "" Then
            strSearch = strSearch & " AND UACC.UllageTo like '" & strUllageTo & "%' "
        End If
        
        If NOT strUllageDiff = "" Then
            strSearch = strSearch & " AND UACC.UllageDiff like '" & strUllageDiff & "%' "
        End If
        
        If NOT strVolume = "" Then
            strSearch = strSearch & " AND UACC.Volume like '" & strVolume & "%' "
        End If
        ...
        Try
            intErrNo = objPM.mtdGetUllageAverageCapacityConversion(strOpCd, strParam, objRptDs)
        ...
        For intCnt=0 To objRptDs.Tables(0).Rows.Count - 1
            objRptDs.Tables(0).Rows(intCnt).Item("Status") = objPM.mtdGetUllageAverageCapacityConversionStatus(objRptDs.Tables(0).Rows(intCnt).Item("Status"))
            objRptDs.Tables(0).Rows(intCnt).Item("UpdateDate") = objGlobal.GetLongDate(objRptDs.Tables(0).Rows(intCnt).Item("UpdateDate"))
        Next

        rdCrystalViewer.Load(objMapPath & "Web\EN\PM\Reports\Crystal\PM_Rpt_UllageAverageCapacityConversionMasterList.rpt", OpenReportMethod.OpenReportByTempCopy)
        ...
        Else
            ...
            DiskOpts.DiskFileName = objMapPath & "web\ftp\PM_Rpt_UllageAverageCapacityConversionMasterList.pdf"
            rdCrystalViewer.ExportOptions.DestinationOptions = DiskOpts
            rdCrystalViewer.Export()

            Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../../ftp/PM_Rpt_UllageAverageCapacityConversionMasterList.pdf"">")
        End If
    ...
    Sub PassParam()
        ...
        paramField5 = ParamFields.Item("UllageFromTag")
        paramField6 = ParamFields.Item("UllageToTag")
        paramField7 = ParamFields.Item("UllageDiffTag")
        paramField8 = ParamFields.Item("VolumeTag")
        ...
        ParamDiscreteValue5.value = UllageFromTag
        ParamDiscreteValue6.value = UllageToTag
        ParamDiscreteValue7.value = UllageDiffTag
        ParamDiscreteValue8.value = VolumeTag
