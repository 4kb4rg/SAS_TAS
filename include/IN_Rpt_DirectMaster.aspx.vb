...
Public Class IN_Rpt_DirectMaster : inherits page
    ...
    Sub Bind_ITEM(ByVal blnIsPDFFormat As Boolean)
        ...
        strSearch =  "AND ItemType = '" & objInventory.EnumInventoryItemType.DirectCharge & "' AND itm.Status like  '" & IIF(Not strStatus = "", strStatus, "%" ) &"' "
        ...
        rdCrystalViewer.Load(objMapPath & "Web\EN\IN\Reports\Crystal\IN_Rpt_DirectMaster.rpt", OpenReportMethod.OpenReportByTempCopy)
        ...
        Else
            ...
            DiskOpts.DiskFileName = objMapPath & "web\ftp\IN_Rpt_DirectMaster.pdf"
            rdCrystalViewer.ExportOptions.DestinationOptions = DiskOpts
            rdCrystalViewer.Export()

            Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../../ftp/IN_Rpt_DirectMaster.pdf"">")
        End If
