...
Public Class TX_Rpt_TaxReports : Inherits Page
    ...
    Dim str21TtpDPPAmt As String
    Dim str21TtpTaxAmt As String
    Dim str21TdkTtpDPPAmt As String
    Dim str21TdkTtpTaxAmt As String
    Dim str21TtpQty As String
    Dim str21TdkTtpQty As String
    ...
    Public Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        str21TtpQty = IIf(Trim(Request.QueryString("str21TtpQty")) = "", "0", Trim(Request.QueryString("str21TtpQty")))
        str21TtpDPPAmt = IIf(Trim(Request.QueryString("str21TtpDPPAmt")) = "", "0", Trim(Request.QueryString("str21TtpDPPAmt")))
        str21TtpTaxAmt = IIf(Trim(Request.QueryString("str21TtpTaxAmt")) = "", "0", Trim(Request.QueryString("str21TtpTaxAmt")))
        str21TdkTtpQty = IIf(Trim(Request.QueryString("str21TdkTtpQty")) = "", "0", Trim(Request.QueryString("str21TdkTtpQty")))
        str21TdkTtpDPPAmt = IIf(Trim(Request.QueryString("str21TdkTtpDPPAmt")) = "", "0", Trim(Request.QueryString("str21TdkTtpDPPAmt")))
        str21TdkTtpTaxAmt = IIf(Trim(Request.QueryString("str21TdkTtpTaxAmt")) = "", "0", Trim(Request.QueryString("str21TdkTtpTaxAmt")))
    ...
    Sub Bind_ITEM(ByVal blnIsPDFFormat As Boolean)
        ...
        Select Case strPrintOpt
            ...
            Case "4"
                ...
                End If
            Case "5"
                If strLembarInt = "0" Then
                    strOpCd = "TX_STDRPT_GET_SSPALL"
                Else
                    strOpCd = "TX_STDRPT_GET_SPTMASA"
                End If
        End Select
    ...
    Sub PassParam()
        ...
        paramField21 = paramFields.Item("str21TtpDPPAmt")
        paramField22 = paramFields.Item("str21TtpTaxAmt")
        paramField23 = paramFields.Item("str21TdkTtpDPPAmt")
        paramField24 = paramFields.Item("str21TdkTtpTaxAmt")
        paramField25 = paramFields.Item("str21TtpQty")
        paramField26 = paramFields.Item("str21TdkTtpQty")
        ...
        ParamDiscreteValue21.Value = str21TtpDPPAmt
        ParamDiscreteValue22.Value = str21TtpTaxAmt
        ParamDiscreteValue23.Value = str21TdkTtpDPPAmt
        ParamDiscreteValue24.Value = str21TdkTtpTaxAmt
        ParamDiscreteValue25.Value = str21TtpQty
        ParamDiscreteValue26.Value = str21TdkTtpQty
