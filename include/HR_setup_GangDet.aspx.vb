...
Public Class HR_setup_GangDet : Inherits Page
    ...
    Sub BackBtn_Click(Sender As Object, E As ImageClickEventArgs)
        Response.Redirect("HR_setup_Ganglist.aspx")
    End Sub
    ...
    Sub BindDept(ByVal pv_strDeptCode As String)
        ...
        For intCnt = 0 To objBlkGrpDs.Tables(0).Rows.Count - 1
            ...
            objBlkGrpDs.Tables(0).Rows(intCnt).Item("Description") = objBlkGrpDs.Tables(0).Rows(intCnt).Item("DeptCode") & " (" & Trim(objBlkGrpDs.Tables(0).Rows(intCnt).Item("Description")) & ")"
        ...
        If intSelectIndex = 0 Then
            If pv_strDeptCode <> "" Then
                ...
                dr("Description") = Trim(pv_strDeptCode)
            Else
                dr("DeptCode") = ""
    ...
    Sub GangLevel_Changed(sender As Object, e As EventArgs)
   ...
   Sub GangLeader_Changed(sender As Object, e As EventArgs)
        Dim strGangLevel As String = ddlGangLevel.SelectedItem.Value  
