...
Public Class PR_StdRpt_GajiBesarPreview_Rekap_Estate : Inherits Page
    ...
    Sub BindReport()
        ...
        Dim strOpCd As String = "PR_PR_STDRPT_GAJIBESAR_REKAP_REPORT"
        Dim strParamName As String
        Dim strParamValue As String
        Dim ReportID As String = Request.QueryString("RptID")


        strParamName = "ACCMONTH|ACCYEAR|PHYMONTH|PHYYEAR|COMPCODE|LOCCODE|DATEFROM|DATETO|DECIMAL|F_TYPE"
        ...
        rdCrystalViewer.Load(objMapPath & "web\" & strLangCode & "\reports\crystal\PR_StdRpt_GajiBesar_Rekap_Estate.rpt", OpenReportMethod.OpenReportByTempCopy)
        ...
        If strExportToExcel = "0" Then
            crDiskFileDestinationOptions.DiskFileName = objMapPath & "web\ftp\PR_StdRpt_GajiBesar_Rekap_Estate.pdf"
        Else
            crDiskFileDestinationOptions.DiskFileName = objMapPath & "web\ftp\PR_StdRpt_GajiBesar_Rekap_Estate.xls"
        End If
        ...
        If strExportToExcel = "0" Then
            Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../ftp/PR_StdRpt_GajiBesar_Rekap_Estate.pdf"">")
        Else
            Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../ftp/PR_StdRpt_GajiBesar_Rekap_Estate.xls"">")
        End If
    End Sub
