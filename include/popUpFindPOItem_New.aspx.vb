...
Public Class popUpFindPOItem_New : Inherits Page
    ...
    Protected WithEvents lblSaldo As System.Web.UI.WebControls.Label
    ...
    Protected WithEvents lstStorageFr As System.Web.UI.WebControls.DropDownList
    Protected WithEvents DDLItemGroup As System.Web.UI.WebControls.DropDownList
    ...
    Sub BindItemGroup()
        ...
        strParamValue = "AND PType.ProdTypeCode IN (SELECT ProdTypeCode FROM PU_SUPPLIER_USER Where UserID='" & strUserId & "')" & "|" & ""
        ...
        DDLItemGroup.DataValueField = "ProdTypeCode"
        DDLItemGroup.DataTextField = "Description"
    ...
    Sub BindStorage(ByVal pv_strcode As String)
        ...
        sSQLKriteria = "Select StorageCode,Description From IN_STORAGE Where LocCode='" & strLocCode & "'"
    ...
    Protected Function LoadData() As DataSet
        ...
        Dim strOpCode As String = "IN_CLSTRX_ITEM_PO_STOCK_SEARCH"
        Dim intErrNo As Integer
        Dim strParamName As String = ""
        Dim strParamValue As String = ""
        ...
        strSortExp = " ORDER BY i.ItemCode ASC"
        strParamName = "LOCCODE|STORAGE|STRSEARCH|SORTEXP"

        If txtItemCode.Text.Trim <> "" Then
            sSQLKriteria = "AND (i.Description LIKE '%" & Trim(txtItemCode.Text) & "%' or i.Itemcode LIKE '%" & Trim(txtItemCode.Text) & "%')"
        End If

        strParamValue = strLocCode & "|" & lstStorageFr.SelectedItem.Value & "|" & "AND  Sup.UserID='" & strUserId & "'  " & sSQLKriteria & "" & "|" & strSortExp
    ...
    Sub OnSelectItem(ByVal Sender As Object, ByVal e As DataGridCommandEventArgs)
        ...
        Dim CPCell2 As TableCell = e.Item.Cells(5)
        Dim CPCell3 As TableCell = e.Item.Cells(6)
        ...
        If Left(strINItem, 3) = "txt" Then
            ...
            onclick_reload_txt(strUnitCost, lblCost.Text, False, blnPostBack)
        Else
