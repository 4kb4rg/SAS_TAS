...
Public Class HR_StdRpt_Berhenti_KaryPreview_Estate : Inherits Page
    ...
    Sub BindReport()
        ...
        strOpCd = "HR_HR_STDRPT_EMP_BERHENTI_GET"
        fname = "HR_StdRpt_Emp_Berhenti_Estate"
        ...
        Try
            ...
            objRpt.Tables(0).TableName = "HR_HR_STDRPT_EMP_BERHENTI_DET"
        ...
        objRptDs.Tables(0).TableName = "HR_HR_STDRPT_EMP_BERHENTI_DET"
