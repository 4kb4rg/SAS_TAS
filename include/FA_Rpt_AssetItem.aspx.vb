...
Public Class FA_Rpt_AssetItem : inherits page
    ...
    Sub Bind_ITEM(ByVal blnIsPDFFormat As Boolean)
        ...
        strSearch =  " AND Loccode = '" & strLocation & "' AND ItemType = '" & objInventory.EnumInventoryItemType.FixedAssetItem & "' AND itm.Status like  '" & IIF(Not strStatus = "", strStatus, "%" ) &"' "
        ...
        rdCrystalViewer.Load(objMapPath & "Web\EN\FA\Reports\Crystal\FA_Rpt_AssetItem.rpt", OpenReportMethod.OpenReportByTempCopy)
        ...
        Else
            ...
            DiskOpts.DiskFileName = objMapPath & "web\ftp\FA_Rpt_AssetItem.pdf"
            rdCrystalViewer.ExportOptions.DestinationOptions = DiskOpts
            rdCrystalViewer.Export()

            Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../../ftp/FA_Rpt_AssetItem.pdf"">")
        End If
    End Sub
