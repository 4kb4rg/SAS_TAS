...
Public Class IN_StdRpt_PRList : Inherits Page
    ...
    Sub BindPRStatusList()
        ...
        lstPRStatus.Items.Add(New ListItem("Active", "Active"))
        lstPRStatus.Items.Add(New ListItem("Cancelled", "Cancelled"))
        lstPRStatus.Items.Add(New ListItem("Outstanding/Confirmed", "Outstanding"))

        lstPRStatus.Items.Add(New ListItem("Closed", "Closed"))

        lstPRStatus.Items.Add(New ListItem("Deleted", "Deleted"))
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        Try
            intErrNo = objSysCfg.mtdGetConfigInfo(strParam, _
                                                  ...
                                                  objSysCfgDs)
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=IN_STDRPT_PRLIST_GET_CONFIG_DATE&errmesg=" & lblErrMessage.Text & "&redirect=../en/reports/IN_StdRpt_Selection.aspx")
        End Try
        ...
        If Not (strDateFrom = "" And strDateTo = "") Then
            If objGlobal.mtdValidInputDate(strDateSetting, strDateFrom, objDateFormat, objDateFrom) = True And objGlobal.mtdValidInputDate(strDateSetting, strDateTo, objDateFormat, objDateTo) = True Then
                Response.Write("<Script Language=""JavaScript"">window.open(""IN_StdRpt_PRListPreview.aspx?Type=Print&Location=" & strUserLoc & "&RptID=" & strRptID & "&RptName=" & strRptName & "&Decimal=" & strDec & _
