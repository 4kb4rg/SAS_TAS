...
Public Class PM_Rpt_StorageAreaMasterDetail : Inherits Page
    ...
    Sub BindReport()
        ...
        Dim strOpCd As String = "PM_RPT_STORAGEAREAMASTERDETAIL_GET"
        Dim strFileName As String = "PM_Rpt_StorageAreaMasterDetail"
        ...
        If NOT strStatus = "" Then
            strSearch =  strSearch & " AND SA.Status like '" & strStatus & "' "
        End If
        ...
        If NOT strDescription = "" Then
            strSearch = strSearch & " AND ST.StorageTypeCode like '" & strDescription & "%' "
        End If
        ...
        ElseIf LCase(Trim(strSortExp)) = LCase("Description") Then
            strSortExp = "ST." & Trim(strSortExp)
        ElseIf UCase(Left(strSortExp, 3)) <> "SA." And UCase(Left(strSortExp, 3)) <> "ST." Then
            strSortExp = "SA." & Trim(strSortExp)
        End If
        ...
        Try
            intErrNo = objPMSetup.mtdGetStorageArea(strOpCd, _
                                                strParam, _
                                                objRptDs)
        ...
        For I = 0 To objRptDs.Tables(0).Rows.Count - 1
            ...
            End Select
            objRptDs.Tables(0).Rows(I).Item("Status") = objPMSetup.mtdGetStorageAreaFormulaStatus(objRptDs.Tables(0).Rows(I).Item("Status"))
