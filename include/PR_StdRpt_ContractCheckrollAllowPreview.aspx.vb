...
Public Class PR_StdRpt_ContractCheckrollAllow_Preview : Inherits Page
    ...
    Sub BindReport()
        ...
        Dim strOpCd_Contract_Checkroll_Allow_GET As String = "PR_STDRPT_CONTRACT_CHECKROLL_ALLOW_GET"
        Dim strFileName As String = "PR_StdRpt_ContractCheckRollAllow"
        ...
        If Not Request.QueryString("SuppCode") = "" Then
            SearchStr = "AND CA.SupplierCode LIKE '" & Request.QueryString("SuppCode") & "' "
        End If

        strParam = objPRTrx.EnumContractCheckroll.Active & "|" & objPRSetup.EnumCountDayType.Working & "|" & strUserLoc & "|" & _
                   Request.QueryString("AttdDateFrom").Trim & "|" & Request.QueryString("AttdDateTo").Trim & "|" & _
                   objPRTrx.EnumAttdTrxStatus.Active & "','" & objPRTrx.EnumAttdTrxStatus.Confirmed & "','" & objPRTrx.EnumAttdTrxStatus.Closed & "|" & _
                   objPUSetup.EnumSuppStatus.Active & "|" & objHRTrx.EnumEmpStatus.Active & "|" & SearchStr
        Try
            intErrNo = objPR.mtdGetReport_ContractCheckrollAllow(strOpCd_Contract_Checkroll_Allow_GET, _
                                                                 strParam, _
                                                                 objRptDs, _
                                                                 objMapPath)
    ...
    Sub PassParam()
        ...
        ParamDiscreteValue6.Value = Request.QueryString("Decimal").Trim
        ParamDiscreteValue7.Value = Request.QueryString("lblLocation").Trim
        ParamDiscreteValue8.Value = Request.QueryString("RptID").Trim
        ParamDiscreteValue9.Value = Request.QueryString("RptName").Trim
        ParamDiscreteValue10.Value = Request.QueryString("SuppCode").Trim
        ParamDiscreteValue11.Value = Request.QueryString("AttdDateFrom").Trim
        ParamDiscreteValue12.Value = Request.QueryString("AttdDateTo").Trim
        ...
        ParamFieldDef8 = ParamFieldDefs.Item("ParamRptID")
        ParamFieldDef9 = ParamFieldDefs.Item("ParamRptName")
        ParamFieldDef10 = ParamFieldDefs.Item("ParamSuppCode")
        ParamFieldDef11 = ParamFieldDefs.Item("ParamAttdDateFrom")
        ParamFieldDef12 = ParamFieldDefs.Item("ParamAttdDateTo")
