...
Public Class IN_StdRpt_MthStkAccMoveDetails : Inherits Page
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        Response.Write("<Script Language=""JavaScript"">window.open(""IN_StdRpt_MthStkAccMoveDetailsPreview.aspx?Type=Print&Location=" & strUserLoc & _
