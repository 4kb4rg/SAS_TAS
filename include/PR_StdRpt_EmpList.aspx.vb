...
Public Class PR_StdRpt_EmpList : Inherits Page
    ...
    Sub GetEntireLangCap()
        ...
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=PR_STDRPT_EMPLIST_LANGCAP_BUSSTERM_GET&errmesg=" & lblErrMessage.Text & "&redirect=../en/reports/PR_StdRpt_Selection.aspx")
        End Try
    ...
    Sub BindSortByList()
        ...
        lstSortBy.Items.Add(New ListItem("Employee Name", "name"))
    End Sub
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        Response.Write("<Script Language=""JavaScript"">window.open(""PR_StdRpt_EmpListPreview.aspx?Type=Print&CompName=" & strCompany & _
                       "&Location=" & strUserLoc & _
                       "&RptID=" & strRptID & _
                       "&RptName=" & strRptName & _
                       "&Decimal=" & strDec & _
                       "&lblLocation=" & lblLocation.Text & _
                       "&lblJamsostek=" & lblJamsostek.Text & _
                       "&EmpCodeFrom=" & strEmpCodeFrom & _
                       "&EmpCodeTo=" & strEmpCodeTo & _
                       "&GangCode=" & strGangCode & _
                       "&Status=" & strStatus & _
                       "&SortBy=" & strSortBy & _
                       "&OrderBy=" & strOrderBy & "&SortByText=" & strSortByText & "&OrderByText=" & strOrderByText & """,null ,""status=yes, resizable=yes, scrollbars=yes, toolbar=no, location=no"");</Script>")
    End Sub
