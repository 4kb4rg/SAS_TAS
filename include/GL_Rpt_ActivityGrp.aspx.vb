...
Public Class GL_Rpt_ActivityGrp : inherits page
    ...
    Public Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        strActGrpCode = Trim(Request.QueryString("strActGrpCode"))
        ...
        ActGrpTag = Trim(Request.QueryString("ActGrpTag"))
        ActGrpDescTag = Trim(Request.QueryString("ActGrpDescTag"))
    ...
    Sub Bind_ITEM(ByVal blnIsPDFFormat As Boolean)
        ...
        Dim strOpCd As String = "GL_CLSSETUP_ACTGRP_SEARCH"
        ...
        strSearch =  " AND Act.Status like '" & IIF(Not strStatus = "", strStatus, "%" ) &"' "

        If NOT strActGrpCode = "" Then
            strSearch =  strSearch & " AND Act.ActGrpCode like '" & strActGrpCode & "%' "
        End If
        
        If NOT strDescription = "" Then
            strSearch = strSearch & " AND Act.Description like '" & _
                        strDescription &"%' "
        End If
        ...
        For intCnt=0 To objRptDs.Tables(0).Rows.Count - 1
            objRptDs.Tables(0).Rows(intCnt).Item("Status") = objGLSetup.mtdGetActGrpStatus(objRptDs.Tables(0).Rows(intCnt).Item("Status"))
            objRptDs.Tables(0).Rows(intCnt).Item("UpdateDate") = objGlobal.GetLongDate(objRptDs.Tables(0).Rows(intCnt).Item("UpdateDate"))
        Next

        rdCrystalViewer.Load(objMapPath & "Web\EN\GL\Reports\Crystal\GL_Rpt_ActivityGrp.rpt", OpenReportMethod.OpenReportByTempCopy)
        ...
        Else
            ...
            DiskOpts.DiskFileName = objMapPath & "web\ftp\GL_Rpt_ActivityGrp.pdf"
            rdCrystalViewer.ExportOptions.DestinationOptions = DiskOpts
            rdCrystalViewer.Export()

            Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../../ftp/GL_Rpt_ActivityGrp.pdf"">")
        End If
    ...
    Sub PassParam()
        ...
        paramField4 = ParamFields.Item("ActGrpTag")
        paramField5 = ParamFields.Item("ActGrpDescTag")
        ...
        ParamDiscreteValue4.value = ActGrpTag
        ParamDiscreteValue5.value = ActGrpDescTag
