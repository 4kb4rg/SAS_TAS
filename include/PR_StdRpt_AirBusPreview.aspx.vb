...
Public Class PR_StdRpt_AirBusPreview : Inherits Page
    ...
    Sub BindReport()
        ...
        Dim strOpCdAirBusListGet As String = "PR_STDRPT_AIRFARE_LIST"
        ...
        Try
            intErrNo = objPRRpt.mtdGetReport_AirBusList(strOpCdAirBusListGet, _
                                                           strCompany, _
                                                           strLocation, _
                                                           strUserId, _
                                                           strAccMonth, _
        ...
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=PR_STDRPT_AIRFARE_LIST_REPORT&errmesg=" & lblErrMessage.Text & "&redirect=")
        End Try

        rdCrystalViewer.Load(objMapPath & "web\" & strLangCode & "\Reports\Crystal\PR_StdRpt_AirBusListing.rpt", OpenReportMethod.OpenReportByTempCopy)
        ...
        crDiskFileDestinationOptions.DiskFileName = objMapPath & "web\ftp\PR_StdRpt_AirBusListing.pdf"
        ...
        Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../ftp/PR_StdRpt_AirBusListing.pdf"">")
    End Sub
    ...
    Sub PassParam()
        ...
        paramField9 = paramFields.Item("lblNearLoc")
        paramField10 = paramFields.Item("lblPOH")
        ...
        ParamDiscreteValue9.Value = Request.QueryString("lblNearLoc")
        ParamDiscreteValue10.Value = Request.QueryString("lblPOH")
