...
Public Class PR_setup_AstekList_Estate : Inherits Page

    Protected WithEvents dgLine As DataGrid
    Protected WithEvents lbDelete As LinkButton
    Protected WithEvents lblTracker As Label
    Protected WithEvents lstDropList As DropDownList
    Protected WithEvents txtAstekCode As TextBox
    ...
    Protected Function LoadData() As DataSet
        ...
        If Not txtAstekCode.Text = "" Then
            strSearch = strSearch & " AND A.AstekCode like '%" & _
                        txtAstekCode.Text & "%' "
        End If
        ...
        If objBankDs.Tables(0).Rows.Count > 0 Then
            For intCnt = 0 To objBankDs.Tables(0).Rows.Count - 1
                objBankDs.Tables(0).Rows(intCnt).Item("AstekCode") = Trim(objBankDs.Tables(0).Rows(intCnt).Item("AstekCode"))
    ...
    Sub DEDR_Delete(ByVal Sender As Object, ByVal e As DataGridCommandEventArgs)
        Dim strOpCd_UPD As String = "PR_PR_STP_ASTEK_LIST_DEL"
        Dim int As Integer = e.Item.ItemIndex
        Dim ACCell As TableCell = e.Item.Cells(0)
    ...
    Sub NewAstekBtn_Click(ByVal Sender As Object, ByVal E As ImageClickEventArgs)
        Response.Redirect("PR_setup_ASTEKDet_Estate.aspx")
    End Sub
