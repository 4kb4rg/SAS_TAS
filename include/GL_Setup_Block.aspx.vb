...
Public Class GL_Setup_Block : Inherits Page
    ...
    Sub Page_Load(Sender As Object, E As EventArgs)
        ...
        Else
            ...
            If SortExpression.Text = "" Then
                SortExpression.Text = "blk.BlkCode"
            End If
    ...
    Sub BindGrid() 
        ...
        For intCnt = 0 To dgLine.Items.Count - 1
            ...
            Select Case CInt(Trim(lbl.Text))
                Case objGLSetup.EnumBlockStatus.Active
    ...
    Sub onload_GetLangCap()
        ...
        lblDescription.text = GetCaption(objLangCap.EnumLangCap.BlockDesc)
        NewTBBtn.AlternateText = GetCaption(objLangCap.EnumLangCap.Block)
        ...
        strBlockGrpCodeTag = GetCaption(objLangCap.EnumLangCap.BlockGrp) & lblCode.text
    ...
    Sub GetEntireLangCap()
        ...
        Catch Exp As Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=GL_SETUP_BLOCK_GET_LANGCAP&errmesg=" & lblErrMessage.Text & "&redirect=gl/setup/gl_setup_block.aspx")
        End Try
    ...
    Protected Function LoadData() As DataSet
        ...
        Dim strOpCd_GET As String = "GL_CLSSETUP_BLOCK_LIST_GET"    
        ...
        strSrchBlockCode = IIF(srchBlockCode.Text = "", "", srchBlockCode.Text)
        ...
        Try
            intErrNo = objGLSetup.mtdGetBlock(strOpCd_GET, strLocation, strParam, objGLSetupDs, False)
        ...
        If objGLSetupDs.Tables(0).Rows.Count > 0 Then
            For intCnt = 0 To objGLSetupDs.Tables(0).Rows.Count - 1
                objGLSetupDs.Tables(0).Rows(intCnt).Item("BlkCode") = Trim(objGLSetupDs.Tables(0).Rows(intCnt).Item("BlkCode"))
    ...
    Sub btnPreview_Click (sender As Object, e As ImageClickEventArgs)
        ...
        strBlockCode = srchBlockCode.text
        strDescription = srchDescription.text
        strUpdateBy =  txtLastUpdate.text
        strSortExp = SortExpression.text
        strSortCol = SortCol.text

        Response.Write("<Script Language=""JavaScript"">window.open(""../reports/GL_Rpt_Block.aspx?strBlockCodeTag=" & strBlockCodeTag & _
                    ...
                    "&strBlockGrpCodeTag=" & strBlockGrpCodeTag & "&strStatus=" & strStatus & _
                    "&strBlockCode=" & strBlockCode & "&strDescription=" & strDescription & _
    ...
    Sub DEDR_Delete(Sender As Object, e As DataGridCommandEventArgs)
        ...
        strParam = strSelBlkCode & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & _
                    ...
                    Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & _
                    objGLSetup.EnumBlockStatus.Deleted & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) 
        Try
            intErrNo = objGLSetup.mtdUpdBlock(strOpCd_UPD, _
                                              ...
                                              blnExceedLicSize)
        Catch Exp As Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=GL_SETUP_BLOCK_LIST_DEL&errmesg=" & lblErrMessage.Text & "&redirect=gl/setup/gl_setup_block.aspx")
        End Try
    ...
    Sub NewTBBtn_Click(Sender As Object, E As ImageClickEventArgs)
        Response.Redirect("GL_Setup_BlockDet.aspx")
    End Sub
