...
Public Class IN_Rpt_ProdMaterial : inherits page
    ...
    Public Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        strProdMatCode = Trim(Request.QueryString("strProdMatCode"))
        ...
        ProdMatCodeTag = Trim(Request.QueryString("ProdMatCodeTag"))
        ProdMatDescTag = Trim(Request.QueryString("ProdMatDescTag"))
    ...
    Sub Bind_ITEM(ByVal blnIsPDFFormat As Boolean)
        ...
        Dim strOpCd As String = "IN_CLSSETUP_PRODMAT_LIST_GET_FOR_REPORT"
        ...
        strSearch =  " AND PMat.Status like '" & IIF(Not strStatus = "", strStatus, "%" ) &"' "
        If NOT strProdMatCode = "" Then
            strSearch =  strSearch & " AND PMat.ProdMatCode like '" & strProdMatCode & "%' "
        End If        
        If NOT strDescription = "" Then
            strSearch = strSearch & " AND PMat.Description like '" & _
                        strDescription &"%' "
        End If       
        ...
        Try
            intErrNo = objInventory.mtdGetMasterList(strOpCd, _
                                                     strParam, _
                                                     EnumInventoryMasterType.ProductMaterial, _
                                                     objRptDs)
        ...
        For intCnt=0 To objRptDs.Tables(0).Rows.Count - 1
            objRptDs.Tables(0).Rows(intCnt).Item("Status") = objInventory.mtdGetProductMaterialStatus(objRptDs.Tables(0).Rows(intCnt).Item("Status"))
        ...
        rdCrystalViewer.Load(objMapPath & "Web\EN\IN\Reports\Crystal\In_Rpt_ProdMaterial.rpt", OpenReportMethod.OpenReportByTempCopy)
        ...
        Else
            ...
            DiskOpts.DiskFileName = objMapPath & "web\ftp\In_Rpt_ProdMaterial.pdf"
            rdCrystalViewer.ExportOptions.DestinationOptions = DiskOpts
            rdCrystalViewer.Export()
            Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../../ftp/In_Rpt_ProdMaterial.pdf"">")
        End If
    ...
    Sub PassParam()
        ...
        paramField2 = ParamFields.Item("ProdMatCodeTag")
        paramField3 = ParamFields.Item("ProdMatDescTag")
        ...
        ParamDiscreteValue2.value = ProdMatCodeTag
        ParamDiscreteValue3.value = ProdMatDescTag
