...
Public Class IN_STOCKRESERVLIST : Inherits Page
    ...
    Dim strOppCd_GET As String = "IN_CLSTRX_STOCKRESERV_LIST_GET"
...
'   End Sub
    ...
    Protected Function LoadData() As DataSet
        ...
        If srchStatusList.SelectedItem.Value = 0 Then
            StrStatus = "ALL"
        End If
    ...
    Sub btnNewItm_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        Response.Redirect("../../IN/Trx/IN_trx_StockReserv_details.aspx")
    End Sub
