...
Public Class WS_MasterDetails : Inherits Page
    ...
    Sub Page_Load(ByVal Sender As Object, ByVal E As EventArgs)
        ...
        ElseIf objAR.mtdHasAccessRights(objAR.mtdGetAccessRights(objAR.EnumWSAccessRights.WSItemMaster), intWSAR) = False Then
    ...
    Sub GetEntireLangCap()
        ...
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=WS_SETUP_WORKSHOPITEMMASTER_GET_LANGCAP&errmesg=" & lblErrMessage.Text & "&redirect=ws/setup/ws_stockmaster_detail.aspx")
        End Try
    ...
    Protected Function LoadData() As DataSet
        ...
        strParam = ItemCode & "|" & objIN.EnumInventoryItemType.WorkshopItem & "|" & Trim(strLocation) 
        Try
            intErrNo = objIN.mtdGetMasterDetail(strOppCd_GET, strParam, objDataSet)
        Catch Exp As System.Exception
            Response.Redirect("../../../include/mesg/ErrorMessage.aspx?errcode=GET_STOCKITEM_DETAILS&errmesg=" & lblErrMessage.Text & "&redirect=WS/Setup/WS_StockMaster.aspx")
        End Try
    ...
    Sub UpdateData(ByVal strAction As String)
        ...
        Catch Exp As System.Exception
            Response.Redirect("../../../include/mesg/ErrorMessage.aspx?errcode=UPDATE_STOCKITEM&errmesg=" & lblErrMessage.Text & "&redirect=WS/Setup/WS_StockMaster.aspx")
        End Try
        ...
        Else
            Select Case blnUpdate.Text
                Case True
                    Response.Redirect("WS_StockMaster.aspx")
                Case False
                    Response.Redirect("WS_StockMaster_Detail.aspx")
            End Select
        End If
