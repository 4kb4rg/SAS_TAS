...
Public Class HR_StdRpt_EmployeePayrollPreview : Inherits Page
    ...
    Sub BindReport()
        ...
        Dim strOpCdEmployeePayrollGet As String = "HR_STDRPT_EMPLOYEEPAYROLL_GET"
        ...
        Dim strPayMode As String = Request.QueryString("PayMode")
        Dim strStatus As String = Request.QueryString("Status")
        Dim strRptFileName = "HR_StdRpt_EmployeePayroll"

        SearchStr = ""
        
        If Not (strEmployeeCodeFrom = "" And strEmployeeCodeTo = "") Then
            SearchStr = SearchStr & "  AND PAY.EmpCode >= '" & strEmployeeCodeFrom & "' AND PAY.EmpCode <= '" & strEmployeeCodeTo & "'" & vbCrLf
        End If

        If Not strPayMode = "" Then
            SearchStr = SearchStr & "  AND PAY.PayMode = '" & strPayMode & "'" & vbCrLf
        End If
        ...
        Try
            intErrNo = objHRReport.mtdGetReport_HRGeneral(strOpCdEmployeePayrollGet, strParam, objRptDs, objMapPath)
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=GET_EMPLOYEE_PAYROLL_REPORT&errmesg=" & lblErrMessage.Text & "&redirect=")
        End Try
    ...
    Sub PassParam()
        ...
        paramField7 = paramFields.Item("PayMode")
        ...
        If Not Request.QueryString("PayMode") = "" Then
            ParamDiscreteValue7.Value = objHRTrx.mtdGetPayMode(CInt(Request.QueryString("PayMode")))
        Else
            ParamDiscreteValue7.Value = "All"
        End If
        ParamDiscreteValue8.Value = objHRTrx.mtdGetEmpStatus(Request.QueryString("Status"))
