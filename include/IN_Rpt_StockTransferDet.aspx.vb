...
Public Class IN_Rpt_StockTransferDet : inherits page
    ...
    Sub Bind_ITEM(ByVal blnIsPDFFormat As Boolean)
        ...
        Dim strOpCd_Get As String = "IN_CLSTRX_STOCKTRANSFER_DETAIL_GET_FOR_REPORT" & "|" & "StockTransfer"
        Dim strOpCd_GetLine As String = "IN_CLSTRX_STOCKTRANSFER_LINE_GET" & "|" & "StockTransferLn"
        ...
        Try
            intErrNo = objIN.mtdGetStockTransferReport(strOpCodes, _
                                                       strParam, _
                                                       strCompany, _
                                                       strLocation, _
                                                       strUserId, _
