...
Public Class NU_trx_DoubleTurnList : Inherits Page
    ...
    Sub Page_Load(ByVal Sender As Object, ByVal E As EventArgs)
        ...
        Else
            ...
            If SortExpression.Text = "" Then
                SortExpression.Text = "DoubleTurnID"
            End If
    ...
    Sub GetEntireLangCap()
        ...
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=NU_CLSTRX_DOUBLETURNLIST_GET_LANGCAP&errmesg=" & Exp.ToString() & "&redirect=NU/trx/NU_trx_DoubleTurnList.aspx")
        End Try
    ...
    Sub BindSearchList()
        srchStatusList.Items.Add(New ListItem(objNUTrx.mtdGetDoubleTurnStatus(objNUTrx.EnumDoubleTurnStatus.All), objNUTrx.EnumDoubleTurnStatus.All))
        srchStatusList.Items.Add(New ListItem(objNUTrx.mtdGetDoubleTurnStatus(objNUTrx.EnumDoubleTurnStatus.Closed), objNUTrx.EnumDoubleTurnStatus.Closed))
        srchStatusList.Items.Add(New ListItem(objNUTrx.mtdGetDoubleTurnStatus(objNUTrx.EnumDoubleTurnStatus.Confirmed), objNUTrx.EnumDoubleTurnStatus.Confirmed))
        srchStatusList.Items.Add(New ListItem(objNUTrx.mtdGetDoubleTurnStatus(objNUTrx.EnumDoubleTurnStatus.Deleted), objNUTrx.EnumDoubleTurnStatus.Deleted))
    ...
    Protected Function LoadData() As DataSet
        Dim strOppCode_Get As String = "NU_CLSTRX_DOUBLETURN_GET"
        Dim strParam As String
        Dim intCnt As Integer
        ...
        Try
            intErrNo = objNUTrx.mtdGetDoubleTurn(strCompany, _
                                                ...
                                                objTxDs)
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=NU_CLSTRX_DOUBLETURNLIST_GET&errmesg=" & Exp.ToString() & "&redirect=NU/trx/NU_trx_DoubleTurnList.aspx")
        End Try

        For intCnt = 0 To objTxDs.Tables(0).Rows.Count - 1
            objTxDs.Tables(0).Rows(intCnt).Item("DoubleTurnID") = objTxDs.Tables(0).Rows(intCnt).Item("DoubleTurnID").Trim()
    ...
    Sub NewBtn_Click(ByVal Sender As Object, ByVal E As ImageClickEventArgs)
        Response.Redirect("NU_trx_DoubleTurnDetails.aspx")
    End Sub
