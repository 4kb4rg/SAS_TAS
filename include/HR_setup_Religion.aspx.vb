...
Public Class HR_Setup_Religion : Inherits Page
    ...
    Protected WithEvents srchReligionCode as TextBox
    ...
    Dim strOppCd_GET As String = "HR_CLSSETUP_RELIGION_LIST_GET"
    Dim strOppCd_ADD As String = "HR_CLSSETUP_RELIGION_LIST_ADD"
    Dim strOppCd_UPD As String = "HR_CLSSETUP_RELIGION_LIST_UPD"
    ...
    Sub Page_Load(Sender As Object, E As EventArgs)
        ...
        Else
            ...
            If SortExpression.text = "" Then
                SortExpression.text = "ReligionCode"
                sortcol.text = "ASC"
            End If
    ...
    Protected Function LoadData() As DataSet
        ...
        SearchStr =  " AND REL.Status like '" & IIF(Not srchStatusList.selectedItem.Value = objHR.EnumReligionStatus.All, _
                       srchStatusList.selectedItem.Value, "%" ) &"' "
        If NOT srchReligionCode.text = "" Then
            SearchStr =  SearchStr & " AND REL.ReligionCode like '" & srchReligionCode.text &"%' "
        End If
        If NOT srchDesc.text = "" Then
            SearchStr = SearchStr & " AND REL.Description like '" & _
                        srchDesc.text &"%' "
        End If
        ...
        Try
        intErrNo = objHR.mtdGetMasterList(strOppCd_GET, strParam, objHR.EnumHRMasterType.Religion, objDataSet)
    ...
    Sub DEDR_Edit(Sender As Object, E As DataGridCommandEventArgs)
        ...
        Select Case cint(Edittext.text) = objHR.EnumReligionStatus.Active
            Case True
                Statuslist.selectedindex = 0
                EditText = EventData.Items.Item(CInt(e.Item.ItemIndex)).FindControl("ReligionCode")
    ...
    Sub DEDR_Update(Sender As Object, E As DataGridCommandEventArgs)
        ...
        EditText = E.Item.FindControl("ReligionCode")
        ReligionCode = EditText.Text
        ...
        intErrNo = objHR.mtdUpdMasterList(strOppCd_ADD, _
                                          ...
                                          strUserId, _
                                          strParam, _
                                          objHR.EnumHRMasterType.Religion, _
                                          blnDupKey, _
                                          blnUpdate.text)
        Catch Exp As System.Exception
    ...
    Sub DEDR_Delete(Sender As Object, E As DataGridCommandEventArgs)
        ...
        Status = IIF(EditText.Text = objHR.EnumReligionStatus.Active, _
                        objHR.EnumReligionStatus.Deleted, _
                        objHR.EnumReligionStatus.Active )
        EditText = E.Item.FindControl("CreateDate")
        CreateDate = EditText.Text
        strParam =  ReligionCode & "|" & _
                    Description & "|" & _
