...
Public Class DP_EmployeeList : Inherits Page
    ...
    Sub NewEmpBtn_Click(ByVal Sender As Object, ByVal E As ImageClickEventArgs)
        Response.Redirect("DP_trx_MemberDetail.aspx?redirect=empdet")
    End Sub

    Sub NewTrxBtn_Click(ByVal Sender As Object, ByVal E As ImageClickEventArgs)
        Response.Redirect("DP_trx_MemberTransactionDetail.aspx?redirect=empdet")
    End Sub

    Sub NewPensionBtn_Click(ByVal Sender As Object, ByVal E As ImageClickEventArgs)
        Response.Redirect("DP_trx_PensionProcess.aspx?redirect=empdet")
    End Sub

    Sub NewPenBenBtn_Click(ByVal Sender As Object, ByVal E As ImageClickEventArgs)
        Response.Redirect("DP_trx_BeneficiaryBenefit.aspx?redirect=empdet")
    End Sub

    Sub NewBenTrxBtn_Click(ByVal Sender As Object, ByVal E As ImageClickEventArgs)
        Response.Redirect("DP_trx_BeneficiaryTransactionDetail.aspx?redirect=empdet")
    End Sub
