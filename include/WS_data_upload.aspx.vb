...
Public Class WS_data_upload : Inherits Page
    ...
    Sub UploadBtn_Click(Sender As Object, E As ImageClickEventArgs)
        ...
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=WSDATA_GET_FTPPATH&errmesg=" & lblErrMesage.Text & "&redirect=ws/data/ws_data_upload.aspx")
        End Try        
        ...
        If objGlobal.mtdValidateUploadFileName(strZipName, objGlobal.EnumDataTransferFileType.WS_WorkshopReferenceData, strErrMsg) = False Then
        ...
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=WSDATA_SAVEAS&errmesg=" & lblErrUpload.Text & "&redirect=ws/data/ws_data_upload.aspx")
        End Try
        ...
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=WSDATA_DECRYPT_REF&errmesg=" & lblErrMesage.Text & "&redirect=ws/data/ws_data_upload.aspx")
        End Try
        ...
        Try
            intErrNo = objWSData.mtdUploadRef(strXmlPath)
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=WSDATA_UPLOAD_REF&errmesg=" & lblErrMesage.Text & "&redirect=ws/data/ws_data_upload.aspx")
        End Try
