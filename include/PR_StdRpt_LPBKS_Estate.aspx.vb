...
Public Class PR_StdRpt_LPBKS_Estate : Inherits Page
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        Response.Write("<Script Language=""JavaScript"">window.open(""PR_StdRpt_LPBKSPreview_Estate.aspx?CompCode=" & strCompany & "&Location=" & strUserLoc & "&RptID=" & strRptID & "&RptName=" & strRptName & "&Decimal=" & strDec & _
                       "&lblLocation=" & lblLocation.Text & _
                       "&SelDate=" & strFrom & _
                       "&Divisi=" & ddldivisi.SelectedItem.Value.Trim() & _
                       "&Mandor=" & ddlmandor.SelectedItem.Value.Trim() & _
                       "&isMandor=" & chkmandor.Checked & """ ,""" & strRptID & """ ,""status=yes, resizable=yes, scrollbars=yes, toolbar=no, location=no"");</Script>")
    End Sub
