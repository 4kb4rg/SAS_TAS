...
Public Class PR_DATA_WAGES_UPLOAD : Inherits Page
    ...
    Sub UploadBtn_Click(Sender As Object, E As ImageClickEventArgs)
        ...
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=PRDATA_GET_FTPPATH&errmesg=" & lblErrMesage.Text & "&redirect=pr/data/pr_data_upload.aspx")
        End Try        
        ...
        If objGlobal.mtdValidateUploadFileName(strZipName, objGlobal.EnumDataTransferFileType.PR_PayrollWagesData, strErrMsg) = False Then
        ...
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=PRDATA_SAVEAS&errmesg=" & lblErrUpload.Text & "&redirect=pr/data/pr_data_upload.aspx")
        End Try
        ...
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=PRDATA_DECRYPT_REF&errmesg=" & lblErrMesage.Text & "&redirect=pr/data/pr_data_upload.aspx")
        End Try
        ...
        Try
            intErrNo = objPRData.mtdUploadRef(strXmlPath)   
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=PRDATA_UPLOAD_REF&errmesg=" & lblErrMesage.Text & "&redirect=pr/data/pr_data_upload.aspx")
        End Try
