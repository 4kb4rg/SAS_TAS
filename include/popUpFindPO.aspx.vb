...
Public Class PopUpFindPO : Inherits Page
    ...
    Protected Function LoadData() As DataSet
        Dim strOpCode As String = "PU_CLSTRX_PO_INVOICERECEIVE_GET"
        ...
        If txtItemCode.Text = "" Then
            strParamValue = " And (A.POID Like '" & txtItemCode.Text & "'" & _
                            " Or A.SupplierCode Like '" & txtItemCode.Text & "'" & _
                            " Or Supp.Name Like '" & txtItemCode.Text & "'" & _
                            " Or A.Remark Like '" & txtItemCode.Text & "')"
        Else
            strParamValue = " And (A.POID Like '%" & txtItemCode.Text & "%'" & _
                            " Or A.SupplierCode Like '%" & txtItemCode.Text & "%'" & _
                            " Or Supp.Name Like '%" & txtItemCode.Text & "%'" & _
