<%@ Page Language="vb" src="../../../include/IN_trx_StockTransferDIV_list.aspx.vb" Inherits="IN_TransferDIV" %>
			...
			<tr>
				...
				<div class="kontenlist">
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						<tr>
							<td><strong>STOCK TRANSFER DIVISI LIST</strong><hr style="width :100%" />   
                            </td>
						...
						<tr>
							...
							<table cellpadding="4" cellspacing="0" style="width: 100%">
								...
								<td width="20%" valign=bottom height=26>Stock Transfer ID :<BR><asp:TextBox id=srchStockTxID width=100% maxlength="32" runat="server"/></td>
					...
					<asp:DataGrid id="dgStockTransfer"
						...
						<Columns>
							<asp:HyperLinkColumn
									...
									DataNavigateUrlField="StockTransferDivID"
									DataNavigateUrlFormatString="IN_trx_StockTransferDiv_details.aspx?id={0}"
									DataTextField="StockTransferDivID"
									DataTextFormatString="{0:c}"
									SortExpression="StockTransferDivID"/>
							<asp:HyperLinkColumn
							...
							<asp:TemplateColumn HeaderText="Transfer Date" SortExpression="tx.StockTransferDate">
								<ItemTemplate>
									<%# objGlobal.GetLongDate(Container.DataItem("StockTransferDate")) %>
								</ItemTemplate>
							</asp:TemplateColumn>
							...
							<asp:TemplateColumn>
								<ItemTemplate>
									...
									<asp:label id="lblTxID" Text=<%# Container.DataItem("StockTransferDivID") %> Visible="False" Runat="server"></asp:label>
