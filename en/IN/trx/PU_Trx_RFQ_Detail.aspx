...
<html>
	...
	<body>
		...
		<table border="0" width="100%" cellspacing="0" cellpadding="1" class="font9Tahoma">
			...
			<tr>
				<td style="width: 255px; height: 14px;" valign="middle">Transaction Date :*</td>
            ...
            <tr>
                ...
                <td style="width: 1168px; height: 20px" valign="middle">
                    <asp:TextBox ID="txtSupCode" runat="server" AutoPostBack="False" MaxLength="15" Width="20%"></asp:TextBox>
                    ...
                    <asp:TextBox ID="txtSupName" runat="server" BackColor="Transparent"
                            BorderStyle="None" Font-Bold="True" ForeColor="White" MaxLength="10" Width="60%"></asp:TextBox></td>
			...
			<tr>
				...
				<td style="width: 1168px; height: 20px;" valign="middle">
                                            ...
                                            <input id="BtnViewPR" runat="server" causesvalidation="False" onclick="javascript:PopPR_RPH('frmPurReqDet', '', 'txtItemCode','TxtItemName','txtCost1','txtQtyOrder1','txtPRID_Plmph','txtTtlCost1','txtPRRefLocCode','txtAddNote','txtPRRefId','txtPurchUOM','False');"
                                                type="button" value=" ... " />
                    <asp:ImageButton id="ImgGen" UseSubmitBehavior="false" ImageURL="../../Images/butt_generate.gif" onClick="btnGenerate_Click" CausesValidation="false"  AlternateText="ImgGenerate" runat="server" />
                                            </td>
			...
			<tr>
						...
						<tr>
							<td colspan="3" width=100%>
                                <asp:DataGrid ID="dgPRLn" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                    ...
                                    OnEditCommand="DEDR_Edit" OnUpdateCommand="DEDR_Update" PagerStyle-Visible="False"
                                    Width="97%" 
                                    class="font9Tahoma">	
                ...
                <tr>
                    <td height="25" style="width: 255px" valign="top">
			...
			<tr>
				<td height="25" style="width: 255px"><asp:label id=lblRemark Runat="server" Visible="False">Remark :</asp:label></td>	
				<td colspan="5">
