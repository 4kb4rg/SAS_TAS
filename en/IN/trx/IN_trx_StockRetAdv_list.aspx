<%@ Page Language="vb" trace=False src="../../../include/IN_Trx_StockRetAdv_List.aspx.vb" Inherits="IN_RetAdv" %>
<%@ Register TagPrefix="UserControl" Tagname="MenuINTrx" src="../../menu/menu_INTrx.ascx"%>
<%@ Register TagPrefix="Preference" Tagname="PrefHdl" src="../../include/preference/preference_handler.ascx"%>
<html>
	<head>
		<title>Stock Return Advice List</title>
			...
			<tr>
				...
				<div class="kontenlist">
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						<tr>
							<td><strong>STOCK RETURN ADVICE LIST</strong><hr style="width :100%" />   
                            </td>
				        ...
				        <tr>
					        <td colspan=6><hr size="1" noshade><asp:TextBox id=srchUpdateBy width=100% maxlength="128" Visible=false runat="server"/></td>
				        </tr>
						<tr>
							...
							<table cellpadding="4" cellspacing="0" style="width: 100%">
								...
								<td width="25%" height="26">Stock Return Advice ID :<BR><asp:TextBox id=srchStockTxID width=100% maxlength="32" runat="server"/></td>
								<td style="width: 127px">
                                    Receive Ref. No<BR>
                                    <asp:TextBox id=TxtRcvNo width=100% maxlength="32" runat="server"/></td>
								<td style="width: 6%">Period :<BR>
					...
					<asp:DataGrid id="dgStockTx"
						...
						<Columns>
							<asp:HyperLinkColumn
									HeaderText="Stock Return Advice ID"
									DataNavigateUrlField="ItemRetAdvID"
									DataNavigateUrlFormatString="IN_Trx_StockRetAdv_Details.aspx?id={0}"
									DataTextField="ItemRetAdvID"
									DataTextFormatString="{0:c}"
									SortExpression="ItemRetAdvID" />						
                            <asp:TemplateColumn HeaderText="Date Created" SortExpression="CreateDate">
                  			    <ItemTemplate>
							...
							<asp:TemplateColumn HeaderText="Status" SortExpression="tx.Status">
								<ItemTemplate>
									<%# objINtx.mtdGetStockRetAdvStatus(Container.DataItem("Status")) %>
								</ItemTemplate>
							</asp:TemplateColumn>
					...
					<BR><asp:label id=lblUnDel text="Insufficient stock in Inventory to perform operation!" Visible=False forecolor=red Runat="server" />
						...
						<tr>
							<td>
						        <asp:ImageButton id=ibNew UseSubmitBehavior="false" OnClick=btnNewItm_Click imageurl="../../images/butt_new.gif" AlternateText="New Stock Return Advice" runat=server/>&nbsp;
