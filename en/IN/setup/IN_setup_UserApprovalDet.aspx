<%@ Page Language="vb" src="~/include/IN_setup_UserApprovalDet.aspx.vb" Inherits="IN_setup_UserApprovalDet" %>
	...
	<Preference:PrefHdl id=PrefHdl runat="server" />
		...
		<tr>
			...
			<asp:label id="sortcol" Visible="False" Runat="server"/>	
				...
				<tr>
					<td colspan="3"><UserControl:MenuINSetup id=menuIN runat="server" /></td>
                    <td colspan="1">
                    </td>
				</tr>
				<tr>
                    ...
                    <td align="right" colspan="1" style="height: 21px">
                                        ...
                                        <tr>
                                            <td class="mt-h" style="height: 21px">
                                                ...
                                                User :</td>
                                                            <td colspan="4">
                                                                <asp:DropDownList ID="DDLUser" runat="server" AutoPostBack="true" OnSelectedIndexChanged="UserIndexChanged" Width="100%">
                                                                </asp:DropDownList></td>
				...
				<tr>
					...
					<asp:TemplateColumn SortExpression="ProdTypeCode" HeaderText="Item Group">
						<ItemTemplate>
						   <asp:Label Text=<%# Container.DataItem("DeptCode") %> id="lblProdTypeCode" runat="server" />						
						</ItemTemplate>
                        <ItemStyle Width="25%" />
					</asp:TemplateColumn>
                   ...
                   &nbsp;<asp:ImageButton ID="btnDelete" runat="server"
                                ...
                                OnClick="btnDelete_Click" Visible="true" />&nbsp; </td>
                    <td colspan="1">
                    </td>
				</tr>
				<tr>
