<%@ Page Language="vb" src="../../../include/IN_setup_prodbrand.aspx.vb" Inherits="IN_ProdBrand" %>
					...
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						...
						<tr>
							...
							<table cellpadding="4" cellspacing="0" style="width: 100%">
								...
								<td width="20%" height="26" valign=bottom><asp:label id="lblProdBrandCode" runat="server" /> :<BR>
									<asp:TextBox id=srchProdBrandCode width=100% maxlength="8" runat="server"/>
								</td>
							    ...
							    <table cellpadding="4" cellspacing="1" style="width: 100%">
					                ...
					                <Columns>
						                ...
						                <asp:TemplateColumn SortExpression="ProdBrandCode">
							                ...
							                <EditItemTemplate>
								                <asp:TextBox id="ProdBrandCode" MaxLength="8" width=95%
										                Text='<%# Container.DataItem("ProdBrandCode") %>'
										                runat="server"/>
								                <BR>
						                ...
						                <asp:TemplateColumn HeaderText="Status" SortExpression="PBrand.Status">
							                <ItemTemplate>
								                <%# objIN.mtdGetProductBrandStatus(Container.DataItem("Status")) %>
							                </ItemTemplate>
							                <EditItemTemplate>
								                <asp:DropDownList id="StatusList" size=1 Visible=False runat=server />
								                <asp:TextBox id="Status" Readonly=TRUE 
