<%@ Page Language="vb" Src="../../../include/IN_Setup_StockMaster_Details.aspx.vb" Inherits="IN_MasterDetails" %>
<%@ Register TagPrefix="UserControl" Tagname="MenuINSetup" src="../../menu/menu_INsetup.ascx"%>
<%@ Register TagPrefix="Preference" Tagname="PrefHdl" src="../../include/preference/preference_handler.ascx"%>
<html>
<head>
    <title>STOCK MASTER DETAILS</title>
    ...
    <form id="frmSysSetting" class="main-modul-bg-app-list-pu" runat="server">
        ...
        <table cellpadding="2" width="100%" border="0" class="font9Tahoma">
            ...
            <tr>
                ...
                <td colspan=4><asp:TextBox id="StckItemCode" runat="server" width=95% maxlength="20"  CssClass="font9Tahoma" />
            ...
            <tr>
                ...
                <td colspan=4><asp:TextBox id="Desc" runat="server" maxlength="256" width=95%  CssClass="font9Tahoma" />
            ...
            <tr>
                ...
                <td colspan=4><asp:DropDownList id="lstProdType" width=95% runat="server"  CssClass="font9Tahoma" />
            ...
            <tr>
                ...
                <td colspan=4><asp:DropDownList id="lstProdCat" width=95% runat="server"  CssClass="font9Tahoma" />
            ...
            <tr>
                <td>Fertilizer :</td>
                <td colspan=4><asp:CheckBox id="chkFertInd" width=100% runat="server" /></td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
            </tr>
            <tr>
                <td><asp:label id="Label4" Runat="server" text="Fuel Item Type "/> :</td>
                <td><asp:RadioButton id="Fuel_No" runat="server" TextAlign="Right" Text="Not Applicable" GroupName="FuelItm" Checked="True"/><br>
                    ...
                    <asp:RadioButton id="Fuel_Lub" runat="server" TextAlign="Right" Text="Lubricant" GroupName="FuelItm"/><br></td>
            </tr>
            ...
            <tr>
                ...
                <td><asp:RadioButton id="Itm_Stock" runat="server" TextAlign="Right" Text="Stock" OnCheckedChanged="ItmType_CheckedChanged" AutoPostBack="True" GroupName="ItmType" Checked="True"/><br>
                    <asp:RadioButton id="Itm_Workshop" runat="server" TextAlign="Right" Text="Workshop" OnCheckedChanged="ItmType_CheckedChanged" AutoPostBack="True" GroupName="ItmType"/><br>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
            ...
            <tr>
                ...
                <td colspan=4><asp:DropDownList id="lstProdBrand" width=95% runat="server"  CssClass="font9Tahoma" /></td>
                <td>&nbsp;Initial Cost : <asp:Label id="InitialCost" runat="server"/></td>
            </tr>
            <tr>
                <td><asp:label id="lblProdModel" Runat="server" /> *:</td>
                <td colspan=4><asp:DropDownList id="lstProdModel" width=95% runat="server"  CssClass="font9Tahoma" />
            ...
            <tr>
                ...
                <td colspan=4><asp:DropDownList id="lstProdMat" width=95% runat="server"  CssClass="font9Tahoma" /></td>
                <td>&nbsp;Lowest Cost : <asp:Label id="LowestCost" runat="server"/></td>
            </tr>
            <tr>
                <td><asp:label id="lblStockAna" Runat="server" /> :</td>
                <td colspan=4><asp:DropDownList id="lstStockAnalysis" width=95% runat="server"  CssClass="font9Tahoma" /></td>
                <td>&nbsp;Average Cost : <asp:Label id="AvrgCost" runat="server"/></td>
            </tr> 
            <tr>
                <td width=16%><asp:label id="lblVehExpCode" Runat="server" /> :</td>
                <td colspan=4><asp:DropDownList id="lstVehExpense" width=95% runat="server"  CssClass="font9Tahoma" /></td>
            ...
            <tr>
                ...
                <td colspan=4><asp:DropDownList id="lstAccCode" width=95% runat="server"  CssClass="font9Tahoma" />
            ...
            <tr>
                ...
                <td colspan=4><asp:DropDownList id="PurchaseUOM" width=95% runat="server"  CssClass="font9Tahoma" />
								<asp:Label id="lblErrPurchaseUOM" forecolor=red text="<BR>Please select unit of measurement." visible=false runat=server/></td>
            ...
            <tr>
                ...
                <td colspan=4><asp:DropDownList id="InventoryUOM" width=95% runat="server"  CssClass="font9Tahoma" />
            ...
            <tr>
                ...
                <td><asp:TextBox id="purchaseACNo" runat="server" maxlength="32" width=100%  CssClass="font9Tahoma" /></td>
            ...
            <tr>
                ...
                <td width=25%><asp:TextBox id="IssueACNo" runat="server" maxlength="32" width=100%  CssClass="font9Tahoma" /></td>
            </tr>
            <tr>
                ...
                <td>&nbsp;</td>
				<td>&nbsp;</td>
				<td colspan="2"><u><b>Selling Price :*</b></u></td>
				
            </tr>
            <tr>
                <td><asp:label id="Label18" Runat="server" text="Reorder Level "/> :</td>
                <td><asp:TextBox id="ReorderLvl" runat="server" maxlength="15" width=50%  CssClass="font9Tahoma" />
                ...
                <td>&nbsp;</td>
                <td>&nbsp;</td>
                <td><asp:RadioButton id="Fixed_Price" runat="server" TextAlign="Right" Text="Fixed :" GroupName="SellPrice"/></td>
            ...
            <tr>
                ...
                <td><asp:TextBox id="ReorderQty" runat="server" maxlength="15" width=50%  CssClass="font9Tahoma" />
                ...
                <td><asp:TextBox id="LatestPrice" runat="server" text=0 maxlength="9" width=100%  CssClass="font9Tahoma" />
			...
			<tr>
                ...
                <td>&nbsp;</td>
                <td>&nbsp;</td>
                <td colspan=2><asp:RadioButton id="Avrg_Price" runat="server" TextAlign="Right" Text="% of Average Cost :" GroupName="SellPrice" Checked="True"/> <asp:TextBox id="AvrgPrice" runat="server" maxlength="9" text=0 width=62%  CssClass="font9Tahoma" ></asp:TextBox>
            ...
            <tr>
                ...
                <td><asp:TextBox id="txtLifespan" enabled=true visible=false runat="server" maxlength="6" text=0 width=50%  CssClass="font9Tahoma" /> 
					<asp:label id="LabelHour" visible=false Runat="server" text="  Hours"/>
					<asp:Label id="lblErrLifespan" forecolor=red text="<BR>Please entry Lifespan." visible=false runat=server/></td>	                
			</tr>		
            <tr>
                <td><asp:label id="Label20" Runat="server" text="Remark"/> :</td>
                <td colspan="5"><asp:TextBox id="Remark" runat="server" maxlength="64" width=100%  CssClass="font9Tahoma" /></td>
            </tr>
            <tr>
                <td><asp:label id="LabelBin" Runat="server" text="Item Bin "/> :</td>
                <td><asp:TextBox id="txtBin" enabled=false runat="server" maxlength="20" width=50%  CssClass="font9Tahoma" /></td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
            ...
            <tr>
                ...
                <td><asp:TextBox id="txtFuelMeter" runat="server" enabled=false text=0 maxlength="15" width=50%  CssClass="font9Tahoma" /> 
            ...
            <tr>
                <td height=25><u><b>Inventory Bin Level</b></u></td>
				<td>&nbsp;</td>
                <td>&nbsp;</td>
				<td>&nbsp;</td>
				<td>&nbsp;</td>
