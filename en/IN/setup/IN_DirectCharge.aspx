<%@ Page Language="vb" src="../../../include/IN_Setup_DirectCharge.aspx.vb" Inherits="IN_DirectCharge" %>
<%@ Register TagPrefix="UserControl" Tagname="MenuINSetup" src="../../menu/menu_INsetup.ascx"%>
<%@ Register TagPrefix="Preference" Tagname="PrefHdl" src="../../include/preference/preference_handler.ascx"%>
<html>
	<head>
		<title>Direct Charge List</title>
			...
			<tr>
				...
				<div class="kontenlist">
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
							    ...
							    <table cellpadding="4" cellspacing="1" style="width: 100%">
						            ...
						            <Columns>
							            <asp:HyperLinkColumn
									            ...
									            DataNavigateUrlFormatString="IN_DirectCharge_Detail.aspx?id={0}"
						...
						<tr>
							<td>
					            <asp:ImageButton id=ibNew OnClick="btnNewItm_Click" imageurl="../../images/butt_new.gif" AlternateText="New Direct Charge Item" runat="server"/>
