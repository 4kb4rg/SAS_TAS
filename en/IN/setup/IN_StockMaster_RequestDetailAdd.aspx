<%@ Page Language="vb" Src="../../../include/IN_StockMaster_RequestDetailAdd.aspx.vb" Inherits="IN_StockMaster_RequestDetailAdd" %>
    ...
    <form id="frmSysSetting" class="main-modul-bg-app-list-pu"  runat="server">
        ...
        <table cellpadding="2" width="100%" border="0"  class="font9Tahoma">
            ...
            <tr>
                ...
                <td colspan=4><asp:TextBox id="StckItemCode" runat="server" width=95% maxlength="20"/>
            ...
            <tr>
                ...
                <td colspan=4><asp:TextBox id="Desc" runat="server" maxlength="256" width=95% />
            ...
            <tr>
                ...
                <td colspan=4><asp:DropDownList id="lstProdType" width=95% runat="server" />
            ...
            <tr>
                ...
                <td colspan=4><asp:DropDownList id="lstProdCat" width=95% runat="server" />
            ...
            <tr>
                ...
                <td colspan=4><asp:DropDownList id="lstProdBrand" width=95% runat="server" /></td>
                <td>&nbsp;Initial Cost : <asp:Label id="InitialCost" runat="server"/></td>
            </tr>
            <tr>
                <td><asp:label id="lblProdModel" Runat="server" /> *:</td>
                <td colspan=4><asp:DropDownList id="lstProdModel" width=95% runat="server" />
            ...
            <tr>
                ...
                <td colspan=4><asp:DropDownList id="lstProdMat" width=95% runat="server" /></td>
                <td>&nbsp;Lowest Cost : <asp:Label id="LowestCost" runat="server"/></td>
            </tr>
            <tr>
                <td><asp:label id="lblStockAna" Runat="server" /> :</td>
                <td colspan=4><asp:DropDownList id="lstStockAnalysis" width=95% runat="server" /></td>
                <td>&nbsp;Average Cost : <asp:Label id="AvrgCost" runat="server"/></td>
            </tr>
            <tr>
                <td width=16%><asp:label id="lblVehExpCode" Runat="server" /> :</td>
                <td colspan=4><asp:DropDownList id="lstVehExpense" width=95% runat="server" /></td>
            ...
            <tr>
                ...
                <td colspan=4><asp:DropDownList id="lstAccCode" width=95% runat="server" />
            ...
            <tr>
                ...
                <td colspan=4><asp:DropDownList id="PurchaseUOM" width=95% runat="server" />
            ...
            <tr>
                ...
                <td colspan=4><asp:DropDownList id="InventoryUOM" width=95% runat="server" />
            ...
            <tr>
                ...
                <td><asp:TextBox id="FixedPrice" runat="server" text=0 maxlength="19" width=100%/>
            ...
            <tr>
                ...
                <td><asp:TextBox id="LatestPrice" runat="server" text=0 maxlength="9" width=100%/>
			...
			<tr>
                ...
                <td>&nbsp;</td>
                <td>&nbsp;</td>
                <td colspan=2><asp:RadioButton id="Avrg_Price" runat="server" TextAlign="Right" Text="% of Average Cost :" GroupName="SellPrice" Checked="True"/> <asp:TextBox id="AvrgPrice" runat="server" maxlength="9" text=0 width=62%></asp:TextBox>
            ...
            <tr>
                ...
                <td><asp:TextBox id="txtLifespan" enabled=true visible=false runat="server" maxlength="6" text=0 width=50%/> 
            ...
            <tr>
                ...
                <td><asp:TextBox id="txtBin" enabled=false runat="server" maxlength="20" width=50%/></td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
            ...
            <tr>
                ...
                <td><asp:TextBox id="txtFuelMeter" runat="server" enabled=false text=0 maxlength="15" width=50%/> 
            ...
            <tr>
                <td colspan="6">
                    ...
                    <asp:imagebutton id="btnSyncData" onclick="btnSyncData_Click" runat="server" imageurl="../../images/butt_synchronize_data.gif" AlternateText="Synchronize Data" Visible="False" />                    
