<%@ Page Language="vb" src="../../../include/IN_setup_prodmodel.aspx.vb" Inherits="IN_ProdModel" %>
						...
						<tr>
							...
							<table cellpadding="4" cellspacing="0" style="width: 100%">
								...
								<td width="20%" height="26" valign=bottom>
									<asp:label id="lblProdModelCode" runat="server" /> :<BR>
									<asp:TextBox id=srchProdModelCode width=100% maxlength="8" runat="server"/>
								</td>
						    ...
						    <tr>
							    ...
							    <table cellpadding="4" cellspacing="1" style="width: 100%">
					                ...
					                <asp:TemplateColumn SortExpression="ProdModelCode">
						                <ItemTemplate>
							                <%# Trim(Container.DataItem("ProdModelCode")) %>
						                </ItemTemplate>
						                <EditItemTemplate>
					                ...
					                <asp:TemplateColumn HeaderText="Status" SortExpression="PModel.Status">
						                <ItemTemplate>
							                <%# objIN.mtdGetProductModelStatus(Container.DataItem("Status")) %>
						                </ItemTemplate>
						                <EditItemTemplate>
