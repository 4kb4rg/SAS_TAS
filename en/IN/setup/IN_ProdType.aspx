<%@ Page Language="vb" src="../../../include/IN_Setup_ProdType.aspx.vb" Inherits="IN_ProdType" %>
			...
			<tr>
				...
				<div class="kontenlist">
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						...
						<tr>
							...
							<table cellpadding="4" cellspacing="0" style="width: 100%">
								...
								<td width="20%" height="26" valign=bottom>
									<asp:label id="lblProdTypeCode" runat="server" /> :<BR>
							    ...
							    <table cellpadding="4" cellspacing="1" style="width: 100%">
						            ...
						            <asp:DataGrid id="EventData"
					                    ...
					                    <asp:TemplateColumn HeaderText="Status" SortExpression="PType.Status">
						                    <ItemTemplate>
							                    <%# objIN.mtdGetProductTypeStatus(Container.DataItem("Status")) %>
						                    </ItemTemplate>
						                    <EditItemTemplate>
						...
						<tr>
							<td>
					            <asp:ImageButton id=ibNew imageurl="../../images/butt_new.gif" OnClick="DEDR_Add" AlternateText="New Product Type" runat="server"/>
