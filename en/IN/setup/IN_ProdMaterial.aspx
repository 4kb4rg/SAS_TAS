<%@ Page Language="vb" src="../../../include/IN_setup_prodMaterial.aspx.vb" Inherits="IN_ProdMaterial" %>
						...
						<tr>
							...
							<table cellpadding="4" cellspacing="0" style="width: 100%">
								...
								<td width="20%" height="26" valign=bottom>
									<asp:label id="lblProdMatCode" runat="server" /> :<BR>
									<asp:TextBox id=srchProdMatCode width=100% maxlength="8" runat="server"/>
								</td>
						    ...
						    <tr>
							    ...
							    <table cellpadding="4" cellspacing="1" style="width: 100%">
					                ...
					                <asp:TemplateColumn SortExpression="ProdMatCode">
						                ...
						                <EditItemTemplate>
							                <asp:TextBox id="ProdMatCode" MaxLength="8" width=95%
					                ...
					                <asp:TemplateColumn HeaderText="Status" SortExpression="PMat.Status">
						                <ItemTemplate>
							                <%# objIN.mtdGetProductMaterialStatus(Container.DataItem("Status")) %>
						                </ItemTemplate>
						                <EditItemTemplate>
