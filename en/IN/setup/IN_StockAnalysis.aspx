<%@ Page Language="vb" trace="False" src="../../../include/IN_setup_StockAnalysis.aspx.vb" Inherits="IN_StockAnalysis" %>
					...
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						...
						<tr>
							...
							<table cellpadding="4" cellspacing="0" style="width: 100%">
								...
								<td width="20%" height="26" valign=bottom><asp:label id="lblStockAnaCode" runat="server" /> :<BR>
								<asp:TextBox id=srchStockAnaCode width=100% maxlength="8" runat="server"/>
							</td>
								<td width="42%" height="26" valign=bottom><asp:label id="lblDescription" runat="server" /> :<BR>
						    ...
						    <tr>
							    ...
							    <table cellpadding="4" cellspacing="1" style="width: 100%">
					                ...
					                <asp:TemplateColumn HeaderText="Last Update" SortExpression="StockAna.UpdateDate">
						                ...
						                <EditItemTemplate >
							                <asp:TextBox id="UpdateDate" Readonly=TRUE Visible=False size=8 
					                ...
					                <asp:TemplateColumn HeaderText="Status" SortExpression="StockAna.Status">
						                <ItemTemplate>
							                <%# objIN.mtdGetStockAnalysisStatus(Container.DataItem("Status")) %>
						                </ItemTemplate>
						                <EditItemTemplate>
