<%@ Page Language="vb" src="../../../include/WM_data_uploaddisp.aspx.vb" Inherits="WM_data_uploaddisp" %>
...
<title>Upload Dispatch File</title>
</head>
...
<form id=frmUpload enctype="multipart/form-data" runat=server>
	<table border="0" cellspacing="0" width="100%">
		<tr>
			<td width=100% colspan=3 align=center><UserControl:MenuWMData id=MenuWMData runat="server" /></td>
		</tr>
		<tr>
			<td class="mt-h" colspan="2">UPLOAD DISPATCH FILE</td>
		</tr>
		<tr>
			<td colspan=2><hr size="1" noshade></td>
		</tr>
		<tr>
			<td colspan="2">Dispatch Data</td>
		</tr>
		<tr>
			<td colspan="2">&nbsp;</td>
		</tr>
				...
				<table id=tblBefore border=0 cellpadding=2 cellspacing=0 width=100% runat=server>
					...
					<tr>
						<td colspan="2">
							...
							<asp:Label id=lblErrUpload text="There was an error when uploading the file" visible=false forecolor=red runat=server />
						</td>
					</tr>
					<tr>
						<td colspan="2">
		...
		<tr>
			<td colspan="2">
				<table id=tblAfter border=0 width=100% runat=server>
					<tr>
						<td colspan="2">Your Dispatch Data reference file has been successfully uploaded.</td>
					</tr>
				</table>
			</td>
		</tr>
