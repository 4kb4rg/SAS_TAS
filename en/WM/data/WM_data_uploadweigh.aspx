<%@ Page Language="vb" src="../../../include/WM_data_uploadweigh.aspx.vb" Inherits="WM_data_uploadweigh" %>
<%@ Register TagPrefix="Preference" Tagname="PrefHdl" src="../../include/preference/preference_handler.ascx"%>
<html>

<head>
<Preference:PrefHdl id=PrefHdl runat="server" />
<title>Upload WeighBridge Data</title>
</head>
...
<form id=frmUpload enctype="multipart/form-data" runat=server>
	<table border="0" cellspacing="0" width="100%">
		...
		<tr>
			<td class="mt-h" colspan="2">UPLOAD WEIGHBRIDGE DATA</td>
		</tr>
		<tr>
			<td colspan=2><hr size="1" noshade></td>
		</tr>
		<tr>
			<td colspan="2">Upload WeighBridge Data</td>
		</tr>
		<tr>
			<td colspan="2">&nbsp;</td>
		</tr>
