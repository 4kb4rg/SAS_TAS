<%@ Page Language="vb" src="../../../include/TX_trx_PPNMasukanList.aspx.vb" Inherits="TX_trx_PPNMasukanList" %>
			...
			<tr>
				...
				<div class="kontenlist">
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						<tr>
							<td><strong>VAT IN LIST</strong><hr style="width :100%" />   
                            </td>
			        ...
			        <tr>
                        <td colspan=2>
                            <asp:HyperLink ID="LinkDownload" ForeColor=red Visible=false runat="server" NavigateUrl="~/en/TX/trx/TX_trx_PPNMasukanList.aspx">HyperLink</asp:HyperLink>
                        </td>
                    </tr>
