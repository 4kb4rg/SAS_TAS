...
<head>
    <title>Faktur Pajak Entry Detail</title> 
...
<body onload="javascript:self.focus();document.frmMain.txtFromId.focus();" leftmargin="2" topmargin="2">
    <form id=frmMain runat="server" class="main-modul-bg-app-list-pu">
		...
		<table id=tblMain width=100% border=0 cellspacing="1" cellpadding="1"  runat=server class="font9Tahoma">
			<tr>
				<td colspan=2 class="mt-h">Faktur Pajak Entry Detail</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td width=50%><textarea rows="4" id=txtDescr cols="50" readonly=readonly runat=server></textarea></td>
			</tr>	
			<tr>
				<td width=20%>Doc Amount : </td>
				<td width=50%><asp:TextBox id=txtAmount width=80% ReadOnly=true runat=server /></td>
				 <td>&nbsp;</td>
				<td>Total FP Amount : </td>
			...
			<tr>
				<td colSpan="6">
                    <table id="tblSelection" cellSpacing="0" cellPadding="2" width="100%" border="0" runat=server>
                        ...
                        <tr class="mb-c">
                            <td width="20%" height=25>Faktur Pajak DPP Amount: </td>
                        ...
                        <tr class="mb-c">
                            <td width="20%" height=25>Faktur Pajak Amount: </td>
				    ...
				    <asp:DataGrid id=dgLineDet
					    ...
					    AllowSorting="True"
							...
							<AlternatingItemStyle BackColor="#EEEEEE" Font-Bold="False" 
                                ...
                                Font-Underline="False"/>
					    <Columns>	
						   <asp:TemplateColumn HeaderText="FP No." ItemStyle-Width="15%">
							    <ItemTemplate>
								    <asp:label text=<%# Container.DataItem("FPNo") %> id="lblFPNo" runat="server" />
							    </ItemTemplate>
						    </asp:TemplateColumn>
						    <asp:TemplateColumn HeaderText="FP Date" ItemStyle-Width="7%">
							    <ItemTemplate>
						    ...
						    <asp:TemplateColumn HeaderText="FP DPP Amount" ItemStyle-Width="10%" HeaderStyle-HorizontalAlign=Right ItemStyle-HorizontalAlign=Right>
							    <ItemTemplate> 
								    <ItemStyle />
						    ...
						    <asp:TemplateColumn HeaderText="FP Amount" ItemStyle-Width="10%" HeaderStyle-HorizontalAlign=Right ItemStyle-HorizontalAlign=Right>
							    <ItemTemplate> 
								    <ItemStyle />
