...
<html>
	...
	<body onload="javascript:CCA();">
		...
		<TABLE cellSpacing="0" cellPadding="3" width="100%" border="0">
				...
				<TD colSpan="2">
					...
					<tr>
						...
						<tr>
							...
							<td width="4%">&nbsp;</td>
							<td width="91%" colspan=5>
								<asp:CheckBox onclick="javascript:CCA();" id=cbINProdBrand text=" Product Brand" textalign=right runat=server />
							</td>
						</tr>
						<tr>
							<td width="5%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbItemToMachine text=" Assign Item To Machine" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbStkTransferInternal text=" Internal Stock Transfer" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr class="mr-h">
							<td width="5%">&nbsp;</td>
							<td width="63%" class="NormalBold" colspan="2"><asp:CheckBox onclick="javascript:CCA();" id=cbCT text=" Activate Taxation Access Rights" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbCTMaster text=" Tax Object Rate" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbCTItem text=" Supplier" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbCTPR text=" Tax Verification" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbCTRcv text=" Tax Verified" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbCTRtnAdv text=" Pph 21" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbCTIsu text=" Pph 22" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbCTRtn text=" Pph 23" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbCTAdj text=" Pph 26" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbWSProdMaster text=" Product Type" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbWSProdBrand text=" Product Brand" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbWSProdModel text=" Product Model" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbWSProdCategory text=" Product Category" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbWSProdMaterial text=" Product Material" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbWSStockAnalysis text=" Stock Analysis" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbWSItemMaster text=" Workshop Item Master" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbWSWorkMaster text=" Work Code" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbWSWorkshopService text=" Workshop Service" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbWSPart text=" Workshop Item Part" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbWSDirChrgMaster text=" Direct Charge Item Master" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
				        ...
				        <tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbWSMillProcDitr text=" Monthly Mill Process Distribution" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbWSCalMachine text=" Calendarized Machine" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbNUMasterItem text=" Nursery Item Master" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbNUItem text=" Nursery Item" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbNUMasterSetup text=" Nursery Batch" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbNUCullType text=" Culling Type" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbNUSeedIssue text=" Seedlings Issue" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbDtNu text=" Download/Upload Nursery Setup Files" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbPUPelimpahan text=" Pelimpahan" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbPURPH text=" RPH" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbPUGRN text=" Goods Return" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr class="mr-h">
							<td width="5%">&nbsp;</td>
							<td width="63%" class="NormalBold" colspan="2"><asp:CheckBox onclick="javascript:CCA();" id=cbCB text=" Activate Cash And Bank Access Rights" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbCBPayment text=" Payment" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbCBReceipt text=" Receipt" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						</tr>
						<!-- start to add new cash bank module. SMN 4 Sep 2006 -->
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbCBCashBank text=" Cash Bank" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbCBDeposit text=" Bank Reconsiliation" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbCBInterAdj text=" Saldo Bank" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbCBWithdrawal text=" Withdrawal" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						</tr>
						<!-- start to add Cash Flow. SMN 4 Sep 2006 -->
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbCBCashFlow text=" Treasury Cash Flow Report" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbCBMthEnd text=" Month End Process" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbHRDepartment textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbHRNationality text=" Nationality" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbHRFunc text=" Function" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbHRPosition text=" Position" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbHRLevel text=" Level" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbHRReligion text=" Religion" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbHRICType text=" IC Type" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbHRRace text=" Race" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbHRSkill text=" Skill" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbHRQualification text=" Qualification" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbHRSubject text=" Subject" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbHREval text=" Evaluation" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbHRCPCode text=" CP Code" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbHRSalScheme text=" Employee Category" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbHRSalGrade text=" Salary Grade" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbHRShift text=" Shift" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbHRGang text=" Gang" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbHRBankFormat text=" Bank Format" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbHRBank text=" Bank" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbHRJamsostek text=" Jamsostek" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbHRTaxBranch text=" Tax Branch" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbHRTax text=" Tax" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbHRContSuper text=" Contractor Supervision" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbHRHoliday text=" Holiday Schedule" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbHRPublicHoliday text=" Public Holiday" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbHRPOH text=" Point Of Hired" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbPRADGroup text=" Allowance and Deduction Group" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbPRAD text=" Allowance and Deduction" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbPRDenda text=" Denda" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr id=TrHarvInc runat=server>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbPRHarvInc text=" Harvesting Incentive" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbPRLoad text=" Load" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbPRRoute text=" Route" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbPRMedical text=" Medical" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbPRAirBus text=" AirBus" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbPRMaternity text=" Maternity" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbPRPensiun text=" Pensiun" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbPRRelocation text=" Relocation" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbPRRice text=" Rice Ration" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbPRIncentive text=" Incentive" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbPREmployeeEvaluation text=" Employee Evaluation" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbPRStandardEvaluation text=" Standard Evaluation" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbPRSalaryIncrease text=" Salary Increase" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr  id=TrTranInc runat=server>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbPRTranInc text=" Employee Evaluation" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbPRPaySetup text=" Payroll Setup" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbPRDailyAttd text=" Daily Attendance" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbPRHarvAttd text=" Harvester Production Attendance" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbPRWeekly text=" Weekly Attendance" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbPRAttdTrx text=" Attendance Checkroll" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbPRRatePay text=" Piece Rate Payment" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbPRContractPay text=" Contract Payment" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbPRADTrx text=" Allowance and Deduction" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbPRWagesPay text=" Wages Payment" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbPRContCheckroll text=" Contractor Checkroll" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						</tr>
						<!-- New screen Work Performance Minamas PRM 04 Apr 2006-->
						<!-- start -->
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbPRWorkPerformance text=" Work Performance" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbPRWPContractor text=" Work Performance Contractor" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbDwPR text=" Download Statutory" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbDwPRWages text=" Download/Upload Wages" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbDwPRBankAuto text=" Download Bank Auto-Credit Files" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbDwAttdInterface text=" Attendance System Interface" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbPRMthRice text=" Rice Ration Process" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbPRMthRapel text=" Rapel Process" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbPRMthBonus text=" Bonus Process" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbPRMthTHR text=" THR Process" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbPRMthDaily text=" Daily Process/Rollback" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbPRMthPayroll text=" Payroll Process/Rollback" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbPRMthTransfer text=" Transfer Interface" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbBINote text=" Debit Note" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbBICreditNote text=" Credit Note" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbFARegSetup text=" Asset Registration Header" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbFARegLine text=" Asset Registration Line" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbFAMasterSetup text=" Asset Master" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbFAItemSetup text=" Asset Item" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbDtDwFA text=" Download Reference Files" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbDtUpFA text=" Upload Reference Files" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr class="mr-h">
							<td width="5%">&nbsp;</td>
							<td width="63%" class="NormalBold" colspan="2"><asp:CheckBox onclick="javascript:CCA();" id=cbCM text=" Activate Contract Management Access Rights" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbCMMasterSetup text=" Currency" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbCMExchangeRate text=" Exchange Rate" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbCMContractQuality text=" Contract Quality" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbCMClaimQuality text=" Claim Quality" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbCMContractDOReg text=" DO Registration" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbCMGenDNCN text=" Generate Debit or Credit Note from Production MPOB Price " textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr class="mr-h">
							<td width="5%">&nbsp;</td>
							<td width="63%" class="NormalBold" colspan="2">
								<asp:CheckBox onclick="javascript:CCA();" id=cbPD text=" Activate Production Access Rights" textalign=right runat=server />
								<asp:CheckBox onclick="javascript:CCA();" id=cbPM text=" Activate Mill Production Management Access Rights" textalign=right visible=false runat=server />
							</td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbPMMasterSetup text=" Ullage - Volume Table Master" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbPMVolConvMaster text=" Ullage - Volume Conversion Master" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbPMAvgCapConvMaster text=" Ullage - Average Capacity Conversion Master" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbPMCPOPropertyMaster text=" CPO Properties Master" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbPMStorageTypeMaster text=" Storage Type Master" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbPMStorageAreaMaster text=" Storage Area Master" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbPMProcessingLineMaster text=" Processing Line Master" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbPMMachineMaster text=" Machine Master" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbPMAcceptableOilQuality text=" Acceptable Oil Quality" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbPMAcceptableKernelQuality text=" Acceptable Kernel Quality" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbPMTestSample text=" Test Sample" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbPMHarvestingInterval text=" Harvesting Interval" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbPMMill text=" Mill" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbPMMachineCriteria text=" Machine Criteria" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbPOMProd text=" POM Production" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbPOMStorage text=" POM Storage" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbPOMStat text=" POM Statistic" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						</tr>
						<tr id=TrMPOB runat=server>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbMPOBPrice text=" MPOB Price" textalign=right runat=server visible=false /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbYearPlantYield text=" Year of Planting Yield" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id="cbPMKernelLoss" text=" Kernel Loss" textalign="right"
										runat="server" /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id="cbPMWastedWaterQuality" text=" Wasted Water Quality"
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbAccClsGrp textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbActGrp textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbSubAct textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbVehExpGrp textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbVehType textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbBlkGrp textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbSubBlk textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbAccountGrp textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbGLCOGS text=" Cost of Goods Sold Setup" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbFSSetup text=" Financial Statement Report Setup" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbJrn text=" Journal Entry" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbPosting text=" Posting" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbJrnAdj text=" Journal Adjustment" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbRunHour text=" Actual Station Running Hour" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbGLGCDist text=" General Charges Distribution" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
							<td width="59%"><asp:CheckBox onclick="javascript:CCA();" id=cbGLJrnMthEnd text=" Journal Adjustment Process" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="63%" colspan="2"><asp:CheckBox onclick="javascript:CCA();" id=cbPeriodCfg text=" Period Configuration" textalign=right runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
			...
			<TR>
				<TD colSpan="2">
					<table border="0" cellpadding="0" cellspacing="0" width="100%">
						...
						<tr>
							<td width="5%">&nbsp;</td>
							<td width="63%" class="NormalBold" colspan="2"><asp:CheckBox onclick="javascript:CCA();" id=cbADTNU text=" Automate Nursery Posting" textalign=right visible=false checked=true runat=server /></td>
							<td width="6%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="17%">&nbsp;</td>
							<td width="4%">&nbsp;</td>
			...
			<asp:label id=lblSalary visible=false text="Salary Scheme, Salary Grade, Shift, Gang" runat=server />
			<asp:label id=lblBank visible=false text="Bank" runat=server />
			<asp:label id=lblTax visible=false text=" Tax Branch, Tax" runat=server />
			...
			<asp:Label id=lblCBARExt visible=false runat=server />
		</TABLE>
		</form>
	</body>
</html>
