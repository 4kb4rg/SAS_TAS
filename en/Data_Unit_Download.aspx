		...
		<table id="tblDownload" border="0" width="100%" cellpadding="1" cellspacing="0" class="font9Tahoma" >
			...
			<tr>
				<td class="mt-h" colspan=5>
                  <strong>  DOWNLOAD DATA UNIT</strong></td>
			</tr>
			<tr>
				<td colspan=5>
                         <hr style="width :100%" />
			...
			<tr>
				<td colspan=5 height=25>
					<font color=red></font><p>
                        Process will download data unit on
                        selected periode:</td>
			</tr>
			<tr>
			...
			<tr>
				<td width=40% height=25>Accounting Period To Be downloaded :</td> 
				<td width=30%>
			...
			<tr>
				<td colspan=5 height=25>
                    <asp:Label id=lblErrProcess visible=false forecolor=red text="There are some errors when download data." runat=server/>
				</td>
			</tr>
			<tr>
				<td colspan=5>
					<asp:Button id=btnProceed Text="Download" AlternateText="Download data unit" OnClick="btnProceed_Click" class="button-small" runat="server" />
				&nbsp;</td>
			</tr>
