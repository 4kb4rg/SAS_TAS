<%@ Page Language="vb" src="../../../include/PR_trx_DriverPremiList_Estate.aspx.vb" Inherits="PR_OvertimeList"%> 
<%@ Register TagPrefix="UserControl" Tagname="MenuPRTrx" src="../../menu/menu_prtrx.ascx"%>
<%@ Register TagPrefix="Preference" Tagname="PrefHdl" src="../../include/preference/preference_handler.ascx"%>

<html>
	<head>
		<title>Employee Premium Driver List</title>
			...
			<tr>
				...
				<div class="kontenlist">
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						<tr>
							<td><strong>LIST PREMI SUPIR</strong><hr style="width :100%" />   
                            </td>
						...
						<tr>
							...
							<table cellpadding="4" cellspacing="0" style="width: 100%">
								...
								<td height="26" width="20%" >Year<BR /><asp:TextBox ID="ddlYear" runat="server" Width="100%"></asp:TextBox></td>
							    ...
							    <table cellpadding="4" cellspacing="1" style="width: 100%">
                                    ...
                                    <td>
						             <asp:DataGrid id=dgEmpList
							                ...
							                <Columns>
							                <asp:BoundColumn Visible=False HeaderText="PrmDrv ID" DataField="PrmDrvID" />
								                <asp:HyperLinkColumn HeaderText="PrmDrv ID" 
													                 SortExpression="A.PrmDrvID" 
													                 DataNavigateUrlField="PrmDrvID" 
													                 DataNavigateUrlFormatString="PR_trx_DriverPremiDet_Estate.aspx?PrmDrvID={0}" 
													                 DataTextField="PrmDrvID" />
						
								
																			 
								                <asp:TemplateColumn HeaderText="EmpCode" SortExpression="A.EmpCode">
									                <ItemTemplate>
								                ...
								                <asp:TemplateColumn HeaderText="Car No" >
									                <ItemTemplate>
										                <asp:Label id=lblcarno text='<%# Container.DataItem("CarNo") %>'  runat=server/>
									                </ItemTemplate>
								                </asp:TemplateColumn>
								
								                <asp:TemplateColumn HeaderText="Premi" >
									                <ItemTemplate>
										                <asp:Label id=lblpremi text='<%# Container.DataItem("TotalPremi") %>'  runat=server/>
									                </ItemTemplate>
								                </asp:TemplateColumn>
						...
						<tr>
							<td>
					            <asp:ImageButton id=NewEmpBtn OnClick="NewEmpBtn_Click" imageurl="../../images/butt_new.gif" AlternateText="BKM Perawatan & Umum" runat="server"/>
							</td>
						</tr>
                        <tr>
                            <td>
