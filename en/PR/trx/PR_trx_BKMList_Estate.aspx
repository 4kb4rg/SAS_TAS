<%@ Page Language="vb" src="../../../include/PR_trx_BKMList_Estate.aspx.vb" Inherits="PR_BKMList"%> 
			...
			<tr>
				...
				<div class="kontenlist">
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						<tr>
							<td><strong>DAFTAR BUKU KERJA MANDOR & KCS</strong><hr style="width :100%" />   
                            </td>
						...
						<tr>
							...
							<table cellpadding="4" cellspacing="0" style="width: 100%">
								...
								<td height="26" width="10%">No.BKM :<BR><asp:TextBox id=txtBKM width=100% maxlength="25" runat="server"/></td>
	     						<td height="26" width="10%">Mandor :<BR><asp:TextBox id=txtEmpName width=100% maxlength="128" runat="server"/></td>
								<td height="26" width="10%">
                                    Divisi :<BR><asp:DropDownList id="ddlEmpDiv" width=100% runat=server /></td>
                                <td height="26" width="10%">
                                    Kategori :<BR />
                                    <asp:DropDownList ID="ddlEmpBKMTy" runat="server" Width="100%" OnSelectedIndexChanged="ddlEmpBKMTy_OnSelectedIndexChanged" AutoPostBack=true/>
                                </td>
                                <td height="26" width="15%">
                                    SubKategori :<BR />
                                    <asp:DropDownList ID="ddlEmpBKMsub" runat="server" Width="100%" OnSelectedIndexChanged="ddlEmpBKMsub_OnSelectedIndexChanged" AutoPostBack=true/>
                                </td>
								<td height="26" width="15%">
                                    Aktiviti :<BR />
                                    <asp:DropDownList ID="ddlEmpBKMAkt" runat="server" Width="100%" />
                                </td>
                                <td height="26" width="15%" >
                                    Periode : <br />
								...
								<td height="26" width="8%">
                                    Type : <br />
                                    <asp:DropDownList ID="ddlBkmtype" runat="server" Width="100%">
								...
								<td width="8%" height="26">Status :<BR>
							    ...
							    <table cellpadding="4" cellspacing="1" style="width: 100%">
						            ...
						            <asp:DataGrid id=dgEmpList
							                ...
							                <%--<asp:BoundColumn Visible=False HeaderText="No.BKM" DataField="BKMCode" />
						                        ...
						                        <asp:TemplateColumn HeaderText="No.BKM" SortExpression="A.BKMCode">
									                <ItemTemplate>
								                ...
								                <%--<asp:TemplateColumn HeaderText="BKM Type">
									                <ItemTemplate>
						                             <%# Container.DataItem("BKMType") %>
						                            </ItemTemplate>
								                </asp:TemplateColumn>--%>
								                ...
								                <asp:TemplateColumn HeaderText="Kategori">
									                <ItemTemplate>
										                <asp:Label id=lblType text='<%# Container.DataItem("BKMTyp") %>'  runat=server/>
									                </ItemTemplate>
								                </asp:TemplateColumn>
								
								                <asp:TemplateColumn HeaderText="Mandor" SortExpression="B.EmpName">
									                <ItemTemplate>
										                <asp:Label id=lblEmpName text='<%# Container.DataItem("EmpName") %>'  runat=server/>
									                </ItemTemplate>
								                </asp:TemplateColumn>
								
								                <asp:TemplateColumn HeaderText="KCS" >
									                <ItemTemplate>
										                <asp:Label id=lblKCS text='<%# Container.DataItem("KCS") %>'  runat=server/>
									                </ItemTemplate>
								                </asp:TemplateColumn>
								
								                <asp:TemplateColumn HeaderText="Mandor 1" >
									                <ItemTemplate>
										                <asp:Label id=lblMdr1 text='<%# Container.DataItem("Mdr1") %>'  runat=server/>
									                </ItemTemplate>
								                </asp:TemplateColumn>
								
								                <asp:TemplateColumn HeaderText="Supir">
									                <ItemTemplate>
										                <asp:Label id=lblsupir text='<%# Container.DataItem("SupirName") %>'  runat=server/>
									                </ItemTemplate>
								                </asp:TemplateColumn>
								
								                <asp:TemplateColumn HeaderText="No.Polisi">
									                <ItemTemplate>
										                <asp:Label id=lblnopolisi text='<%# Container.DataItem("NoPolisi") %>'  runat=server/>
									                </ItemTemplate>
								                </asp:TemplateColumn>
						...
						<tr>
							<td>
					            <asp:ImageButton id=NewEmpBtn OnClick="NewEmpBtn_Click" imageurl="../../images/butt_new.gif" AlternateText="Buku Kerja Mandor" runat="server"/>
							</td>
						</tr>
                        <tr>
                            <td>
