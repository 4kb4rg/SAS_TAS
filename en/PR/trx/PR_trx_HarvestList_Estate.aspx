<%@ Page Language="vb" src="../../../include/PR_trx_HarvestList_Estate.aspx.vb" Inherits="PR_HarvestList"%> 
<%@ Register TagPrefix="UserControl" Tagname="MenuPRTrx" src="../../menu/menu_prtrx.ascx"%>
<%@ Register TagPrefix="Preference" Tagname="PrefHdl" src="../../include/preference/preference_handler.ascx"%>

<html>
	<head>
		<title>Employee Premium Harvest List</title>
			...
			<tr>
				...
				<div class="kontenlist">
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						<tr>
							<td><strong>LIST BUKU POTONG BUAH</strong><hr style="width :100%" />   
                            </td>
						    ...
						    <tr>
							    ...
							    <table cellpadding="4" cellspacing="1" style="width: 100%">
						            ...
						            <asp:DataGrid id=dgEmpList
							            ...
							            <Columns>
							            <asp:BoundColumn Visible=False HeaderText="BPB ID" DataField="PrmID" />
								            <asp:HyperLinkColumn HeaderText="BPB ID" 
													             SortExpression="A.PrmID" 
													             DataNavigateUrlField="PrmID" 
													             DataNavigateUrlFormatString="PR_trx_HarvestDet_Estate.aspx?PrmID={0}" 
													             DataTextField="PrmID" />
								            ...
								            <asp:TemplateColumn HeaderText="Tot.JJG" SortExpression="TotalJjg" HeaderStyle-HorizontalAlign="Right">
									            <ItemTemplate>
								            ...
								            <asp:TemplateColumn HeaderText="Prm.Kerajinan" SortExpression="PremiKerajinan" HeaderStyle-HorizontalAlign="Right">
									            <ItemTemplate>
										            <asp:Label id=lblKerajinan text='<%# objGlobal.GetIDDecimalSeparator_FreeDigit(FormatNumber(Container.DataItem("PremiKerajinan"),2),0) %>' runat=server/>
									            </ItemTemplate>
									            <ItemStyle HorizontalAlign="Right" />
								            </asp:TemplateColumn>
								
								            <asp:TemplateColumn HeaderText="Total Premi" SortExpression="Total" HeaderStyle-HorizontalAlign="Right">
									            <ItemTemplate >
