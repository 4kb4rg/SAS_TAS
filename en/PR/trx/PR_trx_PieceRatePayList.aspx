<%@ Page Language="vb" src="../../../include/PR_trx_PieceRatePayList.aspx.vb" Inherits="PR_trx_PieceRatePayList" %>
<%@ Register TagPrefix="UserControl" Tagname="MenuPRTrx" src="../../menu/menu_prtrx.ascx"%>
<%@ Register TagPrefix="Preference" Tagname="PrefHdl" src="../../include/preference/preference_handler.ascx"%>
<html>
	<head>
		<title>Harvester Production Payment List</title>
			...
			<tr>
				...
				<div class="kontenlist">
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						<tr>
							<td><strong>HARVESTER PRODUCTION PAYMENT LIST</strong><hr style="width :100%" />   
                            </td>
						...
						<tr>
							...
							<table cellpadding="4" cellspacing="0" style="width: 100%">
								...
								<td width="18%" height="26">Harvester Production ID :<BR><asp:TextBox id=txtPieceRateID width=100% maxlength="20" runat="server" /></td>
								<td width="40%" height="26">Description :<BR><asp:TextBox id=txtDescription width=100% maxlength="128" runat="server" /></td>
							    ...
							    <table cellpadding="4" cellspacing="1" style="width: 100%">
                                    ...
                                    <td>
						             <asp:DataGrid id=dgLine runat=server
							            ...
							            <Columns>
								            <asp:BoundColumn Visible=False HeaderText="Harvester Production ID" DataField="PieceRateID" />
								            <asp:HyperLinkColumn HeaderText="Harvester Production ID" ItemStyle-Width="15%"
									            SortExpression="PAY.PieceRateID" 
									            DataNavigateUrlField="PieceRateID" 
									            DataNavigateUrlFormatString="PR_trx_PieceRatePayDet.aspx?payid={0}" 
									            DataTextField="PieceRateID" />

								            <asp:TemplateColumn HeaderText="Description" ItemStyle-Width="40%" SortExpression="PAY.Description">
									            <ItemTemplate>
								            ...
								            <asp:TemplateColumn HeaderText="Status" ItemStyle-Width="10%" SortExpression="PAY.Status">
									            <ItemTemplate>
										            <%# objPRTrx.mtdGetPieceRateStatus(Container.DataItem("Status")) %>
									            </ItemTemplate>
								            </asp:TemplateColumn>
								            ...
								            <asp:TemplateColumn ItemStyle-Width="15%" ItemStyle-HorizontalAlign=center>
									            <ItemTemplate>
										            <asp:Label id=lblPieceRateId text='<%# Container.DataItem("PieceRateID") %>' visible=false runat=server/>
										            <asp:label id="lblStatus" Text='<%# Trim(Container.DataItem("Status")) %>' Visible="False" Runat="server" />
										            <asp:label id="lblAllowCancel" Text='<%# Trim(Container.DataItem("AllowCancel")) %>' Visible="False" Runat="server" />
						...
						<tr>
							<td>
					            <asp:ImageButton id=NewPayBtn OnClick="NewPayBtn_Click" imageurl="../../images/butt_new.gif" AlternateText="New Harvester Production Payment" runat="server"/>
                        ...
                        <tr>
                            <td>
 					            <asp:Button ID="NewPayBtn2" class="button-small" runat="server" Text="New Harvester Production Payment" />&nbsp;
