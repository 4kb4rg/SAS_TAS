<%@ Page Language="vb" src="../../../include/PR_Trx_ADList.aspx.vb" Inherits="PR_Trx_ADList" %>
<%@ Register TagPrefix="UserControl" Tagname="MenuPRTrx" src="../../menu/menu_PRTrx.ascx"%>
<%@ Register TagPrefix="Preference" Tagname="PrefHdl" src="../../include/preference/preference_handler.ascx"%>
<html>
	<head>
		<title>Allowance And Deduction Entry List</title>
			...
			<tr>
				...
				<div class="kontenlist">
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						<tr>
							<td><strong>ALLOWANCE AND DEDUCTION ENTRY LIST</strong><hr style="width :100%" />   
                            </td>
						...
						<tr>
							...
							<table cellpadding="4" cellspacing="0" style="width: 100%">
								...
								<td width="10%" height="26">A.D. Code :<BR><asp:TextBox id=txtADTrxId width=100% maxlength="20" runat="server" /></td>
								<td width="30%">Description :<BR><asp:TextBox id=txtDescription width=100% maxlength="128" runat="server" /></td>
								<td width="15%">Employee Code :<BR><asp:TextBox id=txtEmpCode width=100% maxlength="20" runat="server" /></td>
							...
							<Columns>
								<asp:BoundColumn Visible=False HeaderText="AD Code" DataField="ADTrxId" />
									
								<asp:TemplateColumn HeaderText="A.D. Code" SortExpression="AD.ADTrxId">
									<ItemTemplate>
										<asp:Label id=lblADId text='<%# Container.DataItem("ADTrxId") %>' visible=false runat=server/>
										<asp:LinkButton id=lbADCode CommandName=Item text='<%# Container.DataItem("ADCode") %>' runat=server />
									</ItemTemplate>
								</asp:TemplateColumn>

								<asp:HyperLinkColumn HeaderText="Description" ItemStyle-Width="30%" HeaderStyle-Width="30%"
									SortExpression="AD.Description" 
									DataNavigateUrlField="ADTrxId" 
									DataNavigateUrlFormatString="PR_Trx_ADDet.aspx?adid={0}" 
									DataTextField="Description" />
									
								<asp:HyperLinkColumn HeaderText="Employee Code" ItemStyle-Width="15%" HeaderStyle-Width="15%"
									SortExpression="AD.EmpCode" 
									DataNavigateUrlField="ADTrxId" 
									DataNavigateUrlFormatString="PR_Trx_ADDet.aspx?adid={0}" 
									DataTextField="EmpCode" />
									
								<asp:TemplateColumn HeaderText="Last Update" ItemStyle-Width="10%" HeaderStyle-Width="10%" SortExpression="AD.UpdateDate">
									<ItemTemplate>
										<%# objGlobal.GetLongDate(Container.DataItem("UpdateDate")) %>
									</ItemTemplate>
								</asp:TemplateColumn>
									
								<asp:TemplateColumn HeaderText="Status" ItemStyle-Width="10%" HeaderStyle-Width="10%" SortExpression="AD.Status">
									<ItemTemplate>
										<%# objPRTrx.mtdGetADTrxStatus(Container.DataItem("Status")) %>
									</ItemTemplate>
								</asp:TemplateColumn>
						...
						<tr>
							<td>
					            <asp:ImageButton id=NewADBtn OnClick="NewADBtn_Click" imageurl="../../images/butt_new.gif" AlternateText="New Allowance and Deduction Entry" runat="server"/>
