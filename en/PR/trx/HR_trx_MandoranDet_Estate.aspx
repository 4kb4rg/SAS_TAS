			...
			<table border=0 cellspacing=0 cellpadding=2 width=100% class="font9Tahoma">
                        ...
                        <table cellpadding="0" cellspacing="0" class="style1">
                            <tr>
                                ...
                                <td class="font9Header"  style="text-align: right">
                                    ...
                                    Tgl Update :<asp:Label id=lblLastUpdate runat=server />&nbsp;|Diupdate : <asp:Label id=lblUpdatedBy runat=server />
                                </td>
                            </tr>
                        </table>
                        <hr style="width :100%" />
				...
				<tr>
					<td align="left" class="style3">
                        Divisi</td>
					<td align="left" style="height: 26px; width: 413px;">
						<GG:AutoCompleteDropDownList id=ddlEmpDiv width="100%" CssClass="font9Tahoma" runat=server OnSelectedIndexChanged="ddlEmpDiv_OnSelectedIndexChanged" AutoPostBack=true/>
						<asp:label id="lbldivisi" runat="server" Visible=false />
						<asp:Label id=validddlEmpDiv forecolor=red visible=false runat=server />
						<GG:AutoCompleteDropDownList id=ddlMdrtype width="100%" visible=False runat=server/>	
				...
				<tr>
					...
					<td align="left" style="height: 26px; width: 413px;">
					<GG:AutoCompleteDropDownList id=ddlMdrCode width="100%" CssClass="font9Tahoma"  runat=server OnSelectedIndexChanged="ddlEmpMdr_OnSelectedIndexChanged" AutoPostBack=true/>
					<asp:label id="lblMdrCode" runat="server" Visible=false/>
					<asp:Label id=validddlMdrCode forecolor=red visible=false runat=server />
					
					<GG:AutoCompleteDropDownList id=ddlKcsCode CssClass="font9Tahoma"  width="100%" Visible=false runat=server/>
					<asp:label id="lblkcsCode" runat="server" Visible=false/>
					<asp:Label id=validddlKcsCode forecolor=red visible=false runat=server />
					<GG:AutoCompleteDropDownList id=ddlTrnCode CssClass="font9Tahoma"  width="100%" Visible=false runat=server/>
				...
				<tr>
					...
					<td align="left" style="height: 26px; width: 413px;">
					<GG:AutoCompleteDropDownList id=ddlEmpCode CssClass="font9Tahoma"  width="100%" runat=server/>&nbsp;
					</td>
					<td style="width: 79px ;height: 26px;">&nbsp;</td>
					<td style="height: 26px"></td>
					<td style="height: 26px"></td>
				...
				<tr>
					...
					<td align="left" style="height: 26px; width: 413px;">
					<asp:DropDownList ID="ddlEmpMonth" CssClass="font9Tahoma"  runat="server" Width="25%" OnSelectedIndexChanged="ddlEmpMonth_OnSelectedIndexChanged" AutoPostBack=true>
				...
				<tr>
					<td colspan="5" style="height: 28px">
                        ...
                        <asp:DropDownList ID="ddlbeforemonth" CssClass="font9Tahoma"  runat="server" Width="100px">
                            <asp:ListItem Value="01">January</asp:ListItem>
                            <asp:ListItem Value="02">February</asp:ListItem>
                            <asp:ListItem Value="03">March</asp:ListItem>
                            <asp:ListItem Value="04">April</asp:ListItem>
				...
				<tr>
					<td colspan=6>
                        <asp:DataGrid ID="dgLine" runat="server" 
                             ...
                             Width="100%" OnDeleteCommand="dgLine_Delete" OnItemDataBound="dgLine_Bind">
                            <PagerStyle Visible="False" />
