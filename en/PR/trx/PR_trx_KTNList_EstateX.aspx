...
<html>
	<head>
		<title>DAFTAR BUKU KERJA KONTANAN</title>
			...
			<tr>
				...
				<div class="kontenlist">
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						<tr>
							<td><strong>DAFTAR BUKU KERJA KONTANAN</strong><hr style="width :100%" />   
                            </td>
						...
						<tr>
							...
							<table cellpadding="4" cellspacing="0" style="width: 100%">
								...
								<td height="26" width="10%">No. :<BR><asp:TextBox id=txtBKM width=100% maxlength="25" runat="server"/></td>
                                ...
                                <td height="26" width="15%">
                                    SubKategori :<BR />
                                    <asp:DropDownList ID="ddlEmpBKMsub" runat="server" Width="100%" />
                                </td>
							    ...
							    <table cellpadding="4" cellspacing="1" style="width: 100%">
						            ...
						            <asp:DataGrid id=dgEmpList
							                ...
							                <Columns>
						                        ...
						                        <asp:TemplateColumn HeaderText="No." SortExpression="A.BKMCode">
									                <ItemTemplate>
						...
						<tr>
							<td>
					            <asp:ImageButton id=NewEmpBtn OnClick="NewEmpBtn_Click" imageurl="../../images/butt_new.gif" AlternateText="Buku Kerja Kontanan" runat="server"/>
							</td>
						</tr>
                        <tr>
                            <td>
 					            <asp:Button ID="NewEmpBtn2" class="button-small" runat="server" Text="Buku Kerja Kontanan"  />&nbsp;
