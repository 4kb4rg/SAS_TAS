<%@ Page Language="vb" src="../../../include/PR_trx_KutipBrondolanList_Estate.aspx.vb" Inherits="PR_KutipBrondolanList"%> 
			...
			<tr>
				...
				<div class="kontenlist">
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						<tr>
							<td><strong>LIST BUKU KUTIP BRONDOLAN</strong><hr style="width :100%" />   
                            </td>
						    ...
						    <tr>
							    ...
							    <table cellpadding="4" cellspacing="1" style="width: 100%">
						            ...
						            <asp:DataGrid id=dgEmpList
							            ...
							            <Columns>
							            <asp:BoundColumn Visible=False HeaderText="BRD ID" DataField="BrdID" />
								            <asp:HyperLinkColumn HeaderText="BRD ID" 
													             SortExpression="A.BrdID" 
													             DataNavigateUrlField="BrdID" 
													             DataNavigateUrlFormatString="PR_trx_KutipBrondolanDet_Estate.aspx?BrdID={0}" 
													             DataTextField="BrdID" />
