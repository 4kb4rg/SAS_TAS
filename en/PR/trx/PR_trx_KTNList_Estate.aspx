<%@ Page Language="vb" src="../../../include/PR_trx_KTNList_Estate.aspx.vb" Inherits="PR_KTNList"%> 
<%@ Register TagPrefix="UserControl" Tagname="MenuPRTrx" src="../../menu/menu_prtrx.ascx"%>
<%@ Register TagPrefix="Preference" Tagname="PrefHdl" src="../../include/preference/preference_handler.ascx"%>

<html>
	<head>
		<title>Buku Kerja SPK</title>
        <link href="../../include/css/gopalms.css" rel="stylesheet" type="text/css" />
<%--		<Preference:PrefHdl id=PrefHdl runat="server" />--%>
	</head>
	<body onload="javascript:document.frmMain.txtBKM.focus();">
			...
			<tr>
				...
				<div class="kontenlist">
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						<tr>
							<td><strong>DAFTAR BUKU KERJA SPK</strong><hr style="width :100%" />   
                            </td>
						...
						<tr>
							...
							<table cellpadding="4" cellspacing="0" style="width: 100%">
								...
								<td height="26" width="10%">No.KTN :<BR><asp:TextBox id=txtBKM width=100% maxlength="25" runat="server"/></td>
	     						<td height="26" width="10%">Supplier :<BR><asp:DropDownList id=ddlsupplier width=100% maxlength="128" runat="server"/></td>
						    ...
						    <tr>
							    ...
							    <table cellpadding="4" cellspacing="1" style="width: 100%">
						            ...
						            <asp:DataGrid id=dgEmpList
							            ...
							            <Columns>
							            <%--<asp:BoundColumn Visible=False HeaderText="No.KTN" DataField="BKMCode" />
								            <asp:HyperLinkColumn HeaderText="No.KTN" 
													             SortExpression="A.BKMCode" 
													             DataNavigateUrlField="BKMCode" 
													             DataNavigateUrlFormatString="PR_trx_KTNDet_New_Estate.aspx?BKMCode={0}" 
													             DataTextField="BKMCode" />--%>
													 
						                    <asp:TemplateColumn HeaderText="No.KTN" SortExpression="A.BKMCode">
									            <ItemTemplate>
								            ...
								            <asp:TemplateColumn HeaderText="Supplier" >
									            <ItemTemplate>
										            <asp:Label id=lblSupName text='<%# Container.DataItem("Name") %>'  runat=server/>
									            </ItemTemplate>
								            </asp:TemplateColumn>
								
								            <asp:TemplateColumn HeaderText="POID">
									            <ItemTemplate>
						                        <asp:Label id=lblPOID text='<%# Container.DataItem("POID") %>'  runat=server/>
						                        </ItemTemplate>
								            </asp:TemplateColumn>
						...
						<tr>
							<td>
					            <asp:ImageButton id=NewEmpBtn OnClick="NewEmpBtn_Click" imageurl="../../images/butt_new.gif" AlternateText="Buku Kerja SPK" runat="server"/>
							</td>
						</tr>
                        <tr>
                            <td>
