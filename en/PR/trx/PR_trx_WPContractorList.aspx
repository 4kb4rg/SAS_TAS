<%@ Page Language="vb" src="../../../include/PR_Trx_WPContractorList.aspx.vb" Inherits="PR_Trx_WPContractorList" %>
<%@ Register TagPrefix="UserControl" Tagname="MenuPRTrx" src="../../menu/menu_PRTrx.ascx"%>
<%@ Register TagPrefix="Preference" Tagname="PrefHdl" src="../../include/preference/preference_handler.ascx"%>
<html>
	<head>
		<title>Work Performance Contractor Entry List</title>
			...
			<tr>
				...
				<div class="kontenlist">
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						<tr>
							<td><strong>WORK PERFORMANCE CONTRACTOR ENTRY LIST</strong><hr style="width :100%" />   
                            </td>
						...
						<tr>
							...
							<table cellpadding="4" cellspacing="0" style="width: 100%">
								...
								<td width="20%" height="26">Supplier Code :<BR><asp:TextBox id=txtWPTrxID width=100% maxlength="20" runat="server" /></td>
								<td width="30%">Function/COA :<BR><asp:TextBox id=txtAccCode width=100% maxlength="20" runat="server" /></td>
								<td width="15%">Date :<BR><asp:TextBox id=txtWPDate width=100% maxlength="128" runat="server" /></td>
						    ...
						    <tr>
							    ...
							    <table cellpadding="4" cellspacing="1" style="width: 100%">
						            ...
						            <asp:DataGrid id=dgLine runat=server
							            ...
							            <Columns>
								            <asp:BoundColumn Visible=False HeaderText="Contractor Code" DataField="WPTrxId" />
								
								            <asp:TemplateColumn HeaderText="Contractor Code" HeaderStyle-Width="19%" SortExpression="WP.WPTrxId">
									            <ItemTemplate>
										            <asp:Label id=lblWPTrxId text='<%# Container.DataItem("WPTrxId") %>' visible=false runat=server/>
										            <asp:LinkButton id=lblContractorCode CommandName=Item text='<%# Container.DataItem("ContractorCode") %>' runat=server />
									            </ItemTemplate>
								            </asp:TemplateColumn>
																
								            <asp:HyperLinkColumn HeaderText="Function/COA" ItemStyle-Width="20%" HeaderStyle-Width="29%"
									            SortExpression="WP.AccCode" 
									            DataNavigateUrlField="WPTrxId" 
									            DataNavigateUrlFormatString="PR_trx_WPContractorDet.aspx?WPTrxID={0}" 
									            DataTextField="AccCode" />
									
								            <asp:TemplateColumn HeaderText="Date" ItemStyle-Width="10%" HeaderStyle-Width="19%" SortExpression="WP.WPDate">
									            <ItemTemplate>
										            <asp:LinkButton id=lblWPDate CommandName=Item text='<%# objGlobal.GetLongDate(Container.DataItem("WPDate")) %>' runat=server />
									            </ItemTemplate>
								            </asp:TemplateColumn>
