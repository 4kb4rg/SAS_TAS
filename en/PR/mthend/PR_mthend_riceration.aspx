<%@ Page Language="vb" src="../../../include/PR_mthend_riceration.aspx.vb" Inherits="PR_mthend_riceration" %>
	...
	<body>
		...
		<form id=frmProcess runat=server>
			...
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				...
				<tr>
					<td colspan=4 class="mt-h" width="100%" ><asp:label id=lblTitle runat=server /></td>
				</tr>
				<tr>
					<td colspan=4><hr size="1" noshade></td>
				</tr>
				<tr>
					<td colspan=4>Please ensure that Employee Payroll and Family details are completed before proceed. <br>
					<asp:label id=lblRiceRation runat=server/> for all or selected employee(s) will be updated according to the latest payroll and family details.
					</td>
				</tr>
				<tr>
