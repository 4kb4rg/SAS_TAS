<%@ Page Language="vb" src="../../../include/PR_mthend_bonusprocess.aspx.vb" Inherits="PR_mthend_BonusProcess" %>
	...
	<body>
		...
		<form id=frmProcess runat=server>
			...
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				...
				<tr>
					<td colspan=4 class="mt-h" width="100%" >BONUS PROCESS</td>
				</tr>	
				<tr>
				...
				<tr>
					<td colspan=4>
						<font color=red>Important notes before bonus process:</font><p> 
						Please ensure that Employee Payroll and Family details are completed before proceed.<br>
						Bonus SKU for all or selected employee(s) will be updated according to the latest payroll and family details.<br>
					</td>
				</tr>				
				<tr>
				...
				<tr>
					<td colspan=4>
						...
						<asp:Label id=lblSuccess text="Bonus SKU has processed successfully." visible=false forecolor=blue runat=server />
