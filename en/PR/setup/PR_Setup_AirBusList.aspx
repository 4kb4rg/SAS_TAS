<%@ Page Language="vb" src="../../../include/PR_setup_AirBusList.aspx.vb" Inherits="PR_Setup_AirBusList" %>
<%@ Register TagPrefix="UserControl" Tagname="MenuPRSetup" src="../../menu/menu_PRsetup.ascx"%>
<%@ Register TagPrefix="Preference" Tagname="PrefHdl" src="../../include/preference/preference_handler.ascx"%>
<html>
	<head>
		<title>Air Fare/Bus Ticket List</title>
					...
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						...
						<tr>
							...
							<table cellpadding="4" cellspacing="0" style="width: 100%">
								...
								<td width="20%" height="26" valign=bottom><asp:label id="lblTitle2" runat="server"/>Code :<BR><asp:TextBox id=txtAirBusCode width=100% maxlength="8" runat="server" /></td>
								<td width="40%" height="26" valign=bottom>Description :<BR><asp:TextBox id=txtDescription width=100% maxlength="128" runat="server" /></td>
								<!--<td width="20%" height="26" valign=bottom>Point Of Hired Code :<BR><asp:TextBox id=txtPOHCode width=100% maxlength="10" runat="server" /></td> -->
						    ...
						    <tr>
							    ...
							    <table cellpadding="4" cellspacing="1" style="width: 100%">
						            ...
						            <asp:DataGrid id=dgLine runat=server
							                ...
							                <Columns>
								                <asp:BoundColumn Visible=False HeaderText="Ticket Code" DataField="TicketCode" />
								                <asp:HyperLinkColumn ItemStyle-Width="20%" HeaderStyle-Width="20%"
									                SortExpression="TicketCode" 
									                DataNavigateUrlField="TicketCode" 
									                DataNavigateUrlFormatString="PR_setup_AirBusDet.aspx?ticketcode={0}" 
									                DataTextField="TicketCode" />
									
								                <asp:HyperLinkColumn HeaderText="Description" ItemStyle-Width="20%" HeaderStyle-Width="20%"
									                SortExpression="TicketDesc" 
									                DataNavigateUrlField="TicketCode" 
									                DataNavigateUrlFormatString="PR_setup_AirBusDet.aspx?ticketcode={0}" 
									                DataTextField="TicketDesc" />
									
								                <asp:TemplateColumn HeaderText="Point Of Hired" ItemStyle-Width="20%" HeaderStyle-Width="20%" SortExpression="POH">
									                <ItemTemplate>
										                <%# Container.DataItem("POH") %>
									                </ItemTemplate>
								                </asp:TemplateColumn>
								
								                <asp:TemplateColumn HeaderText="Last Update" ItemStyle-Width="10%" HeaderStyle-Width="10%" SortExpression="PR.UpdateDate">
									                <ItemTemplate>
										                <%# objGlobal.GetLongDate(Container.DataItem("UpdateDate")) %>
									                </ItemTemplate>
								                </asp:TemplateColumn>
									
								                <asp:TemplateColumn HeaderText="Status" ItemStyle-Width="10%" HeaderStyle-Width="10%" SortExpression="PR.Status">
									                <ItemTemplate>
						...
						<tr>
							<td>
					            <asp:ImageButton id=NewADBtn OnClick="NewADBtn_Click" imageurl="../../images/butt_new.gif" AlternateText="New Air Fare/Bus Ticket" runat="server"/>
