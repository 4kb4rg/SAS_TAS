<%@ Page Language="vb" src="../../../include/PR_setup_AttdList.aspx.vb" Inherits="PR_setup_AttdList" %>
			...
			<tr>
				...
				<div class="kontenlist">
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						<tr>
							<td><strong>ATTENDANCE CODE LIST</strong><hr style="width :100%" />   
                            </td>
						...
						<tr>
							...
							<table cellpadding="4" cellspacing="0" style="width: 100%">
								...
								<td width="20%" height="26">Attendance Code :<BR><asp:TextBox id=txtAttdCode width=100% maxlength="8" runat="server" /></td>
								<td width="35%" height="26">Description :<BR><asp:TextBox id=txtDescription width=100% maxlength="128" runat="server" /></td>
						    ...
						    <tr>
							    ...
							    <table cellpadding="4" cellspacing="1" style="width: 100%">
						            ...
						            <asp:DataGrid id=dgLine runat=server
							                ...
							                <Columns>
								                <asp:BoundColumn Visible=False HeaderText="Attendance Code" DataField="AttCode" />
								                <asp:HyperLinkColumn HeaderText="Attendance Code" ItemStyle-Width="15%"
									                SortExpression="Attd.AttCode" 
									                DataNavigateUrlField="AttCode" 
									                DataNavigateUrlFormatString="PR_setup_AttdDet.aspx?tbcode={0}" 
									                DataTextField="AttCode" />
									
								                <asp:HyperLinkColumn HeaderText="Description" ItemStyle-Width="40%" 
									                SortExpression="Attd.Description" 
									                DataNavigateUrlField="AttCode" 
									                DataNavigateUrlFormatString="PR_setup_AttdDet.aspx?tbcode={0}" 
									                DataTextField="Description" />
								
								                <asp:TemplateColumn HeaderText="Last Update" ItemStyle-Width="10%" SortExpression="Attd.UpdateDate">
									                <ItemTemplate>
										                <%# objGlobal.GetLongDate(Container.DataItem("UpdateDate")) %>
									                </ItemTemplate>
								                </asp:TemplateColumn>
									
								                <asp:TemplateColumn HeaderText="Status" ItemStyle-Width="10%" SortExpression="Attd.Status">
									                <ItemTemplate>
