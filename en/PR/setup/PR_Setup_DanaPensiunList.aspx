<%@ Page Language="vb" src="../../../include/PR_Setup_DanaPensiunList.aspx.vb" Inherits="PR_Setup_DanaPensiunList" %>
<%@ Register TagPrefix="UserControl" Tagname="MenuPRSetup" src="../../menu/menu_PRsetup.ascx"%>
<%@ Register TagPrefix="Preference" Tagname="PrefHdl" src="../../include/preference/preference_handler.ascx"%>
<html>
	<head>
		<title>Dana Pensiun List</title>
					...
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						...
						<tr>
							...
							<table cellpadding="4" cellspacing="0" style="width: 100%">
								...
								<td width="20%" height="26" valign=bottom><asp:label id="lblTitle2" runat="server"/>Code :<BR><asp:TextBox id="srchDanaPensiunCode" width=100% maxlength="8" runat="server" /></td>
						    ...
						    <tr>
							    ...
							    <table cellpadding="4" cellspacing="1" style="width: 100%">
					                ...
					                <Columns>
					                <asp:BoundColumn Visible=False HeaderText="Dana Pensiun Code" DataField="DanaPensiunCode" />					
					                <asp:HyperLinkColumn HeaderText="Dana Pensiun Code" ItemStyle-Width="21%" HeaderStyle-Width="15%"
						                SortExpression="P.DanaPensiunCode" 
						                DataNavigateUrlField="DanaPensiunCode" 
						                DataNavigateUrlFormatString="PR_Setup_DanaPensiunDet.aspx?danapensiuncode={0}" 
						                DataTextField="DanaPensiunCode" />						
					                <asp:HyperLinkColumn HeaderText="Dana Pensiun Description" ItemStyle-Width="30%" HeaderStyle-Width="30%"
						                SortExpression="P.DanaPensiunDesc" 
						                DataNavigateUrlField="DanaPensiunCode" 
						                DataNavigateUrlFormatString="PR_Setup_DanaPensiunDet.aspx?danapensiuncode={0}" 
						                DataTextField="DanaPensiunDesc" />
					                <asp:TemplateColumn HeaderText="Type" SortExpression="DanaPensiunType">
						                <ItemTemplate>
							                <%# Container.DataItem("DanaPensiunType") %>
						                </ItemTemplate>
					                </asp:TemplateColumn>		
					                <asp:TemplateColumn HeaderText="Last Update" SortExpression="P.UpdateDate">
						                <ItemTemplate>
					                ...
					                <asp:TemplateColumn HeaderText="Status" SortExpression="P.Status">
						                <ItemTemplate>
						...
						<tr>
							<td>
					            <asp:ImageButton id=ibNew OnClick="DEDR_Add" imageurl="../../images/butt_new.gif" AlternateText="New Dana Pensiun" runat="server"/>
