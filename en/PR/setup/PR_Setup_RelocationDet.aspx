<%@ Page Language="vb" src="../../../include/PR_Setup_RelocationDet.aspx.vb" Inherits="PR_Setup_RelocationDet" %>
...
<tr>
	...
	<div class="kontenlist">
			...
			<Input Type=Hidden id=Relocationcode runat=server />
			<table border=0 cellspacing=0 cellpadding=2 width=100% class="font9Tahoma">
				...
				<tr>
					<td width="20%" height="25"><asp:Label id=lblTitle2 runat=server />Code :* </td>
					<td width="30%">
						<asp:Textbox id="txtRelocationCode" width="50%" maxlength="8" runat="server"/>
						<asp:Label id=lblErrDupRelocationCode visible=false forecolor=red text="<br>Relocation code in used, please try other Relocation Code." runat=server/>
						<asp:RequiredFieldValidator id=validateCode display=Dynamic runat=server 
							ErrorMessage="<br>Please Enter Relocation Code"
							ControlToValidate=txtRelocationCode />
				...
				<tr>
					...
					<td><asp:DropDownList id=ddlType width=85% runat=server/> 
						<asp:Label id=lblErrType visible=false forecolor=red text="<br>Please select Relocation Type." runat=server/>
					</td>
					<td>&nbsp;</td>
					<td>Last Updated : </td>
				...
				<tr>
					...
					<td><asp:Textbox id=txtAmount maxlength=15 width=30% runat=server/>
						<asp:RequiredFieldValidator id=rvfAmount display=Dynamic runat=server 
							ErrorMessage="<br>Please enter Relocation rate."
				...
				<tr>
					<td colspan="6"><asp:Label id=lblErrExists visible=false forecolor=red text="<br>Relocation setup for selected type above already exists. " runat=server/></td>
				</tr>
				<tr>
					<td colspan="6">
