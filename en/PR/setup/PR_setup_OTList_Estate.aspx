<%@ Page Language="vb" src="../../../include/PR_setup_OTList_Estate.aspx.vb" Inherits="PR_setup_OTList_Estate" %>
			...
			<tr>
				...
				<div class="kontenlist">
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						<tr>
							<td><strong>DAFTAR SETTING TARIF LEMBUR</strong><hr style="width :100%" />   
                            </td>
						...
						<tr>
							...
							<table cellpadding="4" cellspacing="0" style="width: 100%">
								...
								<td height="26" valign=bottom style="width: 21%">Kode Lembur :<BR><asp:TextBox id=txtOTCode width=100% maxlength="8" runat="server" /></td>								
								<td height="26" valign=bottom style="width: 20%">Harga Beras :<BR><asp:TextBox id=txtBerasRate width=100% maxlength="15" runat="server" /></td>
							...
							<Columns>
								<asp:BoundColumn Visible=False HeaderText="Kode Lembur" DataField="OTCode" />								
								<asp:HyperLinkColumn HeaderText="Kode Lembur" SortExpression="OTCode" 
									DataNavigateUrlField="OTCode" 
									DataNavigateUrlFormatString="PR_setup_OTDet_Estate.aspx?OTCode={0}" 
									DataTextField="OTCode" />								
								
								<asp:TemplateColumn HeaderText="Harga Beras" >
									<ItemTemplate>
										<%#Container.DataItem("Berasrate")%>
									</ItemTemplate>
								</asp:TemplateColumn>
								
								<asp:TemplateColumn HeaderText="Tipe Hari">
									<ItemTemplate>
										<%#Container.DataItem("TyHari")%>
									</ItemTemplate>
								</asp:TemplateColumn>
								
								<asp:TemplateColumn HeaderText="Psn 1(%)" >
									<ItemTemplate>
										<%#Container.DataItem("psn_1")%>
									</ItemTemplate>
								</asp:TemplateColumn>
								
								<asp:TemplateColumn HeaderText="Psn 2(%)" >
									<ItemTemplate>
										<%#Container.DataItem("psn_2")%>
									</ItemTemplate>
								</asp:TemplateColumn>
								
								<asp:TemplateColumn HeaderText="Psn 3(%)" >
									<ItemTemplate>
										<%#Container.DataItem("psn_3")%>
									</ItemTemplate>
								</asp:TemplateColumn>
								
								<asp:TemplateColumn HeaderText="Psn 4(%)" >
									<ItemTemplate>
										<%#Container.DataItem("psn_4")%>
									</ItemTemplate>
								</asp:TemplateColumn>
