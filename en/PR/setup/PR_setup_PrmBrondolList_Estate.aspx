<%@ Page Language="vb" src="../../../include/PR_setup_PrmBrondolList_Estate.aspx.vb" Inherits="PR_setup_PrmBrondolList_Estate" %>
<%@ Register TagPrefix="UserControl" Tagname="MenuPRSetup" src="../../menu/menu_prsetup.ascx"%>
<%@ Register TagPrefix="Preference" Tagname="PrefHdl" src="../../include/preference/preference_handler.ascx"%>
<html>
	<head>
		<title>Premi Brondol List</title>
			...
			<tr>
				...
				<div class="kontenlist">
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						<tr>
							<td><strong><asp:label id="lblTitle" runat="server" >PREMI BRONDOL</asp:label> LIST</strong><hr style="width :100%" />   
                            </td>
						...
						<tr>
							...
							<table cellpadding="4" cellspacing="0" style="width: 100%">
								...
								<td height="26" valign=bottom style="width: 21%">
                                    Brondolan ID :<BR><asp:TextBox id=txtGolId width=100% maxlength="8" runat="server" /></td>								
							...
							<Columns>
								<asp:BoundColumn Visible=False HeaderText="Premi Brondolan ID" DataField="PRBrondolCode" />								
								<asp:HyperLinkColumn HeaderText="Golongan ID" SortExpression="PRBrondolCode" 
									DataNavigateUrlField="PRBrondolCode" 
									DataNavigateUrlFormatString="PR_setup_PrmBrondolDet_Estate.aspx?PRBrondolCode={0}" 
									DataTextField="PRBrondolCode" />		
								...
								<asp:TemplateColumn HeaderText="Premi Brondol" >
									<ItemTemplate>
										<%#Container.DataItem("PrmBdl")%>
									</ItemTemplate>
								</asp:TemplateColumn>																				
