<%@ Page Language="vb" src="../../../include/PR_Setup_MedicalList.aspx.vb" Inherits="PR_Setup_MedicalList" %>
					...
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						...
						<tr>
							...
							<table cellpadding="4" cellspacing="0" style="width: 100%">
								...
								<td width="20%" height="26" valign=bottom><asp:label id="lblTitle2" runat="server"/> Code :<BR><asp:TextBox id="srchMedicalCode" width=100% maxlength="8" runat="server" /></td>
						    ...
						    <tr>
							    ...
							    <table cellpadding="4" cellspacing="1" style="width: 100%">
					                ...
					                <Columns>
					                <asp:BoundColumn Visible=False HeaderText="Medical Code" DataField="MedicalCode" />					
					                <asp:HyperLinkColumn HeaderText="Medical Code" ItemStyle-Width="21%" HeaderStyle-Width="15%"
						                SortExpression="M.MedicalCode" 
						                DataNavigateUrlField="MedicalCode" 
						                DataNavigateUrlFormatString="PR_Setup_MedicalDet.aspx?medicalcode={0}" 
						                DataTextField="MedicalCode" />						
					                <asp:HyperLinkColumn HeaderText="Medical Description" ItemStyle-Width="30%" HeaderStyle-Width="30%"
						                SortExpression="M.MedicalDesc" 
						                DataNavigateUrlField="MedicalCode" 
						                DataNavigateUrlFormatString="PR_Setup_MedicalDet.aspx?medicalcode={0}" 
						                DataTextField="MedicalDesc" />
					                <asp:TemplateColumn HeaderText="Type" SortExpression="MedicalType">
						                <ItemTemplate>
							                <%# Container.DataItem("MedicalType") %>
						                </ItemTemplate>
					                </asp:TemplateColumn>		
						...
						<tr>
							<td>
					            <asp:ImageButton id=ibNew OnClick="DEDR_Add" imageurl="../../images/butt_new.gif" AlternateText="New Medical" runat="server"/>
				        		<asp:ImageButton id=ibPrint imageurl="../../images/butt_print.gif" AlternateText=Print visible=false runat="server"/>
							</td>
						</tr>
                        <tr>
                            <td>
 					            <asp:Button ID="ibNew2" class="button-small" runat="server" Text="New Medical" />&nbsp;
