<%@ Page Language="vb" src="../../../include/PR_Setup_Contractor.aspx.vb" Inherits="PR_Setup_Contractor" %>
			...
			<tr>
				...
				<div class="kontenlist">
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						<tr>
							<td><strong>PURCHASE ORDER LIST</strong><hr style="width :100%" />   
                            </td>
						...
						<tr>
							...
							<table cellpadding="4" cellspacing="0" style="width: 100%">
								...
								<td width="20%" height="26">Contractor Code :<br><asp:TextBox id="srchContractorCd" width="100%" maxlength="8" runat="server"/></td>
						    ...
						    <tr>
							    ...
							    <table cellpadding="4" cellspacing="1" style="width: 100%">
					                ...
					                <Columns>					
					                <asp:TemplateColumn HeaderText="Contractor Code" ItemStyle-Width="10%" SortExpression="Ctr.ContractorCode">
						                <ItemTemplate>
							                <%# Container.DataItem("ContractorCode") %>
						                </ItemTemplate>
						                <EditItemTemplate>
							                <asp:TextBox id="ContractorCode" MaxLength="8" width="95%"
									                Text='<%# trim(Container.DataItem("ContractorCode")) %>'
									                runat="server"/>
							                <asp:RequiredFieldValidator id=validateCode display=dynamic runat=server 
									                ErrorMessage="<br>Please enter Contractor Code."
									                ControlToValidate="ContractorCode" />
					                ...
					                <asp:TemplateColumn HeaderText="Name" ItemStyle-Width="20%" SortExpression="Ctr.Name">
						                <ItemTemplate>
					                ...
					                <asp:TemplateColumn HeaderText="Employee Code" ItemStyle-Width="20%" SortExpression="Ctr.EmpCode">
						                <ItemTemplate>
							                <%# Container.DataItem("EmpCode")%>
						                </ItemTemplate>
						                <EditItemTemplate>
							                <asp:DropDownList id="EmpCode" onselectedIndexchanged="onSelect_Emp" autopostback=true size=1 width="100%" runat="server"/> 
							                <asp:label id=lblEmpCode visible=false text='<%# Container.DataItem("EmpCode") %>' runat=server/>
						                </EditItemTemplate>
					                </asp:TemplateColumn>	
					                <asp:TemplateColumn HeaderText="Account Code" ItemStyle-Width="20%" SortExpression="Ctr.AccCode">
						                <ItemTemplate>
							                <%# Container.DataItem("AccCode")%>
						                </ItemTemplate>
						                <EditItemTemplate>
							                <asp:DropDownList id="AccCode" size=1 width="100%" runat="server"/>
					                ...
					                <asp:TemplateColumn HeaderText="Last Update" ItemStyle-Width="9%" SortExpression="Ctr.UpdateDate">
						                <ItemTemplate>
					                ...
					                <asp:TemplateColumn HeaderText="Status" ItemStyle-Width="5%" SortExpression="Ctr.Status">
						                <ItemTemplate>
							                <%# objPR.mtdGetContrListStatus(Container.DataItem("Status")) %>
						                </ItemTemplate>
						                <EditItemTemplate>
						...
						<tr>
							<td>
					            <asp:ImageButton id=ibNew OnClick="DEDR_Add" imageurl="../../images/butt_new.gif" AlternateText="New Contractor" runat="server"/>
