<%@ Page Language="vb" src="../../../include/PR_Setup_DivCode_Estate.aspx.vb" Inherits="PR_Setup_DivCode_Estate" %>
			...
			<tr>
				...
				<div class="kontenlist">
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						<tr>
							<td><strong>DAFTAR DIVISI</strong><hr style="width :100%" />   
                            </td>
						...
						<tr>
							...
							<table cellpadding="4" cellspacing="0" style="width: 100%">
								...
								<td width="15%" height="26" valign=bottom>Kode Divisi :<BR><asp:TextBox id=srchDeptCode width=100% maxlength="8" runat="server"/></td>
						    ...
						    <tr>
							    ...
							    <table cellpadding="4" cellspacing="1" style="width: 100%">
						            ...
						            <asp:DataGrid id="EventData"
					                    ...
					                    <Columns>					
					                    <asp:TemplateColumn HeaderText="Kode Divisi" SortExpression="BlkGrpCode">
						                    <ItemTemplate>
							                    <%#Container.DataItem("BlkGrpCode")%>
						                    </ItemTemplate>
						                    <EditItemTemplate>
							                    <asp:TextBox id="BlkGrpCode" MaxLength="8" width=95%
								                    Text='<%# trim(Container.DataItem("BlkGrpCode")) %>' runat="server"/><BR>
