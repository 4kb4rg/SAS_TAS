<%@ Page Language="vb" src="../../../include/PR_Setup_MaternityList.aspx.vb" Inherits="PR_Setup_MaternityList" %>
<%@ Register TagPrefix="UserControl" Tagname="MenuPRSetup" src="../../menu/menu_PRsetup.ascx"%>
<%@ Register TagPrefix="Preference" Tagname="PrefHdl" src="../../include/preference/preference_handler.ascx"%>
<html>
	<head>
		<title>Maternity List</title>
					...
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						...
						<tr>
							...
							<table cellpadding="4" cellspacing="0" style="width: 100%">
								...
								<td width="10%" height="26" valign=bottom><asp:label id="lblTitle2" runat="server"/>Code :<BR><asp:TextBox id=txtMaternityCode width=100% maxlength="8" runat="server" /></td>
						    ...
						    <tr>
							    ...
							    <table cellpadding="4" cellspacing="1" style="width: 100%">
						            ...
						            <asp:DataGrid id=dgLine runat=server
							                ...
							                <Columns>
								                <asp:BoundColumn Visible=False HeaderText="Maternity Code" DataField="MaternityCode" />
								                <asp:HyperLinkColumn ItemStyle-Width="10%" HeaderStyle-Width="10%"
									                SortExpression="MaternityCode" 
									                DataNavigateUrlField="MaternityCode" 
									                DataNavigateUrlFormatString="PR_setup_MaternityDet.aspx?Maternitycode={0}" 
									                DataTextField="MaternityCode" />
									
								                <asp:HyperLinkColumn HeaderText="Description" ItemStyle-Width="20%" HeaderStyle-Width="20%"
									                SortExpression="MaternityDesc" 
									                DataNavigateUrlField="MaternityCode" 
									                DataNavigateUrlFormatString="PR_setup_MaternityDet.aspx?Maternitycode={0}" 
									                DataTextField="MaternityDesc" />
									
								                <asp:TemplateColumn HeaderText="Employee Category" ItemStyle-Width="20%" HeaderStyle-Width="20%" SortExpression="EmpCategory">
									                <ItemTemplate>
										                <%# Container.DataItem("EmpCategory") %>
									                </ItemTemplate>
								                </asp:TemplateColumn>
								
								                <asp:TemplateColumn HeaderText="Last Update" ItemStyle-Width="10%" HeaderStyle-Width="10%" SortExpression="M.UpdateDate">
									                <ItemTemplate>
										                <%# objGlobal.GetLongDate(Container.DataItem("UpdateDate")) %>
									                </ItemTemplate>
								                </asp:TemplateColumn>
									
								                <asp:TemplateColumn HeaderText="Status" ItemStyle-Width="10%" HeaderStyle-Width="10%" SortExpression="M.Status">
									                <ItemTemplate>
						...
						<tr>
							<td>
					            <asp:ImageButton id=NewADBtn OnClick="NewADBtn_Click" imageurl="../../images/butt_new.gif" AlternateText="New Maternity" runat="server"/>
