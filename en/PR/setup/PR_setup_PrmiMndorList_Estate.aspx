<%@ Page Language="vb" src="../../../include/PR_setup_PrmiMndorList_Estate.aspx.vb" Inherits="PR_setup_PrmiMndorList_Estate" %>
			...
			<tr>
				...
				<div class="kontenlist">
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						<tr>
							<td><strong>PREMI MANDOR LIST</strong><hr style="width :100%" />   
                            </td>
						...
						<tr>
							...
							<table cellpadding="4" cellspacing="0" style="width: 100%">
								...
								<td height="26" valign=bottom style="width: 21%">
                                    Premi Mandor ID :<BR><asp:TextBox id=txtGolId width=100% maxlength="8" runat="server" /></td>								
							...
							<Columns>
								<asp:BoundColumn Visible=False HeaderText="Premi Mandor ID" DataField="PMdrID" />								
								<asp:HyperLinkColumn HeaderText="Premi Mandor ID" SortExpression="PMdrID" 
									DataNavigateUrlField="PMdrID" 
									DataNavigateUrlFormatString="PR_setup_PrmiMndor_Estate.aspx?PMdrID={0}" 
									DataTextField="PMdrID" />		
								...
								<asp:TemplateColumn HeaderText="Mdr.Panen(%)" >
									<ItemTemplate>
										<%#Container.DataItem("PsnMdrPanen")%>
									</ItemTemplate>
								</asp:TemplateColumn>																				
								
								<asp:TemplateColumn HeaderText="Mdr.Brondol(%)" >
									<ItemTemplate>
										<%#Container.DataItem("PsnMdrBrondol")%>
									</ItemTemplate>
								</asp:TemplateColumn>	
								
								<asp:TemplateColumn HeaderText="KCS(%)" >
									<ItemTemplate>
										<%#Container.DataItem("PsnMdrKcs")%>
									</ItemTemplate>
								</asp:TemplateColumn>	
								
								<asp:TemplateColumn HeaderText="Mdr.Traksi(%)" >
									<ItemTemplate>
										<%#Container.DataItem("PsnMdrTraksi")%>
									</ItemTemplate>
								</asp:TemplateColumn>	
								
								<asp:TemplateColumn HeaderText="Mdr.Timbangan(Rp/Ton)" >
									<ItemTemplate>
										<%#Container.DataItem("PayKrnTimbang")%>
									</ItemTemplate>
								</asp:TemplateColumn>	
