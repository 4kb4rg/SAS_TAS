<%@ Page Language="vb" debug="true" src="../../../include/PR_setup_YearPlan_Estate.aspx.vb" Inherits="PR_Stp_YearPlan" %>
<%@ Register TagPrefix="UserControl" Tagname="MenuHRSetup" src="../../menu/menu_hrsetup.ascx"%>
<%@ Register TagPrefix="Preference" Tagname="PrefHdl" src="../../include/preference/preference_handler.ascx"%>
<html>
	<head>
		<title>Tahun Tanam List</title>
			...
			<tr>
				...
				<div class="kontenlist">
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						<tr>
							<td><strong>DAFTAR TAHUN TANAM</strong><hr style="width :100%" />   
                            </td>
						...
						<tr>
							...
							<table cellpadding="4" cellspacing="0" style="width: 100%">
								...
								<td width="15%" height="26" valign=bottom>Kode Tahun Tanam :<BR><asp:TextBox id=srchYearPlan width=100% maxlength="8" runat="server"/></td>
								<td width="20%" height="26" valign=bottom>Divisi :<BR><asp:DropDownList id=srchdivisi width=100% runat="server"/></td>
								<td width="10%" height="26" valign=bottom>Status :<BR><asp:DropDownList id="srchStatusList" width=100% runat=server /></td>
								<td width="15%" height="26" valign=bottom>Diupdate :<BR><asp:TextBox id=srchUpdateBy width=100% maxlength="128" runat="server"/></td>
						    ...
						    <tr>
							    ...
							    <table cellpadding="4" cellspacing="1" style="width: 100%">
					                ...
					                <%--<asp:HyperLinkColumn HeaderText="Kode Tahun Tanam" ItemStyle-Width="15%"
									                SortExpression="BlkCode" 
									                DataNavigateUrlField="BlkCode" 
									                DataNavigateUrlFormatString="PR_setup_YearPlanDet_Estate.aspx?BlkCode={0}" 
									                DataTextField="BlkCode" />--%>
									
					                <asp:TemplateColumn HeaderText="Kode Tahun Tanam">
						                <ItemTemplate>
						...
						<tr>
							<td>
					            <asp:ImageButton id=btnNew OnClick="NewTBBtn_Click" imageurl="../../images/butt_new.gif" AlternateText="New Year Plant Code" runat="server"/>
							</td>
						</tr>
                        <tr>
                            <td>
