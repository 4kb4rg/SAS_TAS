<%@ Page Language="vb" src="../../../include/PR_Setup_TranIncList.aspx.vb" Inherits="PR_Setup_TranIncList" %>
<%@ Register TagPrefix="UserControl" Tagname="MenuPRSetup" src="../../menu/menu_PRsetup.ascx"%>
<%@ Register TagPrefix="Preference" Tagname="PrefHdl" src="../../include/preference/preference_handler.ascx"%>
<html>
	<head>
		<title>Transport Incentive List</title>
					...
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						...
						<tr>
							...
							<table cellpadding="4" cellspacing="0" style="width: 100%">
								...
								<td width="20%" height="26" valign=bottom><asp:label id="lblTitle2" runat="server"/>Code :<BR><asp:TextBox id=txtTranIncCode width=100% maxlength="8" runat="server" /></td>
								<td width="20%" height="26" valign=bottom>Description :<BR><asp:TextBox id=txtDescription width=100% maxlength="128" runat="server" /></td>
							...
							<Columns>
								<asp:BoundColumn Visible=False  DataField="TranIncCode" />
								<asp:HyperLinkColumn ItemStyle-Width="20%" HeaderStyle-Width="20%"
									SortExpression="TranIncCode" 
									DataNavigateUrlField="TranIncCode" 
									DataNavigateUrlFormatString="PR_setup_TranIncDet.aspx?TranInccode={0}" 
									DataTextField="TranIncCode" />
								...
								<asp:TemplateColumn HeaderText="Last Update" ItemStyle-Width="10%" HeaderStyle-Width="10%" SortExpression="TI.UpdateDate">
									<ItemTemplate>
										<%# objGlobal.GetLongDate(Container.DataItem("UpdateDate")) %>
									</ItemTemplate>
								</asp:TemplateColumn>
									
								<asp:TemplateColumn HeaderText="Status" ItemStyle-Width="10%" HeaderStyle-Width="10%" SortExpression="TI.Status">
									<ItemTemplate>
						...
						<tr>
							<td>
					            <asp:ImageButton id=NewADBtn OnClick="NewADBtn_Click" imageurl="../../images/butt_new.gif" AlternateText="New Transport Incentive" runat="server"/>
