<%@ Page Language="vb" src="../../../include/PR_setup_PrmKaretList_Estate.aspx.vb" Inherits="PR_setup_PrmKaretList_Estate" %>
<%@ Register TagPrefix="UserControl" Tagname="MenuHRSetup" src="../../menu/menu_hrsetup.ascx"%>
<%@ Register TagPrefix="Preference" Tagname="PrefHdl" src="../../include/preference/preference_handler.ascx"%>
<html>
	<head>
		<title>Premi Deres List</title>
			...
			<tr>
				...
				<div class="kontenlist">
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						<tr>
							<td><strong>DAFTAR PREMI DERES</strong><hr style="width :100%" />   
                            </td>
							...
							<Columns>
							   ...
							   <asp:TemplateColumn HeaderText="Periode Start" SortExpression="periodeend">
								...
								<%--<asp:TemplateColumn HeaderText="KKK(%)">
									<ItemTemplate>
										<asp:Label ID=kkk_psn Text='<%#Container.DataItem("KKK_Psn")%>' runat=server/>										
									</ItemTemplate>
								</asp:TemplateColumn>	
								...
								<asp:TemplateColumn HeaderText="LM(%)">
									<ItemTemplate >
										<asp:Label ID=lm_psn Text='<%#Container.DataItem("LM_psn")%>' Visible=true runat=server/>										
									</ItemTemplate>
									<ItemStyle HorizontalAlign="Right" />
									<HeaderStyle HorizontalAlign="Right" />
								</asp:TemplateColumn>		--%>
															
								<asp:TemplateColumn HeaderText="KKK Basis(Kg)">
									<ItemTemplate >
										<asp:Label ID=kkk_bss Text='<%#Container.DataItem("KKK_Basis")%>' Visible=true runat=server/>										
									</ItemTemplate>
									<ItemStyle HorizontalAlign="Right" />
									<HeaderStyle HorizontalAlign="Right" />
								</asp:TemplateColumn>		
								
								<asp:TemplateColumn HeaderText="LM Basis(Kg)">
									<ItemTemplate >
										<asp:Label ID=lm_bss Text='<%#Container.DataItem("LM_Basis")%>' Visible=true runat=server/>										
									</ItemTemplate>
									<ItemStyle HorizontalAlign="Right" />
									<HeaderStyle HorizontalAlign="Right" />
								</asp:TemplateColumn>		
								
								<asp:TemplateColumn HeaderText="KKK Ov.basis(Rp)">
									<ItemTemplate >
										<asp:Label ID=kkk_ob Text='<%#Container.DataItem("KKK_RpOB")%>' Visible=true runat=server/>										
									</ItemTemplate>
									<ItemStyle HorizontalAlign="Right" />
									<HeaderStyle HorizontalAlign="Right" />
								</asp:TemplateColumn>		
								
								<asp:TemplateColumn HeaderText="LM Ov.basis(Rp)">
									<ItemTemplate >
										<asp:Label ID=lm_ob Text='<%#Container.DataItem("LM_RpOB")%>' Visible=true runat=server/>										
									</ItemTemplate>
									<ItemStyle HorizontalAlign="Right" />
									<HeaderStyle HorizontalAlign="Right" />
								</asp:TemplateColumn>	
								
								<asp:TemplateColumn HeaderText="GT Ov.basis(Rp)">
									<ItemTemplate >
										<asp:Label ID=gt_ob Text='<%#Container.DataItem("GT_RpOB")%>' Visible=true runat=server/>										
									</ItemTemplate>
									<ItemStyle HorizontalAlign="Right" />
									<HeaderStyle HorizontalAlign="Right" />
								</asp:TemplateColumn>	
