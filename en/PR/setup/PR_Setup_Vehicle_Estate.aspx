<%@ Page Language="vb" src="../../../include/PR_Setup_Vehicle_Estate.aspx.vb" Inherits="PR_Setup_Vehicle_Estate" %>
			...
			<tr>
				...
				<div class="kontenlist">
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						...
						<tr>
							...
							<Columns>
								<asp:HyperLinkColumn ItemStyle-Width="15%"
									SortExpression="veh.VehCode" 
									DataNavigateUrlField="VehCode" 
									DataNavigateUrlFormatString="PR_Setup_VehicleDet_Estate.aspx?tbcode={0}" 
								...
								<asp:TemplateColumn ItemStyle-Width="15%" ItemStyle-HorizontalAlign=center>
									<ItemTemplate>
										<asp:Label id=lblLnId Visible=False text=<%# Container.DataItem("VehCode")%> Runat="server" />
						...
						<tr>
							<td>
					            <asp:ImageButton id=NewTBBtn onClick=NewTBBtn_Click imageurl="../../images/butt_new.gif" AlternateText="New Vehicle" runat=server/>
