<%@ Page Language="vb" src="../../../include/PR_setup_Aktiviti_Estate.aspx.vb" Inherits="PR_setup_Aktiviti_Estate" %>
			...
			<tr>
				...
				<div class="kontenlist">
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						<tr>
							<td><strong>AKTIVITI</strong><hr style="width :100%" />   
                            </td>
						...
						<tr>
							...
							<table cellpadding="4" cellspacing="0" style="width: 100%">
								...
								<td height="26" valign=bottom style="width: 23%">
                                    Aktiviti Code :<BR><asp:TextBox id=srchJobCode width=100% maxlength="8" runat="server"/></td>
						    ...
						    <tr>
							    ...
							    <table cellpadding="4" cellspacing="1" style="width: 100%">
					                ...
					                <asp:TemplateColumn SortExpression="JobCode" HeaderText="Aktiviti Code">
						                <ItemTemplate>
							                <%#Container.DataItem("JobCode")%>
						                </ItemTemplate>
						                <EditItemTemplate>
							                <asp:TextBox id="JbtCode" MaxLength="8" width=95%
								                Text='<%# trim(Container.DataItem("JobCode")) %>' ReadOnly=true runat="server"/><BR>
					                ...
					                <asp:TemplateColumn SortExpression="Catid" HeaderText="kategori">
						                <ItemTemplate>
							                <%#Container.DataItem("CatId")%>
						                </ItemTemplate>
						                <EditItemTemplate>													
							                <asp:DropDownList id="ddlcatid" width=100% AutoPostBack=true runat=server>
							                </asp:DropDownList>
							                <asp:Label id=lblErrCodeGrpJobe visible=false text ="Please select kategori" forecolor=red runat=server/>	
							                <asp:label id=lblcatid visible=false text='<%# trim(Container.DataItem("CatId")) %>' runat=server/>						
						                </EditItemTemplate>
						                <ItemStyle Width=100 />
						
					                </asp:TemplateColumn>	
					
					                <asp:TemplateColumn SortExpression="JobName" HeaderText="Description">
						                <ItemTemplate>
							                <%#Container.DataItem("JobName")%>
						                </ItemTemplate>
						                <EditItemTemplate>
							                <asp:TextBox id="Description" width=100% MaxLength="100"
								                Text='<%# trim(Container.DataItem("JobName")) %>' runat="server"/>
					                ...
					                <asp:TemplateColumn HeaderText="UOM">
						                ...
						                <EditItemTemplate>
							                <asp:TextBox id="Uom" width=100% MaxLength="3"
								                Text='<%# trim(Container.DataItem("Uom")) %>' runat="server"/>
							                <asp:RequiredFieldValidator id=validateUom display=Dynamic runat=server 
								                ControlToValidate=Uom />															
						                </EditItemTemplate>
					                </asp:TemplateColumn>				
