<%@ Page Language="vb" src="../../../include/PR_Setup_Angsuran.aspx.vb" Inherits="PR_Setup_Angsuran" %>
<%@ Register TagPrefix="UserControl" Tagname="MenuHRSetup" src="../../menu/menu_hrsetup.ascx"%>
<%@ Register TagPrefix="Preference" Tagname="PrefHdl" src="../../include/preference/preference_handler.ascx"%>
<html>
	<head>
		<title>Identity Card Type List</title>
			...
			<tr>
				...
				<div class="kontenlist">
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						<tr>
							<td><strong>Angsuran LIST</strong><hr style="width :100%" />   
                            </td>
						...
						<tr>
							...
							<table cellpadding="4" cellspacing="0" style="width: 100%">
								...
								<td width="15%" height="26" valign=bottom>Ansguran Code :<BR><asp:TextBox id=srchAngsuranCode width=100% maxlength="8" runat="server"/></td>
						    ...
						    <tr>
							    ...
							    <table cellpadding="4" cellspacing="1" style="width: 100%">
					                ...
					                <Columns>					
					                <asp:TemplateColumn HeaderText="Angsuran Code" SortExpression="AngsuranCode">
						                <ItemTemplate>
							                <%# Container.DataItem("AngsuranCode") %>
						                </ItemTemplate>
						                <EditItemTemplate>
							                <asp:TextBox id="AngsuranCode" MaxLength="8" width=95%
								                Text='<%# trim(Container.DataItem("AngsuranCode")) %>' runat="server"/><BR>
							                <asp:RequiredFieldValidator id=validateCode display=dynamic runat=server 
								                ErrorMessage="Please Enter Identification Card Type Code"
								                ControlToValidate=AngsuranCode />
					                ...
					                <asp:TemplateColumn HeaderText="Description" SortExpression="Description">
						                ...
						                <EditItemTemplate>
							                ...
							                <asp:RequiredFieldValidator id=validateDesc display=Dynamic runat=server 
								                ErrorMessage="Please Enter IC Type Description"
								                ControlToValidate=Description />
						                </EditItemTemplate>
					                </asp:TemplateColumn>					
					                <asp:TemplateColumn HeaderText="Last Update" SortExpression="IC.UpdateDate">
						                <ItemTemplate>
					                ...
					                <asp:TemplateColumn HeaderText="Status" SortExpression="IC.Status">
						                <ItemTemplate>
						...
						<tr>
							<td>
					            <asp:ImageButton id=btnNew OnClick="DEDR_Add" imageurl="../../images/butt_new.gif" AlternateText="New IC Type" runat="server"/>
