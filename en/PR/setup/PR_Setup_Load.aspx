<%@ Page Language="vb" src="../../../include/PR_Setup_Load.aspx.vb" Inherits="PR_Setup_Load" %>
...
<%--	<Preference:PrefHdl id=PrefHdl runat="server" />--%>
		<body>
		    <form id="Load" runat="server" class="main-modul-bg-app-list-pu">
					...
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						...
						<tr>
							...
							<table cellpadding="4" cellspacing="0" style="width: 100%">
								...
								<td width="20%" height="26"><asp:label id="lblLoad" runat="server" /> Code :<br><asp:TextBox id="srchLoadCode" width="100%" maxlength="8" runat="server"/></td>
						    ...
						    <tr>
					            ...
					            <Columns>					
					            <asp:TemplateColumn ItemStyle-Width="21%" SortExpression="L.LoadCode">
						            <ItemTemplate>
							            <%# Container.DataItem("LoadCode") %>
						            </ItemTemplate>
						            <EditItemTemplate>
							            <asp:TextBox id="LoadCode" MaxLength="8" width=95%
									            Text='<%# Trim(Container.DataItem("LoadCode")) %>'
									            runat="server"/>
							            <asp:RequiredFieldValidator id=validateCode display=dynamic runat=server 
									            ControlToValidate="LoadCode" />
					            ...
					            <asp:TemplateColumn SortExpression="L.Description">
						            <ItemTemplate>
					            ...
					            <asp:TemplateColumn HeaderText="Last Update" SortExpression="L.UpdateDate">
						            <ItemTemplate>
					            ...
					            <asp:TemplateColumn HeaderText="Status" SortExpression="L.Status">
						            <ItemTemplate>
							            <%# objPR.mtdGetLoadStatus(Container.DataItem("Status")) %>
						            </ItemTemplate>
						            <EditItemTemplate>
						...
						<tr>
							<td>
					            <asp:ImageButton id=ibNew OnClick="DEDR_Add" imageurl="../../images/butt_new.gif" AlternateText="New Load" runat="server"/>
