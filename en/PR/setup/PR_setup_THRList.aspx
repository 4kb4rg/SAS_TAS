<%@ Page Language="vb" src="../../../include/PR_setup_THRList.aspx.vb" Inherits="PR_setup_THRList" %>
			...
			<tr>
				...
				<div class="kontenlist">
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						<tr>
							<td><strong>DAFTAR THR</strong><hr style="width :100%" />   
                            </td>
						...
						<tr>
							...
							<table cellpadding="4" cellspacing="0" style="width: 100%">
								...
								<td height="26" valign=bottom style="width: 21%">Kode THR :<BR><asp:TextBox id=txtAstekCode width=100% maxlength="8" runat="server" /></td>								
						    ...
						    <tr>
							    ...
							    <table cellpadding="4" cellspacing="1" style="width: 100%">
						            ...
						            <asp:DataGrid id=dgLine runat=server
							                ...
							                <Columns>
								                <asp:BoundColumn Visible=False HeaderText="Kode THR" DataField="THRId" />								
								                <asp:HyperLinkColumn HeaderText="Kode THR" SortExpression="THRId" 
									                DataNavigateUrlField="THRId" 
									                DataNavigateUrlFormatString="PR_setup_THRDet.aspx?THRId={0}" 
									                DataTextField="THRId" />								
								               
								                <asp:TemplateColumn HeaderText="Periode Bayar" SortExpression="PeriodeStart">
									                <ItemTemplate>
										                <%#Container.DataItem("PeriodeBayar")%>
									                </ItemTemplate>
								                </asp:TemplateColumn>		
								
								                <asp:TemplateColumn HeaderText="Periode CutOff" SortExpression="PeriodeEnd">
									                <ItemTemplate>
										                <%#Container.DataItem("PeriodeMulai")%> - <%#Container.DataItem("PeriodeSelesai")%>
									                </ItemTemplate>
								                </asp:TemplateColumn>

												<asp:TemplateColumn HeaderText="Agama" SortExpression="PeriodeEnd">
									                <ItemTemplate>
										                <%#Container.DataItem("ReligionNm")%>
									                </ItemTemplate>
								                </asp:TemplateColumn>
