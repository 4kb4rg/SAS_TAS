<%@ Page Language="vb" src="../../../include/PR_setup_ADList.aspx.vb" Inherits="PR_Setup_ADList" %>
<%@ Register TagPrefix="UserControl" Tagname="MenuPRSetup" src="../../menu/menu_PRsetup.ascx"%>
<%@ Register TagPrefix="Preference" Tagname="PrefHdl" src="../../include/preference/preference_handler.ascx"%>
<html>
	<head>
		<title>Allowance And Deduction List</title>
			...
			<tr>
				...
				<div class="kontenlist">
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						<tr>
							<td><strong>ALLOWANCE AND DEDUCTION CODE LIST</strong><hr style="width :100%" />   
                            </td>
						...
						<tr>
							...
							<table cellpadding="4" cellspacing="0" style="width: 100%">
								...
								<td width="15%" height="26" valign=bottom>A.D. Code :<BR><asp:TextBox id=txtADCode width=100% maxlength="8" runat="server" /></td>
						    ...
						    <tr>
							    ...
							    <table cellpadding="4" cellspacing="1" style="width: 100%">
						            ...
						            <asp:DataGrid id=dgLine runat=server
							                ...
							                <Columns>
								                <asp:BoundColumn Visible=False HeaderText="A.D. Code" DataField="ADCode" />
								                <asp:HyperLinkColumn HeaderText="A.D. Code" ItemStyle-Width="15%" HeaderStyle-Width="15%"
									                SortExpression="AD.ADCode" 
									                DataNavigateUrlField="ADCode" 
									                DataNavigateUrlFormatString="PR_setup_ADDet.aspx?adcode={0}" 
									                DataTextField="ADCode" />
						...
						<tr>
							<td>
					            <asp:ImageButton id=NewADBtn OnClick="NewADBtn_Click" imageurl="../../images/butt_new.gif" AlternateText="New Allowance And Deduction" runat="server"/>
