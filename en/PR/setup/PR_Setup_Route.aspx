<%@ Page Language="vb" src="../../../include/PR_Setup_Route.aspx.vb" Inherits="PR_Setup_Route" %>
					...
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						...
						<tr>
							...
							<table cellpadding="4" cellspacing="0" style="width: 100%">
								...
								<td width="20%" height="26"><asp:label id="lblRoute" runat="server" /> Code :<br><asp:TextBox id="srchRouteCode" width="100%" maxlength="8" runat="server"/></td>
						    ...
						    <tr>
							    ...
							    <table cellpadding="4" cellspacing="1" style="width: 100%">
					                ...
					                <Columns>
					                <asp:BoundColumn Visible=False HeaderText="Route Code" DataField="RouteCode" />					
					                <asp:HyperLinkColumn HeaderText="Route Code" ItemStyle-Width="21%" HeaderStyle-Width="15%"
						                SortExpression="R.RouteCode" 
						                DataNavigateUrlField="RouteCode" 
						                DataNavigateUrlFormatString="PR_Setup_RouteDet.aspx?routecode={0}" 
						                DataTextField="RouteCode" />						
					                <asp:HyperLinkColumn HeaderText="Description" ItemStyle-Width="30%" HeaderStyle-Width="30%"
						                SortExpression="R.Description" 
						                DataNavigateUrlField="RouteCode" 
						                DataNavigateUrlFormatString="PR_Setup_RouteDet.aspx?routecode={0}" 
						                DataTextField="Description" />
					                <asp:TemplateColumn SortExpression="R.RouteRate">
						                <ItemTemplate>
							                <%# ObjGlobal.GetIDDecimalSeparator(Container.DataItem("RouteRate")) %> <!-- Modified BY ALIM -->
						                </ItemTemplate>
						                <EditItemTemplate>
							                <!-- Modified BY ALIM maxlenght=22 -->
							                <asp:TextBox id="RouteRate" Size=15 MaxLength=22
								                Text='<%# trim(Container.DataItem("RouteRate")) %>'
								                runat="server"/>
							                <asp:RequiredFieldValidator id=validateRate display=Dynamic runat=server 
								                ErrorMessage="Please Enter Route Rate"
								                ControlToValidate="RouteRate" />															
							                <asp:CompareValidator id="cvRate" display=dynamic runat="server" 
								                ControlToValidate="RouteRate" Text="<br>The value must whole number or with decimal. " 
								                Type="double" Operator="DataTypeCheck"/>	
							                <!-- Modified BY ALIM -->						
							                <asp:RegularExpressionValidator id=revRouteRate 
								                ControlToValidate="RouteRate"
					                ...
					                <asp:TemplateColumn HeaderText="Last Update" SortExpression="R.UpdateDate">
						                <ItemTemplate>
					                ...
					                <asp:TemplateColumn HeaderText="Status" SortExpression="R.Status">
						                <ItemTemplate>
							                <%# objPR.mtdGetRouteStatus(Container.DataItem("Status")) %>
						                </ItemTemplate>
						                <EditItemTemplate>
						...
						<tr>
							<td>
					            <asp:ImageButton id=ibNew OnClick="DEDR_Add" imageurl="../../images/butt_new.gif" AlternateText="New Route" runat="server"/>
