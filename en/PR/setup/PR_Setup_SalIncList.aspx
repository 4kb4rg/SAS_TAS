<%@ Page Language="vb" src="../../../include/PR_Setup_SalIncList.aspx.vb" Inherits="PR_Setup_SalIncList" %>
			...
			<tr>
				...
				<div class="kontenlist">
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						...
						<tr>
							...
							<table cellpadding="4" cellspacing="0" style="width: 100%">
								...
								<td width="20%" height="26" valign=bottom>
									<asp:label id="lblValue" runat="server" /> Evaluation Value:<BR>
									<asp:TextBox id=srchValue width=100%  runat="server"/>
								</td>
								<td width="20%" height="26" valign=bottom>
									<asp:label id="lblIncrease" runat="server" /> % Increase:<BR>
									<asp:TextBox id=srchIncrease width=100%  runat="server"/>
								</td>
					                ...
					                <asp:TemplateColumn SortExpression="Year" HeaderText="Year">
						                ...
						                <EditItemTemplate>
							                <asp:TextBox id="txtYear" MaxLength="4" columns="4"
									                ...
									                runat="server"/>							
							                <asp:label id="lblDupMsg"  Text="<br>Selected Year <br> and Value <br>already exists" Visible = false forecolor=red Runat="server"/>
							                <asp:RequiredFieldValidator id=validateYear display=dynamic runat=server 
									                ControlToValidate=txtYear />
						                </EditItemTemplate>
					                </asp:TemplateColumn>
	
					                <asp:TemplateColumn SortExpression="Value" HeaderText="Evaluation Value">
						                <ItemTemplate>
							                <%# Trim(Container.DataItem("Value")) %>
						                </ItemTemplate>
						                <EditItemTemplate>
							                <asp:TextBox id="txtValue" columns="8" Text='<%# Trim(Container.DataItem("Value")) %>' runat="server"/>	
							                <asp:RequiredFieldValidator id=validateValue display=dynamic runat=server 
									                ControlToValidate=txtValue />														
						                </EditItemTemplate>
					                </asp:TemplateColumn>
					
					                <asp:TemplateColumn SortExpression="Increase" HeaderText="% Increase">
						                <ItemTemplate>
							                <%# Trim(Container.DataItem("Increase")) %> %
						                </ItemTemplate>
						                <EditItemTemplate>
							                <asp:TextBox id="txtIncrease" columns="8" Text='<%# Trim(Container.DataItem("Increase")) %>' runat="server"/> %
							                <asp:RequiredFieldValidator id=validateIncrease display=dynamic runat=server 
									                ControlToValidate=txtIncrease />
						...
						<tr>
							<td>
					            <asp:ImageButton id=ibNew OnClick="DEDR_Add" imageurl="../../images/butt_new.gif" AlternateText="New Salary Increase" runat="server"/>
