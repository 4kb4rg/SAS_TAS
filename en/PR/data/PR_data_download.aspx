<%@ Page Language="vb" src="../../../include/PR_data_download.aspx.vb" Inherits="PR_data_download" %>
			...
			<tr>
				<td width="100%">
					...
					<table id=tblDownload border="0" cellpadding="0" cellspacing="0" width="100%" runat=server>
						...
						<tr>
							<td width="100%" colspan="4">Payroll Reference Data</td>
						</tr>
						<tr>
						...
						<tr>
							<td colspan=2>&nbsp;</td>
							<td colspan=2><asp:CheckBox id=cbADGroup onclick="javascript:CCA();" text="Allowance & Deduction Group, Allowance & Deduction" runat=server /></td>
						</tr>
						<tr>
							<td colspan=2>&nbsp;</td>
							<td colspan=2><asp:CheckBox id=cbContractor onclick="javascript:CCA();" text="Contractor" runat=server /></td>
						</tr>
						<tr>
							<td colspan=2>&nbsp;</td>
							<td colspan=2><asp:CheckBox id=cbAttd onclick="javascript:CCA();" text="Attendance" runat=server /></td>
						</tr>
						<tr>
							<td colspan=2>&nbsp;</td>
							<td colspan=2><asp:CheckBox id=cbAttdIncScheme onclick="javascript:CCA();" text="Attendance Incentive Scheme" runat=server /></td>
						</tr>
						<tr>
							<td colspan=2>&nbsp;</td>
							<td colspan=2><asp:CheckBox id=cbAttdHarvScheme onclick="javascript:CCA();" text="Harvesting Incentive Scheme" runat=server /></td>
						</tr>
						<tr>
							<td colspan=2>&nbsp;</td>
							<td colspan=2><asp:CheckBox id=cbDiff onclick="javascript:CCA();" text="Differentials" runat=server /></td>
						</tr>
						<tr>
							<td colspan=2>&nbsp;</td>
							<td colspan=2><asp:CheckBox id=cbPayDiv onclick="javascript:CCA();" text="Pay Division" runat=server /></td>
						</tr>
						<tr>
							<td colspan=2>&nbsp;</td>
							<td colspan=2><asp:CheckBox id=cbMAC onclick="javascript:CCA();" text="Mechanically Assisted Collection" runat=server /></td>
						</tr>
						<tr>
