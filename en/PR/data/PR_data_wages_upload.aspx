<%@ Page Language="vb" src="../../../include/PR_data_wages_upload.aspx.vb" Inherits="PR_DATA_WAGES_UPLOAD" %>
...
<form id=frmUpload enctype="multipart/form-data" runat=server>
	<table border="0" cellspacing="0" width="100%">
		...
		<tr>
			<td class="mt-h" colspan="2">UPLOAD WAGES PAYMENT</td>
		</tr>
		<tr>
			<td colspan=2><hr size="1" noshade></td>
		</tr>
		<tr>
			<td colspan="2">Payroll Wages Data</td>
		</tr>
		<tr>
			<td colspan="2">&nbsp;</td>
		</tr>
		...
		<tr>
			<td colspan="2">
				<table id=tblAfter border=0 width=100% runat=server>
					<tr>
						<td colspan="2">Your Payroll wages file has been successfully uploaded.</td>
					</tr>
				</table>
			</td>
		</tr>
