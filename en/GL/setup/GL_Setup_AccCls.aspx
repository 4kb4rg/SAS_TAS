<%@ Page Language="vb" src="../../../include/GL_Setup_AccCls.aspx.vb" Inherits="GL_Setup_AccCls" %>
<%@ Register TagPrefix="UserControl" Tagname="MenuGLSetup" src="../../menu/menu_GLsetup.ascx"%>
<%@ Register TagPrefix="Preference" Tagname="PrefHdl" src="../../include/preference/preference_handler.ascx"%>
<html>
	<head>
		<title>Account Class List</title>
        <link href="../../include/css/gopalms.css" rel="stylesheet" type="text/css" />
	</head>
	<%--<Preference:PrefHdl id=PrefHdl runat="server" />--%>
		<body>
		    <form id="AccCls" runat="server" class="main-modul-bg-app-list-pu">
			...
			<tr>
				...
				<div class="kontenlist">
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						...
						<tr>
							...
							<table cellpadding="4" cellspacing="0" style="width: 100%">
								...
								<td width="20%" height="26"><asp:label id="lblAccClsCode" runat="server"/> :<br><asp:TextBox id="srchAccClsCd" width="100%" runat="server"/></td>
					...
					<Columns>					
					<asp:TemplateColumn SortExpression="Acc.AccClsCode">
						<ItemTemplate>
							<%# Container.DataItem("AccClsCode") %>
						</ItemTemplate>
						<EditItemTemplate>
							<asp:TextBox id="AccClsCode" width="100%"
								Text='<%# trim(Container.DataItem("AccClsCode")) %>'
								runat="server"/>
							<asp:RequiredFieldValidator id=validateCode display=dynamic runat=server 
								ControlToValidate="AccClsCode" />
							...
							<asp:label id="lblLenMsg" Visible="false" forecolor="red" runat="server"/>

						</EditItemTemplate>
					</asp:TemplateColumn>	
					<asp:TemplateColumn SortExpression="Acc.Description">
						<ItemTemplate>
					...
					<asp:TemplateColumn SortExpression="Acc.AccClsGrpCode">
						<ItemTemplate>
							<%# Container.DataItem("AccClsGrpCode")%>
						</ItemTemplate>
						<EditItemTemplate>
							<asp:DropDownList id="AccClsGrpCode" size=1 width="100%" runat="server"/>
							<asp:label id=lblAccClsGrpCode visible=false text='<%# Container.DataItem("AccClsGrpCode") %>' runat=server/>
						</EditItemTemplate>
					</asp:TemplateColumn>
					...
					<asp:TemplateColumn HeaderText="Status" ItemStyle-Width="5%" SortExpression="Acc.Status">
						<ItemTemplate>
							<%# objGLSetup.mtdGetAccClsStatus(Container.DataItem("Status")) %>
						</ItemTemplate>
						<EditItemTemplate>
					...
					<asp:TemplateColumn ItemStyle-Width="12%" ItemStyle-HorizontalAlign=Center>					
						...
						<tr>
							<td>
                        <asp:ImageButton id=ibNew OnClick="DEDR_Add" imageurl="../../images/butt_new.gif" AlternateText="New Account Class" runat="server"/>
