<%@ Page Language="vb" src="../../../include/GL_Setup_BlockGrp.aspx.vb" Inherits="GL_Setup_BlockGrp" %>
		...
		<table cellpadding="0" cellspacing="0" style="width: 100%">
			...
			<tr>
				...
				<div class="kontenlist">
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						...
						<tr>
							...
							<table cellpadding="4" cellspacing="0" style="width: 100%">
								...
								<td width="20%" height="26"><asp:label id="lblBlkGrpCode" runat="server" /> :<br><asp:TextBox id="srchBlkGrpCode" width="100%" maxlength="8" runat="server"/></td>
					...
					<Columns>					
					<asp:TemplateColumn ItemStyle-Width="10%" SortExpression="blk.BlkGrpCode">
						<ItemTemplate>
							<%# Container.DataItem("BlkGrpCode") %>
						</ItemTemplate>
						<EditItemTemplate>
							<asp:TextBox id="BlkGrpCode" MaxLength="8" width="100%"
									Text='<%# trim(Container.DataItem("BlkGrpCode")) %>'
									runat="server"/>
					...
					<asp:TemplateColumn ItemStyle-Width="25%" SortExpression="blk.Description">
						<ItemTemplate>
					...
					<asp:TemplateColumn HeaderText="Inti/Plasma">
							<ItemStyle Width="10%" />
							<ItemTemplate>
							   <%#IIf(Trim(Container.DataItem("Inti")) = "I", "Inti", "Plasma")%>
							</ItemTemplate>
							<EditItemTemplate>
								<asp:DropDownList id="ddlInti" width=98% runat=server>
								<asp:ListItem Value="I" Selected="True">Inti</asp:ListItem>
								<asp:ListItem Value="P" >Plasma</asp:ListItem>
								</asp:DropDownList>	
                               	<asp:Label id="lblInti" visible=False Text='<%# trim(Container.DataItem("Inti")) %>' runat=server/>							
							</EditItemTemplate>
						</asp:TemplateColumn>		
					<asp:TemplateColumn HeaderText="Bin">
							<ItemStyle Width="20%" />
							<ItemTemplate>
								<%#objINSetup.mtdGetInventoryBinLevel(Container.DataItem("Bin"))%>
							</ItemTemplate>
							<EditItemTemplate>
								<asp:DropDownList id="ddlInventoryBin" width=98% runat=server>
								</asp:DropDownList>		
								<asp:Label id="lblBin" visible=False Text='<%# trim(Container.DataItem("Bin")) %>' runat=server/>												
							</EditItemTemplate>
						</asp:TemplateColumn>			
					...
					<asp:TemplateColumn HeaderText="Status" SortExpression="blk.Status">
						<ItemTemplate>
							<%# objGLSetup.mtdGetBlkGrpStatus(Container.DataItem("Status")) %>
						</ItemTemplate>
						<EditItemTemplate>
					...
					<asp:TemplateColumn ItemStyle-HorizontalAlign=Center>					
						...
						<tr>
							<td>
					            <asp:ImageButton id=NewBlkGrp onClick=DEDR_Add imageurl="../../images/butt_new.gif" AlternateText="New Divisi" runat=server/>
