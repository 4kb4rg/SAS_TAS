<%@ Page Language="vb" src="../../../include/GL_Setup_Activity.aspx.vb" Inherits="GL_Setup_Activity" %>
			...
			<tr>
				...
				<div class="kontenlist">
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						...
						<tr>
							...
							<table cellpadding="4" cellspacing="0" style="width: 100%">
								...
								<td width="15%" height="26"><asp:label id="lblActCode" runat="server" /> : <BR>
									<asp:TextBox id=srchActCode width=100% runat="server" />
								</td>
								<td width="40%" height="26"><asp:label id="lblDescription" runat="server" /> : <BR>
							...
							<Columns>
								<asp:HyperLinkColumn ItemStyle-Width="15%"
									SortExpression="Act.ActCode" 
									DataNavigateUrlField="ActCode" 
									DataNavigateUrlFormatString="GL_Setup_ActivityDet.aspx?tbcode={0}" 
									DataTextField="ActCode" />
									
								<asp:HyperLinkColumn ItemStyle-Width="35%" 
									SortExpression="Act.Description" 
									DataNavigateUrlField="ActCode" 
									DataNavigateUrlFormatString="GL_Setup_ActivityDet.aspx?tbcode={0}" 
								...
								<asp:TemplateColumn HeaderText="Status" ItemStyle-Width="10%" SortExpression="Act.Status">
									<ItemTemplate>
										<%# objGLSetup.mtdGetActSatus(Container.DataItem("Status")) %>
									</ItemTemplate>
								</asp:TemplateColumn>
								...
								<asp:TemplateColumn ItemStyle-Width="15%" ItemStyle-HorizontalAlign=center>
									<ItemTemplate>
										<asp:Label id=lblLnId Visible=False text=<%# Container.DataItem("ActCode")%> Runat="server" />
						...
						<tr>
							<td>
					            <asp:ImageButton id=NewTBBtn OnClick="NewTBBtn_Click" imageurl="../../images/butt_new.gif" AlternateText="New Activity" runat="server"/>
