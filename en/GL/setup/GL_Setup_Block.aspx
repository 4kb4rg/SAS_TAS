<%@ Page Language="vb" src="../../../include/GL_Setup_Block.aspx.vb" Inherits="GL_Setup_Block" %>
...
<html>
	...
	<body>
		<form id=frmBlock runat="server" class="main-modul-bg-app-list-pu">
					...
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						...
						<tr>
							...
							<table cellpadding="4" cellspacing="0" style="width: 100%">
								...
								<td width="20%" height="26"><asp:label id="lblBlkCode" runat="server" /> :<BR>
									<asp:TextBox id=srchBlockCode width=100% maxlength="8" CssClass="fontObject" runat="server" />
								</td>
								<td width="35%" height="26"><asp:label id="lblDescription" runat="server" /> :<BR>
									<asp:TextBox id=srchDescription width=100% maxlength="128" CssClass="fontObject" runat="server" />
								</td>
								<td width="15%" height="26">Status :<BR>
									<asp:DropDownList id="srchStatus" width=100% CssClass="fontObject" runat=server>
										<asp:ListItem value="0">All</asp:ListItem>
										<asp:ListItem value="1" selected>Active</asp:ListItem>
										<asp:ListItem value="2">Deleted</asp:ListItem>
									</asp:DropDownList>
								</td>
								<td width="20%" height="26">Last Updated By :<BR><asp:TextBox id=txtLastUpdate width=100% maxlength="128" CssClass="fontObject" runat="server"/></td>
...
<AlternatingItemStyle CssClass="mr-r"/>
							<Columns>
								<asp:HyperLinkColumn ItemStyle-Width="15%"
									SortExpression="blk.BlkCode" 
									DataNavigateUrlField="BlkCode" 
									DataNavigateUrlFormatString="GL_Setup_BlockDet.aspx?tbcode={0}" 
									DataTextField="BlkCode" />
									
								<asp:HyperLinkColumn ItemStyle-Width="35%" 
									SortExpression="blk.Description" 
									DataNavigateUrlField="BlkCode" 
									DataNavigateUrlFormatString="GL_Setup_BlockDet.aspx?tbcode={0}" 
									DataTextField="Description" />
								
								<asp:TemplateColumn HeaderText="Last Update" ItemStyle-Width="10%" SortExpression="blk.UpdateDate">
									<ItemTemplate>
										<%# objGlobal.GetLongDate(Container.DataItem("UpdateDate")) %>
									</ItemTemplate>
								</asp:TemplateColumn>
									
								<asp:TemplateColumn HeaderText="Status" ItemStyle-Width="10%" SortExpression="blk.Status">
									<ItemTemplate>
										<%# objGLSetup.mtdGetBlockStatus(Container.DataItem("Status")) %>
									</ItemTemplate>
								</asp:TemplateColumn>
								...
								<asp:TemplateColumn ItemStyle-Width="15%" ItemStyle-HorizontalAlign=right>
									<ItemTemplate>
										<asp:Label id=lblLnId Visible=False text=<%# Container.DataItem("BlkCode")%> Runat="server" />
						...
						<tr>
							<td>
					            <asp:ImageButton id=NewTBBtn onClick=NewTBBtn_Click imageurl="../../images/butt_new.gif" AlternateText="New Block" runat=server/>
