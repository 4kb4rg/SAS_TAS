<%@ Page Language="vb" src="../../../include/GL_Setup_ALKOHList.aspx.vb" Inherits="GL_Setup_ALKOHList" %>
<%@ Register TagPrefix="UserControl" Tagname="MenuGLSetup" src="../../menu/menu_glsetup.ascx"%>
<%@ Register TagPrefix="Preference" Tagname="PrefHdl" src="../../include/preference/preference_handler.ascx"%>
<html>
	<head>
		<title>Alokasi Overhead List</title>
        <link href="../../include/css/gopalms.css" rel="stylesheet" type="text/css" />
	<%--	<Preference:PrefHdl id=PrefHdl runat="server" />--%>
	</head>
	<body>
		<form id=frmVehicle runat="server" class="main-modul-bg-app-list-pu">
			...
			<tr>
				...
				<div class="kontenlist">
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						...
						<tr>
							...
							<Columns>
								<asp:HyperLinkColumn ItemStyle-Width="15%"
									SortExpression="veh.AlkohCode" 
									DataNavigateUrlField="AlkohCode" 
									DataNavigateUrlFormatString="GL_Setup_ALKOHDet.aspx?tbcode={0}" 
									DataTextField="AlkohCode" />
								...
								<asp:TemplateColumn HeaderText="Status" ItemStyle-Width="10%" SortExpression="veh.Status">
									<ItemTemplate>
										<%# objGLSetup.mtdGetVehicleStatus(Container.DataItem("Status")) %>
									</ItemTemplate>
								</asp:TemplateColumn>
								...
								<asp:TemplateColumn ItemStyle-Width="15%" ItemStyle-HorizontalAlign=center>
									<ItemTemplate>
										<asp:Label id=lblLnId Visible=False text=<%# Container.DataItem("AlkohCode")%> Runat="server" />
						...
						<tr>
							<td>
					            <asp:ImageButton id=NewTBBtn onClick=NewTBBtn_Click imageurl="../../images/butt_new.gif" AlternateText="New Alokasi" runat=server/>
