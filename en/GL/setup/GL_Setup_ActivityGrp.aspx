<%@ Page Language="vb" src="../../../include/GL_Setup_ActivityGrp.aspx.vb" Inherits="GL_Setup_ActivityGrp" %>
<%@ Register TagPrefix="UserControl" Tagname="MenuGLSetup" src="../../menu/menu_GLsetup.ascx"%>
<%@ Register TagPrefix="Preference" Tagname="PrefHdl" src="../../include/preference/preference_handler.ascx"%>
<html>
	<head>
		<title>Activity Group List</title>
        <link href="../../include/css/gopalms.css" rel="stylesheet" type="text/css" />
	</head>
	<%--<Preference:PrefHdl id=PrefHdl runat="server" />--%>
		<body>
		    <form id="ActivityGrp" runat="server" class="main-modul-bg-app-list-pu">
		...
		<table cellpadding="0" cellspacing="0" style="width: 100%">
			...
			<tr>
				...
				<div class="kontenlist">
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						...
						<tr>
							...
							<table cellpadding="4" cellspacing="0" style="width: 100%">
								...
								<td width="20%" height="26"><asp:label id="lblActGrpCode" runat="server"/><br><asp:TextBox id="srchActGrpCd" width="100%" maxlength="8" runat="server"/></td>
					...
					<Columns>					
					<asp:TemplateColumn SortExpression="Act.ActGrpCode">
						<ItemTemplate>
							<%# Container.DataItem("ActGrpCode") %>
						</ItemTemplate>
						<EditItemTemplate>
							<asp:TextBox id="ActGrpCode" MaxLength="8" width="100%"
									Text='<%# trim(Container.DataItem("ActGrpCode")) %>'
									runat="server"/>
							<asp:RequiredFieldValidator id=validateCode display=dynamic runat=server 
									ErrorMessage="Please Enter Activity Group Code"
									ControlToValidate="ActGrpCode" />
					...
					<asp:TemplateColumn SortExpression="Act.Description">
						<ItemTemplate>
					...
					<asp:TemplateColumn HeaderText="Last Update" ItemStyle-Width="10%" SortExpression="Act.UpdateDate">
						<ItemTemplate>
					...
					<asp:TemplateColumn HeaderText="Status" ItemStyle-Width="5%" SortExpression="Act.Status">
						<ItemTemplate>
							<%# objGLSetup.mtdGetActGrpStatus(Container.DataItem("Status")) %>
						</ItemTemplate>
						<EditItemTemplate>
					...
					<asp:TemplateColumn ItemStyle-Width="10%" ItemStyle-HorizontalAlign=center>					
						...
						<tr>
							<td>
					            <asp:ImageButton id=ibNew OnClick="DEDR_Add" imageurl="../../images/butt_new.gif" AlternateText="New Activity Group" runat="server"/>
