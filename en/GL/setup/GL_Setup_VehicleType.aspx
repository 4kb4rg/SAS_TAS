<%@ Page Language="vb" src="../../../include/GL_Setup_VehicleType.aspx.vb" Inherits="GL_Setup_VehicleType" %>
		...
		<body>
			...
			<tr>
				...
				<div class="kontenlist">
					...
					<Columns>					
					<asp:TemplateColumn ItemStyle-Width="15%" SortExpression="veh.VehTypeCode">
						<ItemTemplate>
							<%# Container.DataItem("VehTypeCode") %>
						</ItemTemplate>
						<EditItemTemplate>
							<asp:TextBox id="VehTypeCode" MaxLength="8" width="100%"
								Text='<%# trim(Container.DataItem("VehTypeCode")) %>'
								runat="server"/>
							<asp:RequiredFieldValidator id=validateCode display=dynamic runat=server 
								ControlToValidate="VehTypeCode" />
					...
					<asp:TemplateColumn ItemStyle-Width="30%" SortExpression="veh.Description">
						<ItemTemplate>
					...
					<asp:TemplateColumn HeaderText="Last Update" ItemStyle-Width="15%" SortExpression="veh.UpdateDate">
						<ItemTemplate>
					...
					<asp:TemplateColumn HeaderText="Workshop" >
						<ItemStyle Width="10%" />
						<ItemTemplate>
							<asp:CheckBox id="IsPowerSupply1" Checked= <%#Container.DataItem("IsPowerSupply")%>  runat="server" Enabled ="false"/>
						</ItemTemplate>
						<EditItemTemplate>
							<asp:CheckBox id="IsPowerSupply" Checked= <%#Container.DataItem("IsPowerSupply")%>   runat="server" />
						</EditItemTemplate>
					</asp:TemplateColumn>
