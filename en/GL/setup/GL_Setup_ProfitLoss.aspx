<%@ Page Language="vb" src="../../../include/GL_Setup_ProfitLoss.aspx.vb" Inherits="GL_Setup_ProfitLoss" %>
<%@ Register TagPrefix="UserControl" Tagname="MenuGLSetup" src="../../menu/menu_GLsetup.ascx"%>
<%@ Register TagPrefix="Preference" Tagname="PrefHdl" src="../../include/preference/preference_handler.ascx"%>
<html>
	<head>
		<title>Profit and Loss Statement Template</title>
			...
			<tr>
				...
				<div class="kontenlist">
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						<tr>
							<td><strong>PROFIT AND LOSS TEMPLATE</strong><hr style="width :100%" />   
                            </td>
					...
					<asp:TemplateColumn>
				        ...
				        <tr>
					        <td><b><asp:label id=lblErrCalc runat=server /></b></td>
				        </tr>
                        <tr>
                            <td>
 					            &nbsp;</td>
