<%@ Page Language="vb" src="../../../include/GL_Setup_SubBlock.aspx.vb" Inherits="GL_Setup_SubBlock" %>
<%@ Register TagPrefix="UserControl" Tagname="MenuGLSetup" src="../../menu/menu_glsetup.ascx"%>
<%@ Register TagPrefix="Preference" Tagname="PrefHdl" src="../../include/preference/preference_handler.ascx"%>
<html>
	<head>
		<title>Sub Block List</title>
						...
						<tr>
							...
							<table cellpadding="4" cellspacing="0" style="width: 100%">
								...
								<td width="20%" height="26"><asp:label id="lblSubBlkCode" runat="server" /> :<BR>
									<asp:TextBox id=srchSubBlockCode width=100% maxlength="8" CssClass="fontObject" runat="server" />
								</td>
...
<AlternatingItemStyle CssClass="mr-r"/>
							...
							<Columns>
								<asp:HyperLinkColumn ItemStyle-Width="15%"
									SortExpression="sub.SubBlkCode" 
									DataNavigateUrlField="SubBlkCode" 
									DataNavigateUrlFormatString="GL_Setup_SubBlockDet.aspx?tbcode={0}" 
								...
								<asp:TemplateColumn HeaderText="Last Update" ItemStyle-Width="10%" SortExpression="sub.UpdateDate">
									<ItemTemplate>
										<%# objGlobal.GetLongDate(Container.DataItem("UpdateDate")) %>
									</ItemTemplate>
								</asp:TemplateColumn>
									
								<asp:TemplateColumn HeaderText="Status" ItemStyle-Width="10%" SortExpression="sub.Status">
									<ItemTemplate>
										<%# objGLSetup.mtdGetSubBlockStatus(Container.DataItem("Status")) %>
									</ItemTemplate>
								</asp:TemplateColumn>
								...
								<asp:TemplateColumn ItemStyle-Width="15%" ItemStyle-HorizontalAlign=center>
									<ItemTemplate>
										<asp:Label id=lblLnId Visible=False text=<%# Container.DataItem("SubBlkCode")%> Runat="server" />
