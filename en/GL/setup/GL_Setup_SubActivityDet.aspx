<%@ Page Language="vb" trace="false" src="../../../include/GL_Setup_SubActivityDet.aspx.vb" Inherits="GL_Setup_SubActivityDet" %>
...
<html>
	...
	<body>
		...
		<Form id=frmSubActDet  class="main-modul-bg-app-list-pu" runat="server">
			...
			<Input Type=Hidden id=hidActCode runat=server />
			<table border=0 cellspacing=0 cellpadding=2 width=100% class="font9Tahoma">
				...
				<tr>
					<td width=20% height=25><asp:label id="lblSubActCode" runat="server" /> :* </td>
					<td width=30%>
						<asp:Textbox id=txtSubActCode width=50% onTextChanged="ActCodeBySubAct" autopostback=true runat=server/>
						<asp:RequiredFieldValidator id=validateCode display=Dynamic runat=server 
								ControlToValidate=txtSubActCode />
				...
				<tr>
					<td height=25><asp:label id="lblSubActDesc" runat="server" /> :*</td>
				...
				<tr>
					<td height=25><asp:label id="lblActivity" runat="server" /> : </td>
					<td><asp:DropDownList id=ddlActCode width=100% runat=server/></td>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
