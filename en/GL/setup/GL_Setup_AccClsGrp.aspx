<%@ Page Language="vb" src="../../../include/GL_Setup_AccClsGrp.aspx.vb" Inherits="GL_Setup_AccClsGrp" %>
<%@ Register TagPrefix="UserControl" Tagname="MenuGLSetup" src="../../menu/menu_GLsetup.ascx"%>
<%@ Register TagPrefix="Preference" Tagname="PrefHdl" src="../../include/preference/preference_handler.ascx"%>
<html>
	<head>
		<title>Account Class Group List</title>
        <link href="../../include/css/gopalms.css" rel="stylesheet" type="text/css" />
	</head>
	<%--<Preference:PrefHdl id=PrefHdl runat="server" />--%>
		<body>
		    <form id="AccClsGrp" runat="server" class="main-modul-bg-app-list-pu">
		...
		<table cellpadding="0" cellspacing="0" style="width: 100%">
			...
			<tr>
				...
				<div class="kontenlist">
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						...
						<tr>
							...
							<table cellpadding="4" cellspacing="0" style="width: 100%">
								...
								<td width="20%" height="26"><asp:label id="lblAccClsGrpCode" runat="server"/> :<br><asp:TextBox id="srchAccClsGrpCd" width="100%" maxlength="8" runat="server"/></td>
					...
					<Columns>					
					<asp:TemplateColumn ItemStyle-Width="21%" SortExpression="Acc.AccClsGrpCode">
						<ItemTemplate>
							<%# Container.DataItem("AccClsGrpCode") %>
						</ItemTemplate>
						<EditItemTemplate>
							<asp:TextBox id="AccClsGrpCode" MaxLength="8" width="100%"
								Text='<%# trim(Container.DataItem("AccClsGrpCode")) %>'
								runat="server"/>
							<asp:RequiredFieldValidator id=validateCode display=dynamic runat=server 
								ControlToValidate="AccClsGrpCode" />															
					...
					<asp:TemplateColumn HeaderText="Status" SortExpression="Acc.Status">
						<ItemTemplate>
							<%# objGLSetup.mtdGetAccClsGrpStatus(Container.DataItem("Status")) %>
						</ItemTemplate>
						<EditItemTemplate>
