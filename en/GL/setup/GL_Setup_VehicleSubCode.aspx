<%@ Page Language="vb" src="../../../include/GL_Setup_VehicleSubCode.aspx.vb" Inherits="GL_Setup_VehicleSubCode" %>
<%@ Register TagPrefix="UserControl" Tagname="MenuGLSetup" src="../../menu/menu_glsetup.ascx"%>
<%@ Register TagPrefix="Preference" Tagname="PrefHdl" src="../../include/preference/preference_handler.ascx"%>
<html>
	<head>
		<title>Vehicle Expense Code</title>
        <link href="../../include/css/gopalms.css" rel="stylesheet" type="text/css" />
		<%--<Preference:PrefHdl id=PrefHdl runat="server" />--%>
	</head>
	<body>
		<form id=frmVehSubCode runat="server"  class="main-modul-bg-app-list-pu">
					...
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						...
						<tr>
							...
							<table cellpadding="4" cellspacing="0" style="width: 100%">
								...
								<td width="20%" height="26"><asp:label id="lblVehExpCode" runat="server" /> :<BR>
									<asp:TextBox id=srchVehExpCode width=100% maxlength="8" runat="server" />
								</td>
							...
							<Columns>
								<asp:HyperLinkColumn ItemStyle-Width="15%"
									SortExpression="veh.VehExpenseCode" 
									DataNavigateUrlField="VehExpenseCode" 
									DataNavigateUrlFormatString="GL_Setup_VehicleSubCodeDet.aspx?tbcode={0}" 
									DataTextField="VehExpenseCode" />
									
								<asp:HyperLinkColumn ItemStyle-Width="35%" 
									SortExpression="veh.Description" 
									DataNavigateUrlField="VehExpenseCode" 
									DataNavigateUrlFormatString="GL_Setup_VehicleSubCodeDet.aspx?tbcode={0}" 
									DataTextField="Description" />
								
								<asp:TemplateColumn HeaderText="Last Update" ItemStyle-Width="10%" SortExpression="veh.UpdateDate">
									<ItemTemplate>
										<asp:Label id=lblMyVehExpCode visible=false text='<%# Container.DataItem("VehExpenseCode") %>' runat=server/>
										<%# objGlobal.GetLongDate(Container.DataItem("UpdateDate")) %>
									</ItemTemplate>
								</asp:TemplateColumn>
									
								<asp:TemplateColumn HeaderText="Status" ItemStyle-Width="10%" SortExpression="veh.Status">
									<ItemTemplate>
										<%# objGLSetup.mtdGetVehicleExpenseStatus(Container.DataItem("Status")) %>
									</ItemTemplate>
								</asp:TemplateColumn>
						...
						<tr>
							<td>
					            <asp:ImageButton id=NewTBBtn onClick=NewTBBtn_Click imageurl="../../images/butt_new.gif" AlternateText="New Vehicle Expense Code" runat="server"/>
						...
						<asp:Label id=lblVehExpGrpCode Visible=False Runat="server" />
							</td>
						</tr>
                        <tr>
                            <td>
