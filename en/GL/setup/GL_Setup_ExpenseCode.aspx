<%@ Page Language="vb" src="../../../include/GL_Setup_ExpenseCode.aspx.vb" Inherits="GL_Setup_ExpenseCode" %>
<%@ Register TagPrefix="UserControl" Tagname="MenuGLSetup" src="../../menu/menu_GLsetup.ascx"%>
<%@ Register TagPrefix="Preference" Tagname="PrefHdl" src="../../include/preference/preference_handler.ascx"%>
<html>
	<head>
		<title>Expense Code List</title>
        <link href="../../include/css/gopalms.css" rel="stylesheet" type="text/css" />
	</head>
	<%--<Preference:PrefHdl id=PrefHdl runat="server" />--%>
		<body>
		    <form id="Expense" runat="server" class="main-modul-bg-app-list-pu">
		...
		<table cellpadding="0" cellspacing="0" style="width: 100%">
			...
			<tr>
				...
				<div class="kontenlist">
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						...
						<tr>
							...
							<table cellpadding="4" cellspacing="0" style="width: 100%">
								...
								<td width="20%" height="26"><asp:label id="lblExpenseCode" runat="server"/> :<br><asp:TextBox id="srchExpCode" width="100%" runat="server"/></td>
					...
					<Columns>					
					<asp:TemplateColumn SortExpression="Expense.ExpenseCode">
						<ItemTemplate>
							<%# Container.DataItem("ExpenseCode") %>
						</ItemTemplate>
						<EditItemTemplate>
							<asp:TextBox id="ExpenseCode" MaxLength="8" width="100%"
									Text='<%# trim(Container.DataItem("ExpenseCode")) %>'
									runat="server"/>
							<asp:RequiredFieldValidator id=validateCode display=dynamic runat=server 
									ControlToValidate="ExpenseCode" />
					...
					<asp:TemplateColumn SortExpression="Expense.Description">
						<ItemTemplate>
					...
					<asp:TemplateColumn HeaderText="Last Update" ItemStyle-Width="10%" SortExpression="Expense.UpdateDate">
						<ItemTemplate>
					...
					<asp:TemplateColumn HeaderText="Status" ItemStyle-Width="5%" SortExpression="Expense.Status">
						<ItemTemplate>
							<%# objGLSetup.mtdGetExpCodeStatus(Container.DataItem("Status")) %>
						</ItemTemplate>
						<EditItemTemplate>
					...
					<asp:TemplateColumn ItemStyle-Width="10%" ItemStyle-HorizontalAlign=center>				
						...
						<tr>
							<td>
					            <asp:ImageButton id=ibNew OnClick="DEDR_Add" imageurl="../../images/butt_new.gif" AlternateText="New Expense Code" runat="server"/>
