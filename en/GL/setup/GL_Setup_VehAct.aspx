<%@ Page Language="vb" src="../../../include/GL_Setup_VehAct.aspx.vb" Inherits="GL_Setup_VehAct" %>
			...
			<tr>
				...
				<div class="kontenlist">
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
							    ...
							    <table cellpadding="4" cellspacing="1" style="width: 100%">
					                ...
					                <Columns>					
					                    <asp:HyperLinkColumn ItemStyle-Width="15%"
							                SortExpression="Acc.VehActCode" 
							                DataNavigateUrlField="VehActCode" 
							                DataNavigateUrlFormatString="GL_Setup_VehActDet.aspx?tbcode={0}" 
						...
						<tr>
							<td>
					            <asp:ImageButton id=ibNew OnClick="NewBtn_Click" imageurl="../../images/butt_new.gif" AlternateText="New Vehicle Expense Group" runat="server"/>
