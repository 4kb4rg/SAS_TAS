<%@ Page Language="vb" src="../../../include/GL_Setup_VehicleSubGrpCode.aspx.vb" Inherits="GL_Setup_VehicleSubGrpCode" %>
<%@ Register TagPrefix="UserControl" Tagname="MenuGLSetup" src="../../menu/menu_GLsetup.ascx"%>
<%@ Register TagPrefix="Preference" Tagname="PrefHdl" src="../../include/preference/preference_handler.ascx"%>
<html>
	<head>
		<title>Vehicle Expense Group List</title>
		...
		<table cellpadding="0" cellspacing="0" style="width: 100%">
			...
			<tr>
				...
				<div class="kontenlist">
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						...
						<tr>
							...
							<table cellpadding="4" cellspacing="0" style="width: 100%">
								...
								<td width="20%" height="26"><asp:label id="lblVehExpGrpCode" runat="server"/> :<br><asp:TextBox id="srchVehExpGrpCd" width="100%" maxlength="8" runat="server"/></td>
					...
					<Columns>					
					<asp:TemplateColumn ItemStyle-Width="21%" SortExpression="Acc.VehExpGrpCode">
						<ItemTemplate>
							<%# Container.DataItem("VehExpGrpCode") %>
						</ItemTemplate>
						<EditItemTemplate>
							<asp:TextBox id="VehExpGrpCode" MaxLength="8" width="100%"
								Text='<%# trim(Container.DataItem("VehExpGrpCode")) %>'
								runat="server"/>
							<asp:RequiredFieldValidator id=validateCode display=dynamic runat=server 
								ControlToValidate="VehExpGrpCode" />															
