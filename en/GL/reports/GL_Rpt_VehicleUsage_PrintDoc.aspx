<%@ Page Language="vb" Src="../../../include/GL_Rpt_VehicleUsage_PrintDoc.aspx.vb" Inherits="GL_Rpt_VehicleUsage_PrintDoc"%>
...
<html>
	<head>
		<title>Vehicle Daily Activity</title>
	</head>
	<body>
		<form id=frmReport method=post runat=server>
			...
			<asp:DataGrid id=dgResult Visible=true runat=server/>
		</form>
