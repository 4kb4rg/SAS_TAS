<%@ Page Language="vb" Trace="False" src="../../../include/GL_Trx_VehicleUsage_List.aspx.vb" Inherits="GL_VehicleUsage_List" %>
						...
						<tr>
							...
							<table cellpadding="4" cellspacing="0" style="width: 100%">
								<tr class="font9Tahoma">
									...
									<asp:TextBox id=srchVehUsageID width=100% maxlength="32" runat="server"/>
								</td>
							    ...
							    <table cellpadding="4" cellspacing="1" style="width: 100%">
					                ...
					                <Columns>
						                <asp:HyperLinkColumn
								                ...
								                DataNavigateUrlFormatString="GL_Trx_VehicleUsage_Details.aspx?id={0}"
