<%@ Page Language="vb" src="../../../include/GL_trx_PDOList.aspx.vb" Inherits="GL_trx_PDOList" %>
<%@ Register TagPrefix="UserControl" Tagname="MenuGLTrx" src="../../menu/menu_GLTrx.ascx"%>
<%@ Register TagPrefix="Preference" Tagname="PrefHdl" src="../../include/preference/preference_handler.ascx"%>
<html>
	<head>
		<title>PERMINTAAN DROPPING DANA</title>
		...
		<body>
			...
			<table cellpadding="0" cellspacing="0" style="width: 100%">
				...
				<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						<tr>
							<td><strong>Permintaan Dropping Dana LIST</strong><hr style="width :100%" />   
                             </td>                            
						</tr>
					    <tr>
						...
						<tr>
								...
								<Columns>
									...
									<asp:TemplateColumn HeaderText="Ref. Date">
										<ItemTemplate>
											<%# objGlobal.GetLongDate(Container.DataItem("PDODate")) %>
										</ItemTemplate>
									</asp:TemplateColumn>
