<%@ Page Language="vb" trace=false src="../../../include/GL_trx_BudgetProd_Estate_list.aspx.vb" Inherits="GL_trx_BudgetProd_Estate_list" %>
			...
			<tr>
				...
				<div class="kontenlist">
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						<tr>
							<td><strong>BUDGET PRODUKSI ESTATE LIST</strong><hr style="width :100%" />   
                            </td>
						...
						<tr>
							...
							<table cellpadding="4" cellspacing="0" style="width: 100%">
								...
								<td width="14%" height="26">Periode :<BR><asp:TextBox id=srchAccYear width=100% maxlength="20" runat="server" /></td>
								<td width="14%" height="26">
                                    Tahun Tanam :<BR><asp:TextBox id=txtGroupCoa width=100% maxlength="20" runat="server" /></td>
								<td width="14%">
                                    <br />
						...
						<asp:DataGrid id="dgList"
							...
							<asp:TemplateColumn HeaderText="Tahun Tanam" >
									<ItemTemplate>
									<asp:Label ID=lblGroupCoa Text='<%#Container.DataItem("GroupCoa")%>' runat=server/>	
									</ItemTemplate>
							</asp:TemplateColumn>							
						
								<asp:TemplateColumn HeaderText="Komoditi" >
									<ItemTemplate>
										<%#Container.DataItem("Komoditi")%>
									</ItemTemplate>
								</asp:TemplateColumn>
