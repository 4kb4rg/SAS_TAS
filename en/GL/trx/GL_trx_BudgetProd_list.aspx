<%@ Page Language="vb" trace=false src="../../../include/GL_trx_BudgetProd_list.aspx.vb" Inherits="GL_trx_BudgetProd_list" %>
			...
			<tr>
				...
				<div class="kontenlist">
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						<tr>
							<td><strong>BUDGET PRODUKSI LIST</strong><hr style="width :100%" />   
                            </td>
						...
						<asp:DataGrid id="dgList"
							...
							<Columns>
								...
								<asp:HyperLinkColumn HeaderText="Acc Year" 
									...
									DataNavigateUrlField="AccYear" 
									DataNavigateUrlFormatString="GL_trx_BudgetProd_Det.aspx?AccYear={0}" 
								...
								<asp:TemplateColumn HeaderText="Created By" SortExpression="UpdateID ">
									<ItemTemplate>
