<%@ Page Language="vb" trace="False" src="../../../include/GL_Trx_Workshop_Details.aspx.vb" Inherits="GL_Workshop_Details" %>
...
<html>
	...
	<body>
		...
		<table border=0 width="100%" cellspacing="0" cellpadding="1" class="font9Tahoma">
			...
			<tr>
				<td height=25><asp:label id=lblChargeLocCodeTag runat=server /> Kerja :*</td>
				<td><asp:DropDownList id=ddlChargeLocCode width="100%" Enabled=false CssClass="fontObject" runat=server  />
						<asp:Label id=lblChargeLocCodeErr forecolor=red visible=false runat=server  /></td>
				<td>&nbsp;</td>
				<td>&nbsp;</td>
				<td>&nbsp;</td>	
				<td>&nbsp;</td>
				...
				<td colspan="6" style="height: 400px">
					<table id="tblAdd" border="0" width="100%" cellspacing="0" cellpadding="4" runat="server" class="sub-add">
                        ...
                        <tr class="mb-c">
                            ...
                            <td style="height: 39px">
                                <GG:AutoCompleteDropDownList id="lstChargeLevel" Width="100%" AutoPostBack=True OnSelectedIndexChanged=lstChargeLevel_OnSelectedIndexChanged runat=server CssClass="font9Tahoma"/><asp:label id=lblChargeMsg Text ="Please Select Charge Level" forecolor=Red Visible=False Runat="server"/></td>
                            <td style="height: 39px">
                            </td>
                            <td style="height: 39px">
                            </td>
                        ...
                        <tr class="mb-c">
                            ...
                            <td>
                            <asp:DropDownList id="lstPreBlock" Width="100%"  runat=server  CssClass="font9Tahoma" /><br />
						...
						<tr class="mb-c" style="visibility: hidden;">
							<td>Productivity :</td>
							<td><asp:textbox id="txtWPUnit" Width=35% maxlength=15 EnableViewState=False Runat="server" CssClass="font9Tahoma"/>
								<asp:RequiredFieldValidator 
									id="RequiredFieldValidator3" 
									runat="server" 
									EnableClientScript="True"
									ControlToValidate="txtWPUnit" 
									display="dynamic"/>
								...
								<asp:RangeValidator id="RangeValidator1"
                                    ...
                                    &nbsp;
									<asp:DropDownList id=ddlUOM width=25% runat=server /></td>
							<td>&nbsp;</td>
				            <td>&nbsp;</td>
				            <td>&nbsp;</td>
				            <td>&nbsp;</td>
                    ...
                    <asp:DataGrid ID="dgStkTx" runat="server" AllowSorting="True"                 
                        ...
                        <Columns>
							...
							<asp:TemplateColumn HeaderText="VehCode">
                                <ItemStyle Width="15%" />
                                <ItemTemplate>
                                    <asp:Label ID="lblvehCodedesc" runat="server" Text='<%# Container.DataItem("_VehDescription") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateColumn>
                            ...
                            <asp:TemplateColumn  headertext="Vehicle Usage &lt;br&gt;(Run Unit)" >
                                <HeaderStyle HorizontalAlign="Right" />
                                <ItemStyle HorizontalAlign="Right" Width="10%" />
                                <ItemTemplate>
                                    <asp:Label ID="UsageUnit" runat="server" Text='<%# ObjGlobal.GetIDDecimalSeparator_FreeDigit(Container.DataItem("UsageUnit"),2) %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateColumn>
                            <asp:TemplateColumn  headertext="Productivity" >
                                ...
                                <ItemTemplate>
                                    <asp:Label ID="WPUnit" runat="server" Text='<%# ObjGlobal.GetIDDecimalSeparator_FreeDigit(Container.DataItem("WPUnit"),2) %>'></asp:Label>
                                    <asp:Label ID="lblUOM" runat="server" Text='<%# Container.DataItem("UOM") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateColumn>
                            <asp:TemplateColumn>
                                ...
                                <ItemTemplate>
                                    ...
                                    <asp:Label ID="lblID" runat="server" Text='<%# Container.DataItem("VehUsageLnID") %>' Visible="False"></asp:Label>
                                    <asp:Label ID="lblvehCode" runat="server" Text='<%# Container.DataItem("VehActCode") %>' Visible="False"></asp:Label>
