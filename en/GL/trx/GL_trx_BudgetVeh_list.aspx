<%@ Page Language="vb" trace=false src="../../../include/GL_trx_BudgetVeh_list.aspx.vb" Inherits="GL_trx_BudgetVeh_list" %>
			...
			<tr>
				...
				<div class="kontenlist">
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						<tr>
							<td><strong>BUDGET KENDARAAN LIST</strong><hr style="width :100%" />   
                            </td>
						...
						<tr>
							...
							<table cellpadding="4" cellspacing="0" style="width: 100%">
								...
								<td width="14%">
                                    Nama Kendaraan:<asp:TextBox id="srchVehCode" width="100%" maxlength="8" runat="server" /></td>							
								<td width="14%">
                                    <br />
						...
						<HeaderStyle CssClass="mr-h" BackColor="#CCCCCC" Font-Bold="False" 
							...
							<Columns>
								<asp:HyperLinkColumn HeaderText="Acc Year" 
									...
									DataNavigateUrlFormatString="GL_trx_BudgetVeh_Details.aspx?Idx={0}" 
									DataTextField="AccYear" />
								<asp:TemplateColumn HeaderText="Nama Kendaraan" SortExpression="Description">
									<ItemTemplate>
								...
								<asp:TemplateColumn HeaderText="Create By" SortExpression="UpdateID">
									<ItemTemplate>
