	...
	<body >
        ...
        <td>
			...
			<tr>
				...
				<td><asp:Textbox id="txtDesc" Width=100% MaxLength=928 runat=server CssClass="fontObject"/>
				...
				<td colspan="6">
					<table id="tblAdd" border="0" width="100%" cellspacing="0" cellpadding="2" runat="server" class="sub-Add">
						<tr class="mb-c">
							...
							<td colspan=4><asp:TextBox id=txtDescLn Width=95% maxlength=1023 runat=server CssClass="fontObject"/>	
