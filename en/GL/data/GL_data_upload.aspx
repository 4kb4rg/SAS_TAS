<%@ Page Language="vb" src="../../../include/GL_data_upload.aspx.vb" Inherits="GL_data_upload" %>
...
<form id=frmUpload enctype="multipart/form-data" runat=server>
	<table border="0" cellspacing="0" width="100%">
		...
		<tr>
			<td colspan="2">General Ledger Reference Data</td>
		</tr>
		<tr>
			<td colspan="2">&nbsp;</td>
		</tr>
		...
		<tr>
			<td colspan="2">
				<table id=tblAfter border=0 width=100% runat=server>
					<tr>
						<td colspan="2">Your General Ledger reference file has been successfully uploaded.</td>
					</tr>
				</table>
			</td>
		</tr>
