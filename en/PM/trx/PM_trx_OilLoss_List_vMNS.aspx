<%@ Page Language="vb" Inherits="PM_oilLossList" src="../../../include/PM_trx_oilLoss_List.aspx.vb"%>
<%@ Register TagPrefix="UserControl" Tagname="MenuPDTrx" src="../../menu/menu_PDtrx.ascx"%>
<%@ Register TagPrefix="Preference" Tagname="PrefHdl" src="../../include/preference/preference_handler.ascx"%>
<HTML>
	<HEAD>
		<title>OIL LOSS TRANSACTION</title> 
			...
			<tr>
				...
				<div class="kontenlist">
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						<tr>
							<td><strong>OIL LOSS LIST</strong><hr style="width :100%" />   
                            </td>
						...
						<tr>
						    ...
						    <tr>
							    ...
							    <table cellpadding="4" cellspacing="1" style="width: 100%">
                                    <tr>
                                    <td>
						            <asp:DataGrid id="dgoilLossList" AutoGenerateColumns="False" width="100%" runat="server" GridLines="None"
							                ...
							                <Columns>
								                ...
								                <asp:TemplateColumn>
									                ...
									                <ItemTemplate>
										                <asp:Label id=lblTransId visible=false text='<%# Container.DataItem("OilLossId") %>' runat=server/>
