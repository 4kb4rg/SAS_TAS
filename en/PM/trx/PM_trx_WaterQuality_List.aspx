<%@ Page Language="vb" Inherits="PM_trx_WaterQuality_List" src="../../../include/PM_trx_WaterQuality_List.aspx.vb"%>
<%@ Register TagPrefix="UserControl" Tagname="MenuPDTrx" src="../../menu/menu_PDtrx.ascx"%>
<%@ Register TagPrefix="Preference" Tagname="PrefHdl" src="../../include/preference/preference_handler.ascx"%>
<HTML>
	<HEAD>
		<title>WATER QUALITY TRANSACTION</title> 
			...
			<tr>
				...
				<div class="kontenlist">
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						<tr>
							<td><strong>WATER QUALITY LIST</strong><hr style="width :100%" />   
                            </td>
						...
						<tr>
						    ...
						    <tr>
							    ...
							    <table cellpadding="4" cellspacing="1" style="width: 100%">
                                    <tr>
                                    <td>
						            <asp:DataGrid id="dgWaterList" AutoGenerateColumns="False" width="100%" runat="server" GridLines="None"
							                Cellpadding="2" AllowPaging="True" Pagesize="15" OnPageIndexChanged="OnPageChanged" Pagerstyle-Visible="False"
							                OnDeleteCommand="DEDR_Delete" OnEditCommand="DEDR_Edit" OnSortCommand="Sort_Grid" AllowSorting="True"
                                                        class="font9Tahoma">
							                ...
							                <Columns>
								                <asp:TemplateColumn SortExpression="OL.TransDate" HeaderText="Transaction Date">
								                ...
								                <asp:TemplateColumn SortExpression="OL.TestSampleCode" HeaderText="Test Sample">
									                <ItemStyle Width="26%"></ItemStyle>
									                <ItemTemplate>
										                <%#Container.DataItem("TestSampleDesc") %>
									                </ItemTemplate>
								                </asp:TemplateColumn>
								                <asp:TemplateColumn SortExpression="OL.StationCode" HeaderText="Station">
									                <ItemStyle Width="12%"></ItemStyle>
									                <ItemTemplate>
										                <%#Container.DataItem("StationCode") %>
									                </ItemTemplate>
								                </asp:TemplateColumn>
								
								                <asp:TemplateColumn SortExpression="OL.MachineCode" HeaderText="Machine">
									                <ItemStyle Width="12%"></ItemStyle>
									                <ItemTemplate>
								                ...
								                <asp:TemplateColumn SortExpression="OL.UpdateDate" HeaderText="Last Update">
									                <ItemStyle Width="12%"></ItemStyle>
									                <ItemTemplate>
										                <%# objGlobal.GetLongDate(Container.DataItem("UpdateDate")) %>
									                </ItemTemplate>
								                </asp:TemplateColumn>
								                <asp:TemplateColumn SortExpression="OL.Status" HeaderText="Status">
									                <ItemStyle Width="10%"></ItemStyle>
									                <ItemTemplate>
										                <%# objPMTrx.mtdGetDailyProdStatus(Container.DataItem("Status")) %>
									                </ItemTemplate>
								                </asp:TemplateColumn>
								                <asp:TemplateColumn SortExpression="OL.UpdateID" HeaderText="Updated By">
								                ...
								                <asp:TemplateColumn>
									                ...
									                <ItemTemplate>
										                <asp:Label id=lblTransId visible=false text='<%# Container.DataItem("WaterId") %>' runat=server/>
