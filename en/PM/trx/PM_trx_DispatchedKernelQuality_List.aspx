<%@ Page Language="vb" trace="false" codefile="../../../include/PM_trx_DispatchedKernelQuality_List.aspx.vb" Inherits="PM_DispatchedKernelQualityList" %>
			...
			<tr>
				...
				<div class="kontenlist">
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						<tr>
							<td><strong>DISPATCHED KERNEL QUALITY LIST</strong><hr style="width :100%" />   
                            </td>
						...
						<tr>
						    ...
						    <tr>
							    ...
							    <table cellpadding="4" cellspacing="1" style="width: 100%">
                                    <tr>
                                    <td>
						            <asp:DataGrid id=dgDispatchedKernelQualityList
							                ...
							                <Columns>
								                ...
								                <asp:TemplateColumn HeaderText="No.Kendaraan" >
									                <ItemTemplate>
