<%@ Page Language="vb" trace="false" src="../../../include/PM_trx_KernelLoss_List.aspx.vb" Inherits="PM_KernelLossList" %>
			...
			<tr>
				...
				<div class="kontenlist">
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						<tr>
							<td><strong>KERNEL LOSSES LIST</strong><hr style="width :100%" />   
                            </td>
						...
						<tr>
						    ...
						    <tr>
							    ...
							    <table cellpadding="4" cellspacing="1" style="width: 100%">
                                    <tr>
                                    <td>
						            <asp:DataGrid id=dgKernelLossesList
							                ...
							                <Columns>
								                <asp:TemplateColumn HeaderText="Transaction Date" SortExpression="TransDate" >
									                <ItemTemplate>										
										                <asp:LinkButton id="Edit" CommandName="Edit" Text='<%# objGlobal.GetLongDate(Container.DataItem("TransDate")) %>' runat="server"/>
									                </ItemTemplate>
								                </asp:TemplateColumn>
								
								                <asp:TemplateColumn HeaderText="Processing Line No." SortExpression="ProcessLnNo">
									                <ItemTemplate>
										                <%# Container.DataItem("ProcessLnNo") %>
									                </ItemTemplate>
								                </asp:TemplateColumn>
								                ...
								                <asp:TemplateColumn ItemStyle-HorizontalAlign=Center>
									                <ItemTemplate>
										                ...
										                <asp:Label id=lblProcessingLnNo visible=false text='<%# Container.DataItem("ProcessLnNo") %>' runat=server/>										
