<%@ Page Language="vb" trace="false" codefile="../../../include/PM_trx_OilLoss_List.aspx.vb" Inherits="PM_OilLossList" %>
			...
			<tr>
				...
				<div class="kontenlist">
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						<tr>
							<td><strong>OIL LOSSES LIST</strong><hr style="width :100%" />   
                            </td>
						...
						<tr>
							...
							<table cellpadding="4" cellspacing="0" style="width: 100%">
								...
								<td wdith="45%">&nbsp;</td>								
								<!--<td width="10%">&nbsp;<BR><asp:DropDownList id="srchStatusList1" visible="false" width=100% runat=server /></td>-->
								<!--<td width="15%"><BR><asp:DropDownList id="srchStatusList" visible="false" width=100% runat=server /></td>-->
						    ...
						    <tr>
							    ...
							    <table cellpadding="4" cellspacing="1" style="width: 100%">
						            ...
						            <asp:DataGrid id=dgOilLossList
							            ...
							            <Columns>
								            <asp:TemplateColumn HeaderText="Transaction Date" SortExpression="DateProd" >
									            <ItemTemplate>										
										            <asp:LinkButton id="Edit" CommandName="Edit" Text='<%# objGlobal.GetLongDate(Container.DataItem("DateProd")) %>' runat="server"/>
									            </ItemTemplate>
								            </asp:TemplateColumn>
																			
 								            <asp:TemplateColumn HeaderText="OIL Losses"  >
									            <ItemTemplate>
										            <%# Container.DataItem("OILLosses")%>
									            </ItemTemplate>
								            </asp:TemplateColumn>

								            <asp:TemplateColumn HeaderText="Kernel Losses"  >
									            <ItemTemplate>
										            <%# Container.DataItem("KerLosses")%>
									            </ItemTemplate>
								            </asp:TemplateColumn>
