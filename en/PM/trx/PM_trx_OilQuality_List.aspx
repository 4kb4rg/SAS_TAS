<%@ Page Language="vb" trace="false" src="../../../include/PM_trx_OilQuality_List.aspx.vb" Inherits="PM_OilQualityList" %>
			...
			<tr>
				...
				<div class="kontenlist">
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						<tr>
							<td><strong>OIL QUALITY LIST</strong><hr style="width :100%" />   
                            </td>
						...
						<tr>
						    ...
						    <tr>
							    ...
							    <table cellpadding="4" cellspacing="1" style="width: 100%">
                                    <tr>
                                    <td>
						            <asp:DataGrid id=dgOilQualityList
