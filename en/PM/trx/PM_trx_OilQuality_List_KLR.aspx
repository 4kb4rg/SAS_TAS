<%@ Page Language="vb" trace="false" codefile="../../../include/PM_trx_OilQuality_List_KLR.aspx.vb" Inherits="PM_trx_OilQuality_List_KLR" %>
					...
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						...
						<tr>
							...
							<table cellpadding="4" cellspacing="0" style="width: 100%">
								...
								<td width="10%" height="26" valign=bottom align=right><asp:Button id=SearchBtn Text="Search" OnClick=srchBtn_Click runat="server" CssClass="button-small"/></td>
								</tr>
							</table>
							    ...
							    <table cellpadding="4" cellspacing="1" style="width: 100%">
						            ...
						            <asp:DataGrid id=dgList
							            ...
							            <Columns>
								            ...
								            <asp:TemplateColumn HeaderText="Storage Code"  >
									            <ItemTemplate>
										            <%# Container.DataItem("TankiCode")%>
									            </ItemTemplate>
								            </asp:TemplateColumn>

								            <asp:TemplateColumn HeaderText="Storage Name"  >
									            <ItemTemplate>
										            <%# Container.DataItem("TankiName")%>
									            </ItemTemplate>
								            </asp:TemplateColumn>
			                                ...
			                                <asp:TemplateColumn HeaderText="FFA ( %)"  >
			                                    ...
			                                    <asp:TemplateColumn HeaderText="Dobi (%)"  >
									            <ItemTemplate>
