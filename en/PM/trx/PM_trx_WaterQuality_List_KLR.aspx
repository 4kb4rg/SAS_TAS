<%@ Page Language="vb" trace="false" src="../../../include/PM_trx_WaterQuality_List_KLR.aspx.vb" Inherits="PM_trx_WaterQuality_List_KLR" %>
						            ...
						            <asp:DataGrid id=dgList
							                ...
							                <Columns>
								                ...
								                <asp:TemplateColumn HeaderText="Status" SortExpression="Status">
									                <ItemTemplate>
										                <%# objPMTrx.mtdGetWaterQualityStatus(Container.DataItem("Status"))%>
									                </ItemTemplate>
								                </asp:TemplateColumn>
