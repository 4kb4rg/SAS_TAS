<%@ Page Language="vb" trace="false" src="../../../include/PM_Setup_StorageAreaMaster.aspx.vb" Inherits="PM_Setup_StorageAreaMaster" %>
<%@ Register TagPrefix="UserControl" Tagname="MenuPDSetup" src="../../menu/menu_PDSetup.ascx"%>
<%@ Register TagPrefix="Preference" Tagname="PrefHdl" src="../../include/preference/preference_handler.ascx"%>

<html>
	<head>
		<title>STORAGE AREA MASTER LIST</title>
        <link href="../../include/css/gopalms.css" rel="stylesheet" type="text/css" />
<%--		<Preference:PrefHdl id=PrefHdl runat="server" />--%>
	</head>
	<body>
	    <form id=frmPMSList runat=server class="main-modul-bg-app-list-pu">
			...
			<tr>
				...
				<div class="kontenlist">
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						<tr>
							<td><strong>STORAGE AREA MASTER LIST</strong><hr style="width :100%" />   
                            </td>
						...
						<tr>
							...
							<table cellpadding="4" cellspacing="0" style="width: 100%">
								...
								<td width="30%">Storage Area Code :<BR><asp:TextBox id="srchStorageAreaCode" maxlength=8 width=100% runat=server /></td>
								<td width="25%">Storage Type :<BR><asp:TextBox id="srchStorageType" width=100% maxlength=8 runat=server /></td>
						    ...
						    <tr>
							    ...
							    <table cellpadding="4" cellspacing="1" style="width: 100%">
						            ...
						            <asp:DataGrid id=EventData
							            ...
							            <Columns>
								            <asp:HyperLinkColumn HeaderText="Storage Area Code" 
									            SortExpression="StorageAreaCode" 
									            DataNavigateUrlField="StorageAreaCode" 
									            DataNavigateUrlFormatString="PM_Setup_StorageAreaMaster_Det.aspx?StorageAreaCode={0}" 
									            DataTextField="StorageAreaCode" 
									            ItemStyle-Width= "20%" /> 
								
								            <asp:HyperLinkColumn HeaderText="Storage Type" 
								            ...
								            <asp:TemplateColumn HeaderText="Status" SortExpression="ST.Status">
									            <ItemStyle Width="12%" />
									            <ItemTemplate>
										            <%# objPM.mtdGetStorageTypeStatus(Container.DataItem("Status")) %>
									            </ItemTemplate>
								            </asp:TemplateColumn>
