<%@ Page Language="vb" src="../../../include/PM_Setup_MachineMaster.aspx.vb" Inherits="PM_Setup_MachineMaster" %>
					...
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						...
						<tr>
							...
							<table cellpadding="4" cellspacing="0" style="width: 100%">
								...
								<td width="15%"><asp:label id="lblMachineCode" runat="server" /> :<BR><asp:TextBox id=srchMachineCode width=100% maxlength="8" runat="server"/></td>
								<td width="35%"><asp:label id="lblDescription" runat="server" /> :<BR><asp:TextBox id=srchDescription width=100% maxlength="128" runat="server"/></td>
								<!-- CR_THG00009 START -->
								<td width="10%">Processing Line :<BR><asp:TextBox id=txtProcessLine width=100% maxlength="3" runat="server"/></td>
								<!-- CR_THG00009 END -->
								...
								<td width="5%" height="26" valign=bottom align=right><asp:Button ID="Button1" Text="Search" OnClick=srchBtn_Click runat="server" class="button-small"/></td>
								</tr>
							</table>
						    ...
						    <tr>
							    ...
							    <table cellpadding="4" cellspacing="1" style="width: 100%">
					                ...
					                <Columns>					
					                <asp:TemplateColumn SortExpression="MachineCode">
						                <ItemStyle Width="15%" />
						                <ItemTemplate>
							                <%# Container.DataItem("MachineCode") %>
						                </ItemTemplate>
						                <EditItemTemplate>
							                <asp:TextBox id="txtMachineCode" MaxLength="8" width=95%
									                Text='<%# trim(Container.DataItem("MachineCode")) %>'
									                runat="server"/>
							                <BR>
							                <asp:RequiredFieldValidator id=validateMachineCode display=dynamic runat=server 
									                ControlToValidate=txtMachineCode />
							                <asp:RegularExpressionValidator id=revMachineCode 
								                ControlToValidate="txtMachineCode"
					                ...
					                <asp:TemplateColumn HeaderText="Processing Line" SortExpression="ProcessingLnNo">
						                <ItemStyle Width="10%" />
						                <ItemTemplate>
							                <%# Container.DataItem("ProcessingLnNo") %>
						                </ItemTemplate>
						                <EditItemTemplate>
							                <asp:DropDownList id="ddlProcessingLine" width=100% runat="server"/>
						                </EditItemTemplate>
					                </asp:TemplateColumn>
					                ...
					                <asp:TemplateColumn HeaderText="Status" SortExpression="M.Status">
						                <ItemStyle Width="10%" />
						                <ItemTemplate>
							                <%# objPM.mtdGetMachineStatus(Container.DataItem("Status")) %>
						                </ItemTemplate>
						                <EditItemTemplate>
