<%@ Page Language="vb" src="../../../include/PM_Setup_TestSample.aspx.vb" Inherits="PM_Setup_TestSample" %>
<%@ Register TagPrefix="UserControl" Tagname="MenuPDSetup" src="../../menu/menu_PDSetup.ascx"%>
<%@ Register TagPrefix="Preference" Tagname="PrefHdl" src="../../include/preference/preference_handler.ascx"%>
<html>
	<head>
		<title>Test Sample List</title>
			...
			<tr>
				...
				<div class="kontenlist">
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						<tr>
							<td><strong>TEST SAMPLE LIST</strong><hr style="width :100%" />   
                            </td>
						...
						<tr>
							...
							<table cellpadding="4" cellspacing="0" style="width: 100%">
								...
								<td width="15%">Test Sample Code :<BR><asp:TextBox id=srchTestSampleCode width=100% maxlength="8" runat="server"/></td>
								<td width="35%">Description :<BR><asp:TextBox id=srchDescription width=100% maxlength="128" runat="server"/></td>
						    ...
						    <tr>
							    ...
							    <table cellpadding="4" cellspacing="1" style="width: 100%">
					                ...
					                <Columns>					
					                <asp:TemplateColumn SortExpression="TestSampleCode">
						                <ItemStyle Width="15%" />
						                <ItemTemplate>
							                <%# Container.DataItem("TestSampleCode") %>
						                </ItemTemplate>
						                <EditItemTemplate>
							                <asp:TextBox id="txtTestSampleCode" MaxLength="8" width=95%
									                Text='<%# trim(Container.DataItem("TestSampleCode")) %>'
									                runat="server"/>
							                <BR>
							                <asp:RequiredFieldValidator id=validateTestSampleCode display=dynamic runat=server 
									                ControlToValidate=txtTestSampleCode />
							                <asp:RegularExpressionValidator id=revTestSampleCode 
								                ControlToValidate="txtTestSampleCode"
