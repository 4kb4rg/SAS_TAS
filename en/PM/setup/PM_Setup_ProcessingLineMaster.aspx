<%@ Page Language="vb" src="../../../include/PM_Setup_ProcessingLineMaster.aspx.vb" Inherits="PM_Setup_ProcessingLineMaster" %>
<%@ Register TagPrefix="UserControl" Tagname="MenuPDSetup" src="../../menu/menu_PDSetup.ascx"%>
<%@ Register TagPrefix="Preference" Tagname="PrefHdl" src="../../include/preference/preference_handler.ascx"%>
<html>
	<head>
		<title>Processing Line Master</title>
					...
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						...
						<tr>
							...
							<table cellpadding="4" cellspacing="0" style="width: 100%">
								...
								<td width="20%">
									<asp:label id="lblProcessingLineNo" runat="server" /> :<BR>
									<asp:TextBox id=srchProcessingLineNo width=100% maxlength="3" runat="server"/>
									<asp:RegularExpressionValidator id=revsrchProcessingLineNo
										ControlToValidate="srchProcessingLineNo"
										ValidationExpression="\d{1,3}"
										Display="Dynamic"
										text="Maximum length 3 digits only."
										runat="server"/>
								</td>
								<td width="35%">&nbsp;</td>
						    ...
						    <tr>
							    ...
							    <table cellpadding="4" cellspacing="1" style="width: 100%">
					                ...
					                <Columns>					
					                <asp:TemplateColumn SortExpression="ProcessingLnNo">
						                <ItemStyle Width="25%" />
						                <ItemTemplate>
							                <%# Container.DataItem("ProcessingLnNo") %>
						                </ItemTemplate>
						                <EditItemTemplate>
							                <asp:TextBox id="txtProcessingLineNo" MaxLength="3" width=95%
									                Text='<%# trim(Container.DataItem("ProcessingLnNo")) %>'
									                runat="server"/>
							                <BR>
							                <asp:RequiredFieldValidator id=validateProcessingLineNo display=dynamic runat=server 
									                ControlToValidate=txtProcessingLineNo />
							                <asp:RegularExpressionValidator id=revProcessingLineNo 
								                ControlToValidate="txtProcessingLineNo"
								                ValidationExpression="\d{1,3}"
								                Display="Dynamic"
								                text="Maximum length 3 digits only."
								                runat="server"/>
							                <asp:label id="lblDupMsg"  Text="Line No already exist" Visible = false forecolor=red Runat="server"/>
						                </EditItemTemplate>
					                </asp:TemplateColumn>	
					                <asp:TemplateColumn HeaderText="Last Update" SortExpression="PL.UpdateDate">
						                <ItemStyle Width="20%" />
						                <ItemTemplate>
					                ...
					                <asp:TemplateColumn HeaderText="Status" SortExpression="PL.Status">
						                <ItemStyle Width="20%" />
						                <ItemTemplate>
							                <%# objPM.mtdGetProcessingLineStatus(Container.DataItem("Status")) %>
						                </ItemTemplate>
						                <EditItemTemplate>
						...
						<tr>
							<td>
					            <asp:ImageButton id=ibNew imageurl="../../images/butt_new.gif" OnClick="DEDR_Add" AlternateText="New Processing Line No" runat="server"/>
