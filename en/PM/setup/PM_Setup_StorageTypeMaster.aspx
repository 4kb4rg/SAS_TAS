<%@ Page Language="vb" trace="false" src="../../../include/PM_Setup_StorageTypeMaster.aspx.vb" Inherits="PM_Setup_StorageTypeMaster" %>
<%@ Register TagPrefix="UserControl" Tagname="MenuPDSetup" src="../../menu/menu_PDSetup.ascx"%>
<%@ Register TagPrefix="Preference" Tagname="PrefHdl" src="../../include/preference/preference_handler.ascx"%>

<html>
	<head>
		<title>STORAGE TYPE MASTER LIST</title>
			...
			<tr>
				...
				<div class="kontenlist">
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						<tr>
							<td><strong>STORAGE TYPE MASTER LIST</strong><hr style="width :100%" />   
                            </td>
						...
						<tr>
							...
							<table cellpadding="4" cellspacing="0" style="width: 100%">
								...
								<td width="25%">Storage Type Code :<BR><asp:TextBox id="srchStorageTypeCode" width=100% maxlength=8 runat=server /></td>
								<td width="30%">Description :<BR><asp:TextBox id="srchDescription" width=100% maxlength=128 runat=server /></td>
						    ...
						    <tr>
							    ...
							    <table cellpadding="4" cellspacing="1" style="width: 100%">
						            ...
						            <asp:DataGrid id=EventData
							                ...
							                <Columns>
								                <asp:HyperLinkColumn HeaderText="Storage Type Code" 
									                SortExpression="StorageTypeCode" 
									                DataNavigateUrlField="StorageTypeCode" 
									                DataNavigateUrlFormatString="PM_Setup_StorageTypeMaster_Det.aspx?StorageTypeCode={0}" 
									                DataTextField="StorageTypeCode" 
									                ItemStyle-Width= "20%" /> 
