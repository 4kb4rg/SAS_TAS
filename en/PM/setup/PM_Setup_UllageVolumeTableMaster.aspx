<%@ Page Language="vb" src="../../../include/PM_Setup_UllageVolumeTableMaster.aspx.vb" Inherits="PM_Setup_UllageVolumeTableMaster" %>
<%@ Register TagPrefix="UserControl" Tagname="MenuPDSetup" src="../../menu/menu_PDSetup.ascx"%>
<%@ Register TagPrefix="Preference" Tagname="PrefHdl" src="../../include/preference/preference_handler.ascx"%>
<html>
	<head>
		<title>Ullage - Volume Table Master</title>
					...
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						...
						<tr>
							...
							<table cellpadding="4" cellspacing="0" style="width: 100%">
								...
								<td width="20%"><asp:label id="lblTableCode" runat="server" /> :<BR><asp:TextBox id=srchTableCode width=100% maxlength="8" runat="server"/></td>
							    ...
							    <table cellpadding="4" cellspacing="1" style="width: 100%">
						            ...
						            <asp:DataGrid id="EventData"
					                    ...
					                    <asp:TemplateColumn SortExpression="UVTableCode">
						                    ...
						                    <EditItemTemplate>
							                    <asp:TextBox id="txtTableCode" MaxLength="8" width=95%
									                    Text='<%# trim(Container.DataItem("UVTableCode")) %>'
									                    runat="server"/>
							                    <BR>
							                    <asp:RequiredFieldValidator id=validateTableCode display=dynamic runat=server 
									                    ControlToValidate=txtTableCode />
							                    <asp:RegularExpressionValidator id=revTableCode 
								                    ControlToValidate="txtTableCode"
					                    ...
					                    <asp:TemplateColumn HeaderText="Last Update" SortExpression="UVT.UpdateDate">
						                    <ItemStyle Width="12%" />
						                    <ItemTemplate>
					                    ...
					                    <asp:TemplateColumn HeaderText="Status" SortExpression="UVT.Status">
						                    <ItemStyle Width="12%" />
						                    <ItemTemplate>
							                    <%# objPM.mtdGetUllageVolumeTableStatus(Container.DataItem("Status")) %>
						                    </ItemTemplate>
						                    <EditItemTemplate>
						...
						<tr>
							<td>
					            <asp:ImageButton id=ibNew imageurl="../../images/butt_new.gif" OnClick="DEDR_Add" AlternateText="New Table Code" runat="server"/>
