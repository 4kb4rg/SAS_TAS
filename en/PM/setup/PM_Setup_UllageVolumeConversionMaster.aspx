<%@ Page Language="vb" src="../../../include/PM_Setup_UllageVolumeConversionMaster.aspx.vb" Inherits="PM_Setup_UllageVolumeConversionMaster" %>
<%@ Register TagPrefix="UserControl" Tagname="MenuPDSetup" src="../../menu/menu_PDSetup.ascx"%>
<%@ Register TagPrefix="Preference" Tagname="PrefHdl" src="../../include/preference/preference_handler.ascx"%>
<html>
	<head>
		<title>Ullage - Volume Conversion Master</title>
					...
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						...
						<tr>
							...
							<table cellpadding="4" cellspacing="0" style="width: 100%">
								...
								<td width="20%">
									<asp:label id="lblUllage" runat="server" /> :<BR>
									<asp:TextBox id=srchUllage width=100% maxlength="21" runat="server"/>
									<asp:RegularExpressionValidator id="revsrchUllage" 
										ControlToValidate="srchUllage"
						    ...
						    <tr>
							    ...
							    <table cellpadding="4" cellspacing="1" style="width: 100%">
						            ...
						            <asp:DataGrid id="EventData"
					                    ...
					                    <asp:TemplateColumn SortExpression="Ullage">
						                    <ItemStyle Width="18%" />
						                    <ItemTemplate>
							                    <%# objGlobal.DisplayQuantityFormat(Container.DataItem("Ullage")) %>
						                    </ItemTemplate>
						                    <EditItemTemplate>
							                    <asp:TextBox id="txtUllage" width=100% MaxLength="21"
								                    Text='<%# trim(Container.DataItem("Ullage")) %>'
								                    runat="server"/>
							                    <asp:RequiredFieldValidator id=validateUllage display=Dynamic runat=server 
									                    ControlToValidate=txtUllage />
							                    <asp:RegularExpressionValidator id="revUllage" 
								                    ControlToValidate="txtUllage"
								                    ValidationExpression="\d{1,15}\.\d{1,5}|\d{1,15}"
								                    Display="Dynamic"
								                    text = "Maximum length 15 digits and 5 decimal places"
					                    ...
					                    <asp:TemplateColumn HeaderText="Last Update" SortExpression="UVC.UpdateDate">
						                    <ItemStyle Width="18%" />
						                    <ItemTemplate>
					                    ...
					                    <asp:TemplateColumn HeaderText="Status" SortExpression="UVC.Status">
						                    <ItemStyle Width="10%" />
						                    <ItemTemplate>
							                    <%# objPM.mtdGetUllageVolumeConversionStatus(Container.DataItem("Status")) %>
						                    </ItemTemplate>
						                    <EditItemTemplate>
						...
						<tr>
							<td>
					            <asp:ImageButton id=ibNew imageurl="../../images/butt_new.gif" OnClick="DEDR_Add" AlternateText="New Ullage-Volume Conversion Entry" runat="server"/>
