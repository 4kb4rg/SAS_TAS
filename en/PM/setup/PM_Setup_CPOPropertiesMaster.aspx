<%@ Page Language="vb" src="../../../include/PM_Setup_CPOPropertiesMaster.aspx.vb" Inherits="PM_Setup_CPOPropertiesMaster" %>
<%@ Register TagPrefix="UserControl" Tagname="MenuPDSetup" src="../../menu/menu_PDSetup.ascx"%>
<%@ Register TagPrefix="Preference" Tagname="PrefHdl" src="../../include/preference/preference_handler.ascx"%>
<html>
	<head>
		<title>CPO Properties Master</title>
					...
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						...
						<tr>
							...
							<table cellpadding="4" cellspacing="0" style="width: 100%">
								...
								<td width="15%">
									<asp:label id="lblTemperature" runat="server" /> :<BR>
									<asp:TextBox id=srchTemperature width=100% maxlength="8" runat="server"/>
									<asp:RegularExpressionValidator id=revsrchTemperature 
										ControlToValidate="srchTemperature"
										ValidationExpression="\d{1,3}\.\d{1,2}|\d{1,3}"
										Display="Dynamic"
										text="Maximum length 3 digits and 2 decimal places"
										runat="server"/>
								</td>
								<td width="23%">
									<asp:label id="lblDensity" runat="server" /> :<BR>
									<asp:TextBox id=srchDensity width=100% maxlength="21" runat="server"/>
									<asp:RegularExpressionValidator id=revsrchDensity 
										ControlToValidate="srchDensity"
							    ...
							    <table cellpadding="4" cellspacing="1" style="width: 100%">
                                    ...
                                    <td>
						             <asp:DataGrid id="EventData"
					                    ...
					                    <asp:TemplateColumn SortExpression="Temperature">
						                    <ItemStyle Width="15%" />
						                    <ItemTemplate>
							                    <%# objGlobal.DisplayQuantityFormat(Container.DataItem("Temperature")) %>
						                    </ItemTemplate>
						                    <EditItemTemplate>
							                    <asp:TextBox id="txtTemperature" MaxLength="8" width=95%
									                    Text='<%# trim(Container.DataItem("Temperature")) %>'
									                    runat="server"/>
							                    <BR>
							                    <asp:RequiredFieldValidator id=validateTemperature display=dynamic runat=server 
					                    ...
					                    <asp:TemplateColumn SortExpression="Density">
						                    <ItemStyle Width="20%" />
						                    <ItemTemplate>
							                    <%# objGlobal.DisplayQuantityFormat(Container.DataItem("Density")) %>
						                    </ItemTemplate>
						                    <EditItemTemplate>
							                    <asp:TextBox id="txtDensity" width=100% MaxLength="21"
								                    Text='<%# trim(Container.DataItem("Density")) %>'
								                    runat="server"/>
							                    <asp:RequiredFieldValidator id=validateDensity display=Dynamic runat=server 
									                    ControlToValidate=txtDensity />	
							                    <asp:RegularExpressionValidator id="revDensity" 
								                    ControlToValidate="txtDensity"
								                    ValidationExpression="\d{1,15}\.\d{1,5}|\d{1,15}"
								                    Display="Dynamic"
								                    text = "Maximum length 15 digits and 5 decimal places"
					                    ...
					                    <asp:TemplateColumn HeaderText="Last Update" SortExpression="CPOP.UpdateDate">
						                    <ItemStyle Width="15%" />
						                    <ItemTemplate>
					                    ...
					                    <asp:TemplateColumn HeaderText="Status" SortExpression="CPOP.Status">
						                    <ItemStyle Width="10%" />
						                    <ItemTemplate>
							                    <%# objPM.mtdGetCPOPropertiesStatus(Container.DataItem("Status")) %>
						                    </ItemTemplate>
						                    <EditItemTemplate>
						...
						<tr>
							<td>
					            <asp:ImageButton id=ibNew imageurl="../../images/butt_new.gif" OnClick="DEDR_Add" AlternateText="New CPO Properties Entry" runat="server"/>
