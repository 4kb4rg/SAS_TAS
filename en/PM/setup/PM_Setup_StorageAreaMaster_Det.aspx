<%@ Page Language="vb" Src="../../../include/PM_Setup_StorageAreaMaster_Det.aspx.vb" Inherits="PM_Setup_StorageAreaMaster_Det" %>
<%@ Register TagPrefix="UserControl" Tagname="MenuPDSetup" src="../../menu/menu_PDSetup.ascx"%>
<%@ Register TagPrefix="Preference" Tagname="PrefHdl" src="../../include/preference/preference_handler.ascx"%>
<html>
	<head>
		<title>Storage Area Master Details</title>
	...
	<body>
		...
		<tr>
			...
			<asp:Label id="lblTempStorageTypeCode" runat="server" Visible="False"/>
			...
			<table cellSpacing="0" cellPadding="2" width="100%" border="0" class="font9Tahoma">
				...
				<tr>
					<td class="mt-h" colspan="3" width="50%">STORAGE AREA MASTER DETAILS</td>
				...
				<tr>
					<td width="20%" height=25>Storage Area Code :*</td>
					<td width="30%" valign=center>
						<asp:TextBox id="txtStorageAreaCode" runat="server" width=100% maxlength="8" />
						<asp:RequiredFieldValidator 
							id="rfvStorageAreaCode" 
							runat="server"  
							ControlToValidate="txtStorageAreaCode" 
				...
				<tr>
					<td height=25>Storage Type :*</td>
					<td><asp:DropDownList id="lstStorageType" width="100%" runat="server" size="1" AutoPostBack=true OnSelectedIndexChanged="lstStorageType_OnSelectedIndexChanged" />
						<asp:RequiredFieldValidator id="validateStorageType" runat="server" 
								display="dynamic" 
								ControlToValidate="lstStorageType"
				...
				<tr>
					<td height=25>Storage No :*</td>
					<td><asp:TextBox id="txtStorageNo" runat="server" width=100% maxlength="8"/>
						<asp:RequiredFieldValidator 
							id="rfvStorageNo" 
							runat="server"  
							ControlToValidate="txtStorageNo" 
							text = "Field cannot be blank"
							display="dynamic"/>
					</td>
					<td>&nbsp;</td>
				...
				<tr>
					<td>
						<table id=tblFormula class="mb-c" cellSpacing="0" cellPadding="2" width="100%" border="0" runat=server >
							<tr>
								<td colspan="3"><b><u>Formula</u></b></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td>
									<asp:DropDownList id="lstFirstOperandType" width=100% runat="server" size="1" AutoPostBack=true OnSelectedIndexChanged="lstDropDownList_OnSelectedIndexChanged" />
									<asp:RequiredFieldValidator 
							...
							<tr>
								...
								<td>
									<asp:DropDownList id="lstSecondOperandType" width=100% runat="server" size="1" AutoPostBack=true OnSelectedIndexChanged="lstDropDownList_OnSelectedIndexChanged" />
									<asp:RequiredFieldValidator 
