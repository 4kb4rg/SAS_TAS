<%@ Page Language="vb" src="../include/menu_hr.aspx.vb" Inherits="menu_hr" %>
	...
	<tr>
		...
		<table cellpadding="0" cellspacing="0" style="width: 100%; height: 0px;">
		 ...
		 <asp:Image runat="server" ID="Image1" ImageUrl="images/thumbs/btlogout.png" ToolTip="Log Off" CssClass="button" /></a>
				...
				<td class="style2" valign="center"><img height="35px" src="images/iconmm.png" width="40px" /><span class="font14">HUMAN &nbsp; RESOURCES &nbsp; MANAGEMENT</span></td>
				<td valign="top">
				    &nbsp;</td>
				<td valign="top">
          ...
          <igtab:UltraWebTab   ID="UltraWebTab1" runat="server" Width="100%"  Height="100%" BorderStyle="None" 
            ...
            <Tabs>
                <igtab:Tab Key="trx" DefaultImage="../images/icon1.png"  Tooltip="Transaction Application">
                    <ContentPane BorderStyle="None"   TargetUrl="menu_hrtrx.aspx"  Scrollable="Hidden">
                    </ContentPane>
                ...
                <igtab:Tab Key="stp" DefaultImage="../images/icon2.png"  Tooltip="Setup Application">
                    <ContentPane BorderStyle="None" TargetUrl="menu_hrstp.aspx" Scrollable="Hidden">
                    </ContentPane>
                ...
                <igtab:Tab Key="rpt" DefaultImage="../images/icon3.png" Tooltip="Reports Application">
                    <ContentPane BorderStyle="None" TargetUrl="menu_hrrpt.aspx" Scrollable="Hidden">
                    </ContentPane>
                ...
                <igtab:Tab Key="rpt" DefaultImage="../images/icon4.png" Tooltip="Data Transfer Application">
                    <ContentPane BorderStyle="None" TargetUrl="menu_hrdt.aspx" Scrollable="Hidden">
                    </ContentPane>
                ...
                <igtab:Tab key="mth" DefaultImage="../images/icon5.png"  Tooltip="Month End Processing">
                    <ContentPane BorderStyle="None" TargetUrl="menu_hrmth_estate.aspx" Scrollable="Hidden">
                    </ContentPane>
	...
	<tr>
		...
		<table style="width: 100%; " cellpadding="0" cellspacing="0">
			<tr>
				...
				<td style="width: 100%"><span class="font14">&nbsp;&nbsp;Human Resources</span></td>
				<td valign="bottom">
        ...
        <div style="height:1000px; width:100%; position:absolute; top:90px; z-index:500">
           ...
           <igtab:UltraWebTab   ID="UltraWebTab1" runat="server" Width="100%"  Height="100%" BorderStyle="None" 
            ...
            <Tabs>
                ...
                <igtab:Tab key="mth" Text="Processing" Tooltip="Daily & Month End Processing">
                    <ContentPane BorderStyle="None" TargetUrl="menu_hrmth_estate.aspx" Scrollable="Hidden">
                    </ContentPane>
...
<%--
    ...
    <div class="BackgroundTopCornerHR"></div>--%>
  <%--  </form>
</body>--%>--%>
