<%@ Page Language="vb" src="../../../include/CM_Setup_PriceBasisList.aspx.vb" Inherits="CM_Setup_PriceBasisList" %>
<%@ Register TagPrefix="UserControl" Tagname="menu_cm_setup" src="../../menu/menu_cmsetup.ascx"%>
<%@ Register TagPrefix="Preference" Tagname="PrefHdl" src="../../include/preference/preference_handler.ascx"%>
<html>
	<head>
		<title>Price Basis List</title>
			...
			<tr>
				...
				<div class="kontenlist">
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						<tr>
							<td><strong>PRICE BASIS LIST</strong><hr style="width :100%" />   
                            </td>
						...
						<tr>
							...
							<table cellpadding="4" cellspacing="0" style="width: 100%">
								...
								<td width="18%" height="26">Price Basis Code :<br>
									<asp:TextBox id="srchPriceBasisCode" width="100%" maxlength="8" runat="server"/>
								</td>
								...
								<td width="10%" height="26">Last Update By :<br><asp:TextBox id="srchUpdBy" width="100%" maxlength="10" runat="server"/></td>
						    ...
						    <tr>
					            ...
					            <Columns>					
					            <asp:TemplateColumn HeaderText="Price Basis Code" ItemStyle-Width="21%" SortExpression="curr.PriceBasisCode">
						            <ItemTemplate>
							            <%# Container.DataItem("PriceBasisCode") %>
						            </ItemTemplate>
						            <EditItemTemplate>
							            <asp:TextBox id="PriceBasisCode" MaxLength="8" width="100%"
								            Text='<%# trim(Container.DataItem("PriceBasisCode")) %>'
								            runat="server"/>
							            <asp:RequiredFieldValidator id=validateCode display=dynamic runat=server 
								            ControlToValidate="PriceBasisCode" />															
					            ...
					            <asp:TemplateColumn HeaderText="Status" SortExpression="curr.Status">
						            <ItemTemplate>
							            <%# objCMSetup.mtdGetPriceBasisStatus(Container.DataItem("Status")) %>
						            </ItemTemplate>
						            <EditItemTemplate>
