<%@ Page Language="vb" src="../../../include/CM_data_upload.aspx.vb" Inherits="CM_data_upload" %>
<%@ Register TagPrefix="UserControl" Tagname="MenuCMMthEnd" src="../../menu/menu_CMData.ascx"%>
...
<form id=frmUpload enctype="multipart/form-data" runat=server>
	<table border="0" cellspacing="0" width="100%">
		<tr>
			<td width=100% colspan=3 align=center><UserControl:MenuCMMthEnd id=MenuCMMthEnd runat="server" /></td>
		</tr>
		<tr>
		...
		<tr>
			<td colspan="2">Contract Management Reference Data</td>
		</tr>
		<tr>
			<td colspan="2">&nbsp;</td>
		</tr>
		...
		<tr>
			<td colspan="2">
				<table id=tblAfter border=0 width=100% runat=server>
					<tr>
						<td colspan="2">Your Contract Management reference file has been successfully uploaded.</td>
					</tr>
				</table>
			</td>
		</tr>
