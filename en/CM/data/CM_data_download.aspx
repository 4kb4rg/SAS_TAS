<%@ Page Language="vb" src="../../../include/CM_data_download.aspx.vb" Inherits="CM_data_download" %>
<%@ Register TagPrefix="UserControl" Tagname="MenuCMData" src="../../menu/menu_CMData.ascx"%>
...
<html>
	...
	<body>
		<table border="0" width="100%" cellpadding="1" cellspacing="0">
			<tr>
				<td width="100%" align=center><UserControl:MenuCMData id=MenuCMData runat="server" /></td>
			</tr>
			<tr>
				<td width="100%">
					...
					<table id=tblDownload border="0" cellpadding="0" cellspacing="0" width="100%" runat=server>
						...
						<tr>
							<td width="100%" colspan="4">Contract Management Reference Data</td>
						</tr>
						<tr>
						...
						<tr visible=false>
							<td>&nbsp;</td>
							<td colspan=3><asp:CheckBox id=cbSeller text="Seller" runat=server /></td>
						</tr>
						<tr>
							<td>&nbsp;</td>
							<td colspan=3><asp:CheckBox id=cbCurrency text="Currency" runat=server /></td>
						</tr>
						<tr visible=false>
							<td>&nbsp;</td>
							<td colspan=3><asp:CheckBox id=cbPriceBasis text="Price Basis" runat=server /></td>
						</tr>
						<tr>
