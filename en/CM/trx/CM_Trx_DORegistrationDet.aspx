<%@ Page Language="vb" src="../../../include/CM_Trx_DORegistrationDet.aspx.vb" Inherits="CM_Trx_DORegistrationDet" %>
<%@ Register TagPrefix="UserControl" Tagname="menu_CM_Trx" src="../../menu/menu_CMTrx.ascx"%>
<%@ Register TagPrefix="Preference" Tagname="PrefHdl" src="../../include/preference/preference_handler.ascx"%>
<html>
	<head>
		<title>DO Registration Details</title>
	...
	<body>
		<Form id=frmMain class="main-modul-bg-app-list-pu" runat="server">
			...
			<tr>
				...
				<tr>
					<td class="font9Tahoma" colspan="6"><strong> DO REGISTRATION DETAILS</strong></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td width=30%>
						<asp:textbox id=lblDONo maxlength=128 width=100% CssClass="fontObject" runat=server/>
					</td>
					<td width=5%>&nbsp;</td>
				...
				<tr>
					...
					<td><asp:RadioButtonList id=rdDODest repeatdirection=horizontal onSelectedIndexChanged=onChange_DODestination autopostback=true CssClass="font9Tahoma" runat=server>
				...
				<tr>
					...
					<td><asp:Textbox id=txtDODate maxlength=128 width=25% CssClass="fontObject" runat=server/>
				...
				<tr>
					...
					<td><asp:Textbox id=txtDOQty maxlength=128 style="text-align:right" width=25% OnKeyUp="javascript:calRemAmount();" CssClass="fontObject"  runat=server/>
				...
				<tr>
					...
					<td><asp:dropdownlist id=ddlContNo width=100% autopostback=true onselectedindexchanged=onChanged_ContractNo CssClass="fontObject" runat=server/>
				...
				<tr>
					...
					<td><asp:dropdownlist id=ddlBillParti width=100% CssClass="fontObject" runat=server/>
				...
				<tr>
					...
					<td>
                        <asp:DropDownList id="ddlTerm" width=100%    runat=server>
                                        ...
                                        <asp:ListItem value="1">FRANCO Pabrik pembeli</asp:ListItem>
										<asp:ListItem value="2">LOCO Pabrik penjual</asp:ListItem>
				...
				<tr>
					...
					<td><asp:Textbox id=txtContractQty maxlength=128 width=25% style="text-align:right" CssClass="fontObject" runat=server/>
				...
				<tr>
					...
					<td><asp:Textbox id=txtRemContractQty maxlength=128 width=25% style="text-align:right" CssClass="fontObject" runat=server/>
				...
				<tr>
					...
					<td><textarea rows=5 id=taProductSpesification cols=52 class="fontObject" runat=server></textarea>
					</td>
					<td>&nbsp;</td>
				</tr>
				<tr>
					<td height=25>Quality Note : </td>
					<td><textarea rows=3 id=taProductQuality cols=52 class="fontObject" runat=server></textarea>
					</td>
					<td>&nbsp;</td>
				</tr>
				<tr>
					<td height=25>Quantity Note: </td>
					<td><textarea rows=3 id=taProductQuantity cols=52 class="fontObject" runat=server></textarea>
					</td>
					<td>&nbsp;</td>
				</tr>
				<tr>
					<td height=25>Transporter Code :*</td>
					<td><asp:dropdownlist id=ddlTransporter width=100% CssClass="fontObject" runat=server/>
						
					</td>
				</tr>
				<tr>
					<td height=25>Loading Destination : </td>
					<td><textarea rows=3 id=taLoadDest cols=52 class="fontObject" runat=server></textarea>
					</td>
					<td>&nbsp;</td>
				</tr>	
				<tr>
					...
					<td width=30%>
						<asp:textbox id=txtPackaging maxlength=128 width=100% CssClass="fontObject" runat=server/>
					</td>
				</tr>
				<tr>
					<td height=25>Delivery Note : </td>
					<td><textarea rows=3 id=taDeliveryNote cols=52 class="fontObject" runat=server></textarea>
					</td>
					<td>&nbsp;</td>
				</tr>
				...
				<tr>
					...
					<td><asp:textbox id=txtShipName width=100%  CssClass="fontObject" runat=server/>
					</td>
					<td>&nbsp;</td>
				</tr>	
				...
				<tr>
					...
					<td><asp:Textbox id=txtEstimationDate maxlength=128 width=25% CssClass="fontObject" runat=server/>
				...
				<tr>
					...
					<td><asp:Textbox id=txtExpiredDate1 maxlength=128 width=25% CssClass="fontObject" runat=server/>
				...
				<tr>	
					...
					<td><asp:Textbox id=txtExpiredDate2 maxlength=128 width=25% CssClass="fontObject" runat=server/>
				...
				<tr>
					...
					<td><asp:dropdownlist id=ddlProduct width=50% visible=false CssClass="fontObject" runat=server/>
				...
				<tr>
					...
					<td width=30%>
						<asp:textbox id=txtMatched maxlength=128 width=25% style="text-align:right" CssClass="fontObject" runat=server/>
					</td>
				</tr>
				...
				<tr>
					...
					<td><asp:textbox id=txtNPWP width=50% CssClass="fontObject" runat=server/>
					</td>
					<td>&nbsp;</td>					
				</tr>				
				...
				<tr>
					...
					<td valign=top>
						<textarea rows="4" id=txtAddress cols="52" class="fontObject" runat=server></textarea>
				...
				<tr>
                    <td colspan="3">
                    <asp:CheckBox id="cbExcel" text=" Export To Excel" checked="false" CssClass="font9Tahoma" runat="server" /></td>
                </tr>
                <tr>
					<td colspan=6>&nbsp;</td>
				</tr>
				<tr>
					<td colspan="6">
						...
						<asp:ImageButton id=PrintBtn AlternateText="Print Preview"  ImageUrl="../../Images/butt_print_preview.gif" onClick="btnPrintPrev_Click" runat=server />					
						<asp:ImageButton id=UpdDOBtn AlternateText=" Updating DO "  CausesValidation=False imageurl="../../images/butt_upddo.gif" onclick=UpdDOButton_Click CommandArgument=UpdDO runat=server />
						...
						<asp:ImageButton id=DeactivateDOBtn AlternateText="  Deactivate DO  " CausesValidation=False imageurl="../../images/butt_deactivatedo.gif" onclick=Button_DeactivateDO runat=server />
					</td>
				</tr>
