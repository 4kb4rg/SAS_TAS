<%@ Page Language="vb" src="../../../include/CM_Trx_SPKDOList.aspx.vb" Inherits="CM_Trx_SPKDOList" %>
<%@ Register TagPrefix="UserControl" Tagname="menu_CM_Trx" src="../../menu/menu_CMTrx.ascx"%>
<%@ Register TagPrefix="Preference" Tagname="PrefHdl" src="../../include/preference/preference_handler.ascx"%>
<html>
	<head>
		<title>SPK DO List</title>
	...
	<body>
		<form id=frmMain runat="server">
			...
			<table border="0" cellspacing="1" cellpadding=1 width="100%">
				...
				<tr>
					<td class="mt-h" colspan="3">SPK - DO LIST</td>
						...
						<table width="100%" cellspacing="0" cellpadding="3" border="0" align="center">
							<tr class="mb-t">
								<td valign=top width="15%" height="26">DO No :<BR>
									<asp:TextBox id=txtDONo width=100% maxlength="50" runat="server" /></td>
								<td valign=top width="25%" height="26">Contract No :<BR>
									<asp:TextBox id="txtContractNo" width=100% runat=server/></td>
								...
								<td valign=top width="10%" height="26">Last Updated By :<br>
									<asp:TextBox id="txtLastUpdate" width=100% runat=server/>
								</td>
								<td width="5%" valign=bottom height="26" align=right>
									<asp:Button id="SearchBtn" Text="Search" OnClick=srchBtn_Click runat="server"/>
								</td>
							</tr>
							<tr>
					...
					<td colspan=6>					
						<asp:DataGrid id=dgLine 
							...
							<Columns>
								...
								<asp:TemplateColumn HeaderText="SPK No.">
								  <ItemTemplate>
									 <asp:Hyperlink runat= "server" Text='<%# DataBinder.Eval(Container.DataItem,"DONo").tostring%>' 
									  NavigateUrl='<%# "CM_Trx_SPKDODet.aspx?tbcode=" & DataBinder.Eval (Container.DataItem,"DONo").tostring & _   
