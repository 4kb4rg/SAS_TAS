<%@ Page Language="vb" src="../../../include/CM_Trx_SPKDODet.aspx.vb" Inherits="CM_Trx_DORegistrationDet" %>
<%@ Register TagPrefix="UserControl" Tagname="menu_CM_Trx" src="../../menu/menu_CMTrx.ascx"%>
<%@ Register TagPrefix="Preference" Tagname="PrefHdl" src="../../include/preference/preference_handler.ascx"%>
<html>
	<head>
		<title>SPK-DO Registration Detail   
        </title>
	...
	<body>
		<Form id=frmMain class="main-modul-bg-app-list-pu" runat="server">
			...
			<table border=0 cellspacing=0 cellpadding=2 width=100%>
				...
				<tr>
					<td class="font9Tahoma" colspan="6"><strong>SPK-DO REGISTRATION DETAILS</strong> </td>
				</tr>
			...
			<tr>
				...
				<tr>
					...
					<td><asp:Textbox id=txtDODate maxlength=128 width=25% CssClass="fontObject" runat=server ReadOnly/>
						<!--<a href="javascript:PopCal('txtDODate');">
						    <asp:Image id="btnDODate" ImageAlign=AbsMiddle runat="server" ImageUrl="../../Images/calendar.gif"/>
						</a>-->
				...
				<tr style="display:none;">
					<td height=25><asp:CheckBox ID="chktitipolah" Text=" Titip Olah" runat="server" OnCheckedChanged="chktitipolah_changed" CssClass="font9Tahoma" AutoPostBack="true"/></td>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
					<td>Updated By : </td>
				...
				<tr style="display:none;">
					...
					<td><asp:dropdownlist id=ddlTerm width=100% CssClass="fontObject" runat=server/></td>
				</tr>
				...
				<tr>
					...
					<td>
					    <asp:dropdownlist id=ddlTransporter width=100% CssClass="fontObject" runat=server/>
				...
				<tr>
					...
					<td>
					    <asp:dropdownlist id=ddlOAngkut width=100% runat=server autopostback=true onselectedindexchanged=onChanged_ddlOAngkut CssClass="fontObject" runat=server/>
					    <asp:label id=lblErrddlOAngkut visible=false forecolor=red text="<br>Please select cost transporter." runat=server/>					   
					</td>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
					<td>
						Harga : <asp:Textbox id=txtOangkutharga width=30% enabled=False runat=server/> &nbsp;	PPN : <asp:Textbox id=OangkuthargaPPN width=30% enabled=False CssClass="fontObject" runat=server/>
					</td>
				</tr>
				...
				<tr>
					...
					<td><textarea rows=9 id=taDeliveryNote cols=52 class="fontObject" runat=server></textarea>
					</td>
					<td>&nbsp;</td>
				</tr>
				...
				<tr>
					<td colspan="6">
						...
						<asp:Button id=GenSPK Text=" Generate SPK " OnClick=Button_GenSPK visible=False CssClass="button-small" runat="server" />
					
					</td>
				</tr>
				<tr>
				<td colspan="6" style="display:none;">
				<asp:dropdownlist id=ddlprint width=10% CssClass="fontObject" runat=server>
