<%@ Page Language="vb" src="../../../include/CM_Trx_SPKDOList.aspx.vb" Inherits="CM_Trx_DORegistrationList" %>
<%@ Register TagPrefix="UserControl" Tagname="menu_CM_Trx" src="../../menu/menu_CMTrx.ascx"%>
<%@ Register TagPrefix="Preference" Tagname="PrefHdl" src="../../include/preference/preference_handler.ascx"%>
<html>
	<head>
		<title>SPK-DO Registration List</title>
					...
					<td colspan=6>					
						<asp:DataGrid id=dgLine 
							...
							<Columns>
                                ...
                                <asp:TemplateColumn HeaderText="SPK ID" ItemStyle-Width="15%" SortExpression="SPKID">
	                                <ItemTemplate>
		                                <%#Container.DataItem("SPKID")%>
	                                </ItemTemplate>
                                </asp:TemplateColumn>
