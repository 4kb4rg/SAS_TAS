					...
					<div class="panel">
                        <table id="tlbRpt"  cellSpacing="1" cellPadding="0" width="100%" border="0" runat="server">
							<tr>
                                ...
                                <asp:hyperlink id="lnkRpt1" runat="server" target="middleFrame"  text="Human Resources" cssclass="lb-tti"></asp:hyperlink>
                                </div></a></td>
							</tr>
	                        <tr>
								<td><a href="#"><div class="childmenu">
                                <asp:hyperlink id="lnkRpt2" runat="server" target="middleFrame"  text="Payroll" cssclass="lb-tti"></asp:hyperlink>
                                </div></a></td>
							</tr>

                            <%--<tr>
								<td><a href="#"><div class="childmenu">
                                <asp:hyperlink id="Hyperlink1" runat="server" target="middleFrame"  text="Human Resources-Estate" cssclass="lb-tti"></asp:hyperlink>
                                </div></a></td>
							</tr>--%>
              <%--              <tr>
								<td><a href="#"><div class="childmenu">
                                <asp:hyperlink id="Hyperlink2" runat="server" target="middleFrame"  text="Payroll-Estate" cssclass="lb-tti"></asp:hyperlink>
                                </div></a></td>
							</tr>--%>
						</table>
					</div>
