<%@ Page Language="vb" src="../../../include/cb_trx_TemplAccount.aspx.vb" Inherits="cb_trx_TemplAccount" %>
	...
	<body>
		...
		<tr>
			...
			<table border=0 cellspacing=0 cellpadding=2 width=100%>
				<tr>
					<td class="mt-h" colspan="5"><asp:label id=lblStmtName runat=server /> : Add/Delete <asp:label id=lblTitle runat=server/> for <asp:label id=lblRowDesc runat=server />				
				</tr>
				<tr>
				...
				<tr>
					<td colspan="5">
						<TABLE id="tblSelection" width="100%" class="font9Tahoma" cellspacing="0" cellpadding="6" border="0" align="center" runat=server>
