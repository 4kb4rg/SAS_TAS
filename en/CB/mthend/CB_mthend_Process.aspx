...
<html>
	...
	<body>
		...
		<table border="0" width="100%" cellpadding="1" cellspacing="0" class="font9Tahoma">
			...
			<tr>
				<td colspan=5><strong>CASH AND BANK MONTH END PROCESS</strong> </td>
			</tr>
			<tr>
				<td colspan=5>
                    <hr style="width :100%" />
			...
			<tr>
				...
				&nbsp;<asp:Button ID="Issue9" class="button-small" 
                        runat="server" Text="Proceed For Month End Close" Width="181px"  />
				</td>
			</tr>
		</table>
