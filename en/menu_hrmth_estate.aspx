	...
	<tr>
		...
		<table cellpadding="0" cellspacing="0" style="width: 254px">
			...
			<tr>
				<td valign="top">
                    <div class="panel">
                            <table id="TblPT_MonthlyHead"  cellSpacing="1" cellPadding="0" width="100%" border="0" runat="server">
				    ...
				    <button class="accordion">Proses Bulanan</button>					
					<div class="panel">
                        <table id="tblPR_Monthy"  cellSpacing="1" cellPadding="0" width="100%" border="0" runat="server">
							<tr>
								<td><a href="#"><div class="childmenu">
                                <asp:hyperlink class="lb-mt" id="Hyperlink1N" runat="server" NavigateUrl="/en/PR/mthend/PR_mthend_payrollprocess_estate.aspx"  target="middleFrame" text="Proses Payroll" ></asp:hyperlink>
                                </div></a></td>
							</tr>
	                        <tr>
								<td><a href="#"><div class="childmenu">
                                <asp:hyperlink class="lb-mt" id="Hyperlink2N" runat="server" NavigateUrl="/en/PR/mthend/PR_mthend_stkissueprocess_estate.aspx"  target="middleFrame" text="Proses Stock Issue BKM" ></asp:hyperlink>
                                </div></a></td>
							</tr>
                            <tr>
								<td><a href="#"><div class="childmenu">
                                <asp:hyperlink class="lb-mt" id="Hyperlink3N" runat="server" NavigateUrl="/en/PR/mthend/PR_mthend_spkprocess_estate.aspx"  target="middleFrame" text="Proses Goods Receive BAPP" ></asp:hyperlink>
                                </div></a></td>
							</tr>
						</table>
					</div>
