		...
		<table cellpadding="0" cellspacing="0" style="width: 254px">
			...
			<tr>
				<td valign="top">
					...
					<div class="panel">
                        <table id="tblMth"  cellSpacing="1" cellPadding="0" width="100%" border="0" runat="server">
							<tr>
								<td><a href="#"><div class="childmenu">
                                <asp:hyperlink id="lnkMth1" runat="server" target="middleFrame"  text="Inventory" cssclass="lb-tti"></asp:hyperlink>
                                </div></a></td>
							</tr>
	                        <tr>
								<td><a href="#"><div class="childmenu">
                                <asp:hyperlink id="lnkMth2" runat="server" target="middleFrame"  text="Purchasing" cssclass="lb-tti"></asp:hyperlink>
                                </div></a></td>
							</tr>
						</table>
					</div>
