<%@ Page Language="vb" src="../include/menu_mm.aspx.vb" Inherits="menu_mm" %>
	...
	<tr>
		...
		<table cellpadding="0" cellspacing="0" style="width: 100%; height: 0px;">
		 ...
		 <asp:Image runat="server" ID="Image1" ImageUrl="images/thumbs/btlogout.png" ToolTip="Log Off" CssClass="button" /></a>
				...
				<td class="style2" valign="center"><img height="35px" src="images/iconmm.png" width="40px" /><span class="font14">M A T E R I A L &nbsp;&nbsp;  M A N A G E M E N T</span></td>
				<td valign="top">
				    &nbsp;</td>
				<td valign="top">
