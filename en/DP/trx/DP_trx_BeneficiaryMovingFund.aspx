	...
	<body>
		...
		<tr>
			...
			<table border=0 cellspacing="1" width="100%" class="font9Tahoma">
				...
				<tr>
					<td height=25><b>ACTIVE BENEFICIARY</b></td>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
					<td><b>BENEFITS</b></td>
				</tr>
				...
				<tr>
                    <td height=25>Active Date :*</td>
                    <td><asp:TextBox id=txtActiveDate width=50% runat=server />
                    </td>
                </tr>
                <tr>
					<td colspan=5>&nbsp;</td>
                ...
                <tr>
					<td height=25><b>TRANSACTIONS PROCESS</b></td>
				</tr>
				<tr>
					<td colspan=5><hr size="1" noshade></td>
				</tr>
				<tr>
                    ...
                    <td><asp:TextBox id=txtTransDate width=50% runat=server />
                        ...
                        <asp:Label id=Label22 visible=False forecolor=red text="<br>Date format should be in " runat=server />
                ...
                <tr>
                    <td height=25>Transferred Amount :*</td>
                    <td><asp:TextBox id=txtTransferAmount width=100% runat=server />
                        <asp:RegularExpressionValidator 
			                id="RegularExpressionValidator2" 
			                ControlToValidate="txtTransferAmount"
                ...
                <tr>
					<td height=25><b>PENSION FUND DETAIL</b></td>
				</tr>
                <tr>
                     <td height=25>Fund Name :*</td>
                     <td><asp:TextBox id=txtFundName width=100% runat=server /></td>
                </tr>
                <tr>
				    <td height=25 valign=top>Fund Address :</td>
                    <td valign=top>
                        <textarea rows="6" id=txtFundAddress width=100% cols="37" value="" runat=server></textarea>
                        <asp:Label id=Label6 visible=false forecolor=red text="Maximum length for address is up to 512 characters only." runat=server />
                    </td>
				</tr>
				<tr>
				    <td height=25>Fund Tel No :</td>
                    <td><asp:TextBox id=txtFundTelp width=100% maxlength=15 runat=server />
                                                    ...
                                                    <table id="Table3" width="100%" class="mb-c" cellspacing="0" cellpadding="4" border="0" align="left" runat=server>
					                                    <tr>						
						                                    <td>
							                                    <table border=0 cellpadding=2 cellspacing=0 width=100%>
							                                        <tr>
					                                                    <td width=20% height=25>BENEFITS BALANCE</td>
					                                                    <td>&nbsp;</td>
				                                                    </tr>
				                                                    <tr>
					                                                    <td width=20% height=25>Total Receipt Benefit until last month :</td>
					                                                    <td width=25% align=right><asp:Label id=lblBeginBalance runat=server /></td>
					                                                    <td width=5%>&nbsp;</td>
					                                                    <td width=20%></td>
					                                                    <td width=25%></td>
				                                                    </tr>
							                                        ...
							                                        <tr>
					                                                    <td width=20% height=25>CONTRIBUTIONS</td>
					                                                    <td>&nbsp;</td>
				                                                    </tr>
							                                        <tr>
					                                                    <td height=25>Total Employee Contribution Amount :</td>
					                                                    <td align=right><asp:Label id=lblTotEmpeConAmount runat=server /></td>
