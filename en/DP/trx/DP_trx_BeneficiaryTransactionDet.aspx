	...
	<body>
		...
		<tr>
			...
			<table border=0 cellspacing="1" width="100%" class="font9Tahoma">
				...
				<tr>
					<td height=25><b>NEW BENEFICIARY</b></td>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
					<td><b>NEW BENEFITS</b></td>
				</tr>
				<tr>
                    <td height=25>Name :*</td>
                    <td><asp:DropDownList id=ddlBenNameNew width=100% runat=server/>
                        <asp:Label id=Label18 visible=false forecolor=red text="<br>Please select one Beneficiary Name." runat=server/>
                    </td>	
                    <td>&nbsp;</td>
                    <td>Defined Benefit :</td>
					<td><asp:Label id=lblDefinedBenefitNew runat=server /></td>
                </tr>
                <tr>
                    <td height=25>Status :*</td>
                    ...
                    <td>&nbsp;</td>
                    <td>Total Allowance :</td>
					<td><asp:Label id=lblTotAllowanceNew runat=server /></td>
                </tr>
                <tr>
                    <td height=25>Date of Birth :*</td>
                    ...
                    <td>&nbsp;</td>
					<td>Total Deduction :</td>
					<td><asp:Label id=lblTotDeductionNew runat=server /></td>
                </tr>
                <tr>
                    <td height=25>Age :</td>
                    ...
                    <td>&nbsp;</td>
					<td>Receipt Benefit :</td>
					<td><asp:Label id=lblReceiptBenefitNew runat=server /></td>
                </tr>
                <tr>
                    <td height=25 valign=top>Residential Address :</td>
                    <td valign=top>
                ...
                <tr>
                 ...
                 <tr>
                    <td>&nbsp;</td>
                    <td height=25>
                        <input type=button width=100% value=" same like above " id="Button1" onclick="javascript:PopSupplier('frmMain', '', 'ddlSupplier', 'True');" CausesValidation=False runat=server />
                    </td>
                </tr>
				<tr>
					<td colspan=5>&nbsp;</td>
				...
				<tr>
				    <td colspan=2>	
				        <igtab:UltraWebTab ID="UltraWebTab1" AutoPostBack=false  runat="server" Height="100%" Width="100%" BorderColor="#949C9C" ThreeDEffect="False">
