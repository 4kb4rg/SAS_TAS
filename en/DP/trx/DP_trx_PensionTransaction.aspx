       ...
       <table cellpadding="0" cellspacing="0" style="width: 100%" >
		<tr>
			...
			<table border=0 cellspacing="1" width="100%" class="font9Tahoma">
				<tr>
					<td class="mt-h" colspan="5">BENEFICIARY TRANSACTION</td>
				</tr>
				<tr>
				...
				<tr>
					<td colspan=5>PENSION PROCESS</td>
				</tr>
				<tr>
					<td colspan=5><hr size="1" noshade></td>
				</tr>
				...
				<tr>
				    <td height=25>Pension Date :</td>
					<td><asp:TextBox id=txtPensionDate width=50% runat=server />
						<a href="javascript:PopCal('txtPensionDate');"><asp:Image id="Image8" runat="server" ImageUrl="../../Images/calendar.gif"/></a>						
						...
						<asp:RequiredFieldValidator id=RequiredFieldValidator9 display=dynamic runat=server 
							ErrorMessage="<br>Please enter Membership Date." 
							ControlToValidate=txtPensionDate />			
					</td>
					<td>&nbsp;</td>
					<td>Pension No :*</td>
					<td><asp:TextBox id=txtPensionNo width=100% runat=server /></td>
				</tr>
				<tr>
					...
					<td>&nbsp;</td>
					<td>Reason :</td>
					<td><asp:TextBox id=txtReason width=100% runat=server /></td>
				</tr>
				<tr>
				    <td height=25>Payment Status :*</td>
					<td><asp:DropDownList id=ddlPayStatus width=100% runat=server/>
						<asp:Label id=Label6 visible=false forecolor=red text="<br>Please select one Payment Status." runat=server/>
					</td>
				</tr>
				<tr>
				    <td>&nbsp;</td>
				    ...
				    <td colspan=2>	
						                                    ...
						                                    <td>
							                                    <table border=0 cellpadding=2 cellspacing=0 width=100%>
                                                                    <tr>
                                                                       ...
                                                                       <td width=100% colspan=5><asp:TextBox id=txtBenName maxlength=64 width=100% runat=server />
                                                                    ...
                                                                    <tr>
                                                                        <td height=25>Date of Birth :*</td>
                                                                        <td><asp:TextBox id=txtBenDOB width=15% runat=server />
                                                                            <a href="javascript:PopCal('txtBenDOB');"><asp:Image id="Image6" runat="server" ImageUrl="../../Images/calendar.gif"/></a>						
                                                                            <asp:Label id=Label9 visible=False forecolor=red text="<br>Date format should be in " runat=server />
                                                                            <asp:RequiredFieldValidator id=RequiredFieldValidator8 display=dynamic runat=server 
                                                                                ErrorMessage="<br>Please enter Date Of Birth." 
                                                                                ControlToValidate=txtBenDOB />			
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
				                                                        <td height=25 width=20% valign=top>Residential Address :</td>
                                                                    ...
                                                                    <tr>
                                                                        <td height=25 width=20%>Residential Tel No :</td>
                                                                        <td><asp:TextBox id=txtBenTelp width=33% maxlength=15 runat=server />
                                                                    ...
                                                                    <tr class="mb-c">											
			                                                            <td>
				                                                            <asp:ImageButton id=btnAddBen imageurl="../../images/butt_add.gif" alternatetext=Add  runat=server />
			                                                            </td>
		                                                            </tr>	
		                                                        </table>
		                                                    </td>
							...
							<AlternatingItemStyle BackColor="#EEEEEE" Font-Bold="False" 
                                ...
                                Font-Underline="False"/>
						                                <Columns>						
				                                            ...
				                                            <asp:TemplateColumn ItemStyle-Width="20%" HeaderText="Residential Address" >
					                                            <ItemTemplate>
						                                            <asp:Label Text=<%# Container.DataItem("ResidentialAddress") %> id="lblResidentialAddress" runat="server" />
					                                            </ItemTemplate>
				                                            </asp:TemplateColumn>	
				                                             <asp:TemplateColumn ItemStyle-Width="20%" HeaderText="Residential Telp. No" >
					                                            <ItemTemplate>
						                                            <asp:Label Text=<%# Container.DataItem("ResidentialTelpNo") %> id="lblResidentialTelpNo" runat="server" />
					                                            </ItemTemplate>
				                                            </asp:TemplateColumn>	
							                                ...
							                                <td>
								                                <table border=0 cellpadding=2 cellspacing=0 width=100%>
                                                                    <tr>
                                                                        ...
                                                                        <td width=100% colspan=5><asp:TextBox id=txtMemberName maxlength=64 width=100% runat=server />
                                                                    ...
                                                                    <tr>
                                                                        <td height=25>Date of Birth :*</td>
                                                                        <td><asp:TextBox id=txtDOBFam width=15% runat=server />
                        ...
                        class="font9Tahoma">	
							...
							<AlternatingItemStyle BackColor="#EEEEEE" Font-Bold="False" 
                                ...
                                <igtab:Tab Text=" Contribution Saldo ">
                                    <ContentTemplate>
                                        <table border="0" cellpadding="2" cellspacing="0" width="100%">
                                            <tr class=mb-t>
                                                <td colspan=6>
						                                    ...
						                                    <td>
							                                    <table border=0 cellpadding=2 cellspacing=0 width=100%>
							                                         <tr>
					                                                    ...
					                                                    <td width=30%>Begin Balance</td>
					                                                    <td>&nbsp;</td>
					                                                    <td>End Balance :</td>
					                                                    <td width=15%>&nbsp;</td>
				                                                    </tr>
							                                        <tr>
					                                                    <td height=25>Total Employee Contribution Amount :</td>
					                                                    <td align=right><asp:Label id=lblTotEmpeConAmountBegin runat=server /></td>
					                                                    <td>&nbsp;</td>
					                                                    <td align=right><asp:Label id=lblTotEmpeConAmountEnd runat=server /></td>
				                                                    </tr>
				                                                    <tr>
					                                                    <td height=25>Total Employer Contribution Amount :</td>
					                                                    <td align=right><asp:Label id=lblTotEmprConAmountBegin runat=server /></td>
					                                                    <td>&nbsp;</td>
					                                                    <td align=right><asp:Label id=lblTotEmprConAmountEnd runat=server /></td>
				                                                    </tr>
				                                                    <tr>
					                                                    <td height=25>Total Contribution Amount :</td>
					                                                    <td align=right><asp:Label id=lblTotConAmountBegin runat=server /></td>
					                                                    <td>&nbsp;</td>
					                                                    <td align=right><asp:Label id=lblTotConAmountEnd runat=server /></td>
				                                                    </tr>
                                                                    <tr>
					                                                    <td colspan=5>&nbsp;</td>
				                                                    </tr>
						                                    ...
						                                    <td>
							                                    <table border=0 cellpadding=2 cellspacing=0 width=100%>
				                                                    <tr>
                                                                        ...
                                                                        <td colspan=5><asp:DropDownList id=ddlPayType width=100% runat=server/>
