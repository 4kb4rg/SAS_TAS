		...
		<form id=frmMain runat=server>
			...
			<table border=0 cellspacing="1" width="100%">
				...
				<tr>
					...
					<td>&nbsp;</td>
					<td>&nbsp;</td>
					<td>BENEFIT BALANCE</td>
				</tr>
				<tr>
					<td height=25>Defined Benefit :</td>
					<td><asp:Label id=lblDefinedBenefit runat=server /></td>
					<td>&nbsp;</td>
					<td>Begin Balance :</td>
					<td><asp:Label id=lblBeginBalance runat=server /></td>
				</tr>
				<tr>
					<td height=25>Total Allowance :</td>
					<td><asp:Label id=lblTotAllowance runat=server /></td>
					<td>&nbsp;</td>
					<td>Adjustment :</td>
					<td><asp:Label id=lblCorrection runat=server /></td>
				</tr>
				<tr>
					<td height=25>Total Deduction :</td>
				...
				<tr>
					<td height=25>Receipt Benefit :</td>
				    ...
				    <td colspan=6>	
                        ...
                        <SelectedTabStyle CssClass="ContentTabSelected">
                            ...
                            <Tabs>
                                ...
                                <igtab:Tab Text=" Contribution, Allowance & Deduction ">
                                    <ContentTemplate>
                                        <table border="0" cellpadding="2" cellspacing="0" width="100%">
                                            <tr class=mb-t>
                                                <td colspan=6>
                                                    <table id="Table3" width="100%" class="mb-c" cellspacing="0" cellpadding="4" border="0" align="left" runat=server>
					                                    <tr>						
						                                    <td>
							                                    <table border=0 cellpadding=2 cellspacing=0 width=100%>
							                                        <tr>
					                                                    <td width=20% height=25>CONTRIBUTION</td>
					                                                    <td>&nbsp;</td>
				                                                    </tr>
							                                        <tr>
					                                                    <td width=20% height=25>Total Employee Contribution Amount :</td>
					                                                    <td width=25% align=right><asp:Label id=lblTotEmpeConAmount runat=server /></td>
				                                                    </tr>
				                                                    <tr>
                                                                    ...
                                                                    <tr>
				                                                     ...
				                                                     <tr>
					                                                    <td width=20% height=25>ALLOWANCE & DEDUCTION</td>
					                                                    <td>&nbsp;</td>
				                                                    </tr>
				                                                    <tr>
                                                                        <td height=25>Transaction Code :</td>
                                                                        <td colspan=5><asp:DropDownList id=ddlADCode width=100% runat=server/>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td colspan=5><asp:DropDownList id=ddlADType width=100% runat=server/>
                                                                    ...
                                                                    <tr>
					                                                    ...
					                                                    <td colspan=5><asp:TextBox id=txtDuration width=20% runat=server /></td>
				                                                    </tr>
				                                                    <tr>
                                                                        <td height=25>Effective Period :</td>
                                                                        <td colspan=5><asp:DropDownList id=ddlPeriod width=20% runat=server/>
                                                                            <asp:Label id=Label6 visible=false forecolor=red text="<br>Please select one Period." runat=server/>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
					                                                    <td height=25>Amount :</td>
					                                                    <td colspan=5><asp:TextBox id=txtADAmount width=20% runat=server /></td>
				                                                    </tr>
				                                                    <tr class="mb-c">											
			                                                            <td>
