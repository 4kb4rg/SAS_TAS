	...
	<body>
		...
		<tr>
			...
			<table border=0 cellspacing="1" width="100%" class="font9Tahoma">
                ...
                <tr>
					<td height=25><b>ALLOWACE & DEDUCTION</b></td>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
				</tr>
                </table>
                ...
                <tr>
				    <td colspan="6">
					    <table id="tblSelection" border="0" width="100%" cellspacing="0" cellpadding="4" runat="server" class="font9Tahoma">
					        <tr class="mb-c">
                                <td height=25 width=20%>Transaction Code :</td>
                                <td colspan=4><asp:DropDownList id=ddlADCode width=100% runat=server/>
                            ...
                            <tr class="mb-c">	
                                ...
                                <td colspan=4><asp:DropDownList id=ddlADType width=100% runat=server/>
                            ...
                            <tr class="mb-c">	
                                ...
                                <td colspan=4><asp:TextBox id=txtDuration width=15% runat=server /></td>
                            </tr>
                            <tr class="mb-c">	
                                <td height=25>Effective Period :</td>
                                <td colspan=4><asp:DropDownList id=ddlPeriod width=15% runat=server/>
                                    <asp:Label id=Label6 visible=false forecolor=red text="<br>Please select one Period." runat=server/>
                                </td>
                            </tr>
                            <tr class="mb-c">	
                                <td height=25>Amount :</td>
                                <td colspan=4><asp:TextBox id=txtADAmount width=100% runat=server />
                                              <asp:RegularExpressionValidator 
									            id="RegularExpressionValidator2" 
									            ControlToValidate="txtADAmount"
