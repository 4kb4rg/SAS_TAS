<%@ Page Language="vb" src="../../../include/DP_trx_MemberList.aspx.vb" Inherits="DP_MemberList" %>
			...
			<tr>
				...
				<div class="kontenlist">
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						    ...
						    <tr>
							    ...
							    <table cellpadding="4" cellspacing="1" style="width: 100%">
						            ...
						            <asp:DataGrid id=dgEmpList
							                ...
							                <Columns>
							                    <asp:HyperLinkColumn  HeaderText="Member Code" 
													                 SortExpression="NoPes" 
													                 DataNavigateUrlField="NoPes" 
													                 DataNavigateUrlFormatString="DP_trx_MemberDet.aspx?NoPes={0}" 
													                 DataTextField="NoPes" />
								                <asp:HyperLinkColumn  HeaderText="Employee Code" 
													                 SortExpression="NoPeg" 
													                 DataNavigateUrlField="NoPes" 
													                 DataNavigateUrlFormatString="DP_trx_MemberDet.aspx?NoPes={0}" 
													                 DataTextField="NoPeg" />
								                <asp:HyperLinkColumn  HeaderText="Member Name" 
													                 SortExpression="Nam" 
													                 DataNavigateUrlField="NoPes" 
													                 DataNavigateUrlFormatString="DP_trx_MemberDet.aspx?NoPes={0}" 
													                 DataTextField="Nam" />
						...
						<tr>
							<td>
					            <asp:ImageButton id=btnMemDet OnClick="MemberDet_Click" imageurl="../../images/butt_new.gif" AlternateText="New Member" runat="server"/>
						        <asp:ImageButton id=btnMemTrx OnClick="MemberTrx_Click" imageurl="../../images/butt_new.gif" AlternateText="Member Transaction" runat="server"/>
						        <asp:ImageButton id=btnMemAD OnClick="MemberAD_Click" imageurl="../../images/butt_new.gif" AlternateText="Member Allowance & Deduction" runat="server"/>
						        <asp:ImageButton id=btnMemPen OnClick="MemberPen_Click" imageurl="../../images/butt_new.gif" AlternateText="Pension Process" runat="server"/>
