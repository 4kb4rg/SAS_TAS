<%@ Page Language="vb" src="../../../include/HR_trx_EmployeeQlfList.aspx.vb" Inherits="HR_EmployeeQlfList" %>
<%@ Register TagPrefix="UserControl" Tagname="MenuHR" src="../../menu/menu_hrtrx.ascx"%>
<%@ Register TagPrefix="Preference" Tagname="PrefHdl" src="../../include/preference/preference_handler.ascx"%>

<html>
	<head>
		<title>Employee Qualification List</title>
        <link href="../../include/css/gopalms.css" rel="stylesheet" type="text/css" />
	<%--	<Preference:PrefHdl id=PrefHdl runat="server" />--%>
	</head>
	<body>
	    <form id=frmEmpQlfList runat=server class="main-modul-bg-app-list-pu">
			...
			<tr>
				...
				<div class="kontenlist">
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						<tr>
							<td><strong>EMPLOYEE QUALIFICATION LIST</strong><hr style="width :100%" />   
                            </td>
						    ...
						    <tr>
							    ...
							    <table cellpadding="4" cellspacing="1" style="width: 100%">
						            ...
						            <asp:DataGrid id=dgEmpQlfList
							            ...
							            <Columns>
								            <asp:TemplateColumn HeaderText="Qualification Code" SortExpression="QualificationCode">
									            <ItemTemplate>
										            <asp:Label id=lblQualificationCode text='<%# Container.DataItem("QualificationCode") %>' visible=false runat=server/>
										            <asp:LinkButton id=lbQualificationCode text='<%# Container.DataItem("QlfDesc") %>' CommandName=Edit runat=server />
									            </ItemTemplate>
								            </asp:TemplateColumn>
							
								            <asp:TemplateColumn HeaderText="Subject Code" SortExpression="SubjectCode">
									            <ItemTemplate>
										            <asp:Label id=lblSubjectCode text='<%# Container.DataItem("SubjectCode") %>' visible=false runat=server/>
										            <asp:LinkButton id=lbSubjectCode text='<%# Container.DataItem("SubjDesc") %>' CommandName=Edit runat=server />
									            </ItemTemplate>
								            </asp:TemplateColumn>
								            ...
								            <asp:TemplateColumn>
									            <ItemTemplate>
										            <asp:Label id=lblQualificationID text='<%# Container.DataItem("QualificationID") %>' visible=false runat=server/>
										            <asp:LinkButton id=lbQualificationID text='<%# Container.DataItem("QualificationID") %>' visible=false runat=server />
									            </ItemTemplate>
								            </asp:TemplateColumn>
						...
						<tr>
							<td>
					            <asp:ImageButton id=NewEmpQlfBtn imageurl="../../images/butt_new.gif" onClick=NewEmpQlfBtn_Click AlternateText="New Qualification" runat="server"/>
						        <asp:ImageButton id=ibPrint imageurl="../../images/butt_print.gif" visible=false AlternateText=Print runat="server"/>
