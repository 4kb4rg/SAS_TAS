<%@ Page Language="vb" src="../../../include/HR_setup_Deptlist.aspx.vb" Inherits="HR_setup_Deptlist" %>
					...
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						...
						<tr>
							...
							<table cellpadding="4" cellspacing="0" style="width: 100%">
								...
								<td width="15%" height="26" valign=bottom><asp:label id="lblDepartment" runat="server" /> Code :<BR><asp:TextBox id=txtDeptCode width=100% maxlength="8" runat="server" /></td>
								<td width="40%" height="26" valign=bottom>&nbsp;</td>
						    ...
						    <tr>
							    ...
							    <table cellpadding="4" cellspacing="1" style="width: 100%">
						            ...
						            <asp:DataGrid id=dgLine runat=server
							            ...
							            <Columns>
								            <asp:BoundColumn Visible=False HeaderText="Department Code" DataField="DeptCode" />								
								            <asp:HyperLinkColumn HeaderText="Department Code" SortExpression="A.DeptCode" 
									            DataNavigateUrlField="DeptCode" 
									            DataNavigateUrlFormatString="HR_setup_DeptDet.aspx?deptcode={0}" 
						...
						<tr>
							<td>
					            <asp:ImageButton id=NewDeptBtn onClick=NewDeptBtn_Click imageurl="../../images/butt_new.gif" AlternateText="New Department" runat="server"/>
