<%@ Page Language="vb" src="../../../include/HR_Setup_Race.aspx.vb" Inherits="HR_Setup_Race" %>
			...
			<tr>
				...
				<div class="kontenlist">
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						<tr>
							<td><strong>RACE LIST</strong><hr style="width :100%" />   
                            </td>
						...
						<tr>
							...
							<table cellpadding="4" cellspacing="0" style="width: 100%">
								...
								<td width="15%" height="26" valign=bottom>Race Code :<BR><asp:TextBox id=srchRaceCode width=100% maxlength="8" runat="server"/></td>
						    ...
						    <tr>
							    ...
							    <table cellpadding="4" cellspacing="1" style="width: 100%">
					                ...
					                <Columns>					
					                <asp:TemplateColumn HeaderText="Race Code" SortExpression="RaceCode">
						                <ItemTemplate>
							                <%# Container.DataItem("RaceCode") %>
						                </ItemTemplate>
						                <EditItemTemplate>
							                <asp:TextBox id="RaceCode" MaxLength="8" width=95%
								                Text='<%# trim(Container.DataItem("RaceCode")) %>' runat="server"/><BR>
							                <asp:RequiredFieldValidator id=validateCode display=dynamic runat=server 
								                ErrorMessage="Please Enter Race Code"
								                ControlToValidate=RaceCode />
					                ...
					                <asp:TemplateColumn HeaderText="Last Update" SortExpression="RA.UpdateDate">
						                <ItemTemplate>
					                ...
					                <asp:TemplateColumn HeaderText="Status" SortExpression="RA.Status">
						                <ItemTemplate>
						...
						<tr>
							<td>
					            <asp:ImageButton id=btnNew OnClick="DEDR_Add" imageurl="../../images/butt_new.gif" AlternateText="New Race Code" runat="server"/>
