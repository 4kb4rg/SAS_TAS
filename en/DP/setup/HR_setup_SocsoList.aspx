<%@ Page Language="vb" src="../../../include/HR_setup_SocsoList.aspx.vb" Inherits="HR_setup_SocsoList" %>
<%@ Register TagPrefix="UserControl" Tagname="MenuHRSetup" src="../../menu/menu_hrsetup.ascx"%>
<%@ Register TagPrefix="Preference" Tagname="PrefHdl" src="../../include/preference/preference_handler.ascx"%>
<html>
	<head>
		<title>Socso List</title>
			...
			<tr>
				...
				<div class="kontenlist">
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						<tr>
							<td><strong>SOCSO LIST</strong><hr style="width :100%" />   
                            </td>
						...
						<tr>
							...
							<table cellpadding="4" cellspacing="0" style="width: 100%">
								...
								<td width="15%" height="26" valign=bottom>Socso Code :<BR><asp:TextBox id=txtSocsoCode width=100% maxlength="8" runat="server" /></td>
						    ...
						    <tr>
							    ...
							    <table cellpadding="4" cellspacing="1" style="width: 100%">
						            ...
						            <asp:DataGrid id=dgLine runat=server
							            ...
							            <Columns>
								            <asp:BoundColumn Visible=False HeaderText="Socso Code" DataField="SocsoCode" />
								            <asp:HyperLinkColumn HeaderText="Socso Code" ItemStyle-Width="15%" HeaderStyle-Width="15%"
									            SortExpression="S.SocsoCode" 
									            DataNavigateUrlField="SocsoCode" 
									            DataNavigateUrlFormatString="HR_setup_SocsoDet.aspx?socsocode={0}" 
									            DataTextField="SocsoCode" />
									
								            <asp:HyperLinkColumn HeaderText="Description" ItemStyle-Width="40%" HeaderStyle-Width="40%"
									            SortExpression="S.Description" 
									            DataNavigateUrlField="SocsoCode" 
									            DataNavigateUrlFormatString="HR_setup_SocsoDet.aspx?socsocode={0}" 
									            DataTextField="Description" />
								
								            <asp:TemplateColumn HeaderText="Last Update" ItemStyle-Width="10%" HeaderStyle-Width="10%" SortExpression="S.UpdateDate">
									            <ItemTemplate>
										            <%# objGlobal.GetLongDate(Container.DataItem("UpdateDate")) %>
									            </ItemTemplate>
								            </asp:TemplateColumn>
									
								            <asp:TemplateColumn HeaderText="Status" ItemStyle-Width="10%" HeaderStyle-Width="10%" SortExpression="S.Status">
									            <ItemTemplate>
										            <%# objHRSetup.mtdGetSocsoStatus(Container.DataItem("Status")) %>
									            </ItemTemplate>
								            </asp:TemplateColumn>
						...
						<tr>
							<td>
					            <asp:ImageButton id=NewSocsoBtn OnClick="NewSocsoBtn_Click" imageurl="../../images/butt_new.gif" AlternateText="New Socso Code" runat="server"/>
