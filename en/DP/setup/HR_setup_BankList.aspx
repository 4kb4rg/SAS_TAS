<%@ Page Language="vb" src="../../../include/HR_setup_BankList.aspx.vb" Inherits="HR_setup_BankList" %>
			...
			<tr>
				...
				<div class="kontenlist">
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						<tr>
							<td><strong>BANK LIST</strong><hr style="width :100%" />   
                            </td>
						...
						<tr>
							...
							<table cellpadding="4" cellspacing="0" style="width: 100%">
								...
								<td width="15%" height="26" valign=bottom>Bank Code :<BR><asp:TextBox id=txtBankCode width=100% maxlength="8" runat="server" /></td>
						    ...
						    <tr>
							    ...
							    <table cellpadding="4" cellspacing="1" style="width: 100%">
						            ...
						            <asp:DataGrid id=dgLine runat=server
							            ...
							            <Columns>
								            <asp:BoundColumn Visible=False HeaderText="Bank Code" DataField="BankCode" />
								            <asp:HyperLinkColumn HeaderText="Bank Code" ItemStyle-Width="15%" HeaderStyle-Width="15%"
									            SortExpression="B.BankCode" 
									            DataNavigateUrlField="BankCode" 
									            DataNavigateUrlFormatString="HR_setup_BankDet.aspx?bankcode={0}" 
								            ...
								            <asp:TemplateColumn HeaderText="Status" ItemStyle-Width="10%" HeaderStyle-Width="10%" SortExpression="B.Status">
									            <ItemTemplate>
										            <%# objHRSetup.mtdGetBankStatus(Container.DataItem("Status")) %>
									            </ItemTemplate>
								            </asp:TemplateColumn>
						...
						<tr>
							<td>
					            <asp:ImageButton id=NewBankBtn OnClick="NewBankBtn_Click" imageurl="../../images/butt_new.gif" AlternateText="New Bank" runat="server"/>
