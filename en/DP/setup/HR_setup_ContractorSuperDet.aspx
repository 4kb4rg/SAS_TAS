	...
	<body>
		...
		<tr>
			...
			<table border=0 cellspacing=0 cellpadding=2 width=100% class="font9Tahoma">
				...
				<tr>
					<td class="mt-h" colspan="6">CONTRACTOR SUPERVISION DETAILS</td>
				</tr>
				<tr>
							...
							<tr>						
								<td>
									<TABLE cellSpacing="0" cellPadding="2" width="100%" border="0">
										...
										<TR class="mb-c">
											<TD colspan=2 height=25><asp:ImageButton id=btnAdd imageurl="../../images/butt_add.gif" alternatetext=Add onclick=btnAdd_Click runat=server />
                                            <asp:Button ID="AddBtn5" runat="server" class="button-small" Text="Add" />							
                                            </TD>
										</TR>
									</TABLE>
								</td>
