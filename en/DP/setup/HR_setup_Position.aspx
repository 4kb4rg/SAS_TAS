<%@ Page Language="vb" src="../../../include/HR_Setup_Position.aspx.vb" Inherits="HR_Setup_Position" %>
			...
			<tr>
				...
				<div class="kontenlist">
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						<tr>
							<td><strong>POSITION LIST</strong><hr style="width :100%" />   
                            </td>
						...
						<tr>
							...
							<table cellpadding="4" cellspacing="0" style="width: 100%">
								...
								<td width="15%" valign=bottom height="26">Position Code :<BR><asp:TextBox id=srchPositionCode width=100% maxlength="8" runat="server"/></td>
								<td width="40%" valign=bottom height="26">Description :<BR><asp:TextBox id=srchDesc width=100% maxlength="128" runat="server"/></td>
								...
								<td width="10%" valign=bottom height="26" align=left><asp:Button id="SearchBtn" Text="Search" OnClick=srchBtn_Click runat="server" class="button-small"/></td>
								</tr>
							</table>
						    ...
						    <tr>
							    ...
							    <table cellpadding="4" cellspacing="1" style="width: 100%">
						            ...
						            <asp:DataGrid id="EventData"
						                ...
						                <Columns>					
						                <asp:TemplateColumn HeaderText="Position Code" SortExpression="PositionCode" ItemStyle-Width="12%">
							                <ItemTemplate>
								                <%# Container.DataItem("PositionCode") %>
							                </ItemTemplate>
							                <EditItemTemplate>
								                <asp:TextBox id="PositionCode" MaxLength="8" width=95%
									                Text='<%# trim(Container.DataItem("PositionCode")) %>' runat="server"/><BR>
								                <asp:RequiredFieldValidator id=validateCode display=dynamic runat=server 
									                ErrorMessage="Please Enter Position Code"
									                ControlToValidate=PositionCode />
						                ...
						                <asp:TemplateColumn HeaderText="Description" SortExpression="Description" ItemStyle-Width="25%">
							                <ItemTemplate>
							                ...
							                <EditItemTemplate>
								                ...
								                <asp:RequiredFieldValidator id=validateDesc display=Dynamic runat=server 
									                ErrorMessage="Please Enter Position Description"
									                ControlToValidate=Description />															
							                </EditItemTemplate>
						                </asp:TemplateColumn>					
						                <asp:TemplateColumn SortExpression="FuncCode" ItemStyle-Width="13%">
							                <ItemTemplate>
								                <%# Container.DataItem("FuncCode") %>
							                </ItemTemplate>
							                <EditItemTemplate>
								                <asp:DropDownList id="FuncCode" width=100% runat=server/>
								                <asp:label id=lblFuncCode visible=false text='<%# Container.DataItem("FuncCode") %>' runat=server/>
							                </EditItemTemplate>
						                </asp:TemplateColumn>					
						                <asp:TemplateColumn HeaderText="Last Update" SortExpression="POS.UpdateDate" ItemStyle-Width="8%">
							                <ItemTemplate>
						                ...
						                <asp:TemplateColumn HeaderText="Status" SortExpression="POS.Status" ItemStyle-Width="8%">
							                <ItemTemplate>
								                <%# objHR.mtdGetPositionStatus(Container.DataItem("Status")) %>
							                </ItemTemplate>
							                <EditItemTemplate>
						                ...
						                <asp:TemplateColumn ItemStyle-Width="12%" ItemStyle-HorizontalAlign=center>					
							                <ItemTemplate>
						...
						<tr>
							<td>
					            <asp:ImageButton id=btnNew OnClick="DEDR_Add" imageurl="../../images/butt_new.gif" AlternateText="New Position Code" runat="server"/>
