<%@ Page Language="vb" src="../../../include/HR_Setup_Qualification.aspx.vb" Inherits="HR_Setup_Qualification" %>
			...
			<tr>
				...
				<div class="kontenlist">
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						<tr>
							<td><strong>QUALIFICATION LIST</strong><hr style="width :100%" />   
                            </td>
						...
						<tr>
							...
							<table cellpadding="4" cellspacing="0" style="width: 100%">
								...
								<td width="15%" height="26" valign=bottom>Qualification Code :<BR><asp:TextBox id=srchQualificationCode width=100% maxlength="8" runat="server"/></td>
						    ...
						    <tr>
							    ...
							    <table cellpadding="4" cellspacing="1" style="width: 100%">
					                ...
					                <asp:TemplateColumn HeaderText="Qualification Code" SortExpression="QualificationCode">
						                <ItemTemplate>
							                <%# Container.DataItem("QualificationCode") %>
						                </ItemTemplate>
						                <EditItemTemplate>
							                <asp:TextBox id="QualificationCode" MaxLength="8" width=95%
								                Text='<%# trim(Container.DataItem("QualificationCode")) %>' runat="server"/><BR>
							                <asp:RequiredFieldValidator id=validateCode display=dynamic runat=server 
								                ErrorMessage="Please Enter Qualification Code"
								                ControlToValidate=QualificationCode />
					                ...
					                <asp:TemplateColumn HeaderText="Description" SortExpression="Description">
						                ...
						                <EditItemTemplate>
							                ...
							                <asp:RequiredFieldValidator id=validateDesc display=Dynamic runat=server 
								                ErrorMessage="Please Enter Qualification Description"
								                ControlToValidate=Description />
						                </EditItemTemplate>
					                </asp:TemplateColumn>					
					                <asp:TemplateColumn HeaderText="Last Update" SortExpression="QUA.UpdateDate">
						                <ItemTemplate>
					                ...
					                <asp:TemplateColumn HeaderText="Status" SortExpression="QUA.Status">
						                <ItemTemplate>
						...
						<tr>
							<td>
					            <asp:ImageButton id=btnNew OnClick="DEDR_Add" imageurl="../../images/butt_new.gif" AlternateText="New Qualification Code" runat="server"/>
