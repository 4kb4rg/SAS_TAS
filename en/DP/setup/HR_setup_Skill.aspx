<%@ Page Language="vb" src="../../../include/HR_Setup_Skill.aspx.vb" Inherits="HR_Setup_Skill" %>
			...
			<tr>
				...
				<div class="kontenlist">
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						<tr>
							<td><strong>SKILL LIST</strong><hr style="width :100%" />   
                            </td>
						...
						<tr>
							...
							<table cellpadding="4" cellspacing="0" style="width: 100%">
								...
								<td width="15%" height="26" valign=bottom>Skill Code :<BR><asp:TextBox id=srchSkillCode width=100% maxlength="8" runat="server"/></td>
						    ...
						    <tr>
							    ...
							    <table cellpadding="4" cellspacing="1" style="width: 100%">
					                ...
					                <asp:TemplateColumn HeaderText="Skill Code" SortExpression="SkillCode">
						                <ItemTemplate>
							                <%# Container.DataItem("SkillCode") %>
						                </ItemTemplate>
						                <EditItemTemplate>
							                <asp:TextBox id="SkillCode" MaxLength="8" width=95%
								                Text='<%# trim(Container.DataItem("SkillCode")) %>'	runat="server"/><BR>
							                <asp:RequiredFieldValidator id=validateCode display=dynamic runat=server 
								                ErrorMessage="Please Enter Skill Code"
								                ControlToValidate=SkillCode />
					                ...
					                <asp:TemplateColumn HeaderText="Description" SortExpression="Description">
						                ...
						                <EditItemTemplate>
							                ...
							                <asp:RequiredFieldValidator id=validateDesc display=Dynamic runat=server 
								                ErrorMessage="Please Enter Skill Description"
								                ControlToValidate=Description />
						                </EditItemTemplate>
					                </asp:TemplateColumn>					
					                <asp:TemplateColumn HeaderText="Last Update" SortExpression="SK.UpdateDate">
						                <ItemTemplate>
					                ...
					                <asp:TemplateColumn HeaderText="Status" SortExpression="SK.Status">
						                <ItemTemplate>
						...
						<tr>
							<td>
					            <asp:ImageButton id=btnNew OnClick="DEDR_Add" imageurl="../../images/butt_new.gif" AlternateText="New Skill Code" runat="server"/>
