<%@ Page Language="vb" src="../../../include/HR_Setup_ICType.aspx.vb" Inherits="HR_Setup_ICType" %>
			...
			<tr>
				...
				<div class="kontenlist">
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						<tr>
							<td><strong>IDENTITY CARD TYPE LIST</strong><hr style="width :100%" />   
                            </td>
						...
						<tr>
							...
							<table cellpadding="4" cellspacing="0" style="width: 100%">
								...
								<td width="15%" height="26" valign=bottom>IC Type Code :<BR><asp:TextBox id=srchICTypeCode width=100% maxlength="8" runat="server"/></td>
						    ...
						    <tr>
							    ...
							    <table cellpadding="4" cellspacing="1" style="width: 100%">
					                ...
					                <Columns>					
					                <asp:TemplateColumn HeaderText="IC Type Code" SortExpression="ICTypeCode">
						                <ItemTemplate>
							                <%# Container.DataItem("ICTypeCode") %>
						                </ItemTemplate>
						                <EditItemTemplate>
							                <asp:TextBox id="ICTypeCode" MaxLength="8" width=95%
								                Text='<%# trim(Container.DataItem("ICTypeCode")) %>' runat="server"/><BR>
							                <asp:RequiredFieldValidator id=validateCode display=dynamic runat=server 
								                ErrorMessage="Please Enter Identification Card Type Code"
								                ControlToValidate=ICTypeCode />
