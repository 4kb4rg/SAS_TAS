<%@ Page Language="vb" src="../../../include/HR_setup_ShiftList.aspx.vb" Inherits="HR_setup_ShiftList" %>
			...
			<tr>
				...
				<div class="kontenlist">
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						<tr>
							<td><strong>SHIFT LIST</strong><hr style="width :100%" />   
                            </td>
						...
						<tr>
							...
							<table cellpadding="4" cellspacing="0" style="width: 100%">
								...
								<td width="15%" height="26" valign=bottom>Shift Code :<BR><asp:TextBox id=txtShiftCode width=100% maxlength="8" runat="server" /></td>
						    ...
						    <tr>
							    ...
							    <table cellpadding="4" cellspacing="1" style="width: 100%">
						            ...
						            <asp:DataGrid id=dgLine runat=server
							            ...
							            <Columns>
								            <asp:BoundColumn Visible=False HeaderText="Shift Code" DataField="ShiftCode" />
								            <asp:HyperLinkColumn HeaderText="Shift Code" ItemStyle-Width="15%"
									            SortExpression="S.ShiftCode" 
									            DataNavigateUrlField="ShiftCode" 
									            DataNavigateUrlFormatString="HR_setup_ShiftDet.aspx?shiftcode={0}" 
								            ...
								            <asp:TemplateColumn HeaderText="Status" ItemStyle-Width="10%" SortExpression="S.Status">
									            <ItemTemplate>
						...
						<tr>
							<td>
					            <asp:ImageButton id=NewBtn OnClick="NewBtn_Click" imageurl="../../images/butt_new.gif" AlternateText="New Shift" runat="server"/>
