<%@ Page Language="vb" src="../../../include/HR_Setup_Religion.aspx.vb" Inherits="HR_Setup_Religion" %>
					...
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						...
						<tr>
							...
							<table cellpadding="4" cellspacing="0" style="width: 100%">
								...
								<td width="15%" height="26" valign=bottom><asp:label id="lblReligion" runat="server" /> Code :<BR><asp:TextBox id=srchReligionCode width=100% maxlength="8" runat="server"/></td>
						    ...
						    <tr>
							    ...
							    <table cellpadding="4" cellspacing="1" style="width: 100%">
					                ...
					                <Columns>					
					                <asp:TemplateColumn SortExpression="ReligionCode">
						                <ItemTemplate>
							                <%# Container.DataItem("ReligionCode") %>
						                </ItemTemplate>
						                <EditItemTemplate>
							                <asp:TextBox id="ReligionCode" MaxLength="8" width=95%
								                Text='<%# trim(Container.DataItem("ReligionCode")) %>' runat="server"/><BR>
							                <asp:RequiredFieldValidator id=validateCode display=dynamic runat=server 
								                ControlToValidate=ReligionCode />
					                ...
					                <asp:TemplateColumn HeaderText="Last Update" SortExpression="REL.UpdateDate">
						                <ItemTemplate>
					                ...
					                <asp:TemplateColumn HeaderText="Status" SortExpression="REL.Status">
						                <ItemTemplate>
						...
						<tr>
							<td>
					            <asp:ImageButton id=btnNew OnClick="DEDR_Add" imageurl="../../images/butt_new.gif" AlternateText="New Religion Code" runat="server"/>
