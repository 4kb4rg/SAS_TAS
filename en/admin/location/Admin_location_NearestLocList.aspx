	...
	<Preference:PrefHdl id=PrefHdl runat="server" />
		<body>
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" class="font9Tahoma">
				...
				<tr>
					<td class="font9Tahoma" colspan="4" width=60%><asp:label id="lblTitle" runat="server" /> LIST</td>
					...
					<td colspan=6 width=100% class="mb-c">
						<table width="100%" cellspacing="0" cellpadding="3" border="0" align="center">
							<tr class="mb-t">
								...
								<td width="8%" height="26" valign=bottom align=right><asp:Button  Text="Search" OnClick=srchBtn_Click runat="server" class="button-small"/></td>
							</tr>
						</table>
					</td>
				</tr>
