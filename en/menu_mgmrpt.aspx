<%@ Page Language="vb" src="../include/menu_mgmrpt.aspx.vb" Inherits="menu_mgmrpt" %>
	...
	<tr>
		...
		<table cellpadding="0" cellspacing="0" style="width: 100%; height: 0px;">
		 ...
		 <asp:Image runat="server" ID="Image1" ImageUrl="images/thumbs/btlogout.png" ToolTip="Log Off" CssClass="button" /></a>
				...
				<td class="style2" valign="center"><img height="35px" src="images/iconmm.png" width="40px" /><span class="font14">R E P O R T &nbsp;&nbsp;  M A N A G E M E N T</span></td>
				<td valign="top">
				    &nbsp;</td>
				<td valign="top">
        ...
        <div style="width:100%; height:1000px; position:absolute; top:40px; z-index:500; left: 0px;" >
          <igtab:UltraWebTab   ID="UltraWebTab1" runat="server" Width="100%"  Height="100%" BorderStyle="None" 
            ...
            <RoundedImage LeftSideWidth="0" RightSideWidth="0" SelectedImage="./imagess/thumbs/ig_tab_winXP1.gif"
                NormalImage="./images/thumbs/ig_tab_winXP3.gif" HoverImage="./imagess/thumbs/ig_tab_winXP2.gif"
            ...
            <Tabs>
                ...
                <igtab:Tab Key="rpt" DefaultImage="../images/icon3.png" Tooltip="Reports Application">
                    <ContentPane BorderStyle="None" TargetUrl="menu_mgmrptall.aspx" Scrollable="Hidden">
                    </ContentPane>
                </igtab:Tab>
...
<%--<body style="padding-right: 0px; padding-left: 0px; margin-left: 0px; margin-right: 0px; margin-bottom:0px">
	...
	<tr>
		...
		<table style="width: 100%; " cellpadding="0" cellspacing="0">
			<tr>
				...
				<td style="width: 100%"><span class="font14">&nbsp;&nbsp;Material Management</span></td>
				<td valign="bottom">
   ...
   <div style="position:absolute; right:5px; top:5px; width:650px; padding:0px 0px 0px 0px; display:block; height:100px">
		...
		<asp:Image runat="server" ID="imgLogOff" ImageUrl="images/thumbs/LogOff.gif" ToolTip="Log Off"/></a>
         ...
         <div style="width:100%; height:1000px; position:absolute; top:85px; z-index:600; left: 0px;" >
           ...
           <Tabs>
                <igtab:Tab Key="trx" Text="Transaction" Tooltip="Transaction Application">
                    <ContentPane BorderStyle="None" TargetUrl="menu_mmtrx.aspx"  Scrollable="Hidden">
                    </ContentPane>
                </igtab:Tab>
                <igtab:TabSeparator>
                </igtab:TabSeparator>
                <igtab:Tab Key="stp" Text="Setup" Tooltip="Setup Application">
                    <ContentPane BorderStyle="None" TargetUrl="menu_mmstp.aspx" Scrollable="Hidden">
                    </ContentPane>
                ...
                <igtab:Tab Key="rpt" Text="Reports" Tooltip="Reports Application">
                    <ContentPane BorderStyle="None" TargetUrl="menu_mmrpt.aspx" Scrollable="Hidden">
                    </ContentPane>
                ...
                <igtab:Tab key="mth" Text="Month End" Tooltip="Month End Processing">
                    <ContentPane BorderStyle="None" TargetUrl="menu_mmmth.aspx" Scrollable="Hidden">
                    </ContentPane>
                    
                </igtab:Tab>
                 <igtab:TabSeparator>
                </igtab:TabSeparator>
                <igtab:Tab Key="rpt" Text="Data Transfer" Tooltip="Data Transfer Application">
                    <ContentPane BorderStyle="None" TargetUrl="menu_mmdt.aspx" Scrollable="Hidden">
                    </ContentPane>
