<%@ Page Language="vb" trace="False"  SmartNavigation="True" src="../../../include/BD_setup_NurseryActivity.aspx.vb" Inherits="BD_NurseryActivity_Format" %>
	...
	<Preference:PrefHdl id=PrefHdl runat="server" />
		<body>
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%">
				...
				<tr>
					<td class="mt-h" colspan="4" width=60%><asp:label id=lblTitle text="NURSERY ACTIVITY" runat=server /></td>
				...
				<tr>
					...
					<asp:TemplateColumn >
						...
						<EditItemTemplate>
							<asp:Label id="lblAcc" Text=<%# Container.DataItem("AccCode") %> visible=false runat="server" />
					...
					<asp:TemplateColumn HeaderText ="Item" >
						...
						<EditItemTemplate>
							<asp:Label id="lblTxID" Text=<%# trim(Container.DataItem("NurseryActID")) %> visible=false runat="server" />
				...
				<tr>
					<td align="left" ColSpan=6>
						<asp:ImageButton id=ibNew OnClick="DEDR_Add" imageurl="../../images/butt_new.gif" AlternateText="New Nursery Activity" runat="server"/>
					</td>
				</tr>
			</table>
				</FORM>
