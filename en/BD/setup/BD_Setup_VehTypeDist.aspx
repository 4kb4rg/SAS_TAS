			    ...
			    <tr>
				    ...
				    <div class="kontenlist">
					    <table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						    <tr>
							    <td><strong>VEHICLE TYPE DISTRIBUTION</strong><hr style="width :100%" />   
                                </td>
						    </tr>
                            <tr>
                                <td>
						...
						<Columns>						
							<asp:TemplateColumn HeaderStyle-HorizontalAlign=Left ItemStyle-HorizontalAlign=Left SortExpression="ActCode">
								...
								<EditItemTemplate>
									...
									<asp:Label ID="Label1" Text='<%# Container.DataItem("Act") %>' runat="server" />
								</EditItemTemplate>
							</asp:TemplateColumn>
							...
							<asp:TemplateColumn HeaderStyle-HorizontalAlign=Left ItemStyle-HorizontalAlign=Left SortExpression="VehCode">
								...
								<EditItemTemplate>
									...
									<asp:Label ID="Label2" Text='<%# Container.DataItem("Veh") %>' runat="server" />
								</EditItemTemplate>
							</asp:TemplateColumn>
						...
						<tr>
							<td>
					            <asp:ImageButton id=ibAdd OnClick="DEDR_Add" imageurl="../../images/butt_add.gif" AlternateText="Add" runat="server"/>
							</td>
						</tr>
                        <tr>
                            <td>
