			...
			<tr>
				...
				<div class="kontenlist">
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
				        ...
				        <tr>
					        <td colspan=6><asp:label id="lblErrCopyTemp" forecolor=red text="Error occuring while copying setup templates to next period." Visible = false Runat="server"/><hr style="width :100%" />   </td>
				        </tr>	
