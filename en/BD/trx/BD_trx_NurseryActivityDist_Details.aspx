<%@ Page Language="vb" trace="false" SmartNavigation="True" src="../../../include/BD_trx_NurseryActivityDist_Details.aspx.vb" Inherits="BD_NurseryActivityDist_Details" %>
	...
	<Preference:PrefHdl id=PrefHdl runat="server" />
		<body>
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" runat=server >
				...
				<tr>
					<td class="mt-h" colspan="4" width=60%>NURSERY ACTIVITY CALENDERISATION</td>
			...
			<table cellpadding="2" cellspacing="0" runat="server">
				<tr id="trPeriodTitle" runat="server">
					<td style="width:100px;" nowrap>&nbsp; <!-- Account Code --></td>
					<td style="width:200px;" nowrap>&nbsp; <!-- Description --></td>
					<td style="width:100px;" nowrap>&nbsp; <!-- Year Budget --></td>
					<td style="width:100px;" nowrap>&nbsp; <!-- Total Add Vote --></td>
					<td style="width:50px;" nowrap>&nbsp; <!-- Edit --></td>
				</tr>
			</table>
			<asp:DataGrid id="dgNurseryActivityDist"
				...
				<Columns>
					<asp:TemplateColumn >
						...
						<ItemTemplate  >
							...
							<asp:label id="lblNurseryActDistID" width=300px visible=false Text='<%# trim(Container.DataItem("NurseryActDistID")) %>' runat="server"/>
						</ItemTemplate>
					</asp:TemplateColumn>																																		
