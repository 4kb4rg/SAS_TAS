<%@ Page Language="vb" SmartNavigation="True" trace="false" src="../../../include/BD_trx_NurseryActivity_Det_DistByBlock.aspx.vb" Inherits="BD_trx_NurseryActivity_Det_DistByBlock" %>
	...
	<Preference:PrefHdl id=PrefHdl runat="server" />
		<body>
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%">
				...
				<tr>
					<td class="mt-h" colspan="4" width=60%><asp:label id=lblTitleNurseryAct text="NURSERY ACTIVITY" runat=server /></td>
				...
				<tr>
					<TD colspan = 6 >					
					<asp:DataGrid id="dgNurseryActivityDetDist"
