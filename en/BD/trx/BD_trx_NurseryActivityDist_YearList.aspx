<%@ Page Language="vb" trace="False" src="../../../include/BD_trx_NurseryActivityDist_YearList.aspx.vb" Inherits="BD_NurseryActivityDist_Year" %>
							    ...
							    <table cellpadding="4" cellspacing="1" style="width: 100%">
						            ...
						            <asp:DataGrid id="BlockList"
						                ...
						                <Columns>	
							                <asp:TemplateColumn>
								                <ItemTemplate>
									                <asp:LinkButton id="lbblkcode" Text=<%# Container.DataItem("OriBlkCode") %> CommandArgument=<%# Container.DataItem("BlkCode") %> onClick="btnBlockYear_Click" runat="server" />
								                </ItemTemplate>
							                </asp:TemplateColumn>
													
							                <asp:TemplateColumn >
								                <ItemTemplate>
									                <asp:LinkButton id="lbsubblkcode" Text=<%# Container.DataItem("BlkCode") %> CommandArgument=<%# Container.DataItem("OriBlkCode") %> onClick="btnSubBlockYear_Click" runat="server" />
								                </ItemTemplate>
							                </asp:TemplateColumn>
						                </Columns>
					                </asp:DataGrid>
