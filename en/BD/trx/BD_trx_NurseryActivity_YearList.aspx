<%@ Page Language="vb" trace="False" src="../../../include/BD_trx_NurseryActivity_YearList.aspx.vb" Inherits="BD_NurseryActivity_Year" %>
			...
			<tr>
				...
				<div class="kontenlist">
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
				        ...
				        <tr>
                            <td class="font9Tahoma"><table cellpadding="4" cellspacing="0" style="width: 100%">
                            <td class="style2"4" cellspacing="0">
				        ...
				        <tr>
                            <td class="font9Tahoma"><table cellpadding="4" cellspacing="0" style="width: 100%">
					        <td colspan="6" align=center><asp:label id="lblErrNurserySeed" text="Nursery Seed transaction have not been done! " forecolor=red runat="server"/></td>
				            </table></td>
                        </tr>
							    ...
							    <table cellpadding="4" cellspacing="1" style="width: 100%">
						            ...
						            <asp:DataGrid id="YearList"
						                ...
						                <Columns>
							                <asp:TemplateColumn>
								                <ItemTemplate>
									                <asp:LinkButton id="lbblkcode" Text=<%# Container.DataItem("OriBlkCode") %> CommandName=<%# Container.DataItem("BlkCode") %> onClick="btnBlockYear_Click" runat="server" />
								                </ItemTemplate>
							                </asp:TemplateColumn>						
							                <asp:TemplateColumn >
								                <ItemTemplate>
									                <asp:LinkButton id="lbsubblkcode" Text=<%# Container.DataItem("BlkCode") %> CommandName=<%# Container.DataItem("OriBlkCode") %> onClick="btnSubBlockYear_Click" runat="server" />
								                </ItemTemplate>
							                </asp:TemplateColumn>
						                </Columns>
					                </asp:DataGrid>
						...
						<tr>
					        <TD colspan = 6 align=center>					
						        ...
						        <asp:Label id=lblBlockErr Text="Please Check Block Info." Forecolor=Red Visible=False runat=server />
					        </td>
				        </tr>
					</table>
				</div>
