<%@ Page Language="vb" trace="False" src="../../../include/BD_trx_PlantationOHDist_Distribute.aspx.vb" Inherits="BD_PlantationOH_Dist" %>
...
<html>
	<head>
		...
		<body onload="this.focus()" >
			...
			<asp:label id="lblOverheadDistID" visible=False runat="server"/>
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%">
				...
				<!--<tr>
					<td colspan="4" width=60%><asp:label id="lblCost" text="Year of Planting " runat="server"/> : <asp:label id="lblYear" runat="server"/></td>
					<td align="right" colspan="2" width=40%>&nbsp;</td>
				</tr>-->
				<tr>
