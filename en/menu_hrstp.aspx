				...
				<td valign="top">
                    ...
                    <div class="panel">
                        <table id="tlbStpPR_Estate"  cellSpacing="1" cellPadding="0" width="100%" border="0" runat="server">
							...
							<tr>
								<td><a href="#"><div class="childmenu">
                                <asp:hyperlink id="Hyperlink36" runat="server" NavigateUrl="/en/PR/setup/PR_setup_RapelList_Estate.aspx" target="middleFrame" text="Rapel Upah" cssclass="lb-mt"></asp:hyperlink>
                                </div></a></td>
							</tr>
							<tr>
								<td><a href="#"><div class="childmenu">
                                <asp:hyperlink id="Hyperlink37" runat="server" NavigateUrl="/en/PR/setup/PR_setup_THRList.aspx" target="middleFrame" text="Tunjangan Hari Raya" cssclass="lb-mt"></asp:hyperlink>
                                </div></a></td>
							</tr>
						</table>
					</div>
