				...
				<td valign="top">
					...
					<div class="panel">
						<table cellpadding="0" cellspacing="1" style="width: 254px">
							...
							<tr>
								<td><a href="#"><div class="fathermenu">Reporting</div></a></td>
							</tr>
							<tr>
								<td><a href="#"><div class="fathermenu">Transaction</div></a></td>
							</tr>
							<tr>
								<td><a href="#"><div class="childmenu">Purchase Requisition</div></a></td>
							</tr>
							<tr>
								<td><a href="#"><div class="childmenu">Stock Receive</div></a></td>
							</tr>
							<tr>
								<td><a href="#"><div class="childmenu">Stock Adjustment</div></a></td>
							</tr>
							<tr>
								<td><a href="#"><div class="childmenu">Stock Transfer</div></a></td>
							</tr>
							<tr>
								<td><a href="#"><div class="childmenu">Stock Transfer Divisi</div></a></td>
							</tr>
							<tr>
								<td><a href="#"><div class="childmenu">Stock Return</div></a></td>
							</tr>
						</table>
					</div>
			     ...
			     <table id="tblINHead" cellSpacing="0" cellPadding="0" width="100%" border="0" runat="server">
						...
						<table id="tblIN" style="VISIBILITY: hidden; POSITION: absolute" cellSpacing="0" cellPadding="0"
							...
							<tr height="20">
								<td width="20"></td>
								<td width="14">&nbsp;<IMG src="images/leftdot.gif" border="0" width="1" height="1"></td>
								<td class="lb-mti"><asp:hyperlink class="lb-mt" id="lnkIN01_APP" runat="server" NavigateUrl="/en/IN/Trx/IN_PurReq_APP.aspx" target="middleFrame" text="Requisition Approval"></asp:hyperlink></td>
							</tr>
							<tr height="20">
								<td width="20" ></td>
								<td width="14">&nbsp;<IMG src="images/leftdot.gif" border="0" width="1" height="1"></td>
								<td class="lb-mti"><asp:hyperlink class="lb-mt" id="lnkIN01_MTR" runat="server" NavigateUrl="/en/IN/Trx/IN_PurReq_MTR.aspx" target="middleFrame" text="Requisition Monitor"></asp:hyperlink></td>
							</tr>
							<tr height="20">
								<td width="20"></td>
								<td width="14">&nbsp;<IMG src="images/leftdot.gif" border="0" width="1" height="1"></td>
						...
						<table id="tblPU" style="VISIBILITY: hidden; POSITION: absolute" cellSpacing="0" cellPadding="0"
                            ...
                            <tr height="20">
								<td width="20"></td>
								<td width="14">&nbsp;<IMG src="images/leftdot.gif" border="0" width="1" height="1"></td>
								<td class="lb-mti"><asp:hyperlink class="lb-mt" id="lnkPU06" runat="server" NavigateUrl="/en/PU/Trx/PU_Trx_PelimpahanUser.aspx" target="middleFrame" text="PR Assign To User"></asp:hyperlink></td>
							</tr>
							...
							<tr height="20">
								<td width="20"></td>
								<td width="14">&nbsp;<IMG src="images/leftdot.gif" border="0" width="1" height="1"></td>
								<td class="lb-mti"><asp:hyperlink class="lb-mt" id="lnkPU01" runat="server" NavigateUrl="/en/PU/Trx/pu_trx_RPHList.aspx" target="middleFrame" text="Quotation (DTH)"></asp:hyperlink></td>
							</tr>
							<tr height="20">
								<td width="20"></td>
								<td width="14">&nbsp;<IMG src="images/leftdot.gif" border="0" width="1" height="1"></td>
                        ...
                        <table id="tblDATAHead" cellSpacing="0" cellPadding="0" width="100%" runat="server">
							<tr height="20">
								<td width="20"></td>
								<td width="14"><IMG src="images/arow.gif" border="0" align="left" width="5" height="8"></td>
								<td class="lb-hti"><A class="lb-tti" href="javascript:togglebox(tblDATA);">Data Collection</A></td>
							</tr>
						</table>
				        <table id="tblDATA" style="VISIBILITY: hidden; POSITION: absolute" cellSpacing="0" cellPadding="0"
							width="100%" border="0" runat="server">
							<tr height="20">
								<td width="20"></td>
								<td width="14">&nbsp;<IMG src="images/leftdot.gif" border="0" width="1" height="1"></td>
								<td class="lb-mti"><asp:hyperlink class="lb-mt" id="Hyperlink2" runat="server" NavigateUrl="/en/IN/Trx/IN_PurReq_MTR.aspx" target="middleFrame" text="Requisition Monitor"></asp:hyperlink></td>
							</tr>
							<tr height="20">
								<td width="20"></td>
								<td width="14">&nbsp;<IMG src="images/leftdot.gif" border="0" width="1" height="1"></td>
								<td class="lb-mti"><asp:hyperlink class="lb-mt" id="Hyperlink3" runat="server" NavigateUrl="/en/PU/Trx/PU_trx_PO_MTR.aspx" target="middleFrame" text="Purchasing Monitor"></asp:hyperlink></td>
							</tr>
							<tr height="20">
                                <td width="20"></td>
                                <td width="14"></td>
                                <td class="lb-mti">
                                    <asp:HyperLink ID="lnkStpINRequest" runat="server" CssClass="lb-mt" NavigateUrl="/en/IN/setup/IN_StockMaster_Request.aspx"
                                        Target="middleFrame" Text="Request Stock Master"></asp:HyperLink></td>
                            </tr>
                            <tr height="20">
								<td width="20"></td>
								<td width="14">&nbsp;<IMG src="images/leftdot.gif" border="0" width="1" height="1"></td>
