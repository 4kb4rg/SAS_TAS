<%@ Page Language="vb" src="../../../include/RC_trx_JournalDet.aspx.vb" Inherits="RC_trx_JournalDet" %>
<%@ Register TagPrefix="UserControl" Tagname="MenuRC" src="../../menu/menu_rctrx.ascx"%>
<%@ Register TagPrefix="Preference" Tagname="PrefHdl" src="../../include/preference/preference_handler.ascx"%>

<html>
	<head>
		<title>Reconciliation Journal Details</title>
	...
	<body>
		...
		<TABLE id="tblHeader" cellSpacing="0" cellPadding="2" width="100%" border="0" class="font9Tahoma">
			...
			<tr>
				<td class="mt-h" colspan="5">RECONCILIATION JOURNAL DETAILS</td>
			</tr>
			<tr>
				<td colspan=5><hr size="1" noshade></td>
			</tr>
			<TR>
				<TD vAlign="top" height=25 width="20%">Journal ID :</TD>
				<TD vAlign="top" width="30%"><asp:Label id=lblJournalId runat=server /></TD>
				<TD width="2%"></TD>
				<TD vAlign="top" width="20%">Account Period:</TD>
				<TD vAlign="top" width="28%"><asp:Label id=lblAccPeriod runat=server /></TD>
			</TR>
			<TR>
				<TD vAlign="top" height=25>Journal Ref No :</TD>
				<TD vAlign="top">
					<asp:Textbox id=txtJournalRefNo width=100% maxlength=32 runat=server/> 
				</TD>
				<TD></TD>
			...
			<TR>
				<TD vAlign="top" height=25>Document :</TD>
				<TD vAlign="top">
					<asp:DropDownList id=ddlDocument width=100% runat=server>
						<asp:ListItem value="1">Debit Note</asp:ListItem>
						<asp:ListItem value="2">Credit Note</asp:ListItem>
			...
			<TR>
				<TD vAlign="top" height=25><asp:Label id=lblDocType Text="Journal Type : " runat=server/></TD>
			...
			<TR>
				<TD colSpan="5" vAlign="top">
					<table width="100%" class="mb-c" cellspacing="0" cellpadding="6" border="0" align="center">
						<tr>						
							<td>
								<TABLE id="tblSelection" cellSpacing="0" cellPadding="1" width="100%" border="0" runat=server>
									<TR class="mb-c">
										<TD vAlign="top" height=25><asp:label id=lblAccount runat=server /> Code :*</TD>
										<TD vAlign="top" colspan=5>
											<asp:DropDownList id=ddlAccount width=90% runat=server/> 
											<input type="button" id=btnFind1 value=" ... " onclick="javascript:findcode('frmMain','','ddlAccount','1','','','','','','','','','','','','',hidBlockCharge.value,hidChargeLocCode.value);" runat=server/>
											<asp:Label id=lblErrAccount visible=false forecolor=red runat=server/>
										</TD>
									</TR>
									<TR class="mb-c">
										<TD vAlign="top" height=25>Description :*</TD>
										<TD vAlign="top" colspan=5>
											<asp:Textbox id=txtDescription width=100% maxlength=128 runat=server/>
											<asp:Label id=lblErrDescription visible=false forecolor=red text="<br>Please enter description." runat=server/>
										</TD>
									</TR>
									<tr class="mb-c">
										<td height=25 width=20%>Quantity :*</td>
										<td width=20%>
											<asp:Textbox id=txtQty OnKeyUp="javascript:calAmount();" width=100% maxlength=21 runat=server/>
											...
											<asp:RegularExpressionValidator id=revTotalUnits 
												...
												runat="server"/>
											<asp:Label id=lblErrTotalUnits visible=false forecolor=red text="<br>Please enter quantity." runat=server/>
										</td>
					...
					<asp:DataGrid id=dgLineDet
						...
						<Columns>						
							...
							<asp:TemplateColumn HeaderText="Quantity" HeaderStyle-HorizontalAlign=Right ItemStyle-HorizontalAlign=Right>
								<ItemTemplate> 
									<asp:Label Text=<%# FormatNumber(Container.DataItem("Qty"), 2) %> id="lblQty" runat="server" />
								</ItemTemplate>
							</asp:TemplateColumn>
							...
							<asp:TemplateColumn ItemStyle-HorizontalAlign=Right>
								<ItemTemplate>
									<asp:label id=jrnlnid visible="false" text=<%# Container.DataItem("JournalLnId")%> runat="server" />
			...
			<TR>
				<TD colSpan="5">
					<asp:Label id=lblErrTotal forecolor=red visible=false text="Cannot confirm zero amount journal.<br>" runat=server/>
					...
					<Input type=hidden id=jrnid value="" runat=server />
				</TD>
			</TR>
