<%@ Page Language="vb" src="../../../include/RC_trx_download.aspx.vb" Inherits="RC_trx_download" %>
<%@ Register TagPrefix="UserControl" Tagname="MenuRCData" src="../../menu/menu_RCData.ascx"%>
<%@ Register TagPrefix="Preference" Tagname="PrefHdl" src="../../include/preference/preference_handler.ascx"%>
<html>
	<head>
		<title>Download Transaction File</title>
	</head>
	<Preference:PrefHdl id=PrefHdl runat="server" />
	<body>
		<table border="0" width="100%" cellpadding="1" cellspacing="0">
			<tr>
				<td width="100%" align=center><UserControl:MenuRCData id=MenuRCData runat="server" /></td>
			</tr>
			<tr>
				<td width="100%">
					...
					<table id=tblDownload border="0" cellpadding="0" cellspacing="0" width="100%" runat=server>
						...
						<tr>
							<td width="100%" colspan="4">Reconciliation Transaction Data</td>
						</tr>
						<tr>
						...
						<tr>
							<td>&nbsp;</td>
							<td colspan=3><asp:CheckBox id=cbStkTrf text="Stock Transfer" runat=server /></td>
						</tr>
						<tr>
							<td>&nbsp;</td>
							<td colspan=3><asp:CheckBox id=cbStkRcv text="Stock Receive" runat=server /></td>
						</tr>
						<tr>
							<td>&nbsp;</td>
							<td colspan=3><asp:CheckBox id=cbGRN text="Goods Return Note" runat=server /></td>
						</tr>
						<tr>
							<td>&nbsp;</td>
							<td colspan=3><asp:CheckBox id=cbBill text="Billing Debit Note & Credit Note" runat=server /></td>
						</tr>
						<tr>
							<td>&nbsp;</td>
							<td colspan=3><asp:CheckBox id=cbJournal text="General Ledger Journal" runat=server /></td>
						</tr>
						<tr>
