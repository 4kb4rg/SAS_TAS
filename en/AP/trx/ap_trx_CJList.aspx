...
<%--	<Preference:PrefHdl id=PrefHdl runat="server" />--%>
	...
	<body>
	    <form id=frmCJList runat="server" class="main-modul-bg-app-list-pu">
			...
			<tr>
				...
				<div class="kontenlist">
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						<tr>
							<td><strong>CREDITOR JOURNAL LIST</strong><hr style="width :100%" />   
                            </td>
						...
						<tr>
							...
							<table cellpadding="4" cellspacing="0" style="width: 100%">
								...
								<td valign=bottom width=20%>Creditor Journal ID :<BR><asp:TextBox id=txtCJID width=100% maxlength="32" CssClass="fontObject" runat="server" /></td>
								<td valign=bottom width=25%>Supplier Code :<BR><asp:TextBox id=txtSupplier width=100% maxlength="20" CssClass="fontObject"  runat="server"/></td>
								...
								<td valign=bottom width=20%>Last Updated By :<BR><asp:TextBox id=txtLastUpdate width=100% maxlength="128" CssClass="fontObject"  runat="server"/></td>
