...
<html>
	...
	<script language="javascript">
	        ...
	        function calTaxPrice() {
				...
				doc.txtTaxAmount.value = newnumber;
				if (doc.txtTaxAmount.value == 'NaN')
					doc.txtTaxAmount.value = '';
				else
					doc.txtTaxAmount.value = doc.txtTaxAmount.value;
			}
	</script>		
	<body>
		...
		<tr>
			...
			<tr>
				...
				<td width="40%"><asp:Label id=lblInvoiceRcvID runat=server /></td>
				<td width="5%">&nbsp;</td>
			...
			<tr>
				...
				<td>
					<asp:TextBox ID=txtInvoiceRcvRefNo maxlength=32 width=85% CssClass="fontObject" Runat=server />
			...
			<tr>
				...
				<td><asp:TextBox ID=txtInvoiceRcvRefDate maxlength=10 width=25% CssClass="fontObject" Runat=server />
			...
			<tr>
				...
				<td><asp:DropDownList id=ddlPO width=85%  autopostback=true onSelectedIndexChanged=onSelect_Change CssClass="fontObject" runat=server />
				    <input type=button value=" ... " id="Find" onclick="javascript:PopPO('frmMain', '', 'ddlPO', 'True');" CausesValidation=False runat=server class="button-small" />
			...
			<tr>
				...
				<td><!-- <asp:Label ID=lblSupplier runat=server /> -->
					<asp:DropDownList id=ddlSuppCode width=85% autopostback=true onSelectedIndexChanged=onSelect_Supp CssClass="fontObject" runat=server />
			...
			<tr>
				...
				<td><asp:TextBox ID=txtCreditTerm maxlength=3 width=10% CssClass="fontObject" Runat=server /> Days
				...
				<td>&nbsp;</td>
				<td><asp:Label id=Label10 text="PPh" Font-Bold=true runat=server /></td>
				<td><asp:CheckBox id="chkTaxes" Text="  No" checked=false AutoPostBack=true OnCheckedChanged=Taxes_changed runat=server /></td>
			</tr>
			<tr>
				...
				<td>&nbsp;</td>
				<td>KPP :</td>
				<td><asp:DropDownList id="ddlKPPInit" width="90%" CssClass="fontObject" runat="server" /></td>
			</tr>
			<tr>
				...
				<td>&nbsp;</td>
				<td>Tax Init :</td>
				<td><asp:DropDownList id="ddlTaxObjectGrp" OnSelectedIndexChanged="TaxObjectGrp_Changed" autopostback=true width="90%" runat="server" /></td>
			</tr>
			<tr>
			    <td height=25>Supplier Invoice Amount : </td>
				<td><asp:TextBox ID=txtSplInvAmt maxlength=10 width=50% text=0 style="text-align:right" CssClass="fontObject" Runat=server /> 
				...
				<td>&nbsp;</td>
				<td>Tax Object :</td>
				<td><asp:DropDownList id="ddlTaxObject" width="90%" OnSelectedIndexChanged="TaxObject_Changed" autopostback=true  CssClass="fontObject" runat="server" /></td>
			</tr>
			<tr>
	            ...
	            <td>&nbsp;</td>
				<td>DPP Amount : </td>
				<td><asp:TextBox ID=txtDPPAmount maxlength=10 width=90% text=0 style="text-align:right" OnKeyUp="javascript:calTaxPrice();" CssClass="fontObject" Runat=server /> 
					...
					<asp:RequiredFieldValidator id="RequiredFieldValidator3" runat="server" 
						display="dynamic" 
						ControlToValidate="txtDPPAmount"
						Text="Please enter dpp amount" />
					<asp:Label id=Label2 visible=false forecolor=red text="Please enter dpp amount." runat=server />
				</td>
		    </tr>	
		    <tr>
                ...
                <td>&nbsp;</td>
                <td>Tax Amount : </td>
				<td><asp:TextBox ID=txtTaxAmount maxlength=10 width=90% text=0 style="text-align:right" CssClass="fontObject" Runat=server /> 
				    <asp:RegularExpressionValidator id=RegularExpressionValidator2 												
						ControlToValidate="txtTaxAmount"												
					...
					<asp:Label id=Label1 visible=false forecolor=red text="Please enter tax amount." runat=server />
				</td>
			</tr>
			<tr>
				<td height=25></td>
			...
			<tr>
			    <td height=25>VAT Credited</td>
				<td><asp:CheckBox id=chkPPNCredited text="" runat=server/></td>
				<td>&nbsp;</td>
			</tr>
							...
							<td>-->
								<table id="tblSelection" cellSpacing="0" cellPadding="2" width="100%" border="0" runat=server>
									<tr class="mb-c">
										...
										<td colSpan="5"><asp:DropDownList id="lstItem" Width=95% runat=server EnableViewState=True onSelectedIndexChanged=ItemIndexChanged autopostback=true onchange="javascript:ChkUnmatchUnitCost();" />
									...
									<tr class="mb-c">
										...
										<td colSpan="5" style="height: 28px">
                                            ...
                                            <input type="button" id=btnFind1 value=" ... " onclick="javascript:PopCOA_Desc('frmMain', '', 'txtAccCode', 'txtAccName', 'False');" class="button-small" runat=server/>
                                            <asp:Button ID="CoaChangeButton2" runat="server" Font-Bold="True" OnClick="onSelect_Account"
                                                Text="Click Here" CssClass="button-small" ToolTip="Click Here" Width="65px" />
									...
									<tr id="RowBlk" class="mb-c">
										...
										<td colSpan="5"><asp:DropDownList id=ddlBlock width=95% runat=server/>
											<asp:Label id=lblErrBlock visible=false forecolor=red runat=server/>
										</td>
									</tr>
									<tr class="mb-c">
										<td height=25><asp:label id=lblVehicle runat=server /> :</td>
										<td colSpan="5"><asp:Dropdownlist id=ddlVehCode width=95% runat=server/>
									...
									<tr class="mb-c">
										...
										<td colSpan="5"><asp:Dropdownlist id=ddlVehExpCode width=95% runat=server/>
											<asp:Label id=lblErrVehicleExp visible=false forecolor=red runat=server/>
										</td>
									</tr>
									<tr class="mb-c">
										<td width="20%" height=25>Invoice Quantity :*</td>
										<td width="30%"><asp:TextBox id=txtQty width=60% Text=0 style="text-align:right" maxlength=22 runat=server />
									...
									<tr class="mb-c">
										...
										<td><asp:TextBox id=txtCost width=60% maxlength=21 Text=0 style="text-align:right" runat=server OnKeyUp ="javascript:ChkUnmatchUnitCost();"  />
									...
									<tr class="mb-c">
										...
										<td><asp:TextBox id=txtPBBKB width=60% maxlength=21 Text=0 style="text-align:right" runat=server />
									...
									<tr class="mb-c">
										...
										<td><asp:TextBox id=txtDONo width=60% maxlength=20 runat=server /></td>
										<td>&nbsp;</td>
										<td>&nbsp;</td>
										<td>&nbsp;</td>
										<td>&nbsp;</td>
									...
									<tr class="mb-c">
										<td height=25>Other Invoice No./Additional Note :</td>
										<td><asp:TextBox id=txtOtherInvNo width=100% maxlength=128 runat=server /></td>
										<td>&nbsp;</td>
										<td>&nbsp;</td>
										<td>&nbsp;</td>
										<td>&nbsp;</td>
				...
				<td colSpan="6">
					<asp:DataGrid id=dgLineDet
						...
						<Columns>	
							...
							<asp:TemplateColumn HeaderText="Other Invoice No. <br> DO No." ItemStyle-Width="10%">
								<ItemTemplate> 
									<ItemStyle />
										<asp:Label Text=<%# Container.DataItem("OtherInvNo") %> id="lblOtherInvNo" runat="server" /><br />
							...
							<asp:TemplateColumn HeaderText="Quantity Received" ItemStyle-Width="8%" HeaderStyle-HorizontalAlign=Right ItemStyle-HorizontalAlign=Right >
								<ItemTemplate>
									<asp:Label Text=<%# iif(trim(Container.DataItem("QtyReceive")) ="",Container.DataItem("QtyReceive"), objGlobal.GetIDDecimalSeparator_FreeDigit(iif(isnumeric(Container.DataItem("QtyReceive")),Container.DataItem("QtyReceive"),0), 2)) %> 
							...
							<asp:TemplateColumn HeaderText="Quantity Invoice" ItemStyle-Width="8%" HeaderStyle-HorizontalAlign=Right ItemStyle-HorizontalAlign=Right >
								<ItemTemplate>
									<asp:Label id=txtIDQtyInvoiced runat="server"										
										Text='<%# objGlobal.GetIDDecimalSeparator_FreeDigit(FormatNumber(Container.DataItem("QtyInvoice"),2),2) %>'
										width=100% />
							...
							<asp:TemplateColumn HeaderText="Unit Price" ItemStyle-Width="8%" HeaderStyle-HorizontalAlign=Right ItemStyle-HorizontalAlign=Right >
								<ItemTemplate>
									...
									<asp:Label id=txtUnitPrice visible = False runat="server"
										Text='<%# Container.DataItem("CostToDisplay") %>'
										width=100% />
								</ItemTemplate>							
							</asp:TemplateColumn>									
							...
							<asp:TemplateColumn HeaderText="PPN" HeaderStyle-HorizontalAlign=Right ItemStyle-Width="8%" ItemStyle-HorizontalAlign=Right>
								<ItemTemplate> 
									<ItemStyle />
										...
										<asp:Label Text=<%# Container.DataItem("PPNAmount") %> id="lblPPNAmount" visible = False runat="server" />
									</ItemStyle>
								</ItemTemplate>
							</asp:TemplateColumn>
							<asp:TemplateColumn HeaderStyle-HorizontalAlign=Right ItemStyle-Width="2%" ItemStyle-HorizontalAlign=Right>
								<ItemTemplate> 
									<ItemStyle />
							...
							<asp:TemplateColumn HeaderText="Total Amount" HeaderStyle-HorizontalAlign=Right ItemStyle-Width="8%" ItemStyle-HorizontalAlign=Right>
								<ItemTemplate> 
									<ItemStyle />
										...
										<asp:Label Text=<%# Container.DataItem("PPHAmount") %> id="lblPPHAmount" visible = False runat="server" />
									</ItemStyle>
								</ItemTemplate>
							</asp:TemplateColumn>				
			...
			<tr>
				<td colSpan="6">
					...
					<P>
					<asp:ImageButton ID="NewBtn"     UseSubmitBehavior="false" AlternateText="New"  visible=false   onclick="NewBtn_Click"     ImageUrl="../../images/butt_new.gif"     CausesValidation=False Runat=server /> 
