			...
			<tr>
				...
				<div class="kontenlist">
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						<tr>
							<td><strong>SUPPLIER CREDIT NOTE LIST</strong><hr style="width :100%" />   
                            </td>
						...
						<tr>
							...
							<table cellpadding="4" cellspacing="0" style="width: 100%">
								...
								<td valign=bottom width=12%>Credit Note ID :<BR><asp:TextBox id=txtCNID width=100% maxlength="32" CssClass="fontObject" runat="server" /></td>
								<td valign=bottom width=18%>Credit Note Ref. No. :<BR><asp:TextBox id=txtCNRefNoID width=100% maxlength="20"  CssClass="fontObject" runat="server" /></td>
