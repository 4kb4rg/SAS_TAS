<%@ Page Language="vb" Src="../../../include/AP_Rpt_PaymentDet.aspx.vb" Inherits="AP_Rpt_PaymentDet"%>
...
<html>
	...
	<body>
		<form id=frmReport method=post runat=server>
			<cr:CrystalReportViewer id="crvView2" width="350px" height="50px" runat="server" valign=center displaygrouptree="false" displaytoolbar="true" pagetotreeratio="4" />
