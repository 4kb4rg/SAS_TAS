<%@ Page Language="vb" src="../../../include/WS_setup_prodmodel.aspx.vb" Inherits="WS_ProdModel" %>
					...
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						...
						<tr>
							...
							<table cellpadding="4" cellspacing="0" style="width: 100%">
								...
								<td width="20%" height="26"><asp:label id=lblProdModel runat=server /> Code :<BR><asp:TextBox id=srchProdModelCode width=100% maxlength="8" runat="server"/></td>
								<td width="37%" height="26"><asp:label id=lblProdModelDesc runat=server /> :<BR><asp:TextBox id=srchDesc width=100% maxlength="128" runat="server"/></td>
						    ...
						    <tr>
							    ...
							    <table cellpadding="4" cellspacing="1" style="width: 100%">
						            ...
						            <Columns>
						            <asp:TemplateColumn SortExpression="ProdModelCode">
							            <ItemStyle width=15% />		
							            <ItemTemplate>
								            <%# Container.DataItem("ProdModelCode") %>
							            </ItemTemplate>
							            <EditItemTemplate>
								            <asp:TextBox id="ProdModelCode" MaxLength="8" width=95%
									            Text='<%# Trim(Container.DataItem("ProdModelCode")) %>'
									            runat="server"/><BR>
								            <asp:label id="lblDupMsg" Text="Code already exist" Visible=false forecolor=red Runat="server"/>
								            <asp:RequiredFieldValidator id=validateCode display=dynamic runat=server
									            ControlToValidate=ProdModelCode />
						            ...
						            <asp:TemplateColumn HeaderText="Last Update" SortExpression="PModel.UpdateDate">
							            <ItemStyle width=15% />		
							            <ItemTemplate>
						            ...
						            <asp:TemplateColumn HeaderText="Status" SortExpression="PModel.Status">
							            <ItemStyle width=10% />						
							            <ItemTemplate>
								            <%# objWS.mtdGetProductModelStatus(Container.DataItem("Status")) %>
							            </ItemTemplate>
							            <EditItemTemplate>
						...
						<tr>
							<td>
					            <asp:ImageButton id=ibNew onClick=DEDR_Add imageurl="../../images/butt_new.gif" AlternateText="New Product Model" runat=server/>
