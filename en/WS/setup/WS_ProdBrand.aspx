<%@ Page Language="vb" src="../../../include/WS_setup_prodbrand.aspx.vb" Inherits="WS_ProdBrand" %>
					...
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						...
						<tr>
							...
							<table cellpadding="4" cellspacing="0" style="width: 100%">
								...
								<td width="20%" height="26"><asp:label id="lblProdBrand" runat=server /> Code :<BR><asp:TextBox id=srchProdBrandCode width=100% maxlength="8" runat="server"/></td>
								<td width="37%" height="26"><asp:label id="lblProdBrandDesc" runat=server /> :<BR><asp:TextBox id=srchDesc width=100% maxlength="128" runat="server"/></td>
						    ...
						    <tr>
							    ...
							    <table cellpadding="4" cellspacing="1" style="width: 100%">
						            ...
						            <Columns>
							            <asp:TemplateColumn SortExpression="ProdBrandCode">
								            <ItemStyle width=15% />						
								            <ItemTemplate>
									            <%# Container.DataItem("ProdBrandCode") %>
								            </ItemTemplate>
								            <EditItemTemplate>
									            <asp:TextBox id="ProdBrandCode" MaxLength="8" width=95%
										            Text='<%# Trim(Container.DataItem("ProdBrandCode")) %>'
										            runat="server"/><BR>
									            <asp:label id="lblDupMsg" Text="Code already exist" Visible = false forecolor=red Runat="server"/>
									            <asp:RequiredFieldValidator id=validateCode display=dynamic runat=server 
										            ControlToValidate=ProdBrandCode />															
							            ...
							            <asp:TemplateColumn HeaderText="Last Update" SortExpression="PBrand.UpdateDate">
								            <ItemStyle width=15% />						
								            <ItemTemplate>
							            ...
							            <asp:TemplateColumn HeaderText="Status" SortExpression="PBrand.Status">
								            <ItemStyle width=10% />						
								            <ItemTemplate>
									            <%# objWS.mtdGetProductBrandStatus(Container.DataItem("Status")) %>
								            </ItemTemplate>
								            <EditItemTemplate>
						...
						<tr>
							<td>
					            <asp:ImageButton id=ibNew onClick=DEDR_Add imageurl="../../images/butt_new.gif" AlternateText="New Product Brand" runat=server/>
