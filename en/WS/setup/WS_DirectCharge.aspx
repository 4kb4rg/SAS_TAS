<%@ Page Language="vb" src="../../../include/WS_Setup_DirectCharge.aspx.vb" Inherits="WS_DirectCharge" %>
<%@ Register TagPrefix="UserControl" Tagname="MenuWS" src="../../menu/menu_wssetup.ascx"%>
<%@ Register TagPrefix="Preference" Tagname="PrefHdl" src="../../include/preference/preference_handler.ascx"%>
<html>
	<head>
		<title>Workshop Direct Charge List</title>
					...
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						...
						<tr>
							...
							<table cellpadding="4" cellspacing="0" style="width: 100%">
								...
								<td width="20%" height="26"><asp:label id=lblDirectChgItem runat=server /> Code :<BR><asp:TextBox id=srchDCCode width=100% maxlength="8" runat="server"/></td>
								<td width="37%" height="26"><asp:label id=lblDirectChgItemDesc runat=server /> :<BR><asp:TextBox id=srchDesc width=100% maxlength="128" runat="server"/></td>
							    ...
							    <table cellpadding="4" cellspacing="1" style="width: 100%">
						            ...
						            <Columns>
							            <asp:HyperLinkColumn
									            ...
									            DataNavigateUrlFormatString="WS_DirectCharge_Detail.aspx?id={0}"
						...
						<tr>
							<td>
					            <asp:ImageButton id=ibNew onClick=btnNewItm_Click imageurl="../../images/butt_new.gif" AlternateText="New Direct Charge" runat=server/>
