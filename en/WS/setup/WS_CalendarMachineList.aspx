<%@ Page Language="vb" src="../../../include/WS_Setup_CalendarMachineList.aspx.vb" Inherits="WS_Setup_CalendarMachineList" %>
<%@ Register TagPrefix="UserControl" Tagname="MenuWS" src="../../menu/menu_wssetup.ascx"%>
<%@ Register TagPrefix="Preference" Tagname="PrefHdl" src="../../include/preference/preference_handler.ascx"%>
<html>
	<head>
		<title>Calendarized Machine List</title>
			...
			<tr>
				...
				<div class="kontenlist">
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						<tr>
							<td><strong>CALENDARIZED MACHINE LIST</strong><hr style="width :100%" />   
                            </td>
						...
						<tr>
							...
							<table cellpadding="4" cellspacing="0" style="width: 100%">
								...
								<td width="20%" height="26"><asp:label id="lblBlkCode" runat="server" /> :<BR>
									<asp:TextBox id=srchBlockCode width=100% maxlength="8" runat="server" />
								</td>
						    ...
						    <tr>
							    ...
							    <table cellpadding="4" cellspacing="1" style="width: 100%">
						            ...
						            <asp:DataGrid id=dgLine runat=server
							            ...
							            <Columns>
								            <asp:HyperLinkColumn ItemStyle-Width="20%"
									            SortExpression="ws.BlkCode" 
									            DataNavigateUrlField="SubBlkMonth" 
									            DataNavigateUrlFormatString="WS_CalendarMachineDet.aspx?tbcode={0}" 
									            DataTextField="BlkCode" />
									
								            <asp:HyperLinkColumn ItemStyle-Width="20%"
									            SortExpression="ws.SubBlkCode" 
									            DataNavigateUrlField="SubBlkMonth"
									            DataNavigateUrlFormatString="WS_CalendarMachineDet.aspx?tbcode={0}"
									            DataTextField="SubBlkCode" />
									
								            <asp:HyperLinkColumn ItemStyle-Width="20%" 
									            SortExpression="ws.SelMonth" 
									            DataNavigateUrlField="SubBlkMonth" 
									            DataNavigateUrlFormatString="WS_CalendarMachineDet.aspx?tbcode={0}" 
								            ...
								            <asp:TemplateColumn HeaderText="Status" ItemStyle-Width="10%" SortExpression="sub.Status">
									            <ItemTemplate>
										            <%# objWS.mtdGetCalendarizedMachineStatus(Container.DataItem("Status")) %>
									            </ItemTemplate>
								            </asp:TemplateColumn>
								            ...
								            <asp:TemplateColumn ItemStyle-Width="15%" ItemStyle-HorizontalAlign=center>
									            <ItemTemplate>
										            ...
										            <asp:Label id=lblSelMonth Visible=False text=<%# Container.DataItem("SelMonth")%> Runat="server" />
