<%@ Page Language="vb" src="../../../include/WS_setup_prodMaterial.aspx.vb" Inherits="WS_ProdMaterial" %>
					...
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						...
						<tr>
							...
							<table cellpadding="4" cellspacing="0" style="width: 100%">
								...
								<td width="20%" height="26"><asp:label id="lblProdMat" runat="server" /> Code :<BR><asp:TextBox id=srchProdMatCode width=100% maxlength="8" runat="server"/></td>
								<td width="37%" height="26"><asp:label id="lblProdMatDesc" runat="server" /> :<BR><asp:TextBox id=srchDesc width=100% maxlength="128" runat="server"/></td>
						    ...
						    <tr>
							    ...
							    <table cellpadding="4" cellspacing="1" style="width: 100%">
						            ...
						            <asp:DataGrid id="EventData"
						                ...
						                <Columns>
							                <asp:TemplateColumn SortExpression="ProdMatCode">
								                <ItemStyle width=15% />								
								                <ItemTemplate>
									                <%# Container.DataItem("ProdMatCode") %>
								                </ItemTemplate>
								                <EditItemTemplate>
									                <asp:TextBox id="ProdMatCode" MaxLength="8" Size="8"
											                Text='<%# Trim(Container.DataItem("ProdMatCode")) %>'
											                runat="server"/><BR>
									                <asp:label id="lblDupMsg"  Text="Code already exist" Visible = false forecolor=red Runat="server"/>
									                <asp:RequiredFieldValidator id=validateCode display=dynamic runat=server ControlToValidate=ProdMatCode />															
								                </EditItemTemplate>
							                </asp:TemplateColumn>
							                <asp:TemplateColumn SortExpression="Description">
								                ...
								                <EditItemTemplate>
									                <asp:TextBox id="Description" Size=35 MaxLength="64"
							                ...
							                <asp:TemplateColumn HeaderText="Last Update" SortExpression="PMat.UpdateDate">
								                <ItemStyle width=15% />								
								                <ItemTemplate>
							                ...
							                <asp:TemplateColumn HeaderText="Status" SortExpression="PMat.Status">
								                <ItemStyle width=10% />								
								                <ItemTemplate>
									                <%# objWS.mtdGetProductMaterialStatus(Container.DataItem("Status")) %>
								                </ItemTemplate>
								                <EditItemTemplate>
									                <asp:DropDownList id="StatusList" width=100% runat=server Visible=False/>
							                ...
							                <asp:TemplateColumn HeaderText="Updated By" SortExpression="UserName">
								                ...
								                <EditItemTemplate >
									                <asp:TextBox id="UserName" Readonly=TRUE size=8 Visible=False
						...
						<tr>
							<td>
					            <asp:ImageButton id=ibNew onClick=DEDR_Add imageurl="../../images/butt_new.gif" AlternateText="New Product Material" runat=server/>
