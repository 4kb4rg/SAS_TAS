<%@ Page Language="vb" src="../../../include/WS_setup_StockAnalysis.aspx.vb" Inherits="WS_StockAnalysis" %>
					...
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						...
						<tr>
							...
							<table cellpadding="4" cellspacing="0" style="width: 100%">
								...
								<td width="20%" height="26"><asp:label id="lblStockAnal" runat=server /> Code :<BR><asp:TextBox id=srchStockAnaCode width=100% maxlength="8" runat="server"/></td>
								<td width="37%" height="26"><asp:label id="lblStockAnalDesc" runat=server /> :<BR><asp:TextBox id=srchDesc width=100% maxlength="128" runat="server"/></td>
						    ...
						    <tr>
							    ...
							    <table cellpadding="4" cellspacing="1" style="width: 100%">
						            ...
						            <Columns>
							            <asp:TemplateColumn SortExpression="StockAnalysisCode">
								            <ItemStyle width=15% />								
								            <ItemTemplate>
									            <%# Container.DataItem("StockAnalysisCode") %>
								            </ItemTemplate>
								            <EditItemTemplate>
									            <asp:TextBox id="StockAnalysisCode" MaxLength="8" width=95%
										            Text='<%# Trim(Container.DataItem("StockAnalysisCode")) %>'
										            runat="server"/><BR>
									            <asp:label id="lblDupMsg" Text="Code already exist" Visible=false forecolor=red Runat="server"/>
									            <asp:RequiredFieldValidator id=validateCode display=dynamic runat=server 
										            ControlToValidate=StockAnalysisCode />
							            ...
							            <asp:TemplateColumn HeaderText="Last Update" SortExpression="StockAna.UpdateDate">
								            <ItemStyle width=15% />								
								            <ItemTemplate>
									            <%# objGlobal.GetLongDate(Container.DataItem("UpdateDate")) %>
								            </ItemTemplate>
								            <EditItemTemplate >
									            <asp:TextBox id="UpdateDate" Readonly=TRUE width=100% Visible=False
							            ...
							            <asp:TemplateColumn HeaderText="Status" SortExpression="StockAna.Status">
								            <ItemStyle width=10% />								
								            <ItemTemplate>
									            <%# objWS.mtdGetStockAnalysisStatus(Container.DataItem("Status")) %>
								            </ItemTemplate>
								            <EditItemTemplate>
							            ...
							            <asp:TemplateColumn HeaderText="Updated By" SortExpression="UserName">
								            ...
								            <EditItemTemplate >
									            <asp:TextBox id="UserName" Readonly=TRUE width=100% Visible=False
						...
						<tr>
							<td>
					            <asp:ImageButton id=ibNew onClick=DEDR_Add imageurl="../../images/butt_new.gif" AlternateText="New Stock Analysis" runat=server/>
