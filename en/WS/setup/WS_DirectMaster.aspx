<%@ Page Language="vb" src="../../../include/WS_Setup_DirectMaster.aspx.vb" Inherits="WS_DirectMaster" %>
<%@ Register TagPrefix="UserControl" Tagname="MenuWSSetup" src="../../menu/menu_WSsetup.ascx"%>
<%@ Register TagPrefix="Preference" Tagname="PrefHdl" src="../../include/preference/preference_handler.ascx"%>
<html>
	<head>
		<title>Direct Charge Master List</title>
			...
			<tr>
				...
				<div class="kontenlist">
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
							    ...
							    <table cellpadding="4" cellspacing="1" style="width: 100%">
						            ...
						            <Columns>
							            <asp:HyperLinkColumn
									            ...
									            DataNavigateUrlFormatString="WS_DirectMaster_Detail.aspx?id={0}"
						...
						<tr>
							<td>
					            <asp:ImageButton id=ibNew onClick=btnNewItm_Click imageurl="../../images/butt_new.gif" AlternateText="New Direct Charge Master" runat=server/>					
