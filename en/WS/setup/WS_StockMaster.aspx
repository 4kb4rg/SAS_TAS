<%@ Page Language="vb" src="../../../include/WS_Setup_StockMaster.aspx.vb" Inherits="WS_StockMaster" %>
<%@ Register TagPrefix="UserControl" Tagname="MenuWSSetup" src="../../menu/menu_WSsetup.ascx"%>
<%@ Register TagPrefix="Preference" Tagname="PrefHdl" src="../../include/preference/preference_handler.ascx"%>
<html>
	<head>
		<title>Workshop Item Master List</title>
			...
			<tr>
				...
				<div class="kontenlist">
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						<tr>
							<td><strong>WORKSHOP ITEM MASTER LIST</strong><hr style="width :100%" />   
                            </td>
						...
						<tr>
							...
							<table cellpadding="4" cellspacing="0" style="width: 100%">
								...
								<td width="20%" height="26">Workshop Item Code :<BR><asp:TextBox id=srchStockCode width=100% maxlength="8" runat="server"/></td>
							    ...
							    <table cellpadding="4" cellspacing="1" style="width: 100%">
						            ...
						            <Columns>
							            <asp:HyperLinkColumn
									            ...
									            DataNavigateUrlFormatString="WS_StockMaster_Detail.aspx?id={0}"
						...
						<tr>
							<td>
					            <asp:ImageButton id=ibNew onClick=btnNewItm_Click imageurl="../../images/butt_new.gif" AlternateText="New Workshop Item Master" runat=server/>
