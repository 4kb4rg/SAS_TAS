<%@ Page Language="vb" Src="../../../include/WS_StockMaster_Details.aspx.vb" Inherits="WS_MasterDetails" %>
<%@ Register TagPrefix="UserControl" Tagname="MenuWSSetup" src="../../menu/menu_WSsetup.ascx"%>
<%@ Register TagPrefix="Preference" Tagname="PrefHdl" src="../../include/preference/preference_handler.ascx"%>
<html>
<head>
    <title>WORKSHOP ITEM MASTER DETAILS</title>
...
<body>
    <form id="frmSysSetting" runat="server" class="main-modul-bg-app-list-pu">
        ...
        <table cellpadding="2" width="100%" border="0" class="font9Tahoma">
 			<tr>
				<td colspan="6">
					<UserControl:MenuWSSetup id=menuWS runat="server" />
				</td>
			</tr>
            <tr>
                <td class="mt-h" colspan="6"><asp:label id="lblHead" Runat="server" text="WORKSHOP ITEM MASTER DETAILS"/></td>
            </tr>
			<tr>
            ...
            <tr>
                ...
                <td><asp:DropDownList id="lstAccCode" width=100% runat="server" />
					<asp:RequiredFieldValidator id="validateAccCode" runat="server" 
						ErrorMessage="Please Select Account Code" 
						display="dynamic" 
						ControlToValidate="lstAccCode"/></td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
            ...
            <tr>
                ...
                <td width=30%><asp:DropDownList id="PurchaseUOM" width=100% runat="server" />
								<asp:RequiredFieldValidator id="validatePurchaseUOM" runat="server" 
								ErrorMessage="Please Select Unit of Measurement" 
								display="dynamic" 
								ControlToValidate="PurchaseUOM"/></td>
                <td width=5%>&nbsp;</td>
                <td width=5%>&nbsp;</td>
            ...
            <tr>
                ...
                <td><asp:DropDownList id="InventoryUOM" width=100% runat="server" />
					<asp:RequiredFieldValidator id="validateInventoryUOM" runat="server" 
								ErrorMessage="Please Select Unit of Measurement" 
								display="dynamic" 
								ControlToValidate="InventoryUOM"/></td>
                <td>&nbsp;</td>
            ...
            <tr>
                ...
                <td><asp:TextBox id="FixedPrice" runat="server" maxlength="19" text=0 width=100%/>
            ...
            <tr>
                ...
                <td><asp:TextBox id="LatestPrice" runat="server" maxlength="3" text=0 width=50%/>
            ...
            <tr>
                ...
                <td>&nbsp;</td>
                <td>&nbsp;</td>
                <td><asp:RadioButton id="Avrg_Price" runat="server" TextAlign="Right" Text="% of Average Cost :" GroupName="SellPrice" Checked="True"/></td>
                <td><asp:TextBox id="AvrgPrice" runat="server" maxlength="3" text=0 width=50%></asp:TextBox>
            ...
            <tr>
                ...
                <td><asp:TextBox id="txtFuelMeter" runat="server" maxlength="21" text=0 width=50%/> 
