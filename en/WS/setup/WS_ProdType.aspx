<%@ Page Language="vb" src="../../../include/WS_Setup_ProdType.aspx.vb" Inherits="WS_ProdType" %>
					...
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						...
						<tr>
							...
							<table cellpadding="4" cellspacing="0" style="width: 100%">
								...
								<td width="20%" height="26"><asp:label id="lblProdType" runat="server" /> Code :<BR><asp:TextBox id=srchProdTypeCode width=100% maxlength="8" runat="server"/></td>
								<td width="37%" height="26"><asp:label id="lblProdTypeDesc" runat="server" /> :<BR><asp:TextBox id=srchDesc width=100% maxlength="128" runat="server"/></td>
						    ...
						    <tr>
							    ...
							    <table cellpadding="4" cellspacing="1" style="width: 100%">
					                ...
					                <Columns>
						                ...
						                <asp:TemplateColumn SortExpression="ProdTypeCode">
							                <ItemStyle width=15% />						
							                <ItemTemplate>
								                <%# Container.DataItem("ProdTypeCode") %>
							                </ItemTemplate>
							                <EditItemTemplate>
								                <asp:TextBox id="ProdTypeCode" MaxLength="8" width=95%
									                Text='<%# Trim(Container.DataItem("ProdTypeCode")) %>'
									                runat="server"/><BR>
								                <asp:RequiredFieldValidator id=validateCode display=dynamic runat=server
									                ControlToValidate=ProdTypeCode />															
						                ...
						                <asp:TemplateColumn HeaderText="Last Update" SortExpression="PType.UpdateDate">
							                <ItemStyle width=15% />						
							                <ItemTemplate>
						                ...
						                <asp:TemplateColumn HeaderText="Status" SortExpression="PType.Status">
							                <ItemStyle width=10% />						
							                <ItemTemplate>
								                <%# objWS.mtdGetProductTypeStatus(Container.DataItem("Status")) %>
							                </ItemTemplate>
							                <EditItemTemplate>
								                <asp:DropDownList id="StatusList" visible=false width=100% runat=server />
								                <asp:TextBox id="Status" 
									                Text='<%# Container.DataItem("Status")%>' visible=false 
									                runat="server"/>
							                </EditItemTemplate>
						                </asp:TemplateColumn>
						                <asp:TemplateColumn HeaderText="Updated By" SortExpression="UserName">
							                ...
							                <EditItemTemplate >
								                <asp:TextBox id="UserName" visible=false width=100% 
						...
						<tr>
							<td>
					            <asp:ImageButton id=ibNew onClick=DEDR_Add imageurl="../../images/butt_new.gif" AlternateText="New Product Type" runat=server/>
