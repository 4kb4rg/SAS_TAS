<%@ Page Language="vb" src="../../../include/WS_setup_prodCategory.aspx.vb" Inherits="WS_ProdCategory" %>
					...
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						...
						<tr>
							...
							<table cellpadding="4" cellspacing="0" style="width: 100%">
								...
								<td width="20%" height="26"><asp:label id=lblProdCat runat=server /> Code :<BR><asp:TextBox id=srchProdCatCode width=100% maxlength="8" runat="server"/></td>
								<td width="37%" height="26"><asp:label id=lblProdCatDesc runat=server /> :<BR><asp:TextBox id=srchDesc width=100% maxlength="128" runat="server"/></td>
							    ...
							    <table cellpadding="4" cellspacing="1" style="width: 100%">
						            ...
						            <asp:DataGrid id="EventData"
						                ...
						                <asp:TemplateColumn HeaderText="Status" SortExpression="PCat.Status">
							                <ItemStyle width=10% />								
							                <ItemTemplate>
								                <%# objWS.mtdGetProductCategoryStatus(Container.DataItem("Status")) %>
							                </ItemTemplate>
							                <EditItemTemplate>
