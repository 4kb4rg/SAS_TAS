	...
	<body>
		...
		<table id="tblHeader" cellSpacing="0" cellPadding="2" width="100%" border="0" class="font9Tahoma">
                    ...
                    <table cellpadding="0" cellspacing="0" class="style1">
                        <tr>
                            ...
                            <td class="font9Header" style="text-align: right">
                                Period : <asp:Label id=lblAccPeriod runat=server />&nbsp;| Status : <asp:Label id=lblStatus runat=server />&nbsp;| Date Created : <asp:Label id=lblDateCreated runat=server />&nbsp;| Last Update : <asp:Label ID=lblLastUpdate runat=server />&nbsp;| Print Date : <asp:Label ID=lblPrintDate runat=server />&nbsp;| Updated By :<asp:Label ID=lblUpdatedBy runat=server />
                            </td>
                        </tr>
                    </table>
                    <hr style="width :100%" />
			...
			<tr>
				...
				<td><asp:DropDownList id=ddlBillParty width=100% autopostback=true onselectedindexchanged=onChanged_BillParty runat=server CssClass="font9Tahoma" />
			...
			<tr>
				...
				<td><asp:Dropdownlist id=ddlDocType width=100% runat=server CssClass="font9Tahoma" /></td>
				<td>&nbsp;</td>
				<td>&nbsp;</td>
				<td>&nbsp;</td>
			</tr>
			<tr>
				...
				<td><asp:Textbox id=txtCustRef width=100% maxlength=256 runat=server CssClass="font9Tahoma" />
			...
			<tr>
				...
				<td><asp:Textbox id=txtDevRef width=100% maxlength=128 runat=server CssClass="font9Tahoma" />
			...
			<tr>
				...
				<td><asp:Textbox id=txtSeller width=100% maxlength=128 runat=server CssClass="font9Tahoma" />
				<td>&nbsp;</td>
			</tr>
			<tr>
				<td height=25>Contract No. :</td>
                <td><asp:DropDownList id=ddlContract width=100% autopostback=true onselectedindexchanged=onChanged_ContractNo runat=server CssClass="font9Tahoma" /></td>	
				<td>&nbsp;</td>
			</tr>
			<tr>
				<td height=25>Currency Code :</td>
                <td><asp:DropDownList id=ddlCurrency width=100% runat=server CssClass="font9Tahoma" /></td>	
				<td>&nbsp;</td>
			</tr>
			<tr>
			    <td height=25>Exchange Rate :</td>
                <td><asp:TextBox id=txtExRate text="1" width=20% maxlength=20 runat=server CssClass="font9Tahoma" /></td>				
            </tr>
            <tr>
			    <td height=25>Advance Payment (excl. vat) :</td>
                <td><asp:TextBox id=txtAdvAmount text="0" width=50% style="text-align:right" runat=server CssClass="font9Tahoma" />
							...
							<td>-->
								<table id="tblSelection" cellSpacing="0" cellPadding="4" width="100%" border="0" runat=server class="sub-Add">
									<tr class="mb-c">
										...
										<td colSpan="5" style="height: 28px">
                                            <asp:TextBox ID="txtAccCode" runat="server" AutoPostBack="True" MaxLength="15" OnTextChanged="onSelect_StrAccCode"
                                                Width="23%" CssClass="font9Tahoma" ></asp:TextBox>
                                            ...
                                            <asp:TextBox ID="txtAccName" runat="server" BackColor="Transparent" BorderStyle="None"
                                                Font-Bold="True" ForeColor="White" MaxLength="10" Width="56%" CssClass="font9Tahoma" ></asp:TextBox><br />
									...
									<tr id="RowBlk" class="mb-c">
										...
										<td colspan=5>
											<asp:DropDownList id=ddlBlock width=95% runat=server CssClass="font9Tahoma" />
									...
									<tr class="mb-c">
										...
										<td colspan=5>
											<asp:Dropdownlist id=ddlVehCode width=95% runat=server CssClass="font9Tahoma" />
									...
									<tr class="mb-c">
										...
										<td colspan=5>
											<asp:Dropdownlist id=ddlVehExpCode width=95% runat=server CssClass="font9Tahoma" />
									...
									<tr class="mb-c">
										...
										<td colspan=5>
											<asp:Textbox id=txtDescription width=95% maxlength=128 runat=server CssClass="font9Tahoma" />
									...
									<tr class="mb-c">
										...
										<td width=20%>
											<asp:Textbox id=txtTotalUnits OnKeyUp="javascript:calAmount('1');" width=70% maxlength=15 runat=server CssClass="font9Tahoma" />
										...
										<td width=20%>
											<asp:Textbox id=txtRate width=50% OnKeyUp="javascript:calAmount('2');" maxlength=22 runat=server CssClass="font9Tahoma" />
										...
										<td width=20%>
											<asp:Textbox id=txtAmount width=80% OnKeyUp="javascript:calAmount('3');" maxlength=22 runat=server CssClass="font9Tahoma" />
									...
									<tr class="mb-c">
										...
										<td><asp:Textbox id=txtPPHRate width=50% maxlength=5 runat=server CssClass="font9Tahoma" />
			...
			<tr>
				...
				<td><asp:Textbox id=txtUnderName Text="" maxlength=128 width=50% runat=server CssClass="font9Tahoma" /></td>	
				<td>&nbsp;</td>
			</tr>	
			<tr>
				<td height=25 valign=top>Undersigned Post :*</td>
				<td><asp:Textbox id=txtUnderPost text="" maxlength=128 width=50% runat=server CssClass="font9Tahoma" /></td>		
				<td>&nbsp;</td>
			</tr>	
			<tr>
			    <td colspan=6>&nbsp;</td>
			...
			<tr visible=False>
				...
				<td><asp:Textbox id=txtFakturNo Text="" maxlength=128 width=50% ReadOnly=true runat=server CssClass="font9Tahoma" /></td>	
				<td>&nbsp;</td>
			</tr>	
			<tr visible=False>
				<td height=25 valign=top>Faktur Pajak Date :*</td>
				<td><asp:TextBox id=txtFakturDate width=25% maxlength="10" ReadOnly=true runat="server" CssClass="font9Tahoma" />
			...
			<tr visible=False>
			    <td> </td>
			    <td colspan=5><asp:RadioButton id="Opt1" Enabled=false runat="server" TextAlign="Right" Text=" Lembar ke-1   :   Untuk pembeli BKP/penerima JKP sebagai bukti pajak masukan" GroupName="Option" Checked="True"/><br>
