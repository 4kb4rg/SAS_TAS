<%@ Page Language="vb" src="../../../include/BI_trx_DNDet.aspx.vb" Inherits="BI_trx_DNDet" %>
...
<html>
	...
	<body>
		...
		<table id="tblHeader" cellSpacing="0" cellPadding="2" width="100%" border="0"  class="font9Tahoma">
                    ...
                    <table cellpadding="0" cellspacing="0" class="style1">
                        <tr>
                            <td  class="font9Tahoma">
                                <strong>DEBIT NOTE DETAILS</strong></td>
                            <td class="font9Header"  style="text-align: right">
                                Period : <asp:Label id=lblAccPeriod runat=server />&nbsp;| Status : <asp:Label id=lblStatus runat=server />&nbsp;| Date Created : <asp:Label id=lblDateCreated runat=server />&nbsp;| Last Update : <asp:Label ID=lblLastUpdate runat=server />&nbsp;| Print Date : <asp:Label ID=lblPrintDate runat=server />&nbsp;| Updated By : <asp:Label ID=lblUpdatedBy runat=server /></td>
                        </tr>
                    </table>
                    <hr style="width :100%" />
                </td>
			...
			<tr>
				<td height=25 width="20%">Debit Note ID :</td>
				<td width="40%"><asp:Label id=lblDebitNoteID runat=server /></td>
				<td width="5%">&nbsp;</td>
				<td width="15%">&nbsp;</td>
				<td width="20%">&nbsp;</td>
				<td width="5%">&nbsp;</td>
			...
			<tr>
				...
				<td><asp:DropDownList id=ddlBillParty width=100% runat=server CssClass="font9Tahoma"/>
        ...
        <table cellSpacing="0" cellPadding="2" width="100%" border="0" runat=server  class="font9Tahoma">
            <tr>
            <td>
			<tr>
				<td colSpan="6">
							...
							<td>-->
                                ...
                                <asp:TextBox ID="txtAccCode" runat="server" AutoPostBack="True" 
                                    ...
                                    Width="22%"></asp:TextBox>
                                            &nbsp;<input id="Find" runat="server" class="button-small" 
                                    onclick="javascript:PopCOA_Desc('frmMain', '', 'txtAccCode', 'txtAccName', 'False');" 
                                    type="button" value=" ... " /> <asp:Button ID="BtnGetData" runat="server" CssClass="button-small" 
                                    ...
                                    CssClass="fontObject" Font-Bold="True" MaxLength="10" Width="55%"></asp:TextBox>
									...
									<tr class="mb-c">
										...
										<td width=20%>
											<asp:Textbox id=txtTotalUnits OnKeyUp="javascript:calAmount('1');" width=70% maxlength=15 style="text-align:right" runat=server CssClass="font9Tahoma"/>
										...
										<td width=20%>
											<asp:Textbox id=txtRate width=70% OnKeyUp="javascript:calAmount('2');" maxlength=22 style="text-align:right" runat=server CssClass="font9Tahoma"/>
										...
										<td width=20%>
											<asp:Textbox id=txtAmount width=80% OnKeyUp="javascript:calAmount('3');" maxlength=22 style="text-align:right" runat=server CssClass="font9Tahoma"/>
			...
			<tr>
				<td colSpan="6">
					<asp:DataGrid id=dgLineDet
						...
						<Columns>						
							<asp:TemplateColumn ItemStyle-Width=14%>
								<ItemTemplate>
							...
							<asp:TemplateColumn HeaderText="Unit Price" ItemStyle-Width=8% HeaderStyle-HorizontalAlign=Right ItemStyle-HorizontalAlign=Right>
								<ItemTemplate> 
									...
									<asp:Label Text=<%# FormatNumber(Container.DataItem("Cost"), 5) %> id="lblCost" visible = False runat="server" />
								</ItemTemplate>
							</asp:TemplateColumn>
							...
							<asp:TemplateColumn ItemStyle-Width=5% ItemStyle-HorizontalAlign=Right>
								<ItemTemplate>
									<asp:label id=dnlnid visible="false" text=<%# Container.DataItem("DebitNoteLNID")%> runat="server" />
			...
			<tr>
				<td colSpan="6">
					<asp:Label id=lblErrTotal forecolor=red visible=false text="There was no amount to bill.<br>" runat=server/>
						    <asp:ImageButton id=NewCNBtn onClick=NewCNBtn_Click imageurl="../../images/butt_new.gif" AlternateText="New Credit Note" runat=server/>
                    ...
                    <br />
                     <telerik:RadInputManager  ID="RadInputManager1" runat="server">
                             <telerik:NumericTextBoxSetting BehaviorID="NumericBehavior2" EmptyMessage="please type" KeepTrailingZerosOnFocus="False">
                                <TargetControls>
                                    <telerik:TargetInput ControlID="txtTotalUnits" />
                                </TargetControls>
                     ...
                     <telerik:RadInputManager  ID="RadInputManager2" runat="server">
                             <telerik:NumericTextBoxSetting BehaviorID="NumericBehavior2" EmptyMessage="please type" KeepTrailingZerosOnFocus="False">
                                <TargetControls>
                                    <telerik:TargetInput ControlID="txtRate" />
                                </TargetControls>
                            </telerik:NumericTextBoxSetting>  
                    </telerik:RadInputManager>
