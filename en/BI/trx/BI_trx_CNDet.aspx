	...
	<body>
        ...
        <td>
			...
			<tr>
				<td class="mt-h" colspan="6">
                    <table cellpadding="0" cellspacing="0" class="style1">
                        <tr>
                            ...
                            <strong> CREDIT NOTE DETAILS</strong> </td>
				...
				&nbsp;| Last Update : <asp:Label ID=lblLastUpdate runat=server />&nbsp;| Print Date : <asp:Label ID=lblPrintDate runat=server />&nbsp;| Updated By : <asp:Label ID=lblUpdatedBy runat=server />
                            </td>
                        </tr>
                    </table>
                    <hr style="width :100%" />
