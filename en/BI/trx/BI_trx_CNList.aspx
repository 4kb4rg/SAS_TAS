<%@ Page Language="vb" src="../../../include/BI_trx_CNList.aspx.vb" Inherits="BI_trx_CNList" %>
<%@ Register TagPrefix="UserControl" Tagname="MenuBI" src="../../menu/menu_bitrx.ascx"%>
<%@ Register TagPrefix="Preference" Tagname="PrefHdl" src="../../include/preference/preference_handler.ascx"%>
<html>

<head>
<title>Accounts Receivables - Credit Note List</title>
    <link href="../../include/css/gopalms.css" rel="stylesheet" type="text/css" />
<%--<Preference:PrefHdl id=PrefHdl runat="server" />--%>
</head>
	<body>
	    <form id=frmCNList runat="server" class="main-modul-bg-app-list-pu">
			...
			<tr>
				...
				<div class="kontenlist">
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						<tr>
							<td><strong>CREDIT NOTE LIST</strong><hr style="width :100%" />   
                            </td>
...
<td valign=bottom width=20%>Credit Note ID :<BR><asp:TextBox id=txtCNID width=100% maxlength=32 runat=server /></td>
								...
								<td valign=bottom width=20%>Billing Type :<br><asp:dropdownlist id=ddlCreditNoteType width=100% CssClass="font9Tahoma" runat=server /></td>
					...
					<asp:DataGrid id=dgLine
							...
							<Columns>
								...
								<asp:HyperLinkColumn HeaderText="Credit Note ID" 
													 ...
													 DataNavigateUrlFormatString="BI_trx_CNDet.aspx?cnid={0}" 
													 DataTextField="CreditNoteID" />
													 
								<asp:TemplateColumn SortExpression="CN.BillPartyCode">
									<ItemTemplate>
								...
								<asp:TemplateColumn HeaderText="Billing Type" SortExpression="CN.DocType">
									<ItemTemplate>
										<%# objBITrx.mtdGetCreditNoteDocType(Container.DataItem("DocType")) %>
									</ItemTemplate>
								</asp:TemplateColumn>
								...
								<asp:TemplateColumn HeaderText="Status" SortExpression="CN.Status">
									<ItemTemplate>
										<%# objBITrx.mtdGetCreditNoteStatus(Container.DataItem("Status")) %>
									</ItemTemplate>
								</asp:TemplateColumn>
