...
<html>
	...
	<body>
		...
		<table id="tblHeader" cellSpacing="0" cellPadding="2" width="100%" border="0">
			...
			<tr>
				<td class="mt-h" colspan="6">CREDITOR JOURNAL DETAILS</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><asp:TextBox id=txtCJRefDate width=25% maxlength=10 runat=server />
			...
			<tr>
				...
				<td>
                    ...
                    <input id="Find" runat="server" causesvalidation="False" onclick="javascript:PopSupplier_New('frmMain','','txtSupCode','txtSupName','txtCreditTerm','txtPPN','txtPPNInit', 'False');"
                        type="button" value=" ... " />&nbsp;<asp:ImageButton ID="btnGet" runat="server" AlternateText="Get Data"
                            ...
                            OnClick="GetSupplierBtn_Click" ToolTip="Click For Get Data" /><asp:TextBox ID="txtSupName"
                                ...
                                MaxLength="10" Width="99%"></asp:TextBox><asp:Label id=lblErrSupplier forecolor=Red text="Please select Supplier Code" runat=server/>
				</td>
				<td>&nbsp;</td>
				<td>Date Created :</td>
							...
							<td>-->
								<table id="tblSelection" cellSpacing="0" cellPadding="2" width="100%" border="0" runat=server>
									<tr class="mb-c">
										...
										<td colSpan="5"><asp:DropDownList id=ddlAccMonth size=1 width=10% runat=server ></asp:DropDownList>&nbsp;
											<asp:DropDownList id=ddlAccYear size=1 width=10% onclick="fnBindAccMonth(document.frmMain.ddlAccMonth, this);" runat=server />&nbsp;
									...
									<tr class="mb-c">
										...
										<td colSpan="5"><asp:DropDownList id=ddlInvoiceRcv width=95% autopostback=true onSelectedIndexChanged=onSelect_InvPPNH runat=server /></td>
									</tr>
									<tr class="mb-c">
										<td width="20%" height=25>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2. Debit Note ID :</td>
										<td colSpan="5"><asp:DropDownList width=95% id=ddlDebitNote runat=server /></td>
									</tr>
									<tr class="mb-c">
										<td height=25>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;3. Credit Note ID :</td>
										<td colSpan="5"><asp:DropDownList width=95% id=ddlCreditNote runat=server /></td>
									</tr>
									<tr class="mb-c">
										<td height=25>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;4. Payment ID :</td>
										<td colSpan="5"><asp:DropDownList width=95% id=ddlPayment autopostback=true onSelectedIndexChanged=onSelect_PayPPNH runat=server /></td>
									</tr>
									<tr class="mb-c">
										<td height="25">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;5. Creditor Journal ID :</td>
										<td colSpan="5"><asp:DropDownList width="95%" id="ddlCreditorJournal" runat="server"></asp:DropDownList></td>
									</tr>
									<tr class="mb-c">
										<td height="25">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;6. Goods Receive ID :</td>
										<td colSpan="5"><asp:DropDownList width="95%" id="ddlGoodsRcv" runat="server"></asp:DropDownList></td>
									</tr>
									<tr class="mb-c">
										<td height=25></td>
									...
									<tr class="mb-c">
										...
										<td colSpan="5" style="height: 33px" valign="top">
                                            ...
                                            <input id="btnFind1" runat="server" onclick="javascript:PopCOA_Desc('frmMain', '', 'txtAccCode', 'txtAccName', 'False');"
                                                type="button" value=" ... " />&nbsp;<asp:Button ID="BtnGetData" runat="server" Font-Bold="True"
                                                    OnClick="onSelect_Account" Text="Get" ToolTip="Click For Refresh COA " Width="40px" />
									...
									<tr class="mb-c">
										...
										<TD width="30%"><asp:Textbox id=txtPPHRate Enabled=False width=50% maxlength=5 runat=server/>
			...
			<tr>
				...
				<td colSpan="6" vAlign="top"><asp:TextBox ID=txtRemark maxlength=256 width=100% Runat=server /></td>
			</tr>
			<tr>
				<td colSpan="6">&nbsp;</td>
			</tr>			
