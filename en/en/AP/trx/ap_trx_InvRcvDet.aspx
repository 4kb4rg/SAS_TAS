	...
	<body>
		...
		<table id="tblHeader" cellSpacing="0" cellPadding="2" width="100%" border="0">
			...
			<tr>
				...
				<td>&nbsp;</td>
				<td>KPP :</td>
				<td><asp:DropDownList id="ddlKPPInit" width="90%" runat="server" /></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><asp:TextBox ID=txtSplInvAmt maxlength=10 width=50% text=0 style="text-align:right" Runat=server /> 
				...
				<td>&nbsp;</td>
				<td>Tax Object :</td>
				<td><asp:DropDownList id="ddlTaxObject" width="90%" OnSelectedIndexChanged="TaxObject_Changed" autopostback=true  runat="server" /></td>
			</tr>
			<tr>
	            ...
	            <td>&nbsp;</td>
				<td>DPP Amount : </td>
				<td><asp:TextBox ID=txtDPPAmount maxlength=10 width=90% text=0 style="text-align:right" OnKeyUp="javascript:calTaxPrice();" Runat=server /> 
		    ...
		    <tr>
                ...
                <td>&nbsp;</td>
                <td>Tax Amount : </td>
				<td><asp:TextBox ID=txtTaxAmount maxlength=10 width=90% text=0 style="text-align:right" Runat=server /> 
