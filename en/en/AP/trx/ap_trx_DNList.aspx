...
<head>
	...
	<body>
	    <form id=frmDNList runat="server">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%">
				...
				<tr>
					<td class="mt-h" colspan="3">SUPPLIER DEBIT NOTE LIST</td>
				...
				<tr>
					<td colspan=6 width=100% class="mb-c">
						<table width="100%" cellspacing="0" cellpadding="3" border="0" align="center">
							<tr class="mb-t">
								<td valign=bottom width=12%>Debit Note ID :<BR><asp:TextBox id=txtDNID width=100% maxlength="32" runat="server" /></td>
								<td valign=bottom width=18%>Debit Note Ref. No. :<BR><asp:TextBox id=txtDNRefNoID width=100% maxlength="20" runat="server" /></td>
