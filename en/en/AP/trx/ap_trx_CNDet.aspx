...
<html>
	...
	<body>
		...
		<table id="tblHeader" cellSpacing="0" cellPadding="2" width="100%" border="0">
			...
			<tr>
				<td class="mt-h" colspan="5">SUPPLIER CREDIT NOTE DETAILS</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td width="10%"><asp:Label id=lblAccPeriod runat=server /></td>
				<td></td>
			</tr>
			<tr>
				<td height=25>Credit Note Ref. No. : </td>
				<td><asp:TextBox id=txtCNRefNo width=100% maxlength=20 runat=server />
			...
			<tr>
				...
				<td><asp:TextBox id=txtCNRefDate width=25% maxlength=10 runat=server />
			...
			<tr>
				...
				<td>
				    ...
				    <input type=button value=" ... " id="Find"  onclick="javascript:PopSupplier_New('frmMain','','txtSupCode','txtSupName','txtCreditTerm','txtPPN','txtPPNInit', 'False');" CausesValidation=False runat=server />
                    <asp:ImageButton
                        ID="btnGet" runat="server" AlternateText="Get Data" CausesValidation="False"
                        ImageAlign="AbsMiddle" ImageUrl="../../images/icn_next.gif" OnClick="GetSupplierBtn_Click"
                        ToolTip="Click For Get Data" /><asp:TextBox ID="txtSupName" runat="server" BackColor="Transparent"
                            BorderStyle="None" Font-Bold="True" ForeColor="White" MaxLength="10" Width="99%"></asp:TextBox><br />
						...
						<tr>						
							<td>-->
								<table id="tblSelection" cellSpacing="0" cellPadding="4" width="100%" border="0" runat=server>
									...
									<tr class="mb-c">
										...
										<td width="80%">
                                            <asp:TextBox ID="txtAccCode" runat="server" AutoPostBack="True" MaxLength="15" OnTextChanged="onSelect_StrAccCode"
                                                Width="20%"></asp:TextBox>&nbsp;<input id="Button1" runat="server" onclick="javascript:PopCOA_Desc('frmMain', '', 'txtAccCode', 'txtAccName', 'False');"
                                                    type="button" value=" ... " />
                                            ...
                                            <asp:TextBox ID="txtAccName" runat="server" BackColor="Transparent" BorderStyle="None"
                                                Font-Bold="True" ForeColor="White" MaxLength="10" Width="64%"></asp:TextBox><br />
									...
									<tr class="mb-c">
										<td height=25>Credit Amount :*</td>
										<td><asp:TextBox id=txtCreditAmount width=20% maxlength=22 style="text-align:right" text=0 OnBlur="javascript:lostFocusAmount();" runat=server />											
			...
			<tr>
				<td colspan=3>&nbsp;</td>
				<td height=25>Total Credit Amount : </td>
				<td Align=right><asp:Label ID=lblViewTotalCreditAmount Runat=server />
								<asp:Label ID=lblTotalCreditAmount visible = False Runat=server />&nbsp;</td>
				<td>&nbsp;</td>
			</tr>
			<tr>
				<td colspan=3>&nbsp;</td>
				<td height=25>Outstanding Payment Amount : </td>
				<td Align=right><asp:Label ID=lblViewOutPayAmount Runat=server />
								<asp:Label ID=lblOutPayAmount visible = False Runat=server />&nbsp;</td>
				<td>&nbsp;</td>
			</tr>
			<tr>
			...
			<tr>
			    ...
			    <td align=right style="height: 25px"><asp:Label id=lblTotalViewJournal Visible=false runat=server /> </td>
			    <td style="height: 25px">&nbsp;</td>	
