<%@ Page Language="vb" src="../include/menu_pmrpt.aspx.vb" Inherits="menu_pmrpt" %>
            ...
            <table>
			    ...
			    <td width="20"></td>
						...
						<tr height="20">
							...
							<td class="lb-hti"><asp:hyperlink id="lnkRpt2" runat="server" target="middleFrame"  text="Nursery" cssclass="lb-tti"></asp:hyperlink></td>
						</tr>

						<tr height="20">
							<td width="20"></td>
							<td width="14"><IMG src="images/spacer.gif" border="0" align="left" width="1" height="1"></td>
							<td class="lb-hti"><asp:hyperlink id="lnkRpt3" runat="server" target="middleFrame"  text="Workshop" cssclass="lb-tti"></asp:hyperlink></td>
						</tr>
						</table>
