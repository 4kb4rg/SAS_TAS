<%@ Page Language="vb" src="../include/menu_pdmth.aspx.vb" Inherits="menu_pdmth" %>
           ...
           <div id="Nav" style="position:absolute; width:20%; top:0px; left:0px; height:1000px">
            ...
            <table>
			  ...
			  <tr height="20">
				...
				<td class="lb-hti"><asp:hyperlink id="lnkMth1" runat="server" target="middleFrame"  text="Production" cssclass="lb-tti"></asp:hyperlink></td>
			  </tr>
