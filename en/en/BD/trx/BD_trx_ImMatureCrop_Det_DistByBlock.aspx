<%@ Page Language="vb" SmartNavigation="True" trace="false" src="../../../include/BD_trx_ImMatureCrop_Det_DistByBlock.aspx.vb" Inherits="BD_ImMatureCrop_Det_DistByBlock" %>
<%@ Register TagPrefix="UserControl" Tagname="MenuBDtrx" src="../../menu/menu_BDTrx.ascx"%>
<%@ Register TagPrefix="Preference" Tagname="PrefHdl" src="../../include/preference/preference_handler.ascx"%>
<html>
	<head>
		<title>Immature Crop</title>
	</head>
	<Preference:PrefHdl id=PrefHdl runat="server" />
		<body>
			...
			<asp:label id=lblSubBlkTag visible=false runat=server />
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%">
				...
				<tr>
					<td class="mt-h" colspan="4" width=60%><asp:label id=lblTitleImMatureCrop text="IMMATURE CROP ACTIVITY" runat=server /></td>
				...
				<tr>
					<TD colspan = 6 >					
					<asp:DataGrid id="dgImMatureCropDetDist"
