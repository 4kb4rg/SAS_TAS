<%@ Page Language="vb" SmartNavigation="True" trace="false" src="../../../include/BD_trx_NurseryActivity_Details.aspx.vb" Inherits="BD_NurseryActivity_Det" %>
<%@ Register TagPrefix="UserControl" Tagname="MenuBDtrx" src="../../menu/menu_BDTrx.ascx"%>
<%@ Register TagPrefix="Preference" Tagname="PrefHdl" src="../../include/preference/preference_handler.ascx"%>
<html>
	<head>
		<title>Nursery Activity</title>
	</head>
	<Preference:PrefHdl id=PrefHdl runat="server" />
		<body>
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" runat=server>
				...
				<tr>
					<td class="mt-h" colspan="4" width=60%><asp:label id=lblTitleNurseryActivity text="NURSERY ACTIVITY" runat=server /></td>
				...
				<tr>
					<td colspan="4" width=60%>Total Seed : <asp:label id="lblTotalSeedFig" runat="server"/></td>
					<td align="right" colspan="2" width=40%>&nbsp;</td>
				</tr>
				<tr>
				...
				<tr>
					<TD colspan = 6 >					
					<asp:DataGrid id="dgNurseryActivityDet"
						...
						<Columns>	
							...
							<asp:TemplateColumn HeaderText="Items">
								...
								<ItemTemplate>
									...
									<asp:label id="lblNurseryActID" text=<%# Container.DataItem("NurseryActID") %> Visible=False Runat="server"></asp:label>
							...
							<asp:TemplateColumn HeaderText="Frequency" >
								...
								<ItemTemplate>
									<asp:Label id=lblFreq Text=<%# objGlobal.GetIDDecimalSeparator(FormatNumber(Container.DataItem("Frequency"), 0, True, False, False)) %> runat=server />
								</ItemTemplate>
								<EditItemTemplate>
									<asp:TextBox id="txtFreq" width=100% MaxLength="25"
										Text='<%# FormatNumber(Container.DataItem("Frequency"),0, True, False, False) %>'
										runat="server"/>
							...
							<asp:TemplateColumn HeaderText="Others" >
								...
								<EditItemTemplate>
									...
									<asp:RegularExpressionValidator id="RegExpOtherCost" 
										ControlToValidate="txtOtherCost"
										ValidationExpression="\d{1,19}"
										Display="Dynamic"
										text = "Maximum length 19 digits and 0 decimal points"
										runat="server"/>
									<asp:RangeValidator id="RangeOtherCost"
										ControlToValidate="txtOtherCost"
										MinimumValue="-9999999999999999999"
										MaximumValue="9999999999999999999"
										Type="double"
							...
							<asp:TemplateColumn HeaderText="Materials" >
								...
								<EditItemTemplate>
									...
									<asp:TextBox id="txtMaterialCost" width=100% MaxLength="25"
										...
										visible=false runat="server"/>
									<asp:RegularExpressionValidator id="RegExpMaterialCost" 
										ControlToValidate="txtMaterialCost"
										ValidationExpression="\d{1,19}"
										Display="Dynamic"
										text = "Maximum length 19 digits and 0 decimal points"
										runat="server"/>
									<asp:RangeValidator id="RangeMaterialCost"
										ControlToValidate="txtMaterialCost"
										MinimumValue="-9999999999999999999"
										MaximumValue="9999999999999999999"
										Type="double"
							...
							<asp:TemplateColumn HeaderText="Labour" >
								...
								<EditItemTemplate>
									...
									<asp:TextBox id="txtLabourCost" width=100% MaxLength="25"
										...
										visible=false runat="server"/>
									<asp:RegularExpressionValidator id="RegExpLabourCost" 
							...
							<asp:TemplateColumn HeaderText="Cost per Seed" >
								<HeaderStyle HorizontalAlign="Right" />			
								<ItemStyle  Width="8%" HorizontalAlign="Right" />						
								<ItemTemplate>
									<asp:Label id=lblCostperSeed Text=<%# objGlobal.GetIDDecimalSeparator(FormatNumber(Container.DataItem("CostperSeed"), 0, True, False, False)) %> runat=server />
								</ItemTemplate>
								<EditItemTemplate>
									<asp:Label id=lblCostperSeed Text=<%# objGlobal.GetIDDecimalSeparator(FormatNumber(Container.DataItem("CostperSeed"), 0, True, False, False)) %> runat=server />
									<asp:TextBox id="txtCostperSeed" width=100% MaxLength="25"
										Text='<%# FormatNumber(Container.DataItem("CostperSeed"),0, True, False, False) %>'
										visible=false runat="server"/>
										<asp:RegularExpressionValidator id="RegExpCostperSeed" 
										ControlToValidate="txtCostperSeed"
										ValidationExpression="\d{1,19}"
										Display="Dynamic"
										text = "Maximum length 19 digits and 0 decimal points"
										runat="server"/>
									<asp:RangeValidator id="RangeCostPerSeed"
										ControlToValidate="txtCostperSeed"
										MinimumValue="-9999999999999999999"
										MaximumValue="9999999999999999999"
										Type="double"
				...
				<tr>
					<td align="left" ColSpan=6>
						...
						<asp:Label id=lblNoRecord visible=false Text="Total seed cannot be zero !" Forecolor=red runat=server />
					</td>
				</tr>
			</table>
		</FORM>
