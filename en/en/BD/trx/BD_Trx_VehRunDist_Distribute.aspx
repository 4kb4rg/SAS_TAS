<%@ Page Language="vb" trace="False" src="../../../include/BD_trx_VehRunDist_Distribute.aspx.vb" Inherits="BD_VehRunDist_Dist" %>
<%@ Register TagPrefix="Preference" Tagname="PrefHdl" src="../../include/preference/preference_handler.ascx"%>
<html>
	<head>
		<title>Vehicle Running Distribution</title>
	</head>
		<Preference:PrefHdl id=PrefHdl runat="server" />
		<body onload="this.focus()" >
		    <form runat="server" ID="Form1">
			<asp:Label id=lblErrMessage visible=false Text="Error while initiating component." runat=server />
			<asp:label id="lblVehRunDistID" visible=false runat="server"/>
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%">
				...
				<tr>
					<td colspan="4" width=60%><asp:label id="lblVehTag" runat="server"/> : <asp:label id="lblVehCode" runat="server"/></td>
					<td align="right" colspan="2" width=40%>&nbsp;</td>
				</tr>
				<tr>
