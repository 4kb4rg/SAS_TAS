<%@ Page Language="vb" trace="False" src="../../../include/BD_trx_ImMatureCropDist_Distribute.aspx.vb" Inherits="BD_ImMatureCrop_Dist" %>
...
<html>
	<head>
		...
		<body onload="this.focus()" >
			...
			<asp:label id="lblUnMatureCropDistID" visible=False runat="server"/>
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" runat=server>
				...
				<tr>
					...
					<asp:TemplateColumn HeaderText="Figure" >
						<ItemTemplate>
							<asp:TextBox id="TxFig" width=100% maxlength="19" runat="server"/>						
