<%@ Page Language="vb" trace="false" SmartNavigation="True" src="../../../include/BD_trx_PlantationOH_Details.aspx.vb" Inherits="BD_PlantationOH_Det" %>
...
<html>
	...
	<Preference:PrefHdl id=PrefHdl runat="server" />
		<body>
			...
			<asp:Label id=lblBgtActivePrd visible=false Text="No Active Periods in Budgeting Module !" runat=server />
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%">
				...
				<tr>
					<td class="mt-h" colspan="4" width=60%><asp:label id=lblPlantOHTitle Text="PLANTATION OVERHEADS" runat=server /></td>
				...
				<tr>
					<td colspan="4" width=60%>Total Planted Area Size : <asp:label id="lblTotalAreaFig" runat="server"/></td>
					<td align="right" colspan="2" width=40%>&nbsp;</td>
				</tr>
				<tr>
				...
				<tr>
					<td align="left" ColSpan=6>
						...
						<asp:Label id=lblNoRecordTop visible=false Text="Area Size or Crop Production Budgeted cannot be zero !" Forecolor=red runat=server />
					</td>
				</tr>				
				<tr>
					<TD colspan = 6 >					
					<asp:Label id=lblerrMessage2 visible=false Text="Error updating database (Overflow)" Forecolor=red runat=server />
					<asp:DataGrid id="dgPlantOH"
						...
						<Columns>	
							...
							<asp:TemplateColumn HeaderText="Items">
								...
								<ItemTemplate>
									...
									<asp:label id="lblOverheadSetID" text=<%# Container.DataItem("OverheadSetID") %> Visible=False Runat="server"></asp:label>
								...
								<EditItemTemplate>
									...
									<asp:label id="lblDispType" text=<%# Trim(Container.DataItem("ItemdisplayType")) %> Visible=False Runat="server"></asp:label>																
									<asp:label id="lblDispCol" text=<%# Trim(Container.DataItem("ItemDisplayCol")) %> Visible=False Runat="server"></asp:label>																
									<asp:Label id=lblLnNoRecord visible=false Text="<Br> Area Size or Crop Production cannot be zero !" Forecolor=red runat=server />
								</EditItemTemplate>
							</asp:TemplateColumn>
							...
							<asp:TemplateColumn HeaderText="Cost Per Weight" >
								<ItemStyle  Width="6%" HorizontalAlign="Right" />						
								<ItemTemplate>
