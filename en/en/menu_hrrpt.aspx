<%@ Page Language="vb" src="../include/menu_hrrpt.aspx.vb" Inherits="menu_hrrpt" %>
           ...
           <div id="Nav" style="position:absolute; width:20%; top:0px; left:0px; height:1000px">
            ...
            <table id="tlbRpt" cellSpacing="0" cellPadding="0" width="100%" runat="server">
			  <%--  <tr height="20">
				    ...
				    <td class="lb-hti"><asp:hyperlink id="lnkRpt1" runat="server" target="middleFrame"  text="Human Resources" cssclass="lb-tti"></asp:hyperlink></td>
			    </tr>
			    <tr height="20">
				    <td width="20"></td>
				    <td width="14"><IMG src="images/spacer.gif" border="0" align="left"></td>
				    <td class="lb-hti"><asp:hyperlink id="lnkRpt2" runat="server" target="middleFrame"  text="Payroll" cssclass="lb-tti"></asp:hyperlink></td>
			    </tr>--%>
			
			    <tr height="20">
				    <td width="20"></td>
				    <td width="14"><IMG src="images/spacer.gif" border="0" align="left"></td>
				    <td class="lb-hti"><asp:hyperlink id="lnkRpt1" runat="server" target="middleFrame"  text="Human Resources-Estate" cssclass="lb-tti"></asp:hyperlink></td>
			    </tr>
			    <tr height="20">
				    <td width="20"></td>
				    <td width="14"><IMG src="images/spacer.gif" border="0" align="left"></td>
				    <td class="lb-hti"><asp:hyperlink id="lnkRpt2" runat="server" target="middleFrame"  text="Payroll-Estate" cssclass="lb-tti"></asp:hyperlink></td>
			    </tr>
