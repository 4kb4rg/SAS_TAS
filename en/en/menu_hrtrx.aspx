                  ...
                  <table id="TblPR_EstateHead" cellSpacing="0" cellPadding="0" width="100%" runat="server">
						...
						<table id="tblPR_Estate" style="VISIBILITY: hidden; POSITION: absolute" cellSpacing="0" cellPadding="0"
							...
							<tr height="20">
								<td width="20"></td>
								<td width="14">&nbsp;<IMG src="images/dot.gif" border="0"></td>
								<td class="lb-mti"><asp:hyperlink class="lb-mt" id="Hyperlink6" runat="server" NavigateUrl="/en/PR/Trx/PR_trx_RKHList_Estate.aspx"  target="middleFrame" text="Rencana Kerja " ></asp:hyperlink></td>
							</tr>
							--%>
							...
							<tr height="20">
								<td width="20"></td>
								<td width="14">&nbsp;<IMG src="images/dot.gif" border="0"></td>
								<td class="lb-mti"><asp:hyperlink class="lb-mt" id="Hyperlink55" runat="server" NavigateUrl="/en/PR/Trx/PR_trx_koreksibasisEmp_estate.aspx"  target="middleFrame" text="Koreksi Basis Panen" ></asp:hyperlink></td>
							</tr>
							--%>
