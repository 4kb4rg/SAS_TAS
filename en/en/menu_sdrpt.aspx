<%@ Page Language="vb" src="../include/menu_sdrpt.aspx.vb" Inherits="menu_sdrpt" %>
    ...
    <form id="form1" runat="server">
           ...
           <div id="Nav" style="position:absolute; width:20%; top:0px; left:0px; height:1000px">
			 ...
			 <tr height="20">
				...
				<td class="lb-hti"><asp:hyperlink id="lnkRpt1" runat="server" target="middleFrame"  text="Contract Management" cssclass="lb-tti"></asp:hyperlink></td>
			 </tr>

                         <tr height="20">
				<td width="20"></td>
				<td width="14"><IMG src="images/spacer.gif" border="0" align="left" width="1" height="1"></td>
				<td class="lb-hti"><asp:hyperlink id="lnkRpt2" runat="server" target="middleFrame"  text="Weighing Management" cssclass="lb-tti"></asp:hyperlink></td>
			 </tr>	
