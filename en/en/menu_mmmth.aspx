<%@ Page Language="vb" src="../include/menu_mmmth.aspx.vb" Inherits="menu_mmmth" %>
           ...
           <div id="Nav" style="position:absolute; width:20%; top:0px; left:0px; height:1000px">
            ...
            <table>
			    ...
			    <td width="20"></td>
                        ...
                        <table id="tblMth" cellSpacing="0" cellPadding="0" width="100%" runat="server">
			  <tr height="20">
				<td width="20"></td>
				<td width="14"><IMG src="images/spacer.gif" border="0" align="left" width="1" height="1"></td>
				<td class="lb-hti"><asp:hyperlink id="lnkMth1" runat="server" target="middleFrame"  text="Inventory" cssclass="lb-tti"></asp:hyperlink></td>
			  </tr>

			  <tr height="20">
				<td width="20"></td>
				<td width="14"><IMG src="images/spacer.gif" border="0" align="left" width="1" height="1"></td>
				<td class="lb-hti"><asp:hyperlink id="lnkMth2" runat="server" target="middleFrame"  text="Purchasing" cssclass="lb-tti"></asp:hyperlink></td>
			  </tr>
			</table>
