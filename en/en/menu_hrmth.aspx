<%@ Page Language="vb" src="../include/menu_hrmth.aspx.vb" Inherits="menu_hrmth" %>
           ...
           <div id="Nav" style="position:absolute; width:20%; top:0px; left:0px; height:1000px">
            ...
            <table>
			  ...
			  <tr height="20">
				...
				<td class="lb-hti"><asp:hyperlink id="lnkMth1" runat="server" target="middleFrame"  text="Payroll" cssclass="lb-tti"></asp:hyperlink></td>
			  </tr>
