...
<html>
	...
	<body>
		...
		<table id="tblHeader" cellSpacing="0" cellPadding="2" width="100%" border="0">
			...
			<tr>
				<td class="mt-h" colspan="6">DEBTOR JOURNAL DETAILS</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><asp:DropDownList id=ddlBillParty width=100% AutoPostBack=true OnSelectedIndexChanged=onSelect_Change runat=server/>
							...
							<td>-->
								<table id="tblSelection" cellSpacing="0" cellPadding="4" width="100%" border="0" runat=server>
									<tr class="mb-c">
										...
										<td colSpan="5"><asp:dropdownlist id=ddlAccMonth size=1 width=10% runat=server >
											...
											<asp:dropdownlist id=ddlAccYear size=1 width=10% runat=server />&nbsp;
									...
									<tr class="mb-c">
										...
										<td colSpan="5"><asp:DropDownList id=ddlInvoice width=95% autopostback=true onSelectedIndexChanged=onSelect_InvPPNH runat=server/></td>
									</tr>
									<tr class="mb-c">
										<td height=25 width=20%>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2. Debit Note ID :</td>
										<td colSpan="5"><asp:DropDownList id=ddlDebitNote width=95% runat=server/></td>
									</tr>
									<tr class="mb-c">
										<td height=25 width=20%>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;3. Credit Note ID :</td>
										<td colSpan="5"><asp:Dropdownlist id=ddlCreditNote width=95% runat=server/></td>
									</tr>
									<tr class="mb-c">
										<td height=25 width=20%>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;4. Receipt ID :</td>
										<td colSpan="5"><asp:Dropdownlist id=ddlReceipt width=95% autopostback=true onSelectedIndexChanged=onSelect_RecPPNH runat=server/>
									...
									<tr class="mb-c">
										...
										<td colSpan="5"><asp:Dropdownlist id=ddlDebtorJrn width=95% runat=server/></td>
									</tr>
									<tr class="mb-c">
									...
									<tr class="mb-c">
										...
										<td colSpan="5"><asp:Dropdownlist id=ddlAccount width=95% onselectedindexchanged=onSelect_Account autopostback=true runat=server/>
			...
			<tr>
				...
				<asp:Label ID=lblViewTotalAmount Runat=server />
