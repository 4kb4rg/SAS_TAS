<%@ Page Language="vb" src="../../../include/BI_data_download.aspx.vb" Inherits="BI_data_download" %>
<%@ Register TagPrefix="UserControl" Tagname="MenuBIData" src="../../menu/menu_BIData.ascx"%>
...
<html>
	...
	<body>
		<table border="0" width="100%" cellpadding="1" cellspacing="0">
			<tr>
				<td width="100%" align=center><UserControl:MenuBIData id=MenuBIData runat="server" /></td>
			</tr>
			<tr>
				<td width="100%">
					...
					<table id=tblDownload border="0" cellpadding="0" cellspacing="0" width="100%" runat=server>
						...
						<tr>
							<td width="100%" colspan="4">Billing Reference Data</td>
						</tr>
						<tr>
						...
						<tr>
							<td>&nbsp;</td>
							<td colspan=3><asp:CheckBox id=cbBillParty text="Bill Party" runat=server /></td>
						</tr>
						<tr>
