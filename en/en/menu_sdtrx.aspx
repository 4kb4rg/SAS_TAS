	  ...
	  <table id="tblSpc1" cellSpacing="0" cellPadding="0" width="100%" runat="server">
	   ...
	   <table id="tblWMHead" cellSpacing="0" cellPadding="0" width="100%" border="0" runat="server">
        ...
        <table id="tblSDHead" cellSpacing="0" cellPadding="0" width="100%" border="0" runat="server">
		    ...
		    <td width="20"></td>
		    <td width="14"><IMG src="images/arow.gif" border="0" align="left" width="5" height="8"></td>
		    <td class="lb-hti"><A class="lb-tti" href="javascript:togglebox(tblSD);">Distribution</A></td>
		    </tr>
	    </table>
	    
	     <table id="tblSD" style="VISIBILITY: hidden; POSITION: absolute" cellSpacing="0" cellPadding="0" runat="server" >
		    <tr height="20">
			    <td width="20"></td>
			    <td width="14">&nbsp;<IMG src="images/leftdot.gif" border="0" width="1" height="1"></td>
			    <td class="lb-mti"><asp:hyperlink class="lb-mt" id="lnkSD1" runat="server" NavigateUrl="/en/IN/trx/IN_Trx_StockSales_List.aspx?type=SD" target="middleFrame" text="Sales"></asp:hyperlink></td>
		    </tr>
		 </table>
		 -->
      </div>
