<%@ Page Language="vb" src="../../include/reports/NU_StdRpt_DoubleTurnList.aspx.vb" Inherits="NU_StdRpt_DoubleTurnList" %>
...
<HTML>
	<HEAD>
		<title>Nursery - Double-Turns Listing</title>
	...
	<body>
        ...
        <td style="width: 100%; height: 800px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1"  class="font9Tahoma">
				<tr>
					<td class="mt-h" colspan="3">NURSERY - DOUBLE-TURNS LISTING</td>
