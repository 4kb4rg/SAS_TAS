<%@ Page Language="vb" src="../../include/reports/PD_StdRpt_ProdStat_Estate.aspx.vb" Inherits="PD_StdRpt_ProdStat_Estate" %>
	...
	<body>
        ...
        <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma">
				<tr>
					<td class="font9Tahoma"><strong>PRODUCTION - PENGIRIMAN TBS REPORT</strong> </td>
			...
			<table width=100% border="0" cellspacing="1" cellpadding="1" ID="Table2" class="font9Tahoma" runat=server>	
			   <tr>
				...
				<tr>
					<td width=25%>Tujuan Pabrik : </td>
					<td colspan=3>
						<asp:DropDownList id="ddlMill" width="45%" runat="server" />						
					</td>			
				</tr>
				<tr>
					<td colspan="4">
