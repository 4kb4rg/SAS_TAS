<%@ Page Language="vb" src="../../include/reports/CT_StdRpt_PRList.aspx.vb" Inherits="CT_StdRpt_PRList" %>
...
<HTML>
	<HEAD>
		<title>Canteen - Purchase Request Report</title>
		...
		<tr>
           <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma">
				<tr>
					<td class="mt-h" colspan="3">CANTEEN - PURCHASE REQUEST LISTING</td>
