<%@ Page Language="vb" src="../../include/reports/CT_StdRpt_StkUsageFreqList.aspx.vb" Inherits="CT_StdRpt_StkUsageFreqList" %>
...
<HTML>
	<HEAD>
		<title>Canteen - Usage Frequency Listing</title>
		...
		<tr>
           <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1"  class="font9Tahoma">
				<tr>
					<td class="mt-h" colspan="3">CANTEEN - USAGE FREQUENCY LISTING</td>
			...
			<table width=100% border="0" cellspacing="1" cellpadding="1" ID="Table2"  class="font9Tahoma">
				...
				<tr>
					...
					<td><asp:RadioButton id="rbIssAll" text="All" checked="true" GroupName="rbIss" runat="server" />&nbsp;			
						<asp:RadioButton id="rbIss" text="Issued Before" GroupName="rbIss" runat="server" />&nbsp;	
						<asp:RadioButton id="rbNIss" text="Never Issued Before" GroupName="rbIss" runat="server" /></td>
				<td>&nbsp;</td>
					<td>&nbsp;</td>								
				</tr>																				
				<tr>
