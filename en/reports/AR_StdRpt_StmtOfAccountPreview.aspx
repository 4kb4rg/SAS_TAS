<%@ Page Language="vb" Src="../../include/reports/AR_StdRpt_StmtOfAccountPreview.aspx.vb" Inherits="AR_StdRpt_StmtOfAccountPreview" %>
...
<HTML>
	<HEAD>
		<title>Account Receivables Statement Of Account Report</title>
	...
	<body MS_POSITIONING="GridLayout" onload="this.focus()" >
		...
		<asp:Label id=lblNoRecord visible=false text="Statement of Account is not found." runat="server" />	
	</body>
</HTML>
