<%@ Page Language="vb" src="../../include/reports/CB_StdRpt_DailyBank.aspx.vb" Inherits="CB_StdRpt_DailyBank" %>
...
<HTML>
	<HEAD>
		<title>Cash And Bank - Daily Bank Transaction</title>
		...
		<tr>
           <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" class="font9Tahoma" ID="Table1">
				<tr>
					<td class="font9Tahoma" colspan="3"><strong> CASH AND BANK - DAILY BANK TRANSACTION</strong></td>
			...
			<table width=100% border="0" cellspacing="1" cellpadding="1" ID="Table2" class="font9Tahoma" runat=server>	
				...
				<tr>
					<td colspan="3">
                       <asp:CheckBox id="cbKomparatif" text=" Comparative" checked="false" runat="server" /></td>
				</tr>
				<tr>
					<td colspan="3">
                       <asp:CheckBox id="cbSaldo" text=" Saldo Bank" checked="false" runat="server" /></td>
				</tr>
			    <tr>
					<td colspan="3">
