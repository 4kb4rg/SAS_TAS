<%@ Page Language="vb" src="../../include/reports/IN_StdRpt_InventoryValList.aspx.vb" Inherits="IN_StdRpt_InventoryValList" %>
...
<HTML>
	<HEAD>
		<title>Inventory - Inventory Valuation Listing</title>
	...
	<body>
        ...
        <td style="width: 100%; height: 800px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1">
				<tr>
					<td class="font9Tahoma" colspan="3"><strong>INVENTORY - INVENTORY VALUATION LISTING</strong> </td>
			...
			<table width=100% border="0" cellspacing="0" cellpadding="1" ID="Table2" class="font9Tahoma">
				...
				<tr>
					<td>Item Code :</td>
					<td colspan=3 ><asp:textbox id="txtItemCode" maxlength=20 width="30%" runat="server" /> 
					<input type=button value=" ... " id="Find" onclick="javascript:PopItem('frmMain', '', 'txtItemCode', 'False');" CausesValidation=False runat=server />
					(blank for all)</td>
					<td>&nbsp;</td>
				</tr>
				<tr>
					<td>Variable Level :</td>
					<td colspan=2 ><asp:textbox id="txtVarLevel" maxlength=3 width="30%" runat="server" /> %</td>
					<td>&nbsp;</td>
				</tr>
				<tr>
