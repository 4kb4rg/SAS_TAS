<%@ Page Language="vb" src="../../include/reports/AR_StdRpt_LaporanPenjualan.aspx.vb" Inherits="AR_StdRpt_LaporanPenjualan" %>
...
<HTML>
	<HEAD>
		<title>Account Receivable - Laporan Penjualan</title>
		...
		<tr>
           <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1">
				<tr>
					<td class="font9Tahoma" colspan="3"><strong> ACCOUNT RECEIVABLE - LAPORAN PENJUALAN</strong></td>
