<%@ Page Language="vb" src="../../include/reports/GL_StdRpt_UpahPanen.aspx.vb" Inherits="GL_StdRpt_UpahPanen" %>
...
<HTML>
	<HEAD>
		<title>General Ledger - Managerial Report (Upah Panen(Rp/Kg))</title>
	...
	<body>
		...
		<tr>
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma">
				<tr>
					<td class="mt-h" colspan="3">GENERAL LEDGER - MANAGERIAL REPORT (UPAH PANEN(RP/KG))</td>
			...
			<table width=100% border="0" cellspacing="2" cellpadding="1" ID="Table2" class="font9Tahoma" runat=server>
				...
				<tr>
					...
					<td colspan=2>
						<asp:TextBox id="txtRemark"  runat="server" maxlength=128/>
					</td>			
				</tr>						
				<tr>
					<td colspan=3>&nbsp;</td>
