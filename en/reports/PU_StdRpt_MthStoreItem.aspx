<%@ Page Language="vb" src="../../include/reports/PU_StdRpt_MthStoreItem.aspx.vb" Inherits="PU_StdRpt_MthStoreItem" %>
...
<HTML>
	<HEAD>
		<title>Purchasing - Monthly Purchases Item</title>
	...
	<body>
        ...
        <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma">
				<tr>
					<td class="font9Tahoma" colspan="3"><strong>PURCHASING - MONTHLY PURCHASES ITEM</strong> </td>
