<%@ Page Language="vb" src="../../include/reports/CT_StdRpt_StkReceiveList.aspx.vb" Inherits="CT_StdRpt_StkReceiveList" %>
...
<HTML>
	<HEAD>
		<title>Canteen - Canteen Receive Listing</title>
		...
		<tr>
           <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma">
				<tr>
					<td class="font9Tahoma" colspan="3">CANTEEN - CANTEEN RECEIVE LISTING</td>
			...
			<table width=100% border="0" cellspacing="1" cellpadding="1" ID="Table2" class="font9Tahoma" runat=server>	
				<tr>
					<td>Canteen Receive ID From :</td>
					<td><asp:textbox id="txtStkRcvIDFrom" width="50%" runat="server" /> (blank for all)</td>
					<td>To :</td>
					<td><asp:textbox ID="txtStkRcvIDTo" maxlength=20 width="50%" Runat=server /> (blank for all)</td>
				</tr>
				<tr>
					<td>Canteen Receive Ref No :</td>
					<td><asp:textbox id="txtStkRefNo" maxlength=20 width="50%" runat="server" /> (blank for all)</td>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
				</tr>	
				<tr>
