<%@ Page Language="vb" src="../../include/reports/HR_StdRpt_EmployeeDetail_Estate.aspx.vb" Inherits="HR_StdRpt_EmployeeDetail_Estate" %>
...
<HTML>
	<HEAD>
		<title>Human Resource - Karyawan Details </title>
	...
	<body>
        ...
        <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma">
				<tr>
					<td class="font9Tahoma" colspan="3"><strong>Laporan Karyawan Detail</strong> </td>
			...
			<table width=100% border="0" cellspacing="1" cellpadding="1" ID="Table2" class="font9Tahoma" runat=server>	
				...
				<tr>
					...
					<td width=35%><asp:DropDownList id="ddldivisi"  width="100%" OnSelectedIndexChanged="ddldivisi_OnSelectedIndexChanged" AutoPostBack=true runat="server" /></td>
					<td width=15%>&nbsp;</td>
					<td width=35%>&nbsp;</td>									
				</tr>
				...
				<tr>
					...
					<td width=35%><asp:DropDownList id="ddlemp" width="100%" runat="server" /></td>
					<td width=15%>&nbsp;</td>
					<td width=35%>&nbsp;</td>									
				</tr>
