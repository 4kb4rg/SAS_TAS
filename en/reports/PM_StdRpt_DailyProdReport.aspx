<%@ Page Language="vb" trace=false src="../../include/reports/PM_StdRpt_DailyProdReport.aspx.vb" Inherits="PM_StdRpt_DailyProdReport" %>
	...
	<body>
        ...
        <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma">
				<tr>
					<td class="font9Tahoma" colspan="3"><strong>PRODUCTION MANAGEMENT - DAILY PRODUCTION REPORT</strong> </td>
