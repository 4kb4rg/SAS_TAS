<%@ Page Language="vb" src="../../include/reports/CM_StdRpt_CurrencyMasterList.aspx.vb" Inherits="CM_StdRpt_CurrencyMasterList" %>
...
<HTML>
	<HEAD>
		<title>Contract Management - Currency Master Listing</title>
		...
		<tr>
           <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma">
				<tr>
					<td class="font9Tahoma" colspan="3"><strong>CONTRACT MANAGEMENT - CURRENCY MASTER LISTING</strong> </td>
			...
			<table width="100%" border="0" cellspacing="1" cellpadding="1" ID="Table1" class="font9Tahoma">
				<tr>
					<td>Currency Code : </td>
					<td><asp:textbox id="txtCurrencyCode" maxlength=8 width="50%" runat="server" /> (blank for all)</td>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
				</tr>
				<tr>
				...
				<tr ID="trUpdateBy" >
					<td>Updated By :</td>
					<td><asp:TextBox id="TxtUpdatedBy" maxlength="8" width="50%" runat="server" /> (blank for all) </td>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
				</tr>
				<tr>
