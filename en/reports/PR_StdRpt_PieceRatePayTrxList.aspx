<%@ Page Language="vb" src="../../include/reports/PR_StdRpt_PieceRatePayTrxList.aspx.vb" Inherits="PR_StdRpt_PieceRatePayTrxList" %>
...
<HTML>
	<HEAD>
		<title>Payroll - Piece Rate Payment Transaction Listing</title>
	...
	<body>
		<form runat="server" ID="frmMain">
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1">
				<tr>
					<td class="mt-h" colspan="3">PAYROLL - PIECE RATE PAYMENT TRANSACTION LISTING</td>
			...
			<table width=100% border="0" cellspacing="1" cellpadding="1" ID="Table2" runat=server>	
				...
				<tr>
					<td>Gang Code : </td>  
					<td>
						<asp:TextBox id="txtGangCode" maxlength=8 width=50% runat="server"/> (leave blank for all)
					</td>	
					<td colspan=2>&nbsp;</td>	
				</tr>	
				<tr>
				...
				<tr>
					...
					<td>
						<asp:TextBox id="txtGroupRef" maxlength=20 width=50% runat="server"/> (leave blank for all)
					</td>
					<td colspan=2>&nbsp;</td>	
				</tr>
				<tr>
					...
					<td>
						<asp:TextBox id="txtRefDate" maxlength=8 width=50% runat="server"/>
