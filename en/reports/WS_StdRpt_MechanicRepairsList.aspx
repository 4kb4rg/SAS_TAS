<%@ Page Language="vb" src="../../include/reports/WS_StdRpt_MechanicRepairsList.aspx.vb" Inherits="WS_StdRpt_MechanicRepairsList" %>
...
<HTML>
	<HEAD>
		<title>Workshop - Mechanic Repairs Report</title>
	...
	<body>
        ...
        <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma">
				<tr>
					<td class="font9Tahoma" colspan="3"><strong>WORKSHOP - MECHANIC REPAIRS REPORT</strong> </td>
				...
				<tr>
					<td colspan="6"><asp:Label id="lblDate" forecolor=red visible="false" text="Incorrect Date Format. Date Format is " runat="server" />
									<asp:Label id="lblErrAccMonth" forecolor=red visible="false" text="Accounting Month from cannot be bigger than Accounting Year To if same year." runat="server" />
			...
			<table width=100% border="0" cellspacing="1" cellpadding="1" ID="Table2" class="font9Tahoma" runat=server>
				...
				<tr>
					<td><asp:label id=lblWorkCreateDateFrom runat=server /></td>
					<td><asp:TextBox id="txtWorkCreateDateFrom" size="12" width=50% maxlength="10" runat="server"/>
  								  <a href="javascript:PopCal('txtWorkCreateDateFrom');">
  								  <asp:Image id="btnSelWCDateFrom" runat="server" ImageUrl="../Images/calendar.gif"/></a></td>						
					<td>To :</td>
					<td><asp:TextBox id="txtWorkCreateDateTo" size="12" width=50% maxlength="10" runat="server"/>
  								  <a href="javascript:PopCal('txtWorkCreateDateTo');">
  								  <asp:Image id="btnSelWCDateTo" runat="server" ImageUrl="../Images/calendar.gif"/></a></td>										
				</tr>										
				<tr>
