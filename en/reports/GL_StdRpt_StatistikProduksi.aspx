<%@ Page Language="vb" src="../../include/reports/GL_StdRpt_StatistikProduksi.aspx.vb" Inherits="GL_StdRpt_StatistikProduksi" %>
...
<HTML>
	<HEAD>
		<title>General Ledger - Managerial Report(Statistik Produksi)</title>
	...
	<body>
		...
		<tr>
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma">
				<tr>
					<td class="font9Tahoma" colspan="3"><strong>GENERAL LEDGER - MANAGERIAL REPORT (STATISTIK PRODUKSI)</strong> </td>
