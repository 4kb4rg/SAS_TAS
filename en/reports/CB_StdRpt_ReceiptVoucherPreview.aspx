<%@ Page Language="vb" Src="../../include/reports/CB_StdRpt_ReceiptVoucherPreview.aspx.vb" Inherits="CB_StdRpt_ReceiptVoucherPreview" %>
...
<HTML>
	<HEAD>
		<title>Cash And Bank - Receipt Voucher Report</title>
	</HEAD>
