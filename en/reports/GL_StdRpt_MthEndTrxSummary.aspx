<%@ Page Language="vb" src="../../include/reports/GL_StdRpt_MthEndTrxSummary.aspx.vb" Inherits="GL_StdRpt_MthEndTrxSummary" %>
...
<HTML>
	<HEAD>
		<title>General Ledger - Monthly Account Distribution Report</title>
		...
		<tr>
           <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1">
				<tr>
					<td class="font9Tahoma" colspan="3"><strong>GENERAL LEDGER - MONTHLY ACCOUNT DISTRIBUTION REPORT</strong> </td>
			...
			<table width=100% border="0" cellspacing="2" cellpadding="1" ID="Table2" class="font9Tahoma" runat=server>
				...
				<tr>
					<td colspan=3>
						<asp:CheckBox id="cbDetail" text=" Display a detailed summary." value="yes" runat="server"/>
					</td>
				</tr>											
				<tr>
					<td colspa=3>&nbsp;</td>
