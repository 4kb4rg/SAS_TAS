<%@ Page Language="vb" src="../../include/reports/GL_StdRpt_UpahRata2SKUH.aspx.vb" Inherits="GL_StdRpt_UpahRata2SKUH" %>
...
<HTML>
	<HEAD>
		<title>General Ledger - Managerial Report (Upah Rata - Rata SKU Harian) Report</title>
	...
	<body>
		...
		<tr>
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma">
				<tr>
					<td class="mt-h" colspan="3">GENERAL LEDGER - MANAGERIAL REPORT (UPAH RATA - RATA SKU HARIAN)</td>
