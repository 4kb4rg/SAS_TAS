<%@ Page Language="vb" src="../../include/reports/CB_StdRpt_Transaction.aspx.vb" Inherits="CB_StdRpt_Transaction" %>
           ...
           <td style="width: 100%; height: 1500px" valign="top">
			...
			<table width=100% border="0" cellspacing="1" cellpadding="1" ID="Table2" runat=server>	
				...
				<tr>
					...
					<td colspan="2">    
					 <asp:Textbox id="txtAccCode" text = "110.11.01" width=40% maxlength=32 runat=server/>
