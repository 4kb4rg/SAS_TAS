<%@ Page Language="vb" src="../../include/reports/AR_StdRpt_ReceiptList.aspx.vb" Inherits="AR_StdRpt_ReceiptList" %>
...
<HTML>
	<HEAD>
		<title>Account Receivables - Receipt Listing </title>
		...
		<tr>
           <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma">
				<tr>
					<td class="font9Tahoma" colspan="3"><strong>ACCOUNT RECEIVABLES - RECEIPT LISTING</strong> </td>
			...
			<table width=100% border="0" cellspacing="1" cellpadding="1" ID="Table2" class="font9Tahoma" runat=server>	
				<tr>
					...
					<td width=39%><asp:textbox id="txtReceiptIDFrom"  maxlength=20 width="50%" runat="server" /> (blank for all) </td>
					<TD width=4%>To :</TD>
					<TD width=40%><asp:TextBox ID=txtReceiptIDTo maxlength=20 width="50%" Runat=server /> (blank for all) </TD>
				</tr>
				...
				<tr>
					...
					<td width=39%><asp:textbox id="txtBankCode"  maxlength=8 width="50%" runat="server" /> (blank for all)</td>
					<TD width=4%>&nbsp;</TD>
					<TD width=40%>&nbsp;</TD>
				</tr>
				<tr>
