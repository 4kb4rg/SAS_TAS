<%@ Page Language="vb" Src="../../include/reports/WS_StdRpt_WorkshopIssueReturnSlip.aspx.vb" Inherits="WS_StdRpt_WorkshopIssueReturnSlip" %>
...
<html>
	<head>
		<title>Workshop - Workshop Issue/Return Slip</title>
	...
	<body>
        ...
        <td style="width: 100%; height: 1500px" valign="top">
			...
			<table ID="tblMain" Border="0" CellSpacing="1" CellPadding="1" Width="100%">
				<tr>
					<td Class="font9Tahoma" ColSpan="6">WORKSHOP - WORKSHOP ISSUE/RETURN SLIP</td>
				</tr>
				<tr>
					<td ColSpan="6">
                        <hr style="width :100%" /> 
