<%@ Page Language="vb" src="../../include/reports/GL_StdRpt_TrialBalDailyByTransTemp.aspx.vb" Inherits="GL_StdRpt_TrialBalDailyByTransTemp" %>
...
<HTML>
	<HEAD>
		<title>General Ledger - Detail Jurnal Transaction Temporary Report</title>
	...
	<body>
		...
		<tr>
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1">
				<tr>
					<td class="font9Tahoma" colspan="3"><strong> GENERAL LEDGER - DETAIL JURNAL TRANSACTION TEMPORARY REPORT </strong></td>
			...
			<table width="100%" border="0" cellspacing="2" cellpadding="1" ID="Table2" class="font9Tahoma" runat=server>	
				...
				<tr>
					...
					<tr>
					<td width=15%>Transaction ID From : </td>  
					<td width=30%><asp:TextBox id="txtSrchTrxIDFrom" width="90%" runat="server"/> </td>
					<td width=15%>To : </td>
					<td width=30%><asp:TextBox id="txtSrchTrxIDTo" width="90%" runat="server"/> </td>
				</tr>						
				<tr>
					<td colspan="6">&nbsp;</td>
				</tr>
				...
				<tr>
				    <td colspan="6">
                    <asp:CheckBox id="cbVoucher" text=" Voucher" checked="false" runat="server" /></td>
				</tr>
