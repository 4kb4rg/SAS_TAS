<%@ Page Language="vb" src="../../include/reports/PU_StdRpt_GoodsRcvList.aspx.vb" Inherits="PU_StdRpt_GoodsRcvList" %>
...
<HTML>
	<HEAD>
		<title>Purchasing - Goods Receive Listing</title>
	...
	<body>
        ...
        <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma">
				<tr>
					<td class="font9Tahoma" colspan="3"><strong> PURCHASING - GOODS RECEIVE LISTING</strong></td>
			...
			<table width=100% border="0" cellspacing="1" cellpadding="1" ID="Table2" class="font9Tahoma" runat=server>	
				...
				<tr>
					...
					<td><asp:textbox id="txtDocIDFrom" width="50%" maxlength=32 runat="server" /> (blank for all)</td>
					<td>To :</td>
					<td><asp:textbox id="txtDocIDTo" width="50%" maxlength=32 runat="server" /> (blank for all)</td>
				</tr>			
				<tr>
					<td>Goods Received Ref No From :</td>
					<td><asp:textbox id="txtDocNoFrom" width="50%" maxlength=32 runat="server" /> (blank for all)</td>
					<td>To :</td>
					<td><asp:textbox id="txtDocNoTo" width="50%" maxlength=32 runat="server" /> (blank for all)</td>
				</tr>			
				<tr>
				...
				<tr>
					<td>Item Code :</td>
					<td><asp:textbox id="txtItemCode" width="50%" runat="server" /> 
				...
				<tr>
					...
					<td><asp:textbox id="txtAccCode" width="50%" runat="server" /> (blank for all)</td>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><asp:textbox id="txtVehCode" width="50%" runat="server" /> (blank for all)</td>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
				</tr>
				<tr>
					<td><asp:label id=lblVehExpCode runat=server /></td>
					<td><asp:textbox id="txtVehExpCode" width="50%" runat="server" /> (blank for all)</td>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
				</tr>
				<tr>
				...
				<tr>
					<td height="25">To <asp:label id=lblLocation runat=server /> Code :*</td>
					<td><asp:DropDownList id=ddlToLocCode width=100% runat=server />
						<asp:Label id=lblToLocCode forecolor=red visible=false runat=server /></td>
					<td>&nbsp;</td>											
				</tr>					
				<tr>
					<td width=25%>Group By : </td>
					<td colspan=2><asp:RadioButton id="rbTrx" text="GRID" checked="true" GroupName="rbGroup" runat="server" />
					    <asp:RadioButton id="rbItem" text="Item" GroupName="rbGroup" runat="server" />
						<asp:RadioButton id="rbSupp" text="Supplier" GroupName="rbGroup" runat="server" />
					</td>			
					<td colspan=3>&nbsp;</td>
				</tr>
				<tr>
