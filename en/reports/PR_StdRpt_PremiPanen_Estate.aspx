<%@ Page Language="vb" src="../../include/reports/PR_StdRpt_PremiPanen_Estate.aspx.vb" Inherits="PR_StdRpt_PremiPanen_Estate" %>
...
<HTML>
	<HEAD>
		<title>Payroll - Premi Panen</title>
	...
	<body>
		<form runat="server" ID="frmMain">
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1">
				<tr>
					<td class="mt-h" colspan="3">PAYROLL - PREMI PANEN</td>
