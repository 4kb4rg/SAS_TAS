<%@ Page Language="vb" src="../../include/reports/AP_StdRpt_SuppAccAgeList.aspx.vb" Inherits="AP_StdRpt_SuppAccAgeList" %>
...
<HTML>
	<HEAD>
		<title>Accounts Payable - Supplier Account Ageing Listing</title>
		...
		<tr>
           <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1">
				...
				<tr>
					<td class="font9Tahoma" colspan="3"><strong> ACCOUNTS PAYABLE - SUPPLIER ACCOUNT AGEING LISTING</strong></td>
			...
			<table width=100% border="0" cellspacing="1" cellpadding="1" ID="Table2" class="font9Tahoma" runat=server>	
				...
				<tr>
					...
					<td width=35%><asp:textbox id="txtSupplier" width="50%" maxlength=20 runat="server" /> 
				...
				<tr>
					...
					<td><asp:textbox id=txtAccCode maxlength=32 width=50% runat=server  /> 
					    <input type="button" id=btnFind1 value=" ... " onclick="javascript:PopCOA('frmMain', '', 'txtAccCode', 'False');" runat=server/> (blank for all)</td>	
					<td>&nbsp;</td>
				</tr>				
				<tr>
					...
					<td width=39%>
						...
						<asp:Textbox id=txtToAge1 maxlength=3 width=20% runat=server/> Days
						<asp:RequiredFieldValidator 
							id=rfvToAge1
							display=dynamic 
							runat=server
				...
				<tr>
					...
					<td width=39%>
						<asp:Textbox id=txtFromAge2 maxlength=3 width=20% runat=server />
						<asp:RequiredFieldValidator 
							id=rfvFromAge2
							display=dynamic 
							runat=server
						...
						<asp:Textbox id=txtToAge2 maxlength=3 width=20% runat=server/> Days
						<asp:RequiredFieldValidator 
							id=rfvToAge2
							display=dynamic 
							runat=server
				...
				<tr>
					...
					<td width=39%>
						<asp:Textbox id=txtFromAge3 maxlength=3 width=20% runat=server />
						<asp:RequiredFieldValidator 
							id=rfvFromAge3
							display=dynamic 
							runat=server
						...
						<asp:Textbox id=txtToAge3 maxlength=3 width=20% runat=server/> Days
						<asp:RequiredFieldValidator 
							id=rfvToAge3
							display=dynamic 
							runat=server
				...
				<tr>
					...
					<td width=39%>
						<asp:Textbox id=txtFromAge4 maxlength=3 width=20% runat=server />
						<asp:RequiredFieldValidator 
							id=rfvFromAge4
							display=dynamic 
							runat=server
						...
						<asp:Textbox id=txtToAge4 maxlength=3 width=20% runat=server/> Days
						<asp:RequiredFieldValidator 
							id=rfvToAge4
							display=dynamic 
							runat=server
				...
				<tr>
					...
					<td width=39%>
						<asp:Textbox id=txtFromAge5 maxlength=3 width=20% runat=server />
						<asp:RequiredFieldValidator 
							id=rfvFromAge5
							display=dynamic 
							runat=server
