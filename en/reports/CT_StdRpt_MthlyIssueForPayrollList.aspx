<%@ Page Language="vb" src="../../include/reports/CT_StdRpt_MthlyIssueForPayrollList.aspx.vb" Inherits="CT_StdRpt_MthlyIssueForPayrollList" %>
...
<HTML>
	<HEAD>
		<title>Canteen - Monthly Canteen Issue Transfer For Payroll Listing by Product</title>
		...
		<tr>
           <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma">
				<tr>
					<td class="font9Tahoma" colspan="3">CANTEEN - MONTHLY CANTEEN ISSUE TRANSFER FOR PAYROLL LISTING BY PRODUCT</td>
			...
			<table width=100% border="0" cellspacing="1" cellpadding="1" ID="Table2" runat=server>	
				<tr>
					<td>Display details by :</td>
					<td><asp:dropdownlist id="lstDisplay" width="50%" runat="server" /></td>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
				</tr>		
				<tr>
