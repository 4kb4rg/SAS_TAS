<%@ Page Language="vb" src="../../include/reports/AR_StdRpt_CreditNoteList.aspx.vb" Inherits="AR_StdRpt_CreditNoteList" %>
...
<HTML>
	<HEAD>
		<title>Account Receivables - CREDIT NOTE LISTING </title>
		...
		<tr>
           <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1">
				<tr>
					<td class="font9Tahoma" colspan="3">ACCOUNT RECEIVABLES - CREDIT NOTE LISTING</td>
			...
			<table width=100% border="0" cellspacing="1" cellpadding="1" ID="Table2" class="font9Tahoma" runat=server>	
				...
				<tr>
					<td>Billing Type :</td>
					<td><asp:DropDownList id="ddlCreditNoteType" width="50%" runat="server" /></td>					
					<TD>&nbsp;</TD>
					<TD>&nbsp;</TD>
				</tr>
				<tr>
