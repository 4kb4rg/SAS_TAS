<%@ Page Language="vb" Src="../../include/reports/CT_StdRpt_StkReceiveListPreview.aspx.vb" Inherits="CT_StdRpt_StkReceiveList_Preview" %>
	...
	<body MS_POSITIONING="GridLayout" onload="this.focus()" >
		<form id="Form1" method="post" runat="server">
			<table align=center id="tblCrystal" runat="server">
				<tr>
					<td>
						<cr:CrystalReportViewer id="crvView" widthw="350px" height="50px" runat="server" valign=center displaygrouptree="false" displaytoolbar="true" pagetotreeratio="4" />
					</td>
				</tr>
				<tr>
					<td>
