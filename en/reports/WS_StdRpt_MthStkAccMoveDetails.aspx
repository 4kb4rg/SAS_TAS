<%@ Page Language="vb" src="../../include/reports/WS_StdRpt_MthStkAccMoveDetails.aspx.vb" Inherits="WS_StdRpt_MthStkAccMoveDetails" %>
...
<HTML>
	<HEAD>
		<title>Workshop - Monthly Workshop Stock Account Movement Details</title>
	...
	<body>
        ...
        <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1">
				<tr>
					<td class="font9Tahoma" colspan="3">WORKSHOP - MONTHLY WORKSHOP STOCK ACCOUNT MOVEMENT DETAILS</td>
