<%@ Page Language="vb" src="../../include/reports/PR_StdRpt_GajiKecil_Estate.aspx.vb" Inherits="PR_StdRpt_GajiKecil_Estate" %>
	...
	<body>
        ...
        <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1">
				<tr>
					<td class="font9Tahoma" colspan="3"><strong> PAYROLL - PINJAMAN ( GAJI KECIL )</strong></td>
			...
			<tr>
				...
				<tr>
					<td width=17% style="height: 24px">Karyawan :</td>
					<td width=39% style="height: 24px"><GG:AutoCompleteDropDownList id="ddlempcode" width="100%" runat=server/></td>					
					<td width=4% style="height: 24px"></td>	
					<td width=40% style="height: 24px"></td>					
				</tr>
				<tr>
