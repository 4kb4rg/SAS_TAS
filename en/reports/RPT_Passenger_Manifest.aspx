<%@ Page Language="vb" src="../../include/reports/RPT_Passenger_Manifest.aspx.vb" Inherits="RPT_Passenger_Manifest" %>
...
<HTML>
	<HEAD>
		<title>Passenger Manifest Report</title>
	...
	<body>
        ...
        <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma">
				<tr>
					<td class="font9Tahoma" colspan="3">PASSENGER MANIFEST REPORT</td>
			...
			<table width="100%" border="0" cellspacing="2" cellpadding="1" ID="Table2" class="font9Tahoma" runat=server>	
				...
				<tr>
					<td width="15%">Flight Type: </td>
					    <td><asp:DropDownList ID="ddlFlightType" width="70%" OnSelectedIndexChanged="FlightType_Changed" AutoPostBack=true runat="server">
                            <asp:ListItem value="X">- ALL -</asp:ListItem>
                            <asp:ListItem value="D">DOMESTIC</asp:ListItem>
                            <asp:ListItem value="I">INTERNATIONAL</asp:ListItem>
                        </asp:DropDownList></td>      
				...
				<tr>
					<td width="15%">Depart From : </td>
					    <td><GG:AutoCompleteDropDownList id="ddlOrigin" Width="100%"  runat="server" /></td>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
				</tr>
				<tr>
					<td width="15%">Destination : </td>
					    <td><GG:AutoCompleteDropDownList id="ddlDestination" Width="100%"  runat="server" /> </td>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
				</tr>
				<tr>
