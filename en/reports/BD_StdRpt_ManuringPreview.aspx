<%@ Page Language="vb" Src="../../include/reports/BD_StdRpt_ManuringPreview.aspx.vb" Inherits="BD_StdRpt_ManuringPreview" %>
...
<HTML>
	<HEAD>
		<title>Budgeting - Manuring Schedule</title>
	...
	<body MS_POSITIONING="GridLayout" onload="this.focus()" >
		<form id="frmMain" method="post" runat="server">
			<table align=center runat="server">
				...
				<tr>
					<td><asp:Label id="lblBlkTag" visible="false" runat="server" /></td>
				</tr>								
				<tr>
					<td><asp:Label id="lblSubBlkTag" visible="false" runat="server" /></td>
				</tr>								
			</table>
		</form>
