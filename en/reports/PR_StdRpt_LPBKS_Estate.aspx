<%@ Page Language="vb" src="../../include/reports/PR_StdRpt_LPBKS_Estate.aspx.vb" Inherits="PR_StdRpt_LPBKS_Estate" %>
	...
	<body>
        ...
        <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma">
				<tr>
					<td class="font9Tahoma" colspan="3"><strong> LPBKS - Laporan Pemungutan Buah Kelapa Sawit</strong></td>
			...
			<tr>
				...
				<tr>
					...
					<td width=39% style="height: 27px">
                        <asp:CheckBox ID="chkmandor" runat="server" Text="Berdasarkan Mandor" /></td>					
					<td width=4% style="height: 27px"></td>	
					<td width=40% style="height: 27px"></td>					
				</tr>
