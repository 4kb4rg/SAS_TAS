<%@ Page Language="vb" src="../../include/reports/PR_StdRpt_Lembur_Estate.aspx.vb" Inherits="PR_StdRpt_Lembur_Estate" %>
	...
	<body>
        ...
        <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma">
				<tr>
					<td class="font9Tahoma" colspan="3"><strong> PAYROLL - LEMBUR</strong></td>
			...
			<tr>
                ...
                <tr>
                    <td width="17%">
                        Tipe Karyawan :</td>
                    <td width="39%">
                        <asp:DropDownList ID="ddlemptype" runat="server" Width="30%">
                            <asp:ListItem Value="1">Januari</asp:ListItem>
                            <asp:ListItem Value="2">Februari</asp:ListItem>
                            <asp:ListItem Value="3">Maret</asp:ListItem>
                            <asp:ListItem Value="4">April</asp:ListItem>
                ...
                <tr>
                    <td width="17%">
                        Status :</td>
                    <td width="39%">
                        <asp:DropDownList ID="ddlStatus" runat="server" Width="30%">
                ...
                <tr>
                    <td colspan="4">
                        <asp:CheckBox id="chkDetHours" text="Detail Hours" checked="false" runat="server" /></td>
                </tr>
				<tr>
					<td colspan="4">
