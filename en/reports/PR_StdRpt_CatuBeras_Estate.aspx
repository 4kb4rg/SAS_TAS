<%@ Page Language="vb" src="../../include/reports/PR_StdRpt_CatuBeras_Estate.aspx.vb" Inherits="PR_StdRpt_CatuBeras_Estate" %>
	...
	<body>
        ...
        <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma">
				<tr>
					<td class="font9Tahoma" colspan="3"><strong>PAYROLL - CATU BERAS</strong> </td>
