<%@ Page Language="vb" src="../../include/reports/PR_StdRpt_LHPT_Panen_Estate.aspx.vb" Inherits="PR_StdRpt_LHPT_Panen_Estate" %>
	...
	<body>
        ...
        <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma">
				<tr>
					<td class="font9Tahoma" colspan="3"><strong>LHD - Laporan Harian Divisi (Panen)</strong> </td>
			...
			<tr>
				...
				<tr>
					...
					<td width=39% style="height: 27px">
						...
						<asp:CheckBox ID="chktoday" runat="server" checked=True Text="Sampai dengan" />
					</td>					
					...
					<td width=39% style="height: 27px">
                        <asp:DropDownList ID="ddlstatus"  runat="server" Width="100%" >
							<asp:ListItem value="3" selected>Active</asp:ListItem>		
				...
				<tr>
					...
					<td width=39% style="height: 27px">
                        <asp:CheckBox ID="chkmandor" runat="server" Text="Berdasarkan Mandor" visible=False/></td>					
					<td width=4% style="height: 27px"></td>	
					<td width=40% style="height: 27px"></td>					
				</tr>
				...
				<tr>
					...
					<asp:Button ID="Button1" runat="server" Text="Export Excel"  OnClick=Copybtn_Click />
					</td>					
				</tr>				
			</table>
        </div>
