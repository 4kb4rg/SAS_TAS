<%@ Page Language="vb" src="../../include/reports/FA_StdRpt_AssetAct.aspx.vb" Inherits="FA_StdRpt_AssetAct" %>
...
<HTML>
	<HEAD>
		<title>Fixed Asset - Asset Activities</title>
		...
		<tr>
           <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma">
				<tr>
					<td class="font9Tahoma" colspan="3"><strong> FIXED ASSET - ASSET ACTIVITIES</strong></td>
			...
			<table width=100% border="0" cellspacing="1" cellpadding="1" ID="Table2" class="font9Tahoma" runat=server>	
				<tr>
					...
					<td><asp:dropdownlist id=ddlAssetCategory AutoPostBack=True width=50% runat=server /></td>
					<td colspan=2>&nbsp;</td>
				</tr>
				<tr>
					<td width=15%><asp:label id=lblAssetCategory runat=server Visible="False" /> :</td>
				...
				<tr>
					...
					<td><asp:textbox id="txtAssetCode" maxlength=8 width="50%" runat="server" /> (blank for all)</td>
					<td>&nbsp;</td>
					<td>&nbsp;</td>					
				</tr>
				<tr>
