<%@ Page Language="vb" src="../../include/reports/GL_StdRpt_BiayaProduksi.aspx.vb" Inherits="GL_StdRpt_BiayaProduksi" %>
...
<HTML>
	<HEAD>
		<title>General Ledger - Managerial Report(Biaya Produksi)</title>
	...
	<body>
		...
		<tr>
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma">
				<tr>
					<td   colspan="3"><strong> GENERAL LEDGER - MANAGERIAL REPORT (BIAYA PRODUKSI)</strong></td>
