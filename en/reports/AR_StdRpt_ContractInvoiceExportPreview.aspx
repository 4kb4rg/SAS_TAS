<%@ Page Language="vb" Src="../../include/reports/AR_StdRpt_ContractInvoiceExportPreview.aspx.vb" Inherits="AR_StdRpt_ContractInvoiceExportPreview" %>
...
<HTML>
	<HEAD>
		<title>Account Receivables Billing Invoice Export Report</title>
	...
	<body MS_POSITIONING="GridLayout" onload="this.focus()" >
		...
		<asp:Label id=lblNoRecord visible=false text="Invoice is not found." runat="server" />	
	</body>
</HTML>
