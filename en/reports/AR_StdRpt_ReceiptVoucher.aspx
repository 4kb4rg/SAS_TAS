<%@ Page Language="vb" src="../../include/reports/AR_StdRpt_ReceiptVoucher.aspx.vb" Inherits="AR_StdRpt_ReceiptVoucher" %>
...
<HTML>
	<HEAD>
		<title>Account Receivables - Receipt Voucher</title>
		...
		<tr>
           <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma">
				<tr>
					<td class="font9Tahoma" colspan="3"><strong>ACCOUNT RECEIVABLES - RECEIPT VOUCHER</strong> </td>
