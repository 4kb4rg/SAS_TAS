<%@ Page Language="vb" src="../../include/reports/CB_StdRpt_InterestAdjListing.aspx.vb" Inherits="CB_StdRpt_InterestAdjListing" %>
...
<HTML>
	<HEAD>
		<title>Cash And Bank - Interest Adjustment Listing </title>
	...
	<body>
		...
		<tr>
           <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma">
				<tr>
					<td class="font9Tahoma" colspan="3"><strong>CASH AND BANK - INTEREST ADJUSTMENT LISTING</strong> </td>
			...
			<table width=100% border="0" cellspacing="1" cellpadding="1" ID="Table2" class="font9Tahoma" runat=server>	
				<tr>
					<td width="17%">Interest Code From :</td>
					<td width="39%"><asp:textbox id="txtInterestCodeFrom" width="50%"  maxlength=20 runat="server" /> (blank for all) </td>
					<td width="4%">To :</td>
					<td width="40%"><asp:textbox id="txtInterestCodeTo" width="50%"  maxlength=20 runat="server" /> (blank for all) </td>
				</tr>
				<tr>
					<td>Description :</td>
		...
		<asp:label id=lblInterest visible=false runat=server/>
	</body>
</HTML>
