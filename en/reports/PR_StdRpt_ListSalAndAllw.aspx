<%@ Page Language="vb" src="../../include/reports/PR_StdRpt_ListSalAndAllw.aspx.vb" Inherits="PR_StdRpt_ListSalAndAllw" %>
...
<HTML>
	<HEAD>
		<title>Payroll - Rincian Alokasi Iuran Koperasi </title>
	...
	<body>
        ...
        <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma">
				<tr>
					<td class="mt-h" colspan="3">PAYROLL - LIST SALARY AND ALLOWANCES</td>
