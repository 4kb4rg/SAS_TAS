<%@ Page Language="vb" Src="../../include/reports/AR_StdRpt_OfficialReceiptPreview.aspx.vb" Inherits="AR_StdRpt_OfficialReceiptPreview" %>
...
<HTML>
	<HEAD>
		<title>Account Receivables Official Receipt Report</title>
	...
	<body MS_POSITIONING="GridLayout" onload="this.focus()" >
		...
		<asp:Label id=lblNoRecord visible=false text="Official Receipt is not found." runat="server" />	
	</body>
</HTML>
