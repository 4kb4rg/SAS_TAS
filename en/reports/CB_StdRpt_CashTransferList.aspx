<%@ Page Language="vb" src="../../include/reports/CB_StdRpt_CashTransferList.aspx.vb" Inherits="CB_StdRpt_CashTransferList" %>
...
<HTML>
	<HEAD>
		<title>Cash Bank - Cash Transfer Listing</title>
		...
		<tr>
           <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma">
				<tr>
					<td class="font9Tahoma" colspan="3"><strong>CASH BANK - CASH TRANSFER LISTING</strong> </td>
