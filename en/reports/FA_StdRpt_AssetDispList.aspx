<%@ Page Language="vb" src="../../include/reports/FA_StdRpt_AssetDispList.aspx.vb" Inherits="FA_StdRpt_AssetDispList" %>
...
<HTML>
	<HEAD>
		<title>Fixed Asset - Asset Disposal Listing</title>
		...
		<tr>
           <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma">
				<tr>
					<td class="font9Tahoma" colspan="3"><strong> FIXED ASSET - ASSET DISPOSAL LISTING</strong></td>
			...
			<table width=100% border="0" cellspacing="1" cellpadding="1" ID="Table2" class="font9Tahoma" runat=server>	
				...
				<tr>
					<td><asp:label id=lblBillPartyCode runat=server /> Code:</td>
					<td><asp:textbox id="txtBillPartyCode" maxlength=25 width="50%" runat="server" /> (blank for all)</td>
					<td>&nbsp;</td>
					<td>&nbsp;</td> 					
				</tr> 
