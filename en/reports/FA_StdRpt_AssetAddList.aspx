<%@ Page Language="vb" src="../../include/reports/FA_StdRpt_AssetAddList.aspx.vb" Inherits="FA_StdRpt_AssetAddList" %>
...
<HTML>
	<HEAD>
		<title>Fixed Asset - Asset Addition Listing</title>
		...
		<tr>
           <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma">
				<tr>
					<td class="font9Tahoma" colspan="3"><strong> FIXED ASSET - ASSET ADDITION LISTING</strong></td>
