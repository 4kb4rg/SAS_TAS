<%@ Page Language="vb" trace=false src="../../include/reports/WM_StdRpt_FFB_Assess_BySupplier.aspx.vb" Inherits="WM_StdRpt_FFB_Assess_BySupplier" %>
...
<HTML>
	<HEAD>
		<title>Weighing Management - FFB Assessment By Supplier</title>
	...
	<body>
        ...
        <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1">
				<tr>
					<td class="font9Tahoma" colspan="3"><strong> WEIGHING MANAGEMENT - FFB ASSESSMENT BY SUPPLIER</strong></td>
			...
			<table width="100%" border="0" cellspacing="1" cellpadding="1" ID="Table1" class="font9Tahoma">		
				...
				<tr>
					<td>Supplier Type : </td>
					<td><asp:DropDownList id="lstSuppType" width="50%" runat="server" /></td>
					<td>&nbsp;</td>										
					<td>&nbsp;</td>										
				</tr>							
				<tr>
				...
				<tr>
					<td width=17%>Inspection Date From :</td>
					<td width=39%><asp:TextBox id="txtInspDateFrom" size="12" width=50% maxlength="10" runat="server"/>
  								  <a href="javascript:PopCal('txtInspDateFrom');">
  								  <asp:Image id="btnSelInspDateFrom" runat="server" ImageUrl="../Images/calendar.gif"/></a></td>						
					<td width=4%>To :</td>
					<td width=40%><asp:TextBox id="txtInspDateTo" size="12" width=50% maxlength="10" runat="server"/>
  								  <a href="javascript:PopCal('txtInspDateTo');">
  								  <asp:Image id="btnSelInspDateTo" runat="server" ImageUrl="../Images/calendar.gif"/></a></td>										
				</tr>		
				<tr>
					<td>Quality in : </td>
					<td><asp:RadioButton id="rbBunch" text="Bunch Count" GroupName="rbQuality" checked="true" runat="server" />&nbsp;			
								 <asp:RadioButton id="rbPct" text="Percentage" GroupName="rbQuality" runat="server" /></td>
					<td>&nbsp;</td>
					<td>&nbsp;</td>								
				</tr>																									
				<tr>
