<%@ Page Language="vb" src="../../include/reports/GL_StdRpt_MthBlkLedgerList.aspx.vb" Inherits="GL_StdRpt_MthBlkLedgerList" %>
...
<HTML>
	<HEAD>
		<title>General Ledger - Monthly Block Ledger Listing Report</title>
		...
		<tr>
           <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1">
				<tr>
					<td class="font9Tahoma" colspan="3"><strong>GENERAL LEDGER - MONTHLY BLOCK LEDGER LISTING</strong> </td>
			...
			<table width=100% border="0" cellspacing="2" cellpadding="1" ID="Table2" class="font9Tahoma" runat=server>
				...
				<tr>
					<td colspan=3>
						<asp:CheckBox id="cbEstExpense" text=" Display Estate Expenditure"  runat="server"/>
					</td>
				</tr>										
				<tr>
					<td colspa=3>&nbsp;</td>
