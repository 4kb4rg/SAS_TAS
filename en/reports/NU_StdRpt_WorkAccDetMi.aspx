<%@ Page Language="vb" src="../../include/reports/NU_StdRpt_WorkAccDetMi.aspx.vb" Inherits="NU_StdRpt_WorkAccDetMi" %>
...
<html>
	<head>
		<title>Nursery - Biaya Bibitan</title>
	...
	<body>
        ...
        <td style="width: 100%; height: 1500px" valign="top">
			...
			<table Border="0" CellSpacing="1" CellPadding="1" Width="100%" class="font9Tahoma">
				<tr>
					<td Class="font9Tahoma" ColSpan="3"><strong> NURSERY - Biaya Bibitan</strong></td>
			...
			<table Width=100% Border="0" CellSpacing="1" CellPadding="1" class="font9Tahoma" Runat="Server">
				<tr>
					<td Width=17% nowrap>Nursery Account Classification :</td>
					<td Width=39%><asp:TextBox ID="txtAccClass" Width="50%" Runat="Server" /> (blank for all)</td>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
				</tr>
				<tr>
