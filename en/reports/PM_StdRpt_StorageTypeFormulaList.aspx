<%@ Page Language="vb" src="../../include/reports/PM_StdRpt_StorageTypeFormulaList.aspx.vb" Inherits="PM_StdRpt_StorageTypeFormulaList" %>
...
<HTML>
	<HEAD>
		<title>PRODUCTION MANAGEMENT - STORAGE TYPE FORMULA LISTING</title>
	...
	<body>
        ...
        <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1">
				<tr>
					<td class="font9Tahoma" colspan="3">PRODUCTION MANAGEMENT - STORAGE TYPE FORMULA LISTING</td>
			...
			<table width="100%" border="0" cellspacing="1" cellpadding="1" ID="Table2" runat="server">
				<tr>
					...
					<td width=39%><asp:TextBox id="txtStorageTypeCode" size=1 width="50%" runat="server" /> (blank for all)</td>
					<td width=4%>&nbsp;</td>
					<td width=40%>&nbsp;</td>					
				</tr>
				<tr>
