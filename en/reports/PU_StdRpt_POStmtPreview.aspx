<%@ Page Language="vb" trace=false Src="../../include/reports/PU_StdRpt_POStmtPreview.aspx.vb" Inherits="PU_StdRpt_POStmt_Preview" %>
	...
	<body MS_POSITIONING="GridLayout" onload="this.focus()" >
		<form id="Form1" method="post" runat="server">
			<table align=center id="tblCrystal" runat="server">
				...
				<tr>
					<td>
						<asp:datagrid id="EventData2" AutoGenerateColumns="true" width="100%" runat="server" />		
					</td>
				</tr>
			</table>
		</form>
