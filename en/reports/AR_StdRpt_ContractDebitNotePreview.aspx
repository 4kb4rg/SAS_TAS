<%@ Page Language="vb" Src="../../include/reports/AR_StdRpt_ContractDebitNotePreview.aspx.vb" Inherits="AR_StdRpt_ContractDebitNotePreview" %>
...
<HTML>
	<HEAD>
		<title>Account Receivables Debit Note Report</title>
	...
	<body MS_POSITIONING="GridLayout" onload="this.focus()" >
		...
		<asp:Label id=lblNoRecord visible=false text="Debit Note is not found." runat="server" />	
	</body>
</HTML>
