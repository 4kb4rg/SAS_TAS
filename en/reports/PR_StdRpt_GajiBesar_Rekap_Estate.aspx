<%@ Page Language="vb" src="../../include/reports/PR_StdRpt_GajiBesar_Rekap_Estate.aspx.vb" Inherits="PR_StdRpt_GajiBesar_Rekap_Estate" %>
	...
	<body>
        ...
        <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma">
				<tr>
					<td class="font9Tahoma" colspan="3"><strong> PAYROLL - ADVANCE PAYMENT LISTING</strong></td>
			...
			<table width=100% border="0" cellspacing="0" cellpadding="1" ID="Table2" class="font9Tahoma" runat=server>	
				...
				<tr>
					<td style="width: 162px">Tipe :</td>
					<td width=39%><asp:DropDownList id="ddlemptype" width="100%" runat=server>
										<asp:ListItem value="B">Bulanan</asp:ListItem>
										<asp:ListItem value="K" Selected>ALL</asp:ListItem>
									</asp:DropDownList>
					</td>					
					<td width=4%></td>	
					<td width=40%></td>					
				...
				<tr>
					<td style="width: 162px"><asp:ImageButton id="PrintPrev" ImageUrl="../Images/butt_print_preview.gif" AlternateText="Print Preview" onClick="btnPrintPrev_Click" runat="server" /></td>					
				</tr>	
                 <tr>
