<%@ Page Language="vb" src="../../include/reports/PU_StdRpt_GoodsRtnList.aspx.vb" Inherits="PU_StdRpt_GoodsRtnList" %>
...
<HTML>
	<HEAD>
		<title>Purchasing - Goods Return Listing</title>
	...
	<body>
        ...
        <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma">
				<tr>
					<td class="font9Tahoma" colspan="3"><strong> PURCHASING - GOODS RETURN LISTING</strong></td>
			...
			<table width=100% border="0" cellspacing="1" cellpadding="1" ID="Table2" class="font9Tahoma" runat=server>	
				...
				<tr>
					<td><asp:label id=lblGRtnType text="Goods Return Type : " runat=server /> </td>
					<td><asp:DropDownList id="lstGRtnType" width="50%" runat="server" /></td>
					<td>&nbsp;</td>
					<td>&nbsp;</td>									
				</tr>												
				<tr>
