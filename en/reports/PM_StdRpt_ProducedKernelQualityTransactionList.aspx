<%@ Page Language="vb" src="../../include/reports/PM_StdRpt_ProducedKernelQualityTransactionList.aspx.vb" Inherits="PM_StdRpt_ProducedKernelQualityTransactionList" %>
...
<HTML>
	<HEAD>
		<title>Production Management - Produced Kernel Quality Transaction Listing</title>
	...
	<body>
        ...
        <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma">
				<tr>
					<td class="mt-h" colspan="3">PRODUCTION MANAGEMENT - PRODUCED KERNEL QUALITY TRANSACTION LISTING</td>
