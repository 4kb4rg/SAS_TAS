<%@ Page Language="vb" src="../../include/reports/PR_StdRpt_AirBus.aspx.vb" Inherits="PR_StdRpt_AirBus" %>
...
<HTML>
	<HEAD>
		<title>Payroll - Tunjangan Cuti Karyawan </title>
	...
	<body>
        ...
        <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma">
				<tr>
					<td class="font9Tahoma" colspan="3"><strong> PAYROLL - TUNJANGAN CUTI KARYAWAN</strong></td>
			...
			<table width=100% border="0" cellspacing="1" cellpadding="1" ID="Table2" class="font9Tahoma" runat=server>	
				<tr>
					...
					<asp:Label id="lblNearLoc" visible="false" runat="server" />
					<asp:Label id="lblPOH" visible="false" runat="server" />
					</td>
				</tr>
				<tr>
