<%@ Page Language="vb" src="../../include/reports/CT_StdRpt_MthlyOrdersList.aspx.vb" Inherits="CT_StdRpt_MthlyOrdersList" %>
...
<HTML>
	<HEAD>
		<title>Canteen - Monthly Canteen Orders Listing</title>
		...
		<tr>
           <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma">
				<tr>
					<td class="mt-h" colspan="3">CANTEEN - MONTHLY CANTEEN ORDERS LISTING</td>
			...
			<table width=100% border="0" cellspacing="1" cellpadding="1" ID="Table2" class="font9Tahoma" runat=server>	
				...
				<tr>
					<td>DA No :</td>
					<td><asp:textbox id="txtDANo" maxlength=32 width="50%" runat="server" /> (blank for all)</td>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
				</tr>	
				<tr>
					<td>DA Date From :</td>
					<td><asp:TextBox id="txtDADateFrom" size="12" width=50% maxlength="10" runat="server"/>
  								  <a href="javascript:PopCal('txtDADateFrom');">
  								  <asp:Image id="btnSelDateFrom" runat="server" ImageUrl="../Images/calendar.gif"/></a></td>
					<td>To :</td>
					<td><asp:TextBox id="txtDADateTo" size="12" width=50% maxlength="10" runat="server"/>
  								  <a href="javascript:PopCal('txtDADateTo');">
				...
				<tr>
					...
					<td width=35%><asp:DropDownList id="lstOrderBy" size="1" width="50%" runat="server" >
  									<asp:ListItem text="DA" value="DA" />
  									<asp:ListItem text="Item Code" value="IC" />
								  </asp:DropDownList></td>
					<td width=15%>&nbsp;</td>
					<td width=35%>&nbsp;</td>
				</tr>	
