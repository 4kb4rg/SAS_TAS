<%@ Page Language="vb" src="../../include/reports/CB_StdRpt_DailyPayment.aspx.vb" Inherits="CB_StdRpt_DailyPayment" %>
...
<HTML>
	<HEAD>
		<title>Cash And Bank - Daily Payment Transaction</title>
		...
		<tr>
           <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma">
				<tr>
					<td class="font9Tahoma" colspan="3"><strong> CASH AND BANK - DAILY PAYMENT TRANSACTION</strong></td>
