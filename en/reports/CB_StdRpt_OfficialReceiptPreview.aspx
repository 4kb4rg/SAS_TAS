<%@ Page Language="vb" EnableViewState="false" Src="../../include/reports/CB_StdRpt_OfficialReceiptPreview.aspx.vb" Inherits="CB_StdRpt_OfficialReceiptPreview" %>
...
<HTML>
	<HEAD>
		<title>Cash And Bank - Official Receipt Report</title>
	</HEAD>
