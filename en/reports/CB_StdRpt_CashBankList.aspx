<%@ Page Language="vb" src="../../include/reports/CB_StdRpt_CashBankList.aspx.vb" Inherits="CB_StdRpt_CashBankList" %>
...
<HTML>
	<HEAD>
		<title>Cash Bank - Cash Bank Listing</title>
		...
		<tr>
           <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma">
				<tr>
					<td class="font9Tahoma" colspan="3"><strong>CASH BANK - CASH BANK LISTING</strong> </td>
			...
			<table width=100% border="0" cellspacing="1" cellpadding="1" ID="Table2" class="font9Tahoma" runat=server>	
				<tr>
					<td>Cash Bank ID From :</td>
					<td><asp:textbox id="txtCashBankIDFrom" width="50%" runat="server" /> (blank for all)</td>
					<td>To :</td>
					<td><asp:textbox ID="txtCashBankIDTo" width="50%" Runat=server /> (blank for all)</td>
				</tr>	
				...
				<tr>
					<td>Cash Bank Type :</td>
					<td><asp:DropDownList id="lstCashBankType" width="50%" runat="server" /></td>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
				</tr>								
				<tr>
				...
				<tr>
					...
					<td><asp:textbox id="txtAccCode" maxlength=20 width="50%" runat="server" /> 
