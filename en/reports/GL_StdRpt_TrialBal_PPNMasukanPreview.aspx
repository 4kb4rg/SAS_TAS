<%@ Page Language="vb" EnableViewState="false" Src="../../include/reports/GL_StdRpt_TrialBal_PPNMasukanPreview.aspx.vb" Inherits="GL_StdRpt_TrialBal_PPNMasukanPreview" %>
...
<HTML>
	<HEAD>
		<title>General Ledger - Trial Balance PPN Masukan</title>
	</HEAD>
