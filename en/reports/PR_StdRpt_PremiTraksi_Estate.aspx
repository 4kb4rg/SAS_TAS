<%@ Page Language="vb" src="../../include/reports/PR_StdRpt_PremiTraksi_Estate.aspx.vb" Inherits="PR_StdRpt_PremiTraksi_Estate" %>
...
<HTML>
	<HEAD>
		<title>Payroll - Premi Traksi</title>
	...
	<body>
		...
		<div class="kontenlist">
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma">
				<tr>
					<td class="mt-h" colspan="3">PAYROLL - PREMI TRAKSI</td>
