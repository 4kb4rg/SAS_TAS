<%@ Page Language="vb" src="../../include/reports/PR_StdRpt_GajiBank_Estate.aspx.vb" Inherits="PR_StdRpt_GajiBank_Estate" %>
...
<HTML>
	...
	<body>
        ...
        <td style="width: 100%; height: 1500px" valign="top">
			...
			<table width=100% border="0" cellspacing="0" cellpadding="1" ID="Table2" runat=server>	
				<tr>
					<td colspan="7">
					&nbsp;
					</td>
				...
				<tr>
					...
					<td width=39%><asp:DropDownList id="ddltype" width="30%" runat=server>
										<asp:ListItem value="U">UPAH</asp:ListItem>
										<asp:ListItem value="R">RAPEL</asp:ListItem>
										<asp:ListItem value="T">THR</asp:ListItem>
                ...
                <tr>
					<td style="width: 162px"><asp:ImageButton id="PrintPrev" ImageUrl="../Images/butt_print_preview.gif" AlternateText="Print Preview" onClick="btnPrintPrev_Click" runat="server" />&nbsp;
						<asp:Button ID="Issue6" runat="server" class="button-small" Text="Print Preview" hidden/>
                    </td>					
				</tr>	
                 <tr>
