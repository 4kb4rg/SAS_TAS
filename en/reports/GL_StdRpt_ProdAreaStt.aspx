<%@ Page Language="vb" src="../../include/reports/GL_StdRpt_ProdAreaStt.aspx.vb" Inherits="GL_StdRpt_ProdAreaStt" %>
...
<HTML>
	<HEAD>
		<title>General Ledger - Production Area Statement</title>
		...
		<tr>
           <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1">
				<tr>
					<td class="font9Tahoma" colspan="3"><strong>GENERAL LEDGER - PRODUCTION AREA STATEMENT</strong> </td>
			...
			<table width=100% border="0" cellspacing="2" cellpadding="1" ID="Table2" class="font9Tahoma" runat=server>
				<tr id=TrDivision>
					<td><asp:label id="lblDivision" runat="server" /> Division:</td>
					<td colspan=2>
						<asp:textbox id="txtDivision" maxlength="8" width="25%" runat="server" /> (blank for all)
					</td>
				</tr>	
				<tr id=trYrofPlanting>
					<td><asp:label id="lblYrofPlanting" runat="server" /> Year of Planting:</td>
					<td colspan=2>
						<asp:textbox id="txtYrofPlanting" maxlength="8" width="25%" runat="server" /> (blank for all)
					</td>
				</tr>									
				<tr>
					<td colspaN=3>&nbsp;</td>
