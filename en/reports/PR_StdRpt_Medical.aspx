<%@ Page Language="vb" src="../../include/reports/PR_StdRpt_Medical.aspx.vb" Inherits="PR_StdRpt_Medical" %>
...
<HTML>
	<HEAD>
		<title>Payroll - Listing Data Pengobatan </title>
	...
	<body>
        ...
        <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma">
				<tr>
					<td class="mt-h" colspan="3">PAYROLL - LISTING DATA PENGOBATAN</td>
			...
			<table width=100% border="0" cellspacing="1" cellpadding="1" ID="Table2" class="font9Tahoma" runat=server>	
				...
				<tr>
					...
					<td width="5%">:</td>
					<td><asp:DropDownList id="ddlEmployee" runat="server" /> &nbsp;(blank for all)</td>	
					<td>&nbsp;</td>				
				</tr>
				<tr>
					<td colspan="4">&nbsp;</td>
