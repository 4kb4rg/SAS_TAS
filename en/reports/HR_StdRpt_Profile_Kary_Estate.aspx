<%@ Page Language="vb" src="../../include/reports/HR_StdRpt_Profile_Kary_Estate.aspx.vb" Inherits="HR_StdRpt_Profile_Kary_Estate" %>
	...
	<body>
        ...
        <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma">
				<tr>
					<td class="font9Tahoma" colspan="3"><strong> Laporan Profile Karyawan</strong></td>
			...
			<tr>
				...
				<tr>
					...
					<td width=39% style="height: 24px">
                        <GG:AutoCompleteDropDownList ID="ddldivisi" runat="server" Width="50%" /></td>					
				...
				<tr>
					<td width=17% style="height: 24px">
                        Type Karyawan :</td>
					<td width=39% style="height: 24px">
                        <GG:AutoCompleteDropDownList ID="ddlEmpType" runat="server" Width="50%" /></td>					
					<td width=4% style="height: 24px"></td>	
					<td width=40% style="height: 24px"></td>					
				</tr>
				<%--<tr>
