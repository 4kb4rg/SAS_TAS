<%@ Page Language="vb" src="../../include/reports/AP_StdRpt_SuppCreditNoteListing.aspx.vb" Inherits="AP_StdRpt_SuppCreditNoteListing" %>
...
<HTML>
	<HEAD>
		<title>Accounts Payable - Supplier Credit Note Listing </title>
		...
		<tr>
           <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1">
				<tr>
					<td class="font9Tahoma" colspan="3"><strong>ACCOUNTS PAYABLE - SUPPLIER CREDIT NOTE LISTING</strong> </td>
			...
			<table width=100% border="0" cellspacing="1" cellpadding="1" ID="Table2" class="font9Tahoma" runat=server>	
				<tr>
					...
					<td width="39%"><asp:textbox id="txtSuppCreditNoteIDFrom" width="50%"  maxlength=20 runat="server" /> (blank for all) </td>
					<td width="4%">To :</td>
					<td width="40%"><asp:textbox id="txtSuppCreditNoteIDTo" width="50%"  maxlength=20 runat="server" /> (blank for all) </td>
				</tr>
				<tr>
					<td>Credit Note Ref No :</td>
					<td><asp:textbox id="txtSuppCreditNoteRefNo"  width="50%" maxlength=20 runat="server" /> (blank for all) </td>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
				</tr>
				<tr>
					<TD>Credit Note Ref Date From :</TD>
					<TD valign="top">
					<asp:TextBox ID=txtSuppCreditNoteRefDateFrom maxlength="10" width="50%"  Runat=server />
					<a href="javascript:PopCal('txtSuppCreditNoteRefDateFrom');"><asp:Image id="btnSelDateFrom" runat="server" ImageUrl="../Images/calendar.gif"/></a>
					</TD>
					<TD>To :</TD>
					<TD valign="top">
					<asp:TextBox ID=txtSuppCreditNoteRefDateTo maxlength="10" width="50%" Runat=server />
					<a href="javascript:PopCal('txtSuppCreditNoteRefDateTo');"><asp:Image id="btnSelDateTo" runat="server" ImageUrl="../Images/calendar.gif"/></a>
					</TD>
				</tr>
				<tr>
					<td>Supplier Code:</td>
