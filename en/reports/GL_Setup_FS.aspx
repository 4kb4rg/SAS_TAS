<%@ Page Language="vb" src="../../../include/GL_Setup_FS.aspx.vb" Inherits="GL_Setup_FS" %>
	...
	<Preference:PrefHdl id="PrefHdl" runat="server" />
		...
		<form id=frmTmpl runat="server">
			...
			<table border="0" cellspacing="1" cellpadding="2" width="100%">
				...
				<tr>
					<td class="mt-h" colspan="3">FINANCIAL STATEMENT REPORT TEMPLATE DETAIL</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><asp:textbox id="txtDescription" width="80%" maxlength="50" runat="server" />
				...
				<tr>
					<td height="25">Foreign Description :</td>
					<td><asp:textbox id= "txtDescription3" width="80%" maxlength="50" runat="server" />
				...
				<tr>
					<td>Report Type :*</td>
					<td>
						<asp:DropDownList id="ddlReportType" width="30%" runat="server" />
					...
					<table id="tblSelection" border="0" width="100%" cellspacing="0" cellpadding="4" runat="server">
						...
						<tr style="height:25px" class="mb-c">
							...
							<td colspan="4" style="height: 25px">
                               <asp:Textbox id="txtDispSeq1"  Width="10%" maxlength="8"  text = "1" runat="server" />
						...
						<tr style="height:25px" class="mb-c">
							<td style="width:20%; height: 25px;">
                                Description :*</td>
							<td colspan="4">
                                <asp:Textbox id="txtDescription1"  Width="70%" maxlength="50"  runat="server" />
                             </td>
						</tr>
						...
						<tr style="height:25px" class="mb-c">
							...
							<td colspan="4">
                                <asp:Textbox id="txtDescription2"  Width="70%" maxlength="50"  runat="server" />
                             </td>
						</tr>
						 ...
						 <tr style="height:25px" class="mb-c">
				            <td >
                                Display Type :*</td>
				            <td colspan="4">
				               <asp:DropDownList id="ddlFSRowType1" AutoPostback="true" Width="10%" OnSelectedIndexChanged="ddlCheckType1" runat="server" >
                                ...
                                &nbsp; &nbsp;
                                <asp:Textbox id="txtRefNo1"  Width="7%" maxlength="22"  runat="server" visible="true"/>
                                &nbsp; &nbsp;
                                <asp:Label id="lblFormula1" text="Formula :* " runat="server" visible="false"/>
                                &nbsp; &nbsp;
                                <asp:Textbox id="txtFormula1"  Width="60%" maxlength="2000"  runat="server" visible="false" />
                                &nbsp; &nbsp;
                                <asp:CheckBox ID="chkBegBal" runat="server" visible="true" Text=" Is Beg. Balance"/>
                                </td>
                                
			            </tr>
						
								
						<tr id ="trStyle" style="height:25px" class="mb-c">
							<td style="width:20%; height: 25px;">
                            </td>
							<td colspan="4"> Space :    
                                <asp:DropDownList id="ddlSpace1" Width="5%"  runat="server" >
                                ...
                                &nbsp;
                                Font : 
                                <asp:DropDownList id="ddlFont" Width="5%"  runat="server" >
                                    <asp:ListItem value="7">7</asp:ListItem>
						...
						<tr id ="trEditor" style="height:25px" class="mb-c">
						    <td>Font Editor :*</td>
						    <td colspan="4">    
						        Size:&nbsp;
						        <asp:DropDownList id="ddlFSize" Width="5%"  runat="server" >
                                    <asp:ListItem value="7">7</asp:ListItem>
                                    <asp:ListItem value="8">8</asp:ListItem>
                                    <asp:ListItem value="9">9</asp:ListItem>
                                    <asp:ListItem value="10" Selected = "True" >10</asp:ListItem>
                                ...
                                &nbsp;
                                Style:&nbsp;
                                <asp:DropDownList id="ddlFStyle" Width="10%"  runat="server" >
                                ...
                                &nbsp;
                                Effect:&nbsp;
                                <asp:DropDownList id="ddlFEffect" Width="10%"  runat="server" >
                                ...
                                &nbsp;
                                Spacing:&nbsp;
                                <asp:DropDownList id="ddlFSpacing" Width="5%"  runat="server" >
                                    <asp:ListItem value="0" Selected="True">0</asp:ListItem>
                                    <asp:ListItem value="1">1</asp:ListItem>
                                    <asp:ListItem value="2">2</asp:ListItem>
                                    <asp:ListItem value="3">3</asp:ListItem>
                                ...
                                <asp:DropDownList id="ddlFNegSign" Width="5%"  runat="server" >
