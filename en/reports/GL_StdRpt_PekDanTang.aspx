<%@ Page Language="vb" src="../../include/reports/GL_StdRpt_PekDanTang.aspx.vb" Inherits="GL_StdRpt_PekDanTang" %>
		...
		<tr>
           <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1">
				<tr>
					<td class="font9Tahoma" colspan="3"><strong> GENERAL LEDGER - MANAGERIAL REPORT (PEKERJA DAN TANGGUNGAN)</strong></td>
