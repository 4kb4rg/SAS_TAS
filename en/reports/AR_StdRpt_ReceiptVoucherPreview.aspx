<%@ Page Language="vb" Src="../../include/reports/AR_StdRpt_ReceiptVoucherPreview.aspx.vb" Inherits="AR_StdRpt_ReceiptVoucherPreview" %>
...
<HTML>
	<HEAD>
		<title>Account Receivables Receipt Voucher Report</title>
	...
	<body MS_POSITIONING="GridLayout" onload="this.focus()" >
		...
		<asp:Label id=lblNoRecord visible=false text="Receipt Voucher is not found." runat="server" />	
	</body>
</HTML>
