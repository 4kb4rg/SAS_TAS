<%@ Page Language="vb" src="../../include/reports/IN_StdRpt_StockTakeList.aspx.vb" Inherits="IN_StdRpt_StockTakeList" %>
...
<HTML>
	<HEAD>
		<title>Inventory - Stock Take Listing</title>
	...
	<body>
        ...
        <td style="width: 100%; height: 800px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma">
				<tr>
					<td class="font9Tahoma" colspan="3"><strong>INVENTORY - STOCK TAKE LISTING</strong> </td>
			...
			<table width=100% border="0" cellspacing="1" cellpadding="1" ID="Table2" class="font9Tahoma">
				...
				<tr>
					<td>Item Type :</td>
					<td><asp:dropdownlist id="ddlItemType" width="50%" runat="server" /></td>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
				</tr>
				<tr>
