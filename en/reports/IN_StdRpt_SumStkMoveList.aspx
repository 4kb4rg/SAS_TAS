<%@ Page Language="vb" src="../../include/reports/IN_StdRpt_SumStkMoveList.aspx.vb" Inherits="IN_StdRpt_SumStkMoveList" %>
...
<HTML>
	<HEAD>
		<title>Inventory - Summarized Stock Movement Report</title>
	...
	<body>
        ...
        <td style="width: 100%; height: 800px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma">
				<tr>
					<td class="font9Tahoma" colspan="3"><strong> INVENTORY - SUMMARIZED STOCK MOVEMENT LIST</strong></td>
			...
			<table width=100% border="0" cellspacing="0" cellpadding="1" ID="Table2" class="font9Tahoma">
				<tr>
					<td>Group By :</td>
					<td colspan=2><asp:dropdownlist id="lstGrpBy" width="30%" runat="server" /></td>
					<td>&nbsp;</td>
				</tr>															
				<tr>
				...
				<tr>
					<td>Item Code :</td>
					<td colspan=2 ><asp:textbox id="txtItemCode" maxlength=20 width="30%" runat="server" /> (blank for all)</td>
					<td>&nbsp;</td>
				</tr>
				<tr>
					<td width=15%>Suppress zero balance : </td>
					<td width=35%><asp:RadioButton id="rbSuppYes" text="Yes" GroupName="rbSupp" runat="server" />&nbsp;			
