<%@ Page Language="vb" src="../../include/reports/BD_StdRpt_FFBReceivedList.aspx.vb" Inherits="BD_StdRpt_FFBReceivedList" %>
		...
		<tr>
           <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1">
				<tr>
					<td class="font9Tahoma" colspan="3"><strong> BUDGETING - FFB RECEIVED TRANSACTION LISTING</strong></td>
			...
			<table width="100%" border="0" cellspacing="1" cellpadding="1" ID="Table2" class="font9Tahoma" runat="server">
				...
				<tr>
					...
					<td width=39%>
						...
						<asp:RegularExpressionValidator id=revUpdatedDateFrom 
								ControlToValidate="txtUpdatedDateFrom"
								ValidationExpression="([0][123456789]|[12][0123456789]|[3][01])\/([0][123456789]|[1][012])\/\d{4}"
								Display="Dynamic"
								text="<BR>Date in DD/MM/YYYY format."
								runat="server"/>
					</td>
					<td width=4%>To :</td>
					<td width=40%>
						...
						<asp:RegularExpressionValidator id=revUpdatedDateTo 
								ControlToValidate="txtUpdatedDateTo"
								ValidationExpression="([0][123456789]|[12][0123456789]|[3][01])\/([0][123456789]|[1][012])\/\d{4}"
								Display="Dynamic"
								text="<BR>Date in DD/MM/YYYY format."
								runat="server"/>
