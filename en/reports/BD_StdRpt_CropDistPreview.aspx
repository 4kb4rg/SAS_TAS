<%@ Page Language="vb" Src="../../include/reports/BD_StdRpt_CropDistPreview.aspx.vb" Inherits="BD_StdRpt_CropDistPreview" %>
...
<HTML>
	...
	<body MS_POSITIONING="GridLayout" onload="this.focus()" >
		<form id="frmMain" method="post" runat="server">
			<asp:Label id="lblAreaTag" visible="false" runat="server" />					
