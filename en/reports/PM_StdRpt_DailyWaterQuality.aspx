<%@ Page Language="vb" trace=false src="../../include/reports/PM_StdRpt_DailyWaterQuality.aspx.vb" Inherits="PM_StdRpt_DailyWaterQuality" %>
...
<HTML>
	<HEAD>
		<title>Production Management - Daily Analysis Report </title>
	...
	<body>
        ...
        <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1">
				<tr>
					<td class="font9Tahoma" colspan="3">PRODUCTION MANAGEMENT - DAILY ANALYSIS REPORT</td>
			...
			<table width="100%" border="0" cellspacing="1" cellpadding="1" ID="Table1" class="font9Tahoma">		
				<tr>
					...
					<td width="35%">
						<asp:TextBox id="txtTrxDate" runat="server"></asp:TextBox>
						<a href="javascript:PopCal('txtTrxDate');">
							<asp:Image id="btnSelDateFrom" runat="server" ImageUrl="../Images/calendar.gif" EnableViewState="False" /></a><br>
						<asp:RequiredFieldValidator id="rfvTrxDate" runat="server" ErrorMessage="Field cannot be blank." EnableViewState="False"
							Display="Dynamic" ControlToValidate="txtTrxDate"></asp:RequiredFieldValidator>
						<asp:Label id="lblDateFormat" runat="server" EnableViewState="False" Visible="False" ForeColor="Red"></asp:Label>
					</td>
					<td width="15%">&nbsp;</td>
					<td width="35%">&nbsp;</td>
				</tr>
