<%@ Page Language="vb" src="../../include/reports/PR_StdRpt_DaftarMuatTBS_Estate.aspx.vb" Inherits="PR_StdRpt_DaftarMuatTBS_Estate" %>
...
<HTML>
	<HEAD>
		<title>Payroll - Daftar Muat TBS Report </title>
	...
	<body>
        ...
        <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma">
				<tr>
					<td class="font9Tahoma" colspan="3"><strong> PAYROLL - DAFTAR MUAT TBS REPORT</strong></td>
			...
			<table width=100% border="0" cellspacing="1" cellpadding="1" ID="Table2" class="font9Tahoma" runat=server>	
				...
				<tr>
					...
					<td width=39%><asp:DropDownList id="ddlsubcat" width="30%" runat=server>
										<asp:ListItem value="BMM">Muat TBS</asp:ListItem>
										<asp:ListItem value="BML">Langsir TBS</asp:ListItem>
										<asp:ListItem value="BMB">Bongkar TBS</asp:ListItem>
									</asp:DropDownList>
					</td>					
					<td width=4%></td>	
					<td width=40%></td>					
