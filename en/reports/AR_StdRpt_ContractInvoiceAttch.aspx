<%@ Page Language="vb" src="../../include/reports/AR_StdRpt_ContractInvoiceAttch.aspx.vb" Inherits="AR_StdRpt_ContractInvoiceAttch" %>
...
<HTML>
	<HEAD>
		<title>Account Receivables - Invoice Attachment</title>
		...
		<tr>
           <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma">
				<tr>
					<td class="font9Tahoma" colspan="3"><strong>ACCOUNT RECEIVABLES - INVOICE ATTACHMENT</strong> </td>
			...
			<table width=100% border="0" cellspacing="2" cellpadding="1" ID="Table2" class="font9Tahoma" runat=server>
				...
				<tr>
					<td width=17%>Matching ID From : </td>
					<td width=39%><asp:Textbox id=txtFromMatchId maxlength=20 width=50% runat=server/> (blank for all)</td>			
					<td width=4%>To : </td>	
					<td width=40%><asp:Textbox id=txtToMatchId maxlength=20 width=50% runat=server/> (blank for all)</td>
				</tr>
				<tr>
