<%@ Page Language="vb" src="../../include/reports/GL_StdRpt_TrialBalSummaryDet.aspx.vb" Inherits="GL_StdRpt_TrialBalSummaryDet" %>
	...
	<body>
		...
		<tr>
			...
			<table width=100% border="0" cellspacing="2" cellpadding="1" ID="Table2" class="font9Tahoma" runat=server>
				...
				<tr>
					<td colspan=3>
						<asp:CheckBox id="cbWithTrans" text=" With Transaction" value="Yes" runat="server"/>
					</td>
				</tr>										
				<tr>
					<td colspa=3>&nbsp;</td>
