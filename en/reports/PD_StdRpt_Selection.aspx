<%@ Page Language="vb" AutoEventWireup="false" src="../../include/reports/PD_StdRpt_Selection.aspx.vb" Inherits="PD_StdRpt_Selection" %>
...
<HTML>
	<HEAD>
		<title>Production Standard Reports</title>
	...
	<body>
        ...
        <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma">
				<tr>
					<td class="mt-h" colspan="3">PRODUCTION - STANDARD REPORTS</td>
