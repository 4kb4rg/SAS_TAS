<%@ Page Language="vb" src="../../include/reports/CT_StdRpt_TradingAccList.aspx.vb" Inherits="CT_StdRpt_TradingAccList" %>
...
<HTML>
	<HEAD>
		<title>Canteen - Trading Account Report</title>
		...
		<tr>
           <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1">
				<tr>
					<td class="font9Tahoma" colspan="3">CANTEEN - TRADING ACCOUNT REPORT</td>
				...
				<tr>
					<td colspan="6"><asp:Label id="lblDate" forecolor=red visible="false" text="Incorrect Date Format. Date Format is " runat="server" />
									<asp:Label id="lblErrAccMonth" forecolor=red visible="false" text="Accounting Month from cannot be bigger than Accounting Year To if same year." runat="server" /></td>
