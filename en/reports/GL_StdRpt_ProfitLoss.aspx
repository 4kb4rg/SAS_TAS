<%@ Page Language="vb" src="../../include/reports/GL_StdRpt_ProfitLoss.aspx.vb" Inherits="GL_StdRpt_ProfitLoss" %>
...
<HTML>
	<HEAD>
		<title>General Ledger - Profit and Loss Report</title>
		...
		<tr>
           <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1">
				<tr>
					<td class="font9Tahoma" colspan="3"><strong>GENERAL LEDGER - PROFIT LOSS</strong> </td>
