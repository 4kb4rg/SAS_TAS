<%@ Page Language="vb" src="../../include/reports/CT_StdRpt_ItemRetAdvList.aspx.vb" Inherits="CT_StdRpt_ItemRetAdvList" %>
...
<HTML>
	<HEAD>
		<title>Canteen Item Return Advice Standard Report</title>
		...
		<tr>
           <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma">
				<tr>
					<td class="font9Tahoma" colspan="3">CANTEEN ITEM RETURN ADVICE STANDARD REPORT</td>
			...
			<table width=100% border="0" cellspacing="1" cellpadding="1" ID="Table2">	
				<tr>
					...
					<td width=35%><asp:DropDownList id="lstDocNoFrom" width="50%" AutoPostBack="true" onselectedindexchanged="BindDocNoToList" runat="server" /></td>
					<td width=15%>To :</td>
					<td width=35%><asp:DropDownList ID="lstDocNoTo" width="50%" size=1 Runat=server /></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td width=35%><asp:DropDownList id="lstItemCode" size="1" width="50%" runat="server" /></td>
					<td width=15%>&nbsp;</td>
					<td width=35%>&nbsp;</td>
				</tr>						
				<tr>
