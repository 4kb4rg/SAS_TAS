<%@ Page Language="vb" src="../../include/reports/PR_StdRpt_EmpCP8AList.aspx.vb" Inherits="PR_StdRpt_EmpCP8AList" %>
...
<HTML>
	<HEAD>
		<title>EA - Employee CP8A Listing</title>
	...
	<body>
        ...
        <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1">
				<tr>
					<td class="mt-h" colspan="3">EA - EMPLOYEE CP8A LISTING</td>
