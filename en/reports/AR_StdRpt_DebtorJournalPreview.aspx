<%@ Page Language="vb" Src="../../include/reports/AR_StdRpt_DebtorJournalPreview.aspx.vb" Inherits="AR_StdRpt_DebtorJournalPreview" %>
...
<HTML>
	<HEAD>
		<title>Account Receivables Debtor Journal Voucher Report</title>
	...
	<body MS_POSITIONING="GridLayout" onload="this.focus()" >
		...
		<asp:Label id=lblNoRecord visible=false text="Debtor Journal is not found." runat="server" />	
	</body>
</HTML>
