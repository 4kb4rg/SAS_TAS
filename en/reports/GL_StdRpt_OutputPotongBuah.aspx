<%@ Page Language="vb" src="../../include/reports/GL_StdRpt_OutputPotongBuah.aspx.vb" Inherits="GL_StdRpt_OutputPotongBuah" %>
...
<HTML>
	<HEAD>
		<title>General Ledger - Managerial Report (Output Potong Buah)</title>
		...
		<tr>
           <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma">
				<tr>
					<td class="font9Tahoma" colspan="3"><strong> GENERAL LEDGER - MANAGERIAL REPORT (OUTPUT POTONG BUAH)</strong></td>
			...
			<table width=100% border="0" cellspacing="2" cellpadding="1" ID="Table2" class="font9Tahoma" runat=server>		
				...
				<tr id=TrBlkGrp runat=server visible=false>
					...
					<td colspan=2>
						<asp:DropDownList id="ddlBlkGrp" width="55%" runat="server"/> (blank for all)
					</td>			
				</tr>	
				<tr id=TrBlk runat=server visible=false>
					<td width=25%><asp:label id="lblBlk" runat="server" /> : </td>
					<td colspan=2>
						<asp:DropDownList id="ddlBlk" width="55%" runat="server"/> (blank for all)
					</td>			
				</tr>		
				<tr id=TrSubBlk runat=server visible=false>
					<td width=25%><asp:label id="lblSubBlk" runat="server" /> : </td>
					<td colspan=2>
						<asp:DropDownList id="ddlSubBlk" width="55%" runat="server"/> (blank for all)
					</td>			
				</tr>
				...
				<tr id=TrThnTnm runat=server visible=false>
					...
					<td colspan=2>
						<asp:DropDownList id="ddlThnTnm" width="55%" runat="server"/> (blank for all)
					</td>
				</tr>
				
				<tr>
					<td width=25%><asp:label id="Label1" runat="server" />Remark : </td>
					<td colspan=2>
						<asp:TextBox id="txtRemark" maxlength="128" width="60%" runat="server" multiline="True"/>
					</td>			
				</tr>							
				<tr>
					<td colspa=3>&nbsp;</td>
