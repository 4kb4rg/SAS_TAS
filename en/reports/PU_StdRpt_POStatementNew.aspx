<%@ Page Language="vb" src="../../include/reports/PU_StdRpt_POStatementNew.aspx.vb" Inherits="PU_StdRpt_POStatementNew" %>
<%@ Register TagPrefix="Preference" Tagname="PrefHdl" src="../include/preference/preference_handler.ascx"%>
<%@ Register TagPrefix="UserControl" Tagname="MenuReports" src="../menu/menu_reports.ascx"%>
<%@ Register TagPrefix="UserControl" Tagname="PU_STDRPT_SELECTION_CTRL" src="../include/reports/PU_StdRpt_Selection_Ctrl.ascx"%>
<HTML>
	<HEAD>
		<title>Purchasing - Purchase Order Statement</title>
	...
	<body>
        ...
        <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma">
				<tr>
					<td colspan="6">
						<UserControl:MenuReports id=MenuReports runat="server" />
					</td>
				</tr>
				<tr>
					<td class="font9Tahoma" colspan="3"><strong>PURCHASING - PURCHASE ORDER STATEMENT</strong> </td>
			...
			<table width=100% border="0" cellspacing="2" cellpadding="1" ID="Table2" class="font9Tahoma" runat=server>
				...
				<tr>
					<td width=17%>PIC for Sign Of: </td>
					<td width=39%><asp:textbox id=txtPIC maxlength=128 width=50% runat=server /></td>
					<td colspan=2>&nbsp;</td>
				</tr>
				<tr>
					<td width=17%>Jabatan : </td>
					<td width=39%>
						<asp:textbox id=txtJabatan maxlength=128 width=50% runat=server />
					</td>
					<td colspan=2>&nbsp;</td>
				</tr>	
				<tr>
