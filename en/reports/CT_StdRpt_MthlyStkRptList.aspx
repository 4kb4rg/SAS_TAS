<%@ Page Language="vb" src="../../include/reports/CT_StdRpt_MthlyStkRptList.aspx.vb" Inherits="CT_StdRpt_MthlyStkRptList" %>
...
<HTML>
	<HEAD>
		<title>Canteen - Monthly Stock Report</title>
		...
		<tr>
           <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma">
				<tr>
					<td class="mt-h" colspan="3">CANTEEN - MONTHLY STOCK REPORT</td>
