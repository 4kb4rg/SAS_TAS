<%@ Page Language="vb" Src="../../include/reports/AR_StdRpt_ContractCreditNotePreview.aspx.vb" Inherits="AR_StdRpt_ContractCreditNotePreview" %>
...
<HTML>
	<HEAD>
		<title>Account Receivables Credit Note Report</title>
	...
	<body MS_POSITIONING="GridLayout" onload="this.focus()" >
		...
		<asp:Label id=lblNoRecord visible=false text="Credit Note is not found." runat="server" />	
	</body>
</HTML>
