<%@ Page Language="vb" src="../../include/reports/CT_StdRpt_InventoryValList.aspx.vb" Inherits="CT_StdRpt_InventoryValList" %>
...
<HTML>
	<HEAD>
		<title>Canteen - Canteen Valuation Listing</title>
		...
		<tr>
           <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1">
				<tr>
					<td class="font9Tahoma" colspan="3">CANTEEN - CANTEEN VALUATION LISTING</td>
