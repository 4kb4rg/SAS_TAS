<%@ Page Language="vb" src="../../include/reports/GL_StdRpt_VehRunExpense.aspx.vb" Inherits="GL_StdRpt_VehRunExpense" %>
...
<HTML>
	<HEAD>
		<title>General Ledger - Monthly Vehicle Running Expenses</title>
	...
	<body>
		...
		<tr>
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma">
				<tr>
					<td class="font9Tahoma" colspan="3"><strong> GENERAL LEDGER - MONTHLY <asp:label id="lblTitle" runat="server" /> RUNNING EXPENSES</strong><br />
                    </td>
