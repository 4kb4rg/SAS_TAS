           ...
           <td style="width: 100%; height: 1500px" valign="top">
			...
			<table width=100% border="0" cellspacing="1" cellpadding="1" ID="Table2" class="font9Tahoma" runat=server>	
				<tr>
					...
					<td><asp:textbox id="txtDocNoFrom" maxlength=32 width="50%" runat="server" /> (blank for all) </td>
					<td>To :</td>
					<td><asp:textbox id="txtDocNoTo" maxlength=32 width="50%" runat="server" /> (blank for all) </td>
				</tr>
				<tr>
					...
					<a href="javascript:PopCal('txtInvRcvRefDateFrom');"><asp:Image id="btnSelDateFrom" ImageAlign=AbsMiddle runat="server" ImageUrl="../Images/calendar.gif"/></a>
					</td>
				</tr>
				<tr>
					...
					<a href="javascript:PopCal('txtInvRcvRefDateTo');"><asp:Image id="btnSelDateTo" ImageAlign=AbsMiddle runat="server" ImageUrl="../Images/calendar.gif"/></a>
					</td>	
				</tr>
				<tr>
					<td>Supplier Code:</td>
				...
				<tr>
					...
					<a href="javascript:PopCal('txtInvDueDateFrom');"><asp:Image id="btnSelDueDateFrom" ImageAlign=AbsMiddle runat="server" ImageUrl="../Images/calendar.gif"/></a>
					</td>	
				</tr>
				<tr>
					<td> Invoice Type: </td>
					...
					<a href="javascript:PopCal('txtInvDueDateTo');"><asp:Image id="btnSelDueDateTo" ImageAlign=AbsMiddle runat="server" ImageUrl="../Images/calendar.gif"/></a>
					</td>
				</tr>			
				<tr>
					<td> Status: </td>
				...
				<tr>
					<td> User Creation: </td>
					<td><asp:textbox id="txtUserCreation" width="50%" runat="server" /> </td>	
				</tr>	
				<tr>
					<td colspan=6>&nbsp;</td>
				</tr>
