<%@ Page Language="vb" src="../../include/reports/PR_StdRpt_PremiLain_Estate.aspx.vb" Inherits="PR_StdRpt_PremiLain_Estate" %>
	...
	<body>
		<form runat="server" ID="frmMain">
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1">
				<tr>
					<td class="mt-h" colspan="3">PAYROLL - PREMI LAIN</td>
