<%@ Page Language="vb" AutoEventWireup="false" src="../../include/reports/HR_StdRpt_Selection.aspx.vb" Inherits="HR_StdRpt_Selection" %>
...
<HTML>
	<HEAD>
		<title>Human Resource - Standard Reports</title>
	...
	<body>
        ...
        <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1">
				<tr>
					<td class="font9Tahoma" colspan="3"><strong>HUMAN RESOURCE - STANDARD REPORTS</strong> </td>
