<%@ Page Language="vb" src="../../include/reports/GL_StdRpt_DistribusiPemakaian.aspx.vb" Inherits="GL_StdRpt_DistribusiPemakaian" %>
           ...
           <td style="width: 100%; height: 1500px" valign="top">
			...
			<table width=100% border="0" cellspacing="2" cellpadding="1" ID="Table2" class="font9Tahoma" runat=server>	
				...
				<tr>
					...
					<td colspan=2>
						<asp:textbox id="txtRemarks" width="45%" runat="server"/>
					</td>			
				</tr>			
				<tr>
					<td colspan=3>&nbsp;</td>
