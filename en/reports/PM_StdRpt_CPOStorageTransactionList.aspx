<%@ Page Language="vb" src="../../include/reports/PM_StdRpt_CPOStorageTransactionList.aspx.vb" Inherits="PM_StdRpt_CPOStorageTransactionList" %>
...
<HTML>
	<HEAD>
		<title>PRODUCTION MANAGEMENT - CPO STORAGE TRANSACTION LISTING</title>
	...
	<body>
        ...
        <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1">
				<tr>
					<td class="font9Tahoma" colspan="3">PRODUCTION MANAGEMENT - CPO STORAGE TRANSACTION LISTING</td>
