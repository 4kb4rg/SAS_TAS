<%@ Page Language="vb" src="../../include/reports/IN_STDRPT_RKP_STOCK_BLNAN.aspx.vb" Inherits="IN_STDRPT_RKP_STOCK_BLNAN" %>
			...
			<table width=100% border="0" cellspacing="1" cellpadding="1" ID="Table2" class="font9Tahoma">
                <tr>
                    ...
                    <td style="width: 504px; height: 24px">
                        :
                        <asp:DropDownList ID="lstRpt" runat="server" AutoPostBack="False"
                            Width="50%">
                        </asp:DropDownList> <asp:Label id="lblRptError" visible="false" runat="server" text="Please Select Report" style="color:red" /></td>
