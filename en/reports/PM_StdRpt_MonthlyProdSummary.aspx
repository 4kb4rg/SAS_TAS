<%@ Page Language="vb" trace=false src="../../include/reports/PM_StdRpt_MonthlyProdSummary.aspx.vb" Inherits="PM_StdRpt_Monthly_Prod_Sum" %>
...
<HTML>
	<HEAD>
		<title>Production Management - Monthly Production Summary</title>
	...
	<body>
        ...
        <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1">
				<tr>
					<td class="font9Tahoma" colspan="3"><strong> PRODUCTION MANAGEMENT - MONTHLY PRODUCTION SUMMARY</strong></td>
