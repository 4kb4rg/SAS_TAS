<%@ Page Language="vb" src="../../include/reports/CB_StdRpt_DailyReceive.aspx.vb" Inherits="CB_StdRpt_DailyReceive" %>
...
<HTML>
	<HEAD>
		<title>Cash And Bank - Daily Receive Transaction</title>
		...
		<tr>
           <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1">
				<tr>
					<td class="font9Tahoma" colspan="3"><strong> CASH AND BANK - DAILY RECEIVE TRANSACTION</strong></td>
			...
			<table width=100% border="0" cellspacing="1" cellpadding="1" ID="Table2" class="font9Tahoma" runat=server>	
				...
				<tr>
					<td width ="20%">Bank (Acc Code):</td>
					<td colspan="2">    
					 <asp:Textbox id="txtAccCode" text = "110.11.01" width=20% maxlength=32 runat=server/>
