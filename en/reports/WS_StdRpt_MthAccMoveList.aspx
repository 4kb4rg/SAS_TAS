<%@ Page Language="vb" src="../../include/reports/WS_StdRpt_MthAccMoveList.aspx.vb" Inherits="WS_StdRpt_MthAccMoveList" %>
...
<HTML>
	<HEAD>
		<title>Workshop - Monthly Workshop Stock Account Movement Listing</title>
	...
	<body>
        ...
        <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1">
				<tr>
					<td class="font9Tahoma" colspan="3">WORKSHOP - MONTHLY WORKSHOP STOCK ACCOUNT MOVEMENT LISTING</td>
