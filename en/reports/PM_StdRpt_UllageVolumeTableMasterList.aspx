<%@ Page Language="vb" src="../../include/reports/PM_StdRpt_UllageVolumeTableMasterList.aspx.vb" Inherits="PM_StdRpt_UllageVolumeTableMasterList" %>
...
<HTML>
	<HEAD>
		<title>PRODUCTION MANAGEMENT - ULLAGE-VOLUME TABLE MASTER LISTING</title>
	...
	<body>
        ...
        <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma">
				<tr>
					<td class="font9Tahoma" colspan="3">PRODUCTION MANAGEMENT - ULLAGE-VOLUME TABLE MASTER LISTING</td>
			...
			<table width="100%" border="0" cellspacing="1" cellpadding="1" ID="Table2" class="font9Tahoma" runat="server">
				<tr>
					...
					<td width=39%><asp:TextBox id="txtUVTableCode" maxlength="10" width=50% runat="server"/> (blank for all) </td>
