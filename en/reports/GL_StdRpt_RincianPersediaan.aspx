<%@ Page Language="vb" src="../../include/reports/GL_StdRpt_RincianPersediaan.aspx.vb" Inherits="GL_StdRpt_RincianPersediaan" %>
...
<HTML>
	<HEAD>
		<title>General Ledger - Managerial Report (Rincian Persediaan)</title>
	...
	<body>
		...
		<tr>
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma">
				<tr>
					<td class="font9Tahoma" colspan="3"><strong>GENERAL LEDGER - MANAGERIAL REPORT (RINCIAN PERSEDIAAN)</strong> </td>
