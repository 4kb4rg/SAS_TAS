<%@ Page Language="vb" src="../../include/reports/AR_StdRpt_DebitNoteList.aspx.vb" Inherits="AR_StdRpt_DebitNoteList" %>
...
<HTML>
	<HEAD>
		<title>Account Receivables - Debit Note Listing </title>
		...
		<tr>
           <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma">
				<tr>
					<td class="font9Tahoma" colspan="3"><strong>ACCOUNT RECEIVABLES - DEBIT NOTE LISTING</strong> </td>
			...
			<table width=100% border="0" cellspacing="1" cellpadding="1" ID="Table2" class="font9Tahoma" runat=server>	
				...
				<tr>
					<td>Billing Type :</td>
					<td><asp:DropDownList id="ddlDebitNoteType" width="50%" runat="server" /></td>					
					<TD>&nbsp;</TD>
					<TD>&nbsp;</TD>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><asp:textbox id="txtCOA" width="50%"  maxlength=32 runat="server" /> (blank for all) </td>					
					<TD>&nbsp;</TD>
					<TD>&nbsp;</TD>
				</tr>	
				<tr>
