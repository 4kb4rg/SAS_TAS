<%@ Page Language="vb" trace=false src="../../include/reports/WM_StdRpt_Print_Ticket.aspx.vb" Inherits="WM_StdRpt_Print_Ticket" %>
...
<HTML>
	<HEAD>
		<title>Weighing Management - Print Ticket</title>
	...
	<body>
        ...
        <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma">
				<tr>
					<td class="font9Tahoma" colspan="3"><strong> WEIGHING MANAGEMENT - PRINT TICKET</strong></td>
