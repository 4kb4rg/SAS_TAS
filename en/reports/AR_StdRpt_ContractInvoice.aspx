<%@ Page Language="vb" src="../../include/reports/AR_StdRpt_ContractInvoice.aspx.vb" Inherits="AR_StdRpt_ContractInvoice" %>
...
<HTML>
	<HEAD>
		<title>Account Receivables- Contract Invoice</title>
		...
		<tr>
           <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1">
				<tr>
					<td class="font9Tahoma" colspan="3"><strong> ACCOUNT RECEIVABLES - INVOICE </strong></td>
			...
			<table width=100% border="0" cellspacing="2" cellpadding="1" ID="Table2" class="font9Tahoma" runat=server>
				...
				<tr>
					...
					<td width=39%><asp:dropdownlist id=ddlFromInvoiceId width=50% runat=server /> (blank for all)</td>			
					<td width=4%>To : </td>	
					<td width=40%><asp:dropdownlist id=ddlToInvoiceId width=50% runat=server/> (blank for all)</td>
				</tr>	
				<tr>
				...
				<tr>
					...
					<td width=39%><asp:dropdownlist id=ddlInvDocType width=50% runat=server /></td>
					<td colspan=2>&nbsp;</td>
				</tr>
				<tr>
				...
				<tr>
					<td width=17%>Bank : </td>
					<td width=39%>
						<asp:DropDownList id="ddlBankCode" runat="server" Width="50%"></asp:DropDownList></td>
				</tr>
				<tr>
