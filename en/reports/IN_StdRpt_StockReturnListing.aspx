<%@ Page Language="vb" src="../../include/reports/IN_StdRpt_StockReturnListing.aspx.vb" Inherits="IN_StdRpt_StockReturnListing" %>
...
<HTML>
	<HEAD>
		<title>Inventory - Stock Return Listing</title>
	...
	<body>
        ...
        <td style="width: 100%; height: 800px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma">
				<tr>
					<td class="font9Tahoma" colspan="3"><strong>INVENTORY - STOCK RETURN LISTING</strong> </td>
			...
			<table width=100% border="0" cellspacing="1" cellpadding="1" ID="Table2" class="font9Tahoma" runat=server>	
				<tr>
					<td width=17%>Stock Return ID From :</td>
					<td width=39%><asp:textbox id="txtStockReturnIDFrom" maxlength=20 width="50%" runat="server" /> (blank for all)</td>
					<td width= 4%>To :</td>
					<td width=40%><asp:textbox ID="txtStockReturnIDTo" maxlength=20 width="50%" Runat=server /> (blank for all)</td>
				</tr>
				<tr>
