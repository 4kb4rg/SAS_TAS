<%@ Page Language="vb" src="../../include/reports/NU_StdRpt_SeedPlantList.aspx.vb" Inherits="NU_StdRpt_SeedPlantList" %>
...
<HTML>
	<HEAD>
		<title>Nursery - Seeds Planting Listing</title>
	...
	<body>
        ...
        <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma">
				<tr>
					<td class="font9Tahoma" colspan="3"><strong>NURSERY - SEEDS PLANTING LISTING</strong> </td>
