<%@ Page Language="vb" src="../../include/reports/PR_StdRpt_GangAvgEarn.aspx.vb" Inherits="PR_StdRpt_GangAvgEarn" %>
...
<HTML>
	<HEAD>
		<title>Payroll - Gang Average Earning</title>
	...
	<body>
        ...
        <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma">
				<tr>
					<td class="font9Tahoma">PAYROLL - GANG AVERAGE EARNING</td>
