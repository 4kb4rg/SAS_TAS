<%@ Page Language="vb" src="../../include/reports/GL_StdRpt_VehExpenseDet.aspx.vb" Inherits="GL_StdRpt_VehExpenseDet" %>
...
<HTML>
	<HEAD>
		<title>General Ledger - Monthly Vehicle Expense Detail</title>
	...
	<body>
		...
		<tr>
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma">
				<tr>
					<td class="font9Tahoma" colspan="3"><strong> GENERAL LEDGER - MONTHLY <asp:label id="lblTitle" runat="server" /> DETAIL</strong></td>
			...
			<table width=100% border="0" cellspacing="2" cellpadding="1" ID="Table2" class="font9Tahoma" runat=server>	
				...
				<tr>
					<td>Summarize By :</td>
					<td colspan=2>
						<asp:checkbox id="chkSummBy" Text="Vehicle Type" AutoPostBack=true width="25%" runat="server" />
					</td>
				</tr>
