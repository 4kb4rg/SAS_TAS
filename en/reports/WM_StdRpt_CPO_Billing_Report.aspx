<%@ Page Language="vb" trace=false src="../../include/reports/WM_StdRpt_CPO_Billing_Report.aspx.vb" Inherits="WM_StdRpt_CPOBillRpt" %>
...
<HTML>
	<HEAD>
		<title>Weighing Management - CPO Billing Report</title>
	...
	<body>
        ...
        <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma">
				<tr>
					<td class="font9Tahoma" colspan="3"><strong>WEIGHING MANAGEMENT - CPO BILLING REPORT</strong> </td>
