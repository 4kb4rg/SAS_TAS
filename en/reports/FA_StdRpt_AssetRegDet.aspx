<%@ Page Language="vb" src="../../include/reports/FA_StdRpt_AssetRegDet.aspx.vb" Inherits="FA_StdRpt_AssetRegDet" %>
...
<HTML>
	<HEAD>
		<title>Fixed Asset - Daftar Harta Tetap</title>
		...
		<tr>
           <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma">
				<tr>
					<td class="font9Tahoma" colspan="3"><strong> FIXED ASSET - DAFTAR HARTA TETAP</strong></td>
