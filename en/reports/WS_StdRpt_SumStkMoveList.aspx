<%@ Page Language="vb" src="../../include/reports/WS_StdRpt_SumStkMoveList.aspx.vb" Inherits="WS_StdRpt_SumStkMoveList" %>
...
<HTML>
	<HEAD>
		<title>Workshop - Summarized Workshop Stock Movement Report</title>
	...
	<body>
        ...
        <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1">
				<tr>
					<td class="font9Tahoma" colspan="3">WORKSHOP - SUMMARIZED WORKSHOP STOCK MOVEMENT LIST</td>
