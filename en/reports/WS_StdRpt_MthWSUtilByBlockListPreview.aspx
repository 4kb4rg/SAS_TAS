<%@ Page Language="vb" Src="../../include/reports/WS_StdRpt_MthWSUtilByBlockListPreview.aspx.vb" Inherits="WS_StdRpt_MthWSUtilByBlock_Preview" %>
...
<HTML>
	<HEAD>
		<title><asp:label id=lblTitle text="Workshop - Monthly Workshop Stock Utilisation by " runat=server /></title>
