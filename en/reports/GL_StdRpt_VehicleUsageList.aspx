<%@ Page Language="vb" src="../../include/reports/GL_StdRpt_VehicleUsageList.aspx.vb" Inherits="GL_StdRpt_VehicleUsageList" %>
...
<HTML>
	<HEAD>
		<title>General Ledger - Vehicle Usage Listing</title>
	...
	<body>
		...
		<tr>
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma">
				<tr>
					<td class="font9Tahoma" colspan="3"> <strong> GENERAL LEDGER - VEHICLE USAGE LISTING REPORT</strong></td>
