<%@ Page Language="vb" src="../../include/reports/IN_StdRpt_FuelIssueList.aspx.vb" Inherits="IN_StdRpt_FuelIssueList" %>
...
<HTML>
	<HEAD>
		<title>Inventory - Fuel Issue Listing</title>
	...
	<body>
        ...
        <td style="width: 100%; height: 800px" valign="top">
			...
			<asp:Label id="lblBillParty" visible="false" runat="server" />		
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma">
				<tr>
					<td class="font9Tahoma" colspan="3"><strong>INVENTORY - FUEL ISSUE LISTING</strong> </td>
			...
			<table width=100% border="0" cellspacing="1" cellpadding="1" ID="Table2" class="font9Tahoma" runat=server>	
				<tr>
					<td>Fuel Issue ID From:</td>
					<td><asp:textbox id="txtFuelIssueIDFrom" width="50%" maxlength=20 runat="server" /> (blank for all)</td>
					<td>To :</td>
					<td><asp:textbox ID="txtFuelIssueIDTo" width="50%" maxlength=20 Runat=server /> (blank for all)</td>
				</tr>
				<tr>
					<td>Issue Type :</td>
					<td><asp:DropDownList id="lstFuelIssueType" size="1" width="50%" runat="server" /></td>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
				</tr>
				<tr>
				...
				<tr id=TrBlk>
					...
					<td><asp:textbox id="txtBlkCode" maxlength=20 width="50%" runat="server" /> (blank for all)</td>
					<td>&nbsp;</td>
					<td>&nbsp;</td>					
				</tr>
				<tr id=TrSubBlk>
					<td><asp:label id=lblSubBlkCode runat=server /></td>
					<td><asp:textbox id="txtSubBlkCode" maxlength=20 width="50%" runat="server" /> (blank for all)</td>			
					<td>&nbsp;</td>
					<td>&nbsp;</td>				
				</tr>
				<tr>
