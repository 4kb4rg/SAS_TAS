<%@ Page Language="vb" src="../../include/reports/CB_StdRpt_ReceiptVoucher.aspx.vb" Inherits="CB_StdRpt_ReceiptVoucher" %>
		...
		<tr>
           <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma">
				<tr>
					<td class="font9Tahoma" colspan="3"><strong> CASH AND BANK - RECEIPT VOUCHER</strong></td>
			...
			<table width=100% border="0" cellspacing="2" cellpadding="1" ID="Table2" class="font9Tahoma" runat=server>
				...
				<tr>
					...
					<td width=39%><asp:Textbox id=txtFromReceiptID maxlength=35 width=50% runat=server/> (blank for all)</td>			
					<td width=4%>To : </td>	
					<td width=40%><asp:Textbox id=txtToReceiptId maxlength=35 width=50% runat=server/> (blank for all)</td>
				</tr>
				<tr>
				...
				<tr>
					<td width=17%>Receipt Voucher No. : </td>
					<td width=39%><asp:Textbox id=txtVoucherNo maxlength=35 width=50% runat=server/></td>			
				</tr>
				<tr>
				...
				<tr>
					...
					<td><asp:DropDownList id=ddlContract Width=50% runat=server/>
