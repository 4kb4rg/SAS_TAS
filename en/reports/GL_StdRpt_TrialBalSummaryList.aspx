<%@ Page Language="vb" src="../../include/reports/GL_StdRpt_TrialBalSummaryList.aspx.vb" Inherits="GL_StdRpt_TrialBalSummaryList" %>
...
<HTML>
	<HEAD>
		<title>General Ledger - Trial Balance Summary Report</title>
	...
	<body>
		...
		<tr>
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1">
				<tr>
					<td class="font9Tahoma" colspan="3"><strong>GENERAL LEDGER - TRIAL BALANCE SUMMARY REPORT</strong> </td>
			...
			<table width=100% border="0" cellspacing="2" cellpadding="1" ID="Table2" class="font9Tahoma" runat=server>	
				...
				<tr>
					...
					<td colspan=2>
						<asp:checkbox id="cbBalSheet" text="Balance Sheet" value="1" runat="server"/>
						<asp:checkbox id="cbProfLoss" text="Profit and Lost" value="2" runat="server"/>
					</td>			
				</tr>	
				<tr>
					<td colspan=3>
						<asp:CheckBox id="cbEstExpense" text=" Include Estate Expenditure" value="Yes" runat="server"/>
					</td>
				</tr>											
				<tr>
					<td colspa=3>&nbsp;</td>
