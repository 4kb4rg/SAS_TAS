<%@ Page Language="vb" src="../../include/reports/PR_StdRpt_LHPPB_Estate.aspx.vb" Inherits="PR_StdRpt_LHPPB_Estate" %>
	...
	<body>
        ...
        <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1"  class="font9Tahoma">
				<tr>
					<td class="font9Tahoma" colspan="3"><strong> LHPPB - Laporan Harian Premi Potong Buah</strong></td>
