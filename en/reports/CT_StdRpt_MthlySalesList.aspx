<%@ Page Language="vb" src="../../include/reports/CT_StdRpt_MthlySalesList.aspx.vb" Inherits="CT_StdRpt_MthlySalesList" %>
...
<HTML>
	<HEAD>
		<title>Canteen - Monthly Canteen Sales Listing</title>
		...
		<tr>
           <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma">
				<tr>
					<td class="mt-h" colspan="3">CANTEEN - MONTHLY CANTEEN SALES LISTING</td>
