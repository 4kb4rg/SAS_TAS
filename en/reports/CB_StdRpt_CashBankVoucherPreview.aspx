<%@ Page Language="vb" Src="../../include/reports/CB_StdRpt_CashBankVoucherPreview.aspx.vb" Inherits="CB_StdRpt_CashBankVoucherPreview" %>
...
<HTML>
	<HEAD>
		<title>Cash And Bank - Cash Bank Voucher Report</title>
	</HEAD>
