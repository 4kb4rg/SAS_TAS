<%@ Page Language="vb" src="../../include/reports/PM_StdRpt_KernelLossTransactionList.aspx.vb" Inherits="PM_StdRpt_KernelLossTransactionList" %>
...
<HTML>
	<HEAD>
		<title>Production Management - Kernel Loss Transaction Listing</title>
	...
	<body>
        ...
        <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma">
				<tr>
					<td class="font9Tahoma" colspan="3">PRODUCTION MANAGEMENT - KERNEL LOSS TRANSACTION LISTING</td>
