<%@ Page Language="vb" Src="../../include/reports/AR_StdRpt_DebtorAccountAgeingPreview.aspx.vb" Inherits="AR_StdRpt_DebtorAccountAgeingPreview" %>
...
<HTML>
	<HEAD>
		<title>Account Receivables Debtor Account Ageing Report</title>
	...
	<body MS_POSITIONING="GridLayout" onload="this.focus()" >
		...
		<asp:Label id=lblNoRecord visible=false text="Record is not found." runat="server" />	
	</body>
</HTML>
