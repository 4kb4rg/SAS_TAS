<%@ Page Language="vb" src="../../include/reports/PM_StdRpt_StorageAreaMasterList.aspx.vb" Inherits="PM_StdRpt_StorageAreaMasterList" %>
...
<HTML>
	<HEAD>
		<title>PRODUCTION MANAGEMENT - STORAGE AREA MASTER LISTING</title>
	...
	<body>
        ...
        <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma">
				<tr>
					<td class="mt-h" colspan="3">PRODUCTION MANAGEMENT - STORAGE AREA MASTER LISTING</td>
			...
			<table width="100%" border="0" cellspacing="1" cellpadding="1" ID="Table2" class="font9Tahoma" runat="server">
				<tr>
					...
					<td width=39%><asp:TextBox id="txtStorageAreaCode" maxlength="8" width=50% runat="server"/> (blank for all)
					</td>
				...
				<tr>
					...
					<td width=39%><asp:TextBox id="txtStorageType" maxlength="8" width=50% runat="server"/> (blank for all)
					</td>
					<td width=4% align=center></td>
					<td width=40%>&nbsp;</td>
				</tr>
