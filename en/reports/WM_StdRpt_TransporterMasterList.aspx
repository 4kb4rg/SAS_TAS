<%@ Page Language="vb" src="../../include/reports/WM_StdRpt_TransporterMasterList.aspx.vb" Inherits="WM_StdRpt_TransporterMasterList" %>
...
<HTML>
	<HEAD>
		<title>Weighing Management - Transporter Master Listing</title>
	...
	<body>
        ...
        <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma">
				<tr>
					<td class="font9Tahoma" colspan="3"><strong>WEIGHING MANAGEMENT - TRANSPORTER MASTER LISTING</strong> </td>
			...
			<table width="100%" border="0" cellspacing="1" cellpadding="1" ID="Table1" class="font9Tahoma">
				<tr>
					<td width="17%">Transporter Code : </td>
					<td width="39%"><asp:textbox id="txtTransporterCode" maxlength=8  width="50%" runat="server" /> (blank for all)</td>
					<td width="4%">&nbsp;</td>
					<td width="40%">&nbsp;</td>
				</tr>
				<tr>
				...
				<tr>
					<td>Telephone : </td>
					<td><asp:textbox id="txtTelephone" maxlength=128  width="50%" runat="server" /> (blank for all)</td>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
				</tr>				
				<tr>
				...
				<tr>
					<td> </td>
					<td><asp:TextBox id="txtDateFrom" maxlength="10" visible="false" runat="server"/>
  								  <a href="javascript:PopCal('txtDateFrom');">
								  <asp:Image id="btnSelDateFrom" runat="server" visible="false" ImageUrl="../Images/calendar.gif"/></a></td>				
					<td colspan=2> 
								  <asp:TextBox id="txtDateTo" maxlength="10"   visible="false" runat="server"/>
  								  <a href="javascript:PopCal('txtDateTo');">
								  <asp:Image id="btnSelDateTo" runat="server" visible="false"  ImageUrl="../Images/calendar.gif"/></a></td>
				</tr>
				<tr>
					<td></td>
					<td><asp:TextBox id="TxtUpdatedBy"  visible="false"  maxlength="20" runat="server" /></td>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
				<tr>
