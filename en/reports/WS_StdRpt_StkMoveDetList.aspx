<%@ Page Language="vb" src="../../include/reports/WS_StdRpt_StkMoveDetList.aspx.vb" Inherits="WS_StdRpt_StkMoveDetList" %>
...
<HTML>
	<HEAD>
		<title>Workshop - Workshop Stock Movement Detail Listing</title>
	...
	<body>
        ...
        <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma">
				<tr>
					<td class="font9Tahoma" colspan="3"><strong>WORKSHOP - WORKSHOP STOCK MOVEMENT DETAIL LISTING</strong> </td>
