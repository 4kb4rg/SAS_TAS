<%@ Page Language="vb" Src="../../include/reports/GL_StdRpt_LabourHourReconciliationPreview.aspx.vb" Inherits="GL_StdRpt_LabourHourReconciliationPreview" %>
...
<HTML>
	...
	<body MS_POSITIONING="GridLayout" onload="this.focus()" >
		...
		<asp:label id=lblSummary visible=false text=" Summary - " runat=server />	
	</body>
</HTML>
