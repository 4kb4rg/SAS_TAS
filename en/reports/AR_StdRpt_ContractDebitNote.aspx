<%@ Page Language="vb" src="../../include/reports/AR_StdRpt_ContractDebitNote.aspx.vb" Inherits="AR_StdRpt_ContractDebitNote" %>
...
<HTML>
	<HEAD>
		<title>Account Receivables- Debit Note</title>
		...
		<tr>
           <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1">
				<tr>
					<td class="font9Tahoma" colspan="3"><strong> ACCOUNT RECEIVABLES - DEBIT NOTE</strong></td>
			...
			<table width=100% border="0" cellspacing="2" cellpadding="1" ID="Table2" class="font9Tahoma" runat=server>
				...
				<tr>
					...
					<td width=39%><asp:Textbox id=txtFromDebitNoteId maxlength=20 width=50% runat=server/> (blank for all)</td>			
					<td width=4%>To : </td>	
					<td width=40%><asp:Textbox id=txtToDebitNoteId maxlength=20 width=50% runat=server/> (blank for all)</td>
				</tr>
				<tr>
					<td width=17%>Debit Note Date From : </td>
					<td width=39%>
						<asp:Textbox id=txtFromDebitNoteDate maxlength=20 width=50% runat=server/>
						<a href="javascript:PopCal('txtFromDebitNoteDate');">
						<asp:Image id="btnFromDebitNoteDate" runat="server" ImageUrl="../Images/calendar.gif"/></td>			
					<td width=4%>To : </td>	
					<td width=40%>
						<asp:Textbox id=txtToDebitNoteDate maxlength=20 width=50% runat=server/>
						<a href="javascript:PopCal('txtToDebitNoteDate');">
						<asp:Image id="btnToDebitNoteDate" runat="server" ImageUrl="../Images/calendar.gif"/></td>
				</tr>	
				<tr id=TrBillParty>
				...
				<tr>
					...
					<td width=39%><asp:dropdownlist id=ddlDNDocType width=50% autopostback=true onselectedindexchanged="onChange_DocType" runat=server /></td>
					<td colspan=2>&nbsp;</td>
				</tr>
				<tr id=TrBankAccNo>
					<td width=17%>Bank Account No : </td>
					<td width=39%>
						<asp:textbox id=txtBankAccNo maxlength=128 width=50% runat=server />
						<asp:label id=lblBankAccNo visible=false runat=server />
					</td>
					<td colspan=2>&nbsp;</td>
				</tr>	
				<tr id=TrBankName>
					...
					<td width=39%>
						<asp:textbox id=txtBankName maxlength=128 width=50% runat=server />
						<asp:label id=lblBankName visible=false runat=server />
					</td>
					<td colspan=2>&nbsp;</td>
				</tr>
				<tr id=TrBankBranch>
					<td width=17%>Bank Branch : </td>
					<td width=39%>
						<asp:textbox id=txtBankBranch maxlength=128 width=50% runat=server />
						<asp:label id=lblBankBranch visible=false runat=server />
					</td>
					<td colspan=2>&nbsp;</td>
				</tr>				
				<tr id=TrUndName>
