<%@ Page Language="vb" Src="../../include/reports/PM_StdRpt_OilLossTransactionListPreview.aspx.vb" Inherits="PM_StdRpt_OilLossTransactionListPreview" %>
...
<HTML>
	<HEAD>
		<title>Production Management - Loss Transaction Listing</title>
