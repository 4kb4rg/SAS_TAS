<%@ Page Language="vb" trace=false src="../../include/reports/WM_StdRpt_Daily_FFBRcv_By_Supplier_Report.aspx.vb" Inherits="WM_StdRpt_Daily_FFBRcv_BySupp" %>
...
<HTML>
	<HEAD>
		<title>Weighing Management - Daily FFB Received by Supplier Report</title>
				...
				<tr>
					...
					<td width=35% style="height: 24px">   
                        <asp:DropDownList ID="lstRptType" runat="server" AutoPostBack="true" 
                            Width="76%">
                            <asp:ListItem Selected="True" Value="0">Penerimaan TBS By Supplier</asp:ListItem>
                            <asp:ListItem Value="1">Rekapitulasi Harian TBS</asp:ListItem>
                            <asp:ListItem Value="2">FFB Grading Detail</asp:ListItem>
