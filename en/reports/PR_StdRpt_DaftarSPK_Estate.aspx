<%@ Page Language="vb" src="../../include/reports/PR_StdRpt_DaftarSPK_Estate.aspx.vb" Inherits="PR_StdRpt_DaftarSPK_Estate" %>
	...
	<body>
        ...
        <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma">
				<tr>
					<td class="mt-h" colspan="3"><strong> PAYROLL - LAPORAN HARIAN BORONGAN (SPK)</strong></td>
