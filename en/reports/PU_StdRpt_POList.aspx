<%@ Page Language="vb" src="../../include/reports/PU_StdRpt_POList.aspx.vb" Inherits="PU_StdRpt_POList" %>
...
<HTML>
	<HEAD>
		<title>Purchasing - Purchase Order Listing</title>
	...
	<body>
        ...
        <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1">
				<tr>
					<td class="font9Tahoma" colspan="3"><strong> PURCHASING - PURCHASE ORDER LISTING</strong></td>
			...
			<table width=100% border="0" cellspacing="1" cellpadding="1" ID="Table2" class="font9Tahoma" runat=server>	
				...
				<tr>
					<td width=15%>PR Ref. Location :</td>
					<td width=35%><asp:DropDownList id="lstPRRefLoc" size="1" width="50%" runat="server" /></td>
					<td width=15%>&nbsp;</td>
					<td width=35%>&nbsp;</td>
				</tr>		
				<tr>
					<td width=25%>View Invoice/Payment : </td>
					<td colspan=2><asp:RadioButton id="rbYes" text="Yes" GroupName="rbView" runat="server" />
						<asp:RadioButton id="rbNo" text="No" checked="true" GroupName="rbView" runat="server" />
					</td>			
					<td colspan=3>&nbsp;</td>
				</tr>	
				<tr>
