<%@ Page Language="vb" trace=false src="../../include/reports/PM_StdRpt_MonthlyRecordProd.aspx.vb" Inherits="PM_StdRpt_MonthlyRecordProd" %>
	...
	<body>
        ...
        <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma">
				<tr>
					<td class="font9Tahoma" colspan="3"><strong> PRODUCTION MANAGEMENT - MONTHLY RECORD PRODUCTION</strong></td>
			...
			<table width="100%" border="0" cellspacing="1" cellpadding="1" ID="Table1">		
				...
				<tr>
					...
					<td width="35%" style="height: 40px">
                        &nbsp;<a href="javascript:PopCal('txtTrxDate');"></a><br>
                        &nbsp;
					</td>
					<td width="15%" style="height: 40px">&nbsp;</td>
					<td width="35%" style="height: 40px">&nbsp;</td>
				</tr>
