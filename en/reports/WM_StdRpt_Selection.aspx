<%@ Page Language="vb" AutoEventWireup="false" src="../../include/reports/WM_StdRpt_Selection.aspx.vb" Inherits="WM_StdRpt_Selection" %>
...
<HTML>
	<HEAD>
		<title>Weighing Management - Standard Reports</title>
	...
	<body>
        ...
        <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1">
				...
				<tr>
					<td class="font9Tahoma" colspan="3"><strong> WEIGHING MANAGEMENT - STANDARD REPORTS</strong></td>
