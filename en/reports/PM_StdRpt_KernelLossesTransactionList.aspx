<%@ Page Language="vb" src="../../include/reports/PM_StdRpt_KernelLossesTransactionList.aspx.vb" Inherits="PM_StdRpt_KernelLossesTransactionList" %>
...
<HTML>
	<HEAD>
		<title>Production Management - Oil Quality Transaction Listing</title>
	...
	<body>
        ...
        <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma">
				<tr>
					<td class="font9Tahoma" colspan="3">PRODUCTION MANAGEMENT - KERNEL LOSSES TRANSACTION LISTING</td>
