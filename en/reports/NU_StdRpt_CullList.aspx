<%@ Page Language="vb" src="../../include/reports/NU_StdRpt_CullList.aspx.vb" Inherits="NU_StdRpt_CullList" %>
...
<HTML>
	<HEAD>
		<title>Nursery - Culling Listing</title>
	...
	<body>
        ...
        <td style="width: 100%; height: 800px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma">
				<tr>
					<td class="font9Tahoma" colspan="3"><strong> NURSERY - CULLING LISTING</strong></td>
			...
			<table width=100% border="0" cellspacing="1" cellpadding="1" ID="Table2"  class="font9Tahoma" runat=server>	
				...
				<tr>
					<td><asp:label id=lblCullTypeCode runat=server /> :</td>
					<td><asp:textbox id="txtCullTypeCode" maxlength=8 width="50%" runat="server" /> (blank for all)</td>
					<td>&nbsp;</td>
					<td>&nbsp;</td>					
				</tr>
				<tr>
