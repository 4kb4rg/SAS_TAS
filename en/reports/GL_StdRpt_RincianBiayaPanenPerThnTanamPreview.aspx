<%@ Page Language="vb" Src="../../include/reports/GL_StdRpt_RincianBiayaPanenPerThnTanamPreview.aspx.vb" Inherits="GL_StdRpt_RincianBiayaPanenPerThnTanamPreview" %>
...
<HTML>
	...
	<body MS_POSITIONING="GridLayout" onload="this.focus()" >
		...
		<asp:label id=lblRefDesc visible=false text=" with " runat=server />		
	</body>
</HTML>
