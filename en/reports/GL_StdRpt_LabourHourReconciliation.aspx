<%@ Page Language="vb" src="../../include/reports/GL_StdRpt_LabourHourReconciliation.aspx.vb" Inherits="GL_StdRpt_LabourHourReconciliation" %>
...
<html>
	<head>
		<title>General Ledger - Labour Hours Reconciliation Report</title>
		...
		<tr>
           <td style="width: 100%; height: 1500px" valign="top">
			...
			<table Border="0" CellSpacing="1" CellPadding="1" Width="100%">
				<tr>
					<td Class="font9Tahoma" ColSpan="3"><strong>GENERAL LEDGER - LABOUR HOURS RECONCILIATION REPORT</strong> </td>
