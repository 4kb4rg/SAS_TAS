<%@ Page Language="vb" src="../../include/reports/NU_StdRpt_NUWrkAccSum.aspx.vb" Inherits="NU_StdRpt_NUWrkAccSum" %>
...
<HTML>
	<HEAD>
		<title>Nursery - Working Account Summary</title>
	...
	<body>
        ...
        <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma">
				<tr>
					<td class="font9Tahoma" colspan="3"><strong>NURSERY - WORKING ACCOUNT SUMMARY</strong> </td>
