<%@ Page Language="vb" src="../../include/reports/PR_StdRpt_GajiKecil_Hutang_Estate.aspx.vb" Inherits="PR_StdRpt_GajiKecil_Hutang_Estate" %>
	...
	<body>
		<form runat="server"  class="main-modul-bg-app-list-pu" ID="frmMain">
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma">
				<tr>
					<td class="font9Tahoma" colspan="3"><strong>PAYROLL - HUTANG GAJI KECIL</strong> </td>
