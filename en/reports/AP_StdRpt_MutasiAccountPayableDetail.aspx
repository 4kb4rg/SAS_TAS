<%@ Page Language="vb" src="../../include/reports/AP_StdRpt_MutasiAccountPayableDetail.aspx.vb" Inherits="AP_StdRpt_MutasiAccountPayableDetail" %>
...
<HTML>
	<HEAD>
		<title>Account Payable - Mutasi Account Payable Detail</title>
		...
		<tr>
           <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma">
				<tr>
					<td class="font9Tahoma" colspan="3"><strong> ACCOUNT PAYABLE - MUTASI ACCOUNT PAYABLE DETAIL</strong></td>
			...
			<table width=100% border="0" cellspacing="2" cellpadding="1" ID="Table2" class="font9Tahoma" runat=server>	
				...
				<tr>
					...
					<td><asp:DropDownList width=0% id=ddlSupplier BackColor="Transparent" BorderStyle="None" visible=true AutoPostBack=true OnSelectedIndexChanged=onSelect_Supplier runat=server /></td>
				</tr>
				<tr>
					<td>Supplier Type :</td>
					<td><asp:DropDownList width=50% id=ddlSplType runat=server>
					<asp:ListItem value="1" Selected >Supplier PO</asp:ListItem>
				...
				<tr>
					...
					<asp:ListItem value="0" Selected >Regular</asp:ListItem>
