<%@ Page Language="vb" src="../../include/reports/NU_StdRpt_BiayaBibit.aspx.vb" Inherits="NU_StdRpt_BiayaBibit" %>
...
<HTML>
	<HEAD>
		<title>Nursery - Biaya Bibit</title>
	...
	<body>
        ...
        <td style="width: 100%; height: 800px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma"> 
				<tr>
					<td class="font9Tahoma" colspan="3"><strong> NURSERY - BIAYA BIBIT</strong></td>
			...
			<!--	Removed: not used
				...
				<!--tr>
					...
					<td><asp:textbox id="txtItemCode" maxlength=20 width="50%" runat="server" /> 					    
					     ...
					     <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtItemCode"
                            Display="Dynamic" EnableViewState="False" ErrorMessage="Field cannot be blank."></asp:RequiredFieldValidator></td>					
					<td>&nbsp;</td>
					<td>&nbsp;</td>
				</tr-->
				<tr>
