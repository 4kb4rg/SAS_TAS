<%@ Page Language="vb" src="../../include/reports/BD_StdRpt_CapitalExp.aspx.vb" Inherits="BD_StdRpt_CapitalExp" %>
...
<HTML>
	<HEAD>
		<title>Budgeting - Capital Expenditure</title>
		...
		<tr>
           <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma">
				<tr>
					<td class="font9Tahoma" colspan="3"><strong> BUDGETING - CAPITAL EXPENDITURE</strong></td>
			...
			<table width="100%" border="0" cellspacing="1" cellpadding="1" ID="Table2" runat="server" class="font9Tahoma">
				<!--<tr>
