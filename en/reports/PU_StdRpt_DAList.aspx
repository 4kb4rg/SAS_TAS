<%@ Page Language="vb" src="../../include/reports/PU_StdRpt_DAList.aspx.vb" Inherits="PU_StdRpt_DAList" %>
...
<HTML>
	<HEAD>
		<title>Purchasing - Dispatch Advice Listing</title>
	...
	<body>
        ...
        <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma">
				<tr>
					<td class="font9Tahoma" colspan="3"><strong>PURCHASING - DISPATCH ADVICE LISTING</strong> </td>
			...
			<table width=100% border="0" cellspacing="1" cellpadding="1" ID="Table2" class="font9Tahoma" runat=server>	
				...
				<tr>
					<td>Transfer Via :</td>
					<td><asp:textbox id="txtTransporter" width="50%" runat="server" /> (blank for all)</td>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
				</tr>
				<tr>
					<td><asp:label id=lblDAType text="Dispatch Advice Type : " runat=server /> </td>
					<td><asp:DropDownList id="lstDAType" width="50%" runat="server" /></td>
					<td>&nbsp;</td>
					<td>&nbsp;</td>									
				</tr>												
				<tr>
				...
				<tr>
					...
					<td colspan=2><asp:RadioButton id="rbTrx" text="DAID" checked="true" GroupName="rbGroup" runat="server" />
					    <asp:RadioButton id="rbItem" text="Item" GroupName="rbGroup" runat="server" />
						<asp:RadioButton id="rbToLocCode" text="Transfer To" GroupName="rbGroup" runat="server" />
						<asp:RadioButton id="rbTransporter" text="Transfer Via" GroupName="rbGroup" runat="server" />
					</td>			
					<td colspan=3>&nbsp;</td>
				</tr>
				<tr>
