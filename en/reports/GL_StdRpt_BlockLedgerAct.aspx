<%@ Page Language="vb" src="../../include/reports/GL_StdRpt_BlockLedgerAct.aspx.vb" Inherits="GL_StdRpt_BlockLedgerAct" %>
...
<HTML>
	<HEAD>
		<title>General Ledger - Monthly Block Ledger By Activity Report</title>
		...
		<tr>
           <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma">
				<tr>
					<td class="mt-h" colspan="3">GENERAL LEDGER - MONTHLY BLOCK LEDGER BY ACTIVITY REPORT</td>
