<%@ Page Language="vb" src="../../include/reports/PR_StdRpt_RetRemu.aspx.vb" Inherits="PR_StdRpt_RetRemu" %>
...
<HTML>
	<HEAD>
		<title>EA - Return of Remuneration From Employment</title>
	...
	<body>
		<form runat="server" ID="frmMain">
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1">
				<tr>
					<td class="mt-h" colspan="3">EA - RETURN OF REMUNERATION FROM EMPLOYMENT</td>
