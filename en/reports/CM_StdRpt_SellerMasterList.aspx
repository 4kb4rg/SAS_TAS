<%@ Page Language="vb" src="../../include/reports/CM_StdRpt_SellerMasterList.aspx.vb" Inherits="CM_StdRpt_SellerMasterList" %>
...
<HTML>
	<HEAD>
		<title>Contract Management - Seller Master Listing</title>
		...
		<tr>
           <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma">
				<tr>
					<td class="font9Tahoma" colspan="3">CONTRACT MANAGEMENT - SELLER MASTER LISTING</td>
			...
			<table width="100%" border="0" cellspacing="1" cellpadding="1" ID="Table1">
				<tr>
					<td>Seller Code: </td>
					<td><asp:textbox id="txtSellerCode" maxlength=8  runat="server" /> (blank for all)</td>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
				</tr>
				<tr>
				...
				<tr>
					<td>Telephone: </td>
					<td><asp:textbox id="txtTelephone" maxlength=128  runat="server" /> (blank for all)</td>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
				</tr>				
				<tr>
