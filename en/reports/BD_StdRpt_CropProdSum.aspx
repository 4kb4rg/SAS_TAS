<%@ Page Language="vb" src="../../include/reports/BD_StdRpt_CropProdSum.aspx.vb" Inherits="BD_StdRpt_CropProdSum" %>
...
<HTML>
	<HEAD>
		<title>Budgeting - Crop Production Summary</title>
		...
		<tr>
           <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1"  class="font9Tahoma">
				...
				<tr>
					<td class="font9Tahoma" colspan="3"><strong> BUDGETING - CROP PRODUCTION SUMMARY</strong></td>
			...
			<table width="100%" border="0" cellspacing="1" cellpadding="1" ID="Table2"  class="font9Tahoma" runat="server">
				<tr>
					...
					<td width=35%><asp:DropDownList id="lstBlkType" width="40%" runat="server" /></td>
					<td width=15%>&nbsp;</td>
					<td width=35%>&nbsp;</td>									
				</tr>			
				<tr>
