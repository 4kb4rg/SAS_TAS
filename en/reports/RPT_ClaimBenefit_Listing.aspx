<%@ Page Language="vb" src="../../include/reports/RPT_ClaimBenefit_Listing.aspx.vb" Inherits="RPT_ClaimBenefit_Listing" %>
...
<HTML>
	<HEAD>
		<title>Claim/Benefit Report</title>
	...
	<body>
        ...
        <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1">
				<tr>
					<td class="font9Tahoma" colspan="3">CLAIM/BENEFIT REPORT</td>
			...
			<table width="100%" border="0" cellspacing="2" cellpadding="1" ID="Table2" class="font9Tahoma" runat=server>	
				...
				<tr>
					<td width="15%">Listing Type: </td>
					    <td><asp:DropDownList ID="ddlListingType" width="70%" OnSelectedIndexChanged="ListingType_Changed" AutoPostBack=true runat="server">
                            ...
                            <asp:ListItem value="3">BENEFIT</asp:ListItem>
                        </asp:DropDownList></td>      
					<td>&nbsp;</td>
					<td>&nbsp;</td>
				</tr>
				...
				<tr id="ListingType4" visible=false runat="server">
					<td width="15%">Benefit : </td>
					    <td><GG:AutoCompleteDropDownList id="ddlBenefit" Width="70%"  runat="server" /></td>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
				</tr>
				<tr>
