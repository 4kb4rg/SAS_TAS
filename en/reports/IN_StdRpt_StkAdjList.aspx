<%@ Page Language="vb" src="../../include/reports/IN_StdRpt_StkAdjList.aspx.vb" Inherits="IN_StdRpt_StkAdjList" %>
	...
	<body>
        ...
        <td style="width: 100%; height: 800px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1">
				<tr>
					<td class="font9Tahoma" colspan="3"><strong>INVENTORY - STOCK ADJUSTMENT LISTING</strong> </td>
			...
			<table width=100% border="0" cellspacing="1" cellpadding="1" ID="Table2" class="font9Tahoma" runat=server>	
				<tr>
					<td width=17%>Stock Adjustment ID From :</td>
