<%@ Page Language="vb" src="../../include/reports/NU_StdRpt_NUWrkAccDet.aspx.vb" Inherits="NU_StdRpt_NUWrkAccDet" %>
...
<HTML>
	<HEAD>
		<title>Nursery - Working Account Details</title>
	...
	<body>
        ...
        <td style="width: 100%; height: 800px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma">
				<tr>
					<td class="font9Tahoma" colspan="3"><strong>NURSERY - WORKING ACCOUNT DETAILS</strong> </td>
				...
				<tr>
					<td colspan="6"><asp:Label id="lblDate" forecolor=red visible="false" text="Incorrect Date Format. Date Format is " runat="server" />
									...
									<asp:Label id="lblErrAccYear" forecolor=red visible="false" text="Accounting Year from cannot be bigger than Accounting Year To." runat="server" />
									<asp:Label id="lblErrAccCode" forecolor=red visible="false" text="Distribution Account cannot leave blank." runat="server" /></td>
				</tr>
				<tr>
					<td colspan="6">&nbsp;</td>
				</tr>		
			...
			<table width=100% border="0" cellspacing="1" cellpadding="1" ID="Table2" class="font9Tahoma" runat=server>	
				...
				<tr>
					...
					<td><asp:textbox id="txtAccCode" maxlength=32 width="50%" runat="server" /></td>
					<td><asp:Label id="lblXmlAccCode" visible="false" runat="server" /></td>
					<td>&nbsp;</td>					
				</tr>
				<tr>
