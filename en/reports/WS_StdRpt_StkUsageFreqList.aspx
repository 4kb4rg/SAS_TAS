<%@ Page Language="vb" src="../../include/reports/WS_StdRpt_StkUsageFreqList.aspx.vb" Inherits="WS_StdRpt_StkUsageFreqList" %>
...
<HTML>
	<HEAD>
		<title>Workshop - Workshop Stock Usage Frequency Listing</title>
	...
	<body>
        ...
        <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma">
				<tr>
					<td class="font9Tahoma" colspan="3">WORKSHOP - WORKSHOP STOCK USAGE FREQUENCY LISTING</td>
			...
			<table width=100% border="0" cellspacing="1" cellpadding="1" ID="Table2" class="font9Tahoma">
				...
				<tr>
					<td width=15%>Last Issue Date From :</td>
					<td width=35%><asp:TextBox id="txtLastIssDateFrom" size="12" width=50% maxlength="10" runat="server"/>
  								  <a href="javascript:PopCal('txtLastIssDateFrom');">
  								  <asp:Image id="btnSelDateFrom" runat="server" ImageUrl="../Images/calendar.gif"/></a></td>						
					<td width=15%>To :</td>
					<td width=35%><asp:TextBox id="txtLastIssDateTo" size="12" width=50% maxlength="10" runat="server"/>
  								  <a href="javascript:PopCal('txtLastIssDateTo');">
  								  <asp:Image id="btnSelDateTo" runat="server" ImageUrl="../Images/calendar.gif"/></a></td>										
				</tr>	
				<tr>
					<td>Sort By :</td>
					<td><asp:dropdownlist id="lstSortBy" width="30%" runat="server" /></td>
					<td>&nbsp;</td>
					<td>&nbsp;</td>				
				</tr>				
				<tr>
					<td>Order By :</td>
					<td><asp:dropdownlist id="lstOrderBy" width="30%" runat="server" >
				...
				<tr>
					<td>Stock Issue : </td>
					<td><asp:RadioButton id="rbIssAll" text="All" checked="true" GroupName="rbIss" runat="server" />&nbsp;&nbsp;&nbsp;			
						<asp:RadioButton id="rbIss" text="Issued" GroupName="rbIss" runat="server" />&nbsp;&nbsp;&nbsp;	
						<asp:RadioButton id="rbNIss" text="Not Issued" GroupName="rbIss" runat="server" /></td>
				<td>&nbsp;</td>
					<td>&nbsp;</td>								
				</tr>																				
				<tr>
