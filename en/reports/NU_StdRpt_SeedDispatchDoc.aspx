<%@ Page Language="vb" src="../../include/reports/NU_StdRpt_SeedDispatchDoc.aspx.vb" Inherits="NU_StdRpt_SeedDispatchDoc" %>
...
<HTML>
	<HEAD>
		<title>Nursery - Seedlings Dispatch Document</title>
	...
	<body>
        ...
        <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma">
				<tr>
					<td class="font9Tahoma" colspan="3"><strong>NURSERY - SEEDLINGS DISPATCH DOCUMENT</strong> </td>
