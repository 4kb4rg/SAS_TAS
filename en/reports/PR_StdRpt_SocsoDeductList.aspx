<%@ Page Language="vb" src="../../include/reports/PR_StdRpt_SocsoDeductList.aspx.vb" Inherits="PR_StdRpt_SocsoDeductList" %>
...
<HTML>
	<HEAD>
		<title>Payroll - Socso Deduction Listing</title>
	...
	<body>
		<form runat="server" ID="frmMain">
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1">
				<tr>
					<td class="mt-h">PAYROLL - SOCSO DEDUCTION LISTING</td>
			...
			<table width="100%" border="0" cellspacing="1" cellpadding="1" ID="Table2" runat="server">
				...
				<tr>
					<td >Suppress Zero Socso Amount : </td>
