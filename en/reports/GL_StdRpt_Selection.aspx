<%@ Page Language="vb" AutoEventWireup="false" src="../../include/reports/GL_StdRpt_Selection.aspx.vb" Inherits="GL_StdRpt_Selection" %>
	...
	<body>
		...
		<tr>
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma">
				<tr>
					<td  colspan="3"><strong> GENERAL LEDGER - STANDARD REPORTS</strong> </td>
