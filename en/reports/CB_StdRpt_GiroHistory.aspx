<%@ Page Language="vb" src="../../include/reports/CB_StdRpt_GiroHistory.aspx.vb" Inherits="CB_StdRpt_GiroHistory" %>
...
<HTML>
	<HEAD>
		<title>Cash And Bank - Giro/Cheque History</title>
		...
		<tr>
           <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma">
				<tr>
					<td class="font9Tahoma" colspan="3"><strong> CASH AND BANK - GIRO/CHEQUE HISTORY</strong></td>
			...
			<table width=100% border="0" cellspacing="1" cellpadding="1" ID="Table2" class="font9Tahoma" runat=server>	
			    ...
			    <tr>
					<td>Doc Type :</td>
					<td><asp:DropDownList width=50% id=ddlDocType runat=server>
				...
				<tr>
					<td colspan="3">
                       <asp:CheckBox id="cbUsed" text=" Used" checked="true" runat="server" /></td>
				</tr>
			    <tr>
					<td colspan="3">
