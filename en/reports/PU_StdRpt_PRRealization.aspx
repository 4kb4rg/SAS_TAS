<%@ Page Language="vb" src="../../include/reports/PU_StdRpt_PRRealization.aspx.vb" Inherits="PU_StdRpt_PRRealization" %>
...
<HTML>
	<HEAD>
		<title>Inventory - Purchase Request And Realization Report</title>
	...
	<body>
        ...
        <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma">
				<tr>
					<td class="font9Tahoma" colspan="3"><strong>PURCHASING - PURCHASE REQUEST AND REALIZATION</strong> </td>
			...
			<table width=100% border="0" cellspacing="1" cellpadding="1" ID="Table1" class="font9Tahoma">
				<tr>
					<td width=17%>PR No From :</td>
					<td width=39%><asp:textbox id="txtPRNoFrom" width="50%" runat="server" /> (blank for all)</td>
					<td width=4%>To :</td>
					<td width=40%><asp:textbox id="txtPRNoTo" width="50%" runat="server" /> (blank for all)</td>
				</tr>
				<tr>
					<td>PR Type :</td>
