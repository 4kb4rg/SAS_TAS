<%@ Page Language="vb" Src="../../include/reports/IN_StdRpt_MthInvUtilByBlockListPreview.aspx.vb" Inherits="IN_StdRpt_MthInvUtilByBlock_Preview" %>
...
<HTML>
	<HEAD>
		<title><asp:label id=lblTitle text="Inventory - Monthly Inventory Utilisation by " runat=server /></title>
