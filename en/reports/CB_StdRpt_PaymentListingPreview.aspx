<%@ Page Language="vb" EnableViewState="false" Src="../../include/reports/CB_StdRpt_PaymentListingPreview.aspx.vb" Inherits="CB_StdRpt_PaymentListing_Preview" %>
...
<HTML>
	<HEAD>
		<title>Cash And Bank - Payment Listing</title>
	</HEAD>
