<%@ Page Language="vb" EnableViewState="false" Src="../../include/reports/CB_StdRpt_CashTransferListPreview.aspx.vb" Inherits="CB_StdRpt_CashTransferList_Preview" %>
...
<HTML>
	<HEAD>
		<title>Cash And Bank - Cash Transfer Listing</title>
	</HEAD>
