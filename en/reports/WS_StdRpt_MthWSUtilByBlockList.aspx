<%@ Page Language="vb" src="../../include/reports/WS_StdRpt_MthWSUtilByBlockList.aspx.vb" Inherits="WS_StdRpt_MthWSUtilByBlockList" %>
...
<HTML>
	<HEAD>
		<title>Workshop - Monthly Workshop Stock Utilisation </title>
	...
	<body>
        ...
        <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1">
				<tr>
					<td class="font9Tahoma" colspan="3"><asp:label id=lblHeader text="WORKSHOP - MONTHLY WORKSHOP STOCK UTILISATION " runat=server /></td>
