<%@ Page Language="vb" src="../../include/reports/CB_StdRpt_OfficialReceipt.aspx.vb" Inherits="CB_StdRpt_OfficialReceipt" %>
...
<HTML>
	<HEAD>
		<title>Cash And Bank - Official Receipt</title>
		...
		<tr>
           <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma">
				<tr>
					<td class="font9Tahoma" colspan="3"><strong>CASH AND BANK - OFFICIAL RECEIPT</strong> </td>
