<%@ Page Language="vb" src="../../include/reports/PM_StdRpt_CPOPropertiesMasterList.aspx.vb" Inherits="PM_StdRpt_CPOPropertiesMasterList" %>
...
<HTML>
	<HEAD>
		<title>PRODUCTION MANAGEMENT - CPO PROPERTIES MASTER LISTING</title>
	...
	<body>
		<form runat="server" class="main-modul-bg-app-list-pu" ID="frmMain">	
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma">
				<tr>
					<td class="font9Tahoma" colspan="3">PRODUCTION MANAGEMENT - CPO PROPERTIES MASTER LISTING</td>
