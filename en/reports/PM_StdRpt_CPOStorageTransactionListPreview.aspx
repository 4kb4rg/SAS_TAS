<%@ Page Language="vb" Src="../../include/reports/PM_StdRpt_CPOStorageTransactionListPreview.aspx.vb" Inherits="PM_StdRpt_CPOStorageTransactionList_Preview" %>
...
<HTML>
	<HEAD>
		<title>Mill Production - CPO Storage Transaction Listing</title>
