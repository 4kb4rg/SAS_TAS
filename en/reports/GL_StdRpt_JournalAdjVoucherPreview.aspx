<%@ Page Language="vb" Src="../../include/reports/GL_StdRpt_JournalAdjVoucherPreview.aspx.vb" Inherits="GL_StdRpt_JournalAdjVourcherPreview" %>
			...
			<table align=center id="tblCrystal" runat="server">
				...
				<tr>
					<td>
						...
						<asp:Label id=lblNoRecord visible=false forecolor=red text="The report contained no data from the criteria given." runat=server />
					</td>
				</tr>
			</table>
		</form>
