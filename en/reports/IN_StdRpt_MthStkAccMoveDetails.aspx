<%@ Page Language="vb" src="../../include/reports/IN_StdRpt_MthStkAccMoveDetails.aspx.vb" Inherits="IN_StdRpt_MthStkAccMoveDetails" %>
...
<HTML>
	<HEAD>
		<title>Inventory - Monthly Stock Account Movement Details</title>
	...
	<body>
        ...
        <td style="width: 100%; height: 800px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma">
				<tr>
					<td class="font9Tahoma" colspan="3"><strong>INVENTORY - MONTHLY STOCK ACCOUNT MOVEMENT DETAILS</strong> </td>
			...
			<table width=100% border="0" cellspacing="0" cellpadding="1" ID="Table2" class="font9Tahoma" runat=server>
				...
				<tr>
					...
					<td><asp:textbox id="txtAccCode" maxlength=32 width="50%" runat="server" /> 
					 <input type=button value=" ... " id="FindAcc" onclick="javascript:PopCOA('frmMain', '', 'txtAccCode', 'False');" CausesValidation=False runat=server />  
					(blank for all)</td>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
				</tr>
