<%@ Page Language="vb" src="../../include/reports/CT_StdRpt_CanteenReturnListing.aspx.vb" Inherits="CT_StdRpt_CanteenReturnListing" %>
...
<HTML>
	<HEAD>
		<title>Canteen - Canteen Return Listing</title>
		...
		<tr>
           <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma">
				<tr>
					<td class="font9Tahoma" colspan="3">CANTEEN - CANTEEN RETURN LISTING</td>
			...
			<table width=100% border="0" cellspacing="1" cellpadding="1" ID="Table2" runat=server>
				<tr>
					<td width=17%>Canteen Return ID From :</td>
					<td width=39%><asp:textbox id="txtCanteenReturnIDFrom" maxlength=20 width="50%" runat="server" /> (blank for all)</td>
					<td width=4%>To :</td>
					<td width=40%><asp:textbox ID="txtCanteenReturnIDTo" maxlength=20 width="50%" Runat=server /> (blank for all)</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><asp:textbox id="txtBillPartyCode" maxlength=20 width="50%" runat="server" /> (blank for all)</td>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
				</tr>
				<tr>
