<%@ Page Language="vb" src="../../include/reports/IN_StdRpt_StkUsageFreqList.aspx.vb" Inherits="IN_StdRpt_StkUsageFreqList" %>
...
<HTML>
	<HEAD>
		<title>Inventory - Stock Usage Frequency Listing</title>
	...
	<body>
        ...
        <td style="width: 100%; height: 800px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma">
				<tr>
					<td class="="font9Tahoma" colspan="3"><strong> INVENTORY - STOCK USAGE FREQUENCY LISTING</strong></td>
