<%@ Page Language="vb" src="../../include/reports/GL_StdRpt_RincianBiayaPanenPerThnTanam.aspx.vb" Inherits="GL_StdRpt_RincianBiayaPanenPerThnTanam" %>
...
<HTML>
	<HEAD>
		<title>General Ledger - Managerial Report (Rincian Biaya Panen Per Tahun Tanam)</title>
		...
		<tr>
           <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma">
				<tr>
					<td class="font9Tahoma" colspan="3"><strong>GENERAL LEDGER - MANAGERIAL REPORT (RINCIAN BIAYA PANEN PER TAHUN TANAM)</strong> </td>
