<%@ Page Language="vb" src="../../include/reports/PR_StdRpt_bukumandor_Estate.aspx.vb" Inherits="PR_StdRpt_bukumandor_Estate" %>
...
<HTML>
	<HEAD>
		<title>Estate - Buku Mandor</title>
	...
	<body>
        ...
        <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1">
				<tr>
					<td class="font9Tahoma" colspan="3"><strong> BUKU MANDOR/KCS</strong></td>
			...
			<tr>
				...
				<tr>
					<td width=17%>
                        Tanggal :</td>
					<td width=39%>
                        <asp:TextBox ID="txtFromTrxDate" runat="server" MaxLength="30" Width="35%"></asp:TextBox>
                        <a href="javascript:PopCal('txtFromTrxDate');"><asp:Image ID="btnFrom" runat="server" ImageUrl="../Images/calendar.gif" /></a>
                        s/d
                        <asp:TextBox ID="txtToTrxDate" runat="server" MaxLength="30" Width="35%"></asp:TextBox>
                        <a href="javascript:PopCal('txtToTrxDate');"><asp:Image ID="btnTo" runat="server" ImageUrl="../Images/calendar.gif" /></a>&nbsp;
					</td>					
					<td width=4%></td>	
					<td width=40%></td>					
				</tr>
