<%@ Page Language="vb" AutoEventWireup="false" src="../../include/reports/FA_StdRpt_Selection.aspx.vb" Inherits="FA_StdRpt_Selection" %>
...
<HTML>
	<HEAD>
		<title>Fixed Asset Standard Reports</title>
		...
		<tr>
           <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma">
				<tr>
					<td class="font9Tahoma" colspan="3"><strong> FIXED ASSET STANDARD REPORTS</strong></td>
