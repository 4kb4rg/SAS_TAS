<%@ Page Language="vb" src="../../include/reports/AR_StdRpt_DebtorAccountAgeing.aspx.vb" Inherits="AR_StdRpt_DebtorAccountAgeing" %>
...
<HTML>
	<HEAD>
		<title>Account Receivables - Debtor Acccount Ageing</title>
		...
		<tr>
           <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" class="font9Tahoma" ID="Table1">
				<tr>
					<td class="font9Tahoma" colspan="3"><strong> ACCOUNT RECEIVABLES - DEBTOR ACCOUNT AGEING</strong></td>
			...
			<table width=100% border="0" cellspacing="2" cellpadding="1" ID="Table2" class="font9Tahoma" runat=server>
				...
				<tr>
					...
					<td width=39%><asp:textbox id=txtBuyer maxlength=128 width=50% runat=server runat=server /></td>
					<td colspan=2>&nbsp;</td>
				</tr>
				<tr>
					<td width=17%><asp:label id=lblAccCode runat=server /> : </td>
					<td width=39%><asp:textbox id=txtAccCode maxlength=32 width=50% runat=server runat=server /></td>
					<td colspan=2>&nbsp;</td>
				</tr>
				<tr>
