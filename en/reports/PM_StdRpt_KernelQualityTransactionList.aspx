<%@ Page Language="vb" src="../../include/reports/PM_StdRpt_KernelQualityTransactionList.aspx.vb" Inherits="PM_StdRpt_KernelQualityTransactionList" %>
...
<HTML>
	<HEAD>
		<title>Production Management - Kernel Quality Transaction Listing</title>
	...
	<body>
        ...
        <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma">
				<tr>
					<td class="mt-h" colspan="3">PRODUCTION MANAGEMENT - KERNEL QUALITY TRANSACTION LISTING</td>
			...
			<table width="100%" border="0" cellspacing="1" cellpadding="1" ID="Table1" class="font9Tahoma">
				<tr>
					...
					<td>To : </td>
					<td><asp:TextBox id="txtDateTo" maxlength="10" width="50%" runat="server"/>
  					    <a href="javascript:PopCal('txtDateTo');">
						<asp:Image id="btnSelDateTo" runat="server" ImageUrl="../Images/calendar.gif"/></a></td>
				</tr>
				<tr>
					<td width=17%>Processing Line No :</td>
					<td width=39%><asp:DropDownList id="ddlProcessingLnNo" runat="server" width="50%"/>                       
						<asp:RequiredFieldValidator 
							id="rfvProcessingLnNo" 
							runat="server"  
							ControlToValidate="ddlProcessingLnNo" 
