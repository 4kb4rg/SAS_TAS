<%@ Page Language="vb" src="../../include/reports/GL_StdRpt_CostLedgerSummary.aspx.vb" Inherits="GL_StdRpt_CostLedgerSummary" %>
...
<HTML>
	<HEAD>
		<title>General Ledger - Monthly Cost Ledger Summary</title>
		...
		<tr>
           <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma">
				<tr>
					<td class="font9Tahoma" colspan="3"><strong>GENERAL LEDGER - MONTHLY COST LEDGER SUMMARY</strong> </td>
			...
			<table width=100% border="0" cellspacing="2" cellpadding="1" ID="Table2" class="font9Tahoma" runat=server>	
				<tr>
					<td><asp:label id="lblActivity" runat="server" /> Type :</td>
					<td colspan=2>
						<asp:DropDownList id="ddlActType" AutoPostBack=true width="25%" runat="server" />
					</td>
				</tr>
				<tr id=TrActGrp>
					<td valign=top><asp:label id="lblActGrpCode" runat="server" /> :</td>
					<td colspan=2>
						<table width=30% cellpadding=0 cellspadding=0>
							<tr>
								<td valign=top>
									<asp:CheckBox text=All id="cbActGrpAll" OnCheckedChanged=Check_Clicked AutoPostBack=true runat=server />
								</td>
								<td valign=top>
									<asp:CheckBoxList id="cblActGrp" OnSelectedIndexChanged=ActGrpCheckList AutoPostBack=True RepeatColumns="5" RepeatDirection="Horizontal" runat=server />
								</td>			
							</tr>
						</table>
					</td>												
				...
				<tr id=TrAct>
					<td width=25%><asp:label id="lblActCode" runat="server" /> : </td>
					<td colspan=2>
						<asp:TextBox id="txtSrchActCode" width="25%" runat="server"/> (blank for all)
					</td>			
				</tr>
				<tr>
				...
				<tr>
					<td width=25%><asp:label id="lblExpenseCode" runat="server" /> : </td>  
					<td colspan=2>
						<asp:TextBox id="txtSrchExpCode" width="25%" runat="server"/> (blank for all)
					</td>			
				</tr>
				<tr>
