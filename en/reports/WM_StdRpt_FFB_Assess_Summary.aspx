<%@ Page Language="vb" trace=false src="../../include/reports/WM_StdRpt_FFB_Assess_Summary.aspx.vb" Inherits="WM_StdRpt_FFB_Assess_Sum" %>
...
<HTML>
	<HEAD>
		<title>Weighing Management - FFB Assessment Summary</title>
	...
	<body>
        ...
        <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma">
				<tr>
					<td class="font9Tahoma" colspan="3">WEIGHING MANAGEMENT - FFB ASSESSMENT SUMMARY</td>
