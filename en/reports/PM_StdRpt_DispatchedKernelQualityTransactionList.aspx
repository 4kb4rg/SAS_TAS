<%@ Page Language="vb" src="../../include/reports/PM_StdRpt_DispatchedKernelQualityTransactionList.aspx.vb" Inherits="PM_StdRpt_DispatchedKernelQualityTransactionList" %>
...
<HTML>
	<HEAD>
		<title>Production Management - Dispatched Kernel Quality Transaction Listing</title>
	...
	<body>
        ...
        <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1"  class="font9Tahoma">
				<tr>
					<td class="font9Tahoma" colspan="3">PRODUCTION MANAGEMENT - DISPATCHED KERNEL QUALITY TRANSACTION LISTING</td>
