<%@ Page Language="vb" Src="../../include/reports/CT_StdRpt_CanteenReturnListingPreview.aspx.vb" Inherits="CT_StdRpt_CanteenReturnListing_Preview" %>
	...
	<body MS_POSITIONING="GridLayout" onload="this.focus()" >
		<form id="frmMain" method="post" runat="server">
			<table align=center id="tblCrystal" runat="server">
				...
				<tr>
					<td>
						<asp:datagrid id="dgDebug" AutoGenerateColumns="true" width="100%" runat="server" />		
					</td>
				</tr>
			</table>
		</form>
