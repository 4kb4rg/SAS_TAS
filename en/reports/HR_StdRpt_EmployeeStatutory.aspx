<%@ Page Language="vb" src="../../include/reports/HR_StdRpt_EmployeeStatutory.aspx.vb" Inherits="HR_StdRpt_EmployeeStatutory" %>
...
<HTML>
	<HEAD>
		<title>Human Resource - Employee Statutory </title>
	...
	<body>
        ...
        <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma">
				<tr>
					<td class="font9Tahoma" colspan="3"><strong> HUMAN RESOURCE - EMPLOYEE STATUTORY</strong></td>
