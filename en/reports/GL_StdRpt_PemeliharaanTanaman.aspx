<%@ Page Language="vb" src="../../include/reports/GL_StdRpt_PemeliharaanTanaman.aspx.vb" Inherits="GL_StdRpt_PemeliharaanTanaman" %>
...
<HTML>
	<HEAD>
		<title>General Ledger - Managerial Report (Pemeliharaan Tanaman Menghasilkan)</title>
		...
		<tr>
           <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1">
				<tr>
					<td class="font9Tahoma" colspan="3"><strong>GENERAL LEDGER - MANAGERIAL REPORT (PEMELIHARAAN TANAMAN MENGHASILKAN)</strong> </td>
			...
			<table width=100% border="0" cellspacing="2" cellpadding="1" ID="Table2" class="font9Tahoma" =server>
				<tr>
				...
				<tr>
					...
					<td colspan=2>
						<asp:textbox id="txtRemark" width="100%" runat="server"/>
					</td>			
				</tr>
