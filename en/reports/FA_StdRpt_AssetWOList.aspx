<%@ Page Language="vb" src="../../include/reports/FA_StdRpt_AssetWOList.aspx.vb" Inherits="FA_StdRpt_AssetWOList" %>
...
<HTML>
	<HEAD>
		<title>Fixed Asset - Asset Write Off Listing</title>
		...
		<tr>
           <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma">
				<tr>
					<td class="font9Tahoma" colspan="3"><strong> FIXED ASSET - ASSET WRITE OFF LISTING</strong></td>
