<%@ Page Language="vb" src="../../include/reports/PU_StdRpt_PelimpahanList.aspx.vb" Inherits="PU_StdRpt_PelimpahanList" %>
...
<HTML>
	<HEAD>
		<title>Purchasing - Pelimpahan Listing</title>
	...
	<body>
        ...
        <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma">
				<tr>
					<td class="font9Tahoma" colspan="3"><strong> PURCHASING - PELIMPAHAN LISTING</strong></td>
			...
			<table width=100% border="0" cellspacing="1" cellpadding="1" ID="Table2" class="font9Tahoma" runat=server>	
				...
				<tr>
					<td><asp:label id=lblPelimpahanType text="Pelimpahan Type : " runat=server /> </td>
					<td><asp:DropDownList id="lstPelimpahanType" width="50%" runat="server" /></td>
					<td>&nbsp;</td>
					<td>&nbsp;</td>									
				</tr>			
				<tr>
					<td width=15%>Pelimpahan Status :</td>
