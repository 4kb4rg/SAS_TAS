<%@ Page Language="vb" src="../../include/reports/BD_StdRpt_FFBProductionDet.aspx.vb" Inherits="BD_StdRpt_FFBProductionDet" %>
...
<HTML>
	<HEAD>
		<title>Budgeting - FFB Production Budget Details</title>
		...
		<tr>
           <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma">
				<tr>
					<td class="font9Tahoma" colspan="3"><strong> BUDGETING - FFB PRODUCTION BUDGET DETAILS</strong></td>
