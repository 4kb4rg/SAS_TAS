<%@ Page Language="vb" AutoEventWireup="false" src="../../include/reports/BD_StdRpt_Selection.aspx.vb" Inherits="BD_StdRpt_Selection" %>
...
<HTML>
	<HEAD>
		<title>Budgeting - Standard Reports</title>
		...
		<tr>
           <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1"  class="font9Tahoma">
				<tr>
					<td class="font9Tahoma" colspan="3"><strong> BUDGETING - STANDARD REPORTS</strong></td>
