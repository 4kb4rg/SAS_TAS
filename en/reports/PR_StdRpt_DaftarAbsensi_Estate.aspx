<%@ Page Language="vb" src="../../include/reports/PR_StdRpt_DaftarAbsensi_Estate.aspx.vb" Inherits="PR_StdRpt_DaftarAbsensi_Estate" %>
<%@ Register TagPrefix="Preference" Tagname="PrefHdl" src="../include/preference/preference_handler.ascx"%>
<%@ Register TagPrefix="UserControl" Tagname="PR_STDRPT_SELECTION_CTRL" src="../include/reports/PR_StdRpt_Selection_Ctrl_Estate.ascx"%><HTML>
	<HEAD>
			...
			<table width=100% border="0" cellspacing="1" cellpadding="1" ID="Table2" class="font9Tahoma" runat=server>	
                ...
                <tr>
                    <td width="17%">
                        Tipe Karyawan</td>
                    <td width="39%">
                        <GG:AutoCompleteDropDownList ID="ddlemptype" runat="server" Width="30%">
                ...
                <tr>
                    <td width="17%">
                        Tipe Report</td>
                    <td width="39%">
                        <GG:AutoCompleteDropDownList ID="ddlrpttype" runat="server" Width="30%">
