<%@ Page Language="vb" src="../../include/reports/HR_StdRpt_EmployeeCP.aspx.vb" Inherits="HR_StdRpt_EmployeeCP" %>
...
<HTML>
	<HEAD>
		<title>Human Resource - Employee Career Progress </title>
	...
	<body>
        ...
        <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma">
				<tr>
					<td class="font9Tahoma" colspan="3"><strong>HUMAN RESOURCE - <asp:label id="lblTitle" runat="server" /></strong> </td>
