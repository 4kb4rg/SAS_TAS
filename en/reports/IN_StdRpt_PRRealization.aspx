<%@ Page Language="vb" src="../../include/reports/IN_StdRpt_PRRealization.aspx.vb" Inherits="IN_StdRpt_PRRealization" %>
	...
	<body>
        ...
        <td style="width: 100%; height: 800px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma">
				<tr>
					<td class="font9Tahoma" colspan="3"><strong>INVENTORY - PURCHASE REQUEST AND REALIZATION</strong> </td>
			...
			<table width=100% border="0" cellspacing="1" cellpadding="1" ID="Table1" class="font9Tahoma">
				<tr>
					<td>PR No From :</td>
					<td><asp:textbox id="txtPRNoFrom" width="50%" runat="server" /> (blank for all)</td>
					<td>To :</td>
					<td><asp:textbox id="txtPRNoTo" width="50%" runat="server" /> (blank for all)</td>
				</tr>
				<tr>
					<td>PR Type :</td>
