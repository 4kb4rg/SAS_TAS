<%@ Page Language="vb" src="../../include/reports/CB_StdRpt_PosisiDeposito.aspx.vb" Inherits="CB_StdRpt_PosisiDeposito" %>
...
<HTML>
	<HEAD>
		<title>Cash And Bank - Posisi Deposito</title>
		...
		<tr>
           <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma">
				<tr>
					<td class="font9Tahoma" colspan="3"><strong>CASH AND BANK - POSISI DEPOSITO</strong> </td>
			...
			<table width=100% border="0" cellspacing="1" cellpadding="1" ID="Table2" class="font9Tahoma" runat=server>	
				...
				<tr>
					<td>Criteria :</td>
					<td>
					   <asp:RadioButton id="rbPro1" runat="server" Text="Per Bank - Pertanggal" GroupName="pro" Checked="True"></asp:RadioButton>				
					</td>
					<td>&nbsp;</td>
					<td>&nbsp;</td>					
				</tr>
				<tr>
					<td></td>
					<td>
					   <asp:RadioButton id="rbPro2" runat="server" Text="Pertanggal jatuh tempo" GroupName="pro"  ></asp:RadioButton>				
					</td>
