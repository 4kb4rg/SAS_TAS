<%@ Page Language="vb" src="../../include/reports/FA_StdRpt_AssetDeprList.aspx.vb" Inherits="FA_StdRpt_AssetDeprList" %>
...
<HTML>
	<HEAD>
		<title>Fixed Asset - Asset Depreciation Listing</title>
		...
		<tr>
           <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma">
				<tr>
					<td class="font9Tahoma" colspan="3"><strong> FIXED ASSET - ASSET DEPRECIATION LISTING</strong></td>
			...
			<table width=100% border="0" cellspacing="1" cellpadding="1" ID="Table2" class="font9Tahoma" runat=server>	
				<tr>
					<td><asp:label id=lblTxID runat=server /> ID From :</td>
				...
				<tr>
					<td>Reference No :</td>
					<td><asp:textbox id="txtRefNo" maxlength=32 width="50%" runat="server" /> (blank for all)</td>
					<td>&nbsp;</td>
					<td>&nbsp;</td>					
				</tr>
				<tr>
					<td><asp:label id=lblAssetHeaderCode runat=server /> Code:</td>
					<td><asp:textbox id="txtAssetHeaderCode" maxlength=8 width="50%" runat="server" /> (blank for all)</td>
					<td>&nbsp;</td>
					<td>&nbsp;</td> 					
				</tr> 
				<tr>
					<td><asp:label id=lblAssetCode runat=server /> Code:</td>
					<td><asp:textbox id="txtAssetCode" maxlength=32 width="50%" runat="server" /> 
					<input type=button value=" ... " id="Find" onclick="javascript:PopFA('frmMain', '', 'txtAssetCode', 'False');" CausesValidation=False runat=server />  
					(blank for all)</td>
					<td>&nbsp;</td>
					<td>&nbsp;</td> 					
				</tr> 
				<tr>
					<td><asp:label id=lblDeprGLDeprAccCode runat=server /> Code:</td>
					<td><asp:textbox id="txtDeprGLDeprAccCode" maxlength=32 width="50%" runat="server" /> 
					<input type=button value=" ... " id="Find1" onclick="javascript:PopCOA('frmMain', '', 'txtDeprGLDeprAccCode', 'False');" CausesValidation=False runat=server />  
				...
				<tr>
					<td><asp:label id=lblDeprGLAccumDeprAccCode runat=server /> Code:</td>
					<td><asp:textbox id="txtDeprGLAccumDeprAccCode" maxlength=32 width="50%" runat="server" /> 
					<input type=button value=" ... " id="Find2" onclick="javascript:PopCOA('frmMain', '', 'txtDeprGLAccumDeprAccCode', 'False');" CausesValidation=False runat=server />  
					(blank for all)</td>
					<td>&nbsp;</td>
					<td>&nbsp;</td> 					
				</tr> 
				...
				<tr>
					<td width=15%>Tipe Depresiasi :</td>
					<td width=35%><asp:DropDownList id="lstDeprType" size="1" width="50%" runat="server" /></td>
					<td width=15%>&nbsp;</td>
					<td width=35%>&nbsp;</td>
				</tr>
