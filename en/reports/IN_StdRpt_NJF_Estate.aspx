<%@ Page Language="vb" src="../../include/reports/IN_StdRpt_NJF_Estate.aspx.vb" Inherits="IN_StdRpt_NJF_Estate" %>
...
<HTML>
	<HEAD>
		<title>Inventory - Compare Issue & Receive</title>
	...
	<body>
        ...
        <td style="width: 100%; height: 800px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma">
				<tr>
					<td class="font9Tahoma" colspan="3"><strong>INVENTORY - Compare Issue & Receive</strong> </td>
			...
			<tr>
				...
				<tr>
					...
					<td width=39%><asp:DropDownList id="ddlcat" width="30%" runat=server>
										<asp:ListItem value="1">Goods/Stock Receive</asp:ListItem>
										<asp:ListItem value="2">Stock Issue + Return</asp:ListItem>
