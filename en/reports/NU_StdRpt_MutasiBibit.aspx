<%@ Page Language="vb" src="../../include/reports/NU_StdRpt_MutasiBibit.aspx.vb" Inherits="NU_StdRpt_MutasiBibit" %>
...
<HTML>
	<HEAD>
		<title>Nursery - Mutasi Bibit</title>
	...
	<body>
        ...
        <td style="width: 100%; height: 800px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma">
				<tr>
					<td class="font9Tahoma" colspan="3"><strong>NURSERY - MUTASI BIBIT</strong> </td>
