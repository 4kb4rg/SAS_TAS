<%@ Page Language="vb" src="../../include/reports/CB_StdRpt_MutasiBank.aspx.vb" Inherits="CB_StdRpt_MutasiBank" %>
...
<HTML>
	<HEAD>
		<title>Cash And Bank - Mutasi Bank</title>
		...
		<tr>
           <td style="width: 100%; height: 1500px" valign="top">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" ID="Table1" class="font9Tahoma">
				<tr>
					<td class="font9Tahoma" colspan="3"><strong> CASH AND BANK - MUTASI BANK </strong></td>
				...
				<tr>
					...
					<td>
					   <asp:DropDownList id="ddlType"  width="50%" runat="server"> 
						  ...
						  <asp:ListItem value="2">OtherParty</asp:ListItem>
					   </asp:DropDownList>					
					</td>
					<td>&nbsp;</td>
					<td>&nbsp;</td>					
