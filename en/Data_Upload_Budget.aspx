						...
						<td colspan="2" style="height: 99px" valign="top">
                            ...
                            <table border="0" cellpadding="0" cellspacing="0">
                                ...
                                ImageUrl="images/butt_cancel.gif" OnClick="CancelBtn_Click" UseSubmitBehavior="false" />
                                        <br />
				    <asp:Button ID="btnProceed2" runat="server" class="button-small" Text="Upload" Width="70px" />
				    <asp:Button ID="btnProceed3" runat="server" class="button-small" Text="Save" Width="70px" />
				    <asp:Button ID="btnProceed4" runat="server" class="button-small" Text="Cancel" Width="58px" />
                                        <br />
                                    </td>
                                ...
                                ImageUrl="images/butt_cancel.gif" OnClick="CancelBtnPD_Click" 
                                            UseSubmitBehavior="false" Width="58px" />
                                        <br />
				    <asp:Button ID="btnProceed5" runat="server" class="button-small" Text="Upload" Width="70px" />
				    <asp:Button ID="btnProceed6" runat="server" class="button-small" Text="Save" Width="70px" />
				    <asp:Button ID="btnProceed7" runat="server" class="button-small" Text="Cancel" Width="58px" />
                                        &nbsp;</td>
                                ...
                                ImageUrl="images/butt_cancel.gif" OnClick="CancelBtn_Click" UseSubmitBehavior="false" />
                                        <br />
				    <asp:Button ID="btnProceed8" runat="server" class="button-small" Text="Upload" Width="70px" />
				    <asp:Button ID="btnProceed9" runat="server" class="button-small" Text="Save" Width="70px" />
				    <asp:Button ID="btnProceed10" runat="server" class="button-small" Text="Cancel" Width="58px" />
                                        </td>
