<%@ Page Language="vb" src="../../../include/NU_Setup_ItemMaster.aspx.vb" Inherits="NU_NurseryMaster" %>
<%@ Register TagPrefix="UserControl" Tagname="MenuNUSetup" src="../../menu/menu_NUsetup.ascx"%>
<%@ Register TagPrefix="Preference" Tagname="PrefHdl" src="../../include/preference/preference_handler.ascx"%>
<html>
	<head>
		<title>Nursery Master List</title>
			...
			<tr>
				...
				<div class="kontenlist">
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						<tr>
							<td><strong>NURSERY MASTER LIST</strong><hr style="width :100%" />   
                            </td>
						...
						<tr>
							...
							<table cellpadding="4" cellspacing="0" style="width: 100%">
								...
								<td width="20%" height="26">Nursery Item Code :<BR><asp:TextBox id=srchStockCode width=100% maxlength="8" runat="server"/></td>
						    ...
						    <tr>
							    ...
							    <table cellpadding="4" cellspacing="1" style="width: 100%">
					                ...
					                <Columns>
						                <asp:HyperLinkColumn
								                HeaderText="Nursery Item Code"
								                DataNavigateUrlField="ItemCode"
								                DataNavigateUrlFormatString="NU_Setup_ItemMasterDetail.aspx?id={0}"
						...
						<tr>
							<td>
					            <asp:ImageButton id=ibNew onClick=btnNewItm_Click imageurl="../../images/butt_new.gif" AlternateText="New Nursery Item Master" runat=server/>
						        <asp:ImageButton id=ibPrint imageurl="../../images/butt_print.gif" AlternateText=Print onClick="btnPreview_Click" runat="server"/>
							</td>
						</tr>
                        <tr>
                            <td>
 					            <asp:Button ID="ibNew2" class="button-small" runat="server" Text="New Nursery Item Master"  />&nbsp;
