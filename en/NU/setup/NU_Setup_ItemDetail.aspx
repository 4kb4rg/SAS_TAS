<%@ Page Language="vb" Src="../../../include/NU_Setup_ItemDetails.aspx.vb" Inherits="NU_NurseryDetails" %>
<%@ Register TagPrefix="UserControl" Tagname="MenuNUSetup" src="../../menu/menu_NUsetup.ascx"%>
<%@ Register TagPrefix="Preference" Tagname="PrefHdl" src="../../include/preference/preference_handler.ascx"%>
<html>
<head>
    <title>NURSERY ITEM DETAILS</title>
    ...
    <form id="frmSysSetting" runat="server" class="main-modul-bg-app-list-pu">
        ...
        <table cellpadding="2" width="100%" border="0" class="font9Tahoma">
            <tbody>
				...
				<tr>
                    <td class="mt-h" colspan="6"><strong> <asp:label id="lblHead" text="NURSERY ITEM DETAILS" Runat="server"/></strong></td>
                </tr>
				<tr>
					<td colspan=6><hr style="width :100%" />   </td>
				</tr>
                <tr>
                    <td><asp:label id="Label1" text="Nursery Item Code" Runat="server"/> :*</td>
                    <td><asp:DropDownList id="lstItemCode" width=100% runat="server" AutoPostback=True OnSelectedIndexChanged=LoadItemMaster />
                        <asp:TextBox id="NUItemCode" runat="server" Visible=False width=100% maxlength="20"/>
                        <asp:RequiredFieldValidator id="validateCode" runat="server" 
							ErrorMessage="Please Enter Nursery Item Code" 
							display="dynamic" 
							ControlToValidate="NUItemCode"/>							
