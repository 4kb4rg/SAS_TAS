<%@ Page Language="vb" src="../../../include/NU_setup_AccDist.aspx.vb" Inherits="NU_setup_AccDist" %>
					...
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						...
						<tr>
							...
							<table cellpadding="4" cellspacing="0" style="width: 100%">
								...
								<td width="55%" height="26" valign=bottom><asp:label id="lblAccCode" runat="server" /> :<BR><asp:TextBox id=srchAccCode width=100% maxlength="32" runat="server"/></td>
						    ...
						    <tr>
							    ...
							    <table cellpadding="4" cellspacing="1" style="width: 100%">
					                ...
					                <Columns>
						                <asp:TemplateColumn SortExpression="AD.AccCode">
							                <ItemStyle Width="30%" />
							                <ItemTemplate>
								                <%# Container.DataItem("AccCode") %>
							                </ItemTemplate>
							                <EditItemTemplate>
								                <asp:DropDownList id="AccCode" size=1 width="95%" runat="server"/>
								                <asp:label id=lblAccCode visible=false text='<%# Container.DataItem("AccCode") %>' runat=server/>
								                <BR>
								                <asp:RequiredFieldValidator id=validateCode display=dynamic runat=server 
										                ControlToValidate=AccCode />
						                ...
						                <asp:TemplateColumn HeaderText="Last Update" SortExpression="AD.UpdateDate">
							                <ItemStyle Width="13%" />
							                <ItemTemplate>
						                ...
						                <asp:TemplateColumn HeaderText="Status" SortExpression="AD.Status">
							                <ItemStyle Width="10%" />
							                <ItemTemplate>
