<%@ Page Language="vb" src="../../../include/NU_Setup_Item.aspx.vb" Inherits="NU_NurseryItem" %>
<%@ Register TagPrefix="UserControl" Tagname="MenuNUSetup" src="../../menu/menu_NUsetup.ascx"%>
<%@ Register TagPrefix="Preference" Tagname="PrefHdl" src="../../include/preference/preference_handler.ascx"%>
<html>
	<head>
		<title>Nursery Item List</title>
	...
	<%--<Preference:PrefHdl id=PrefHdl runat="server" />--%>
		...
		<table cellpadding="0" cellspacing="0" style="width: 100%">
				<tr>
					<td colspan="6">
						<UserControl:MenuNUSetup id=menuCT runat="server" />
					</td>
				</tr>
			<tr>
				...
				<div class="kontenlist">
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						<tr>
							<td><strong>NURSERY ITEM LIST</strong><hr style="width :100%" />   
                            </td>
						...
						<tr>
							...
							<table cellpadding="4" cellspacing="0" style="width: 100%">
								...
								<td width="20%" height="26">Nursery Item Code :<BR><asp:TextBox id=srchItemCode width=100% maxlength="8" runat="server"/></td>
							    ...
							    <table cellpadding="4" cellspacing="1" style="width: 100%">
					                ...
					                <Columns>
						                <asp:HyperLinkColumn
								                ...
								                DataNavigateUrlFormatString="NU_Setup_ItemDetail.aspx?id={0}"
						...
						<tr>
							<td>
					            <asp:ImageButton id=ibNew onClick=btnNewItm_Click imageurl="../../images/butt_new.gif" AlternateText="New Nursery Item" runat=server/>
