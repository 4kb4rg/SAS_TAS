<%@ Page Language="vb" Src="../../../include/NU_trx_SeedPlantDetails.aspx.vb" Inherits="NU_trx_SeedPlantDetails" %>
<%@ Register TagPrefix="UserControl" Tagname="MenuNUTrx" src="../../menu/menu_NUtrx.ascx"%>
<%@ Register TagPrefix="Preference" Tagname="PrefHdl" src="../../include/preference/preference_handler.ascx"%>
<html>
	<head>
		<title>NURSERY - Seeds Planting Details</title>
	...
	<body>
		...
		<tr>
			...
			<table cellpadding="2" cellspacing=0 width="100%" border="0" class="font9Tahoma">
				...
				<tr>
					<td   colspan="6"><strong>SEEDS PLANTING DETAILS</strong> </td>
				</tr>
				<tr>
					<td colspan=6>
                        <hr style="width :100%" />
				...
				<tr>
					<td width="25%" height=25><asp:label id=lblTxIDTag text="Planting ID" Runat="server"/> :*</td>
