<%@ Page Language="vb" src="../../../include/NU_trx_CullList.aspx.vb" Inherits="NU_trx_CullList" %>
<%@ Register TagPrefix="UserControl" Tagname="MenuNUTrx" src="../../menu/menu_NUtrx.ascx"%>
<%@ Register TagPrefix="Preference" Tagname="PrefHdl" src="../../include/preference/preference_handler.ascx"%>

<html>
	<head>
		<title>NURSERY - Culling List</title>
			...
			<tr>
				...
				<div class="kontenlist">
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						<tr>
							<td><strong>CULLING LIST</strong><hr style="width :100%" />   
                            </td>
						...
						<tr>
							...
							<table cellpadding="4" cellspacing="0" style="width: 100%">
								...
								<td width="20%" height="26" valign=bottom>Culling ID :<BR><asp:TextBox id=srchTxID width=100% maxlength="20" runat="server"/></td>
						    ...
						    <tr>
							    ...
							    <table cellpadding="4" cellspacing="1" style="width: 100%">
						            ...
						            <asp:DataGrid id=dgTxList
							                ...
							                <Columns>
								                <asp:HyperLinkColumn
									                HeaderText="Culling ID"
									                SortExpression="CullID" 
									                DataNavigateUrlField="CullID"
									                DataNavigateUrlFormatString="NU_Trx_CullDetails.aspx?id={0}"
									                DataTextField="CullID"
								                ...
								                <asp:TemplateColumn HeaderText="Culling Type" SortExpression="CullTypeCode">
								                <ItemStyle Width="10%" />
									                <ItemTemplate>
								                ...
								                <ItemStyle Width="10%" />
									            <ItemTemplate>
										            <%# objGlobal.GetLongDate(Container.DataItem("CullDate")) %>
									            </ItemTemplate>
								                </asp:TemplateColumn>
								                ...
								                <asp:TemplateColumn HeaderText="Last Update" SortExpression="NC.UpdateDate">
								                <ItemStyle Width="10%" />
									                <ItemTemplate>
										                <%# objGlobal.GetLongDate(Container.DataItem("UpdateDate")) %>
									                </ItemTemplate>
								                </asp:TemplateColumn>
								                <asp:TemplateColumn HeaderText="Status" SortExpression="NC.Status">
								                <ItemStyle Width="10%" />
									                <ItemTemplate>
										                <%# objNUTrx.mtdGetCullStatus(Container.DataItem("Status")) %>
									                </ItemTemplate>
								                </asp:TemplateColumn>
								                <asp:TemplateColumn HeaderText="Updated By" SortExpression="NC.UpdateID">
								                <ItemStyle Width="15%" />
									                <ItemTemplate>
