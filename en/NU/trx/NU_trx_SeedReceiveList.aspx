<%@ Page Language="vb" src="../../../include/NU_trx_SeedReceiveList.aspx.vb" Inherits="NU_trx_SeedReceiveList" %>
<%@ Register TagPrefix="UserControl" Tagname="MenuNUTrx" src="../../menu/menu_NUtrx.ascx"%>
<%@ Register TagPrefix="Preference" Tagname="PrefHdl" src="../../include/preference/preference_handler.ascx"%>

<html>
	<head>
		<title>NURSERY - Seeds Receive List</title>
			...
			<tr>
				...
				<div class="kontenlist">
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						<tr>
							<td><strong>SEEDS RECEIVE LIST</strong><hr style="width :100%" />   
                            </td>
						...
						<tr>
							...
							<table cellpadding="4" cellspacing="0" style="width: 100%">
								...
								<td width="20%" height="26" valign=bottom>Receive ID :<BR><asp:TextBox id=srchTxID width=100% maxlength="20" runat="server"/></td>
						    ...
						    <tr>
							    ...
							    <table cellpadding="4" cellspacing="1" style="width: 100%">
						            ...
						            <asp:DataGrid id=dgTxList
							            ...
							            <Columns>
								            <asp:HyperLinkColumn
									            HeaderText="Receive ID"
									            SortExpression="ReceiveID" 
									            DataNavigateUrlField="ReceiveID"
									            DataNavigateUrlFormatString="NU_Trx_SeedReceiveDetails.aspx?id={0}"
									            DataTextField="ReceiveID"
								            ...
								            <asp:TemplateColumn HeaderText="Last Update" SortExpression="SR.UpdateDate">
								            <ItemStyle Width="12%" />
									            <ItemTemplate>
										            <%# objGlobal.GetLongDate(Container.DataItem("UpdateDate")) %>
									            </ItemTemplate>
								            </asp:TemplateColumn>
								            <asp:TemplateColumn HeaderText="Status" SortExpression="SR.Status">
								            <ItemStyle Width="10%" />
									            <ItemTemplate>
										            <%# objNUTrx.mtdGetSeedReceiveStatus(Container.DataItem("Status")) %>
									            </ItemTemplate>
								            </asp:TemplateColumn>
								            <asp:TemplateColumn HeaderText="Updated By" SortExpression="SR.UpdateID">
								            <ItemStyle Width="15%" />
									            <ItemTemplate>
