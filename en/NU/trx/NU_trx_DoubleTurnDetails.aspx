<%@ Page Language="vb" Src="../../../include/NU_trx_DoubleTurnDetails.aspx.vb" Inherits="NU_trx_DoubleTurnDetails" %>
<%@ Register TagPrefix="UserControl" Tagname="MenuNUTrx" src="../../menu/menu_NUtrx.ascx"%>
<%@ Register TagPrefix="Preference" Tagname="PrefHdl" src="../../include/preference/preference_handler.ascx"%>
<html>
	<head>
		<title>NURSERY - Double-Turns Details</title>
	...
	<body>
		...
		<tr>
			...
			<table cellpadding="2" cellspacing=0 width="100%" border="0" class="font9Tahoma">
				...
				<tr>
					<td  colspan="6"><strong>DOUBLE-TURNS DETAILS</strong> </td>
				</tr>
				<tr>
					<td colspan=6>
                        <hr style="width :100%" />
				...
				<tr>
					<td width="25%" height=25><asp:label id=lblTxIDTag text="Double-Turns ID" Runat="server"/> :*</td>
				...
				<tr>
					<td height=25>Double-Turns Date :*</td>
					<td>
