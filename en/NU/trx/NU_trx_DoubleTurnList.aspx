<%@ Page Language="vb" src="../../../include/NU_trx_DoubleTurnList.aspx.vb" Inherits="NU_trx_DoubleTurnList" %>
<%@ Register TagPrefix="UserControl" Tagname="MenuNUTrx" src="../../menu/menu_NUtrx.ascx"%>
<%@ Register TagPrefix="Preference" Tagname="PrefHdl" src="../../include/preference/preference_handler.ascx"%>

<html>
	<head>
		<title>NURSERY - Double-Tonne List</title>
			...
			<tr>
				...
				<div class="kontenlist">
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						<tr>
							<td><strong>DOUBLE-TONNE LIST</strong><hr style="width :100%" />   
                            </td>
						...
						<tr>
							...
							<table cellpadding="4" cellspacing="0" style="width: 100%">
								...
								<td width="20%" height="26" valign=bottom>Double-Turns ID :<BR><asp:TextBox id=srchTxID width=100% maxlength="20" runat="server"/></td>
						    ...
						    <tr>
							    ...
							    <table cellpadding="4" cellspacing="1" style="width: 100%">
						            ...
						            <asp:DataGrid id=dgTxList
							            ...
							            <Columns>
								            <asp:HyperLinkColumn
									            HeaderText="Double-Turns ID"
									            SortExpression="DoubleTurnID" 
									            DataNavigateUrlField="DoubleTurnID"
									            DataNavigateUrlFormatString="NU_Trx_DoubleTurnDetails.aspx?id={0}"
									            DataTextField="DoubleTurnID"
								            ...
								            <ItemStyle Width="10%" />
									            <ItemTemplate>
										            <%# objGlobal.GetLongDate(Container.DataItem("DoubleTurnDate")) %>
									            </ItemTemplate>
								            </asp:TemplateColumn>
								            ...
								            <asp:TemplateColumn HeaderText="Last Update" SortExpression="DT.UpdateDate">
								            <ItemStyle Width="12%" />
									            <ItemTemplate>
										            <%# objGlobal.GetLongDate(Container.DataItem("UpdateDate")) %>
									            </ItemTemplate>
								            </asp:TemplateColumn>
								            <asp:TemplateColumn HeaderText="Status" SortExpression="DT.Status">
								            <ItemStyle Width="10%" />
									            <ItemTemplate>
										            <%# objNUTrx.mtdGetDoubleTurnStatus(Container.DataItem("Status")) %>
									            </ItemTemplate>
								            </asp:TemplateColumn>
								            <asp:TemplateColumn HeaderText="Updated By" SortExpression="DT.UpdateID">
								            <ItemStyle Width="15%" />
									            <ItemTemplate>
