<%@ Page Language="vb" src="../../../include/NU_trx_PurReq.aspx.vb" Inherits="NU_PurchaseRequest" %>
...
<%--	<Preference:PrefHdl id=PrefHdl runat="server" />--%>
		...
		<table cellpadding="0" cellspacing="0" style="width: 100%">
				<tr>
					<td colspan="6">
						<UserControl:MenuNUTrx id=menuNU runat="server" />
					</td>
				</tr>
			<tr>
				...
				<div class="kontenlist">
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						            ...
						            <asp:DataGrid id="dgPRListing"
						                ...
						                <Columns>
							                <asp:HyperLinkColumn
								                ...
								                DataNavigateUrlFormatString="NU_trx_PurReq_Details.aspx?PRID={0}"
								                DataTextField="PRID"
							                ...
							                <asp:TemplateColumn HeaderText="Status" SortExpression="PR.Status">
								                <ItemTemplate>
									                <asp:label id="Status" visible="true" text=<%# objNU.mtdGetPurReqStatus(Container.DataItem("Status")) %> runat="server" />
								                </ItemTemplate>
							                </asp:TemplateColumn>
						...
						<tr>
							<td>
					            <asp:ImageButton id=Stock imageurl="../../images/butt_new.gif" AlternateText="New Nursery PR" OnClick="btnNewNurseryPR_Click" runat="server" />
					        	<asp:ImageButton id=ibPrint imageurl="../../images/butt_print.gif" AlternateText=Print visible=false/>
							</td>
						</tr>
                        <tr>
                            <td>
 					            <asp:Button ID="Stock2" class="button-small" runat="server" Text="New Nursery PR" />&nbsp;
