<%@ Page Language="vb" Src="../../../include/NU_trx_CullDetails.aspx.vb" Inherits="NU_trx_CullDetails" %>
<%@ Register TagPrefix="UserControl" Tagname="MenuNUTrx" src="../../menu/menu_NUtrx.ascx"%>
<%@ Register TagPrefix="Preference" Tagname="PrefHdl" src="../../include/preference/preference_handler.ascx"%>
<html>
	<head>
		<title>NURSERY - Culling Details</title>
      ...
      <table cellpadding="0" cellspacing="0" style="width: 100%" >
		<tr>
			...
			<table cellpadding="2" cellspacing=0 width="100%" border="0" class="font9Tahoma">
				...
				<tr>
					<td class="mt-h" colspan="6">CULLING DETAILS</td>
				</tr>
				<tr>
					<td colspan=6><hr style="width :100%" /> </td>
				</tr>				
				<tr>
					<td width="25%" height=25><asp:label id=lblTxIDTag text="Culling ID" Runat="server"/> :*</td>
				...
				<tr>
					<td height=25><asp:label id=lblCullTypeCodeTag text="Culling Type" Runat="server"/> :*</td>
					<td><asp:DropDownList id="ddlCullTypeCode" Width=100% runat=server />
						<asp:label id=lblCullTypeCodeErr Visible=False forecolor=red Runat="server" />
					</td>
					<td>&nbsp;</td>
					<td>Update By : </td>
