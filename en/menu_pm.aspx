<%@ Page Language="vb" src="../include/menu_pm.aspx.vb" Inherits="menu_pm" %>
	...
	<tr>
		...
		<table cellpadding="0" cellspacing="0" style="width: 100%; height: 0px;">
		 ...
		 <asp:Image runat="server" ID="Image1" ImageUrl="images/thumbs/btlogout.png" ToolTip="Log Off" CssClass="button" /></a>
				...
				<td class="style2" valign="center"><img height="35px" src="images/iconmm.png" width="40px" /><span class="font14">PLANT  &nbsp;MAINTENANCE &nbsp;MANAGEMENT</span></td>
				<td valign="top">
				    &nbsp;</td>
				<td valign="top">
          ...
          <igtab:UltraWebTab   ID="UltraWebTab1" runat="server" Width="100%"  Height="100%" BorderStyle="None" 
            ...
            <Tabs>
                <igtab:Tab Key="trx" DefaultImage="../images/icon1.png"  Tooltip="Transaction Application">
                    <ContentPane BorderStyle="None"   TargetUrl="menu_pmtrx.aspx"  Scrollable="Hidden">
                    </ContentPane>
                ...
                <igtab:Tab Key="stp" DefaultImage="../images/icon2.png"  Tooltip="Setup Application">
                    <ContentPane BorderStyle="None" TargetUrl="menu_pmstp.aspx" Scrollable="Hidden">
                    </ContentPane>
                ...
                <igtab:Tab Key="rpt" DefaultImage="../images/icon3.png" Tooltip="Reports Application">
                    <ContentPane BorderStyle="None" TargetUrl="menu_pmrpt.aspx" Scrollable="Hidden">
                    </ContentPane>
                ...
                <igtab:Tab key="mth" DefaultImage="../images/icon5.png"  Tooltip="Month End Processing">
                    <ContentPane BorderStyle="None" TargetUrl="menu_pmmth.aspx" Scrollable="Hidden">
                    </ContentPane>
	...
	<tr>
		...
		<table style="width: 100%; " cellpadding="0" cellspacing="0">
			<tr>
				...
				<td style="width: 100%"><span class="font14">&nbsp;&nbsp;Plant Maintenance</span></td>
				<td valign="bottom">
				<table cellpadding="0" cellspacing="0" style="width: 290px; height: 54px" align="right">
					<tr>
						<td style="width: 54px">
						<img height="54px" src="images/icon1.png" width="54px" class="button" /></td>
						<td>&nbsp;</td>
						<td style="width: 54px">
...
<%--
    ...
    <div class="BackgroundTopCornerPM"></div>--%>
<%--    </form>
</body>--%>--%>
</html>
