<%@ Page Language="vb" trace=false src="../../../include/PopUpFindFA.aspx.vb" Inherits="PopUpFindCOA" %>
...
<body onload="javascript:self.focus();onload_setfocus();" leftmargin="2" topmargin="2">
    ...
    <table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma" >
		...
		<table id="tblMain" width="100%" class="font9Tahoma" runat="server">
			<tr>
				<td width="20%" class="font9Tahoma"><strong>FIND ASSET</strong> </td>
					...
					<td colspan="2">					
						<asp:DataGrid id="dgLine" runat="server"
							...
							<AlternatingItemStyle BackColor="#EEEEEE" Font-Bold="False" 
                                ...
                                Font-Underline="False"/>	
							<Columns>
								<asp:BoundColumn Visible="False" HeaderText="Asset Code" DataField="AssetCode" />
								<asp:ButtonColumn CommandName="Select" Text="Select" ItemStyle-Width="6%" HeaderStyle-Width="6%"/>
								<asp:HyperLinkColumn HeaderText="Asset Code" ItemStyle-Width="20%" HeaderStyle-Width="20%" 
						  	...
						  	<asp:TemplateColumn HeaderText="Tgl. Perolehan" >
								<ItemStyle Width="12%" />
									<ItemTemplate>
						    ...
						    <asp:TemplateColumn HeaderText="Nilai Perolehan"  HeaderStyle-HorizontalAlign=Right ItemStyle-HorizontalAlign=Right>
							<ItemStyle Width="10%" />
							<ItemTemplate >
								<%#objGlobal.GetIDDecimalSeparator(Container.DataItem("AssetValue"))%>
							</ItemTemplate>
						    </asp:TemplateColumn>
							</Columns>
						</asp:DataGrid>
