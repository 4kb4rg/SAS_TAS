<%@ Page Language="vb" trace=false src="../../../include/popUpFindPOItem_New.aspx.vb" Inherits="popUpFindPOItem_New" %>
...
<body onload="javascript:self.focus();onload_setfocus();" leftmargin="2" topmargin="2">
    ...
    <table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma" >
		    <tr>
             <td style="width: 100%; height: 500px" valign="top" class="font9Tahoma" >
		...
		<table id="tblMain" width="100%" class="font9Tahoma" runat="server">
            ...
            <tr>
                <td width="20%">
                    Group Item</td>
                <td width="80%">
                <GG:AutoCompleteDropDownList id=DDLItemGroup width="30%" CssClass="font9Tahoma" runat=server /></td>
            </tr>
			
			<tr>
				<td width="20%">Name/Code : </td>
				<td width="80%">
					<asp:TextBox id="txtItemCode" width="75%" maxlength="128" CssClass="font9Tahoma" runat="server" /></td>
			</tr>
                ...
                <td width="20%">
                    Warehouse :</td>
                <td width="80%">
                <GG:AutoCompleteDropDownList id=lstStorageFr CssClass="font9Tahoma" width="75%" runat=server /></td>
            </tr>
			...
			<tr>
				<td align="right" colspan="2">
                    ...
                    <asp:Label id="lblCost" Runat="server" ForeColor="OrangeRed" />&nbsp;
			...
			<tr>
					<td colspan="2">					
						<asp:DataGrid id="dgLine" runat="server"
							...
							OnSortCommand="Sort_Grid" class="font9Tahoma" PageSize="12">								
							...
							<Columns>
                                ...
                                <asp:BoundColumn DataField="UnitCost" HeaderText="Unit Cost" Visible="False"></asp:BoundColumn>
                                <asp:TemplateColumn HeaderText="Purchase UOM">
                                    <ItemTemplate>
                                        <asp:Label ID="lblPurchCode" runat="server" Text='<%# Container.DataItem("PurchaseUOM") %>'></asp:Label>                                                                                                                           
                                    </ItemTemplate>
                                    <ItemStyle Width="5%" />
                                </asp:TemplateColumn>
