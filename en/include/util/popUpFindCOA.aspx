<%@ Page Language="vb" trace=false src="../../../include/PopUpFindCOA.aspx.vb" Inherits="PopUpFindCOA" %>
...
<body onload="javascript:self.focus();onload_setfocus();" leftmargin="2" topmargin="2">
    ...
    <table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma" >
		...
		<table id="tblMain" width="100%" class="font9Tahoma" runat="server">
			<tr>
				<td width="20%" class="font12Tahoma">FIND COA</td>
			...
			<tr>
				...
				<td width="80%">
				<strong>	<asp:TextBox id="txtItemCode" width="75%" maxlength="128" runat="server" /></strong></td>
			</tr>
			...
			<tr>
				<td align="right" colspan="2">
                    <asp:Label id="lblNameCOA" Runat="server" />
