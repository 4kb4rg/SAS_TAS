<%@ Page Language="vb" trace=false src="../../../include/PopUpFindSI.aspx.vb" Inherits="PopUpFindSI" %>
...
<body onload="javascript:self.focus();onload_setfocus();" leftmargin="2" topmargin="2">
    ...
    <table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma" >
		...
		<table id="tblMain" width="100%" class="font9Tahoma" runat="server">
			<tr>
				<td width="20%" class="mt-h">FIND SI</td>
			...
			<tr>
				<td width="20%">Stock Issue ID/Item Code : </td>
				<td width="80%">
					...
					<td colspan="2">					
						<asp:DataGrid id="dgLine" runat="server"
							...
							<AlternatingItemStyle BackColor="#EEEEEE" Font-Bold="False" 
                                ...
                                Font-Underline="False"/>		
							<Columns>
								<asp:BoundColumn Visible="False" HeaderText="StockIssueID" DataField="StockIssueID" />
								<asp:BoundColumn Visible="False" HeaderText="ItemCode" DataField="ItemCode" />
								<asp:ButtonColumn CommandName="Select" Text="Select" ItemStyle-Width="10%" HeaderStyle-Width="10%"/>
								<asp:HyperLinkColumn HeaderText="StockIssueID" ItemStyle-Width="25%" HeaderStyle-Width="20%" 
								    SortExpression="StockIssueID"
									DataTextField="StockIssueID" />
								<asp:HyperLinkColumn HeaderText="Item Code" ItemStyle-Width="15%" HeaderStyle-Width="15%"
									SortExpression="ItemCode" 
									DataTextField="ItemCode" />
								<asp:TemplateColumn HeaderText="Item Description" HeaderStyle-Width="40%" SortExpression="Description">
