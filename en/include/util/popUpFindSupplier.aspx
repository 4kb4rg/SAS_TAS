<%@ Page Language="vb" trace=false src="../../../include/PopUpFindSupplier.aspx.vb" Inherits="PopUpFindSupplier" %>
...
<body onload="javascript:self.focus();onload_setfocus();" leftmargin="2" topmargin="2">
    ...
    <table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma" >
		...
		<table id="tblMain" width="100%" class="font9Tahoma" runat="server">
			<tr>
				<td width="20%" class="font9Tahoma"><strong>FIND SUPPLIER</strong> </td>
					...
					<td colspan="2">					
						<asp:DataGrid id="dgLine" runat="server"
							...
							<Columns>
								...
								<asp:BoundColumn Visible="False" HeaderText="Name" DataField="SupplierCode" />
								<asp:ButtonColumn CommandName="Select" Text="Select" ItemStyle-Width="10%" HeaderStyle-Width="10%"/>
								<asp:HyperLinkColumn HeaderText="Supplier Code" ItemStyle-Width="20%" HeaderStyle-Width="20%" 
