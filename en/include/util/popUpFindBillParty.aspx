<%@ Page Language="vb" trace=false src="../../../include/PopUpFindBillParty.aspx.vb" Inherits="PopUpFindBillParty" %>
...
<body onload="javascript:self.focus();onload_setfocus();" leftmargin="2" topmargin="2">
    ...
    <table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma" >
		...
		<table id="tblMain" width="100%" runat="server">
			<tr>
				<td width="20%" class="font9Tahoma"><strong>BILL PARTY</strong>  </td>
					...
					<td colspan="2">					
						<asp:DataGrid id="dgLine" runat="server"
							...
							<AlternatingItemStyle BackColor="#EEEEEE" Font-Bold="False" 
                                ...
                                Font-Underline="False"/>			
							<Columns>
								<asp:BoundColumn Visible="False" HeaderText="Bill Party Code" DataField="BillPartyCode" />
								...
								<asp:HyperLinkColumn HeaderText="BillParty Code" ItemStyle-Width="20%" HeaderStyle-Width="20%" 
								    SortExpression="BillPartyCode"
