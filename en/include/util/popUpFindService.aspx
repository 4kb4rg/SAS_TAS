<%@ Page Language="vb" trace=false src="../../../include/PopUpFindService.aspx.vb" Inherits="PopUpFindService" %>
...
<body onload="javascript:self.focus();onload_setfocus();" leftmargin="2" topmargin="2">
    ...
    <table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma" >
		...
		<table id="tblMain" width="100%" class="font9Tahoma" runat="server">
			<tr>
				<td width="20%" class="font9Tahoma"><strong>FIND SERVICE</strong> </td>
				...
				<td align="right" colspan="2">
					...
					<asp:DropDownList id="lstDropList" runat="server"
		         	...
		         	<asp:Imagebutton id="btnNext" runat="server"  
                        imageurl="../../../images/btprev.png" alternatetext="Next" 
					...
					<td colspan="2">					
						<asp:DataGrid id="dgLine" runat="server"
							...
							<AlternatingItemStyle BackColor="#EEEEEE" Font-Bold="False" 
                                ...
                                Font-Underline="False"/>	
							<Columns>
								<asp:BoundColumn Visible="False" HeaderText="Service Item" DataField="ItemCode" />
								...
								<asp:HyperLinkColumn HeaderText="Service Item" ItemStyle-Width="30%" HeaderStyle-Width="30%" 
								    SortExpression="Catatan"
									DataTextField="Catatan" />
								<asp:HyperLinkColumn HeaderText="Description" ItemStyle-Width="60%" HeaderStyle-Width="60%"
									SortExpression="AdditionalNote" 
