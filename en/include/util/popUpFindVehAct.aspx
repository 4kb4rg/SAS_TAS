<%@ Page Language="vb" trace=false src="../../../include/PopUpFindVehAct.aspx.vb" Inherits="PopUpFindVehAct" %>
...
<body onload="javascript:self.focus();onload_setfocus();" leftmargin="2" topmargin="2" class="main-modul-bg-app-list-pu">
    <form id="frmMain" runat="server">
		...
		<table id="tblMain" width="100%" class="font9Tahoma" runat="server">
			<tr>
				<td width="20%" class="font9Tahoma">FIND ACTIVITY</td>
				<td align="right" width="60%"><asp:label id="lblTracker" runat="server"/></td>
			</tr>
			<tr>
				<td colspan="2"><hr size="1" style="width:100%"></td>
			</tr>
			...
			<tr>
                  ...
                  <HeaderStyle  BackColor="#CCCCCC" Font-Bold="False" 
							...
							<AlternatingItemStyle BackColor="#EEEEEE" Font-Bold="False" 
                                ...
                                Font-Underline="False"/>							
							<Columns>
								<asp:BoundColumn Visible="False" HeaderText="Activity Code" DataField="VehActCode" />
								<asp:BoundColumn Visible="False" HeaderText="Account Code" DataField="AccCode" />
								...
								<asp:HyperLinkColumn HeaderText="Activity Code" ItemStyle-Width="20%" HeaderStyle-Width="20%" 
								    SortExpression="VehActCode"
									DataTextField="VehActCode" />
								<asp:HyperLinkColumn HeaderText="Account Code" ItemStyle-Width="30%" HeaderStyle-Width="30%" 
