...
function PopCal(dateField) {
	calendar_window=window.open('/en/include/Util/popUpWincalendar.aspx?formname=frmMain.'+dateField,'calendar_window','width=185,height=155,top=200,left=250',resizable=1);calendar_window.focus() 
}		
