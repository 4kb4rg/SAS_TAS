<%@ Control Language="VB" Inherits="PD_STDRPT_SELECTION_CTRL" src="../../../include/Reports/PD_StdRpt_Selection_Ctrl.ascx.vb" %>
	...
	<tr>
		<td>
			<table width=100% cellspacing="0" cellpadding="1" border="0" align="left" ID="tblRptSelect2" class="font9Tahoma" runat=server>
				...
				<tr id=TrFromTo>		
					<td>From :</td>
					<td><asp:TextBox id="txtDateFrom" maxlength="10" width=100% runat="server"/>
  								  <a href="javascript:PopCal('RptSelect_txtDateFrom');">
								  <asp:Image id="btnSelDateFrom" runat="server" ImageUrl="../../Images/calendar.gif"/></a></td>				
					<td>To :</td>
					<td><asp:TextBox id="txtDateTo" maxlength="10" width=100% runat="server"/>
