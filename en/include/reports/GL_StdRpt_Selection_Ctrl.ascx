<%@ Control Language="VB" Inherits="GL_STDRPT_SELECTION_CTRL" src="../../../include/Reports/GL_StdRpt_Selection_Ctrl.ascx.vb" %>
	...
	<tr>
		<td>
			<table width=100% cellspacing=0 cellpadding=1 border=0 align="left" ID="tblRptSelect2" class="font9Tahoma" runat=server>
				<tr>
					<td>Report Name : </td>
					<td colspan=2><asp:DropDownList id="lstRptname" width=100% size=1 AutoPostBack=true OnSelectedIndexchanged=CheckRptName class="font9Tahoma" runat=server /></td>
					<td>&nbsp;</td>
				</tr>	
				<tr id="TrStmtBy">
					<td valign=top>Print Report by : </td>
					<td colspan=2><asp:dropdownlist id=ddlStmtBy width=30% size=1 AutoPostBack=true OnSelectedIndexChanged=CheckStmtBy class="font9Tahoma" runat=server /></td>
				</tr>
				<tr id="TrCheckLoc">
					<td valign=top>Select the <asp:label id="lblLocTag1" runat="server" /> you want for reporting : </td>
					<td colspan=2>
						<table width=50% cellpadding=0 cellspadding=0>
							<tr>
								<td><asp:CheckBox text=All id="cbLocAll" OnCheckedChanged=Check_Clicked AutoPostBack=true runat=server /></td>
				...
				<tr id="TrRadioLoc">
					<td valign=top>Select the <asp:label id="lblLocTag2" runat="server" /> you want for reporting : </td>
					<td colspan=2>
						<table width=50% cellpadding=0 cellspadding=0>
							<tr>
								<td><asp:RadioButtonList id="rblLocation" RepeatColumns="5" RepeatDirection="Horizontal" AutoPostBack=true class="font9Tahoma" runat=server/></td>
							</tr>
						</table>
					</td>
					<td width=10%>&nbsp;</td>
				...
				<tr id=TrFromTo>		
					...
					<td colspan=2>To : &nbsp;
								  ...
								  <asp:Image id="btnSelDateTo" runat="server" CausesValidation=False ImageUrl="../../Images/calendar.gif"/></a></td>
				</tr>						
				<tr>
				...
				<tr id="TrDivision">
					<td>Division : </td>
					<td>
						<asp:DropDownList id="ddlDivision" size=1 width=100% runat=server />
					</td>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
				</tr>											
