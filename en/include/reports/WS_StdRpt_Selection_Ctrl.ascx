<%@ Control Language="VB" Inherits="WS_STDRPT_SELECTION_CTRL" src="../../../include/Reports/WS_StdRpt_Selection_Ctrl.ascx.vb" %>
			...
			<table width=100% cellspacing="0" cellpadding="1" border="0" align="left" ID="tblRptSelect2" class="font9Tahoma" runat=server>
				...
				<tr>
					...
					<td colspan=2>
						<table width=50% cellpadding=0>
							<tr>
								<td><asp:CheckBox text=All id="cbLocAll" OnCheckedChanged=Check_Clicked AutoPostBack=true class="font9Tahoma" runat=server Visible="False" /></td>
				...
				<tr id="TrMthYr">
					...
					<td><asp:DropDownList id="lstAccMonth"  width=40% runat=server />
						<asp:DropDownList id="lstAccYear"  width=40% autopostback=true onselectedindexchanged=OnIndexChage_FromAccPeriod class="font9Tahoma" runat=server />
					</td>
