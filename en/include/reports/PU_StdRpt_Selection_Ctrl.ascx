<%@ Control Language="VB" Inherits="PU_STDRPT_SELECTION_CTRL" src="../../../include/Reports/PU_StdRpt_Selection_Ctrl.ascx.vb" %>
	...
	<tr>
		<td>
			<table width=100% cellspacing="0" cellpadding="1" border="0" align="left" ID="tblRptSelect2" class="font9Tahoma" runat=server>
				...
				<tr id="TRCompList" visible=false>
					<td valign=top>Select the Company you want for reporting : </td>
					<td colspan=2>
						<table width=50% cellpadding=0 cellspadding=0>
							<tr>
								<td><asp:CheckBox text=All id="cbCompAll"  OnCheckedChanged=CheckComp_Clicked AutoPostBack=true class="font9Tahoma" runat=server /></td>
								<td><asp:CheckBoxList id=cblCompList OnSelectedIndexChanged="CompCheckList" RepeatColumns="5" RepeatDirection="Horizontal" AutoPostBack=True class="font9Tahoma" runat=server /></td>
							</tr>
						</table>
					</td>
					<td><asp:label id=lblCompListErr runat=server visible=false/></td>
				</tr>
				<tr id="TrLocList">
