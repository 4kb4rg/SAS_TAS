<%@ Control Language="VB" Inherits="PR_StdRpt_Selection_Ctrl" src="../../../include/Reports/PR_StdRpt_Selection_Ctrl.ascx.vb" %>
	...
	<tr>
		<td>
			<table width=100% cellspacing="0" cellpadding="1" border="0" align="left" ID="tblRptSelect2" class="font9Tahoma" runat=server>
				<tr>
					<td>Report Name : </td>
					<td colspan=2><asp:DropDownList id="lstRptname" width=80% size=1 AutoPostBack=true OnSelectedIndexchanged=CheckRptName class="font9Tahoma" runat=server /></td>
					<td>&nbsp;</td>
				</tr>		
				<tr id="TrLocation">
					<td>Select the location you want for reporting : </td>
					<td colspan=2>
				...
				<tr id="TrMthYr">
					...
					<td width=20%>
						...
						<asp:DropDownList id="lstAccYear" size=1 width=40% autopostback=true onselectedindexchanged=OnIndexChage_FromAccPeriod class="font9Tahoma" runat=server /></td>
					<td width=20%>&nbsp;</td>
					<td width=20%>&nbsp;</td>
				</tr>			
				<tr id="TrPhyMthYr">
					<td>Physical Month/Year : </td>
					<td><asp:DropDownList id="lstPhyMonth" size=1 width=40% class="font9Tahoma" runat=server>
								    ...
								    <asp:DropDownList id="lstPhyYear" size=1 width=55% class="font9Tahoma" runat=server /></td>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
				</tr>																									
				<tr id=TRFromTo>		
