<%@ Control Language="VB" Inherits="HR_STDRPT_SELECTION_CTRL" src="../../../include/Reports/HR_StdRpt_Selection_Ctrl.ascx.vb" %>
	...
	<tr>
		<td>
			<table width=100% cellspacing="0" cellpadding="1" border="0" align="left" ID="tblRptSelect2" class="font9Tahoma" runat=server>
				<tr>
					<td>Report Name : </td>
					<td colspan=2><asp:DropDownList id="lstRptname" width=220 size=1 AutoPostBack=true OnSelectedIndexchanged=CheckRptName class="font9Tahoma" runat=server /></td>
					<td>&nbsp;</td>
				</tr>
				<tr id="TrLocation">
					...
					<td colspan=2>
						<table width=50% cellpadding=0 cellspadding=0>
							<tr>
								...
								<td><asp:CheckBoxList id=cblUserLoc OnSelectedIndexChanged="LocCheckList" RepeatColumns="5" RepeatDirection="Horizontal" class="font9Tahoma" AutoPostBack=True class="font9Tahoma" runat=server /></td>
							</tr>
						</table>
					</td>
