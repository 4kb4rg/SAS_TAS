<%@ Control Language="VB"  Inherits="AP_STDRPT_SELECTION_CTRL" src="../../../include/Reports/AP_StdRpt_Selection_Ctrl.ascx.vb" %>
		...
		<td>
			<table width=100% cellspacing="0" cellpadding="1" border="0" align="left" ID="tblRptSelect2" class="font9Tahoma" runat=server>
				...
				<tr id="TrMthYr">
					...
					<td>
						<asp:DropDownList id="lstAccMonth"  width=40% class="font9Tahoma" runat=server />
