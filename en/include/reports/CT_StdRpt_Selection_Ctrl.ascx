<%@ Control Language="VB" Inherits="CT_STDRPT_SELECTION_CTRL" src="../../../include/Reports/CT_StdRpt_Selection_Ctrl.ascx.vb" %>
	...
	<tr>
		<td>
			<table width=100% cellspacing="0" cellpadding="1" border="0" align="left" ID="tblRptSelect2" class="font9Tahoma" runat=server>
				<tr>
					<td>Report Name : </td>
					<td colspan=3><asp:DropDownList id="lstRptname" width=73% size=1 autopostback=true onselectedindexchanged=CheckRptName runat=server /></td>
				</tr>
				<tr>
					<td valign=top>Select the location you want for reporting : </td>
					<td colspan=2>
						<table width=50% cellpadding=0 class="font9Tahoma">
							<tr>
				...
				<tr id="TrMthYr">
					...
					<td colspan=2 id=ddlAccMthYrTo visible=false>To : &nbsp;
						<asp:DropDownList id="lstAccMonthTo" size=1 width=20% class="font9Tahoma" runat=server />
						<asp:DropDownList id="lstAccYearTo" size=1 width=20% autopostback=true onselectedindexchanged=OnIndexChage_ToAccPeriod class="font9Tahoma" runat=server />
					</td>
				</tr>																
				<tr id=TRFromTo>		
					<td>From :</td>
