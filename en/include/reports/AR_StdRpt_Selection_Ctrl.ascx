<%@ Control Language="VB"  Inherits="AR_STDRPT_SELECTION_CTRL" src="../../../include/Reports/AR_StdRpt_Selection_Ctrl.ascx.vb" %>
		...
		<td>
			<table width=100% cellspacing="0" cellpadding="1" border="0" align="left" ID="tblRptSelect2" class="font9Tahoma" runat=server>
				<tr>
					...
					<td width=40% colspan=2><asp:DropDownList id="lstRptname" width=80% size=1 AutoPostBack=true OnSelectedIndexchanged=CheckRptName runat=server /></td>
					<td width=20%>&nbsp;</td>
				</tr>	
				<tr id="SelLocation">
