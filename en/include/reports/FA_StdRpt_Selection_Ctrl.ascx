<%@ Control Language="VB" Inherits="FA_StdRpt_Selection_Ctrl" src="../../../include/Reports/FA_StdRpt_Selection_Ctrl.ascx.vb" %>
	...
	<tr>
		<td>
			<table width=100% cellspacing="0" cellpadding="1" border="0" align="left" ID="tblRptSelect2" class="font9Tahoma" runat=server>
				<tr>
					<td>Report Name : </td>
					<td colspan=3><asp:DropDownList id="lstRptname" width=73% size=1 AutoPostBack=true OnSelectedIndexchanged=CheckRptName class="font9Tahoma" runat=server /></td>
				</tr>
				<tr>
				...
				<tr id=TrDec>
					<td>Select number of decimal(s) for reporting : </td>
					<td><asp:DropDownList id=lstDecimal width=40% runat=server>
