<%@ Control Language="VB" Inherits="NU_StdRpt_Selection_Ctrl" src="../../../include/Reports/NU_StdRpt_Selection_Ctrl.ascx.vb" %>
		...
		<td>
			<table width=100% cellspacing="0" cellpadding="1" border="0" align="left" ID="tblRptSelect2" class="font9Tahoma" runat=server>
				...
				<tr id=TrDec>
					...
					<td><asp:DropDownList id=lstDecimal width=40% class="font9Tahoma" runat=server>
