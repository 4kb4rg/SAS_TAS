<%@ Page Language="vb" src="../../../include/CT_Trx_StockReturn_List.aspx.vb" Inherits="CT_StockReturn" %>
<%@ Register TagPrefix="UserControl" Tagname="MenuCTTrx" src="../../menu/menu_CTTrx.ascx"%>
<%@ Register TagPrefix="Preference" Tagname="PrefHdl" src="../../include/preference/preference_handler.ascx"%>
<html>
	<head>
		<title>Canteen Return List</title>
			...
			<tr>
				...
				<div class="kontenlist">
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						<tr>
							<td><strong>CANTEEN RETURN LIST</strong><hr style="width :100%" />   
                            </td>
						...
						<tr>
							...
							<table cellpadding="4" cellspacing="0" style="width: 100%">
								...
								<td width="30%" height="26">Canteen Return ID :<BR><asp:TextBox id=srchStockTxID width=100% maxlength="20" runat="server"/></td>
								<td width="30%" height="26">Canteen Issue ID :<BR><asp:TextBox id=srchIssueID width=100% maxlength="20" runat=server/></td>
						    ...
						    <tr>
							    ...
							    <table cellpadding="4" cellspacing="1" style="width: 100%">
					                ...
					                <Columns>
						                <asp:HyperLinkColumn
								                HeaderText="Canteen Return ID"
								                DataNavigateUrlField="StockRtnID"
								                DataNavigateUrlFormatString="CT_Trx_StockReturn_Details.aspx?id={0}"
								                DataTextField="StockRtnID"
								                DataTextFormatString="{0:c}"
								                SortExpression="StockRtnID"/>

						                <asp:TemplateColumn HeaderText="Last Update" SortExpression="Rtn.UpdateDate">
							                <ItemTemplate>
								                <%# objGlobal.GetLongDate(Container.DataItem("UpdateDate")) %>
							                </ItemTemplate>
						                </asp:TemplateColumn>
						                <asp:TemplateColumn HeaderText="Status" SortExpression="Rtn.Status">
							                <ItemTemplate>
						...
						<tr>
							<td>
					            <asp:ImageButton id=btnreturn OnClick=btnNewItm_Click imageurl="../../images/butt_new.gif" AlternateText="New Canteen Return" runat="server"/>
							</td>
						</tr>
                        <tr>
                            <td>
 					            <asp:Button ID="btnreturn2" class="button-small" runat="server" Text="New Canteen Return"  />&nbsp;
