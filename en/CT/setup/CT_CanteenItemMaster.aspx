<%@ Page Language="vb" src="../../../include/CT_setup_CanteenItemMaster.aspx.vb" Inherits="CT_StockMaster" %>
<%@ Register TagPrefix="UserControl" Tagname="MenuCTSetup" src="../../menu/menu_CTsetup.ascx"%>
<%@ Register TagPrefix="Preference" Tagname="PrefHdl" src="../../include/preference/preference_handler.ascx"%>
<html>
	<head>
		<title>Canteen Master List</title>
...
<%--	<Preference:PrefHdl id=PrefHdl runat="server" />--%>
		<body>
            ...
            <table cellpadding="0" cellspacing="0" style="width: 100%">
				<tr>
					<td colspan="6">
						<UserControl:MenuCTSetup id=menuIN runat="server" />
					</td>
				</tr>
			<tr>
				...
				<div class="kontenlist">
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						<tr>
							<td><strong>CANTEEN MASTER LIST</strong><hr style="width :100%" />   
                            </td>
						...
						<tr>
							...
							<table cellpadding="4" cellspacing="0" style="width: 100%">
								<tr class="font9Tahoma">
								    <td width="20%" height="26">Canteen Item Code :<BR><asp:TextBox id=srchStockCode width=100% maxlength="8" runat="server"/></td>
							    ...
							    <table cellpadding="4" cellspacing="1" style="width: 100%">
					                ...
					                <Columns>
						                <asp:HyperLinkColumn
								                ...
								                DataNavigateUrlFormatString="CT_CanteenItemMaster_Detail.aspx?id={0}"
						...
						<tr>
							<td>
					            <asp:ImageButton id=ibNew onClick=btnNewItm_Click imageurl="../../images/butt_new.gif" AlternateText="New Canteen Item Master" runat=server/>
