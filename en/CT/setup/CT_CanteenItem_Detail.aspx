<%@ Page Language="vb" Src="../../../include/CT_CanteenItem_Details.aspx.vb" Inherits="IN_CanteenItem" %>
<%@ Register TagPrefix="UserControl" Tagname="MenuCTSetup" src="../../menu/menu_CTsetup.ascx"%>
<%@ Register TagPrefix="Preference" Tagname="PrefHdl" src="../../include/preference/preference_handler.ascx"%>
<html>
<head>
    <title>CANTEEN ITEM DETAILS</title>
...
<body>
    <form id="frmSysSetting" runat="server" class="main-modul-bg-app-list-pu">
        ...
        <table cellpadding="2" width="100%" border="0" class="font9Tahoma">
 				...
 				<tr>
					<td colspan="6"><UserControl:MenuCTSetup id=menuCT runat="server" /></td>
				</tr>
				<tr>
                    <td class="mt-h" colspan="6"><asp:label id="lblHead" text="CANTEEN ITEM DETAILS" Runat="server"/></td>
                </tr>
				<tr>
					<td colspan=6><hr size="1" noshade></td>
				</tr>
                <tr>
                    <td><asp:label id="Label1" text="Canteen Item Code" Runat="server"/> :*</td>
                    <td><asp:DropDownList id="lstItemCode" width=100% runat="server" AutoPostback=True OnSelectedIndexChanged=LoadItemMaster />
                        <asp:TextBox id="CTItemCode" runat="server" Visible=False width=100% maxlength="20"/>
                        <asp:RequiredFieldValidator id="validateCode" runat="server" 
							ErrorMessage="Please Enter Canteen Item Code" 
							display="dynamic" 
							ControlToValidate="CTItemCode"/>							
                ...
                <tr>
                    <td>Description :*</td>
                    <td><asp:TextBox id="Desc" runat="server" width=100% maxlength="64"/>
                ...
                <tr>
                    <td><asp:label id="Label2" text="Product Type" Runat="server"/> :</td>
                    <td><asp:DropDownList id="lstProdType" width=100% runat="server" /></td>
                    <td>&nbsp;</td>
                    <td colspan="2">Last Update :</td>
                    <td><asp:Label id="UpdateDate" runat="server"/></td>
                </tr>
                <tr>
                    <td><asp:label id="Label3" text="Product Category" Runat="server"/> :</td>
                    <td><asp:DropDownList id="lstProdCat" width=100% runat="server" /></td>
                    <td>&nbsp;</td>
                ...
                <tr>
                    ...
                    <td><asp:DropDownList id="lstProdModel" width=100% runat="server" /></td>
                    <td>&nbsp;</td>
                ...
                <tr>
                    ...
                    <td><asp:DropDownList id="lstAccCode" width=100% runat="server" /></td>
                    <td>&nbsp;</td>
