<%@ Page Language="vb" src="../../../include/ct_data_download.aspx.vb" Inherits="CT_data_download" %>
<%@ Register TagPrefix="UserControl" Tagname="MenuCTData" src="../../menu/menu_CTData.ascx"%>
...
<html>
	...
	<body>
		<table border="0" width="100%" cellpadding="1" cellspacing="0">
			<tr>
				<td width="100%" align=center><UserControl:MenuCTData id=MenuCTData runat="server" /></td>
			</tr>
			<tr>
				<td width="100%">
					...
					<table id=tblDownload border="0" cellpadding="0" cellspacing="0" width="100%" runat=server>
						...
						<tr>
							<td width="100%" colspan="4">Canteen Reference Data</td>
						</tr>
						<tr>
						...
						<tr>
							<td>&nbsp;</td>
							<td colspan=3><asp:CheckBox id=cbCanteenItem text="Canteen Item Master" runat=server /></td>
						</tr>
						<tr>
