<%@ Page Language="vb" src="../../../include/CT_data_upload.aspx.vb" Inherits="CT_data_upload" %>
...
<form id=frmUpload enctype="multipart/form-data" runat=server>
	<table border="0" cellspacing="0" width="100%">
		<tr>
			<td width=100% colspan=3 align=center><UserControl:MenuCTData id=MenuCTData runat="server" /></td>
		</tr>
		<tr>
		...
		<tr>
			<td colspan="2">Canteen Reference Data</td>
		</tr>
		<tr>
			<td colspan="2">&nbsp;</td>
		</tr>
		...
		<tr>
			<td colspan="2">
				<table id=tblAfter border=0 width=100% runat=server>
					<tr>
						<td colspan="2">Your canteen reference file has been successfully uploaded.</td>
					</tr>
				</table>
			</td>
		</tr>
