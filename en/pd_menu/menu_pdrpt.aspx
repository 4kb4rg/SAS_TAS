<%@ Page Language="vb" src="../include/menu_pdrpt.aspx.vb" Inherits="menu_pdrpt" %>
            ...
            <table>
			    ...
			    <td width="20"></td>
						...
						<tr height="20">
							...
							<td class="lb-hti"><asp:hyperlink id="lnkRpt1" runat="server" target="middleFrame"  text="Estate" cssclass="lb-tti"></asp:hyperlink></td>
						</tr>
						
						<tr height="20">
							<td width="20"></td>
							<td width="14"><IMG src="images/spacer.gif" border="0" align="left"></td>
							<td class="lb-hti"><asp:hyperlink id="lnkRpt2" runat="server" target="middleFrame"  text="Mill" cssclass="lb-tti"></asp:hyperlink></td>
						</tr>
						</table>
