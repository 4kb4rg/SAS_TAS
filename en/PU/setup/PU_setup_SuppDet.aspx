           ...
           <td style="width: 100%; height: 800px" valign="top">
			...
			<table border=0 cellspacing=0 cellpadding=1 width=100% class="font9Tahoma" >
				...
				<tr>
					<td>Address :*</td>
					<td rowspan="5">
						<textarea rows="4" id=txtAddress cols="50" style='width:100%;'  maxlength="512" CssClass="fontObject"  runat=server /></textarea>
				...
				<tr>
					...
					<td>
						<asp:dropdownlist id=ddlSuppType width=100% AutoPostBack="True" onSelectedIndexChanged="SupTypeChanged" CssClass="fontObject"  runat=server></asp:dropdownlist></asp:dropdownlist>
				...
				<tr>
					...
					<td>
					<textarea rows="4" id=txtPOTerms cols="50" style='width:100%;'  maxlength="512" CssClass="fontObject"  runat="server"/></textarea>
				...
				<tr>
    				<td>NPWP No. :	</td>
    				<td><asp:TextBox id=txtNPWPNo width=100% maxlength=32 CssClass="fontObject"  runat="server"/></td>
				</tr>
				<tr>
    				<td>NPWP Address :	</td>
    				<td rowspan="5"><textarea rows="4" id=txtNPWPAddress cols="50" style='width:100%;'  maxlength="512" CssClass="fontObject"  runat="server"/></textarea></td>
				</tr>
				<tr>
					<td colspan=5>&nbsp;</td>
				</tr>
