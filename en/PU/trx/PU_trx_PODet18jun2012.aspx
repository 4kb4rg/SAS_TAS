								...
								<td>
									<table border="0" width="100%" cellspacing="0" cellpadding="1">
										...
										<tr id=Centralized_No Visible = false runat="server">
											<td height="25">Purchase Requisition ID :*</td>
											<td ><asp:TextBox id=txtPRID width=50% maxlength=30 runat=server />
										...
										<tr>
											...
											<td ><asp:DropDownList id=ddlItemCode width=95% runat=server AutoPostBack="True" onSelectedIndexChanged="ItemIndexChanged" />
										...
										<tr>
											<td>PPh 21 :*</td>
											<td><asp:TextBox id=txtPPH21 width=10% maxlength=5 runat=server />
										...
										<tr>
											...
											<td><asp:DropDownList id=ddlTransporter width=50% runat=server AutoPostBack="False"  />
											    <input type=button value=" ... " id="Find1" onclick="javascript:PopSupplier('frmMain', '', 'ddlTransporter', 'False');" CausesValidation=False runat=server />
