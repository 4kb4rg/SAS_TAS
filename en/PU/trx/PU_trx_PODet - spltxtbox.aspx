	...
	<body>
		<form id=frmMain runat=server>
			...
			<table border="0" cellspacing="0" cellpadding="1" width="100%">
				<tr>
					<td colspan="6" style="height: 25px"><UserControl:MenuPU id=menuPU runat="server" />
                        <strong>PURCHASE ORDER DETAILS</strong></td>
				</tr>			
				<tr>
					<td class="mt-h" colspan="6"></td>
				</tr>
				<tr>
					<td colspan="6" style="height: 36px"><hr size="1" noshade></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
                        <asp:TextBox ID="txtSupCode" runat="server" AutoPostBack="False" MaxLength="15" 
                            Width="30%"></asp:TextBox>
						<input type=button value=" ... " id="Find" onclick="javascript:PopSupplier_New('frmMain', '', 'txtSupCode','txtSupName','txtCreditTerm','lblPPNInit', 'False');" causesvalidation="False" runat="server"/>
				...
				<tr>
				    <td style="height: 26px">Exchange Rate :</td>
					<td style="height: 26px"><asp:TextBox id=txtExRate text="1" width=30% maxlength=20 runat=server />
					...
					<td colspan="6">
								...
								<td>
									<table border="0" width="100%" cellspacing="0" cellpadding="1">
										...
										<tr id=Centralized_Yes runat="server">
											<td valign="top" style="height: 44px">Purchase Requisition ID :*</td>
											<td style="height: 44px" valign="top" >
                                                <asp:TextBox ID="txtPRID_Loc" runat="server" AutoPostBack="False" MaxLength="15"
                                                    Width="95%"></asp:TextBox>
                                                <input id="BtnViewPR" runat="server" causesvalidation="False"
										...
										<tr id=Centralized_No Visible = false runat="server">
											<td style="height: 26px">Purchase Requisition ID :*</td>
											<td style="height: 26px" ><asp:TextBox id=txtPRID width=50% maxlength=32 runat=server />
										...
										<tr>
											...
											<td><asp:TextBox id="lblPRLocCode" width="5%" runat=server BorderStyle="None" />
												...
												<asp:TextBox id="lblPPNInit" width="0%" runat=server BorderStyle="None" BackColor="Transparent"  />
												</td>
										</tr>
                                        <tr>
                                            <td height="25">
                        Purchase Requisition Ref. <asp:label id="lblLocation" runat="server" /> :</td>
                                            <td>
                        <asp:DropDownList id=ddlPRRefLocCode width="95%" runat=server AutoPostBack="False" onSelectedIndexChanged="LocIndexChanged" /><br />
                        ...
                        <asp:Label id=lblErrRef forecolor=red visible=false runat=server /></td>
										...
										<tr>
											...
											<td style="height: 70px" ><asp:DropDownList id=ddlItemCode width=95% runat=server />
										...
										<tr>
											...
											<td><asp:TextBox id=TxtItemName width=50% maxlength=128 runat=server />
											</td>
										</tr>
										<tr>
								        ...
								        <tr>
					                        ...
					                        <td><asp:TextBox id=txtDiscount width=10% maxlength=5 runat=server />
												...
												<asp:CheckBox id="chkPPN" enabled=false runat="server"></asp:CheckBox>
										...
										<tr>
											<td>Transporter :</td>
											<td>
                                                <asp:TextBox ID="txtTransCode" runat="server" AutoPostBack="False" MaxLength="15"
                                                    Width="25%"></asp:TextBox>
                                                <input id="Find1" runat="server" causesvalidation="False"
                                                        onclick="javascript:PopSupplier_New('frmMain', '', 'txtTransCode','txtTransName','txtBlank', 'False');"
                                                        type="button" value=" ... " /><asp:TextBox ID="txtTransName" runat="server" BackColor="Transparent"
                                                            BorderStyle="None" Font-Bold="True" ForeColor="White" MaxLength="10" Width="45%"></asp:TextBox>&nbsp;
				...
				<tr>
					<td colspan=6 height="25">&nbsp;<asp:TextBox ID="txtBlank" runat="server" AutoPostBack="False" BackColor="Black"
