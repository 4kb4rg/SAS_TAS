<%@ Page Language="vb" src="../../../include/PU_Trx_PelimpahanGM.aspx.vb" Inherits="PU_Trx_PelimpahanGM" %>
...
<html>
	<head>
		<title>DISPOSITION BY LOCATION</title>
		...
		<body>
             ...
             <td style="width: 100%; height: 1500px" valign="top">
			    <div class="kontenlist">     
		         ...
		         <table border="0" cellspacing="1" class="font9Tahoma" cellpadding="1" width="100%">
            		<tr>
					<td class="font9Tahoma" colspan="3" style="height: 21px"><strong> DISPOSITION BY LOCATION&nbsp;</strong></td>					
				    </tr>
				    <tr>
			...
			<table border="0" cellspacing="1" cellpadding="1" width="99%">
					...
					<td colspan=6 width=99% style="background-color:#FFCC00">
						<table width="99%" style="background-color:#FFCC00" cellspacing="0" cellpadding="3" border="0" align="center" style="height: 40px">
							<tr class="mb-c">
								...
								<td valign=bottom width=20% style="height: 39px">Item Name :<BR><asp:TextBox id="srchItem" width=100% maxlength="32" runat="server"/></td>
								...
								<td valign="bottom" width=5% style="height: 39px">
										...
										</asp:DropDownList> <asp:Button Text="Search" OnClick=srchBtn_Click CssClass="button-small" runat="server" ID="BtnSearch"/> </td>
								...
								<td valign=bottom width=10% align=right style="height: 39px"></td>
							   <td><asp:ImageButton ID="ImgProcesTop" OnClick="BtnProcess_onClick" runat="server" AlternateText="+ Refresh list"  ImageUrl="../../images/butt_process.gif" /></td>
							</tr>
						</table>
					</td>
				</tr>
				<tr>
					<TD colspan=6>
					<div id="divgd" style="width:100%;height:500px;overflow: auto;">   
	                        <asp:DataGrid ID="dgPRListing" runat="server" AllowSorting="True" AutoGenerateColumns="False" PagerStyle-Visible="False" PageSize="30" OnItemDataBound="dgPRListing_BindGrid"
						...
						<HeaderStyle CssClass="mr-h" BackColor="#CCCCCC" Font-Bold="False" 
                            ...
                            <asp:TemplateColumn HeaderText="No">
                                ...
                                <asp:BoundColumn DataField="PRID" HeaderText="Purchase Requition ID" Visible="False"></asp:BoundColumn>
                                <asp:BoundColumn DataField="PrIDSwow" HeaderText="Purchase Requition ID" Visible="True"></asp:BoundColumn>
                                <asp:BoundColumn DataField="ItemCode" HeaderText="Item Code" Visible="False"></asp:BoundColumn>
                          	    <asp:HyperLinkColumn
							HeaderText="Purchase Requitition ID" 
							DataNavigateUrlField="PRID" 							
							DataTextField="PRID"
							DataTextFormatString="{0:c}"													
							SortExpression="PRID" Visible=false />
                                ...
                                <asp:TemplateColumn HeaderText="Quantity Requested">
                                    <ItemTemplate>
                                        ...
                                        &nbsp;<br />
                                        <asp:Label ID="lblPurcUomReq" runat="server" Text='<%# Container.DataItem("UomCode") %>'
                                ...
                                <asp:TemplateColumn HeaderText="Quantity Approved">
                                    <ItemTemplate>
                                        ...
                                        <asp:TextBox ID="lstQtyApp" runat="server" MaxLength="8" Text='<%# trim(Container.DataItem("QtyApp")) %>'
                                            Visible="false" Width="90%"></asp:TextBox>&nbsp;<br />
                                       <asp:Label ID="lblPurcUOMAPP" runat="server" Text='<%# Container.DataItem("UomCode") %>'
                                            Visible="true"></asp:Label>    
                                    </ItemTemplate>
                                    <HeaderStyle HorizontalAlign="Right" />
                                    <ItemStyle HorizontalAlign="Right" Width="7%" />
                               ...
                               <asp:TemplateColumn HeaderText="Purchase <Br> Level By" >
								<ItemTemplate>								
									<asp:label id="lblPRLevel" visible="False" text=<%# Container.DataItem("LocLevel") %> runat="server" />
									<asp:label id="lblPRLevelDesc" visible="true" text=<%# Container.DataItem("LocLevelDesc") %> runat="server" />
								</ItemTemplate>
                                ...
                                <asp:TemplateColumn HeaderText="Order From Location">
                                    <ItemTemplate>                                                                                
                                        <asp:Label ID="lblOrderLocDesc" runat="server" Text='<%# Container.DataItem("PrLocDesc") %>' Font-Bold="True"></asp:Label>                                                                                
                                        <asp:Label ID="lblOrderLoc" runat="server" Text='<%# Container.DataItem("PrLocCode") %>' Font-Bold="True" Visible=false></asp:Label>
                                        <asp:Label ID="lblStatusln" runat="server" Text='<%# Container.DataItem("StatusLn") %>'
                                            Visible="false"></asp:Label>                                        
                                        <asp:Label ID="lblPRCreated" runat="server" Text='<%# Container.DataItem("PRCreated") %>' Font-Italic="true" Visible=True></asp:Label>
                                        </ItemTemplate>
                                    <HeaderStyle HorizontalAlign="Center" />
                                    <ItemStyle HorizontalAlign="Center" Width="8%" />
                                </asp:TemplateColumn>
                                <asp:TemplateColumn HeaderText="Last App. By">
                                    <ItemTemplate>
                                        ...
                                        <asp:Label ID="lblUpdDate" runat="server" Text='<%# objGlobal.GetLongDate(Container.DataItem("UpdateDate")) %>'></asp:Label>
                                    </ItemTemplate>
                                    <ItemStyle HorizontalAlign="LEFT" Width="8%" />
                                </asp:TemplateColumn>
                                <asp:TemplateColumn HeaderText="Disposition <br />To Location / Manager">
                                    <ItemTemplate>                                        
                                    <GG:AutoCompleteDropDownList id=ddlToLocCode AutoPostBack=true  onSelectedIndexChanged="BindToManager"  width=100% CssClass="fontObject" runat=server /><br />                                        
                                    <asp:Label ID="lblToLocCode" Visible=false runat="server"></asp:Label>
                                    </ItemTemplate>
                                    <HeaderStyle HorizontalAlign="Center" />
                                    <ItemStyle HorizontalAlign="LEFT" Width="15%" />
                                </asp:TemplateColumn>
                                <asp:TemplateColumn HeaderText="Disposition To User">
                                    <ItemTemplate>                                        
                                    <GG:AutoCompleteDropDownList id=ddlToUser AutoPostBack=true onSelectedIndexChanged="GetUserLoc"  width=100% CssClass="fontObject" runat=server /><br />
                                        
                                    </ItemTemplate>
                                    <HeaderStyle HorizontalAlign="Center" />
                                    <ItemStyle HorizontalAlign="LEFT" Width="15%" />
                                </asp:TemplateColumn>
                                <asp:BoundColumn DataField="PRStatus" HeaderText="Status" Visible=false></asp:BoundColumn>
                                ...
                                <asp:TemplateColumn HeaderText="Send By Item">
                                    <ItemTemplate>                                    
                                        <asp:Button Text="Send" OnClick=BtnSend_Click runat="server" ID="BtnSend" Font-Size="7pt" Width="35px" Visible="True" Height="26px" ToolTip="click Send for submit One Item PR"/>                                        
                                    </ItemTemplate>
                                    <ItemStyle HorizontalAlign="Center" Width="5%" />
                                </asp:TemplateColumn>
                                  <asp:TemplateColumn  HeaderText="Send All By Item">
                                    <ItemTemplate>                                    
                                        <asp:Button Text="Send By PR" OnClick=BtnSendPR_Click runat="server" ID="BtnSendPR" Font-Size="7pt" Width="70px" Visible="True" Height="26px" ToolTip="click Send for submit All Item PR"/>                                        
                                    </ItemTemplate>
                                    <ItemStyle HorizontalAlign="Center" Width="5%" />
                                </asp:TemplateColumn>
                            </Columns>
				...
				<tr>
					<td align="left" width="80%" ColSpan=6>
					    ...
					    <asp:ImageButton ID="imgProcess" OnClick="BtnProcess_onClick" runat="server" AlternateText="+ Refresh list"  ImageUrl="../../images/butt_process.gif" />
                        ...
                        <table>
                            ...
                            <tr>
                                <td style="width: 59px; height: 21px;">
                                    <span style="font-size: 8pt; font-family: Arial">Purchase Level <br /> By Unit&nbsp;</span></td>
                                <td style="width: 15px; height: 21px;">
                                    :</td>
                                <td style="width: 100px; height: 21px;">
                                    <asp:Label ID="Label2" runat="server" BackColor="Red" Text="-" Width="40px"></asp:Label></td>                                
                            </tr>                            
                            <tr>
                                <td style="width: 59px">
					...
					<td colspan=6 width=100% style="background-color:#FFCC00" >
						<table width="100%" style="background-color:#FFCC00"  cellspacing="0" cellpadding="3" border="0" align="center" style="height: 40px">
							<tr class="mb-c">
								...
								<td valign=bottom width=12% style="height: 39px">
                                    PO Location :<asp:DropDownList id="lstToLocCode_Sent" width=100% runat=server />
					...
					<TD colspan=6>
						...
						<HeaderStyle CssClass="mr-h" BackColor="#CCCCCC" Font-Bold="False" 
                            ...
                            <Columns>
                                 <asp:TemplateColumn HeaderText="No">
                                    <ItemTemplate>
                                          <asp:Label ID="lblNoUrutSent" runat="server" Visible="True"></asp:Label>
                                    </ItemTemplate>
                                    <ItemStyle Width="3%" />
                                  </asp:TemplateColumn>
                            
                                <asp:BoundColumn DataField="PRLnId" Visible="False"></asp:BoundColumn>
                                <asp:BoundColumn DataField="PRID" HeaderText="Purchase Requitition ID" Visible="False"></asp:BoundColumn>
                                <asp:BoundColumn DataField="PrIDSwow" HeaderText="Purchase Requitition ID" Visible="True"></asp:BoundColumn>
                                <asp:BoundColumn DataField="ItemCode" HeaderText="Item Code" Visible="False"></asp:BoundColumn>
                          			<asp:HyperLinkColumn Visible=false
							HeaderText="Purchase Requition ID" 
							DataNavigateUrlField="PRID" 							
							DataTextField="PRID"
							DataTextFormatString="{0:c}"							
							SortExpression="PRID" />
                                ...
                                <asp:TemplateColumn HeaderText="Order From Location">
                                    <ItemTemplate>                                        
                                        ...
                                        <asp:Label ID="lblStatusln" runat="server" Text='<%# Container.DataItem("StatusLn") %>'
                                            Visible="false"></asp:Label>  
                                        <asp:Label ID="lblPRCreatedSend" runat="server" Text='<%# Container.DataItem("PRCreated") %>' Font-Italic="true" Visible=True></asp:Label>
                                        </ItemTemplate>
                                    <HeaderStyle HorizontalAlign="Center" />
                                    <ItemStyle HorizontalAlign="Center" Width="8%" />
                                </asp:TemplateColumn>
                                <asp:TemplateColumn HeaderText="Disp. Date">
                                    <ItemTemplate>
                                        <asp:Label ID="lblUpdDate" runat="server" Text='<%# ObjGlobal.GetLongDate(Container.DataItem("UpdateDate")) %>'></asp:Label>
                                    </ItemTemplate>
                                ...
                                <asp:TemplateColumn HeaderText="Send To Location / <br>Manager ">
                                    <ItemTemplate>
                                        <asp:Label ID="lblPurchLoc" runat="server" Text='<%# Container.DataItem("ToLocCode") %>'                                        
                                            Visible="True"></asp:Label><br />
                                        <asp:Label ID="lblMgrID" runat="server" Text='<%# Container.DataItem("ManagerName") %>'                                        
                                            Visible="True"></asp:Label>
                                        </ItemTemplate>
                                    <HeaderStyle HorizontalAlign="Center" />
                                    <ItemStyle HorizontalAlign="LEFT" Width="14%" />
                                </asp:TemplateColumn>
                                <asp:TemplateColumn HeaderText="Disposition To User PO">
                                    <ItemTemplate>
                                        <asp:Label ID="lblDisptoUser" runat="server" Text='<%# Container.DataItem("ApplyToUser") %>'                                        
                                            Visible="True"></asp:Label>
                                        </ItemTemplate>
                                   <HeaderStyle HorizontalAlign="Center" />
                                ...
                                <asp:TemplateColumn>
                                    <ItemTemplate>                                                                            
                                        <asp:Button Text="Retrieve" OnClick=BtnCancel_Click runat="server" ID="BtnCancel" Font-Size="7pt" Width="50px" Visible="True" Height="26px" ToolTip="Click To Retrieve One Item"/>&nbsp;                                        
                                        &nbsp;
                                    </ItemTemplate>
                                </asp:TemplateColumn>
                                <asp:TemplateColumn>
                                    <ItemTemplate>                                                                            
                                        <asp:Button Text="Retrieve By Pr" OnClick=BtnCancelPR_Click runat="server" ID="BtnCancelPR" Font-Size="7pt" Width="75px" Visible="True" Height="26px" ToolTip="Click To Retrieve PR All Item"/>&nbsp;
                                        &nbsp;
                                    </ItemTemplate>
                                </asp:TemplateColumn>                                
                            </Columns>
