...
<html>
 ...
 <style type="text/css">
                ...
                .modal-body {padding: 2px 2px; background-color:white; color: black;}
		...
		<body>
		    ...
		    <tr>
		     ...
		     <table border="0" cellspacing="1" cellpadding="1" width="100%" class="font9Tahoma">
					<tr>
						<td><strong>PURCHASE REQUISITION ASSIGN TO USER</strong><hr style="width :100%" />   
                        </td>
                            
					</tr>
                    <tr>
                        <td align="right"><asp:label id="Label2" runat="server" /></td> 
                    </tr>
            </table>   
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%">			
					...
					<td colspan=6 width=100% class="mb-c">
						<table width="100%" bgcolor=white cellspacing="0" cellpadding="3" border="0" align="center" style="height: 40px">
							<tr class="font9Tahoma" style="background-color:#FFCC00" >
								...
								<td valign=bottom width=10% align=right style="height: 39px"><asp:Button Text="Search" OnClick=srchBtn_Click runat="server" ID="BtnSearch" class="button-small"/></td>
							</tr>
						</table>
					</td>
				</tr>
						...
						<HeaderStyle CssClass="mr-h" BackColor="#CCCCCC" Font-Bold="False" 
                            ...
                            <Columns>
                                <asp:BoundColumn DataField="PRLnId" Visible="False"></asp:BoundColumn>
                    		      ...
                    		      <asp:TemplateColumn HeaderText="Purchase Requitition ID" ItemStyle-HorizontalAlign="left">    
					                    <ItemTemplate>
					                        <asp:LinkButton id=lnkPRID CommandName=Item text='<%# Container.DataItem("PRID") %>'  runat=server />
					                        <asp:Label id=lblPRID text='<%# Container.DataItem("PRID") %>'  visible=False runat=server />
					                    </ItemTemplate>
							...
							SortExpression="PRID" /> 
                                <asp:TemplateColumn HeaderText="Item &lt;br&gt; Additional Note">
                                    <ItemTemplate>                                        
                                        ...
                                        <br />
                                        <asp:Label ID="lblAddNote" runat="server" Text='<%# Trim(Container.DataItem("ItemDesc")) %>'></asp:Label>
                                        <asp:Label ID="lstAddNote" runat="server" BorderStyle=NONE Height="100%" Width="100%" BackColor="LightGreen" ReadOnly=TRUE Text='<%# trim(Container.DataItem("AdditionalNote")) %>'
                                ...
                                <asp:TemplateColumn HeaderText="From Location">
                                    <ItemTemplate>                                        
                                       PR From : <asp:Label ID="lblOrderLoc" runat="server" Text='<%# Container.DataItem("PrLocDesc") %>'></asp:Label>
                                        <br />
                                        <asp:Label ID="lblCreated" runat="server" Text='<%# Container.DataItem("PRCreated") %>'></asp:Label>                                      
                                        </ItemTemplate>
                                ...
                                <asp:TemplateColumn Visible="false">
                                    <ItemTemplate>
                                        ...
                                        <asp:LinkButton ID="WriteNote" runat="server" CausesValidation="False" CommandName="WriteNote"
                                            Text="Note" Visible=true ></asp:LinkButton>&nbsp;                                                                                                                                             
                                    </ItemTemplate>
				...
				<tr>
					<td align=right colspan="6">
						...
						<asp:ImageButton ID="btnPrev" runat="server" alternatetext="Previous" commandargument="prev" imageurl="../../../images/btprev.png" onClick="btnPrevNext_Click" />
						<asp:DropDownList ID="lstDropList" runat="server" AutoPostBack="True" onSelectedIndexChanged="PagingIndexChanged" />
						<asp:ImageButton ID="btnNext" runat="server" alternatetext="Next" commandargument="next" imageurl="../../../images/btnext.png" onClick="btnPrevNext_Click" />
				...
				<tr>
					<td align="left" width="80%" ColSpan=6>
					    ...
					    <asp:Button ID="myBtn" runat="server" Text="Write Note" class="button-small"/>
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td style="width: 100px; height: 21px;">
                                    <asp:Label ID="lblPRID" runat="server" BackColor="Yellow" Text="-" Width="40px"></asp:Label></td>
                            </tr>                                                 
                            <tr>
                                <td style="width: 59px">
					...
					<td colspan=6 width=100% class="mb-c">
						<table width="100%" bgcolor=white cellspacing="0" cellpadding="3" border="0" align="center" style="height: 40px">
							<tr class="font9Tahoma" style="background-color:#FFCC00" >
								...
								<td valign=bottom width=12% style="height: 39px"><BR></td>
								<td valign=bottom width=10% align=right style="height: 39px"><asp:Button Text="Search" OnClick=srchBtnSent_Click runat="server" ID="srchBtnSent" class="button-small"/></td>
							</tr>
						</table>
					</td>
				</tr>
							...
							SortExpression="PRID" />
                                ...
                                <asp:TemplateColumn HeaderText="Quantity Approved">
                                    <ItemTemplate>
                                        ...
                                        <asp:TextBox ID="lstQtyApp" runat="server" MaxLength="8" Text='<%# trim(Container.DataItem("QtyApp")) %>'
                                            Visible="false" Width="90%"></asp:TextBox>&nbsp;
                                        <asp:Label ID="lblPurchUomReqAPP" runat="server" Text='<%# Container.DataItem("UomCode") %>'
                                            Visible="true"></asp:Label>                                              
                                    </ItemTemplate>
                                    <HeaderStyle HorizontalAlign="Right" />
                                    <ItemStyle HorizontalAlign="Right" Width="7%" />
                                ...
                                <asp:TemplateColumn HeaderText="Order From Location">
                                    <ItemTemplate>                                        
                                        <asp:Label ID="lblOrderLoc" runat="server" Text='<%# Container.DataItem("PrLocCode") %>' Font-Bold="True"></asp:Label>     
                                         <br />
                                        <asp:Label ID="lblCreatedSend" runat="server" Text='<%# Container.DataItem("PRCreated") %>'></asp:Label>
                                        </ItemTemplate>
                                    <HeaderStyle HorizontalAlign="Center" />
                                ...
                                <asp:TemplateColumn HeaderText="Disposition By">
                    		      ...
                    		      <asp:TemplateColumn HeaderText="RFQ ID" ItemStyle-HorizontalAlign="left">    
					                    <ItemTemplate>
					                        <asp:LinkButton id=lnkRFQID CommandName=Item text='<%# Container.DataItem("RfqID") %>'  runat=server />
					                        <asp:Label id=lblRfqID text='<%# Container.DataItem("RfqID") %>'  visible=False runat=server />
					                    </ItemTemplate>
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <ItemStyle HorizontalAlign="Left" Width="10%" />					                    
                                    </asp:TemplateColumn>
                                    
                    		      <asp:TemplateColumn HeaderText="DTH ID" ItemStyle-HorizontalAlign="left">    
					                    <ItemTemplate>
					                        <asp:LinkButton id=lnkDTHID CommandName=Item text='<%# Container.DataItem("RphID") %>'  runat=server />
					                        <asp:Label id=lblDthID text='<%# Container.DataItem("RphID") %>'  visible=False runat=server />
					                    </ItemTemplate>
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <ItemStyle HorizontalAlign="Left" Width="10%" />					                    
                                    </asp:TemplateColumn>
...
<div id="myModal" class="modal" runat=server>
 <div class="modal-content" runat=server style="left: 0px; top: 0px" id="Div2">
    <div class="modal-header" runat=server>
      <span class="close">×</span>  PLEASE WRITE NOTE</div>
    <div class="Font9Tahoma" runat=server id="Div1">
         <table style="width: 99%">
             ...
             <tr>
                 ...
                 <td colspan="2" style="height: 21px">
                     <asp:Label ID="lblPrlNID" runat="server"></asp:Label></td>
             </tr>
             <tr>
                 <td style="width: 190px">
                     Item Code :</td>
             ...
             <tr>
                 <td style="width: 190px" valign="top">
                     Note :</td>
                 <td colspan="2">
                      <asp:TextBox ID="txtPurchNote" runat="server" MaxLength="300" Width="100%" Height="200px" TextMode="MultiLine" Font-Bold="True" Font-Size="Large"></asp:TextBox></td>
             </tr>
             <tr>
                 <td style="width: 190px" valign="top">
                 </td>
                 <td colspan="2" style="text-align: right">
                     <asp:Button ID="BtnSendNote" runat="server" Text="Send" />
                     <asp:Button ID="BtnCloseNote" runat="server" Text="Close" /></td>
             </tr>
          </table>
    </div>
...
<script language="javascript">
    ...
    var btn =document.getElementById('TABBK__ctl0_myBtn');
