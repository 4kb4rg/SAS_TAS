<%@ Page Language="vb" src="../../../include/PU_Trx_DAInternalList.aspx.vb" Inherits="PU_DAInternal" %>
			...
			<tr>
				...
				<div class="kontenlist">
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						<tr>
							<td><strong>DISPATCH ADVICE LIST</strong><hr style="width :100%" />   
                            </td>
						...
						<tr>
							...
							<table cellpadding="4" cellspacing="0" style="width: 100%">
								...
								<td width="20%" valign=bottom height=26>Dispatch Advice ID :<BR><asp:TextBox id=srchStockTxID width=100% maxlength="20" runat="server"/></td>
								<td width="15%" valign=bottom height=26>DA Type :<BR><asp:DropDownList id="ddlDAType" width=100% runat=server /></td>
							    ...
							    <table cellpadding="4" cellspacing="1" style="width: 100%">
						            ...
						            <Columns>
							            <asp:HyperLinkColumn
									            ...
									            DataNavigateUrlFormatString="PU_Trx_DAInternalDet.aspx?DispAdvId={0}"
							            ...
							            <asp:TemplateColumn HeaderText="DA Type" SortExpression="A.DispAdvType">
									            <ItemTemplate>
										            <%#objPUTrx.mtdGetDAType(Container.DataItem("DispAdvType"))%>
									            </ItemTemplate>
							            </asp:TemplateColumn>	
							            <asp:TemplateColumn HeaderText="From" SortExpression="tx.Bin">
								            <ItemTemplate>
									            <%#objINstp.mtdGetInventoryBinLevel(Container.DataItem("Bin"))%>
								            </ItemTemplate>
							            </asp:TemplateColumn>	
							            ...
							            <asp:TemplateColumn HeaderText="Status" SortExpression="tx.Status">
								            <ItemTemplate>
									            <%#objPUTrx.mtdGetDAInternalStatus(Container.DataItem("Status"))%>
								            </ItemTemplate>
							            </asp:TemplateColumn>
							            ...
							            <asp:TemplateColumn>
								            <ItemTemplate>
									            ...
									            <asp:label id="lblTxID" Text=<%# Container.DataItem("DispAdvID") %> Visible="False" Runat="server"></asp:label>
						...
						<tr>
							<td>
					            <asp:ImageButton id=NewINDABtn onClick=NewINDABtn_Click imageurl="../../images/butt_new_stockda.gif" AlternateText="New Stock/Workshop Dispatch Advice" runat=server/>
						        <asp:ImageButton id=NewDCDABtn onClick=NewDCDABtn_Click imageurl="../../images/butt_new_directchargeda.gif" AlternateText="New Direct Charge Dispatch Advice" runat=server/>
						        <asp:ImageButton id=NewFADABtn onClick=NewFADABtn_Click imageurl="../../images/butt_new_fixedassetda.gif" AlternateText="New Fixed Asset Dispatch Advice" runat=server/>
						        <asp:ImageButton id=NewNUDABtn onClick=NewNUDABtn_Click imageurl="../../images/butt_new_nurseryda.gif" AlternateText="New Nursery Dispatch Advice" runat=server/>	
