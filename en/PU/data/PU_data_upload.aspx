<%@ Page Language="vb" src="../../../include/PU_data_upload.aspx.vb" Inherits="PU_data_upload" %>
<%@ Register TagPrefix="UserControl" Tagname="MenuPUData" src="../../menu/menu_PUData.ascx"%>
...
<form id=frmUpload enctype="multipart/form-data" runat=server>
	<table border="0" cellspacing="0" width="100%">
		<tr>
			<td width=100% colspan=3 align=center><UserControl:MenuPUData id=MenuPUData runat="server" /></td>
		</tr>
		<tr>
		...
		<tr>
			<td colspan="2">Purchasing Reference Data</td>
		</tr>
		<tr>
			<td colspan="2">&nbsp;</td>
		</tr>
		...
		<tr>
			<td colspan="2">
				<table id=tblAfter border=0 width=100% runat=server>
					<tr>
						<td colspan="2">Your Purchasing reference file has been successfully uploaded.</td>
					</tr>
				</table>
			</td>
		</tr>
