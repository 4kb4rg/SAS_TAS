<%@ Page Language="vb" src="../../../include/PU_data_download.aspx.vb" Inherits="PU_data_download" %>
...
<html>
	...
	<body>
		<table border="0" width="100%" cellpadding="1" cellspacing="0">
			<tr>
				<td width="100%" align=center><UserControl:MenuPUData id=MenuPUData runat="server" /></td>
			</tr>
			<tr>
				<td width="100%">
					...
					<table id=tblDownload border="0" cellpadding="0" cellspacing="0" width="100%" runat=server>
						...
						<tr>
							<td width="100%" colspan="4">Purchasing Reference Data</td>
						</tr>
						<tr>
						...
						<tr>
							<td>&nbsp;</td>
							<td colspan=3><asp:CheckBox id=cbSupplier text="Supplier" runat=server /></td>
						</tr>
						<tr>
