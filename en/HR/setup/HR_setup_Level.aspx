<%@ Page Language="vb" src="../../../include/HR_Setup_Level.aspx.vb" Inherits="HR_Setup_Level" %>
					...
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						...
						<tr>
							...
							<table cellpadding="4" cellspacing="0" style="width: 100%">
								...
								<td width="15%" height="26" valign=bottom><asp:label id="lblLevel" runat="server"/> Code :<BR><asp:TextBox id=srchLevelCode width=100% maxlength="8" runat="server"/></td>
						    ...
						    <tr>
							    ...
							    <table cellpadding="4" cellspacing="1" style="width: 100%">
						            ...
						            <asp:DataGrid id="EventData"
						                ...
						                <Columns>					
						                <asp:TemplateColumn SortExpression="LevelCode">
							                <ItemTemplate>
								                <%# Container.DataItem("LevelCode") %>
							                </ItemTemplate>
							                <EditItemTemplate>
								                <asp:TextBox id="LevelCode" MaxLength="8" width=95%
									                Text='<%# trim(Container.DataItem("LevelCode")) %>'
									                runat="server"/><BR>
								                <asp:RequiredFieldValidator id=validateCode display=dynamic runat=server 
									                ControlToValidate=LevelCode />
						                ...
						                <asp:TemplateColumn HeaderText="Last Update" SortExpression="LVL.UpdateDate">
							                <ItemTemplate>
						                ...
						                <asp:TemplateColumn HeaderText="Status" SortExpression="LVL.Status">
							                <ItemTemplate>
						...
						<tr>
							<td>
					            <asp:ImageButton id=btnNew OnClick="DEDR_Add" imageurl="../../images/butt_new.gif" AlternateText="New Level Code" runat="server"/>
