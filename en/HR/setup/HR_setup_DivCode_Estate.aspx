<%@ Page Language="vb" src="../../../include/HR_Setup_DivCode_Estate.aspx.vb" Inherits="HR_Setup_DeptCode" %>
			...
			<tr>
				...
				<div class="kontenlist">
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						<tr>
							<td><strong><asp:label id="lblTitle" runat="server" >DIVISION</asp:label> CODE LIST</strong><hr style="width :100%" />   
                            </td>
						...
						<tr>
							...
							<table cellpadding="4" cellspacing="0" style="width: 100%">
								...
								<td width="15%" height="26" valign=bottom><asp:label id="lblDepartment" runat="server" >Division</asp:label> Code :<BR><asp:TextBox id=srchDeptCode width=100% maxlength="8" runat="server"/></td>
						    ...
						    <tr>
							    ...
							    <table cellpadding="4" cellspacing="1" style="width: 100%">
					                ...
					                <Columns>					
					                <asp:TemplateColumn HeaderText="Division Code" SortExpression="DivCode">
						                <ItemTemplate>
							                <%#Container.DataItem("DivCode")%>
						                </ItemTemplate>
						                <EditItemTemplate>
							                <asp:TextBox id="DivCode" MaxLength="8" width=95%
								                Text='<%# trim(Container.DataItem("DivCode")) %>' runat="server"/><BR>
							                <asp:RequiredFieldValidator id=validateCode display=dynamic runat=server 
								                ControlToValidate=DivCode />
					                ...
					                <asp:TemplateColumn SortExpression="TyDiv" HeaderText="Type">
						                <ItemTemplate>
							                <%#Container.DataItem("TyDiv")%>
						                </ItemTemplate>
						                <EditItemTemplate >													
							                <asp:DropDownList id="ddltype" Width=100% AutoPostBack=true runat=server>
							                </asp:DropDownList>
							                <asp:Label id=lblErrtype visible=false text ="Please select type" forecolor=red runat=server/>	
							                <asp:label id=lblTyDiv visible=false text='<%# trim(Container.DataItem("TyDiv")) %>' runat=server/>						
						                </EditItemTemplate>	
						                <ItemStyle Width=100 />		
					                </asp:TemplateColumn>	
