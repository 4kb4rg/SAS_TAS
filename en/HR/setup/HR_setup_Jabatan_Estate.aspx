<%@ Page Language="vb" src="../../../include/HR_Setup_Jabatan_Estate.aspx.vb" Inherits="HR_Setup_Jabatan_Estate" %>
<%@ Register TagPrefix="UserControl" Tagname="MenuHRSetup" src="../../menu/menu_hrsetup.ascx"%>
<%@ Register TagPrefix="Preference" Tagname="PrefHdl" src="../../include/preference/preference_handler.ascx"%>
<html>
	<head>
		<title>Group Job List</title>
			...
			<tr>
				...
				<div class="kontenlist">
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						<tr>
							<td><strong>JABATAN LIST</strong><hr style="width :100%" />   
                            </td>
						...
						<tr>
							...
							<table cellpadding="4" cellspacing="0" style="width: 100%">
								...
								<td width="10%" height="26" valign=bottom>Jabatan Code :<BR><asp:TextBox id=srchJobCode width=100% maxlength="8" runat="server"/></td>
								<td width="20%" height="26" valign=bottom>
                                    Group Pekerjaan:<BR><GG:AutoCompleteDropDownList id=srchgroupjbt width=100% runat="server"/></td>
								<td width="20%" height="26" valign=bottom>Description :<BR><asp:TextBox id=srchDesc width=100% maxlength="128" runat="server"/></td>
					...
					<asp:TemplateColumn SortExpression="JbtCode" HeaderText="Jabatan Code">
						<ItemTemplate>
							<%#Container.DataItem("JbtCode")%>
						</ItemTemplate>
						<EditItemTemplate>
							<asp:TextBox id="JbtCode" MaxLength="8" width=95%
								Text='<%# trim(Container.DataItem("JbtCode")) %>' ReadOnly=true runat="server"/><BR>
					...
					<asp:TemplateColumn SortExpression="CodeGrpJob" HeaderText="Group Pekerjaan">
						<ItemTemplate>
							<%#Container.DataItem("CodeGrpJob")%>
						</ItemTemplate>
						<EditItemTemplate>													
							<asp:DropDownList id="ddlCodeGrpJob" width=100% AutoPostBack=true runat=server>
							</asp:DropDownList>
							<asp:Label id=lblErrCodeGrpJobe visible=false text ="Please select Group Job" forecolor=red runat=server/>	
							<asp:label id=lblCodeGrpJob visible=false text='<%# trim(Container.DataItem("CodeGrpJob")) %>' runat=server/>						
						</EditItemTemplate>
					</asp:TemplateColumn>	
					...
					<asp:TemplateColumn HeaderText="Station">
						<ItemTemplate>
							<%#Container.DataItem("Stationname")%>
						</ItemTemplate>
						<EditItemTemplate>													
							<asp:DropDownList id="ddlStation" width=100% AutoPostBack=true runat=server>
							</asp:DropDownList>
							<asp:label id=lblStation visible=false text='<%# trim(Container.DataItem("Station")) %>' runat=server/>						
						</EditItemTemplate>
					</asp:TemplateColumn>						
