			...
			<tr>
				...
				<div class="kontenlist">
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						<tr>
							<td><strong>&nbsp;JOB DESCRIPTION CODE LIST</strong><hr style="width :100%" />   
                            </td>
						...
						<tr>
							...
							<table cellpadding="4" cellspacing="0" style="width: 100%">
								...
								<td width="15%" height="26" valign=bottom>
                                    &nbsp;Job Code :<BR><asp:TextBox id=srchDeptCode width=100% maxlength="8" runat="server"/></td>
								<td width="40%" height="26" valign=bottom>
                                    &nbsp;Description :<BR><asp:TextBox id=srchName width=100% maxlength="128" runat="server"/></td>
					...
					<Columns>					
					<asp:TemplateColumn HeaderText="Job Code" SortExpression="DeptCode">
						<ItemTemplate>
