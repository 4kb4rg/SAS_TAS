<%@ Page Language="vb" debug="true" src="../../../include/HR_setup_YearPlan_Estate.aspx.vb" Inherits="HR_Stp_YearPlan" %>
<%@ Register TagPrefix="UserControl" Tagname="MenuHRSetup" src="../../menu/menu_hrsetup.ascx"%>
<%@ Register TagPrefix="Preference" Tagname="PrefHdl" src="../../include/preference/preference_handler.ascx"%>
<html>
	<head>
		<title>Division Code List</title>
			...
			<tr>
				...
				<div class="kontenlist">
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						<tr>
							<td><strong><asp:label id="lblTitle" runat="server" >YEAR PLANT</asp:label> LIST</strong><hr style="width :100%" />   
                            </td>
						...
						<tr>
							...
							<table cellpadding="4" cellspacing="0" style="width: 100%">
								...
								<td width="15%" height="26" valign=bottom>
                                    Year Plant :<BR><asp:TextBox id=srchYearPlan width=100% maxlength="8" runat="server"/></td>
						    ...
						    <tr>
							    ...
							    <table cellpadding="4" cellspacing="1" style="width: 100%">
					                ...
					                <Columns>					
					                <asp:TemplateColumn HeaderText="Year Plant" SortExpression="YearPlan">
						                <ItemTemplate>
							                <%#Container.DataItem("YearPlan")%>
						                </ItemTemplate>
						                <EditItemTemplate>
							                <asp:TextBox id="YearPlan" MaxLength="8" width=95%
								                Text='<%# trim(Container.DataItem("YearPlan")) %>' runat="server"/><BR>
							                <asp:RequiredFieldValidator id=validateCode display=dynamic runat=server 
								                ControlToValidate=YearPlan />
					                ...
					                <asp:TemplateColumn HeaderText="Bjr" SortExpression="BJR">
						                <ItemTemplate>
							                <%#Container.DataItem("BJR")%>
						                </ItemTemplate>
						                <EditItemTemplate>
							                <asp:TextBox id="bjr" MaxLength="8" width=95% Text='<%# trim(Container.DataItem("BJR")) %>'  onkeypress="javascript:return isNumberKey(event)" runat="server"/>
						                </EditItemTemplate>
					                </asp:TemplateColumn>
						...
						<tr>
							<td>
					            <asp:ImageButton id=btnNew OnClick="DEDR_Add" imageurl="../../images/butt_new.gif" AlternateText="New Year Plant Code" runat="server"/>
						        <asp:ImageButton id=ibPrint imageurl="../../images/butt_print.gif" AlternateText=Print Visible=false onClick="btnPreview_Click" runat="server"/>
							</td>
						</tr>
                        <tr>
                            <td>
