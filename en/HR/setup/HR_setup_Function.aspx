<%@ Page Language="vb" src="../../../include/HR_Setup_Function.aspx.vb" Inherits="HR_Setup_Function" %>
					...
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						...
						<tr>
							...
							<table cellpadding="4" cellspacing="0" style="width: 100%">
								...
								<td width="15%" height="26" valign=bottom><asp:label id="lblFunction" runat="server" /> Code :<BR><asp:TextBox id=srchFuncCode width=100% maxlength="8" runat="server"/></td>
							<td width="40%" height="26" valign=bottom><asp:label id="lblDesc" runat="server" /> :<BR><asp:TextBox id=srchDesc width=100% maxlength="128" runat="server"/></td>
						    ...
						    <tr>
							    ...
							    <table cellpadding="4" cellspacing="1" style="width: 100%">
						            ...
						            <asp:DataGrid id="EventData"
				                        ...
				                        <Columns>					
					                        <asp:TemplateColumn SortExpression="FuncCode">
						                        <ItemTemplate>
							                        <%# Container.DataItem("FuncCode") %>
						                        </ItemTemplate>
						                        <EditItemTemplate>
							                        <asp:TextBox id="FuncCode" MaxLength="8" width=95%
								                        Text='<%# trim(Container.DataItem("FuncCode")) %>'
								                        runat="server"/><BR>
							                        <asp:RequiredFieldValidator id=validateCode display=dynamic runat=server 
								                        ControlToValidate=FuncCode />
					                        ...
					                        <asp:TemplateColumn HeaderText="Employee Type" SortExpression="EmpType">						
						                        <ItemTemplate>
							                        <%# objHR.mtdGetEmpType(trim(Container.DataItem("EmpType"))) %>
						                        </ItemTemplate>
						                        <EditItemTemplate>													
							                        <asp:DropDownList id="ddlEmpType" width=100% AutoPostBack=true runat=server>
							                        </asp:DropDownList>
							                        <asp:Label id=lblErrEmpType visible=false text ="Please select Employee Type" forecolor=red runat=server/>	
							                        <asp:label id=lblEmpType visible=false text='<%# trim(Container.DataItem("EmpType")) %>' runat=server/>						
						                        </EditItemTemplate>						
					                        </asp:TemplateColumn>					
				
					                        <asp:TemplateColumn HeaderText="Last Update" SortExpression="FUNC.UpdateDate">
						                        <ItemTemplate>
					                        ...
					                        <asp:TemplateColumn HeaderText="Status" SortExpression="FUNC.Status">
						                        <ItemTemplate>
						...
						<tr>
							<td>
					            <asp:ImageButton id=btnNew OnClick="DEDR_Add" imageurl="../../images/butt_new.gif" AlternateText="New Function Code" runat="server"/>
