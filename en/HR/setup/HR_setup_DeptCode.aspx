<%@ Page Language="vb" src="../../../include/HR_Setup_DeptCode.aspx.vb" Inherits="HR_Setup_DeptCode" %>
<%@ Register TagPrefix="UserControl" Tagname="MenuHRSetup" src="../../menu/menu_hrsetup.ascx"%>
<%@ Register TagPrefix="Preference" Tagname="PrefHdl" src="../../include/preference/preference_handler.ascx"%>
<html>
	<head>
		<title>Department Code List</title>
					...
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						...
						<tr>
							...
							<table cellpadding="4" cellspacing="0" style="width: 100%">
								...
								<td width="15%" height="26" valign=bottom><asp:label id="lblDepartment" runat="server" /> Code :<BR><asp:TextBox id=srchDeptCode width=100% maxlength="8" runat="server"/></td>
								<td width="40%" height="26" valign=bottom><asp:label id="lblDesc" runat="server" /> :<BR><asp:TextBox id=srchName width=100% maxlength="128" runat="server"/></td>
						    ...
						    <tr>
							    ...
							    <table cellpadding="4" cellspacing="1" style="width: 100%">
						            ...
						            <asp:DataGrid id="EventData"
					                    ...
					                    <Columns>					
					                    <asp:TemplateColumn SortExpression="DeptCode">
						                    <ItemTemplate>
							                    <%# Container.DataItem("DeptCode") %>
						                    </ItemTemplate>
						                    <EditItemTemplate>
							                    <asp:TextBox id="DeptCode" MaxLength="8" width=95%
								                    Text='<%# trim(Container.DataItem("DeptCode")) %>' runat="server"/><BR>
							                    <asp:RequiredFieldValidator id=validateCode display=dynamic runat=server 
								                    ControlToValidate=DeptCode />
					                    ...
					                    <asp:TemplateColumn HeaderText="Last Update" SortExpression="DEPT.UpdateDate">
						                    <ItemTemplate>
					                    ...
					                    <asp:TemplateColumn HeaderText="Status" SortExpression="DEPT.Status">
						                    <ItemTemplate>
						...
						<tr>
							<td>
					            <asp:ImageButton id=btnNew OnClick="DEDR_Add" imageurl="../../images/butt_new.gif" AlternateText="New Department Code" runat="server"/>
