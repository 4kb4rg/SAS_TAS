	...
	<body>
		...
		<Form id=frmMain class="main-modul-bg-app-list-pu"  runat="server">
			...
			<table border=0 cellspacing=0 cellpadding=2 width=100%  class="font9Tahoma">
				...
				<tr>
					<td class="mt-h" colspan="5"><strong>SHIFT DETAILS</strong>
                        <br />
                    <hr style="width :100%" />
                    </td>
				</tr>
							...
							<tr>						
								<td>
									<TABLE cellSpacing="0" cellPadding="2" width="100%" border="0"  class="font9Tahoma">
										...
										<TR class="mb-c">
											<TD vAlign="top" colspan=5 height=25><asp:ImageButton id=btnAdd imageurl="../../images/butt_add.gif" alternatetext=Add onclick=btnAdd_Click runat=server /></TD>
										</TR>
									</TABLE>
								</td>
							</tr>
