<%@ Page Language="vb" src="../../../include/HR_setup_JobGroup_Estate.aspx.vb" Inherits="HR_setup_JobGroup_Estate" %>
						...
						<tr>
							...
							<table cellpadding="4" cellspacing="0" style="width: 100%">
								...
								<td height="26" valign=bottom style="width: 23%">
                                    Group Job Code :<BR><asp:TextBox id=srchJobCode width=100% maxlength="8" runat="server"/></td>
						    ...
						    <tr>
							    ...
							    <table cellpadding="4" cellspacing="1" style="width: 100%">
					                ...
					                <Columns>					
					                <asp:TemplateColumn SortExpression="GrpJobCode" HeaderText="Group Job">
						                <ItemTemplate>
							                <%#Container.DataItem("GrpJobCode")%>
						                </ItemTemplate>
						                <EditItemTemplate>
							                <asp:TextBox id="GrpJobCode" MaxLength="8" width=95%
								                Text='<%# trim(Container.DataItem("GrpJobCode")) %>' runat="server"/><BR>
							                <asp:RequiredFieldValidator id=validateCode display=dynamic runat=server 
								                ControlToValidate=GrpJobCode />
					                ...
					                <asp:TemplateColumn  HeaderText="BKM">
						                <ItemTemplate>
							                <%# Container.DataItem("isBKM") %>
						                </ItemTemplate>
						                <EditItemTemplate>
							                <asp:DropDownList id="ddlBKM" width=100% runat="server">
							                    <asp:ListItem value="1" selected>Yes</asp:ListItem>
								                <asp:ListItem value="0">No</asp:ListItem>
							                </asp:DropDownList>
							                <asp:label id="lblBKM" Visible=False Text='<%# Container.DataItem("isBKM") %>' runat="server"/>
						                </EditItemTemplate>
					                </asp:TemplateColumn>						
