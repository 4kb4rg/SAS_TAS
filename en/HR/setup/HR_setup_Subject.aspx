<%@ Page Language="vb" src="../../../include/HR_Setup_Subject.aspx.vb" Inherits="HR_Setup_Subject" %>
			...
			<tr>
				...
				<div class="kontenlist">
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						<tr>
							<td><strong>SUBJECT LIST</strong><hr style="width :100%" />   
                            </td>
						...
						<tr>
							...
							<table cellpadding="4" cellspacing="0" style="width: 100%">
								...
								<td width="15%" height="26" valign=bottom>Subject Code :<BR><asp:TextBox id=srchSubjectCode width=100% maxlength="8" runat="server"/></td>
						    ...
						    <tr>
							    ...
							    <table cellpadding="4" cellspacing="1" style="width: 100%">
					                ...
					                <asp:TemplateColumn HeaderText="Subject Code" SortExpression="SubjectCode">
						                <ItemTemplate>
							                <%# Container.DataItem("SubjectCode") %>
						                </ItemTemplate>
						                <EditItemTemplate>
							                <asp:TextBox id="SubjectCode" MaxLength="8" width=95%
								                Text='<%# trim(Container.DataItem("SubjectCode")) %>' Runat="server"/><BR>
							                <asp:RequiredFieldValidator id=validateCode display=dynamic runat=server 
								                ErrorMessage="Please Enter Subject Code"
								                ControlToValidate=SubjectCode />
					                ...
					                <asp:TemplateColumn HeaderText="Last Update" SortExpression="SU.UpdateDate">
						                <ItemTemplate>
					                ...
					                <asp:TemplateColumn HeaderText="Status" SortExpression="SU.Status">
						                <ItemTemplate>
						...
						<tr>
							<td>
					            <asp:ImageButton id=btnNew OnClick="DEDR_Add" imageurl="../../images/butt_new.gif" AlternateText="New Subject Code" runat="server"/>
