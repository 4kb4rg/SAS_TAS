                                                    ...
                                                    <div id="div2" style="height: 350px;width:1020;">		
                                                        <table id="tblSelection" cellSpacing="0" cellPadding="2" width="100%" border="0" class="font12Tahoma" runat=server>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td colSpan="5">
                                                                    <asp:DropDownList id="ddlMonth" width=10% CssClass="font9Tahoma" runat=server>
                                                                    ...
                                                                    &nbsp;
                                                                    <asp:DropDownList id=ddlYear width="10%" maxlength="4" CssClass="font9Tahoma"  runat="server" />
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td width="15%" height=25>Effective Date : </td>
                                                                <td colSpan="5"><asp:TextBox id=txtEffDate width=10% maxlength="10" CssClass="font9Tahoma"  runat="server"/>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><asp:DropDownList width="50%" id=ddlBank CssClass="font9Tahoma"  runat=server />
			                                                ...
			                                                <tr>
                                                                ...
                                                                <td colSpan="5">
                                                                    <asp:DropDownList id="ddlDocType" width=21% CssClass="font9Tahoma"  runat=server>
			                                                ...
			                                                <tr>
                                                                ...
                                                                <td colSpan="5"><asp:TextBox id=txtPrefix width=10% CssClass="font9Tahoma"  runat=server />
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td colSpan="5"><asp:TextBox id=txtNoFrom width=10% maxlength=6 CssClass="font9Tahoma"  runat=server />
																        		-
																                <asp:TextBox id=txtNoTo width=10% maxlength=6 CssClass="font9Tahoma"  runat=server />
                                                        ...
                                                        <asp:DataGrid id=dgLineGen
                                                            ...
                                                            <Columns>	
                                                                <asp:TemplateColumn>		
                                                                    ...
                                                                    <ItemTemplate>
                                                                        <asp:LinkButton id="lbDelete" CommandName="Delete" Text="set invalid" CausesValidation =False Visible=true runat="server" />
                                                                    </ItemTemplate>
                                                                </asp:TemplateColumn>
                                                                ...
                                                                <asp:TemplateColumn HeaderText="Status" ItemStyle-Width="7%" >
			                                                        <ItemTemplate>
				                                                        <asp:Label visible=true Text=<%# Container.DataItem("StatusDesc") %> id="lblStatusDesc" runat="server" /><br />
				                                                    </ItemTemplate>
		                                                        </asp:TemplateColumn>                               
                                                        </Columns>										
                                                        </asp:DataGrid>
