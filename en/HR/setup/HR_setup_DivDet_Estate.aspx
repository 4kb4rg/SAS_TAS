<%@ Page Language="vb" src="../../../include/HR_setup_Divdet_Estate.aspx.vb" Inherits="HR_setup_Deptdet" %>
<%@ Register TagPrefix="UserControl" Tagname="MenuHRSetup" src="../../menu/menu_hrsetup.ascx"%>
<%@ Register TagPrefix="Preference" Tagname="PrefHdl" src="../../include/preference/preference_handler.ascx"%>
<html>
	<head>
		<title>Head of Division Details</title>
	...
	<body>
		...
		<tr>
			...
			<table border=0 cellspacing=0 cellpadding=2 width=100% class="font9Tahoma">
				...
				<tr>
					<td class="mt-h" colspan="5"><asp:label id="lblTitle" runat="server" /> HEAD OF DIVISION DETAILS</td>
				</tr>
				<tr>
					<td colspan=6><hr size="1" noshade></td>
				</tr>
				<tr>
					<td width=20%><asp:label id="lblDepartment" runat="server" >Division </asp:label> Code :* </td>
					<td width=30%>
						<asp:DropDownList id=ddlDivCode width=100% runat=server/>
				...
				<tr>
					<td style="height: 26px">
                        <asp:label id="lblDeptHead" runat="server" >Head of Division</asp:label>
                        :</td>
					<td style="height: 26px">                        
                        <asp:TextBox ID="TxtHeadDiv" runat="server" width=100%></asp:TextBox><%--<input type="button" id=btnFind1 value=" ... " onclick="javascript:findcode('frmMain','','','','','','','','ddlDeptHead','','','','','','','',hidBlockCharge.value,hidChargeLocCode.value);" runat=server/></td>--%><td style="height: 26px">&nbsp;</td>
					<td style="height: 26px">Date Created : </td>
					<td style="height: 26px"><asp:Label id=lblDateCreated runat=server /></td>
				</tr>
				<tr>
					<td align="left">
                        </td>
				...
				<Input Type=Hidden id=divId runat=server />
