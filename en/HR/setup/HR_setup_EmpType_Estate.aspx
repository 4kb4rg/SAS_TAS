<%@ Page Language="vb" src="../../../include/HR_setup_EmpType_Estate.aspx.vb" Inherits="HR_setup_EmpType_Estate" %>
			...
			<tr>
				...
				<div class="kontenlist">
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						<tr>
							<td><strong><asp:label id="lblTitle" runat="server" />EMPLOYMENT TYPE LIST</strong><hr style="width :100%" />   
                            </td>
						...
						<tr>
							...
							<table cellpadding="4" cellspacing="0" style="width: 100%">
								...
								<td height="26" valign=bottom style="width: 23%"><asp:label id="lblEmpTyCode" runat="server" /> Employment Type Code :<BR><asp:TextBox id=srchEmptyCodeCode width=100% maxlength="8" runat="server"/></td>
								<td width="40%" height="26" valign=bottom><asp:label id="lblDesc" runat="server" />Description :<BR><asp:TextBox id=srchDesc width=100% maxlength="128" runat="server"/></td>
						    ...
						    <tr>
							    ...
							    <table cellpadding="4" cellspacing="1" style="width: 100%">
						            ...
						            <asp:DataGrid id="EventData"
					                    ...
					                    <Columns>					
					                    <asp:TemplateColumn SortExpression="EmpTyCode" HeaderText="Employment Type Code">
						                    <ItemTemplate>
							                    <%# Container.DataItem("EmpTyCode") %>
						                    </ItemTemplate>
						                    <EditItemTemplate>
							                    <asp:TextBox id="EmpTyCode" MaxLength="8" width=95%
								                    Text='<%# trim(Container.DataItem("EmpTyCode")) %>' runat="server"/><BR>
							                    <asp:RequiredFieldValidator id=validateCode display=dynamic runat=server 
								                    ControlToValidate=EmpTyCode />
					                    ...
					                    <asp:TemplateColumn HeaderText="Simbol">
						                    <ItemTemplate>
							                    <%#Container.DataItem("Symbol")%>
						                    </ItemTemplate>
						                    <EditItemTemplate>
							                    <asp:DropDownList id="ddlsimbol" width=100% AutoPostBack=true runat=server>
							                    </asp:DropDownList>
							                    <asp:Label id="lbsimbol" visible=False	Text='<%# Container.DataItem("Symbol") %>' runat="server"/>
						                    </EditItemTemplate>
					                    </asp:TemplateColumn>			
					
					                    <asp:TemplateColumn  HeaderText="GroupType">
						                    <ItemTemplate>
							                    <%#Container.DataItem("GroupType")%>
						                    </ItemTemplate>
						                    <EditItemTemplate>
							                    <asp:DropDownList id="ddlGroupType" width=100% AutoPostBack=true runat=server>
							                    </asp:DropDownList>
							                    <asp:Label id="lbGroupType" visible=False	Text='<%# trim(Container.DataItem("GroupType")) %>' runat="server"/>
							                    <asp:RequiredFieldValidator id=validateGroupType display=Dynamic runat=server 
								                    ControlToValidate=ddlGroupType />															
						                    </EditItemTemplate>
					                    </asp:TemplateColumn>			
					                    <asp:TemplateColumn  HeaderText="TaxType">
						                    <ItemTemplate>
							                    <%#Container.DataItem("TaxType")%>
						                    </ItemTemplate>
						                    <EditItemTemplate>
							                    <asp:DropDownList id="ddlTaxType" width=100% AutoPostBack=true runat=server>
							                    </asp:DropDownList>
							                    <asp:Label id="lbTaxType" visible=False	Text='<%# trim(Container.DataItem("TaxType")) %>' runat="server"/>
							                    <asp:RequiredFieldValidator id=validateTaxType display=Dynamic runat=server 
						...
						<tr>
							<td>
					            <asp:ImageButton id=btnNew OnClick="DEDR_Add" imageurl="../../images/butt_new.gif" AlternateText="New Employment Type" runat="server"/>
