           ...
           <table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
			...
			<table border=0 cellspacing=0 cellpadding=2 width=100% class="font9Tahoma">
				...
				<tr>
					...
					<td width=35%>
						<asp:Textbox id=txtBankCode width=50% maxlength=8 runat=server class="font9Tahoma"/>
				...
				<tr>
					<td>Description :*</td>
					<td>
						<asp:Textbox id=txtDescription maxlength=128 width=100% runat=server class="font9Tahoma"/>
				...
				<tr>
					...
					<td align="left">
						<asp:Textbox id=txtBankAcc maxlength=32 width=100% runat=server class="font9Tahoma"/>
				...
				<tr>
					...
					<td align="left" valign=top>
						<asp:Textbox id=txtBankAccOwner width=100% runat=server class="font9Tahoma"/>
				...
				<tr>
					...
					<td align="left" valign=top>
						<asp:Dropdownlist id=ddlAccCode width=100% runat=server class="font9Tahoma"/>
				...
				<tr>
					...
					<td>
						<asp:Textbox id=txtTransCharges width=100% maxlength=9 runat=server class="font9Tahoma"/>
				...
				<tr>
					...
					<td align="left" valign=top>
						<asp:Dropdownlist id=ddlAutoCredit width=100% runat=server class="font9Tahoma"/>
					</td>
					<td>&nbsp;</td>
					<td valign=top>Autocredit Bank Bar Code :</td>
					<td valign=top>
						<asp:Textbox id=txtBarCode width=100% runat=server class="font9Tahoma"/>
					</td>
				</tr>
				<tr>
					<td align="left" valign=top>Cheque Format :</td>
					<td align="left" valign=top>
						<asp:Dropdownlist id=ddlChequeFormat width=100% runat=server class="font9Tahoma"/>
					</td>
					<td>&nbsp;</td>
					<td valign=top>Autocredit Bank Customer ID :</td>
					<td valign=top>
						<asp:Textbox id=txtCustID width=100% runat=server class="font9Tahoma"/>
					</td>
				</tr>
				<tr>
					<td align="left" valign=top>Report Format :</td>
					<td align="left" valign=top>
						<asp:Dropdownlist id=ddlReportFormat width=100% runat=server class="font9Tahoma"/>
					</td>
					<td>&nbsp;</td>
					<td valign=top>Autocredit Batch No :</td>
					<td valign=top>
						<asp:Textbox id=txtBatchNo width=100% runat=server class="font9Tahoma"/>
					</td>
				</tr>
				<tr>
					<td align="left" valign=top>Bilyet Giro Format :</td>
					<td align="left" valign=top>
						<asp:Dropdownlist id=ddlGiroFormat width=100% runat=server class="font9Tahoma"/>
					</td>
				</tr>
				<tr>
					<td align="left" valign=top>Slip Setoran Format :</td>
					<td align="left" valign=top>
						<asp:Dropdownlist id=ddlSetoranFormat width=100% runat=server class="font9Tahoma"/>
					</td>
				</tr>
				<tr>
					<td align="left" valign=top>Slip Transfer Format :</td>
					<td align="left" valign=top>
						<asp:Dropdownlist id=ddlTransferFormat width=100% runat=server class="font9Tahoma"/>
					</td>
				</tr>
				<tr>
					<td align="left" valign=top>SWIFT :</td>
					<td align="left" valign=top>
						<asp:Textbox id=txtSwift width=100% runat=server class="font9Tahoma"/>
					</td>
				</tr>
				...
				<tr>
					...
					<td align="left" valign=top>
						<asp:Textbox id=txtCorBankDescription width=100% runat=server class="font9Tahoma"/>
					</td>
				</tr>
				<tr>
					<td align="left" valign=top>Account No :</td>
					<td align="left" valign=top>
						<asp:Textbox id=txtCorBankAccNo width=100% runat=server class="font9Tahoma"/>
					</td>
				</tr>
				<tr>
					<td align="left" valign=top>SWIFT :</td>
					<td align="left" valign=top>
						<asp:Textbox id=txtCorBankSwift width=100% runat=server class="font9Tahoma"/>
					</td>
				</tr>
				<tr>
