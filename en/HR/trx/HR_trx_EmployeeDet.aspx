                        ...
                        <table cellpadding="0" cellspacing="0" class="style1">
                            <tr>
                                ...
                                <td class="font9Header" style="text-align: right">
                                    Status : <asp:Label id=lblStatus runat=server />&nbsp;| Date Created : <asp:Label id=lblDateCreated runat=server />&nbsp;| Last Update : <asp:Label id=lblLastUpdate runat=server />&nbsp;| Updated By : <asp:Label id=lblUpdateBy runat=server />&nbsp;</td>
                            </tr>
                        </table>
                          <hr style="width :100%" />
                    </td>
