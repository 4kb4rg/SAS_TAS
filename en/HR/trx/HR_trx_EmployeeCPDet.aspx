		...
		<form id=frmMain class="main-modul-bg-app-list-pu" runat=server>
			...
			<table border=0 cellspacing="0" cellpadding=1 width="100%" class="font9Tahoma">
                        ...
                        <table cellpadding="0" cellspacing="0" class="style1">
                            <tr>
                                ...
                                <td  class="font9Header" style="text-align: right">
                                    Name : <asp:Label id=lblEmpName runat=server />&nbsp;| Status : <asp:Label id=lblEmpStatus visible=false runat=server />&nbsp;| Date Created : <asp:Label id=lblDateCreated runat=server />&nbsp;| Last Updated : <asp:Label id=lblLastUpdate runat=server />&nbsp;| Updated By :<asp:Label id=lblUpdateBy runat=server />
                                </td>
                            </tr>
                        </table>
                        <hr style="width :100%" />
				...
				<tr>
					...
					<td valign=top><asp:DropDownList id=ddlCPCode width=100% runat=server AutoPostBack="True" onSelectedIndexChanged="ItemIndexChanged" CssClass="font9Tahoma" />
				...
				<tr>
					...
					<td valign=top><asp:TextBox id=txtDateFrom width=87% runat=server CssClass="font9Tahoma" />
				...
				<tr>
					...
					<td valign=top><asp:TextBox id=txtDateTo width=87% enabled=false runat=server CssClass="font9Tahoma" />
				...
				<tr>
					...
					<td valign=top><asp:TextBox id=txtCeaseDate width=87% enabled=false runat=server CssClass="font9Tahoma" />
				...
				<tr>
					...
					<td valign=top colspan=4><asp:TextBox id=txtRemark width=99% runat=server CssClass="font9Tahoma" /></td>
				</tr>
				<tr>
					...
					<td valign=top colspan=5 bgcolor=black>
						<table width=100% border=0 cellpadding=2 cellspacing=0 bgcolor=DarkGray class="font9Tahoma">
							<tr>
								...
								<td valign=top width=35%><asp:DropDownList id=ddlCompCode width=100% enabled=false runat=server CssClass="font9Tahoma"  />
								...
								<td valign=top width=30%><asp:TextBox id=txtProbation width=100% runat=server CssClass="font9Tahoma" /></td>
							</tr>							
							<tr>
								<td valign=top height=25><asp:label id="lblLocation" runat="server" /> :*</td>
								<td valign=top><asp:DropDownList id=ddlLocCode width=100% enabled=false runat=server CssClass="font9Tahoma" />
								...
								<td valign=top>
									<asp:DropDownList id=ddlPayType width=100% onSelectedIndexChanged=onChg_PayType autopostback=true runat=server CssClass="font9Tahoma"  />
							...
							<tr>
								...
								<td valign=top><asp:DropDownList id=ddlDeptCode width=100% runat=server CssClass="font9Tahoma" />
							...
							<tr>
								...
								<td valign=top><asp:DropDownList id=ddlLevelCode width=100% runat=server CssClass="font9Tahoma" /></td>								
								<td valign=top>&nbsp;</td>
								<td valign=top>Adjustment Amount :*</td>
								<!-- Modified BY ALIM maxlength = 22, width = 75%-->
								<td valign=top><asp:TextBox id=txtIncrementAmt value=0 width=100% maxlength=22 runat=server CssClass="font9Tahoma" />
							...
							<tr>
								...
								<td valign=top>
									<asp:DropDownList id=ddlRptTo width=90% runat=server CssClass="font9Tahoma" /> 
							...
							<tr>
								<td valign=top height=25>Employee Category :*</td>
								<td valign=top><asp:DropDownList id=ddlSalSchemeCode width=100% runat=server CssClass="font9Tahoma" />
							...
							<tr>
								...
								<td valign=top><asp:DropDownList id=ddlSalGradeCode width=100% runat=server CssClass="font9Tahoma" />
							...
							<tr>
								...
								<td valign=top><asp:DropDownList id=ddlPosCode width=100% runat=server CssClass="font9Tahoma" /></td>
								<td valign=top colspan=2>&nbsp;</td>
							</tr>
							<!-- Modified By BHL -->
							<tr>
								<td valign=top height=25>Evaluation :*</td>
								<td valign=top><asp:DropDownList id=ddlEvalCode width=100% runat=server CssClass="font9Tahoma" />
							...
							<tr>
								...
								<td><asp:textbox id=txtIndDailyQuota maxlength=22 text=0 width=100% runat=server CssClass="font9Tahoma" />
							...
							<tr>
								...
								<!-- Modified BY ALIM, max length = 22, width = 75% -->
								<td><asp:textbox id=txtIndQuotaIncRate text=0 width=100% maxlength=22 runat=server CssClass="font9Tahoma" />
									<asp:RegularExpressionValidator 
					...
					<td valign=top colspan=5 bgcolor=black>
						<table width=100% border=0 cellpadding=2 cellspacing=0 bgcolor=DarkGray class="font9Tahoma">
							<tr valign=top>
								...
								<td width=35%>
									<asp:Dropdownlist id=ddlSalary width=100% runat=server CssClass="font9Tahoma" />
							...
							<tr valign=top>
								<td>Daily Rate :*</td>
								<td>
									<asp:Dropdownlist id=ddlDaily width=100% runat=server CssClass="font9Tahoma" />
							...
							<tr valign=top>
								<td>Piece Rate :*</td>
								<td>
									<asp:Dropdownlist id=ddlPiece width=100% runat=server CssClass="font9Tahoma" />
							...
							<tr valign=top>
								<td>Bonus :*</td>
								<td>
									<asp:Dropdownlist id=ddlBonus width=100% runat=server CssClass="font9Tahoma" />
								...
								<td>
									<asp:Dropdownlist id=ddlAdvSalary width=100% runat=server CssClass="font9Tahoma" />
							...
							<tr valign=top>
								<td>THR Allowance :*</td>
								<td>
									<asp:Dropdownlist id=ddlTHR width=100% runat=server CssClass="font9Tahoma" />
								...
								<td>
									<asp:Dropdownlist id=ddlIN width=100% runat=server CssClass="font9Tahoma" />
							...
							<tr valign=top>
								...
								<td>
									<asp:Dropdownlist id=ddlHouse width=100% runat=server CssClass="font9Tahoma" />
								...
								<td>
									<asp:Dropdownlist id=ddlCT width=100% runat=server CssClass="font9Tahoma" />
							...
							<tr valign=top>
								...
								<td>
									<asp:Dropdownlist id=ddlHardShip width=100% runat=server CssClass="font9Tahoma" />
								...
								<td>
									<asp:Dropdownlist id=ddlWS width=100% runat=server CssClass="font9Tahoma" />
							...
							<tr valign=top>
								...
								<td>
									<asp:Dropdownlist id=ddlIncAward width=100% runat=server CssClass="font9Tahoma" />
								...
								<td>
									<asp:Dropdownlist id=ddlWSRefund width=100% runat=server CssClass="font9Tahoma" />
							...
							<tr valign=top>
								...
								<td>
									<asp:Dropdownlist id=ddlTransport width=100% runat=server CssClass="font9Tahoma" />
								...
								<td>Loan :*</td>
								<td>
									<asp:Dropdownlist id=ddlLoan width=100% runat=server CssClass="font9Tahoma" />
							...
							<tr valign=top>
								...
								<td>
									<asp:Dropdownlist id=ddlHouseRent width=100% runat=server CssClass="font9Tahoma" />
								...
								<td>
									<asp:Dropdownlist id=ddlRiceDeduction width=100% runat=server CssClass="font9Tahoma" />
							...
							<tr valign=top>
								...
								<td>
									<asp:Dropdownlist id=ddlMedical width=100% runat=server CssClass="font9Tahoma" />
								...
								<td>
									<asp:Dropdownlist id=ddlBFEmp width=100% runat=server CssClass="font9Tahoma" />
							...
							<tr valign=top>
								...
								<td>
									<asp:Dropdownlist id=ddlMeal width=100% runat=server CssClass="font9Tahoma" />
								...
								<td>
									...
									<asp:Dropdownlist id=ddlOutPayEmp width=100% runat=server CssClass="font9Tahoma" />
							...
							<tr valign=top>
								...
								<td>
									<asp:Dropdownlist id=ddlLeave width=100% runat=server CssClass="font9Tahoma" />
								...
								<td>Absent Days :*</td>
								<td>
									<asp:Dropdownlist id=ddlAbsent width=100% runat=server CssClass="font9Tahoma" />
							...
							<tr valign=top>
								...
								<td>
									<asp:Dropdownlist id=ddlAirBus width=100% runat=server CssClass="font9Tahoma" />
								...
								<td>Hutang :*</td>
								<td>
									<asp:Dropdownlist id=ddlHutang width=100% runat=server CssClass="font9Tahoma" />
							...
							<tr valign=top>
								...
								<td>
									<asp:Dropdownlist id=ddlMaternity width=100% runat=server CssClass="font9Tahoma" />
							...
							<tr valign=top>
								<td>Tax Allowance :*</td>
								<td>
									<asp:Dropdownlist id=ddlTax width=100% runat=server CssClass="font9Tahoma" />
								...
								<td align="left">
									<asp:Dropdownlist id=ddlSPSICOP width=100% runat=server CssClass="font9Tahoma" />
							...
							<tr valign=top>
								<td>Dana Pensiun :*</td>
								<td>
									<asp:Dropdownlist id=ddlDanaPensiun width=100% runat=server CssClass="font9Tahoma" />
								...
								<td align="left" valign=top>
									<asp:Dropdownlist id=ddlLuranCOP width=100% runat=server CssClass="font9Tahoma" />
							...
							<tr valign=top>
								...
								<td>
									<asp:Dropdownlist id=ddlRelocation width=100% runat=server CssClass="font9Tahoma" />
								...
								<td align="left" valign=top>
									<asp:Dropdownlist id=ddlOther width=100% runat=server CssClass="font9Tahoma" />
							...
							<tr valign=top>
								<td>Rapel :*</td>
								<td>
									<asp:Dropdownlist id=ddlRapel width=100% runat=server CssClass="font9Tahoma" />
							...
							<tr valign=top>
								<td>Overtime :*</td>
								<td>
									<asp:Dropdownlist id=ddlOvertime width=100% runat=server CssClass="font9Tahoma" />
								...
								<td align="left">
									<asp:Dropdownlist id=ddlHold width=100% runat=server CssClass="font9Tahoma" />
							...
							<tr valign=top>
								<td>Trip :*</td>
								<td>
									<asp:Dropdownlist id=ddlTrip width=100% runat=server CssClass="font9Tahoma" />
								...
								<td align="left" valign=top>
									<asp:Dropdownlist id=ddlPayment width=100% runat=server CssClass="font9Tahoma" />
							...
							<tr valign=top>
								...
								<td>
									<asp:dropdownlist id=ddlRiceRation width=100% runat=server CssClass="font9Tahoma" />
									<asp:label id=lblErrRice visible=false forecolor=red runat=server />
								</td>
								<td>&nbsp;</td>
								<td align="left" valign=top>Subsidy :*</td>
								<td align="left" valign=top>
									<asp:Dropdownlist id=ddlSubsidy width=100% runat=server CssClass="font9Tahoma" />
							...
							<tr valign=top>
								...
								<td>
									<asp:dropdownlist id=ddlIncentive width=100% runat=server CssClass="font9Tahoma" />
									<asp:label id=lblErrIncentive visible=false forecolor=red runat=server />
								</td>							
								<td>&nbsp;</td>
								<td align="left" valign=top>Deficit :*</td>
								<td align="left" valign=top>
									<asp:Dropdownlist id=ddlDeficit width=100% runat=server CssClass="font9Tahoma" />
							...
							<tr valign=top>
								...
								<td>
									<asp:dropdownlist id=ddlQuotaIncCode width=100% runat=server CssClass="font9Tahoma" />
								...
								<td align="left" valign=top>
									<asp:Dropdownlist id=ddlLevyAdj width=100% runat=server CssClass="font9Tahoma" />
							...
							<tr valign=top>
								...
								<td>
									<asp:Dropdownlist id=ddlContractPay width=100% runat=server CssClass="font9Tahoma" />
							...
							<tr valign=top>
								...
								<td>
									<asp:Dropdownlist id=ddlBIKAccom width=100% runat=server CssClass="font9Tahoma" />
							...
							<tr valign=top>
								...
								<td>
									<asp:Dropdownlist id=ddlBIKVeh width=100% runat=server CssClass="font9Tahoma" />
							...
							<tr valign=top>
								...
								<td>
									<asp:Dropdownlist id=ddlBIKHP width=100% runat=server CssClass="font9Tahoma" />
							...
							<tr valign=top>
								<td>Gratuity :*</td>
								<td>
									<asp:Dropdownlist id=ddlGratuity width=100% runat=server CssClass="font9Tahoma" />
							...
							<tr valign=top>
								...
								<td>
									<asp:Dropdownlist id=ddlRetrench width=100% runat=server CssClass="font9Tahoma" />
							...
							<tr valign=top>
								...
								<td>
									<asp:Dropdownlist id=ddlESOS width=100% runat=server CssClass="font9Tahoma" />
							...
							<tr valign=top>
								...
								<td>
									<asp:Dropdownlist id=ddlAttAllow width=100% runat=server CssClass="font9Tahoma" />
							...
							<tr valign=top>
								...
								<td>
									<asp:Dropdownlist id=ddlStaff width=100% runat=server CssClass="font9Tahoma" />
							...
							<tr valign=top>
								...
								<td>
									<asp:Dropdownlist id=ddlFunctional width=100% runat=server CssClass="font9Tahoma" />
