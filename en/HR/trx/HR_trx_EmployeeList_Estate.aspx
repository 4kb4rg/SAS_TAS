<%@ Page Language="vb" src="../../../include/HR_trx_EmployeeList_Estate.aspx.vb" Inherits="HR_EmployeeList"%> 
			...
			<tr>
				...
				<div class="kontenlist">
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						<tr>
							<td><strong>DAFTAR KARYAWAN</strong><hr style="width :100%" />   
                            </td>
						...
						<tr>
							...
							<table cellpadding="4" cellspacing="0" style="width: 100%">
								...
								<td width="15%" height="26">NIK :<BR><asp:TextBox id=txtEmpCode width=100% maxlength="20" runat="server" /></td>
								<td width="20%" height="26">Nama :<BR><asp:TextBox id=txtEmpName width=100% maxlength="128" runat="server"/></td>
                                <td height="26" style="width: 12%">
                                    Divisi :<br />
                                    <asp:DropDownList id="ddlEmpDiv" width=100% runat=server>
                                    </asp:DropDownList></td>
                                <td height="26" style="width: 12%">
                                    Tipe :<br />
                                    <asp:DropDownList id="ddlEmpType" width=100% runat=server>
                                                                        </asp:DropDownList></td>
								<td height="26" style="width: 15%">
                                    Pekerjaan :<br />
                                    <asp:DropDownList id="ddlEmpJob" width=100% runat=server>
                                              </asp:DropDownList></td>
								<td height="26" style="width: 12%">Status :<BR>
								...
								<td width="20%" height="26">Diupdate :<BR><asp:TextBox id=txtLastUpdate width=100% maxlength="75" runat="server"/></td>
								<td width="10%" height="26" valign=bottom align=right>
								<asp:Button id=SearchBtn Text="Search" OnClick=btnSearch_Click runat="server" class="button-small"/>
								</td>
								</tr>
							</table>
