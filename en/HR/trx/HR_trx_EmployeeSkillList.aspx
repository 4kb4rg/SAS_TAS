<%@ Page Language="vb" src="../../../include/HR_trx_EmployeeSkillList.aspx.vb" Inherits="HR_EmployeeSkillList" %>
<%@ Register TagPrefix="UserControl" Tagname="MenuHR" src="../../menu/menu_hrtrx.ascx"%>
<%@ Register TagPrefix="Preference" Tagname="PrefHdl" src="../../include/preference/preference_handler.ascx"%>

<html>
	<head>
		<title>Employee Skill List</title>
        <link href="../../include/css/gopalms.css" rel="stylesheet" type="text/css" />
<%--		<Preference:PrefHdl id=PrefHdl runat="server" />--%>
	</head>
	<body>
	    <form id=frmEmpSkillList runat=server class="main-modul-bg-app-list-pu">
			...
			<tr>
				...
				<div class="kontenlist">
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						<tr>
							<td><strong>EMPLOYEE SKILL LIST</strong><hr style="width :100%" />   
                            </td>
						...
						<tr>
						    ...
						    <tr>
							    ...
							    <table cellpadding="4" cellspacing="1" style="width: 100%">
                                    <tr>
                                    <td>
						            <asp:DataGrid id=dgEmpSkillList
							                ...
							                <Columns>
								                <asp:TemplateColumn HeaderText="Skill Code" SortExpression="SkillCode">
									                <ItemTemplate>
										                <asp:Label id=lblSkillCode text='<%# Container.DataItem("SkillCode") %>' visible=false runat=server/>
										                <asp:LinkButton id=lbSkillCode text='<%# Container.DataItem("SkillDesc") %>' CommandName=Edit runat=server />
									                </ItemTemplate>
								                </asp:TemplateColumn>
							
								                <asp:TemplateColumn SortExpression="Level">
									                <ItemTemplate>
										                <%# objHR.mtdGetSkillLevel(Container.DataItem("Level")) %>
									                </ItemTemplate>
								                </asp:TemplateColumn>
								                ...
								                <asp:TemplateColumn>
									                <ItemTemplate>
										                <asp:Label id=lblSkillID text='<%# Container.DataItem("SkillID") %>' visible=false runat=server/>
										                <asp:LinkButton id=lbSkillID text='<%# Container.DataItem("SkillID") %>' visible=false runat=server />
									                </ItemTemplate>
								                </asp:TemplateColumn>
						...
						<tr>
							<td>
					            <asp:ImageButton id=NewEmpSkillBtn imageurl="../../images/butt_new.gif" onClick=NewEmpSkillBtn_Click AlternateText="New Skill" runat="server"/>
