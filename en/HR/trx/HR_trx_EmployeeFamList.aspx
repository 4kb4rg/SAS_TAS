<%@ Page Language="vb" src="../../../include/HR_trx_EmployeeFamList.aspx.vb" Inherits="HR_EmployeeFamList" %>
...
<%--		<Preference:PrefHdl id=PrefHdl runat="server" />--%>
	...
	<body>
	    <form id=frmEmpFamList runat=server class="main-modul-bg-app-list-pu">
		...
		<table cellpadding="0" cellspacing="0" style="width: 100%">
			...
			<tr>
				...
				<div class="kontenlist">
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						<tr>
							<td><strong>FAMILY MEMBER LIST</strong><hr style="width :100%" />   
                            </td>
						    ...
						    <tr>
							    ...
							    <table cellpadding="4" cellspacing="1" style="width: 100%">
						            ...
						            <asp:DataGrid id=dgEmpFamList
							            ...
							            <Columns>
								            <asp:TemplateColumn HeaderText="Family Member Name" SortExpression="FamMemberName">
									            <ItemTemplate>
										            <asp:Label id=lblFamName text='<%# Container.DataItem("FamMemberName") %>' visible=false runat=server/>
										            <asp:LinkButton id=lbFamName text='<%# Container.DataItem("FamMemberName") %>' CommandName=Edit runat=server />
									            </ItemTemplate>
								            </asp:TemplateColumn>

								            <asp:TemplateColumn HeaderText="Relationship" SortExpression="Relationship">
									            <ItemTemplate>
										            <%# objHR.mtdGetRelationship(Container.DataItem("Relationship")) %>
									            </ItemTemplate>
								            </asp:TemplateColumn>
								            ...
								            <asp:TemplateColumn>
									            <ItemTemplate>
										            <asp:Label id=lblFamMemberID text='<%# Container.DataItem("FamMemberID") %>' visible=false runat=server/>
										            <asp:LinkButton id=lbFamilyID text='<%# Container.DataItem("FamMemberID") %>' visible=false runat=server />
									            </ItemTemplate>
								            </asp:TemplateColumn>
						...
						<tr>
							<td>
					            <asp:ImageButton id=NewEmpFamBtn imageurl="../../images/butt_new.gif" onClick=NewEmpFamBtn_Click AlternateText="New Family Member" runat="server"/>
			...
			<asp:label id=lblEmpMarital visible=false runat=server />
			<comment>Modified By BHL</comment>
			<asp:label id=lblEmpGender visible=false runat=server />
