	...
	<body>
		<form id=frmMain class="main-modul-bg-app-list-pu" runat=server>
			...
			<table border=0 cellspacing="1" cellpadding="1" width="100%" class="font9Tahoma">
				...
				<tr>
					<td  colspan="5"><strong>EMPLOYEE FAMILY</strong> </td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><asp:TextBox id=txtMemberName maxlength=64 width=100% runat=server />
					...
					<td><asp:DropDownList id=ddlFamEmpCode width=80% runat=server /> 						
						<comment>Search employee code button</comment>
				...
				<tr>
					...
					<td>&nbsp;</td>
					<td><asp:Label id=lblFamMemberID visible=false runat=server /></td>
					<td>&nbsp;</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><asp:TextBox id=txtDOB width=50% runat=server />
						...
						<asp:Label id=lblErrDOB visible=False forecolor=red text="<br>Date format should be in " runat=server />
				...
				<tr>
					<td height=25>Working in this company?</td>
					<td><asp:CheckBox id=cbWorkCompInd text=" Yes" textalign=right runat=server /></td>
					<td colspan=3>&nbsp;</td>
				</tr>
				<tr>
					<td height=25>Cease for rice?</td>
					<td colspan=4><asp:CheckBox id=cbCeaseRiceInd text=" Yes" textalign=right runat=server /></td>
				</tr>
				<tr>
			...
			<asp:label id=lblEmpMarital visible=false text=1 runat=server />
