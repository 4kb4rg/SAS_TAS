		...
		<form id=frmMain class="main-modul-bg-app-list-pu"  runat=server>
			...
			<table border=0 cellspacing="1" width="100%" class="font9Tahoma">
				...
				<tr>
					...
					<td width=25%>
						<asp:DropDownList id=ddlEmpCode width=100% runat=server CssClass="font9Tahoma" />
						<asp:Textbox id=txtEmpCode width=100% maxlength=15 visible=false runat=server CssClass="font9Tahoma" />
				...
				<tr>
					...
					<td><asp:TextBox id=txtNewICNo width=100% maxlength=18 runat=server CssClass="font9Tahoma"/>
					</td>
					<td>&nbsp;</td>
					<td>I.C Type :</td>
					<td><asp:DropDownList id=ddlNewICType width=100% runat=server CssClass="font9Tahoma"/></td>
				</tr>
				<tr>
					<td height=25>Old I.C Number :</td>
					<td><asp:TextBox id=txtOldICNo width=100% maxlength=8 runat=server CssClass="font9Tahoma"/></td>
					<td>&nbsp;</td>
					<td>Old I.C Type :</td>
					<td><asp:DropDownList id=ddlOldICType width=100% runat=server CssClass="font9Tahoma"/></td>
				</tr>
				<tr>
					<td height=25>Koperasi No :</td>
					<td><asp:TextBox id=txtKoperasiNo width=100% maxlength=20 runat=server CssClass="font9Tahoma"/></td>
					<td>&nbsp;</td>
					<td>Koperasi ID :</td>
					<td><asp:DropDownList id=ddlKoperasiID width=100% runat=server CssClass="font9Tahoma"/></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><asp:textbox id=txtBloodType maxlength=3 width=100% runat=server CssClass="font9Tahoma"/>
				...
				<tr>	
					...
					<td><asp:TextBox id=txtState width=50% runat=server CssClass="font9Tahoma" /></td>
					<td>&nbsp;</td>
					<td>Bumiputra :</td>
				...
				<tr>
					...
					<td><asp:TextBox id=txtPensionNo width=100% maxlength=20 runat=server CssClass="font9Tahoma" /></td>
				</tr>
				<tr>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
					...
					<td><asp:DropDownList id=ddlRecruitment width=100% runat=server  CssClass="font9Tahoma"/>
				...
				<tr>
					...
					<td><asp:TextBox id=txtPassportNo width=100% maxlength=32 runat=server CssClass="font9Tahoma" /></td>
					<td>&nbsp;</td>
					<td>Passport Expiry Date :</td>
					<td><asp:TextBox id=txtPassportExpDate width=50% runat=server CssClass="font9Tahoma" />
				...
				<tr>
					...
					<td><asp:TextBox id=txtWorkpassNo width=100% maxlength=32 runat=server CssClass="font9Tahoma" /></td>
					<td>&nbsp;</td>
					<td>Workpass Expiry Date :</td>
					<td><asp:TextBox id=txtWorkpassExpDate width=50% runat=server CssClass="font9Tahoma" />
				...
				<tr>
					...
					<td><asp:TextBox id=txtDriveCls width=100% maxlength=32 runat=server CssClass="font9Tahoma"/></td>
					<td>&nbsp;</td>
					<td>Driving Expiry Date :</td>
					<td><asp:TextBox id=txtDriveExpDate width=50% runat=server CssClass="font9Tahoma" />
				...
				<tr>
					...
					<td><asp:TextBox id=txtOpClass width=100% maxlength=32 runat=server CssClass="font9Tahoma" /></td>
					<td>&nbsp;</td>
					<td>Other Expiry Date :</td>
					<td><asp:TextBox id=txtOpExpDate width=50% runat=server CssClass="font9Tahoma" />
				...
				<tr>
					...
					<td><asp:TextBox id=txtBatchNo width=100% maxlength=32 runat=server CssClass="font9Tahoma" /></td>
					<td>&nbsp;</td>
					<td>Medical Report Expiry Date :</td>
					<td><asp:TextBox id=txtMRExpDate width=50% runat=server CssClass="font9Tahoma" />
				...
				<tr>
					...
					<td><asp:TextBox id=txtLabLicNo width=100% maxlength=32 runat=server CssClass="font9Tahoma" /></td>
					<td>&nbsp;</td>
					<td>Labour License Expiry Date :</td>
					<td><asp:TextBox id=txtLCExpDate width=50% runat=server CssClass="font9Tahoma" />
				...
				<tr>
					...
					<td><asp:TextBox id=txtInsPolNo width=100% maxlength=32 runat=server CssClass="font9Tahoma" /></td>
					<td>&nbsp;</td>
					<td>Insurance Policy Expiry Date :</td>
					<td><asp:TextBox id=txtIPExpDate width=50% runat=server CssClass="font9Tahoma" />
				...
				<tr>
					...
					<td><asp:TextBox id=txtBankGuaNo width=100% maxlength=32 runat=server CssClass="font9Tahoma" /></td>
					<td>&nbsp;</td>
					<td>Bank Guarantee Expiry Date :</td>
					<td><asp:TextBox id=txtBGExpDate width=50% runat=server CssClass="font9Tahoma"/>
				...
				<tr>
					...
					<td><asp:DropDownList id=ddlallwstatus width=100% runat=server CssClass="font9Tahoma" />
