<%@ Page Language="vb" src="../../../include/HR_trx_MutasiList_Estate.aspx.vb" Inherits="HR_trx_MutasiList_Estate" %>
			...
			<tr>
				...
				<div class="kontenlist">
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						<tr>
							<td><strong>DAFTAR MUTASI KARYAWAN</strong><hr style="width :100%" />   
                            </td>
						    ...
						    <tr>
							    ...
							    <table cellpadding="4" cellspacing="1" style="width: 100%">
						            ...
						            <asp:DataGrid id=dgLine runat=server
							            ...
							            <Columns>
								            <asp:BoundColumn Visible=False HeaderText="Kode Mutasi" DataField="MutasiCode" />								
								            <asp:HyperLinkColumn HeaderText="Kode Mutasi" SortExpression="MutasiCode" 
									            DataNavigateUrlField="MutasiCode" 
									            DataNavigateUrlFormatString="HR_trx_MutasiDet_Estate.aspx?MutasiCode={0}" 
									            DataTextField="MutasiCode" />			
								
								            <asp:TemplateColumn HeaderText="Tanggal" >
									            <ItemTemplate>
										            <asp:Label ID = mdate Text='<%#objGlobal.GetLongDate(Container.DataItem("MutasiDate"))%>' Visible=true runat=server/>										
									            </ItemTemplate>
								            </asp:TemplateColumn>		
								            ...
								            <asp:TemplateColumn HeaderText="Divisi Awal" >
									            <ItemTemplate>
										            <asp:Label ID = diva Text='<%#Container.DataItem("DivisiA")%>' Visible=true runat=server/>										
									            </ItemTemplate>
								            </asp:TemplateColumn>
								
													
								            <asp:TemplateColumn HeaderText="Divisi Baru" >
									            <ItemTemplate>
										            <asp:Label ID = divb Text='<%#Container.DataItem("DivisiB")%>' Visible=true runat=server/>										
									            </ItemTemplate>
								            </asp:TemplateColumn>
								            ...
								            <asp:TemplateColumn HeaderText="Tgl.Efektif" >
									            <ItemTemplate>
										            <asp:Label ID = edate Text='<%#objGlobal.GetLongDate(Container.DataItem("EfektifDate"))%>' Visible=true runat=server/>										
									            </ItemTemplate>
								            </asp:TemplateColumn>
								            ...
								            <asp:TemplateColumn>
									            <ItemTemplate>
										            ...
										            <asp:Label id=lblwh Text='<%# Trim(Container.DataItem("IdWorkHist")) %>' Visible=False runat=server />
									            </ItemTemplate>
                                                <ItemStyle HorizontalAlign="Center" />
								            </asp:TemplateColumn>	
							            </Columns>
