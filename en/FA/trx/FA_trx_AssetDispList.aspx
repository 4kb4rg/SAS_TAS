<%@ Page Language="vb" src="../../../include/FA_trx_AssetDispList.aspx.vb" Inherits="FA_trx_AssetDispList" %>
<%@ Register TagPrefix="UserControl" Tagname="MenuFATrx" src="../../menu/menu_FATrx.ascx"%>
<%@ Register TagPrefix="Preference" Tagname="PrefHdl" src="../../include/preference/preference_handler.ascx"%>

<html>
	<head>
		<title>FIXED ASSET - Asset Disposal List</title>
				...
				<div class="kontenlist">
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						...
						<tr>
							...
							<Columns>
								<asp:HyperLinkColumn
									SortExpression="AssetDispID" 
									DataNavigateUrlField="AssetDispID"
									DataNavigateUrlFormatString="FA_trx_AssetDispDetails.aspx?Id={0}"
									DataTextField="AssetDispID"
