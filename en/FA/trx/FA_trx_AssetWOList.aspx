<%@ Page Language="vb" src="../../../include/FA_trx_AssetWOList.aspx.vb" Inherits="FA_trx_AssetWOList" %>
<%@ Register TagPrefix="UserControl" Tagname="MenuFATrx" src="../../menu/menu_FATrx.ascx"%>
<%@ Register TagPrefix="Preference" Tagname="PrefHdl" src="../../include/preference/preference_handler.ascx"%>

<html>
	<head>
		<title>FIXED ASSET - Asset Write Off List</title>
				...
				<div class="kontenlist">
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						...
						<tr>
							...
							<Columns>
								<asp:HyperLinkColumn
									SortExpression="AssetWOID" 
									DataNavigateUrlField="AssetWOID"
									DataNavigateUrlFormatString="FA_trx_AssetWODetails.aspx?Id={0}"
									DataTextField="AssetWOID"
