<%@ Page Language="vb" src="~/include/FA_trx_AssetTranList.aspx .vb" Inherits="FA_trx_AssetTranList" %>
<%@ Register TagPrefix="UserControl" Tagname="MenuFATrx" src="../../menu/menu_FATrx.ascx"%>
<%@ Register TagPrefix="Preference" Tagname="PrefHdl" src="../../include/preference/preference_handler.ascx"%>

<html>
	<head>
		<title>FIXED ASSET - Asset Transfer List</title>
				...
				<div class="kontenlist">
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						...
						<tr>
							...
							<Columns>
								<asp:HyperLinkColumn
									SortExpression="AssetTranID" 
									DataNavigateUrlField="AssetTranID"
									DataNavigateUrlFormatString="FA_trx_AssetTranDetails.aspx?Id={0}"
									DataTextField="AssetTranID"
								...
								<asp:TemplateColumn SortExpression="FA.TranLocCode">
								<ItemStyle Width="7%" />
									<ItemTemplate>
										<%#Container.DataItem("TranLocCode")%>
									</ItemTemplate>
								</asp:TemplateColumn>
								...
								<ItemStyle Width="10%" />
									<ItemTemplate>
										<%# objFATrx.mtdGetAssetDispStatus(Container.DataItem("Status")) %>
									</ItemTemplate>
								</asp:TemplateColumn>
