<%@ Page Language="vb" src="../../../include/FA_trx_AssetDeprList.aspx.vb" Inherits="FA_trx_AssetDeprList" %>
<%@ Register TagPrefix="UserControl" Tagname="MenuFATrx" src="../../menu/menu_FATrx.ascx"%>
<%@ Register TagPrefix="Preference" Tagname="PrefHdl" src="../../include/preference/preference_handler.ascx"%>

<html>
	<head>
		<title>FIXED ASSET - Asset Depreciation List</title>
				...
				<div class="kontenlist">
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						...
						<tr>
							...
							<Columns>
								<asp:HyperLinkColumn
									SortExpression="AssetDeprID" 
									DataNavigateUrlField="AssetDeprID"
									DataNavigateUrlFormatString="FA_trx_AssetDeprDetails.aspx?Id={0}"
									DataTextField="AssetDeprID"
								...
								<ItemStyle Width="10%" />
									<ItemTemplate>
										<%# objFATrx.mtdGetAssetDeprStatus(Container.DataItem("Status")) %>
									</ItemTemplate>
								</asp:TemplateColumn>
						...
						<tr>
							<td>
						        ...
						        <asp:ImageButton id=ibPrint imageurl="../../images/butt_print.gif" 
                                    AlternateText=Print runat="server"/>
							</td>
						</tr>
                        <tr>
                            <td>
