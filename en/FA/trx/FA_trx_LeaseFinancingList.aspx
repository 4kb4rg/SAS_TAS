<%@ Page Language="vb" src="../../../include/FA_trx_LeaseFinancingList.aspx.vb" Inherits="FA_trx_LeaseFinancingList" %>
<%@ Register TagPrefix="UserControl" Tagname="MenuCB" src="../../menu/menu_fatrx.ascx"%>
<%@ Register TagPrefix="Preference" Tagname="PrefHdl" src="../../include/preference/preference_handler.ascx"%>
<html>
<head>
	<title>Lease/Financing Payment Schedule List</title>
			...
			<tr>
				...
				<div class="kontenlist">
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						<tr>
							<td><strong>LEASE/FINANCING PAYMENT SCHEDULE LIST</strong><hr style="width :100%" />   
                            </td>
						...
						<tr>
							...
							<Columns>
								...
								<asp:HyperLinkColumn  HeaderText="TrxID" 
													 ...
													 DataNavigateUrlFormatString="FA_trx_LeaseFinancingDet.aspx?trxid={0}" 
													 DataTextField="TrxID" />
