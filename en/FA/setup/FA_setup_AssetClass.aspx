<%@ Page Language="vb" src="../../../include/FA_setup_AssetClass.aspx.vb" Inherits="FA_setup_AssetClass" %>
						...
						<tr>
							...
							<table cellpadding="4" cellspacing="0" style="width: 100%">
								...
								<td width="18%" height="26" valign=bottom>
									<asp:label id="lblAssetClassCode" runat="server" /> :<BR>
									<asp:TextBox id=srchAssetClassCode width=100% maxlength="8" runat="server"/>
								</td>
						    ...
						    <tr>
							    ...
							    <table cellpadding="4" cellspacing="1" style="width: 100%">
					                ...
					                <Columns>
						                <asp:TemplateColumn SortExpression="AssetClassCode">
							                <ItemStyle Width="15%" />
							                <ItemTemplate>
								                <%# Container.DataItem("AssetClassCode") %>
							                </ItemTemplate>
							                <EditItemTemplate>
								                <asp:TextBox id="AssetClassCode" MaxLength="8" width=95%
										                Text='<%# trim(Container.DataItem("AssetClassCode")) %>'
										                runat="server"/>
								                <BR>
						                ...
						                <asp:TemplateColumn HeaderText="Status" SortExpression="FA.Status">
							                <ItemStyle Width="8%" />
							                <ItemTemplate>
								                <%# objFASetup.mtdGetAssetClassStatus(Container.DataItem("Status")) %>
							                </ItemTemplate>
							                <EditItemTemplate>
