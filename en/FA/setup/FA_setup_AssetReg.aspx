<%@ Page Language="vb" src="../../../include/FA_setup_AssetReg.aspx.vb" Inherits="FA_setup_AssetReg" %>
<%@ Register TagPrefix="UserControl" Tagname="MenuFASetup" src="../../menu/menu_FASetup.ascx"%>
<%@ Register TagPrefix="Preference" Tagname="PrefHdl" src="../../include/preference/preference_handler.ascx"%>
<html>
	<head>
		<title> ASSET REGISTRATION HEADER </title>
						...
						<tr>
							...
							<table cellpadding="4" cellspacing="0" style="width: 100%">
								...
								<td width="15%" height="26" valign=bottom>
									<asp:label id="lblAssetHeader" runat="server" /> :<BR>
									<asp:TextBox id=srchAssetHeader width=100% maxlength="8" runat="server"/>
								</td>
								...
								<td width="15%" height="26" valign=bottom>
									<asp:label id="lblAssetClass" runat="server" /> :<BR>
									<asp:TextBox id=srchAssetClass width=100% maxlength="8" runat="server"/>
								</td>
								<td width="15%" height="26" valign=bottom>
									<asp:label id="lblAssetGrp" runat="server" /> :<BR>
									<asp:TextBox id=srchAssetGrp width=100% maxlength="8" runat="server"/>
								</td>
								<td width="10%" height="26" valign=bottom>Status :<BR>
									<asp:DropDownList id="srchStatusList" width=100% runat=server>
									</asp:DropDownList>
								</td>
								<td width="15%" height="26" valign=bottom>Last Update By :<BR><asp:TextBox id=srchUpdateBy width=100% maxlength="10" runat="server"/></td>
						    ...
						    <tr>
							    ...
							    <table cellpadding="4" cellspacing="1" style="width: 100%">
					                ...
					                <Columns>
						                <asp:TemplateColumn SortExpression="AssetHeaderCode">
							                <ItemStyle Width="13%" />
							                <ItemTemplate>
								                <%# Container.DataItem("AssetHeaderCode") %>
							                </ItemTemplate>
							                <EditItemTemplate>
								                <asp:TextBox id="AssetHeaderCode" MaxLength="8" width=90%
										                Text='<%# trim(Container.DataItem("AssetHeaderCode")) %>'
										                runat="server"/>
								                <BR>
								                <asp:RequiredFieldValidator id=validateCode display=dynamic runat=server 
										                ControlToValidate=AssetHeaderCode />
						                ...
						                <asp:TemplateColumn SortExpression="FA.Description">
							                <ItemStyle Width="20%" />
							                <ItemTemplate>
								                <%# Container.DataItem("Description") %>
							                </ItemTemplate>
							                <EditItemTemplate>
								                <asp:TextBox id="Description" width=95% MaxLength="128"
						                ...
						                <asp:TemplateColumn SortExpression="FA.AssetClassCode">
							                <ItemStyle Width="18%" />
							                <ItemTemplate>
								                <%# Container.DataItem("AssetClassCode") %>
							                </ItemTemplate>
							                <EditItemTemplate>
								                <asp:DropDownList id="AssetClassCode" size=1 width="95%" runat="server"/>
								                <asp:label id=lblAssetClassCode visible=false text='<%# Container.DataItem("AssetClassCode") %>' runat=server/>
								                <BR>
								                <asp:RequiredFieldValidator id=validateAC display=dynamic runat=server 
										                ControlToValidate=AssetClassCode />
							                </EditItemTemplate>
						                </asp:TemplateColumn>
						                <asp:TemplateColumn SortExpression="FA.AssetGrpCode">
							                <ItemStyle Width="18%" />
							                <ItemTemplate>
								                <%# Container.DataItem("AssetGrpCode") %>
							                </ItemTemplate>
							                <EditItemTemplate>
								                <asp:DropDownList id="AssetGrpCode" size=1 width="95%" runat="server"/>
								                <asp:label id=lblAssetGrpCode visible=false text='<%# Container.DataItem("AssetGrpCode") %>' runat=server/>
								                <BR>
								                <asp:RequiredFieldValidator id=validateAG display=dynamic runat=server 
										                ControlToValidate=AssetGrpCode />
							                </EditItemTemplate>
						                </asp:TemplateColumn>
						                ...
						                <asp:TemplateColumn HeaderText="Status" SortExpression="FA.Status">
							                <ItemStyle Width="5%" />
							                <ItemTemplate>
								                <%# objFASetup.mtdGetAssetRegStatus(Container.DataItem("Status")) %>
							                </ItemTemplate>
							                <EditItemTemplate>
