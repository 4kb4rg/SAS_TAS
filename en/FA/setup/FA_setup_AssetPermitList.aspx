<%@ Page Language="vb" src="../../../include/FA_setup_AssetPermitList.aspx.vb" Inherits="FA_setup_AssetPermitList" %>
<%@ Register TagPrefix="UserControl" Tagname="MenuFASetup" src="../../menu/menu_FASetup.ascx"%>
<%@ Register TagPrefix="Preference" Tagname="PrefHdl" src="../../include/preference/preference_handler.ascx"%>

<html>
	<head>
		<title>FIXED ASSET - Asset Permission List</title>
			...
			<tr>
				...
				<div class="kontenlist">
					<table cellpadding="0" cellspacing="0" style="width: 100%" class="font9Tahoma">
						...
						<tr>
							...
							<table cellpadding="4" cellspacing="0" style="width: 100%">
								...
								<td width="40%" height="26" valign=bottom>
									...
									<asp:TextBox id=srchAssetCode width=100% maxlength="8" runat="server"/>
								</td>
								<td width="20%" height="26">Status :<BR>
									<asp:DropDownList id="srchStatusList" width=100% runat=server />
								</td>
								<td width="20%" height="26">Last Update By :<BR>
									<asp:TextBox id=srchUpdateBy width=100% maxlength="10" runat="server"/>
								</td>
								<td width="20%" height="26" valign=bottom align=right><asp:Button id=SearchBtn Text="Search" OnClick=srchBtn_Click runat="server" class="button-small"/></td>
								</tr>
							</table>
						    ...
						    <tr>
							    ...
							    <table cellpadding="4" cellspacing="1" style="width: 100%">
						            ...
						            <asp:DataGrid id=dgTxList
							            ...
							            <Columns>
								            <asp:HyperLinkColumn
									            SortExpression="FA.AssetCode" 
									            DataNavigateUrlField="AssetCode"
									            DataNavigateUrlFormatString="FA_setup_AssetPermitDetails.aspx?AssetCode={0}"
								            ...
								            <ItemStyle Width="15%" />
									            <ItemTemplate>
										            <%# objFASetup.mtdGetAssetPermitStatus(Container.DataItem("Status")) %>
									            </ItemTemplate>
								            </asp:TemplateColumn>
						...
						<tr>
							<td>
					            <asp:ImageButton id=NewBtn imageurl="../../images/butt_new.gif" AlternateText="New" visible=false runat=server/>
