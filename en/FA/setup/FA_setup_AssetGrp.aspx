<%@ Page Language="vb" src="../../../include/FA_setup_AssetGrp.aspx.vb" Inherits="FA_setup_AssetGrp" %>
						...
						<tr>
							...
							<table cellpadding="4" cellspacing="0" style="width: 100%">
								...
								<td width="18%" height="26" valign=bottom>
									<asp:label id="lblAssetGrpCode" runat="server" /> :<BR>
									<asp:TextBox id=srchAssetGrpCode width=100% maxlength="8" runat="server"/>
								</td>
								<td width="52%" height="26" valign=bottom>
						    ...
						    <tr>
							    ...
							    <table cellpadding="4" cellspacing="1" style="width: 100%">
					                ...
					                <Columns>
						                <asp:TemplateColumn SortExpression="AssetGrpCode">
							                <ItemStyle Width="15%" />
							                <ItemTemplate>
								                <%# Container.DataItem("AssetGrpCode") %>
							                </ItemTemplate>
							                <EditItemTemplate>
								                <asp:TextBox id="AssetGrpCode" MaxLength="8" width=95%
										                Text='<%# trim(Container.DataItem("AssetGrpCode")) %>'
										                runat="server"/>
								                <BR>
						                ...
						                <asp:TemplateColumn SortExpression="FACode">
							                <ItemStyle Width="10%" />
							                <ItemTemplate>
								                <%# Container.DataItem("FACode") %>
							                </ItemTemplate>
							                <EditItemTemplate>
								                <asp:TextBox id="FACode" width=100% MaxLength="5"
									                Text='<%# trim(Container.DataItem("FACode")) %>'
									                runat="server"/>														
							                </EditItemTemplate>
						                </asp:TemplateColumn>
						                ...
						                <asp:TemplateColumn HeaderText="Status" SortExpression="FA.Status">
							                <ItemStyle Width="8%" />
							                <ItemTemplate>
								                <%# objFASetup.mtdGetAssetGrpStatus(Container.DataItem("Status")) %>
							                </ItemTemplate>
							                <EditItemTemplate>
