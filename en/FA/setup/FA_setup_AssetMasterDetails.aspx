	<%@ Page Language="vb" Src="../../../include/FA_Setup_AssetMaster_Details.aspx.vb" Inherits="FA_AssetMasterDet" %>
<%@ Register TagPrefix="UserControl" Tagname="MenuFASetup" src="../../menu/menu_FAsetup.ascx"%>
<%@ Register TagPrefix="Preference" Tagname="PrefHdl" src="../../include/preference/preference_handler.ascx"%>
<html>
<head>
    <title>Asset Master Details</title>
    ...
    <form id="frmSysSetting" class="main-modul-bg-app-list-pu"   runat="server">
        ...
        <table cellpadding="2" width="100%" border="0"  class="font9Tahoma">
				...
				<tr>
                    ...
                    <td>
                        <asp:TextBox id="DCCode" runat="server" maxlength="20" width=180% CssClass="font9Tahoma" /><BR>
				...
				<tr>
                    ...
                    <td><asp:DropDownList id="lstUOM" CssClass="font9Tahoma"  runat="server" width=180% size="1"/></td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                    <td colspan="1">&nbsp;</td>
				...
				<tr>
                    ...
                    <td><asp:DropDownList id="lstAccCode" CssClass="font9Tahoma"  runat="server" width=180% size="1"/></td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                    <td colspan="1">&nbsp;</td>
