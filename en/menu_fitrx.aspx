				...
				<td valign="top">                              
					...
					<div class="panel">
                        <table id="tblGL"  cellSpacing="1" cellPadding="0" width="100%" border="0" runat="server">
                            ...
                            <tr>
								<td><a href="#"><div class="childmenu">
                                <asp:hyperlink id="lnkGL04" runat="server"  cssclass="lb-mt" NavigateUrl="/en/GL/Trx/GL_trx_Budget_list.aspx" target="middleFrame" text="Cost Mill Budget"></asp:hyperlink>
                                </div></a></td>
							</tr>
                            <tr>
								<td><a href="#"><div class="childmenu">
                                <asp:hyperlink id="lnkGL05" runat="server"  cssclass="lb-mt" NavigateUrl="/en/GL/Trx/GL_trx_Budget_Item_list.aspx" target="middleFrame" text="Cost Estate Budget"></asp:hyperlink>
                                </div></a></td>
							</tr>
                            <tr>
								<td><a href="#"><div class="childmenu">
                                <asp:hyperlink id="lnkGL06" runat="server"  cssclass="lb-mt" NavigateUrl="/en/GL/Trx/GL_trx_BudgetProd_list.aspx" target="middleFrame" text="Budget Produksi Mill"></asp:hyperlink>
                                </div></a></td>
							</tr>
