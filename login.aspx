<%@ Page Language="vb" src="include/login.aspx.vb" Inherits="login" %>
	...
	<body style="margin: 0; background-color: #d0d0d0; onload=" javascript:onload_setfocus();">
		<form id="frmLogin" runat="server">
			...
			<table cellpadding="0" cellspacing="0" style="width: 90%; height: 90%;" align="center"
				class="main-modul-bg">
				<tr>
					<td valign="top">
									...
									<table cellpadding="0" cellspacing="0" style="width: 100%">
										...
										<tr>
											<td class="cell-center">
												...
												<br>
												<asp:TextBox id="txtUserId" CssClass="font12Tahoma" maxlength="16"
													runat="server" Width="250px" Height="21px" align="center"
													text-align="center" placeholder="Enter your username" />
											</td>
										</tr>
										<tr>
											<td class="cell-center"></td>
											...
											<td class="cell-center">
												...
												<strong>
													<asp:TextBox textmode="password" id="txtPassword"
														CssClass="font12Tahoma" maxlength="16" runat="server"
														align="center" Width="250px" Height="21px" text-align="center"
										...
										<tr>
											<td class="cell-center">&nbsp;
												<asp:Button text="  Login  " onclick="loginBtn_Click" id="Button1"
													runat="server" CssClass="button-form" />
												&nbsp;
												<asp:Button text="  Continue  " onclick="continueBtn_Click"
													id="continueBtn" Visible=false runat="server"
										...
										<tr>
											<td class="cell-center">
												&nbsp;
												<asp:RequiredFieldValidator id="validateUserID" display="dynamic"
													runat="server" ErrorMessage="Please enter your User ID."
													ControlToValidate="txtUserId" />
											</td>
										</tr>
										<tr>
											<td class="cell-center">
												<asp:RequiredFieldValidator id="validatePassword" display="dynamic"
						...
						<table border="0" cellspacing="3" style="width: 241%">
							...
							<tr style="height:25px">
								...
								<td align="center" class="lb-m">
									<asp:Label id="lblErrLoginFail" visible="false" text="Login failed."
										runat="server" />
									<asp:Label id="lblErrAccInactive" visible="false" text="Your account is inactive."
										runat="server" />
									<asp:Label id="lblErrAccDeleted" visible="false" text="Your account has deleted."
										runat="server" />
									<asp:Label id="lblErrMesage" visible="false"
										Text="Error while initiating component." runat="server" />
									<asp:Label id="lblErrExpire" visible="false"
										Text="days to expire date. <br>Please contact IT Administrator. <br> To Continue please input password and click Continue."
										runat="server" />
									<asp:Label id="lblErrExpired" visible="false"
										Text="Green Golden is already expired. <br>Please contact IT Administrator."
										runat="server" />
